...
describe('install (command)', () => {
  ...
  describe('end-to-end tests', () => {
    ...
    const FIXTURE_FAKE_NODE_MODULES_DIR = path.join(
      FIXTURE_ROOT,
      'node_modules',
    );
    ...
    it('installs available libdefs', () => {
      return fakeProjectEnv(async FLOWPROJ_DIR => {
        ...
        await Promise.all([
          ...
          copyDir(
            path.join(FIXTURE_FAKE_NODE_MODULES_DIR, 'underscore'),
            path.join(FLOWPROJ_DIR, 'node_modules', 'underscore'),
          ),
          copyDir(
            path.join(
              FIXTURE_FAKE_NODE_MODULES_DIR,
              '@testscope',
              'underscore',
            ),
            path.join(FLOWPROJ_DIR, 'node_modules', '@testscope', 'underscore'),
          ),
