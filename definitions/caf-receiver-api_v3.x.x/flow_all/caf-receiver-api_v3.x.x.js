...
declare module 'cast.framework' {
    ...
    export class CastReceiverContext {
         ...
         * It takes in a parameter â€˜messageâ€™ that is a string that represents the debug information that the application wants to log.
         */
...
declare module 'cast.framework.events' {
     ...
     */
    declare
    export class SegmentDownloadedEvent {
     ...
     */
    declare
    export class MediaFinishedEvent {
        constructor(
     ...
     */
    declare
    export class MediaElementEvent {
...
declare module 'cast.framework.messages' {
    ...
    export class Track {
        ...
        /**
         * Language tag as per RFC 5646 (If subtype is â€œSUBTITLESâ€ it is mandatory).
         */
        language ? : string;
        ...
        /**
         * It represents the MIME type of the track content. For example if the track is a vtt file it will be â€˜text/vttâ€™. This field is needed for out of band tracks, so it is usually provided if a trackContentId has also been provided. It is not mandatory if the receiver has a way to identify the content from the trackContentId, but recommended. The track content type, if provided, must be consistent with the track type.
         */
     ...
     */
    declare
    export class SetCredentialsRequestData {
        /**
     ...
     */
    declare
    export class QueueUpdateRequestData {
        /**
    ...
    export class QueueReorderRequestData extends RequestData {
        ...
        /**
               * IDs of the items to be reordered, in the new order. Items not provided will keep their existing order. The provided list will be inserted at the position determined by insertBefore. For example:
                  ...
                  If insertBefore is not specified Existing queue: â€œAâ€,â€Dâ€,â€Gâ€,â€Hâ€,â€Bâ€,â€Eâ€ itemIds: â€œDâ€,â€Hâ€,â€Bâ€ New Order: â€œAâ€,â€Gâ€,â€Eâ€,â€œDâ€,â€Hâ€,â€Bâ€

                  If insertBefore is â€œAâ€ Existing queue: â€œAâ€,â€Dâ€,â€Gâ€,â€Hâ€,â€Bâ€ itemIds: â€œDâ€,â€Hâ€,â€Bâ€ New Order: â€œDâ€,â€Hâ€,â€Bâ€,â€œAâ€,â€Gâ€,â€Eâ€

                  If insertBefore is â€œGâ€ Existing queue: â€œAâ€,â€Dâ€,â€Gâ€,â€Hâ€,â€Bâ€ itemIds: â€œDâ€,â€Hâ€,â€Bâ€ New Order: â€œAâ€,â€œDâ€,â€Hâ€,â€Bâ€,â€Gâ€,â€Eâ€
               */
