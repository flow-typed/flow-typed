// @flow
/**
 * Flowtype definitions for rethinkdb
...
declare module 'rethinkdb' {
    ...
    */
    declare     export function connect(
        ...
        cb: (err: ReqlDriverError, conn: Connection) => void): void
    ...
    declare     export function expr(stuff: any): Expression<any >
        ...
        falseBranch: Expression<any>): Expression<any >

        /**
         * Create a javascript expression.
         * @param  - The number of seconds before `r.js` times out. The default value is `5` seconds.
         */
    ...
    declare interface Operation<T>{
        ...
        */
        run(
            ...
            cb: (err: Error, result: T) => void): void,
    ...
    */
    declare type ReqlDriverError = {} & ReqlError
