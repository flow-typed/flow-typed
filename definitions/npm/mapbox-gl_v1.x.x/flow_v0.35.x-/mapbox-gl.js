...
declare module 'npm$namespace$mapboxgl' {
	...
	declare export class NavigationControl extends Control {
		constructor(options?: mapboxgl.ControlOptions): this
	}

	declare export class GeolocateControl extends Control {
		constructor(options?: mapboxgl.ControlOptions): this
	}

	declare export class AttributionControl extends Control {
		constructor(options?: mapboxgl.ControlOptions): this
	}

	declare export class ScaleControl extends Control {
		constructor(options?: {
		position?: "top-right" | "top-left" | "bottom-right" | "bottom-left",
		maxWidth?: number,
		unit?: string
