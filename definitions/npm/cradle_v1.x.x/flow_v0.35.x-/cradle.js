...
declare module 'cradle' {
	...
	declare export interface ChangesOptions {
		since: number
	}
	...
	declare export class Connection  {
		constructor(uri?: string, port?: number, options?: Options): this;
	...
	declare export class Database  {
		...
		update(
		name: string, id: string, queryObject: any, documentBody: any, callback: Callback
	): void;
		...
		id: string,
		rev: string
	}, attachmentData: any, callback: Callback
	): void;
