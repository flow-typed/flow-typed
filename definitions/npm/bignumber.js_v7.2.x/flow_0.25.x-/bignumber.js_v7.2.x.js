...
export type BigNumberInstance = BigNumber
...
declare class BigNumber {
  ...
  /**
    ...
    */
  constructor(n: BigNumberValue, base?: number): this;
  ...
  /**
    ...
    */
  clone(object?: BigNumberConfig): BigNumberConstructor;
  ...
  /**
     ...
     * @param  The configuration object.
    */
  config(object: BigNumberConfig): BigNumberConfig;
  ...
  /**
     ...
     * @param  A numeric value.
    */
  maximum(...n: BigNumberValue[]): BigNumber;
  ...
  /**
     ...
     * @param  A numeric value.
    */
  max(...n: BigNumberValue[]): BigNumber;
  ...
  /**
     ...
     * @param  A numeric value.
    */
  minimum(...n: BigNumberValue[]): BigNumber;
  ...
  /**
     ...
     * @param  A numeric value.
    */
  min(...n: BigNumberValue[]): BigNumber;
  ...
  /**
     ...
     * @param  The configuration object.
    */
  set(object: BigNumberConfig): BigNumberConfig;

  /**
   * Rounds away from zero.
   */
  ROUND_UP: 'NO PRINT IMPLEMENTED: LiteralType';

  /**
   * Rounds towards zero.
   */
  ROUND_DOWN: 'NO PRINT IMPLEMENTED: LiteralType';

  /**
   * Rounds towards Infinity.
   */
  ROUND_CEIL: 'NO PRINT IMPLEMENTED: LiteralType';

  /**
   * Rounds towards -Infinity.
   */
  ROUND_FLOOR: 'NO PRINT IMPLEMENTED: LiteralType';

  /**
   * Rounds towards nearest neighbour. If equidistant, rounds away from zero .
   */
  ROUND_HALF_UP: 'NO PRINT IMPLEMENTED: LiteralType';

  /**
   * Rounds towards nearest neighbour. If equidistant, rounds towards zero.
   */
  ROUND_HALF_DOWN: 'NO PRINT IMPLEMENTED: LiteralType';

  /**
   * Rounds towards nearest neighbour. If equidistant, rounds towards even neighbour.
   */
  ROUND_HALF_EVEN: 'NO PRINT IMPLEMENTED: LiteralType';

  /**
   * Rounds towards nearest neighbour. If equidistant, rounds towards Infinity.
   */
  ROUND_HALF_CEIL: 'NO PRINT IMPLEMENTED: LiteralType';

  /**
   * Rounds towards nearest neighbour. If equidistant, rounds towards -Infinity.
   */
  ROUND_HALF_FLOOR: 'NO PRINT IMPLEMENTED: LiteralType';

  /**
   * See `MODULO_MODE`.
   */
  EUCLID: 'NO PRINT IMPLEMENTED: LiteralType';

  /**
     * To aid in debugging, if a `BigNumber.DEBUG` property is `true` then an error will be thrown
     * on an invalid `BigNumberValue`.
    ...
    An error will also be thrown if a `BigNumberValue` is of type number with more than 15
