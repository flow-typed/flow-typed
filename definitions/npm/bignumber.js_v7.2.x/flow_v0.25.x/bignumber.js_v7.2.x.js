...
const RoundingModeValues = /*::Object.freeze(*/{
...
type RoundingMode = $Values<typeof RoundingModeValues>
...
declare class BigNumber {
   ...
   * ```
   */
  static another(config?: Configuration): BigNumber;
   ...
   */
  constructor(value: number | string | BigNumber, base?: number): BigNumber;
