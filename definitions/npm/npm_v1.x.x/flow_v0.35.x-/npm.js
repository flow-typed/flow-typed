import type { Static } from 'npm$namespace$NPM'
...
declare module 'npm$namespace$NPM' {
	...
	declare export interface Commands {
	...
	declare export interface CommandFunction {
		(args: string[], callback: CommandCallback): void
	}

	declare export interface CommandCallback {
		(err?: Error, result?: any, result2?: any, result3?: any, result4?: any): void
	}

	declare export interface Spinner {
		int: string,
		started: boolean,
		start(): void,
		stop(): void
	...
	declare export interface ConfigStatic {
	...
	declare export interface ConfigDefs {
	...
	declare export interface ConfigTypes {
	...
	declare export interface ConfigShorthands {
		s: any[],
		d: any[],
		dd: any[],
		ddd: any[],
	...
	declare export interface ConfigSource {
		path: string,
		type: string
	}
