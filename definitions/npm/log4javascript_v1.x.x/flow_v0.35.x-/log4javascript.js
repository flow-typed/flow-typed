...
declare
var npm$namespace$log4javascript: {
    ...
    */
declare
export function log4javascript$getLogger(loggerName?: string): log4javascript$Logger
 ...
 */
declare
export function log4javascript$getDefaultLogger(): log4javascript$Logger
 ...
 */
declare
export function log4javascript$getNullLogger(): log4javascript$Logger
 ...
 */
declare
export function log4javascript$getRootLogger(): log4javascript$Logger
 ...
 */
declare
export function log4javascript$resetConfiguration(): void
 ...
 */
declare
export function log4javascript$setEnabled(enabled: boolean): void
 ...
 */
declare
export function log4javascript$isEnabled(): boolean
 ...
 */
declare
export function log4javascript$addEventListener(
    eventType: string,
    listener: {
 ...
 */
declare
export function log4javascript$removeEventListener(
    eventType: string,
    listener: {
        (sender: any, eventType: string, eventArgs: any): void
    }): void
 ...
 */
declare
export function log4javascript$dispatchEvent(eventType: string, eventArgs: any): void
 ...
 */
declare
export function log4javascript$setEventTypes(eventTypes: string[]): void
 ...
 */
declare
export function log4javascript$setShowStackTraces(show: boolean): void
...
*/
declare
export function log4javascript$evalInScope(expr: string): any
 ...
 */
declare
export class AlertAppender mixins Appender {
...
*/
declare
export class AjaxAppender mixins Appender {
 ...
 */
declare
export class PopUpAppender mixins Appender {
 ...
 */
declare
export class InPageAppender mixins Appender {
 ...
 */
declare
export class BrowserConsoleAppender mixins Appender {
 ...
 */
declare
export class NullLayout mixins Layout {
 ...
 */
declare
export class SimpleLayout mixins Layout {
...
*/
declare
export class PatternLayout mixins Layout {
 ...
 */
declare
export class XmlLayout mixins Layout {
...
*/
declare
export class JsonLayout mixins Layout {
 ...
 */
declare
export class HttpPostDataLayout mixins Layout {
...
var npm$namespace$logLog: {
     ...
     */
declare
export function logLog$setQuietMode(quietMode: boolean): void
 ...
 */
declare
export function logLog$setAlertAllErrors(alertAllErrors: boolean): void
 ...
 */
declare
export function logLog$debug(message: string, exception?: Error): void
 ...
 */
declare
export function logLog$displayDebug(): void
 ...
 */
declare
export function logLog$warn(message: string, exception?: Error): void
 ...
 */
declare
export function logLog$error(message: string, exception?: Error): void