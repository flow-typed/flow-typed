// @flow
/**
 * Flowtype definitions for log4javascript
...
declare var npm$namespace$log4javascript: {
        getLogger: typeof log4javascript$getLogger,
        getDefaultLogger: typeof log4javascript$getDefaultLogger,
        getNullLogger: typeof log4javascript$getNullLogger,
        getRootLogger: typeof log4javascript$getRootLogger,
        resetConfiguration: typeof log4javascript$resetConfiguration,
        setEnabled: typeof log4javascript$setEnabled,
        isEnabled: typeof log4javascript$isEnabled,
        addEventListener: typeof log4javascript$addEventListener,
        removeEventListener: typeof log4javascript$removeEventListener,
        dispatchEvent: typeof log4javascript$dispatchEvent,
        setEventTypes: typeof log4javascript$setEventTypes,
        setShowStackTraces: typeof log4javascript$setShowStackTraces,
        evalInScope: typeof log4javascript$evalInScope,
    }
    /**
    ...
    */
declare export function log4javascript$getLogger(loggerName?: string): log4javascript$Logger
 ...
 */
declare export function log4javascript$getDefaultLogger(): log4javascript$Logger


/**
 * Returns an empty logger with no appenders. Useful for disabling all logging.
 */
declare export function log4javascript$getNullLogger(): log4javascript$Logger


/**
 * Returns the root logger from which all other loggers derive.
 */
declare export function log4javascript$getRootLogger(): log4javascript$Logger


/**
 * Resets the all loggers to their default level.
 */
declare export function log4javascript$resetConfiguration(): void


/**
 * Enables or disables all logging, depending on enabled.
 */
declare export function log4javascript$setEnabled(enabled: boolean): void


/**
 * Returns true or false depending on whether logging is enabled.
 */
declare export function log4javascript$isEnabled(): boolean
 ...
 */
declare export function log4javascript$addEventListener(
    eventType: string,
    listener: {
 ...
 */
declare export function log4javascript$removeEventListener(
    eventType: string,
    listener: {
        (sender: any, eventType: string, eventArgs: any): void
    }): void
 ...
 */
declare export function log4javascript$dispatchEvent(eventType: string, eventArgs: any): void


/**
 * Used internally to specify the types of events that the log4javascript object can raise.
 */
declare export function log4javascript$setEventTypes(eventTypes: string[]): void
 ...
 */
declare export function log4javascript$setShowStackTraces(show: boolean): void
...
*/
declare export function log4javascript$evalInScope(expr: string): any
...
declare export class Level {
    ALL: log4javascript$Level;
    TRACE: log4javascript$Level;
    DEBUG: log4javascript$Level;
    INFO: log4javascript$Level;
    WARN: log4javascript$Level;
    ERROR: log4javascript$Level;
    FATAL: log4javascript$Level;
    OFF: log4javascript$Level;
    constructor(level: number, name: string): this;
    toString(): string;
    equals(level: log4javascript$Level): boolean;
    isGreaterOrEqual(level: log4javascript$Level): boolean
}
...
declare export class Logger {
     ...
     */
    addAppender(appender: log4javascript$Appender): void;

    /**
     * Removes the given appender.
     */
    removeAppender(appender: log4javascript$Appender): void;
     ...
     */
    getEffectiveLevel(): log4javascript$Level;
    ...
    */
     ...
     */
    log(level: log4javascript$Level, params: any[]): void;
     ...
     */
    isEnabledFor(level: log4javascript$Level, exception: Error): boolean;
    ...
    */
    ...
    defaults to INFO.
    */
    time(name: string, level?: log4javascript$Level): void;
...
declare export class LoggingEvent {
    ...
    milliseconds: number;
    level: log4javascript$Level;
    messages: any[];
    exception: Error;
    constructor(logger: log4javascript$Logger, timeStamp: Date, level: log4javascript$Level, messages: string[], exception?: Error): this;
...
declare export class Appender {
     ...
     */
    doAppend(loggingEvent: log4javascript$LoggingEvent): void;
     ...
     */
    setThreshold(level: log4javascript$Level): void;

    /**
     * Returns the appender's threshold.
     */
    getThreshold(): log4javascript$Level;
 ...
 */
declare export class AlertAppender mixins Appender {
...
*/
declare export class AjaxAppender mixins Appender {
 ...
 */
declare export class PopUpAppender mixins Appender {
    ...
    */
     ...
     */
    getCommandLayout(): log4javascript$Layout;

    /**
     * Sets the layout used to format the output for commands typed into the command line.
     */
    setCommandLayout(commandLayout: log4javascript$Layout): void;
    ...
    addCommandLineFunction(
        functionName: string,
        commandLineFunction: {
            (appender: log4javascript$Appender, args: any, returnValue: {
 ...
 */
declare export class InPageAppender mixins Appender {
 ...
 */
declare export class BrowserConsoleAppender mixins Appender {
...
declare export class Layout {
     ...
     */
    format(loggingEvent: log4javascript$LoggingEvent): string;
     ...
     */
    getDataValues(loggingEvent: log4javascript$LoggingEvent): Array<any>;
    ...
    */
    ...
    formatWithException(loggingEvent: log4javascript$LoggingEvent): string
}
 ...
 */
declare export class NullLayout mixins Layout {
 ...
 */
declare export class SimpleLayout mixins Layout {
...
*/
declare export class PatternLayout mixins Layout {
 ...
 */
declare export class XmlLayout mixins Layout {
...
*/
declare export class JsonLayout mixins Layout {
 ...
 */
declare export class HttpPostDataLayout mixins Layout {
...
declare var npm$namespace$logLog: {
        setQuietMode: typeof logLog$setQuietMode,
        setAlertAllErrors: typeof logLog$setAlertAllErrors,
        debug: typeof logLog$debug,
        displayDebug: typeof logLog$displayDebug,
        warn: typeof logLog$warn,
        error: typeof logLog$error,
    }
    /**
     ...
     */
declare export function logLog$setQuietMode(quietMode: boolean): void
 ...
 */
declare export function logLog$setAlertAllErrors(alertAllErrors: boolean): void


/**
 * Logs a debugging message to an in-memory list.
 */
declare export function logLog$debug(message: string, exception?: Error): void


/**
 * Displays an alert of all debugging messages.
 */
declare export function logLog$displayDebug(): void


/**
 * Currently has no effect.
 */
declare export function logLog$warn(message: string, exception?: Error): void
 ...
 */
declare export function logLog$error(message: string, exception?: Error): void