 ...
 */
declare export function keyboardjs$withContext(identifier: string, inContextCallBack: () => void): void
 ...
 */
declare export function keyboardjs$pressKey(keyCombo: string): void
 ...
 */
declare export function keyboardjs$releaseKey(keyCombo: string): void
 ...
 */
declare export function keyboardjs$watch(myWin: Window, myDoc: Document | HTMLFormElement): void


/**
 * Detaches KeyboardJS from the window and document/element
 */
declare export function keyboardjs$stop(): voiddeclare module 'keyboardjs' {
