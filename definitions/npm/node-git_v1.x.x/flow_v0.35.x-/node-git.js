...
declare module 'git' {
		...
		fs_read(
		gitDirectory: string, file: string, callback: (err: any, data: any) => void
	): void;
		transform_options(options: any): string[];
		git(functionName: any, options: any, ...args: any[]): void;
		call_git(
		prefix: string, command: any, postfix: string, options: any, args: any, callback: (error: any, result: string) => void
	): void;
		...
		diff(
		commit1: any, commit2: any, callback: (error: any, patch: string) => void
	): void;
		diff(
		commit1: any, commit2: any, options: any, callback: (error: any, patch: string) => void
	): void;
	...
	declare export class GitIndex  {
		...
		commit(
		message: any, parents: any, actor: any, lastTree: any, callback: Function
	): void;
	...
	declare export class PackStorage  {
		...
		unpack_deltified(
		packfile: any, type: any, offset: any, objOffset: any, size: any, options: any
	): any
	}
	...
	declare export class Repo  {
		...
		diff(
		a: string, b: string, paths: any, callback: (error: any, patch: string) => void
	): void;
		...
		log(
		commit: string, path: any, callback: (err: any, commits: Commit[]) => void
	): void;
		log(
		commit: string, path: any, options: any, callback: (err: any, commits: Commit[]) => void
	): void;
