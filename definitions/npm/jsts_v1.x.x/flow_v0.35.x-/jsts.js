...
{
 * @link  Geometry}. Unlike objects of type {
 * @link  Point} (which contain
...
declare export class Coordinate {
     ...
     * @constructor  
     */
    constructor(c: geom$Coordinate): this;
     ...
     * <code>other</code>.other the <code>Coordinate</code> to copy.
     */
    setCoordinate(other: geom$Coordinate): void;

    /**
     * Clones this instance.
     * @return  A point instance cloned from this.
     */
    clone(): geom$Coordinate;

    /**
     * Computes the 2-dimensional Euclidean distance to another location. The
     * Z-ordinate is ignored.p a point.
     * @return  the 2-dimensional Euclidean distance between the
    locations.
    */
    distance(p: geom$Coordinate): number;

    /**
     * Returns whether the planar projections of the two <code>Coordinate</code>s
     * are equal.other a <code>Coordinate</code> with which to do the 2D
    comparison.
     * @return  <code>true</code> if the x- and y-coordinates are
    equal; the z-coordinates do not have to be equal.
    */
    equals2D(other: geom$Coordinate): boolean;

    /**
     * Returns <code>true</code> if <code>other</code> has the same values for
     * the x and y ordinates. Since Coordinates are 2.5D, this routine ignores the
    z value when making the comparison.other a <code>Coordinate</code> with which to do the comparison.
     * @return  <code>true</code> if <code>other</code> is a
    <code>Coordinate</code> with the same values for the x and y
    ordinates.
    */
    equals(other: geom$Coordinate): boolean;
    ...
    values are not handled correctly.other the <code>Coordinate</code> with which this
    <code>Coordinate</code> is being compared.
     * @return  -1, zero, or 1 as explained above.
    */
    compareTo(other: geom$Coordinate): number
}
...
declare export class Envelope {
    ...
    overloaded functionp1 one extremal point of the envelope.p2 another extremal point of the envelope.q the point to test for intersection.
     * @return  <code>true</code> if q intersects the envelope p1-p2.
    */
    intersects(p1: geom$Coordinate, p2: geom$Coordinate, q: geom$Coordinate): boolean;

    /**
     * Test the envelope defined by p1-p2 for intersection with the envelope defined
     * by q1-q2p1 one extremal point of the envelope P.p2 another extremal point of the envelope P.q1 one extremal point of the envelope Q.q2 another extremal point of the envelope Q.
    ...
    intersectsEnvelope(
        ...
        p2: geom$Coordinate,
        q1: geom$Coordinate,
        q2: geom$Coordinate): boolean;

    /**
     * Creates an <code>Envelope</code> for a region defined by maximum and
     * minimum values.
     * @param  the first x-value.
     * @param  the second x-value.
     ...
     * @param  the first Coordinate.
     * @param  the second Coordinate.
     */
    constructor(p1: geom$Coordinate, p2: geom$Coordinate): this;
     ...
     */
    constructor(p: geom$Coordinate): this;

    /**
     * Initialize an <code>Envelope</code> from an existing Envelope.
     * @param  the Envelope to initialize from.
     */
    constructor(env: geom$Envelope): this;
    ...
    */
     ...
     * @return  the area of the envelope, 0.0 if the envelope is null.
     */
    getArea(): number;
    ...
    envelope.
     * @param  the Coordinate to expand to include.
    */
    expandToInclude(p: geom$Coordinate): void;

    /**
     * Enlarges this <code>Envelope</code> so that it contains the given point.
     * Has no effect if the point is already on or within the envelope.
     * @param  the value to lower the minimum x to or to raise the maximum x to.
     * @param  the value to lower the minimum y to or to raise the maximum y to.
     */
     ...
     * @param  the <code>Envelope</code> to expand to include.
    */
    expandToInclude(other: geom$Envelope): void;

    /**
     * Expands this envelope by a given distance in all directions. Both positive
     * and negative distances are supported.
     * @param  the distance to expand the envelope.
     */
    expandBy(distance: number): void;

    /**
     * Expands this envelope by a given distance in all directions. Both positive
     * and negative distances are supported.deltaX the distance to expand the envelope along the the X axis.deltaY the distance to expand the envelope along the the Y axis.
     */
    expandBy(deltaX: number, deltaY: number): void;

    /**
     * Translates this envelope by given amounts in the X and Y direction.transX the amount to translate along the X axis.transY the amount to translate along the Y axis.
     */
     ...
     * non-null
     * @return  the centre coordinate of this envelope <code>null</code>
    if the envelope is null.
    */
    centre(): geom$Coordinate;

    /**
     * Computes the intersection of two {@link Envelopes}env the envelope to intersect with.
     * @return  a new Envelope representing the intersection of
    the envelopes (this will be the null envelope if either argument is
    null, or they do not intersect.
    */
    intersection(env: geom$Envelope): geom$Envelope;

    /**
     * Check if the region defined by <code>other</code> overlaps (intersects) the
     * region of this <code>Envelope</code>.other the <code>Envelope</code> which this <code>Envelope</code>
    is being checked for overlapping.
     * @return  <code>true</code> if the <code>Envelope</code>s
    overlap.
    */
    intersects(other: geom$Envelope): boolean;

    /**
     * Check if the point <code>p</code> overlaps (lies inside) the region of this
     * <code>Envelope</code>.p the <code>Coordinate</code> to be tested.
     * @return  <code>true</code> if the point overlaps this
    <code>Envelope.</code>
    */
    intersects(p: geom$Coordinate): boolean;

    /**
     * Check if the point <code>(x, y)</code> overlaps (lies inside) the region of
     * this <code>Envelope</code>.x the x-ordinate of the point.y the y-ordinate of the point.
     * @return  <code>true</code> if the point overlaps this
    <code>Envelope.</code>
    */
    ...
    <tt>contains</tt>, which would exclude the envelope boundary.other the <code>Envelope</code> to check.
     * @return  true if <code>other</code> is contained in this
    <code>Envelope.</code>
     * @see  covers(Envelope)
    */
    contains(other: geom$Envelope): boolean;

    /**
     * Tests if the given point lies in or on the envelope.
     * <p>
    Note that this is <b>not</b> the same definition as the SFS
    <tt>contains</tt>, which would exclude the envelope boundary.p the point which this <code>Envelope</code> is being checked for
    containing.
     * @return  <code>true</code> if the point lies in the interior or on
    the boundary of this <code>Envelope</code>.
     * @see  covers(Coordinate)
    */
    contains(p: geom$Coordinate): boolean;

    /**
     * Tests if the given point lies in or on the envelope.
     * <p>
    Note that this is <b>not</b> the same definition as the SFS
    <tt>contains</tt>, which would exclude the envelope boundary.x the x-coordinate of the point which this <code>Envelope</code>
    is being checked for containing.y the y-coordinate of the point which this <code>Envelope</code>
    is being checked for containing.
     * @return  <code>true</code> if <code>(x, y)</code> lies in the
    ...
    */
    ...
    /**
     * Tests if the given point lies in or on the envelope.x the x-coordinate of the point which this <code>Envelope</code>
     * is being checked for containing.y the y-coordinate of the point which this <code>Envelope</code>
    is being checked for containing.
     * @return  <code>true</code> if <code>(x, y)</code> lies in the
    interior or on the boundary of this <code>Envelope</code>.
    */
    ...
    /**
     * Tests if the given point lies in or on the envelope.p the point which this <code>Envelope</code> is being checked for
     * containing.
     * @return  <code>true</code> if the point lies in the interior or on
    the boundary of this <code>Envelope</code>.
    */
    covers(p: geom$Coordinate): boolean;

    /**
     * Tests if the <code>Envelope other</code> lies wholely inside this
     * <code>Envelope</code> (inclusive of the boundary).other the <code>Envelope</code> to check.
     * @return  true if this <code>Envelope</code> covers the
    <code>other.</code>
    */
    covers(other: geom$Envelope): boolean;

    /**
     * Computes the distance between this and another <code>Envelope</code>.env The <code>Envelope</code> to test this <code>Envelope</code>
     * against.
     * @return  The distance between overlapping Envelopes is 0. Otherwise,
    the distance is the Euclidean distance between the closest points.
    */
    distance(env: geom$Envelope): number;

    /**
     * other the <code>Envelope</code> to check against.
     * @return  true if envelopes are equal.
     */
    equals(other: geom$Envelope): boolean;

    /**
     * 
     * @return  String representation of this <code>Envelope.</code>
     */
    toString(): string;

    /**
     * 
     * @return  A new instance copied from this.
     */
    clone(): geom$Envelope
}
...
declare export class Geometry {
     ...
     * @return  The name of this <code>Geometry</code>s most specific <code>jsts.geom</code> interface.
     */
    ...
    */
     ...
     * @param  The index of the geometry element.
     * @return  the n'th geometry contained in this geometry.
     */
    getGeometryN(n: number): geom$Geometry;
    ...
    */
     ...
     * @return  a {
     * @link  Coordinate} which is a vertex of this
      <code>Geometry</code>. null if this Geometry is empty.
    */
    getCoordinate(): geom$Coordinate;
    ...
    */
    ...
    <ul>
     * @return  <code>true</code> if this <code>Geometry</code> has any
    ...
    */
     ...
     * empty.
     * @return  <code>true</code> if this <code>Geometry</code> equals
    the empty geometry.
    */
    isEmpty(): boolean;
     ...
     * <code>Geometry</code> gg the <code>Geometry</code> from which to compute the distance.
     * @return  the distance between the geometries. 0 if either input
    geometry is empty.
     * @throws  IllegalArgumentException
      if g is null
    */
    distance(g: geom$Geometry): number;

    /**
     * Tests whether the distance from this <code>Geometry</code> to another is
     * less than or equal to a specified value.geom the Geometry to check the distance to.distance the distance value to compare.
     * @return  <code>true</code> if the geometries are less than
    <code>distance</code> apart.
    */
    isWithinDistance(geom: geom$Geometry, distance: number): boolean;
    isRectangle(): boolean;
    ...
    */
    ...
    centroid)
     * @return  a {
     * @link  Point} which is the centroid of this Geometry.
    */
    getCentroid(): geom$Point;
    ...
    of the geometry.
     * @return  a {
     * @link  Point} which is in the interior of this Geometry.
    */
    ...
    */
    getEnvelopeInternal(): geom$Envelope;
    ...
    </ul>g the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>
     * @return  <code>true</code> if the two <code>Geometry</code>s
    are disjoint.
     * @see  Geometry#intersects
    */
    disjoint(g: geom$Geometry): boolean;
    ...
    <code>false</code>g the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>
     * @return  <code>true</code> if the two <code>Geometry</code>s
    touch; Returns <code>false</code> if both <code>Geometry</code>s
    are points.
    */
    touches(g: geom$Geometry): boolean;
    ...
    */
    intersects(g: geom$Geometry): boolean;
    ...
    <li>The DE-9IM Intersection Matrix for the two geometries matches
    <ul>
    <li><code>[TT***]</code> (for P/L, P/A, and L/A situations)
    ...
    in order to make the relation symmetric.g the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>
     * @return  <code>true</code> if the two <code>Geometry</code>s
    cross.
    */
    crosses(g: geom$Geometry): boolean;
    ...
    points in the boundary of a geomtry B, <code>A.within(B) = false</code>g the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>
     * @return  <code>true</code> if this <code>Geometry</code> is
    within <code>other.</code>
     * @see  Geometry#contains
    */
    within(g: geom$Geometry): boolean;
    ...
    boundary of a geometry B, <code>B.contains(A) = false</code>g the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>
     * @return  <code>true</code> if this <code>Geometry</code>
    contains <code>g.</code>
     * @see  Geometry#within
    */
    contains(g: geom$Geometry): boolean;
    ...
    <li>The DE-9IM Intersection Matrix for the two geometries matches
    <code>[TT*T*]</code> (for two points or two surfaces) or
    <code>[1T*T*]</code> (for two curves)
    </ul>
    ...
    overlap.
    */
    overlaps(g: geom$Geometry): boolean;
    ...
    <code>[*T*FF]</code> or <code>[**TFF]</code>
    ...
    and hence should be more performant.g the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>
     * @return  <code>true</code> if this <code>Geometry</code> covers
    <code>g.</code>
     * @see  Geometry#contains
     * @see  Geometry#coveredBy
    */
    covers(g: geom$Geometry): boolean;
    ...
    <li>The DE-9IM Intersection Matrix for the two geometries matches
    <code>[TF*F*]</code> or <code>[TF*F*]</code> or
    <code>[*FTF*]</code> or <code>[*FTF*]</code>
    ...
    returns <tt>true</tt> for more cases).g the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>
     * @return  <code>true</code> if this <code>Geometry</code> is
     ...
     * @see  Geometry#covers
    */
    coveredBy(g: geom$Geometry): boolean;
    ...
    Specification</i>.other the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>intersectionPattern the pattern against which to check the
    intersection matrix for the two <code>Geometry</code>s.
     * @return  <code>true</code> if the DE-9IM intersection matrix for
    the two <code>Geometry</code>s match
    <code>intersectionPattern.</code>
     * @see  IntersectionMatrix
    */
    relate(g: geom$Geometry, intersectionPattern: string): boolean;

    /**
     * Returns the DE-9IM {@link IntersectionMatrix} for the two
     * <code>Geometry</code>s.g the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>
     * @return  an {
     * @link  IntersectionMatrix} describing the
      intersections of the interiors, boundaries and exteriors of the two
      <code>Geometry</code>s.
    */
    relate2(g: geom$Geometry): any;
    ...
    *F
    ...
    structural equality, see {@link #equalsExact(Geometry)}.g the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>
     * @return  <code>true</code> if the two <code>Geometry</code>s
    are topologically equal.
     * @see  #equalsExact(Geometry)
    */
    equalsTopo(g: geom$Geometry): boolean;
    ...
    (using {@link Geometry#norm() or {@link #normalize()} as appropriate).o the Object to compare.
    ...
    */
    ...
    This is also the result for the buffers of degenerate (zero-area) polygons.distance the width of the buffer (may be positive, negative or 0).quadrantSegments the number of line segments used to represent a
    quadrant of a circle.endCapStyle the end cap style to use.
     * @return  a polygonal geometry representing the buffer region (which
    may be empty).
     ...
     * @see  BufferOp
    */
    buffer(distance: number, quadrantSegments: number, endCapStyle: number): geom$Geometry;
    ...
    */
    ...
    element of the target with the argument.other the <code>Geometry</code> with which to compute the
    intersection.
    ...
    */
    intersection(other: geom$Geometry): geom$Geometry;
    ...
    <ul>
    <li>Unioning a set of {
     * @link  LineString}s has the effect of fully noding
    and dissolving the linework.
    <li>Unioning a set of {
     * @link  Polygon}s will always return a
    {
     ...
     * @return  a set combining the points of this <code>Geometry</code>
    ...
    */
    union(other: geom$Geometry): geom$Geometry;
    ...
    method returns the closure of the resultant <code>Geometry</code>.other the <code>Geometry</code> with which to compute the
    difference.
     * @return  the point set difference of this <code>Geometry</code>
    ...
    if either input is a non-empty GeometryCollection
    */
    difference(other: geom$Geometry): geom$Geometry;
    ...
    <code>Geometry</code>.other the <code>Geometry</code> with which to compute the
    symmetric difference.
     * @return  the point set symmetric difference of this
    ...
    if either input is a non-empty GeometryCollection
    */
    symDifference(other: geom$Geometry): geom$Geometry;
    ...
    children are not <code>Geometry</code>s, returns <code>false</code>.other the <code>Geometry</code> with which to compare this
    <code>Geometry.</code>tolerance distance at or below which two <code>Coordinate</code>s
    are considered equal.
     * @return  
    */
    equalsExact(other: geom$Geometry, tolerance: number): boolean;
    ...
    execution.g a Geometry.
     * @return  true if the input geometries are exactly equal in their
    normalized form.
    */
    equalsNorm(g: geom$Geometry): boolean;
     ...
     * @param filter the filter to apply to this <code>Geometry</code> (and its
    ...
    */
    ...
    compared, etc.other a <code>Geometry</code> with which to compare this
    <code>Geometry.</code>
     * @return  a positive number, 0, or a negative number, depending on
    ...
    */
    compareTo(o: geom$Geometry): number;
    ...
    to its subclasses.other the <code>Geometry</code> with which to compare this
    <code>Geometry</code> for equality.
     * @return  <code>true</code> if the classes of the two
    <code>Geometry</code> s are considered to be equal by the
    <code>equalsExact</code> method.
    */
    isEquivalentClass(other: geom$Geometry): boolean;

    /**
     * Throws an exception if <code>g</code>'s class is
     * <code>GeometryCollection</code> . (Its subclasses do not trigger an
    exception).g the <code>Geometry</code> to check.
     * @throws  Error
       if <code>g</code> is a <code>GeometryCollection</code> but not
       one of its subclasses
    */
    checkNotGeometryCollection(g: geom$Geometry): void;

    /**
     * 
     * @return  true if this is a GeometryCollection.
     */
    isGeometryCollection(): boolean;

    /**
     * 
     * @return  true if this is a GeometryCollection but not subclass.
     */
    ...
    return <code>true.</code>
    */
    computeEnvelopeInternal(): geom$Envelope;

    /**
     * Returns whether this <code>Geometry</code> is greater than, equal to, or
     * less than another <code>Geometry</code> having the same class.
     * @param o a <code>Geometry</code> having the same class as this
    <code>Geometry.</code>
    ...
    Specifications.
    */
    compareToSameClass(o: geom$Geometry): number;
    ...
    negative number.a a <code>Collection</code> of <code>Comparable</code>s.b a <code>Collection</code> of <code>Comparable</code>s.
    ...
    */
    ...
    /**
     * a first Coordinate to compare.b second Coordinate to compare.tolerance tolerance when comparing.
     * @return  true if equal.
     */
    equal(a: geom$Coordinate, b: geom$Coordinate, tolerance: number): boolean;
...
declare export class LineString mixins Geometry {
     ...
     * @constructor  
     */
    constructor(points: Array<geom$Coordinate>, factory?: any): this;

    /**
     * n index.
     * @return  The n'th coordinate of this
    jsts.geom.LineString.
    */
    getCoordinateN(n: number): geom$Coordinate;

    /**
     * n index.
     * @return  The n'th point of this
    jsts.geom.LineString.
    */
    getPointN(n: number): geom$Point;
    ...
    */
    ...
    jsts.geom.LineString.
    */
    getEndPoint(): geom$Point;

    /**
     * 
     * @return  true if LineString is Closed.
     */
    isClosed(): boolean;

    /**
     * 
     * @return  true if LineString is a Ring.
     */
    isRing(): boolean
}
...
declare export class Point mixins Geometry {
     ...
     * @constructor  
     */
    constructor(coordinate: geom$Coordinate, factory?: any): this;
    ...
    /**
     * 
     * @return  Reversed point is a cloned point.
     */
    reverse(): geom$Point
}
...
declare export class Polygon mixins Geometry {
     ...
     * @constructor  
     */
    constructor(shell: geom$LinearRing, holes?: Array<geom$LinearRing>, factory?: any): this;

    /**
     * Gets the exterior ring.
     * @return  The exterior ring.
     */
    getExteriorRing(): geom$LinearRing;

    /**
     * Gets the interior ring at the specified index.
     * @param  The interior ring index.
     * @returns  The interior ring at the specified index.
     */
    getInteriorRingN(n: number): geom$LinearRing;
...
declare export class GeoJSONWriter {
    ...
    */
    ...
    /**
     * Converts a <code>Geometry</code> to its GeoJSON representation.geometry a <code>Geometry</code> to process.
...
declare export class WKTReader {
    ...
    /**
     * Reads a Well-Known Text representation of a {@link Geometry}wkt a <Geometry Tagged Text> string (see the OpenGIS Simple Features
     * Specification).
     * @return  a <code>Geometry</code> read from
    <code>string.</code>
    */
...
declare module 'jsts' {
    declare module.exports: typeof jsts
}