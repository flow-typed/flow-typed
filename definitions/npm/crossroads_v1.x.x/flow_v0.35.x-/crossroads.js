/**
 * Flowtype definitions for crossroads
...
declare export interface CrossroadsJs$CrossRoadsStatic {
    NORM_AS_ARRAY: Function,
         ...
         */
        addRoute(pattern: any, handler?: Function, priority?: number): CrossroadsJs$Route,
         ...
         */
        removeRoute(route: CrossroadsJs$Route): void,
         ...
         */
        create(): CrossroadsJs$CrossRoadsStatic,
         ...
         */
        pipe(router: CrossroadsJs$CrossRoadsStatic): void,
