// @flow
/**
 * Flowtype definitions for ko-grid
...
declare interface kg$Row<EntityType>{
    selected: KnockoutObservable<boolean>,
    entity: EntityType
}

declare interface kg$RowFactory<EntityType>{
    rowCache: kg$Row<EntityType>[]
}

declare interface kg$SelectionService<EntityType>{
    setSelection(row: kg$Row<EntityType>, selected: boolean): void,
    multi: boolean,
    lastClickedRow: kg$Row<EntityType >
}

declare interface kg$Grid<EntityType>{
    configureColumnWidths(): void,
    rowFactory: kg$RowFactory<EntityType>,
    config: kg$GridOptions<EntityType>,
    $$selectionPhase: boolean,
    selectionService: kg$SelectionService<EntityType >
}

declare interface kg$Plugin<EntityType>{
    onGridInit(grid: kg$Grid<EntityType>): void
}

declare interface kg$GridOptions<EntityType>{

    /**
     * Callback for when you want to validate something after selection. 
     */
    afterSelectionChange(row: kg$Row<EntityType>): void,

    /**
     * Callback if you want to inspect something before selection,
     * return false if you want to cancel the selection. return true otherwise.
    Ifyou need to wait for an async call to proceed with selection you can
    userowItem.changeSelection(event) method after returning false initially.
    Note: when shift+ Selecting multiple items in the grid this will only get called
    once and the rowItem will be an array of items that are queued to be selected. 
    */
    beforeSelectionChange(row: kg$Row<EntityType>): boolean,
     ...
     */
    columnDefs?: kg$ColumnDef[] | KnockoutObservable<kg$ColumnDef[]>,
    ...
    */
     ...
     * pagingOptions - 
     */
    pagingOptions?: kg$PagingOptions,

    /**
     * Array of plugin functions to register in ng-grid 
     */
    plugins?: kg$Plugin<EntityType>[],
     ...
     * Ifboth showColumnMenu and showFilter are false the menu button will not display.
     */
     ...
     * Youcan also observe this variable to utilize server-side sorting (see useExternalSorting).
    Syntax is sortinfo: { fields: ['fieldName1',' fieldName2'], direction: 'ASC'/'asc' || 'desc'/'DESC'}
    */
    sortInfo?: kg$SortInfo | KnockoutObservable<kg$SortInfo>,
     ...
     * ThesortInfo object will be updated with the sorting information so you can handle sorting (see sortInfo)
     */
    useExternalSorting?: boolean
}

declare type kg$Direction = "asc" | "desc";

declare interface kg$SortInfo {

    /**
     * Which column to sort 
     */
    column: kg$SortColumn,
...
declare interface kg$SortColumn {
...
declare interface kg$ColumnDef {
...
declare interface kg$FilterOptions {
...
declare interface kg$PagingOptions {
