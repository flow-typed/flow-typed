...
declare interface PDFPromise<T>{
    ...
    then<U>(
        ...
        onReject?: (reason: string) => void): PDFPromise<U >
}
...
declare interface PDFInfo {
    PDFFormatVersion: string,
        ...
        IsXFAPresent: boolean, [key: string]: any
}
...
declare interface PDFPageProxy {
    ...
    pageNumber: number,
        ...
        /**
         * marked as future featureDestroyes resources allocated by the page.
         */
        destroy(): void
}
...
declare interface PDFJSUtilStatic {
     ...
     * @param  - the rectangle with [x1,y1,x2,y2]
...
declare interface PDFJSStatic {
    ...
    maxImageSize: number,
        ...
        */
         ...
         * @param source 
         * @param pdfDataRangeTransport Used if you want to manually server range requests for data in the PDF.  
         * @ee  viewer.js for an example of pdfDataRangeTransport's interface.
