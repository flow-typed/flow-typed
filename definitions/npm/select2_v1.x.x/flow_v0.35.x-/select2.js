/**
 * Flowtype definitions for select2
...
declare interface Select2Options {
    width?: string,
        ...
        formatSelection?: (
            object: any,
            container: JQuery,
            escapeMarkup: (markup: string) => string) => string,
        formatResult?: (
            object: any,
            container: JQuery,
            query: any,
...
declare type Select2JQueryEventObject = {
    val: any,
    added: any,
    removed: any,
    choice: {
...
declare interface JQuery {
    off(
            events?: "change",
            selector?: any,
            handler?: (eventObject: Select2JQueryEventObject) => any): JQuery,
        on(
            events: "change",
            selector?: string,
            data?: any,
        ...
        on(
            ...
            handler?: (eventObject: Select2JQueryEventObject) => any): JQuery,
        on(
            events: "select2-highlight",
            handler?: (eventObject: Select2JQueryEventObject) => any): JQuery,
        on(
            events: "select2-selecting",
            handler?: (eventObject: Select2JQueryEventObject) => any): JQuery,
        on(
            events: "select2-removing",
            handler?: (eventObject: Select2JQueryEventObject) => any): JQuery,
        on(
            events: "select2-removed",
            handler?: (eventObject: Select2JQueryEventObject) => any): JQuery,
        on(
            events: "select2-loaded",
            handler?: (eventObject: Select2JQueryEventObject) => any): JQuery,
        on(
            events: "select2-focus",
            handler?: (eventObject: Select2JQueryEventObject) => any): JQuery,
        on(
            events: "select2-blur",
            handler?: (eventObject: Select2JQueryEventObject) => any): JQuery,
