...
declare
export function Perf$start(): void

declare
export function Perf$stop(): void

declare
export function Perf$printInclusive(measurements?: ___React$Measurements[]): void

declare
export function Perf$printExclusive(measurements?: ___React$Measurements[]): void

declare
export function Perf$printWasted(measurements?: ___React$Measurements[]): void

declare
export function Perf$printOperations(measurements?: ___React$Measurements[]): void

declare
export function Perf$getLastMeasurements(): ___React$Measurements[]

declare
export function Perf$getExclusive(measurements?: ___React$Measurements[]): any

declare
export function Perf$getInclusive(measurements?: ___React$Measurements[]): any

declare
export function Perf$getWasted(measurements?: ___React$Measurements[]): any

declare
export function Perf$getOperations(measurements?: ___React$Measurements[]): any

declare
export function Perf$printDOM(measurements?: ___React$Measurements[]): voiddeclare module 'react-addons-perf' {
