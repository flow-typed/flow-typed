...
declare var npm$namespace$WebFont: {
    load: typeof WebFont$load,
}
declare export function WebFont$load(config: WebFont$Config): void

declare export interface WebFont$Config {
...
declare export interface WebFont$Google {
    families: Array<string>,
        text?: string
}

declare export interface WebFont$Typekit {
    id?: Array<string >
}

declare export interface WebFont$Custom {
    families?: Array<string>,
        urls?: Array<string>,
        testStrings?: {
...
declare export interface WebFont$Fontdeck {
    id?: string
}

declare export interface WebFont$Monotype {
    projectId?: string,
        version?: number
}
