/**
 * Flowtype definitions for mongoose-promise
...
declare module 'mongoose' {
    ...
    declare class MongoosePromise<T>mixins mpromise<T, any>{
        ...
        */
        then<TRes>(
            onFulFill: (arg: T) => void | TRes | PromiseLike<TRes>,
            onReject?: (err: any) => void | TRes | PromiseLike<TRes>): MongoosePromise<TRes>;
        then<TRes>(
            onFulfill: (...args: T[]) => void | TRes | PromiseLike<TRes>,
            onReject?: (err: any) => void | TRes | PromiseLike<TRes>): MongoosePromise<TRes>;
        ...
        ES6<TRes>(
            resolver: (
                ...
                error: (e: any) => void | TRes | PromiseLike<TRes>) => void): MongoosePromise<TRes >
    }
}