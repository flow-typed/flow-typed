...
declare module 'nw.gui' {
	...
	declare interface Shell {
		...
		declare class EventEmitter extends IEventEmitter {
		addListener(event: string, listener: Function): EventEmitter;
		on(event: string, listener: Function): EventEmitter;
		once(event: string, listener: Function): EventEmitter;
		removeListener(event: string, listener: Function): EventEmitter;
	...
	declare export class MenuItem extends EventEmitter, MenuItemConfig {
	...
	declare export class Window extends EventEmitter {
		...
		capturePage(
		callback: Function, config_object: {
		format: string,
		datatype: string
	}
	): void;
	...
	declare export class Tray extends EventEmitter, TrayOption {
