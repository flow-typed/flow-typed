...
declare module 'browser-harness' {
		declare interface HarnessEvents {
	...
	declare export interface Driver {
		...
		findElement(
		selector: string, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		findElements(
		selector: string, callback?: (err: Error, elements: ElementProxy) => void
	): ElementProxy,
		findVisible(
		selector: string, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
	...
	declare export interface ElementProxy {
		...
		val(
		value?: string, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		attr(
		name: string, value?: string, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		removeAttr(
		name: string, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		prop(
		name: string, value?: string, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		...
		hasClass(
		className: string, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		addClass(
		className: string, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		...
		trigger(
		event: string, extraParameters?: any, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		triggerHandler(
		event: string, extraParameters?: any, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		...
		height(
		value?: any, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		innerHeight(
		value?: any, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		...
		scrollLeft(
		value?: number, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		scrollTop(
		value?: number, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		...
		data(
		name: string, value?: any, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		removeData(
		name: string, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy,
		filter(
		selector: any, callback?: (err: Error, element: ElementProxy) => void
	): ElementProxy
	}
