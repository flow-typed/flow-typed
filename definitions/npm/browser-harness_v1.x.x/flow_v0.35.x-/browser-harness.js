// @flow
/**
 * Flowtype definitions for browser-harness
...
declare module 'browser-harness' {
    ...
    declare     export interface Driver {
        exec(args: {
            ...
            findElement(
                selector: string,
                callback?: (err: Error, element: ElementProxy) => void): ElementProxy,
            findElements(
                selector: string,
                callback?: (err: Error, elements: ElementProxy) => void): ElementProxy,
            findVisible(
                selector: string,
                callback?: (err: Error, element: ElementProxy) => void): ElementProxy,
            findVisibles(
    ...
    declare     export function listen(port: number, callback?: Function): void
