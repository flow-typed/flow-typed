...
declare module 'IORedis' {
    ...
    declare type Redis = {
        ...
        duplicate(): Redis,
        monitor(
            calback: (error: Error, monitor: NodeJS.EventEmitter) => void): Promise<NodeJS.EventEmitter>,
    ...
    declare type Cluster = {
        new(
            ...
            options?: IORedis.ClusterOptions): Redis,
        connect(callback: Function): Promise<any>,
        disconnect(): void,
        nodes(role: string): Redis[]
    } & & Commander

    declare interface ResCallbackT<R>{
        (err: Error, res: R): void
    }
    declare interface RedisOptions {
        port?: number,
            host?: string,
    ...
    declare interface ScanStreamOption {
        match?: string,
            count?: number
    }
