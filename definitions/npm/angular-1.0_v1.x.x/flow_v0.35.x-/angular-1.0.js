...
declare interface angular$ICompileService {
    (element: string | angularScenario$Element | JQuery, transclude?: angular$ITranscludeFunction, maxPriority?: number): ng$ITemplateLinkingFunction
}
...
declare interface angular$IHttpService {
    ...
    (config: ng$IRequestConfig): ng$IHttpPromise<T>,
         ...
         */
        get<T>(url: string, config?: angular$IRequestShortcutConfig): ng$IHttpPromise<T>,
         ...
         * @param config Optional configuration object
         */
        delete<T>(url: string, config?: angular$IRequestShortcutConfig): ng$IHttpPromise<T>,
         ...
         * @param config Optional configuration object
         */
        head<T>(url: string, config?: angular$IRequestShortcutConfig): ng$IHttpPromise<T>,
         ...
         * @param config Optional configuration object
         */
        jsonp<T>(url: string, config?: angular$IRequestShortcutConfig): ng$IHttpPromise<T>,
        ...
        post<T>(
            url: string,
            data: any,
            config?: angular$IRequestShortcutConfig): ng$IHttpPromise<T>,
...
declare interface angular$IDirectiveFactory {
    (...args: any[]): ng$IDirective | angular$IDirectiveLinkFn
}
...
declare interface ng$ITemplateLinkingFunction {
    (scope: ng$IScope, cloneAttachFn?: angular$ICloneAttachFunction): JQuery
}
...
declare type ng$IRouteProvider = {
    ...
    */
     ...
     */
    otherwise(params: ng$IRoute): ng$IRouteProvider,
