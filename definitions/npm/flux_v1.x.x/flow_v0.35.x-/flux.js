...
declare module 'flux' {
    declare module.exports: typeof Flux
}
 ...
 */
declare interface FluxUtils$RealOptions {
...
export class Container {
    ...
    */
    create<TComponent>(
        base: React.ComponentClass<TComponent>,
        options?: FluxUtils$RealOptions): React.ComponentClass<TComponent >
}
...
export class MapStore<K, V, TPayload>mixins ReduceStore<immutable.Map<K, V>, TPayload>{
    ...
    */
    getAll(keys: undefined.Indexed<K>, prev?: immutable.Map<K, V>): immutable.Map<K,
    V >
}
...
declare module 'flux/utils' {
    declare module.exports: typeof FluxUtils
}