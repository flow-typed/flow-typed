/**
 * Flowtype definitions for highland
...
declare interface HighlandStatic {
    ...
    *Promise -* Accepts an ES6 / jQuery style promise and returns a
     ...
     * @section  Streams
     * @name  _(source)
     * @param  | Promise} source - (optional) source to take values from from
     * @api  public
    */
    (): Highland$Stream<R>,
        ...
        */
         ...
         * @section  Functions
         * @param  - the number of arguments to wait for before apply fn
         * @param  - the function to curry
         * @param args ... - any number of arguments to pre-apply to the function
         * @returns  Function
         * @api  public
        */
         ...
         * @section  Functions
         * @param  - function to partial apply
        ...
        */
         ...
         * @name  flip(fn, [x, y])
         * @section  Functions
         * @param  - function to flip argument application for
        ...
        */
         ...
         * @section  Objects
         * @name  _.values(obj)
         * @param  - the object to return values from
         * @api  public
        */
         ...
         * @section  Objects
         * @name  _.keys(obj)
         * @param  - the object to return keys from
         * @api  public
         */
         ...
         * @section  Objects
         * @name  _.pairs(obj)
         * @param  - the object to return key/value pairs from
         * @api  public
        */
         ...
         * @section  Objects
         * @name  _.extend(a, b)
         * @param  - the properties to extend b with
         * @param  - the original object to extend
         * @api  public
        */
         ...
         * @section  Objects
         * @name  _.get(prop, obj)
         * @param  - the property to return
         * @param  - the object to read properties from
         * @api  public
         */
         ...
         * @param  - the object to set properties on
         * @api  public
         */
        ...
        */
         ...
         * @param  - the node-style function to wrap
         * @api  public
        */
...
declare interface Highland$Thenable<R>{
    then<U>(
        onFulfilled: (value: R) => Highland$Thenable<U>,
        onRejected: (error: any) => Highland$Thenable<U>): Highland$Thenable<U>,
    then<U>(
        onFulfilled: (value: R) => Highland$Thenable<U>,
        onRejected?: (error: any) => U): Highland$Thenable<U>,
    then<U>(
...
declare interface Highland$Nil {
    Highland_NIL: Highland$Nil
}
...
declare class StreamRedirect<R>{
    constructor(to: Highland$Stream<R>): this;
    to: Highland$Stream<R >
}
 ...
 */
declare type Highland$Stream<R>= {
    ...
    */
     ...
     * @param  } dest - the destination to write all data to
     * @api  public
    */
    pipe<U>(dest: Highland$Stream<U>): Highland$Stream<U>,
    pipe<U>(dest: NodeJS.ReadWriteStream): Highland$Stream<U>,
    ...
    */
     ...
     * @param  - the function to handle errors and values
     * @api  public
    */
    consume<U>(
        f: (
            err: Error,
            x: R,
            push: (err: Error, value?: U) => void,
            next: () => void) => void): Highland$Stream<U>,
     ...
     * @section  Streams
     * @name  Stream.pull(f)
     * @param  - the function to handle data
     * @api  public
    */
    ...
    */
     ...
     * @param  - the function to pass all errors to
     * @api  public
    */
    errors(f: (err: Error, push: (err: Error, x?: R) => void) => void): Highland$Stream<R>,
     ...
     * @param  - the function to handle an error
     * @api  public
     */
    stopOnError(f: (err: Error) => void): Highland$Stream<R>,
    ...
    */
     ...
     * @section  Streams
     * @name  Stream.apply(f)
     * @param  - the function to apply arguments to
     * @api  public
     */
     ...
     * @param  - the callback to provide the completed Array to
     * @api  public
    */
     ...
     * @api  public
    */
    map<U>(f: (x: R) => U): Highland$Stream<U>,
     ...
     * @api  public
    */
    flatMap<U>(f: (x: R) => Highland$Stream<U>): Highland$Stream<U>,
    flatMap<U>(f: (x: R) => U): Highland$Stream<U>,
     ...
     * @param  - the property to which values should be associated
     * @api  public
     */
    pluck<U>(prop: string): Highland$Stream<U>,
     ...
     * @api  public
     */
    filter(f: (x: R) => boolean): Highland$Stream<R>,
     ...
     * @param  - the truth test function which returns a Stream
     * @api  public
    */
    flatFilter(f: (x: R) => Highland$Stream<boolean>): Highland$Stream<R>,
    ...
    */
    reject(f: (x: R) => boolean): Highland$Stream<R>,
     ...
     * @api  public
     */
    find(f: (x: R) => boolean): Highland$Stream<R>,
     ...
     * @section  Streams
     * @name  Stream.group(f)
     * @param  - the function or property name on which to group,
    toString() is called on the result of a function.
     * @api  public
    */
    group(f: (x: R) => string): Highland$Stream<{
        [prop: string]: R[]
    }>,
    group(prop: string): Highland$Stream<{
        [prop: string]: R[]
    }>,
     ...
     * @param  - the properties to match against
     * @api  public
     */
    where(props: Object): Highland$Stream<R>,
     ...
     * @section  Streams
     * @name  Stream.zip(ys)
     * @param  - the other stream to combine values with
     * @api  public
     */
    zip(ys: R[]): Highland$Stream<R>,
    zip(ys: Highland$Stream<R>): Highland$Stream<R>,
     ...
     * @section  Streams
     * @name  Stream.take(n)
     * @param  - integer representing number of values to read from source
     * @api  public
     */
    take(n: number): Highland$Stream<R>,
    ...
    */
     ...
     * @api  public
    */
    flatten<U>(): Highland$Stream<U>,
    flatten(): Highland$Stream<R>,
     ...
     * @param  - the maximum number of concurrent reads/buffers
     * @api  public
    */
    parallel(n: number): Highland$Stream<R>,
     ...
     * @param  - alternate stream to use if this stream is empty
     * @api  public
     */
    otherwise(ys: Highland$Stream<R>): Highland$Stream<R>,
     ...
     * @param  - the function which reduces the values
     * @api  public
    */
    reduce<U>(memo: U, f: (memo: U, x: R) => U): Highland$Stream<U>,
     ...
     * @api  public
     */
    reduce1<U>(memo: U, f: (memo: U, x: R) => U): Highland$Stream<U>,
    ...
    */
     ...
     * @api  public
     */
    scan<U>(memo: U, x: (memo: U, x: R) => U): Highland$Stream<U>,
    ...
    */
    scan1<U>(memo: U, x: (memo: U, x: R) => U): Highland$Stream<U>,
     ...
     * @api  public
    */
    concat(ys: Highland$Stream<R>): Highland$Stream<R>,
    concat(ys: R[]): Highland$Stream<R>,
    ...
    */
    merge(ys: Highland$Stream<Highland$Stream<R >> ): Highland$Stream<R>,
     ...
     * @param  - the arguments to call the method with
     * @api  public
     */
    invoke<U>(method: string, args: any[]): Highland$Stream<U>,
     ...
     * @param  - the minimum milliseconds between each value
     * @api  public
     */
    throttle(ms: number): Highland$Stream<R>,
     ...
     * @param  - the milliseconds to wait before sending data
     * @api  public
    */
    debounce(ms: number): Highland$Stream<R>,
