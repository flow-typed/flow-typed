...
declare module 'redux-devtools-2.1.4' {
...
declare module 'redux-devtools' {
	...
	declare export function persistState(
		sessionId: any, stateDeserializer?: Function, actionDeserializer?: Function
	): Function
...
declare module 'redux-devtools/lib/react' {
	...
	declare export interface Theme {
		...
		declare export class DevTools extends React$Component<any, any> {
		
	}

	declare export class DevToolStore extends React$Component<any, any> {
		dispatch: Function
	}

	declare export class DebugPanel extends React$Component<DebugPanelProps, any> {
		
	}

	declare export class LogMonitor extends React$Component<LogMonitorProps, any> {
