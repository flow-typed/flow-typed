...
declare var EMPTY_META: {};

declare var ENV: {};

declare var EXTEND_PROTOTYPES: boolean;
...
declare function Handlebars$get(root: any, path: string, options?: {}): any

declare function Handlebars$helper(name: string, func: Function, dependentKeys?: string): void
...
declare function Handlebars$precompile(string: string): void

declare function Handlebars$registerBoundHelper(name: string, func: Function, dependentKeys?: string): void

declare class Compiler {}

declare class JavaScriptCompiler {}

declare function Handlebars$registerHelper(name: string, fn: Function, inverse?: boolean): void
...
declare function Ember$addBeforeObserver(obj: any, path: string, target: any, method: Function): any
...
declare var anyUnprocessedMixins: boolean;

declare function Ember$assert(desc: string, test: boolean): void

declare function Ember$beforeObserver(func: Function, propertyName: string): Function

declare function Ember$beforeObserversFor(obj: any, path: string): string[]
...
declare function Ember$flushPendingChains(): void
...
declare function Ember$get(root: any, path: string, options?: {}): any

declare function Ember$getMeta(obj: any, property: string): any
...
declare function Ember$meta(obj: any, writable?: boolean): {}

declare function Ember$metaPath(obj: any, path: string, writable?: boolean): any

declare function Ember$mixin(obj: any, ...args: any[]): any

declare var none: typeof deprecateFunc;

declare function Ember$normalizeTuple(target: any, path: string): any[]
...
declare function Ember$oneWay(obj: any, to: string, from: string): Ember$Binding
...
declare function Ember$removeBeforeObserver(obj: any, path: string, target: any, method: Function): any
...
declare function Ember$setMeta(obj: any, property: string, value: any): void
...
declare function Ember$tryFinally(tryable: Function, finalizer: Function, binding?: any): any
...
declare function Ember$wrap(func: Function, superFunc: Function): Functiondeclare var $: typeof undefined;
