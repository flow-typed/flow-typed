...
declare export interface Ix$Disposable {
    dispose(): void
}

declare export type Ix$Enumerator<T>= {
    moveNext(): boolean,
    getCurrent(): T
} & Ix$Disposable


declare export interface Ix$EnumeratorStatic {
    new<T>(
            moveNext: () => boolean,
            getCurrent: () => T,
...
declare var Enumerator: Ix$EnumeratorStatic;

declare export interface Ix$EnumerableFunc<T, TResult>{
    (item: T, index: number, self: Ix$Enumerable<T>): TResult
}

declare export type Ix$EnumerablePredicate<T>= {} & Ix$EnumerableFunc


declare export interface Ix$Predicate<T>{
    (item: T): boolean
}

declare export interface Ix$EqualityComparer<TFirst, TSecond>{
    (item1: TFirst, item2: TSecond): boolean
}

declare export interface Ix$Comparer<TFirst, TSecond>{
...
declare export type Ix$Grouping<TKey, T>= {
    key: TKey
} & Ix$Enumerable


declare export type Ix$OrderedEnumerable<T>= {
    thenBy<TKey>(
        keySelector: (item: T) => TKey,
        comparer?: Ix$Comparer<TKey, TKey>): Ix$OrderedEnumerable<T>,
...
declare export interface Ix$KeyValuePair<TKey, TValue>{
    key: TKey,
    value: TValue
}

declare export interface Ix$Lookup<TKey, TValue>{
...
declare var Enumerable: Ix$EnumerableStatic;
declare module 'l2o' {
