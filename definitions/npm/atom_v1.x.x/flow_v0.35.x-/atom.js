...
declare interface AtomCore$ISelection {
    onDidChangeRange(
        ...
        onDidDestroy(callback: () => {}): AtomCore$Disposable,
        getScreenRange(): TextBuffer.IRange,
        setScreenRange(
...
declare interface AtomCore$IEditor {
    deserializing: boolean,
        ...
        onDidChangeCursorPosition(callback: Function): AtomCore$Disposable,
        onDidSave(callback: (event: {
            path: string
        }) => void): AtomCore$Disposable,
...
declare interface AtomCore$IGrammar {
    bundledPackage: boolean,
        ...
        rawPatterns: [any],
        rawRepository: any,
        registration: AtomCore$Disposable,
        registry: any,
        repository: Object,
        scopeName: string,
...
declare interface AtomCore$IProject {
    path: string,
        ...
        onDidChangePaths(callback: Function): AtomCore$Disposable
}
...
declare interface AtomCore$IWorkspace {
    addBottomPanel(options: AtomCore$IWorkspacePanelOptions): AtomCore$Panel,
        ...
        observeTextEditors(callback: Function): AtomCore$Disposable,
        reopenItemSync(): any,
        ...
        onDidChangeActivePaneItem(item: any): AtomCore$Disposable
}
