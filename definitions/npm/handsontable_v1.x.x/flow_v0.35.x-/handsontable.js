/**
 * Flowtype definitions for handsontable
...
declare module 'handsontable' {
    declare export var Handsontable: {
        new(element: Element, options: ht$Options): ht$Methods
    };
}