...
declare module 'npm$namespace$ht' {
		...
		afterCopyLimit?: (
		selectedRows: number, selectedColumnds: number, copyRowsLimit: number, copyColumnsLimit: number
	) => void,
		...
		afterRenderer?: (
		TD: Element, row: number, col: number, prop: string | number, value: string, cellProperties: Object
	) => void,
		...
		afterValidate?: (
		isValid: boolean, value: any, row: number, prop: string | number, source: string
	) => void | boolean,
	...
	declare interface Methods {
		...
		alter(
		action: string, index: number, amount?: number, source?: string, keepEmptyRows?: boolean
	): void,
		clear(): void,
		colOffset(): number,
		...
		populateFromArray(
		row: number, col: number, input: any[], endRow?: number, endCol?: number, source?: string, method?: string, direction?: string, deltas?: any[]
	): any,
		...
		selectCell(
		row: number, col: number, endRow?: number, endCol?: number, scrollToCell?: boolean, changeListener?: boolean
	): boolean,
		selectCellByProp(
		row: number, prop: string, endRow?: number, endProp?: string, scrollToCell?: boolean
	): boolean,
