/**
 * Flowtype definitions for dojox.data
 ...
 * @param message 
*/
declare interface data$restListener {
    (message: any): void
}
...
declare class AndOrReadStore mixins undefined.ItemFileReadStore {
    ...
    */
     ...
     */
    close(request: undefined.Request): void;
     ...
     * @param value 
     */
    containsValue(item: undefined.Item, attribute: String, value: any): any;
    ...
    */
     ...
     * @param item 
     */
    getAttributes(item: undefined.Item): any[];
     ...
     * @param item 
     */
    getIdentity(item: undefined.Item): any;

    /**
     * See dojo/data/api/Identity.getIdentityAttributes()
     * @param item 
     */
    getIdentityAttributes(item: undefined.Item): any;

    /**
     * See dojo/data/api/Read.getLabel()
     * @param item 
     */
    getLabel(item: undefined.Item): any;

    /**
     * See dojo/data/api/Read.getLabelAttributes()
     * @param item 
     */
    getLabelAttributes(item: undefined.Item): any;
     ...
     */
    getValue(item: undefined.Item, attribute: String, defaultValue: any): any;
     ...
     * @param attribute 
     */
    getValues(item: undefined.Item, attribute: String): any;
     ...
     * @param attribute 
     */
    hasAttribute(item: undefined.Item, attribute: String): boolean;
 ...
 */
declare class AndOrWriteStore mixins undefined.ItemFileWriteStore, undefined.AndOrReadStore {
    constructor(keywordParameters: Object): this;
    ...
    */
     ...
     * @param item 
     */
    deleteItem(item: undefined.Item): boolean;
    ...
    */
     ...
     * @param value 
     */
    setValue(item: undefined.Item, attribute: String, value: any): any;
     ...
     * @param values 
     */
    setValues(item: undefined.Item, attribute: String, values: any[]): any;
     ...
     * @param attribute 
     */
    unsetAttribute(item: undefined.Item, attribute: String): any;

    /**
     * See dojo/data/api/Notification.onDelete()
     * @param deletedItem 
     */
    onDelete(deletedItem: undefined.Item): void;
     ...
     * @param parentInfo Optional
     */
    onNew(newItem: undefined.Item, parentInfo: Object): void;
...
declare class AppStore {
    ...
    /**
     * See dojo/data/api/Write.save()
     * @param keywordArgs : function    onError: function    scope: object}
     */
    save(keywordArgs: Object): void;
...
declare class AtomReadStore {
     ...
     * @param value 
     */
    containsValue(item: undefined.Item, attribute: Attr, value: any): any;
    ...
    */
    getValue(item: undefined.Item, attribute: Attr, defaultValue: any): any;
    ...
    */
     ...
     * @param attribute A attribute of the Atom Entry
    */
    getValues(item: undefined.Item, attribute: Attr): any;
    ...
    */
     ...
     */
    hasAttribute(item: undefined.Item, attribute: Attr): any;
     ...
     * @param attribute An attribute of an Atom Entry item.
     */
    hasAttribute(item: undefined.Item, attribute: String): any;
...
*/
declare class CssClassStore mixins undefined.CssRuleStore {
    constructor(keywordParameters: Object): this;
 ...
 * @param args 
 */
declare class FlickrRestStore mixins undefined.FlickrStore {
    constructor(args: Object): this;
 ...
 */
declare class JsonQueryRestStore mixins undefined.JsonRestStore, undefined.JsonQuery {
 ...
 * @param options Keyword argumentsThe schema parameterThis is a schema object for this store. This should be JSON Schema format.The service parameterThis is the service object that is used to retrieve lazy data and save resultsThe function should be directly callable with a single parameter of an object id to be loadedThe function should also have the following methods:put(id,value) - puts the value at the given idpost(id,value) - posts (appends) the value at the given iddelete(id) - deletes the value corresponding to the given idNote that it is critical that the service parses responses as JSON.If you are using dojox.rpc.Service, the easiest way to make sure thishappens is to make the responses have a content type ofapplication/json. If you are creating your own service, make sure youuse handleAs: "json" with your XHR requests.The target parameterThis is the target URL for this Service store. This may be used in placeof a service parameter to connect directly to RESTful URL withoutusing a dojox.rpc.Service object.The idAttribute parameterDefaults to 'id'. The name of the attribute that holds an objects id.This can be a preexisting id provided by the server.If an ID isn't already provided when an objectis fetched or added to the store, the autoIdentity systemwill generate an id for it and add it to the index.The syncMode parameterSetting this to true will set the store to using synchronous calls by default.Sync calls return their data immediately from the calling function, socallbacks are unnecessary
 */
declare class JsonRestStore mixins undefined.ServiceStore {
    constructor(options?: any): this;
 ...
 * @param keywordParameters : String}{data: string}{dataVar: jsonObject}
*/
 ...
 * @param keywordParameters : String, label: String}Where label is optional and configures what should be used as the return from getLabel()
*/
 ...
 * @param options Keyword argumentsThe schema parameterThis is a schema object for this store. This should be JSON Schema format.The service parameterThis is the service object that is used to retrieve lazy data and save resultsThe function should be directly callable with a single parameter of an object id to be loadedThe function should also have the following methods:put(id,value) - puts the value at the given idpost(id,value) - posts (appends) the value at the given iddelete(id) - deletes the value corresponding to the given idNote that it is critical that the service parses responses as JSON.If you are using dojox.rpc.Service, the easiest way to make sure thishappens is to make the responses have a content type ofapplication/json. If you are creating your own service, make sure youuse handleAs: "json" with your XHR requests.The target parameterThis is the target URL for this Service store. This may be used in placeof a service parameter to connect directly to RESTful URL withoutusing a dojox.rpc.Service object.The idAttribute parameterDefaults to 'id'. The name of the attribute that holds an objects id.This can be a preexisting id provided by the server.If an ID isn't already provided when an objectis fetched or added to the store, the autoIdentity systemwill generate an id for it and add it to the index.The syncMode parameterSetting this to true will set the store to using synchronous calls by default.Sync calls return their data immediately from the calling function, socallbacks are unnecessary
*/
declare class S3Store mixins undefined.JsonRestStore {
    constructor(options?: any): this;
 ...
 * @param options 
*/
declare class WikipediaStore mixins undefined.ServiceStore {
    constructor(options: any): this;
...
declare class XmlStore {
     ...
     */
    deleteItem(item: undefined.Item): any;
    ...
    */
    setValue(item: undefined.Item, attribute: Attr, value: any): any;
    ...
    */
     ...
     * @param values 
    */
    setValues(item: undefined.Item, attribute: Attr, values: any[]): any;
    ...
    */
     ...
     * @param attribute A tag name of child elements, an XML attribute name or one ofspecial names
    */
    unsetAttribute(item: undefined.Item, attribute: Attr): any;
 ...
 */
declare interface data$GoogleSearchStore {
...
declare module 'dojox/data/restListener' {
    declare var exp: undefined.restListener;
    declare module.exports: typeof exp
}
declare module 'dojox/data/css' {
    declare var exp: undefined.css;
    declare module.exports: typeof exp
}
declare module 'dojox/data/css.rules' {
    declare var exp: undefined.rules;
    declare module.exports: typeof exp
}
...
declare module 'dojox/data/GoogleSearchStore.WebSearch' {
    declare var exp: undefined.WebSearch;
    declare module.exports: typeof exp
}
declare module 'dojox/data/GoogleSearchStore.NewsSearch' {
    declare var exp: undefined.NewsSearch;
    declare module.exports: typeof exp
}
declare module 'dojox/data/AndOrReadStore' {
    declare var exp: undefined.AndOrReadStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/AppStore' {
    declare var exp: undefined.AppStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/AndOrWriteStore' {
    declare var exp: undefined.AndOrWriteStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/AtomReadStore' {
    declare var exp: undefined.AtomReadStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/ClientFilter' {
    declare var exp: undefined.ClientFilter;
    declare module.exports: typeof exp
}
declare module 'dojox/data/CouchDBRestStore' {
    declare var exp: undefined.CouchDBRestStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/CdfStore' {
    declare var exp: undefined.CdfStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/CssRuleStore' {
    declare var exp: undefined.CssRuleStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/CssClassStore' {
    declare var exp: undefined.CssClassStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/CsvStore' {
    declare var exp: undefined.CsvStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/FileStore' {
    declare var exp: undefined.FileStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/FlickrRestStore' {
    declare var exp: undefined.FlickrRestStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/GoogleFeedStore' {
    declare var exp: undefined.GoogleFeedStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/FlickrStore' {
    declare var exp: undefined.FlickrStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/HtmlStore' {
    declare var exp: undefined.HtmlStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/HtmlTableStore' {
    declare var exp: undefined.HtmlTableStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/KeyValueStore' {
    declare var exp: undefined.KeyValueStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/JsonRestStore' {
    declare var exp: undefined.JsonRestStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/JsonQueryRestStore' {
    declare var exp: undefined.JsonQueryRestStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/PersevereStore' {
    declare var exp: undefined.PersevereStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/OpenSearchStore' {
    declare var exp: undefined.OpenSearchStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/PicasaStore' {
    declare var exp: undefined.PicasaStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/OpmlStore' {
    declare var exp: undefined.OpmlStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/RailsStore' {
    declare var exp: undefined.RailsStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/QueryReadStore' {
    declare var exp: undefined.QueryReadStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/S3Store' {
    declare var exp: undefined.S3Store;
    declare module.exports: typeof exp
}
declare module 'dojox/data/SnapLogicStore' {
    declare var exp: undefined.SnapLogicStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/XmlItem' {
    declare var exp: undefined.XmlItem;
    declare module.exports: typeof exp
}
declare module 'dojox/data/ServiceStore' {
    declare var exp: undefined.ServiceStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/WikipediaStore' {
    declare var exp: undefined.WikipediaStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/XmlStore' {
    declare var exp: undefined.XmlStore;
    declare module.exports: typeof exp
}
declare module 'dojox/data/util/JsonQuery' {
    declare var exp: undefined.JsonQuery;
    declare module.exports: typeof exp
}