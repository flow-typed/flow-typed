/**
 * Flowtype definitions for nw.js
...
declare module 'NWJS_Helpers' {
     ...
     */
    declare class EventEmitter mixins NodeJS.EventEmitter {
    ...
    declare interface clip {
         ...
         * @param type (Optional) the type of the data. Support text, png, jpeg, html and rtf. By default, type is set to "text".
         * @param raw (Optional) requiring raw image data. This option is only valid if type is png or jpeg. By default, raw is set to false.
         */
        set(data: string, type?: string, raw?: boolean): void,
             ...
             * @param type (Optional) the type of the data. Support text, png, jpeg, html and rtf. By default, type is set to "text".
             * @param raw (Optional) requiring raw image data. This option is only valid if type is png or jpeg.
             * @returns  the data retrieved from the clipboard.
             */
             ...
             * @returns  List of available types of data in clipboard currenly.
             */
     ...
     */
    declare type DesktopCaptureMonitor = {
         ...
         * @param should_include_screens Whether should include screens
         * @param should_include_windows Whether should include windows
         */
         ...
         * @param listener (id?,name?,order?,type?,primary?)} The callback that handles the `added` event.
        ...
        */
        on(
            ...
            listener: (
                ...
                order?: number,
                type?: string,
                primary?: boolean) => any): this,

        /**
         * Emit when a source was removed.
         * @param event Event name
         * @param listener (order?)} The callback that handles the `remove` event.
        ...
        */
         ...
         * @param event Event name
         * @param listener (id?,new_order?,old_order?)} The callback that handles the `orderchanged` event.
        ...
        */
        on(
            event: "orderchanged",
            listener: (id?: string, new_order?: number, old_order?: number) => any): this,

        /**
         * Emit when the name of the source has changed. This can happen when a window changes title.
         * @param event Event name
         * @param listener (id?,new_order?,old_order?)} The callback that handles the `namechanged ` event.
        ...
        */
         ...
         * @param event Event name
         * @param listener (id?,new_order?,old_order?)} The callback that handles the `thumbnailchanged ` event.
        ...
        */
        on(
            ...
            listener: (id?: string, thumbnail?: string) => any): this
    } & EventEmitter
    ...
    declare interface Cookies {
         ...
         * @param callback The callback when cookie retrieved.
        ...
        */
        get(details: CookiesGetDetails, callback: (cookie?: Cookie) => void): void,
             ...
             * @param callback The callback when cookies retrieved.
            ...
            */
             ...
             * @param callback The callback when cookie has been set.
            ...
            */
            remove(
                ...
                callback: (details?: CookiesRemovedDetails) => void): void,
            ...
            onChanged: {
                 ...
                 * @param callback The callback when cookie has been changed.
    ...
    declare interface WinPolicy {
        ...
        ignore(): void,
             ...
             * @param m The object is in the same format as the Window subfields in manifest format.
             */
    ...
    declare type win = {
         ...
         * @param x Offset to the left of the screen
         * @param y Offset to the top of the screen
         */
         ...
         * @param width The offset width of the window
         * @param height The offset height of the window
         */
         ...
         * @param is_show (Optional) Specify whether the window should be shown or hidden. It's set to true by default.
         */
         ...
         * @param force (Optional) Specify whether to close the window forcely and bypass close event.
         */
         ...
         * @param iframe (Optional) the id or the element of the <iframe> to be jailed on. By default, the DevTools is shown for entire window.
         * @param callback callback with the native window of the DevTools window.
        ...
        */
        showDevTools(
            ...
            callback?: (dev_win?: nw$Window) => void): void,
        ...
        */
         ...
         * @param options Specify whether to close the window forcely and bypass close event.
         */
         ...
         * @param top Whether the window should always be on top
         */
         ...
         * @param visible Whether the window should be visible on all workspaces
         */
         ...
         * @param position The position of the window. There are three valid positions: null or center or mouse
         */
        setPosition(position: string): void,

        /**
         * Control whether to show window in taskbar or dock.
         * @param show Whether show in task bar
         */
        setShowInTaskbar(show: boolean): void,

        /**
         * Request the user’s attension by making the window flashes in the task bar.
         * @param attension If a Boolean, it indicates to request or cancel user’s attension. If an Integer, it indicates the number of times the window flashes.
         */
        requestAttention(attension: boolean | number): void,

        /**
         * Captures the visible area of the window.
         * @param callback The callback when finished capturing the window
        - (optional) arg {base64string|Buffer} Captured page data.
         * @param config (Optional) Conig how captured page returned.
        */
        capturePage(
            callback: (arg: string | Object) => void,
            config?: string | CapturePageConfig): void,

        /**
         * Show window progress bar.
         * @param progress valid values within [0, 1]. Setting to negative value (<0) removes the progress bar.
         */
         ...
         * @param frame The frame to execute in. If iframe is null, it assumes in current window / frame.
         * @param script The source code of the script to be executed
         */
         ...
         * @param frame The frame to execute in. If iframe is null, it assumes in current window / frame.
         * @param path the path of the snapshot file generated by nwjc
         */
         ...
         * @param event Event name
         * @param listener The callback that handles the `close` event.
        ...
        */
         ...
         * @param event Event name
         * @param listener The callback that handles the `closed` event.
         */
         ...
         * @param event Event name
         * @param listener The callback that handles the `loading` event.
         */
         ...
         * @param event Event name
         * @param listener The callback that handles the `loaded` event.
         */
        ...
        */
         ...
         * @param event Event name
         * @param listener The callback that handles the `focus` event.
         */
         ...
         * @param event Event name
         * @param listener The callback that handles the `blur` event.
         */
         ...
         * @param event Event name
         * @param listener The callback that handles the `minimize` event.
         */
         ...
         * @param event Event name
         * @param listener The callback that handles the `restore` event.
         */
         ...
         * @param event Event name
         * @param listener The callback that handles the `maximize` event.
         */
         ...
         * @param event Event name
         * @param listener The callback that handles the `move` event.
        ...
        */
         ...
         * @param event Event name
         * @param listener The callback that handles the `resize` event.
        ...
        */
         ...
         * @param event Event name
         * @param listener The callback that handles the `enter-fullscreen` event.
         */
         ...
         * @param event Event name
         * @param listener The callback that handles the `zoom` event.
        ...
        */
         ...
         * @param event Event name
         * @param listener The callback that handles the `devtools-closed` event.
         */
         ...
         * @param event Event name
         * @param listener The callback that handles the `new-win-policy` event.
        ...
        */
        on(
            ...
            listener: (frame?: HTMLIFrameElement | any, url?: string, policy?: WinPolicy) => any): this,

        /**
         * Emitted when navigating to another page.
         * @param event Event name
         * @param listener The callback that handles the `navigation` event.
        - (optional) frame {HTMLIFrameElement} Is the object of the child iframe where the request is from, or null if it’s from the top window.
        - (optional) url {string} Is the address of the requested link
        - (optional) policy {Object} Is an object contain window policy.
        */
        on(
            ...
            listener: (
                ...
                url?: string,
                policy?: WinNavigationPolicy) => any): this
    } & EventEmitter
...
export interface nw$App {
    ...
    argv: string[],
         ...
         * @param url the URL to query for proxy
         * @returns  Proxy config that is in the same format used in PAC (e.g. "DIRECT", "PROXY localhost:8080").
         */
        getProxyForURL(url: string): string,

        /**
         * Set the proxy config which the web engine will be used to request network resources.
         * @param config Proxy rules
         */
         ...
         * @param sourceOrigin The source origin. e.g. http://github.com/
         * @param destinationProtocol The destination protocol where the sourceOrigin can access to. e.g. app
         * @param destinationHost The destination host where the sourceOrigin can access to. e.g. myapp
         * @param allowDestinationSubdomains If set to true, the sourceOrigin is allowed to access subdomains of
         */
         ...
         * @param shortcut the Shortcut object to register.
         */
         ...
         * @param event Event name
         * @param listener (args?)} The callback that handles the `open` event.
        ...
        */
         ...
         * @param event Event name
         * @param listener The callback that handles the `reopen` event.
         */
...
declare class Menu {
     ...
     * @param option (Optional) Option to customize returned menu object.
     */
     ...
     * @param item the item to be appended to the tail of the menu
     */
    append(item: nw$MenuItem): void;

    /**
     * Insert the `item` at `i`th position of the menu. The index is started from 0.
     * @param item the item to be inserted into the menu
     * @param i the index in the menu list to insert the the item
     */
     ...
     * @param i the index of the item to be removed from the menu
     */
     ...
     * @param options (Optional) Options to modify default `edit` and `window` MenuItems in Mac
     */
 ...
 */
declare class MenuItem mixins NWJS_Helpers.EventEmitter {

    /**
     * Create a new MenuItem.
     * @param option Customize how MenuItem render and behave.
     */
     ...
     * @param event Event name
     * @param listener The callback that handles the `click` event.
     */
...
declare type nw$Screen = {
    ...
    /**
     * 
     * @param sources Array of source types.
     * @param callback callback function with chosed streamId.
    ...
    */
     ...
     * @param event Event name
     * @param listener (screen?)} The callback that handles the `displayBoundsChanged` event.
    ...
    */
     ...
     * @param event Event name
     * @param listener (screen?)} The callback that handles the `displayAdded` event.
    - (optional) screen {screen} screen object
    */
     ...
     * @param event Event name
     * @param listener (screen?)} The callback that handles the `displayRemoved` event.
    - (optional) screen {screen} screen object
    */
...
declare interface nw$Shell {
     ...
     * @param uri A URL to open in system default manner.
     */
...
export class Shortcut mixins NWJS_Helpers.EventEmitter {
    ...
    /**
     * Create new Shortcut.
     * @param option Shortcut option is an object contains initial settings for the Shortcut.
     */
     ...
     * Get or set the active callback of a Shortcut. It will be called when user presses the shortcut.
     * @param event Event name
     * @param listener The callback that handles the `active` event.
     */
     ...
     * Get or set the failed callback of a Shortcut. It will be called when application passes an invalid key, or failed to register the key.
     * @param event Event name
     * @param listener (msg?)} The callback that handles the `failed` event.
...
export class Tray mixins NWJS_Helpers.EventEmitter {
    ...
    /**
     * Create a new Tray.
     * @param option Contains initial settings for the Tray.
     */
...
declare type nw$Window = {
     ...
     * @param event Window} (Optional) Is the DOM window
     */
     ...
     * @param option (Optional) New window open options like window subfields in manifest format plus some more options
     * @param callback (Optional) Callback when with the opened native Window object
...
declare module 'nw.gui' {
    ...
    declare export class Shortcut mixins nw$Shortcut {}
    declare export class Tray mixins nw$Tray {}
