// @flow
/**
 * Flowtype definitions for mongodb-1.4.9
...
declare module 'mongodb' {
    ...
    declare     export class Db {
        ...
        collection(
            collectionName: string,
            callback?: (err: Error, collection: Collection) => void): Collection;
        collection(
            collectionName: string,
        ...
        createCollection(
            collectionName: string,
            callback?: (err: Error, result: Collection) => void): void;
        createCollection(
            collectionName: string,
    ...
    declare     export interface Collection {
        new(
            ...
            collectionName: string,
            pkFactory?: Object,
            options?: CollectionCreateOptions): Collection,
        ...
        insert(query: any, callback?: (err: Error, result: any) => void): void,
            ...
            */
            ...
            find(
                selector: Object,
                fields: any,
                callback?: (err: Error, result: Cursor) => void): Cursor,
            find(
                selector: Object,
            ...
            findOne(
                selector: Object,
                fields: any,
                callback?: (err: Error, result: any) => void): Cursor,
            findOne(
                selector: Object,
                options: CollectionFindOptions,
                callback?: (err: Error, result: any) => void): Cursor,
            ...
            createIndex(
                fieldOrSpec: any,
                options: IndexOptions,
                callback?: (err: Error, indexName: string) => void): void,
            ...
            stats(
                ...
                callback?: (err: Error, results: CollStats) => void): void,
            hint: any
    }
