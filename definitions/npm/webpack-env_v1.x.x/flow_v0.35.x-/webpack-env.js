// @flow
/**
 * Flowtype definitions for webpack-env
...
declare interface ___WebpackModuleApi$RequireContext {
    keys(): string[],
        (id: string): T,
        resolve(id: string): string
}

declare interface ___WebpackModuleApi$RequireFunction {
    ...
    */
        ...
        context: (
            path: string,
            deep?: boolean,
            filter?: RegExp) => ___WebpackModuleApi$RequireContext,
...
declare interface ___WebpackModuleApi$Module {
    exports: any,
        ...
        parent: any,
        children: any[],
        hot: ___WebpackModuleApi$Hot
}

declare type ___WebpackModuleApi$ModuleId = string | number;

declare interface ___WebpackModuleApi$Hot {
    ...
    accept(
            dependencies: string[],
            callback: (updatedDependencies: ___WebpackModuleApi$ModuleId[]) => void): void,
        ...
        */
        check(
            autoApply: boolean,
            callback: (err: Error, outdatedModules: ___WebpackModuleApi$ModuleId[]) => void): void,
        ...
        */
         ...
         */
        apply(
            options: ___WebpackModuleApi$AcceptOptions,
            callback: (err: Error, outdatedModules: ___WebpackModuleApi$ModuleId[]) => void): void,
...
declare interface ___WebpackModuleApi$AcceptOptions {
...
declare var require: ___WebpackModuleApi$RequireFunction;
declare var ___resourceQuery: string;
declare var ___webpack_public_path__: string;
declare var ___webpack_require__: any;
declare var ___webpack_chunk_load__: (chunkId: any, callback: (require: (id: string) => any) => void) => void;
declare var ___webpack_modules__: any[];
declare var ___webpack_hash__: any;
declare var ___non_webpack_require__: any;
declare var DEBUG: boolean;
declare var module: ___WebpackModuleApi$Module;