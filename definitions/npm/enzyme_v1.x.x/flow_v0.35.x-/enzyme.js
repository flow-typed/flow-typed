/**
 * Flowtype definitions for enzyme
...
declare module 'enzyme' {
    ...
    */
    ...
    declare interface CommonWrapper<P, S>{
         ...
         */
        find<P2>(component: ComponentClass<P2>): CommonWrapper<P2,
        any>,
        find<P2>(statelessComponent: StatelessComponent<P2>): CommonWrapper<P2,
        {}>,
        find(props: EnzymePropSelector): CommonWrapper<any,
        any>,
        find(selector: string): CommonWrapper<HTMLAttributes,
        any>,
         ...
         */
        findWhere(
            predicate: (wrapper: CommonWrapper<any, any>) => boolean): CommonWrapper<any,
        any>,
         ...
         * @param selector The selector to match.
         */
        filter<P2>(component: ComponentClass<P2>): CommonWrapper<P2,
        any>,
        filter<P2>(statelessComponent: StatelessComponent<P2>): CommonWrapper<P2,
        {}>,
        filter(props: EnzymePropSelector): CommonWrapper<any,
        any>,
        filter(selector: string): CommonWrapper<HTMLAttributes,
        any>,
         ...
         * @param selector 
         */
        children<P2>(component: ComponentClass<P2>): CommonWrapper<P2,
        any>,
        children<P2>(statelessComponent: StatelessComponent<P2>): CommonWrapper<P2,
        {}>,
        children(props: EnzymePropSelector): CommonWrapper<any,
        any>,
        children(selector: string): CommonWrapper<HTMLAttributes,
        any>,
        children(): CommonWrapper<any,
        any>,
         ...
         * @param index 
         */
        childAt(index: number): CommonWrapper<any,
        any>,
        childAt<P2,
        S2>(index: number): CommonWrapper<P2,
        S2>,
         ...
         * @param selector 
        */
        parents<P2>(component: ComponentClass<P2>): CommonWrapper<P2,
        any>,
        parents<P2>(statelessComponent: StatelessComponent<P2>): CommonWrapper<P2,
        {}>,
        parents(props: EnzymePropSelector): CommonWrapper<any,
        any>,
        parents(selector: string): CommonWrapper<HTMLAttributes,
        any>,
        parents(): CommonWrapper<any,
        any>,

        /**
         * Returns a wrapper with the direct parent of the node in the current wrapper.
         */
        parent(): CommonWrapper<any,
        any>,
         ...
         * @param selector 
        */
        closest<P2>(component: ComponentClass<P2>): CommonWrapper<P2,
        any>,
        closest<P2>(statelessComponent: StatelessComponent<P2>): CommonWrapper<P2,
        {}>,
        closest(props: EnzymePropSelector): CommonWrapper<any,
        any>,
        closest(selector: string): CommonWrapper<HTMLAttributes,
        any>,
    ...
    declare export type ShallowWrapper<P, S>= {
        shallow(): ShallowWrapper<P,
        S>,
        render(): CheerioWrapper<P,
        S>,
        unmount(): ShallowWrapper<any,
        any>,
         ...
         * @param selector The selector to match.
         */
        filter<P2>(component: ComponentClass<P2>): ShallowWrapper<P2,
        any>,
        filter<P2>(statelessComponent: StatelessComponent<P2>): ShallowWrapper<P2,
        {}>,
        filter(props: EnzymePropSelector): ShallowWrapper<any,
        any>,
        filter(selector: string): ShallowWrapper<HTMLAttributes,
        any>,
         ...
         */
        findWhere(
            predicate: (wrapper: CommonWrapper<any, any>) => boolean): ShallowWrapper<any,
        any>,
         ...
         * @param selector 
         */
        children<P2>(component: ComponentClass<P2>): ShallowWrapper<P2,
        any>,
        children<P2>(statelessComponent: StatelessComponent<P2>): ShallowWrapper<P2,
        {}>,
        children(props: EnzymePropSelector): ShallowWrapper<any,
        any>,
        children(selector: string): ShallowWrapper<HTMLAttributes,
        any>,
        children(): ShallowWrapper<any,
        any>,
         ...
         * @param index 
         */
        childAt(index: number): ShallowWrapper<any,
        any>,
        childAt<P2,
        S2>(index: number): ShallowWrapper<P2,
        S2>,
         ...
         */
        dive<P2,
        S2>(options?: ShallowRendererProps): ShallowWrapper<P2,
        S2>,
         ...
         * @param selector 
        */
        parents<P2>(component: ComponentClass<P2>): ShallowWrapper<P2,
        any>,
        parents<P2>(statelessComponent: StatelessComponent<P2>): ShallowWrapper<P2,
        {}>,
        parents(props: EnzymePropSelector): ShallowWrapper<any,
        any>,
        parents(selector: string): ShallowWrapper<HTMLAttributes,
        any>,
        parents(): ShallowWrapper<any,
        any>,
         ...
         * @param selector 
        */
        closest<P2>(component: ComponentClass<P2>): ShallowWrapper<P2,
        any>,
        closest<P2>(statelessComponent: StatelessComponent<P2>): ShallowWrapper<P2,
        {}>,
        closest(props: EnzymePropSelector): ShallowWrapper<any,
        any>,
        closest(selector: string): ShallowWrapper<HTMLAttributes,
        any>,

        /**
         * Returns a wrapper with the direct parent of the node in the current wrapper.
         */
        parent(): ShallowWrapper<any,
        any>,
    ...
    declare export type ReactWrapper<P, S>= {
        unmount(): ReactWrapper<any,
        any>,
        mount(): ReactWrapper<any,
        any>,
        render(): CheerioWrapper<P,
        S>,
        ...
        NOTE: can only be called on a wrapper instance that is also the root instance.
        */
        ref(refName: string): ReactWrapper<any,
        any>,
        ref<P2,
        S2>(refName: string): ReactWrapper<P2,
        S2>,
        ...
        */
         ...
         * @param selector The selector to match.
         */
        find<P2>(component: ComponentClass<P2>): ReactWrapper<P2,
        any>,
        find<P2>(statelessComponent: (props: P2) => JSX.Element): ReactWrapper<P2,
        {}>,
        find(props: EnzymePropSelector): ReactWrapper<any,
        any>,
        find(selector: string): ReactWrapper<HTMLAttributes,
        any>,
         ...
         */
        findWhere(
            predicate: (wrapper: CommonWrapper<any, any>) => boolean): ReactWrapper<any,
        any>,
         ...
         * @param selector The selector to match.
         */
        filter<P2>(component: ComponentClass<P2>): ReactWrapper<P2,
        any>,
        filter<P2>(statelessComponent: StatelessComponent<P2>): ReactWrapper<P2,
        {}>,
        filter(props: EnzymePropSelector): ReactWrapper<any,
        any>,
        filter(selector: string): ReactWrapper<HTMLAttributes,
        any>,
         ...
         * @param selector 
         */
        children<P2>(component: ComponentClass<P2>): ReactWrapper<P2,
        any>,
        children<P2>(statelessComponent: StatelessComponent<P2>): ReactWrapper<P2,
        {}>,
        children(props: EnzymePropSelector): ReactWrapper<any,
        any>,
        children(selector: string): ReactWrapper<HTMLAttributes,
        any>,
        children(): ReactWrapper<any,
        any>,
         ...
         * @param index 
         */
        childAt(index: number): ReactWrapper<any,
        any>,
        childAt<P2,
        S2>(index: number): ReactWrapper<P2,
        S2>,
         ...
         * @param selector 
        */
        parents<P2>(component: ComponentClass<P2>): ReactWrapper<P2,
        any>,
        parents<P2>(statelessComponent: StatelessComponent<P2>): ReactWrapper<P2,
        {}>,
        parents(props: EnzymePropSelector): ReactWrapper<any,
        any>,
        parents(selector: string): ReactWrapper<HTMLAttributes,
        any>,
        parents(): ReactWrapper<any,
        any>,
         ...
         * @param selector 
        */
        closest<P2>(component: ComponentClass<P2>): ReactWrapper<P2,
        any>,
        closest<P2>(statelessComponent: StatelessComponent<P2>): ReactWrapper<P2,
        {}>,
        closest(props: EnzymePropSelector): ReactWrapper<any,
        any>,
        closest(selector: string): ReactWrapper<HTMLAttributes,
        any>,

        /**
         * Returns a wrapper with the direct parent of the node in the current wrapper.
         */
        parent(): ReactWrapper<any,
        any>,
    ...
    declare export type CheerioWrapper<P, S>= {} & CommonWrapper
    ...
    declare export function shallow<P, S>(
            node: ReactElement<P>,
            options?: ShallowRendererProps): ShallowWrapper<P, S >
