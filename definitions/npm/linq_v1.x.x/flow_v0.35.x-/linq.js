import type { EnumerableStatic } from 'npm$namespace$linq'

declare module 'linq' {
					
}

declare module 'npm$namespace$linq' {
		declare interface EnumerableStatic {
		...
		From(obj: NodeList): Enumerable<Node>,
		From(obj: Object): Enumerable<KeyValuePair<string, any>>,
	...
	declare interface Enumerable<T> {
		CascadeBreadthFirst(
		func: ($: T) => any[], resultSelector: (v: any, i: number) => any
	): Enumerable<any>,
		...
		Scan(
		seed: any, func: (a: any, b: any) => any, resultSelector?: ($: T) => any
	): Enumerable<any>,
		...
		SelectMany<TResult>(
		collectionSelector: ($: T, i: number) => TResult[]
	): Enumerable<TResult>,
		SelectMany<TResult>(
		collectionSelector: ($: T, i: number) => Enumerable<TResult>
	): Enumerable<TResult>,
		SelectMany<TCollectionItem, TResult>(
		collectionSelector: ($: T, i: number) => TCollectionItem[], resultSelector: ($: T, item: TCollectionItem) => TResult
	): Enumerable<TResult>,
		SelectMany<TCollectionItem, TResult>(
		collectionSelector: ($: T, i: number) => Enumerable<TCollectionItem>, resultSelector: ($: T, item: TCollectionItem) => TResult
	): Enumerable<TResult>,
		...
		Zip(
		second: Enumerable<any>, selector: (v1: any, v2: any, i: number) => any
	): Enumerable<any>,
		Zip(second: Enumerable<any>, selector: string): Enumerable<any>,
		Join(
		inner: any[], outerKeySelector: (v1: any) => any, innerKeySelector: (v1: any) => any, resultSelector: (v1: any, v2: any) => any, compareSelector?: (v: any) => any
	): Enumerable<any>,
		Join(
		inner: any[], outerKeySelector: string, innerKeySelector: string, resultSelector: string, compareSelector?: string
	): Enumerable<any>,
		Join(
		inner: Enumerable<any>, outerKeySelector: (v1: any) => any, innerKeySelector: (v1: any) => any, resultSelector: (v1: any, v2: any) => any, compareSelector?: (v: any) => any
	): Enumerable<any>,
		Join(
		inner: Enumerable<any>, outerKeySelector: string, innerKeySelector: string, resultSelector: string, compareSelector?: string
	): Enumerable<any>,
		GroupJoin(
		inner: any[], outerKeySelector: (v1: any) => any, innerKeySelector: (v1: any) => any, resultSelector: (v1: any, v2: Enumerable<any>) => any, compareSelector?: (v: any) => any
	): Enumerable<any>,
		GroupJoin(
		inner: any[], outerKeySelector: string, innerKeySelector: string, resultSelector: string, compareSelector?: string
	): Enumerable<any>,
		GroupJoin(
		inner: Enumerable<any>, outerKeySelector: (v1: any) => any, innerKeySelector: (v1: any) => any, resultSelector: (v1: any, v2: Enumerable<any>) => any, compareSelector?: (v: any) => any
	): Enumerable<any>,
		GroupJoin(
		inner: Enumerable<any>, outerKeySelector: string, innerKeySelector: string, resultSelector: string, compareSelector?: string
	): Enumerable<any>,
		...
		GroupBy(
		keySelector: ($: T) => any, elementSelector?: ($: T) => any, resultSelector?: (key: any, e: any) => any, compareSelector?: ($: T) => any
	): Enumerable<any>,
		GroupBy(
		keySelector: string, elementSelector?: string, resultSelector?: string, compareSelector?: string
	): Enumerable<any>,
		PartitionBy(
		keySelector: ($: T) => any, elementSelector?: ($: T) => any, resultSelector?: (key: any, e: any) => any, compareSelector?: ($: T) => any
	): Enumerable<any>,
		...
		keySelector: ($: T) => TKey, elementSelector?: ($: T) => TValue, compareSelector?: (key: TKey) => any
	): Lookup<TKey, TValue>,
		ToLookup(
		keySelector: string, elementSelector?: string, compareSelector?: string
	): Lookup<any, any>,
	...
	declare interface OrderedEnumerable<T> {
	...
	declare interface Grouping<TKey, T> {
		Key(): TKey
	}

	declare interface Lookup<TKey, TValue> {
		Count(): number,
