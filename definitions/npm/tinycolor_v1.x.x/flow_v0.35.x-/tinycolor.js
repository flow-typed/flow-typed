/**
 * Flowtype definitions for tinycolor
...
declare interface tinycolor {
    ...
    fromRatio(ratio: any): tinycolorInstance,
        ...
        readability(
            ...
            secondColor: tinycolorInstance): Readable$Readable,
        ...
        mostReadable(
            ...
            colorsToCompare: tinycolorInstance[]): tinycolorInstance,
        mix(
            color1: tinycolorInstance,
            color2: tinycolorInstance,
            amount?: number): tinycolorInstance,
...
declare interface Readable$Readable {
    brightness: number,
        color: number
}
declare interface ColorFormats$RGB {
    r: number,
        g: number,
        b: number
}

declare type ColorFormats$RGBA = {
    a: number
} & ColorFormats$RGB


declare interface ColorFormats$HSL {
    h: number,
        s: number,
        l: number
}

declare type ColorFormats$HSLA = {
    a: number
} & ColorFormats$HSL


declare interface ColorFormats$HSV {
    h: number,
        s: number,
        v: number
}

declare type ColorFormats$HSVA = {
    a: number
} & ColorFormats$HSV
declare module 'tinycolor2' {
    declare module.exports: typeof tinycolor
}