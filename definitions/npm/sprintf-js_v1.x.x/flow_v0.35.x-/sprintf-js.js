...
var npm$namespace$sprintf_js: {
    ...
    */
declare
export function sprintf_js$sprintf(fmt: string, ...args: any[]): string
...
*/
declare
export function sprintf_js$vsprintf(fmt: string, args: any[]): stringdeclare module 'sprintf-js' {
    declare module.exports: typeof sprintf_js
}
declare
var sprintf: typeof undefined;
declare
var vsprintf: typeof undefined;