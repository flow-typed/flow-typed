...
declare
var npm$namespace$___Combinatorics: {
 ...
 */
declare
function ___Combinatorics$P(m: number, n: number): number
 ...
 */
declare
function ___Combinatorics$C(m: number, n: number): number
 ...
 */
declare
function ___Combinatorics$factorial(n: number): number
 ...
 */
declare
function ___Combinatorics$factoradic(n: number): number[]
 ...
 */
declare
function ___Combinatorics$power<T>(a: T[]): ___Combinatorics$IPredictableGenerator<T[] >
     ...
     */
    declare
function ___Combinatorics$combination<T>(a: T[], n?: number): ___Combinatorics$IGenerator<T[] >
     ...
     */
    declare
function ___Combinatorics$permutation<T>(a: T[], n?: number): ___Combinatorics$IGenerator<T[] >
     ...
     */
    declare
function ___Combinatorics$permutationCombination<T>(a: T[]): ___Combinatorics$IGenerator<T[] >
    ...
    */
    declare
function ___Combinatorics$baseN<T>(a: T[], n?: number): ___Combinatorics$IPredictableGenerator<T[] >
     ...
     */
    declare
function ___Combinatorics$cartesianProduct<T1>(a1: T1[]): ___Combinatorics$ICartesianProductGenerator<[T1] >
