...
declare export function Q$when(): Q$Promise<void >
    ...
    declare export function Q$fcall<T>(method: (...args: any[]) => T, ...args: any[]): Q$Promise<T >

    declare export function Q$send<T>(obj: any, functionName: string, ...args: any[]): Q$Promise<T >

    declare export function Q$invoke<T>(obj: any, functionName: string, ...args: any[]): Q$Promise<T >

    declare export function Q$mcall<T>(obj: any, functionName: string, ...args: any[]): Q$Promise<T >

    declare export function Q$denodeify<T>(nodeFunction: Function, ...args: any[]): (...args: any[]) => Q$Promise<T >
    ...
    declare export function Q$nfbind<T>(nodeFunction: Function, ...args: any[]): (...args: any[]) => Q$Promise<T >

    declare export function Q$nfcall<T>(nodeFunction: Function, ...args: any[]): Q$Promise<T >

    declare export function Q$nfapply<T>(nodeFunction: Function, args: any[]): Q$Promise<T >

    declare export function Q$ninvoke<T>(nodeModule: any, functionName: string, ...args: any[]): Q$Promise<T >

    declare export function Q$npost<T>(nodeModule: any, functionName: string, args: any[]): Q$Promise<T >

    declare export function Q$nsend<T>(nodeModule: any, functionName: string, ...args: any[]): Q$Promise<T >

    declare export function Q$nmcall<T>(nodeModule: any, functionName: string, ...args: any[]): Q$Promise<T >
     ...
     */
    declare export function Q$race<T>(promises: Q$IWhenable<T>[]): Q$Promise<T >


    /**
     * Returns a promise that is fulfilled with an array of promise state snapshots, but only after all the original promises have settled, i.e. become either fulfilled or rejected.
     */
    declare export function Q$allSettled<T>(promises: Q$IWhenable<Q$IWhenable<T>[]>): Q$Promise<Q$PromiseState<T>[] >

    declare export function Q$allResolved<T>(promises: Q$IWhenable<Q$IWhenable<T>[]>): Q$Promise<Q$Promise<T>[] >
     ...
     */
    declare export function Q$timeout<T>(promise: Q$Promise<T>, ms: number, message?: string): Q$Promise<T >


    /**
     * Returns a promise that will have the same result as promise, but will only be fulfilled or rejected after at least ms milliseconds have passed.
     */
    declare export function Q$delay<T>(promise: Q$Promise<T>, ms: number): Q$Promise<T >
 ...
 * Returns whether a given promise is in the pending state. When the static version is used on non-promises, the result is always false.
 */
declare export function Q$isPending(promise: Q$Promise<any>): boolean
...
declare export function Q$defer<T>(): Q$Deferred<T >
    ...
    */
    declare export function Q$promised<T>(callback: (...args: any[]) => T): (...args: any[]) => Q$Promise<T >
 ...
 */
declare export function Q$async<T>(generatorFunction: any): (...args: any[]) => Q$Promise<T >

    declare export function Q$nextTick(callback: Function): void

declare export var onerror: (reason: any) => void;

declare export var longStackSupport: boolean;
...
declare export function Q$resolve<T>(object: Q$IWhenable<T>): Q$Promise<T >
     ...
     */
    declare export function Q$noConflict(): typeof Qdeclare module 'q' {
