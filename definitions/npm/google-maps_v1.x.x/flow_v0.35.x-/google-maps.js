...
declare export var KEY: string;

declare export var CLIENT: string;

declare export var VERSION: string;

declare export var SENSOR: boolean;

declare export var LIBRARIES: Array<string>;
...
declare export function GoogleMapsLoader$isLoaded(): booleandeclare module 'google-maps' {
