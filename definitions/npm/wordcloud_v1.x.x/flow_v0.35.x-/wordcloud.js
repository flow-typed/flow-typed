/**
 * Flowtype definitions for wordcloud
...
declare interface WordCloud$Options {
     ...
     * e.g. [['foo', 12] , ['bar', 6]].
     */
    list?: Array<WordCloud$ListEntry>| any[],
        ...
        */
        ...
        canvas word clouds.
        */
        click?: WordCloud$EventCallback
}

declare interface WordCloud$Dimension {
    x: number,
        y: number,
        w: number,
        h: number
...
declare type WordCloud$ListEntry = [string, number];

declare type WordCloud$EventCallback = (
    item: WordCloud$ListEntry,
    dimension: WordCloud$Dimension,
