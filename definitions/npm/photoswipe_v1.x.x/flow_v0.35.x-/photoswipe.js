/**
 * Flowtype definitions for photoswipe
 ...
 */
declare interface PhotoSwipe$Item {
 ...
 */
declare interface PhotoSwipe$Options {
...
declare interface PhotoSwipe$UIFramework {
    [name: string]: any
}
...
*/
declare interface PhotoSwipe$UI<T>{
...
declare class PhotoSwipe<T>{
        ...
        (4) Options.
        */
        constructor(pswpElement: HTMLElement, uiConstructor: ((pswp: PhotoSwipe<T>, framework: PhotoSwipe$UIFramework) => PhotoSwipe$UI<T>) | boolean, items: PhotoSwipe$Item[], options: T): this;
        ...
        */
        ...
        /**
         * Update gallery size`force` If you set it to `true`, size of the gallery will be updated even if viewport size hasn't changed.
         */
        ...
        /**
         * Zoom in/out the current slide to a specified zoom level, optionally with animation.`destZoomLevel` Destination scale number. Set to 1 for unzoomed.
         *                                    Use `pswp.currItem.fitRatio - image` to zoom the image to perfectly fit into the viewport.`centerPoint`   The center of the zoom, relative to viewport.`speed`        Animation duration in milliseconds. Can be 0.`easingFn`      Easing function (optional). Set to false to use default easing.
                                           This method is passed in the percentage that the animation is finished (from 0 to 1) and should return an eased value (which should be 0 at the start and 1 at the end).`updateFn`      Function will be called on each update frame (optional).
        ...
        */
        ...
        /**
         * Apply zoom and pan to the current slide`zoomLevel``panX``panY`
         * 
        ...
        */
        ...
        listen(
            ...
            callback: (index: number, item: PhotoSwipe$Item) => void): void;
        ...
        */
        listen(
            ...
            callback: (item: PhotoSwipe$Item) => void): void;
        ...
        listen(
            ...
            callback: (e: MouseEvent, isDown: boolean, preventObj: {
                prevent: boolean
            }) => void): void;
     ...
     */
declare class PhotoSwipeUI_Default mixins PhotoSwipe$UI<PhotoSwipeUI_Default$Options>{
     ...
     * Options for the base PhotoSwipe class. Derived from http://photoswipe.com/documentation/options.html
     */
declare interface PhotoSwipeUI_Default$Options {
...
declare interface PhotoSwipeUI_Default$ShareButtonData {
 ...
 * A specific slide in the PhotoSwipe gallery. The terms "item", "slide", and "slide object" are used interchangeably.
 */
declare interface PhotoSwipeUI_Default$Item {
...
declare module 'photoswipe' {
    declare module.exports: typeof PhotoSwipe
}