...
declare
function polymer$createEs6PolymerBase(): void

declare
function polymer$prepareForRegistration(elementClass: Function): polymer$Element

declare
function polymer$createDomModule(definition: polymer$Element): void

declare
function polymer$createElement<T>(element: (...args: any[]) => T): (...args: any[]) => T

declare
function polymer$createClass<T>(element: (...args: any[]) => T): (...args: any[]) => T

declare
function polymer$isRegistered(element: polymer$Element): booleandeclare
var Polymer: {
...
declare
function component(tagname: string, extendsTag?: string): (target: Function) => voiddeclare
function extend(tagname: string): (target: Function) => voiddeclare
function template(templateString: string): (target: Function) => voiddeclare
function style(styleString: string): (target: Function) => voiddeclare
function hostAttributes(attributes: Object): (target: Function) => voiddeclare
function property(ob?: polymer$Property): (target: polymer$Element, propertyKey: string) => voiddeclare
function computed(
    ob?: polymer$Property): (target: polymer$Element, computedFuncName: string) => voiddeclare
function listen(eventName: string): (target: polymer$Element, propertyKey: string) => voiddeclare
function behavior(behaviorObject: any): anydeclare
function observe(
