...
declare module 'npm$namespace$polymer' {
	...
	declare interface PolymerTSElement {
	...
	declare function createEs6PolymerBase(): void

	declare function prepareForRegistration(elementClass: Function): polymer.Element

	declare function createDomModule(definition: polymer.Element): void

	declare function createElement<T>(
		element: NO PRINT IMPLEMENTED: ConstructorType
	): NO PRINT IMPLEMENTED: ConstructorType

	declare function createClass<T>(
		element: NO PRINT IMPLEMENTED: ConstructorType
	): NO PRINT IMPLEMENTED: ConstructorType

	declare function isRegistered(element: polymer.Element): boolean

	declare class PolymerBase extends HTMLElement {
		$: any;
		$$: any;
		root: HTMLElement;
	...
	declare class Base extends polymer$PolymerBase, polymer$Element {
		create<T>(...args: any[]): T;
		register(): void;
		is: string
	}
