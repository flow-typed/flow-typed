...
declare module 'mongoose' {
		...
		modelNames(): string[],
		open(
		host: string, database?: string, port?: number, options?: OpenSetConnectionOptions, callback?: (err: any) => void
	): Connection,
		openSet(
		uris: string, database?: string, options?: OpenSetConnectionOptions, callback?: (err: any) => void
	): Connection,
		db: any,
		collections: {
	...
	declare export interface ConnectOpenOptionsBase {
		db?: any,
		server?: any,
		replset?: any,
		user?: string,
	...
	declare interface OpenSetConnectionOptions {
		mongos?: boolean
	}

	declare interface MongosOptions {
		ha?: boolean,
		haInterval?: number,
		poolSize?: number,
		ssl?: boolean,
	...
	declare export interface HookSyncCallback {
		(next: HookNextFunction, ...hookArgs: any[]): any
	}

	declare export interface HookAsyncCallback {
		(next: HookNextFunction, done: HookDoneFunction, ...hookArgs: any[]): any
	}

	declare export interface HookErrorCallback {
		(error: Error): any
	}

	declare export interface HookNextFunction {
		(error: Error): any,
		(...hookArgs: any[]): any
	}

	declare export interface HookDoneFunction {
		(error: Error): any,
		(...hookArgs: any[]): any
	}

	declare export interface SchemaOption {
		autoIndex?: boolean,
	...
	declare export interface Model<T> {
		...
		aggregate(
		aggregation1: Object, aggregation2: Object, callback: (err: any, res: T[]) => void
	): Promise<T[]>,
		aggregate(
		aggregation1: Object, aggregation2: Object, aggregation3: Object, callback: (err: any, res: T[]) => void
	): Promise<T[]>,
		count(
		...
		create(
		doc1: Object, doc2: Object, fn?: (err: any, res1: T, res2: T) => void
	): Promise<T[]>,
		create(
		doc1: Object, doc2: Object, doc3: Object, fn?: (err: any, res1: T, res2: T, res3: T) => void
	): Promise<T[]>,
		discriminator<U>(name: string, schema: Schema): Model<U>,
		distinct(field: string, callback?: (err: any, res: T[]) => void): Query<T[]>,
		distinct(
		field: string, conditions: Object, callback?: (err: any, res: T[]) => void
	): Query<T[]>,
		ensureIndexes(callback: (err: any) => void): Promise<T>,
		find(): Query<T[]>,
		find(cond: Object, callback?: (err: any, res: T[]) => void): Query<T[]>,
		find(
		cond: Object, fields: Object, callback?: (err: any, res: T[]) => void
	): Query<T[]>,
		find(
		cond: Object, fields: Object, options: Object, callback?: (err: any, res: T[]) => void
	): Query<T[]>,
		...
		findById(
		id: string, fields: Object, options: Object, callback?: (err: any, res: T) => void
	): Query<T>,
		...
		findByIdAndUpdate(
		id: string, update: Object, options: FindAndUpdateOption, callback?: (err: any, res: T) => void
	): Query<T>,
		...
		findOneAndUpdate(
		cond: Object, update: Object, options: FindAndUpdateOption, callback?: (err: any, res: T) => void
	): Query<T>,
		geoNear(
		point: {
		type: string,
		coordinates: number[]
	}, options: Object, callback?: (err: any, res: T[], stats: any) => void
	): Query<T[]>,
		geoNear(
		point: number[], options: Object, callback?: (err: any, res: T[], stats: any) => void
	): Query<T[]>,
		geoSearch(
		cond: Object, options: GeoSearchOption, callback?: (err: any, res: T[]) => void
	): Query<T[]>,
		increment(): T,
		mapReduce<K, V>(
		options: MapReduceOption<T, K, V>, callback?: (err: any, res: MapReduceResult<K, V>[]) => void
	): Promise<MapReduceResult<K, V>[]>,
		mapReduce<K, V>(
		options: MapReduceOption2<T, K, V>, callback?: (err: any, res: MapReduceResult<K, V>[]) => void
	): Promise<MapReduceResult<K, V>[]>,
		model<U>(name: string): Model<U>,
		populate<U>(doc: U, options: Object, callback?: (err: any, res: U) => void): Promise<U>,
		populate<U>(
		doc: U[], options: Object, callback?: (err: any, res: U[]) => void
	): Promise<U[]>,
		update(
		cond: Object, update: Object, callback?: (err: any, affectedRows: number, raw: any) => void
	): Query<T>,
		update(
		cond: Object, update: Object, options: Object, callback?: (err: any, affectedRows: number, raw: any) => void
	): Query<T>,
	...
	declare export interface FindAndUpdateOption {
		new?: boolean,
		upsert?: boolean,
		sort?: Object,
		select?: Object
	...
	declare export interface GeoSearchOption {
		near: number[],
		maxDistance: number,
		limit?: number,
		lean?: boolean
	...
	declare export interface MapReduceOption<T, Key, Val> {
		map: () => void,
	...
	declare export interface MapReduceOption2<T, Key, Val> {
		map: string,
		reduce: (key: Key, vals: T[]) => Val,
		query?: Object,
		limit?: number,
	...
	declare export interface MapReduceResult<Key, Val> {
		_id: Key,
		value: Val
	}

	declare export interface PopulateOption {
		path: string,
		select?: string,
		model?: string,
		match?: Object,
	...
	declare export interface QueryStream {
	...
	declare export interface Document {
		...
		get(path: string, type?: NO PRINT IMPLEMENTED: ConstructorType): any,
		...
		set(
		path: string, val: any, type?: NO PRINT IMPLEMENTED: ConstructorType, options?: Object
	): void,
		...
		toString(): string,
		update<T>(
		doc: Object, options: Object, callback: (err: any, affectedRows: number, raw: any) => void
	): Query<T>,
	...
	declare function connect(
		uri: string, options?: ConnectionOptions, callback?: (err: any) => void
	): Mongoose
	...
	declare export class Mongoose  {
		connect(
		uri: string, options?: ConnectOpenOptionsBase, callback?: (err: any) => void
	): Mongoose;
		createConnection(): Connection;
		createConnection(uri: string, options?: Object): Connection;
		createConnection(
		host: string, database_name: string, port?: number, options?: ConnectOpenOptionsBase
	): Connection;
	...
	declare export class Schema  {
		...
		methods: any;
		statics: any;
		constructor(schema?: Object, options?: Object): this;
		...
		pre(
		method: string, isAsync: boolean, fn: HookAsyncCallback, errorCb?: HookErrorCallback
	): Schema;
	...
	declare export class Query<T>  {
		...
		cast<U>(model: Model<U>, obj: Object): U;
		...
		distinct(field: string, callback?: (err: any, res: T) => void): Query<T>;
		distinct(
		criteria: Object, field: string, callback?: (err: any, res: T) => void
	): Query<T>;
		distinct(
		criteria: Query<T>, field: string, callback?: (err: any, res: T) => void
	): Query<T>;
		...
		populate(
		path: string, select: string, model: string, match?: Object, options?: Object
	): Query<T>;
		...
		update(
		doc: Object, callback?: (err: any, affectedRows: number, doc: T) => void
	): Query<T>;
		update(
		criteria: Object, doc: Object, callback?: (err: any, affectedRows: number, doc: T) => void
	): Query<T>;
		update(
		criteria: Object, doc: Object, options: Object, callback?: (err: any, affectedRows: number, doc: T) => void
	): Query<T>;
	...
	declare export class Promise<T>  {
		constructor(fn?: (err: any, result: T) => void): this;
		then<U>(
		onFulFill: (result: T) => void | U | Promise<U>, onReject?: (err: any) => void | U | Promise<U>
	): Promise<U>;
		end(): void;
