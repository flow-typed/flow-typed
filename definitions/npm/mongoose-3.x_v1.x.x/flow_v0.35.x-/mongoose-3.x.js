/**
 * Flowtype definitions for mongoose-3.x
...
declare module 'mongoose' {
    declare function connect(
        ...
        callback?: (err: any) => void): Mongoose
    ...
    declare export class Mongoose {
        ...
        createConnection(
            ...
            port?: number,
            options?: ConnectOpenOptionsBase): Connection;
    ...
    declare export type Connection = {
        ...
        open(
            ...
            callback?: (err: any) => void): Connection,
        openSet(
            uris: string,
            database?: string,
            options?: OpenSetConnectionOptions,
    ...
    } & ConnectOpenOptionsBase

    declare type OpenSetConnectionOptions = {
    ...
    declare export class Schema {
        ...
        pre(
            method: string,
            isAsync: boolean,
            fn: HookAsyncCallback,
            errorCb?: HookErrorCallback): Schema;
    ...
    declare export type Model<T>= {
        ...
        create(
            doc1: Object,
            doc2: Object,
            fn?: (err: any, res1: T, res2: T) => void): Promise<T[]>,
        create(
            doc1: Object,
            doc2: Object,
            doc3: Object,
            fn?: (err: any, res1: T, res2: T, res3: T) => void): Promise<T[]>,
        discriminator<U>(name: string, schema: Schema): Model<U>,
        distinct(field: string, callback?: (err: any, res: T[]) => void): Query<T[]>,
        distinct(
            field: string,
            conditions: Object,
            callback?: (err: any, res: T[]) => void): Query<T[]>,
        ...
        geoNear(
            ...
            options: Object,
            callback?: (err: any, res: T[], stats: any) => void): Query<T[]>,
        geoNear(
            point: number[],
            options: Object,
            callback?: (err: any, res: T[], stats: any) => void): Query<T[]>,
        ...
        V>(
            ...
            callback?: (err: any, res: MapReduceResult<K, V>[]) => void): Promise<MapReduceResult<K,
        V>[]>,
        mapReduce<K,
        V>(
        ...
        populate<U>(
            doc: U[],
            options: Object,
            callback?: (err: any, res: U[]) => void): Promise<U[]>,
        update(
            cond: Object,
            update: Object,
    ...
    declare export class Query<T>{
        ...
        hint(val: Object): Query<T>; in (val: any[]): Query<T>; in (path: string, val: any[]): Query<T>;
        ...
        update(
            doc: Object,
            callback?: (err: any, affectedRows: number, doc: T) => void): Query<T>;
        update(
            criteria: Object,
            doc: Object,
            callback?: (err: any, affectedRows: number, doc: T) => void): Query<T>;
    ...
    declare export type QueryStream = {
    ...
    declare export interface Document {
        id?: string,
            ...
            get(path: string, type?: (...args: any[]) => any): any,
            ...
            set(path: string, val: any, type?: (...args: any[]) => any, options?: Object): void,
    ...
    declare export class Promise<T>{
        ...
        then<U>(
            ...
            onReject?: (err: any) => void | U | Promise<U>): Promise<U>;
        end(): void;
