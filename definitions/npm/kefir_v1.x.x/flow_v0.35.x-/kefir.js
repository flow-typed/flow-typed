/**
 * Flowtype definitions for kefir
...
declare module 'kefir' {
    ...
    declare export interface Observable<T, S>{
        ...
        observe(
            ...
            onEnd?: () => void): Subscription
    }
    declare export type Stream<T, S>= {
        ...
        S>,
        scan(fn: (prev: T, next: T) => T, seed?: T): Stream<T,
        S>,
        ...
        S>,
        valuesToErrors<U>(handler?: (value: T) => {
            convert: boolean,
            error: U
        }): Stream<void,
        S | U>,
        errorsToValues<U>(handler?: (error: S) => {
            convert: boolean,
            value: U
        }): Stream<T | U,
        void>,
        mapErrors<U>(fn: (error: S) => U): Stream<T,
        U>,
        filterErrors(predicate?: (error: S) => boolean): Stream<T,
        S>,
        endOnError(): Stream<T,
        S>,
        ...
        withHandler<U,
        V>(
            handler: (emitter: Emitter<U, S>, event: Event<T | S>) => void): Stream<U,
        S>,
        combine<U,
        V,
        W>(
            otherObs: Stream<U, V>,
            combinator?: (value: T, ...values: U[]) => W): Stream<W,
        S | V>,
        zip<U,
        V,
        W>(
        ...
        S | V>,
        merge<U,
        V>(otherObs: Stream<U, V>): Stream<T | U,
        S | V>,
        concat<U,
        V>(otherObs: Stream<U, V>): Stream<T | U,
        S | V>,
        flatMap<U,
        V>(transform: (value: T) => Stream<U, V>): Stream<U,
        V>,
        flatMapLatest<U,
        V>(fn: (value: T) => Stream<U, V>): Stream<U,
        V>,
        flatMapFirst<U,
        V>(fn: (value: T) => Stream<U, V>): Stream<U,
        V>,
        ...
        V>(fn: (value: T) => Stream<U, V>): Stream<U,
        V>,
        flatMapConcurLimit<U,
        V>(fn: (value: T) => Stream<U, V>, limit: number): Stream<U,
        V>,
        flatMapErrors<U,
        V>(transform: (error: S) => Stream<U, V>): Stream<U,
        V>,
        filterBy<U>(otherObs: Observable<boolean, U>): Stream<T,
        S>,
        sampledBy<U,
        V,
        W>(
            otherObs: Observable<U, V>,
            combinator?: (a: T, b: U) => W): Stream<W,
        S>,
        skipUntilBy<U,
        V>(otherObs: Observable<U, V>): Stream<U,
        V>,
        takeUntilBy<U,
        V>(otherObs: Observable<U, V>): Stream<U,
        V>,
        ...
        S>,
        awaiting<U,
        V>(otherObs: Observable<U, V>): Stream<boolean,
        S >
    } & Observable

    declare export type Property<T, S>= {
        changes(): Stream<T,
        S>,
        ...
        S>,
        scan(fn: (prev: T, next: T) => T, seed?: T): Property<T,
        S>,
        ...
        void>,
        mapErrors<U>(fn: (error: S) => U): Property<T,
        U>,
        filterErrors(predicate?: (error: S) => boolean): Property<T,
        S>,
        endOnError(): Property<T,
        S>,
        takeErrors(n: number): Stream<T,
        S>,
        ...
        withHandler<U,
        V>(
            handler: (emitter: Emitter<T, S>, event: Event<T | S>) => void): Property<U,
        S>,
        combine<U,
        V,
        W>(
            otherObs: Property<U, V>,
            combinator?: (value: T, ...values: U[]) => W): Property<W,
        S | V>,
        zip<U,
        V,
        W>(
        ...
        S | V>,
        merge<U,
        V>(otherObs: Property<U, V>): Property<T | U,
        S | V>,
        concat<U,
        V>(otherObs: Property<U, V>): Property<T | U,
        S | V>,
        flatMap<U,
        V>(transform: (value: T) => Property<U, V>): Property<U,
        V>,
        flatMapLatest<U,
        V>(fn: (value: T) => Property<U, V>): Property<U,
        V>,
        flatMapFirst<U,
        V>(fn: (value: T) => Property<U, V>): Property<U,
        V>,
        ...
        V>,
        flatMapConcurLimit<U,
        V>(fn: (value: T) => Property<U, V>, limit: number): Property<U,
        V>,
        flatMapErrors<U,
        V>(transform: (error: S) => Property<U, V>): Property<U,
        V>,
        filterBy<U>(otherObs: Observable<boolean, U>): Property<T,
        S>,
        sampledBy<U,
        V,
        W>(
            otherObs: Observable<U, V>,
            combinator?: (a: T, b: U) => W): Property<W,
        S>,
        skipUntilBy<U,
        V>(otherObs: Observable<U, V>): Property<U,
        V>,
        takeUntilBy<U,
        V>(otherObs: Observable<U, V>): Property<U,
        V>,
        ...
        S>,
        awaiting<U,
        V>(otherObs: Observable<U, V>): Property<boolean,
        S >
    } & Observable

    declare export type ObservablePool<T, S>= {
    ...
    declare export function never(): Stream<void, void >
        ...
        declare export function withInterval<T, S>(
            interval: number,
            handler: (emitter: Emitter<T, S>) => void): Stream<T, S >
        ...
        declare export function fromEvents<T, S>(
            ...
            eventName: string,
            transform?: (value: T) => S): Stream<T, S >
        ...
        declare export function combine<T, S, U>(
            ...
            combinator?: (...values: T[]) => U): Observable<U, S >
