...
type $npm$styledComponents$StyledComponent<C: $npm$styledComponents$Component<*>> = (
...
declare module 'styled-components' {
  ...
  declare type StyledComponent<C: Component<*>> = $npm$styledComponents$StyledComponent<C>;

  declare type Theme = $npm$styledComponents$Theme;
  declare type ThemeProviderProps = $npm$styledComponents$ThemeProviderProps;
  declare type Component<Props: {}> = $npm$styledComponents$Component<Props>;
  ...
  declare module.exports: {
    ...
    <C: Component<*>>(baseComponent: C): StyledComponent<C>,
    a: StyledComponent<*>,
