...
const TitleTaggedTemplateLiteral: ReactComponentStyledTaggedTemplateLiteral<{}> =
  styled.h1;

const TitleStyled: ReactComponentStyled<*> = styled.h1`font-size: 1.5em;`;
...
const TitleClass: ReactComponentClass<*> = styled.h1`font-size: 1.5em;`;

declare var needsReactComponentFunctional: (
  ReactComponentFunctional<*>
) => void;
...
const Attrs0ExtendReactComponent: ReactComponentIntersection<
  *
> = Attrs0ReactComponent.extend`

`;

const Attrs0SyledComponent: ReactComponentStyledTaggedTemplateLiteral<*> =
  styled.div;
const Attrs0ExtendStyledComponent: ReactComponentIntersection<
  *
> = Attrs0SyledComponent.extend`

`;

// ---- ATTRIBUTES ----
const Attrs1: ReactComponentStyledTaggedTemplateLiteral<
  *
...
// $ExpectError
const Attrs1Error: ReactComponentStyledTaggedTemplateLiteral<
  *
> = styled.section.attrs({
  testProp: "foo"
})``;
...
const withComponent2: ReactComponentStyled<*> = styled.div.withComponent(
  withComponent1
);
const withComponent3: ReactComponentStyled<*> = styled.div.withComponent(
  Attrs3Class
);
// $ExpectError
const withComponentError1: ReactComponentStyled<*> = styled.div.withComponent(
  0
);
// $ExpectError
const withComponentError2: ReactComponentStyled<*> = styled.div.withComponent(
  "NotHere"
);
...
const StyledClass: ReactComponentClass<{ foo: string, theme: Theme }> = styled(
  NeedsThemeReactClass
)`
  color: red;
`;

const NeedsFoo1Class: ReactComponentClass<{ foo: string }> = withTheme(
  NeedsThemeReactClass
);

// $ExpectError
const NeedsFoo0ClassError: ReactComponentClass<{ foo: string }> = withTheme(
  ReactClass
);
// $ExpectError
const NeedsFoo1ClassError: ReactComponentClass<{ foo: string }> = withTheme(
  NeedsFoo1Class
);
// $ExpectError
const NeedsFoo1ErrorClass: ReactComponentClass<{ foo: number }> = withTheme(
  NeedsThemeReactClass
);
// $ExpectError
const NeedsFoo2ErrorClass: ReactComponentClass<
  { foo: string },
  { theme: string }
> = withTheme(NeedsThemeReactClass);
// $ExpectError
...
// $ExpectError
const NeedsFoo4ErrorClass: ReactComponentClass<{ foo: number }> = withTheme(
  NeedsFoo1Class
);
// $ExpectError
...
// ---- INTERPOLATION TESTS ----
const interpolation: Array<Interpolation> = styled.css`background-color: red;`;
...
const FunctionalComponent: ReactComponentFunctional<{
  foo: string,
  theme: Theme
}> = props => <div />;

const NeedsFoo1: ReactComponentFunctional<{
  foo: string,
  theme: Theme
...
`;
// $ExpectError
const NeedsFoo1Error: ReactComponentFunctional<{ foo: number }> = styled(
  FunctionalComponent
)`background-color: red;`;

const NeedsFoo2: ReactComponentFunctional<{
  foo: string,
  theme: Theme
}> = styled(NeedsFoo1)`background-color: red;`;
// $ExpectError
const NeedsFoo2Error: ReactComponentFunctional<{ foo: number }> = styled(
  NeedsFoo1
)`background-color: red;`;

// ---- FUNCTIONAL COMPONENT TESTS (withTheme)----
const NeedsFoo1Functional: ReactComponentFunctional<{
  foo: string
}> = withTheme(FunctionalComponent);
const NeedsFoo2Functional: ReactComponentFunctional<{
  foo: string
}> = withTheme(NeedsFoo1Functional);

// $ExpectError
const NeedsFoo1ErrorFunctional: ReactComponentFunctional<{
  foo: number
}> = withTheme(FunctionalComponent);

const NeedsFoo2ErrorFunctional: ReactComponentFunctional<{
  foo: string
}> = withTheme(FunctionalComponent);
// $ExpectError
const NeedsFoo3ErrorFunctional: ReactComponentFunctional<{
  foo: number,
  theme: Theme
}> = withTheme(FunctionalComponent);
// $ExpectError
const NeedsFoo4ErrorFunctional: ReactComponentFunctional<{
  foo: number
}> = withTheme(NeedsFoo1Functional);

const NeedsFoo5ErrorFunctional: ReactComponentFunctional<{
  foo: string
}> = withTheme(NeedsFoo1Functional);

// $ExpectError
const NeedsFoo6ErrorFunctional: ReactComponentFunctional<{
  foo: number
}> = withTheme(NeedsFoo1Functional);
