...
declare module 'noVNC' {
	...
	declare interface NvUtilStatic {
		...
		get_logging(): string,
		conf_default(
		cfg: <<UNKNOWN PARAM FORMAT>>, api: <<UNKNOWN PARAM FORMAT>>, defaults: <<UNKNOWN PARAM FORMAT>>, v: <<UNKNOWN PARAM FORMAT>>, mode: <<UNKNOWN PARAM FORMAT>>, type: <<UNKNOWN PARAM FORMAT>>, defval: <<UNKNOWN PARAM FORMAT>>, desc: <<UNKNOWN PARAM FORMAT>>
	): void,
		conf_defaults(
		cfg: <<UNKNOWN PARAM FORMAT>>, api: <<UNKNOWN PARAM FORMAT>>, defaults: <<UNKNOWN PARAM FORMAT>>, arr: <<UNKNOWN PARAM FORMAT>>
	): void,
	...
	declare interface Display {
		...
		copyImage(
		old_x: number, old_y: number, new_x: number, new_y: number, w: number, h: number
	),
		...
		finishTile(): void,
		blitImage(
		x: number, y: number, width: number, height: number, arr: any[], offset: number
	): void,
		blitRgbImage(
		x: number, y: number, width: number, height: number, arr: any[], offset: number
	): void,
