...
declare module 'npm$namespace$Xrm' {
	...
	declare export interface XrmStatic {
		...
		openQuickCreate(
		callback: (recordReference: Page.LookupValue) => void, entityLogicalName: string, createFromEntity?: Page.LookupValue, parameters?: Utility.OpenParameters
	): void,
		openEntityForm(
