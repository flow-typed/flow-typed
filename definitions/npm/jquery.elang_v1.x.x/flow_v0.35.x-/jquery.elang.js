// @flow
/**
 * Flowtype definitions for jquery.elang
...
declare type IELangSearchDefaults = {
...
declare type IELangEditDefaults = {
    editFormHtml: string,
...
declare type IELangTestDefaults = {
    formHtml: string,
