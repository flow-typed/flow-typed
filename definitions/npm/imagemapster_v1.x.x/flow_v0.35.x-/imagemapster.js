/**
 * Flowtype definitions for imagemapster
...
declare type ImageMapster$Select = "select";

declare type ImageMapster$Deselect = "deselect";

declare type ImageMapster$Set = "set";

declare type ImageMapster$Get = "get";

declare type ImageMapster$Highlight = "highlight";

declare type ImageMapster$Unbind = "unbind";

declare type ImageMapster$Resize = "resize";

declare type ImageMapster$Snapshot = "snapshot";

declare type ImageMapster$Rebind = "rebind";

declare type ImageMapster$Keys = "keys";

declare type ImageMapster$SetOptions = "set_options";

declare type ImageMapster$GetOptions = "get_options";

declare type ImageMapster$Tooltip = "tooltip";

declare type ImageMapster$ToolTipCloseEvent = "area-mouseout" | "area-click" | "tooltip-click" | "image-mouseout";

declare type ImageMapster$State = "highlight" | "select";

declare interface ImageMapster$RenderingOptions {
    ...
    */
    fade?: boolean,
        ...
        */
        render_highlight?: string | ImageMapster$RenderingOptions,
        render_select?: string | ImageMapster$RenderingOptions
}

declare type ImageMapster$AreaRenderingOptions = {
    key: string,
    ...
    */
    toolTip?: string
} & ImageMapster$RenderingOptions


declare interface ImageMapster$OnClickData {
...
declare interface ImageMapster$OnStateChangeData {
...
declare interface ImageMapster$OnMouseData {
    ...
    key: string,
        ...
        selected: boolean,
        e: JQueryEventObject,
        options: ImageMapster$AreaRenderingOptions
}

declare interface ImageMapster$OnGetListData {
...
declare interface ImageMapster$OnShowToolTipData {
    ...
    toolTip: JQuery,
         ...
         */
        selected: boolean,
        areaOptions: ImageMapster$AreaRenderingOptions
}

declare type ImageMapster$Options = {
    ...
    */
    areas?: ImageMapster$AreaRenderingOptions[],
    ...
    */
    toolTipClose?: ImageMapster$ToolTipCloseEvent[],

    /**
     * callback when a hotspot area is clicked. Return false to cancel
     * default select action, or true to navigate to the 'href'a callback when an area is clicked.:silent doautocmd FocusLost %
     * 
    ...
    */
    onClick?: (data: ImageMapster$OnClickData) => void,
    ...
    */
    onMouseover?: (data: ImageMapster$OnMouseData) => void,
    ...
    */
    onMouseout?: (data: ImageMapster$OnMouseData) => void,
    ...
    manually.
    */
    onGetList?: (data: ImageMapster$OnGetListData) => JQuery,
    ...
    */
    onStateChange?: (data: ImageMapster$OnStateChangeData) => void,
    ...
    desired.
    */
    onShowToolTip?: (data: ImageMapster$OnShowToolTipData) => void
} & ImageMapster$RenderingOptions
    ...
    mapster(options?: ImageMapster$Options): JQuery,
        ...
        */
        mapster(
            ...
            selected: boolean,
            options: ImageMapster$RenderingOptions): JQuery,
        ...
        */
        mapster(
            ...
            key?: string,
            effective?: boolean): ImageMapster$Options | ImageMapster$AreaRenderingOptions,
