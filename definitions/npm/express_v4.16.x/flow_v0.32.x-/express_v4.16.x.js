declare module "express" {
  ...
  declare export type express$RouterOptions = express$RouterOptions;
  declare export type express$CookieOptions = express$CookieOptions;
  declare export type express$Middleware = express$Middleware;
  declare export type express$NextFunction = express$NextFunction;
  declare export type express$RequestParams = express$RequestParams;
  declare export type express$Response = express$Response;
  declare export type express$Request = express$Request;
  declare export type express$Application = express$Application;
