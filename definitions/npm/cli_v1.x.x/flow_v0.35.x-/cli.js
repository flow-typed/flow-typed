...
declare module 'cli' {
    declare interface CLI {
        app: string,
            ...
            withInput(
                file: string,
                encoding: string,
                callback: (line: string, newline: string, eof: boolean) => void): void,
            withInput(
                file: string,
                callback: (line: string, newline: string, eof: boolean) => void): void,
            ...
            exec(
                ...
                errback?: (err: any, stdout: string) => void): void,
    ...
    declare var cli: CLI;
    declare module.exports: typeof cli
}