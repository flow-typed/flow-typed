...
declare module 'cli' {
		...
		withInput(
		file: string, encoding: string, callback: (line: string, newline: string, eof: boolean) => void
	): void,
		withInput(
		file: string, callback: (line: string, newline: string, eof: boolean) => void
	): void,
		...
		exec(
		cmd: string, callback?: (lines: string[]) => void, errback?: (err: any, stdout: string) => void
	): void,
