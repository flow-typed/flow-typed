// @flow
/**
 * Flowtype definitions for jquery.fileupload
...
declare interface JQuery {
    fileupload(settings: JQueryFileInputOptions | string): JQueryFileUpload,
        ...
        fileupload(
            action: string,
            message: string,
            settings: JQueryFileInputOptions | string): JQueryFileUpload
}
...
declare type JQueryFileUploadChunkObject = {
    blob: any,
    chunkSize: number,
    contentRange: string,
    errorThrown: any
} & JQueryFileInputOptions & JQueryFileUploadXhr
declare type JQueryFileUploadProgressObject = {} & JQueryFileInputOptions & JQueryFileUploadProgressAllObject
declare type JQueryFileUploadDone = {} & JQueryFileInputOptions & JQueryFileUploadXhr