/**
 * Flowtype definitions for dojox.validate
...
this module.
*/
declare interface dojox$validate {}
...
declare interface validate$br {
    ...
    check(form: HTMLFormElement, profile: Object): void,
        ...
        */
         ...
         * @param value 
         * @param flags Optionalflags.allowCruft  Allow address like <mailto:foo
         * @yahoo  .com>.  Default is false.flags in regexp.host can be applied.flags in regexp.ipAddress can be applied.flags in regexp.tld can be applied.
         */
...
er: Enroute
*/
declare interface br$_cardInfo {
 ...
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/validate/_base._isInRangeCache.html
 */
declare interface br$_isInRangeCache {}
...
*/
declare interface validate$creditCard {}


/**
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/validate/regexp.html
 */
declare interface validate$regexp {
    ...
    ca: Object,
         ...
         * @param flags Optionalflags.allowCruft  Allow address like <mailto:foo
         * @yahoo  .com>.  Default is false.flags in regexp.host can be applied.flags in regexp.ipAddress can be applied.
         */
...
er: Enroute
*/
declare interface us$_cardInfo {
 ...
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/validate/_base._isInRangeCache.html
 */
declare interface us$_isInRangeCache {}


/**
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/validate/web.html
 */
declare interface validate$web {
 ...
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/validate/_base._isInRangeCache.html
 */
declare interface web$_isInRangeCache {}
...
er: Enroute
*/
declare interface web$_cardInfo {
 ...
 * @param profile specifies how the form fields are to be validated{trim:Array, uppercase:Array, lowercase:Array, ucfirst:Array, digit:Array,required:Array, dependencies:Object, constraints:Object, confirm:Object}
*/
declare interface validate$check {
...
declare module 'dojox/validate/_base._cardInfo' {
    declare var exp: undefined._cardInfo;
    declare module.exports: typeof exp
}
declare module 'dojox/validate/_base._isInRangeCache' {
    declare var exp: undefined._isInRangeCache;
    declare module.exports: typeof exp
}
