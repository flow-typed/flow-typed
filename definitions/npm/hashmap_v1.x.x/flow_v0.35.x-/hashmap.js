/**
 * Flowtype definitions for hashmap
...
declare class HashMap<TKey, TValue>{
     ...
     * @return  Self.
     */
    set(key: TKey, value: TValue): HashMap<TKey,
    TValue>;
     ...
     * @return  Self.
     */
    multi(...keysAndValues: (TKey | TValue)[]): HashMap<TKey,
    TValue>;
     ...
     * @return  Self.
     */
    copy(map: HashMap<TKey, TValue>): HashMap<TKey,
    TValue>;
     ...
     * @return  Self.
     */
    forEach(callback: (value: TValue, key: TKey) => void): HashMap<TKey,
    TValue >
}
declare module 'hashmap' {
    declare module.exports: typeof HashMap
}