...
declare module 'devextreme-15.1.8' {
...
declare module 'ui' {
	...
	declare export interface dxColorPickerOptions {
	...
	declare export class dxColorPicker extends dxColorBox {
		constructor(element: JQuery, options?: dxColorPickerOptions): this;
		constructor(element: Element, options?: dxColorPickerOptions): this
	}

	declare export class dxTreeView extends CollectionWidget {
	...
	declare export class dxMenuBase extends CollectionWidget {
