...
declare var npm$namespace$riot: {
    ...
    update: typeof riot$update,
    mixin: typeof riot$mixin,
    tag: typeof riot$tag,
 ...
 * Riot settings
 */
declare interface riot$Settings {
...
declare interface riot$Util {
    tmpl: {
        errorHandler(error: riot$TemplateError): void
    }
}
...
declare interface riot$Observable {
     ...
     */
    on(events: string, callback: Function): riot$Observable,
         ...
         * @param callback Callback function
         */
        one(events: string, callback: Function): riot$Observable,

        /**
         * Remove all registered callbacks for specified events
         * @param events Space separated list of events or wildcard '*' that matches all events
         */
        off(events: string): riot$Observable,
         ...
         */
        off(events: string, callback: Function): riot$Observable,
         ...
         */
        trigger(events: string, ...args: any[]): riot$Observable
}
...
declare interface riot$Route {
    ...
    create(): riot$Route,
        ...
        parser(
            ...
            secondParser?: (path: string, filter: string) => any[]): void
}
...
declare function riot$tag(
    ...
    css?: string,
    attrs?: string,
    constructor?: (opts: any) => void): string

declare interface riot$TagImplementation {
...
declare interface riot$TagConfiguration {
...
declare type riot$TagInterface = {
     ...
     * @param mixinObject Mixin object
     */
    mixin(mixinObject: riot$TagMixin): void,
...
declare class Tag mixins TagInterface {
     ...
     */
    constructor(impl: riot$TagImplementation, conf: riot$TagConfiguration, innerHTML?: string): this;
