/**
 * Flowtype definitions for node-4
...
declare module 'crypto' {
    ...
    declare export type Cipher = {
        ...
        update(
            data: Buffer,
            input_encoding: any,
            output_encoding: "binary" | "base64" | "hex"): string,
        update(
            data: string,
    ...
    declare export type Decipher = {
        ...
        update(
            data: Buffer,
            input_encoding: any,
            output_encoding: "utf8" | "ascii" | "binary"): string,
        update(
            data: string,
...
declare module 'stream' {
    ...
    declare export class Stream mixins events.EventEmitter {
        pipe<T>(destination: T, options?: {
            end?: boolean
        }): T
    }
...
declare module 'constants' {
    ...
    declare export var EDQUOT: number;
    declare export var EMULTIHOP: number;
    declare export var ESTALE: number;
