// @flow
/**
 * Flowtype definitions for evernote
...
declare module 'evernote' {
    ...
    declare interface Evernote$Callback<T>{
        (err: Evernote$EDAMUserException | Evernote$EDAMSystemException | Evernote$EDAMNotFoundException, v: T): void
    }

    declare interface Evernote$ClientConfig {
        consumerKey?: string,
    ...
    declare class Client {
        new: (config: Evernote$ClientConfig) => Evernote$Client;
        constructor(config: Evernote$ClientConfig): this;
        getNoteStore(): Evernote$NoteStoreClient;
        getUserStore(): Evernote$UserStoreClient
    }
    ...
    */
    declare class EDAMUserException mixins Thrift.TException {
    ...
    */
    declare class EDAMSystemException mixins Thrift.TException {
        errorCode: EDAMErrorCode;
        message: string;
    ...
    */
    declare class EDAMNotFoundException mixins Thrift.TException {
        identifier: string;
        key: string;
        constructor(args?: {
            identifier?: string,
    ...
    declare     var EDAM_USER_UPLOAD_LIMIT_FREE: number;

    declare     var EDAM_USER_UPLOAD_LIMIT_PREMIUM: number;

    declare     var EDAM_USER_UPLOAD_LIMIT_BUSINESS: number;
    ...
    declare     var EDAM_NOTEBOOK_SHARED_NOTEBOOK_MAX: number;
    ...
    declare class NoteStoreClient {
         ...
         */
        getSyncState(cb: Evernote$Callback<Evernote$SyncState>): void;
        ...
        */
        getSyncStateWithMetrics(
            clientMetrics: Evernote$ClientUsageMetrics,
            cb: Evernote$Callback<Evernote$SyncState>): void;
         ...
         * @param afterUSN The client can pass this value to ask only for objects that
         ...
         * @param maxEntries The maximum number of modified objects that should be
         ...
         * @param filter The caller must set some of the flags in this structure to specify which
        ...
        */
         ...
         * @param authenticationToken This should be an authenticationToken for the guest who has received
        the invitation to the share.    (I.e. this should not be the result of
        NoteStore.authenticateToSharedNotebook)
         * @param linkedNotebook This structure should contain identifying information and permissions
        to access the notebook in question.
        */
        getLinkedNotebookSyncState(
            linkedNotebook: Evernote$LinkedNotebook,
            cb: Evernote$Callback<Evernote$SyncState>): void;
         ...
         * @param fullSyncOnly If true, then the client only wants initial data for a full sync.
        ...
        */
        getLinkedNotebookSyncChunk(
            ...
            cb: Evernote$Callback<Evernote$SyncChunk>): void;

        /**
         * Returns a list of all of the notebooks in the account.
         */
        listNotebooks(cb: Evernote$Callback<Evernote$Notebook[]>): void;
        ...
        */
        getNotebook(guid: string, cb: Evernote$Callback<Evernote$Notebook>): void;

        /**
         * Returns the notebook that should be used to store new notes in the
         * user's account when no other notebooks are specified.
         */
        getDefaultNotebook(cb: Evernote$Callback<Evernote$Notebook>): void;

        /**
         * Asks the service to make a notebook with the provided name.
         * @param notebook The desired fields for the notebook must be provided on this
         ...
         * @return  *     The newly created Notebook.    The server-side GUID will be
        ...
        */
        createNotebook(notebook: Evernote$Notebook, cb: Evernote$Callback<Evernote$Notebook>): void;
        ...
        */
        updateNotebook(notebook: Evernote$Notebook, cb: Evernote$Callback<number>): void;
        ...
        */
        expungeNotebook(guid: string, cb: Evernote$Callback<number>): void;
         ...
         */
        listTags(cb: Evernote$Callback<Evernote$Tag[]>): void;
        ...
        */
        listTagsByNotebook(notebookGuid: string, cb: Evernote$Callback<Evernote$Tag[]>): void;
        ...
        */
        getTag(guid: string, cb: Evernote$Callback<Evernote$Tag>): void;

        /**
         * Asks the service to make a tag with a set of information.
         * @param tag The desired list of fields for the tag are specified in this
        object.    The caller must specify the tag name, and may provide
        the parentGUID.
         * @return  *     The newly created Tag.    The server-side GUID will be
        ...
        */
        createTag(tag: Evernote$Tag, cb: Evernote$Callback<Evernote$Tag>): void;
        ...
        */
        updateTag(tag: Evernote$Tag, cb: Evernote$Callback<number>): void;
        ...
        */
        untagAll(guid: string, cb: Evernote$Callback<void>): void;
        ...
        */
        expungeTag(guid: string, cb: Evernote$Callback<number>): void;
         ...
         */
        listSearches(cb: Evernote$Callback<Evernote$SavedSearch[]>): void;
        ...
        */
        getSearch(guid: string, cb: Evernote$Callback<Evernote$SavedSearch>): void;

        /**
         * Asks the service to make a saved search with a set of information.
         * @param search The desired list of fields for the search are specified in this
         ...
         * @return  *     The newly created SavedSearch.    The server-side GUID will be
        saved in this object.
         * @throws  EDAMUserException <ul>
        ...
        */
        createSearch(
            search: Evernote$SavedSearch,
            cb: Evernote$Callback<Evernote$SavedSearch>): void;
        ...
        */
        updateSearch(search: Evernote$SavedSearch, cb: Evernote$Callback<number>): number;
        ...
        */
        expungeSearch(guid: string, cb: Evernote$Callback<number>): void;
        ...
        findNotes(
            ...
            offset: number,
            maxNotes: number,
            cb: Evernote$Callback<Evernote$NoteList>): void;
         ...
         * @param authenticationToken Must be a valid token for the user's account unless the NoteFilter
         ...
         * @return  *     If the note with the provided GUID is found within the matching note
        ...
        */
        findNoteOffset(filter: Evernote$NoteFilter, guid: string, cb: Evernote$Callback<number>): void;
        ...
        'notebookGuid' is the GUID of a public notebook.
         * @param filter The list of criteria that will constrain the notes to be returned.
         * @param offset The numeric index of the first note to show within the sorted
        results.    The numbering scheme starts with "0".    This can be used for
        pagination.
         * @param maxNotes The mximum notes to return in this query.    The service will return a set
         ...
         * @param resultSpec This specifies which information should be returned for each matching
        ...
        */
        findNotesMetadata(
            ...
            offset: number,
            maxNotes: number,
            resultSpec: Evernote$NotesMetadataResultSpec,
            cb: Evernote$Callback<Evernote$NotesMetadataList>): void;
         ...
         * @param authenticationToken Must be a valid token for the user's account unless the NoteFilter
        'notebookGuid' is the GUID of a public notebook.
         * @param filter The note selection filter that is currently being applied.    The note
        counts are to be calculated with this filter applied to the total set
        of notes in the user's account.
         * @param withTrash If true, then the NoteCollectionCounts.trashCount will be calculated
        ...
        */
        findNoteCounts(
            filter: Evernote$NoteFilter,
            withTrash: boolean,
            cb: Evernote$Callback<Evernote$NoteCollectionCounts>): void;
         ...
         * @param guid The GUID of the note to be retrieved.
         * @param withContent If true, the note will include the ENML contents of its
        'content' field.
         * @param withResourcesData If true, any Resource elements in this Note will include the binary
        contents of their 'data' field's body.
         * @param withResourcesRecognition If true, any Resource elements will include the binary contents of the
        'recognition' field's body if recognition data is present.
         * @param withResourcesAlternateData If true, any Resource elements in this Note will include the binary
        ...
        */
        getNote(
            ...
            cb: Evernote$Callback<Evernote$Note>): void;
        ...
        */
        getNoteApplicationData(guid: string, cb: Evernote$Callback<Evernote$LazyMap>): void;
        ...
        */
        getNoteApplicationDataEntry(guid: string, key: string, cb: Evernote$Callback<string>): void;

        /**
         * Update, or create, an entry in the applicationData map for
         * the note identified by guid.
         */
        setNoteApplicationDataEntry(guid: string, key: string, value: string, cb: Evernote$Callback<number>): void;
        ...
        non-existing key.
        */
        unsetNoteApplicationDataEntry(guid: string, key: string, cb: Evernote$Callback<number>): void;
        ...
        */
        getNoteContent(guid: string, cb: Evernote$Callback<string>): void;
        ...
        will be ignored (so it could be an empty string).
         * @param guid The GUID of the note to be retrieved.
         * @param noteOnly If true, this will only return the text extracted from the ENML contents
         ...
         * @param tokenizeForIndexing If true, this will break the text into cleanly separated and sanitized
        ...
        */
        getNoteSearchText(
            ...
            cb: Evernote$Callback<string>): void;
        ...
        */
        getResourceSearchText(guid: string, cb: Evernote$Callback<string>): void;
        ...
        */
        getNoteTagNames(guid: string, cb: Evernote$Callback<string[]>): void;

        /**
         * Asks the service to make a note with the provided set of information.
         * @param note A Note object containing the desired fields to be populated on
        the service.
         * @return  *     The newly created Note from the service.    The server-side
        ...
        */
        createNote(note: Evernote$Note, cb: Evernote$Callback<Evernote$Note>): void;
        ...
        */
        updateNote(note: Evernote$Note, cb: Evernote$Callback<Evernote$Note>): void;
        ...
        */
        deleteNote(guid: string, cb: Evernote$Callback<number>): void;
        ...
        */
        expungeNote(guid: string, cb: Evernote$Callback<number>): void;
        ...
        */
        expungeNotes(noteGuids: string[], cb: Evernote$Callback<number>): void;
        ...
        */
        expungeInactiveNotes(cb: Evernote$Callback<number>): void;
         ...
         * @return  *     The metadata for the new Note that was created.    This will include the
        ...
        */
        listNoteVersions(noteGuid: string, cb: Evernote$Callback<Evernote$NoteVersionId[]>): void;
        ...
        */
         ...
         * @param guid The GUID of the resource to be retrieved.
         * @param withData If true, the Resource will include the binary contents of the
        'data' field's body.
         * @param withRecognition If true, the Resource will include the binary contents of the
        'recognition' field's body if recognition data is present.
         * @param withAttributes If true, the Resource will include the attributes
         * @param withAlternateData If true, the Resource will include the binary contents of the
        ...
        */
        getResource(
            ...
            cb: Evernote$Callback<Evernote$Resource>): void;
        ...
        */
        getResourceApplicationData(guid: string, cb: Evernote$Callback<Evernote$LazyMap>): void;
        ...
        */
        getResourceApplicationDataEntry(guid: string, key: string, cb: Evernote$Callback<string>): void;

        /**
         * Update, or create, an entry in the applicationData map for
         * the Resource identified by guid.
         */
        setResourceApplicationDataEntry(guid: string, key: string, value: string, cb: Evernote$Callback<number>): void;

        /**
         * Remove an entry identified by 'key' from the applicationData map for
         * the Resource identified by 'guid'.
         */
        unsetResourceApplicationDataEntry(guid: string, key: string, cb: Evernote$Callback<number>): void;
         ...
         * @param resource A Resource object containing the desired fields to be populated on
         ...
         * @return  *     The Update Sequence Number of the resource after the changes have been
        applied.
         * @throws  EDAMUserException <ul>
        <li> BAD_DATA_FORMAT "Resource.guid" - if the parameter is missing
        </li>
        ...
        */
        updateResource(resource: Evernote$Resource, cb: Evernote$Callback<number>): void;
        ...
        */
        getResourceData(guid: string, cb: Evernote$Callback<string>): void;
         ...
         * @param contentHash The MD5 checksum of the resource within that note. Note that
        ...
        */
        getResourceRecognition(guid: string, cb: Evernote$Callback<string>): void;
        ...
        */
        getResourceAlternateData(guid: string, cb: Evernote$Callback<string>): void;
        ...
        */
        getResourceAttributes(guid: string, cb: Evernote$Callback<Evernote$ResourceAttributes>): void;
         ...
         * @param userId The numeric identifier for the user who owns the public notebook.
        ...
        */
        getPublicNotebook(
            userId: number,
            publicUri: string,
            cb: Evernote$Callback<Evernote$Notebook>): void;
         ...
         * @param sharedNotebook A shared notebook object populated with the email address of the share
         ...
         * @return  *     The fully populated SharedNotebook object including the server assigned
        ...
        */
        createSharedNotebook(
            sharedNotebook: Evernote$SharedNotebook,
            cb: Evernote$Callback<Evernote$SharedNotebook>): void;

        /**
         * Update a SharedNotebook object.
         * @param authenticationToken Must be an authentication token from the owner or a shared notebook
        authentication token or business authentication token with sufficient
        permissions to change invitations for a notebook.
         * @param sharedNotebook The SharedNotebook object containing the requested changes.
        ...
        */
        updateSharedNotebook(sharedNotebook: Evernote$SharedNotebook, cb: Evernote$Callback<number>): void;
        ...
        */
        setSharedNotebookRecipientSettings(
            ...
            recipientSettings: Evernote$SharedNotebookRecipientSettings,
            cb: Evernote$Callback<number>): void;
         ...
         * @param authenticationToken The auth token of the user with permissions to share the notebook
         * @param notebookGuid The guid of the shared notebook
         * @param messageText User provided text to include in the email
         * @param recipients The email addresses of the recipients. If this list is empty then all of the
        ...
        */
         ...
         */
        listSharedNotebooks(cb: Evernote$Callback<Evernote$SharedNotebook[]>): void;
        ...
        NOTE: This function is generally not available to third party applications.
        Calls will result in an EDAMUserException with the error code
        PERMISSION_DENIED.sharedNotebookIds - a list of ShardNotebook.id longs identifying the
              objects to delete permanently.
         * @return  *     The account's update sequence number.
        */
        expungeSharedNotebooks(sharedNotebookIds: number[], cb: Evernote$Callback<number>): void;
         ...
         * @param linkedNotebook The desired fields for the linked notebook must be provided on this
         ...
         * @return  *     The newly created LinkedNotebook.    The server-side id will be
        ...
        */
        createLinkedNotebook(
            linkedNotebook: Evernote$LinkedNotebook,
            cb: Evernote$Callback<Evernote$LinkedNotebook>): void;
        ...
        */
        updateLinkedNotebook(linkedNotebook: Evernote$LinkedNotebook, cb: Evernote$Callback<number>): void;

        /**
         * Returns a list of linked notebooks
         */
        listLinkedNotebooks(cb: Evernote$Callback<Evernote$LinkedNotebook[]>): void;
        ...
        Calls will result in an EDAMUserException with the error code
        PERMISSION_DENIED.
         * @param guid The LinkedNotebook.guid field of the LinkedNotebook to permanently remove
        from the account.
        */
        expungeLinkedNotebook(guid: string, cb: Evernote$Callback<number>): void;
         ...
         * @param shareKey The 'shareKey' identifier from the SharedNotebook that was granted to
        some recipient.    This string internally encodes the notebook identifier
        and a security signature.
         * @param authenticationToken If a non-empty string is provided, this is the full user-based
        ...
        */
        authenticateToSharedNotebook(shareKey: string, cb: Evernote$Callback<Evernote$AuthenticationResult>): void;
         ...
         * @param authenticationToken Should be the authentication token retrieved from the reply of
        ...
        */
        getSharedNotebookByAuth(cb: Evernote$Callback<Evernote$SharedNotebook>): void;
        ...
        Calls will result in an EDAMUserException with the error code
        PERMISSION_DENIED.
         * @param authenticationToken The note will be sent as the user logged in via this token, using that
         ...
         * @param parameters The note must be specified either by GUID (in which case it will be
        ...
        */
        emailNote(parameters: Evernote$NoteEmailParameters, cb: Evernote$Callback<void>): void;
        ...
        */
        shareNote(guid: string, cb: Evernote$Callback<string>): void;
        ...
        */
        stopSharingNote(guid: string, cb: Evernote$Callback<void>): void;
         ...
         * @param noteKey The 'noteKey' identifier from the Note that was originally created via
        a call to shareNote() and then given to a recipient to access.
         * @param authenticationToken An optional authenticationToken that identifies the user accessing the
        ...
        */
        authenticateToSharedNote(
            guid: string,
            noteKey: string,
            cb: Evernote$Callback<Evernote$AuthenticationResult>): void;
         ...
         * @param resultSpec Allows the client to indicate the type and quantity of
        information to be returned, allowing a saving of time and
        bandwidth.
         * @return  *     The result of the query, with information considered
        ...
        */
        findRelated(
            query: Evernote$RelatedQuery,
            resultSpec: Evernote$RelatedResultSpec,
            cb: Evernote$Callback<Evernote$RelatedResult>): void
    }
    ...
    */
    declare class SyncChunk {
        ...
        updateCount: number;
        notes: Evernote$Note[];
        notebooks: Evernote$Notebook[];
        tags: Evernote$Tag[];
        searches: Evernote$SavedSearch[];
        resources: Evernote$Resource[];
        expungedNotes: string[];
        expungedNotebooks: string[];
        expungedTags: string[];
        expungedSearches: string[];
        linkedNotebooks: Evernote$LinkedNotebook[];
    ...
    */
    declare class NoteMetadata {
        ...
        notebookGuid: string;
        tagGuids: string[];
        attributes: Evernote$NoteAttributes;
    ...
    */
    declare class RelatedResult {
        ...
        notebooks: Evernote$Notebook[];
        tags: Evernote$Tag[];
        containingNotebooks: Evernote$NotebookDescriptor[];
        constructor(args?: {
            notes?: Evernote$Note[],
            notebooks?: Evernote$Notebook[],
            tags?: Evernote$Tag[],
    ...
    */
    declare class User {
        ...
        active: boolean;
        shardId: string;
        attributes: Evernote$UserAttributes;
        accounting: Evernote$Accounting;
        premiumInfo: Evernote$PremiumInfo;
        businessUserInfo: Evernote$BusinessUserInfo;
        constructor(args?: {
            id?: number,
            username?: string,
            email?: string,
    ...
    */
    declare class ResourceAttributes {
        ...
        fileName: string;
        attachment: boolean;
        applicationData: Evernote$LazyMap;
        constructor(args?: {
            sourceURL?: string,
            timestamp?: number,
            latitude?: number,
    ...
    */
    declare class Resource {
        ...
        duration: number;
        active: boolean;
        recognition: Evernote$Data;
        attributes: Evernote$ResourceAttributes;
        updateSequenceNum: number;
        alternateData: Evernote$Data;
        constructor(args?: {
            guid?: string,
            noteGuid?: string,
            data?: Evernote$Data,
    ...
    */
    declare class SavedSearch {
        ...
        format: QueryFormat;
        updateSequenceNum: number;
        scope: Evernote$SavedSearchScope;
        constructor(args?: {
            guid?: string,
            name?: string,
            query?: string,
    ...
    */
    declare class Notebook {
        ...
        serviceCreated: number;
        serviceUpdated: number;
        publishing: Evernote$Publishing;
        published: boolean;
        stack: string;
        sharedNotebookIds: number[];
        sharedNotebooks: Evernote$SharedNotebook[];
        businessNotebook: Evernote$BusinessNotebook;
        contact: Evernote$User;
        restrictions: Evernote$NotebookRestrictions;
        constructor(args?: {
            guid?: string,
            name?: string,
            updateSequenceNum?: number,
    ...
    */
    declare class UserStoreClient {
         ...
         * @param clientName This string provides some information about the client for
        tracking/logging on the service.    It should provide information about
        the client's software and platform. The structure should be:
        application/version; platform/version; [ device/version ]
        E.g. "Evernote Windows/3.0.1; Windows/XP SP3".
         * @param edamVersionMajor This should be the major protocol version that was compiled by the
        client.    This should be the current value of the EDAM_VERSION_MAJOR
        constant for the client.
         * @param edamVersionMinor This should be the major protocol version that was compiled by the
        ...
        */
        checkVersion(
            ...
            cb: Evernote$Callback<boolean>): void;
         ...
         * @param locale The client's current locale, expressed in language[_country]
        format. E.g., "en_US". See ISO-639 and ISO-3166 for valid
        language and country codes.
         * @return  *     The bootstrap information suitable for this client.
        */
        getBootstrapInfo(locale: string, cb: Evernote$Callback<Evernote$BootstrapInfo>): void;
        ...
        */
        revokeLongSession(cb: Evernote$Callback<void>): void;
         ...
         * @param authenticationToken The authentication token for the user. This may not be a shared authentication
         ...
         * @return  *     The result of the authentication, with the token granting access to the
        ...
        */
        authenticateToBusiness(cb: Evernote$Callback<Evernote$AuthenticationResult>): void;
        ...
        */
        getUser(cb: Evernote$Callback<Evernote$User>): void;
        ...
        */
        getPublicUserInfo(username: string, cb: Evernote$Callback<Evernote$PublicUserInfo>): void;
        ...
        OAuth web service).
        */
        getNoteStoreUrl(cb: Evernote$Callback<string>): void
    }
    ...
    */
    declare class AuthenticationResult {
        ...
        expiration: number;
        user: Evernote$User;
        publicUserInfo: Evernote$PublicUserInfo;
        noteStoreUrl: string;
        webApiUrlPrefix: string;
    ...
    */
    declare class BootstrapProfile {
        name: string;
        settings: Evernote$BootstrapSettings;
        constructor(args?: {
            name: string,
            settings: Evernote$BootstrapSettings
        }): this
    ...
    */
    declare class BootstrapInfo {
        profiles: Evernote$BootstrapProfile[];
        constructor(args?: {
            profiles: Evernote$BootstrapProfile[]
        }): this
    }
