...
/* Summary: Added parts of the flow type from this flow-type repository, from aaronjensen and made some
  own manually change to make compatible with flow v58.0

  NOTE: More method type declaration, etc... will be added manually when needed.

  Resources:
  https://github.com/flowtype/flow-typed/blob/master/definitions/npm/redux-form_v5.x.x/flow_v0.22.x-v0.52.x/redux-form_v5.x.x.js
  https://gist.github.com/aaronjensen/54643af48aedb2f7eba424d9434ca99f
...
declare module 'redux-form' {
  ...
  declare type FunctionComponent<P, S> = (props?: P, S = void) => ?React$Element<any>;
