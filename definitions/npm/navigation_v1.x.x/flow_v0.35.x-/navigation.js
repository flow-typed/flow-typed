// @flow
/**
 * Flowtype definitions for navigation
 ...
 */
declare interface Navigation$StateInfo {
    ...
    key: string,
         ...
         */
        trackTypes?: boolean, [extras: string]: any
}
 ...
 */
declare class State mixins StateInfo {
     ...
     */
    truncateCrumbTrail(state: Navigation$State, crumbs: Navigation$Crumb[]): Navigation$Crumb[]
}
 ...
 * Url
 */
declare interface Navigation$HistoryManager {
...
history is disabled
*/
declare class HashHistoryManager mixins HistoryManager {
...
history is disabled
*/
declare class HTML5HistoryManager mixins HistoryManager {
...
declare class Crumb {
    ...
    crumb trail
    */
    constructor(data: any, state: Navigation$State, link: string, crumblessLink: string, last: boolean): this
}
...
declare class StateContext {
     ...
     * Crumb first
     */
    crumbs: Navigation$Crumb[];

    /**
     * Gets the next crumb
     */
    nextCrumb: Navigation$Crumb;
...
declare class StateNavigator {
     ...
     */
    stateContext: Navigation$StateContext;

    /**
     * Gets the browser Url manager
     */
    historyManager: Navigation$HistoryManager;

    /**
     * Gets a list of States
     */
    states: {
        [index: string]: Navigation$State
    };
     ...
     */
    constructor(states: Navigation$StateInfo[]): this;
     ...
     */
    constructor(states: Navigation$StateInfo[], historyManager: Navigation$HistoryManager): this;

    /**
     * Configures the StateNavigator
     * @param stateInfos A collection of State Infos
     */
    configure(stateInfos: Navigation$StateInfo[]): void;
     ...
     */
    configure(
        stateInfos: Navigation$StateInfo[],
        historyManager: Navigation$HistoryManager): void;
    ...
    */
    navigate(
        stateKey: string,
        navigationData: any,
        historyAction: "add" | "replace" | "none"): void;
