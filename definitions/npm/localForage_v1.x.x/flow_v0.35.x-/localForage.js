// @flow
/**
 * Flowtype definitions for localForage
...
declare interface LocalForageDbMethods {
    getItem<T>(key: string): Promise<T>,
        ...
        iterate(
            iteratee: (value: any, key: string, iterationNumber: number) => any): Promise<any>,
        iterate(
...
declare type LocalForageDriver = {
    _driver: string,
...
declare module 'localforage' {
    ...
    declare module.exports: typeof localforage
}