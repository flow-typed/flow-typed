/**
 * Flowtype definitions for azure
...
declare module 'azure' {
    declare export class TableService mixins BatchServiceClient {
         ...
         * @constructor  * 
         * @extends  {ServiceClient}
         * @param  The storage account or the connection string.
         * @param  The storage access key.
         * @param  The host address.
         * @param  The authentication provider.
         */
        ...
        getServiceProperties(
            ...
            callback: StorageServicePropertiesCallback): void;
        setServiceProperties(
            serviceProperties: StorageServiceProperties,
            callback: StorageCallbackVoid): void;
        setServiceProperties(
            serviceProperties: StorageServiceProperties,
            options: TimeoutIntervalOptions,
            callback: StorageCallbackVoid): void;
        ...
        getTable(
            table: string,
            options: TimeoutIntervalOptions,
            callback?: TableRequestCallback): void;
        ...
        createTableIfNotExists(
            table: string,
            options: TimeoutIntervalOptions,
            callback?: CreateTableIfNotExistsCallback): void;
        deleteTable(table: string, callback?: DeleteTableCallback): void;
        deleteTable(
            table: string,
            options: TimeoutIntervalOptions,
            callback?: DeleteTableCallback): void;
        ...
        queryEntity(
            ...
            partitionKey: string,
            rowKey: string,
            callback?: QueryEntityCallback): void;
        queryEntity(
            table: string,
            partitionKey: string,
            rowKey: string,
        ...
        queryEntities(
            ...
            options: TimeoutIntervalOptions,
            callback?: QueryEntitiesCallback): void;
        insertEntity(
            tableName: string,
            entityDescriptor: Entity,
            callback?: ModifyEntityCallback): void;
        insertEntity(
            tableName: string,
            entityDescriptor: Entity,
            options: TimeoutIntervalOptions,
        ...
        deleteEntity(
            tableName: string,
            entityDescriptor: Entity,
            callback?: DeleteEntityCallback): void;
        deleteEntity(
            tableName: string,
            entityDescriptor: Entity,
            options: UpdateEntityOptions,
    ...
    declare export class BlobService mixins StorageServiceClient {
         ...
         * @param  The storage access key.
         * @param  The host address.
         * @param  The Shared Access Signature token.
         */
        ...
        createContainer(
            ...
            callback: StorageCallback<ContainerResult>): void;
        ...
        createContainerIfNotExists(
            container: string,
            options: CreateContainerOptions,
            callback: StorageCallback<boolean>): void;
        ...
        listBlobs(
            ...
            callback: ListBlobsCallback): void;
        ...
        getBlobProperties(
            ...
            callback: StorageCallback<BlobResult>): void;
        ...
        getBlob(
            container: string,
            blob: string,
            callback: StorageCallback<BlobResult>): stream.Readable;
        getBlob(
            container: string,
            blob: string,
        ...
        getBlobToText(
            ...
            blob: string,
            options: ReadBlobOptions,
            callback: GetBlobToTextCallback): void;
        ...
        */
        ...
        createBlobSnapshot(
            ...
            callback: StorageCallback<string>): void;
        ...
        generateSharedAccessSignature(
            container: string,
            blob: string,
            sharedAccessPolicy: SharedAccessPolicy): SharedAccessSignatureResult;
        ...
        createBlob(
            ...
            blob: string,
            blobType: string,
            callback: StorageCallback<string>): stream.Writable;
        createBlob(
            container: string,
            blob: string,
            blobType: string,
        ...
        listBlobRegions(
            ...
            callback: StorageCallback<PageRange[]>): void;
        ...
        putBlockBlobFromFile(
            ...
            blob: string,
            localFileName: string,
            callback: StorageCallback<BlobResult>): SpeedSummary;
        putBlockBlobFromFile(
            container: string,
            blob: string,
            localFileName: string,
        ...
        */
        commitBlobBlocks(
            ...
            blob: string,
            blockList: BlockList,
            callback: StorageCallback<BlockList>): void;
        commitBlobBlocks(
            container: string,
            blob: string,
            blockList: BlockList,
        ...
        */
        ...
        acquireLease(
            ...
            callback: StorageCallback<LeaseResult>): void;
    ...
    declare export class QueueService mixins StorageServiceClient {
        ...
        createQueue(
            ...
            callback: StorageCallback<QueueResult>): void;
        ...
        */
        createMessage(
            queue: string,
            messageText: string,
            callback: StorageCallback<QueueMessageResult>): void;
        createMessage(
            queue: string,
            messageText: string,
    ...
    declare export function createSqlService(
        ...
        host?: string,
        acsHost?: string,
        authenticationProvider?: string): SqlService
    declare export function createServiceManagementService(
        subscriptionId: string,
        authentication: string,
        hostOptions: string): ServiceManagementService
    declare export function createSqlManagementService(
        subscriptionId: string,
        authentication: string,
        hostOptions: string): SqlManagementService
    declare type RoleEnvironmentInterface = {
        incorrectCallbackErr: string,
        clientId: string,
    ...
    declare export class ServiceClient mixins events.EventEmitter {
    ...
    declare export class BatchServiceClient mixins StorageServiceClient {
        operations: any[];
        ...
        commitBatch(
            options: any,
            callback: (error: any, operationResponses: any[], response: any) => void): void;
    ...
    declare export class LinearRetryPolicyFilter mixins Filter {
        constructor(retryCount?: number, retryInterval?: number): this;
        retryCount: number;
        retryInterval: number;
        handle(requestOptions: any, next: Function): void
    }
    declare export class ExponentialRetryPolicyFilter mixins Filter {
    ...
    declare export class SharedAccessSignature {
        ...
        generateSignedQueryString(
            ...
            queryString: Dictionary<string>,
            resourceType: string,
            sharedAccessPolicy: SharedAccessPolicy): Dictionary<string>;
    ...
    declare module 'ServiceSettings' {
        declare     export var DEFAULT_PROTOCOL: string;
        declare     export class NoMatchError mixins Error {
            name: string;
            message: string;
            constr: any;
            constructor(): this;
        ...
        declare     export function getValidator(
            ...
            isRequired: boolean,
            atLeastOne: boolean): ValidatorFunction
    ...
    declare export class StorageServiceSettings {
        ...
        _createStorageServiceSettings(
            ...
            tableEndpointUri: string): StorageServiceSettings;
        ...
        createExplicitlyOrFromEnvironment(
            storageAccount: string,
            storageAccessKey: string,
            host: string): StorageServiceSettings;
    ...
    declare export type StorageServiceStatsCallback = {} & StorageCallback

    declare export type StorageServicePropertiesCallback = {} & StorageCallback
    ...
    declare export type MetadataOptions = {
        metadata?: StorageMetadata
    } & TimeoutIntervalOptions

    declare export type StorageAclOptions = {
        leaseId?: string,
        signedIdentifiers: SignedIdentifier[]
    } & TimeoutIntervalOptions
    ...
    declare export type QueryTablesOptions = {
    ...
    declare export type QueryEntitiesResultContinuation = {
        tableQuery: TableQuery,
    ...
    declare export type UpdateEntityOptions = {
        checkEtag?: boolean
    } & TimeoutIntervalOptions
    ...
    declare export interface Entity {
        PartitionKey: string,
            RowKey: string,
            Timestamp?: Date,
            etag?: string, [property: string]: string | number | boolean | Date
    }
    declare export type LeaseIdOptions = {
        leaseId?: string
    } & TimeoutIntervalOptions

    declare export type AccessConditionsOptions = {
        accessConditions?: StorageAccessCondition
    } & TimeoutIntervalOptions

    declare export type LeaseAccessConditionsOptions = {
        accessConditions?: StorageAccessCondition
    } & LeaseIdOptions

    declare export type ListContainersOptions = {
        prefix?: string,
        maxresults?: number,
        marker: string,
        include?: string
    ...
    declare export type CreateContainerOptions = {
        metadata?: StorageMetadata,
        publicAccessLevel?: string
    } & TimeoutIntervalOptions

    declare export type GetContainerPropertiesOptions = {
        leaseId?: string
    } & TimeoutIntervalOptions

    declare export type GetContainerMetadataOptions = {
        accessConditions?: StorageAccessCondition
    } & GetContainerPropertiesOptions

    declare export type ListBlobsOptions = {
        prefix?: string,
        delimiter?: string
    ...
    declare export type GetBlobPropertiesOptions = {
        snapshotId?: string
    } & LeaseAccessConditionsOptions

    declare export type SetBlobPropertiesOptions = {
        contentType?: string,
        contentEncoding?: string,
        contentLanguage?: string,
        contentMD5?: string,
    ...
    declare export type ReadBlobOptions = {
        rangeStart?: string,
        rangeEnd?: string,
    ...
    declare export type DeleteBlobOptions = {
        deleteSnapshots?: string
    } & GetBlobPropertiesOptions

    declare export type BlobSnapshotOptions = {
        metadata?: StorageMetadata
    } & GetBlobPropertiesOptions

    declare export type CopyBlobOptions = {
        sourceLeaseId?: string,
        sourceAccessConditions: StorageAccessCondition
    } & BlobSnapshotOptions

    declare export type UploadBlobOptions = {
        metadata?: StorageMetadata,
    ...
    declare export type CreatePagesOptions = {
        contentMD5?: string,
        useTransactionalMD5?: boolean
    } & LeaseAccessConditionsOptions

    declare export type PageRangeOptions = {
        snapshotId?: string,
        rangeStart?: number,
        rangeEnd?: number
    } & LeaseIdOptions

    declare export type UploadBlockBlobOptions = {
        blockIdPrefix?: string
    } & UploadBlobOptions

    declare export type CreateBlockOptions = {
        contentMD5?: string,
        useTransactionalMD5?: boolean
    } & LeaseAccessConditionsOptions

    declare export type LeaseOptions = {
        leaseDuration?: string,
        proposedLeaseId?: string
    } & AccessConditionsOptions

    declare export type BreakLeaseOptions = {
    ...
    declare export type ListQueuesOptions = {
        prefix?: string,
        maxresults?: number,
        marker: string,
        include?: string
    ...
    declare export type CreateQueueMessageOptions = {
        messagettl?: number,
        visibilitytimeout?: number
    } & TimeoutIntervalOptions

    declare export type PeekQueueMessagesOptions = {
        numofmessages?: number
    } & TimeoutIntervalOptions

    declare export type GetQueueMessagesOptions = {
        peekonly?: boolean,
        visibilitytimeout?: number
    } & PeekQueueMessagesOptions

    declare export type UpdateQueueMessagesOptions = {
        messagetext?: string
    } & TimeoutIntervalOptions
    ...
    declare class StorageServiceClient mixins ServiceClient {
