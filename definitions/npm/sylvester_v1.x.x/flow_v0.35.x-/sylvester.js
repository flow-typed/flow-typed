/**
 * Flowtype definitions for sylvester
...
declare module 'Sylvester' {
    ...
    declare interface PlaneStatic {
        ...
        create(anchor: Array<number>| Vector, normal: Array<number>| Vector): Plane,
             ...
             */
            create(
                anchor: Array<number>| Vector,
                v1: Array<number>| Vector,
                v2: Array<number>| Vector): Plane,
            XY: Plane,
            YZ: Plane,
            ZX: Plane,
            YX: Plane
    ...
    declare export var precision: number;
}
declare interface Vector {
    ...
    elements: Array<number>,
         ...
         * @param  The vector to compare equality.
         */
         ...
         * @param  The function to apply to each element (x, i) => {}.
         */
         ...
         * @param  The other vector to calculate the angle.
         */
         ...
         * @param  The value by which to multiply the vector.
         */
        ...
        /**
         * Returns the scalar product of the vector with the argument. Both vectors must have equal dimensionality.: {Vector|Array<number>} vector The other vector.
         */
         ...
         * @param  The value to snap to.
         */
        snapTo(x: number): Vector,

        /**
         * Returns the vector's distance from the argument, when considered as a point in space.
         * @param  The object to calculate the distance.
         */
...
declare interface Plane {
    ...
    anchor: Vector,
         ...
         * @param  The anchor vector.
         * @param  The first direction vector.
         * @param  The second direction vector.
         */
        setVectors(
            anchor: Array<number>| Vector,
            v1: Array<number>| Vector,
...
declare
var Vector: Sylvester.VectorStatic;
declare
var Matrix: Sylvester.MatrixStatic;
declare
var Line: Sylvester.LineStatic;
declare
var Plane: Sylvester.PlaneStatic;
/**
 * Constructor function.
 * @param  The elements.
 */
declare
function $V(elements: Vector | Array<number>): Vector
/**
 * Constructor function.
 * @param  The elements.
 */
declare
function $M(elements: Array<number>| Array<Array<number >> | Vector | Matrix): Matrix
/**
 * Constructor function.
 * @param Array <number>|Vector anchor The anchor vector.
 * @param Array <number>|Vector direction The direction vector.
 */
declare
function $L(anchor: Array<number>| Vector, direction: Array<number>| Vector): Line
/**
 * Constructor function.
 * @param  The anchor vector.
 * @param  The normal vector.
 */
declare
function $P(anchor: Array<number>| Vector, normal: Array<number>| Vector): Plane