declare module 'flux-standard-action' {
  // declare interface FluxStandardAction<ActionType: string | Symbol, Payload: any, Meta: any> {
  //   /**
  ...
  //   meta?: Meta;
  // }
  // declare type FSA<ActionType, Payload, Meta> = FluxStandardAction<ActionType, Payload, Meta>;
