// @flow
/**
 * Flowtype definitions for ng-grid
    ...
    declare     export interface IDomUtilityService {
        eventStorage: any,
            ...
            AssignGridContainers(
                ...
                grid: ngGrid$IGridInstance): void,
            getRealWidth(obj: ngGrid$IDimension): number,
            UpdateGridLayout($scope: ngGrid$IGridScope, grid: ngGrid$IGridInstance): void,
            setStyleText(grid: ngGrid$IGridInstance, css: string): void,
            BuildStyles($scope: ngGrid$IGridScope, grid: ngGrid$IGridInstance, digest: boolean): void,
            setColLeft(col: ngGrid$IColumn, colLeft: number, grid: ngGrid$IGridInstance): void,
