/**
 * Flowtype definitions for firebase-token-generator
...
declare class FirebaseTokenGenerator {
     ...
     * @constructor  * 
     * @param  The secret for the Firebase being used (get yours from the Firebase Admin Console).
     */
     ...
     * @param  JSON data that will be passed to the Firebase Rules API once a client authenticates. Unless the
    "admin" flag is set, it must contain a "uid" key, and if it does it must be a string of length
    256 or less.
     * @param  The developer-supplied options for this token. Supported options are:
...
declare module 'firebase-token-generator' {
    declare module.exports: typeof FirebaseTokenGenerator
}