...
declare module 'tesseract.js' {
					declare module.exports: TesseractStatic


}

declare module 'Tesseract' {
	declare type ImageLike = string | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | CanvasRenderingContext2D | File | Blob | ImageData | Buffer;
	...
	declare interface TesseractJob {
	...
	declare interface TesseractStatic {
