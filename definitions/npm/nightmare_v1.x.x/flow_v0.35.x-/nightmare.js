...
declare module 'nightmare' {
		...
		constructor(options?: Nightmare.IConstructorOptions): this;
		...
		evaluate<T1, T2, R>(
		fn: (arg1: T1, arg2: T2) => R, cb: (result: R) => void, arg1: T1, arg2: T2
	): Nightmare;
		evaluate<T1, T2, T3, R>(
		fn: (arg1: T1, arg2: T2, arg3: T3) => R, cb: (result: R) => void, arg1: T1, arg2: T2, arg3: T3
	): Nightmare;
		wait(): Nightmare;
		...
		on(
		event: "navigationRequested", cb: (url: string, type: string, willNavigate: boolean, main: boolean) => void
	): Nightmare;
		on(
		event: "resourceRequested", cb: (
		requestData: Nightmare.IRequest, networkRequest: Nightmare.INetwordRequest
	) => void
	): Nightmare;
		on(
		event: "resourceReceived", cb: (response: Nightmare.IResponse) => void
	): Nightmare;
		on(
		event: "resourceError", cb: (resourceError: Nightmare.IResourceError) => void
	): Nightmare;
		on(
		event: "consoleMessage", cb: (msg: string, lineNumber: number, sourceId: number) => void
	): Nightmare;
		...
		on(
		event: "error", cb: (msg: string, trace?: Nightmare.IStackTrace[]) => void
	): Nightmare;
...
declare module 'Nightmare' {
		declare export interface IConstructorOptions {
		timeout?: any,
		interval?: any,
		port?: number,
		weak?: boolean,
	...
	declare export interface INetwordRequest {
		abort(): void,
	...
	declare export interface IResourceError {
		id: number,
		url: string,
		errorCode: number,
		errorString: string
	...
	declare export interface IStackTrace {
		file: string,
		line: number,
		function?: string
	}
