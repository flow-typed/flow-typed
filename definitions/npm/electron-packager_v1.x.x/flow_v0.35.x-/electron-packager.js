/**
 * Flowtype definitions for electron-packager
...
export interface ElectronPackager$Options {
    ...
    dir: string,
        ...
        */
         ...
         */
        version - string?: ElectronPackager$VersionString,
...
export interface ElectronPackager$Packager {
    ...
    */
    (opts: ElectronPackager$Options, callback: ElectronPackager$Callback): void
}
declare module 'electron-packager' {
    declare var packager: ElectronPackager$Packager;
