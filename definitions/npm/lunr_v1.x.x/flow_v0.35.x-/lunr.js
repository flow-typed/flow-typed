...
declare module 'tokenizer' {
    ...
    declare     var registeredFunctions: {
        [label: string]: lunr$TokenizerFunction
    };
     ...
     * @param  The function to register.
     * @param  The label to register this function with
     * @memberOf  tokenizer
    */
    declare     function registerFunction(fn: lunr$TokenizerFunction, label: string): void
     ...
     * @param  The label of the serialised tokenizer.
     * @returns  * 
     * @memberOf  tokenizer
    */
    declare     function load(label: string): lunr$TokenizerFunction
}


declare interface lunr$TokenizerFunction {
    (obj: any): string[]
}
...
declare interface lunr$IPipelineFunction {
    (token: string): string,
...
declare class Pipeline {
    ...
    */
    registerFunction(fn: lunr$IPipelineFunction, label: string): void;

    /**
     * Warns if the function is not registered as a Pipeline function.
     * @param fn The function to check for.
     */
    warnIfFunctionNotRegistered(fn: lunr$IPipelineFunction): void;
    ...
    */
    add(...functions: lunr$IPipelineFunction[]): void;
    ...
    */
    after(existingFn: lunr$IPipelineFunction, newFn: lunr$IPipelineFunction): void;
     ...
     * @param newFn The new function to add to the pipeline.
    */
    before(existingFn: lunr$IPipelineFunction, newFn: lunr$IPipelineFunction): void;

    /**
     * Removes a function from the pipeline.
     * @param fn The function to remove from the pipeline.
     */
    remove(fn: lunr$IPipelineFunction): void;
    ...
    */
    load(serialised: any): lunr$Pipeline
}
...
declare class Node {
     ...
     */
    constructor(idx: number, val: number, next: lunr$Node): this
}
...
declare class SortedSet<T>{
    ...
    */
     ...
     */
    intersect(otherSet: lunr$SortedSet<T>): lunr$SortedSet<T>;
     ...
     */
    union(otherSet: lunr$SortedSet<T>): lunr$SortedSet<T>;

    /**
     * Makes a copy of this set
     */
    clone(): lunr$SortedSet<T>;
     ...
     */
    load<T>(serialisedData: T[]): lunr$SortedSet<T >
}

declare interface lunr$IIndexField {
...
declare interface lunr$IIndexSearchResult {
    ref: any,
        score: number
}
...
*/
declare class Index {
    eventEmitter: lunr$EventEmitter;
    documentStore: lunr$Store<string>;
    tokenStore: lunr$TokenStore;
    corpusTokens: lunr$SortedSet<string>;
    pipeline: lunr$Pipeline;
    _fields: lunr$IIndexField[];
    _ref: string;
    _idfCache: {
        [key: string]: string
    };
    ...
    */
    search(query: string): lunr$IIndexSearchResult[];
    ...
    */
    documentVector(documentRef: string): lunr$Vector;
    ...
    */
     ...
     * @param serialisedData The serialised set to load.
    */
    load(serialisedData: any): lunr$Index
}
...
declare class Store<T>{
     ...
     */
    set(id: string, tokens: lunr$SortedSet<T>): void;

    /**
     * Retrieves the tokens from the store for a given key.
     * @param id The key to lookup and retrieve from the store.
     */
    get(id: string): lunr$SortedSet<T>;
     ...
     */
    load<T>(serialisedData: any): lunr$Store<T >
}

declare interface lunr$ITokenDocument {
    ref: number,
        tf: number
}
...
declare class TokenStore {
    root: {
        [token: string]: lunr$TokenStore
    };
    docs: {
        [ref: string]: lunr$ITokenDocument
    };
    length: number;
    ...
    */
    add(token: string, doc: lunr$ITokenDocument, root?: lunr$TokenStore): void;
     ...
     */
    getNode(token: string): lunr$TokenStore;
    ...
    */
    get(token: string, root: lunr$TokenStore): {
        [ref: string]: lunr$ITokenDocument
    };
    count(token: string, root: lunr$TokenStore): number;
     ...
     */
    load(serialisedData: any): lunr$TokenStore
}
...
declare module 'utils' {
     ...
     * @param  The object to convert to a string.
