/**
 * Flowtype definitions for mongoose
...
declare module 'mongoose' {
    declare class NativeBuffer mixins global.Buffer {}
    declare class NativeDate mixins global.Date {}
    declare class NativeError mixins global.Error {}
    declare export var DocumentProvider: any;
    declare export var Mongoose: (...args: any[]) => typeof mongoose;
    declare type Mongoose = typeof mongoose;
    declare export var SchemaTypes: typeof undefined;
    declare export var STATES: Object;
    declare export var connection: Connection;
    declare export var mongo: typeof mongodb;
    ...
    */
    ...
    declare class CastError mixins Error {
    ...
    declare class ConnectionBase mixins events.EventEmitter {
     ...
     * See the node-mongodb-native driver instance for options that it understands. 
     */
    declare type ConnectionOpenOptions = {
     ...
     * See the node-mongodb-native driver instance for options that it understands. 
     */
    declare type ConnectionOpenSetOptions = {
    ...
    declare type ConnectionOptions = {} & ConnectionOpenOptions & ConnectionOpenSetOptions

    declare var Collection: Collection;
    ...
    declare class Connection mixins ConnectionBase {
    ...
    declare class Error mixins global.Error {
    ...
    declare class Schema mixins events.EventEmitter {
        ...
        */
        ...
        post<T>(
            method: string,
            fn: (doc: T, next: (err?: NativeError) => void, ...otherArgs: any[]) => void): this;
        ...
        pre(
            method: string,
            parallel: boolean,
            fn: (next: (err?: NativeError) => void, done: () => void) => void,
            errorCb?: (err: Error) => void): this;
    ...
    declare class MongooseDocument mixins MongooseDocumentOptionals {
        ...
        */
        invalidate(
            ...
            value: any,
            kind?: string): ValidationError | boolean;
    ...
    declare class Subdocument mixins MongooseDocument {
    ...
    declare class Array<T>mixins global.Array<T>{
        ...
        */
         ...
         * Marks the entire array as modified, which if saved, will store it as a $set operation,
        potentially overwritting any changes that happen between when you retrieved the object
        and when you save it.Wraps Array#splice with proper change tracking and casting.
         * Marks the entire array as modified, which if saved, will store it as a $set operation,
        potentially overwritting any changes that happen between when you retrieved the object
        and when you save it.
        */
    ...
    declare class DocumentArray<T>mixins Types$Array<T>{
         ...
         */
        id(id: Types$ObjectId | string | number | NativeBuffer): T;
    ...
    declare class Buffer mixins global.Buffer {
    ...
    declare var ObjectId: Types$ObjectIdConstructor;

    declare type Types$ObjectIdConstructor = typeof undefined & {
        (s?: string | number): mongodb.ObjectID
    };

    declare type Types$ObjectId = {}

    declare class Embedded mixins MongooseDocument {
         ...
         */
        parentArray(): Types$DocumentArray<MongooseDocument>;
    ...
    declare class Query<T>mixins DocumentQuery<T, any>{}
    declare class DocumentQuery<T, DocType>mixins mquery {
        ...
        */
         ...
         * When called with one argument, the most recent path passed to where() is used.
         */
        in (val: any[]): this; in (path: string, val: any[]): this;
        ...
        */
        ...
        remove(
            criteria: Object | Query<any>,
            callback?: (err: any) => void): Query<mongodb.WriteOpResult>;
        ...
        */
         ...
         */
        toConstructor<T>(): (...args: any[]) => Query<T>;
        toConstructor<T, Doc>(): (...args: any[]) => DocumentQuery<T, Doc>;
    ...
    declare type QueryFindOneAndUpdateOptions = {
    ...
    declare type QueryUpdateOptions = {
    ...
    declare class Array mixins SchemaType {
    ...
    declare class String mixins SchemaType {
    ...
    declare class DocumentArray mixins Array {
    ...
    declare class Number mixins SchemaType {
    ...
    declare class Date mixins SchemaType {
    ...
    declare class Buffer mixins SchemaType {
    ...
    declare class Boolean mixins SchemaType {
    ...
    declare class ObjectId mixins SchemaType {
    ...
    declare class Mixed mixins SchemaType {
    ...
    declare class Embedded mixins SchemaType {
    ...
    declare export var PromiseProvider: any;
    declare export var Model: Model<any>;
    declare type Model<T>= {
        ...
        */
        ...
        findById(
            ...
            callback?: (err: any, res: T) => void): DocumentQuery<T,
        T>,
        findById(
            id: Object | string | number,
            projection: Object,
         ...
         */
        $where(argument: string | Function): DocumentQuery<T,
        T>,

        /**
         * Performs aggregations on the models collection.
         * If a callback is passed, the aggregate is executed and a Promise is returned.
        If a callback is not passed, the aggregate itself is returned.... aggregation pipeline operator(s) or operator array
        */
        ...
        count(
            conditions: Object,
            callback?: (err: any, count: number) => void): Query<number>,
        ...
        */
         ...
         * @param projection optional fields to return
         */
        find(callback?: (err: any, res: T[]) => void): DocumentQuery<T[],
        T>,
        find(
            conditions: Object,
            callback?: (err: any, res: T[]) => void): DocumentQuery<T[],
         ...
         * @param id value of _id to query by
        */
        findByIdAndRemove(): DocumentQuery<T,
        T>,
        findByIdAndRemove(
         ...
         * @param id value of _id to query by
         */
        findByIdAndUpdate(): DocumentQuery<T,
        T>,
        findByIdAndUpdate(
            id: Object | number | string,
            update: Object,
        ...
        Executes immediately if callback is passed else a Query object is returned.
        */
        findOneAndRemove(): DocumentQuery<T,
        T>,
        findOneAndRemove(conditions: Object, callback?: (err: any, res: T) => void): DocumentQuery<T,
        T>,
        findOneAndRemove(
            conditions: Object,
            options: {
        ...
        */
        findOneAndUpdate(): DocumentQuery<T,
        T>,
        findOneAndUpdate(
            conditions: Object,
            update: Object,
        ...
        geoNear(
            ...
            callback?: (err: any, res: T[], stats: any) => void): DocumentQuery<T[],
        T>,
    ...
    declare type Document = {
         ...
         */
        ___v?: number
    } & MongooseDocument & & ModelProperties
    ...
    declare type ModelFindOneAndUpdateOptions = {
    ...
    declare interface ModelUpdateOptions {
        ...
        safe?: boolean,
            ...
            */
             ...
             */
            overwrite?: boolean, [other: string]: any
    }
