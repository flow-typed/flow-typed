...
declare module 'jdataview' {
				declare class jDataView extends DataView {
		constructor(byteCount: number, offset?: number, length?: number, littleEndian?: boolean): this;
		constructor(buffer: string, offset?: number, length?: number, littleEndian?: boolean): this;
		constructor(buffer: jDataView.Bytes, offset?: number, length?: number, littleEndian?: boolean): this;
		buffer: any;
		byteOffset: number;
		byteLength: number;
		...
		getBytes(
		length: number, byteOffset?: number, littleEndian?: boolean, toArray?: boolean
	): number[];
...
declare module 'npm$namespace$jDataView' {
	...
	declare class Int64 extends Uint64 {
