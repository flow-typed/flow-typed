// @flow
/**
 * Flowtype definitions for jdataview
...
declare class jDataView mixins DataView {
...
declare class Uint64 {
    ...
    valueOf(): number;
    fromNumber(number: number): jDataView$Uint64
}

declare class Int64 mixins Uint64 {
    fromNumber(number: number): jDataView$Int64
}