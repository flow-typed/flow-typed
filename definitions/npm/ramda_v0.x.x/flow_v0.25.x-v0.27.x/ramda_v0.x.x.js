...
declare module "ramda" {
  ...
  declare class Find {
    ...
    findIndex<K, V, T: Array<V> | { [key: K]: V }>(
      fn: UnaryPredicateFn<V>,
      xs: T
    ): number;
    findIndex<K, V, T: Array<V> | { [key: K]: V }>(
    ...
    findLastIndex<K, V, T: Array<V> | { [key: K]: V }>(
      fn: UnaryPredicateFn<V>,
      xs: T
    ): number;
    findLastIndex<K, V, T: Array<V> | { [key: K]: V }>(
  ...
  declare type AccumIterator<A, B, T> =
    | ((acc: T, x: A, ...args: Array<void>) => [T, B])
    | ((acc: T, ...args: Array<void>) => (x: A) => [T, B]);
  ...
  declare class RReduce {
    ...
    reduce<T, TResult>(
      fn: (acc: TResult, elem: T) => TResult
    ): (acc: TResult, list: Array<T>) => TResult;
    reduce<T, TResult>(
      fn: (acc: TResult, elem: T) => TResult,
      acc: TResult
    ): (list: Array<T>) => TResult;
    ...
    reduceBy<T, TResult>(
      ...
      keyFn: (elem: T) => string
    ) => (list: Array<T>) => { [key: string]: TResult };
    reduceBy<T, TResult>(
      fn: (acc: TResult, elem: T) => TResult
    ): (
      acc: TResult,
    ...
    scan<T, TResult>(
      fn: (acc: TResult, elem: T) => TResult
    ): (acc: TResult, list: Array<T>) => Array<TResult>;
    scan<T, TResult>(
      fn: (acc: TResult, elem: T) => TResult,
      acc: TResult
    ): (list: Array<T>) => Array<TResult>;
    scan<T, TResult>(
      fn: (acc: TResult, elem: T) => TResult
    ): (acc: TResult) => (list: Array<T>) => Array<TResult>;
  }
  ...
  declare class RList<T> {
    ...
    */
    ...
    into<I, T, A: Array<T>, R: Array<*> | string | Object>(
      accum: R,
      xf: (a: A) => I,
      input: A
    ): R;
    into<I, T, A: Array<T>, R>(
      accum: Transformer<I, R>,
      xf: (a: A) => R,
      input: A
    ): R;
    indexBy<V, T: { [key: string]: V }>(
      fn: (x: T) => string,
      xs: Array<T>
    ): { [key: string]: T };
    indexBy<V, T: { [key: string]: V }>(
    ...
    insertAll<T>(
      index: number,
      ...rest: Array<void>
    ): (elem: Array<T>) => (src: Array<T>) => Array<T>;
    insertAll<T>(
      index: number,
      elems: Array<T>,
      ...rest: Array<void>
    ...
    pair<A, B>(a: A): (b: B) => [A, B];
    partition<K, V, T: Array<V> | { [key: K]: V }>(
      fn: UnaryPredicateFn<V>,
      xs: T
    ): [T, T];
    partition<K, V, T: Array<V> | { [key: K]: V }>(
    ...
    pluck<V, K: string | number, T: Array<Array<V> | { [key: string]: V }>>(
      k: K,
      xs: T
    ): Array<V>;
    pluck<V, K: string | number, T: Array<Array<V> | { [key: string]: V }>>(
    ...
    unfold<T, TResult>(
      fn: (seed: T) => Array<TResult> | boolean,
      seed: T
    ): Array<TResult>;
    unfold<T, TResult>(
      fn: (seed: T) => Array<TResult> | boolean
    ): (seed: T) => Array<TResult>;
  ...
  declare class RObject {
    ...
    mapObjIndexed(
      fn: (val: any, key: string, o: Object) => any,
      o: { [key: string]: any }
    ): { [key: string]: any };
    mapObjIndexed(
      fn: (val: any, key: string, o: Object) => any,
      ...args: Array<void>
    ): (o: { [key: string]: any }) => { [key: string]: any };
    ...
    mergeWithKey(
      fn: (v0: string, v1: any, v2: any) => any,
      o1: Object,
      o2: Object
    ): Object;
    mergeWithKey(
    ...
    pick(
      keys: Array<string>
    ): (val: { [key: string]: any }) => { [key: string]: any };
    pickAll(
      keys: Array<string>,
      val: { [key: string]: any }
    ): { [key: string]: ?any };
    ...
    project(
      keys: Array<string>,
      val: Array<{ [key: string]: any }>
    ): Array<{ [key: string]: any }>;
    project(
      keys: Array<string>
    ): (val: Array<{ [key: string]: any }>) => Array<{ [key: string]: any }>;
    ...
    where(predObj: { [key: string]: UnaryPredicateFn<any> }): (
      o: Object
    ) => boolean;
  ...
  declare class RLogic {
    allPass(
      fns: Array<(...args: Array<any>) => boolean>
    ...
    cond(
      fns: Array<
        [(...args: Array<any>) => boolean, (...args: Array<any>) => any]
      >
    ): (...args: Array<any>) => any;
    ...
    ifElse(
      ...
      f1: (...args: Array<any>) => any,
      f2: (...args: Array<any>) => any
    ): (...args: Array<any>) => any;
    ifElse(
      cond: (...args: Array<any>) => boolean
    ): (
      f1: (...args: Array<any>) => any
    ) => (f2: (...args: Array<any>) => any) => (...args: Array<any>) => any;
    ...
    pathSatisfies(
      cond: (x: any) => boolean
    ): (path: Array<string>, o: Object) => boolean;
    pathSatisfies(
      cond: (x: any) => boolean
    ): (path: Array<string>) => (o: Object) => boolean;
  ...
  declare class RFunction {
    ...
    apply<T, V>(fn: (...args: Array<T>) => V): (xs: Array<T>) => V;
    applySpec(
      spec: NestedObject<(x: any) => any>
    ): (...args: Array<any>) => NestedObject<any>;
    ...
    ): (arg1: B, arg0?: A) => TResult;
    flip<A, B, C, TResult>(
      fn: (arg0: A, arg1: B, arg2: C) => TResult
    ): (arg2: C, arg1: B, arg0?: A) => TResult;
    flip<A, B, C, D, TResult>(
      fn: (arg0: A, arg1: B, arg2: C, arg3: D) => TResult
    ): (arg3: D, arg2: C, arg1: B, arg0?: A) => TResult;
    flip<A, B, C, D, E, TResult>(
      fn: (arg0: A, arg1: B, arg2: C, arg3: D, arg4: E) => TResult
    ): (arg4: E, arg3: D, arg2: C, arg1: B, arg0?: A) => TResult;
    identity<T>(x: T): T;
    juxt<T>(
      fns: Array<(...args: Array<any>) => T>
