...
declare module 'phantom' {
		...
		addCookie(
		name: string, value: string, domain: string, callback?: (res: boolean) => void
	): void,
	...
	declare interface WebPage {
		...
		evaluate<T, R>(
		callback: (arg: T) => R, returnCallback: (result: R) => void, arg: T
	): void,
		evaluate<T1, T2, R>(
		callback: (arg1: T1, arg2: T2) => R, returnCallback: (result: R) => void, arg1: T1, arg2: T2
	): void,
		evaluate<T1, T2, T3, R>(
		callback: (arg1: T1, arg2: T2, arg3: T3) => R, returnCallback: (result: R) => void, arg1: T1, arg2: T2, arg3: T3
	): void,
		...
		sendEvent(
		keyboardEventType: string, key: string, null1?: void, null2?: void, modifier?: number
	): void,
	...
	declare function create(
		arg1: string, arg2: string, options: ICreateOptions, callback: (ph: PhantomJS) => void
	): void

	declare function create(
		arg1: string, arg2: string, arg3: string, callback: (ph: PhantomJS) => void
	): void

	declare function create(
		arg1: string, arg2: string, arg3: string, options: ICreateOptions, callback: (ph: PhantomJS) => void
	): void
