 ...
 */
declare
export class ReactDataGrid mixins React.Component<AdazzleReactDataGrid$GridProps, {}>{}
 ...
 */
declare
export class Row mixins React.Component<any, any>{}
 ...
 */
declare
export class Cell mixins React.Component<any, any>{}
declare
export class AutoComplete mixins React.Component<any, {}>{}

declare
export class DropDownEditor mixins React.Component<any, {}>{}

declare
export class SimpleTextEditor mixins React.Component<any, {}>{}

declare
export class CheckboxEditor mixins React.Component<any, {}>{}

declare
export class ImageFormatter mixins React.Component<any, {}>{}

declare
export class Toolbar mixins React.Component<any, any>{}


declare
var npm$namespace$Menu: {
    connect: typeof Menu$connect,
    ContextMenuLayer: typeof Menu$ContextMenuLayer,
}
declare
export class ContextMenu mixins React.Component<any, {}>{}

declare
export class MenuHeader mixins React.Component<any, {}>{}

declare
export class MenuItem mixins React.Component<any, {}>{}

declare
export class SubMenu mixins React.Component<any, {}>{}
...
declare
export function Menu$connect(Menu: any): any

declare
export function Menu$ContextMenuLayer(identifier: any, configure?: (props: any) => any): (Component: any) => anydeclare module 'react-data-grid' {
