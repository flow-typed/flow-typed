// @flow
/**
 * Flowtype definitions for react-data-grid
...
declare interface AdazzleReactDataGrid$GridProps {
    ...
    rowGetter: Array<Object>| ((rowIdx: number) => Object),
         ...
         */
        onRowUpdated?: (e: AdazzleReactDataGrid$RowUpdateEvent) => void,
         ...
         * @param e Information about the event
         */
        onDragHandleDoubleClick?: (e: AdazzleReactDataGrid$DragHandleDoubleClickEvent) => void,
         ...
         * @param e Information about the event
         */
        onGridRowsUpdated?: (e: AdazzleReactDataGrid$GridRowsUpdatedEvent) => void,
 ...
 */
declare interface AdazzleReactDataGrid$Column {
 ...
 */
declare interface AdazzleReactDataGrid$RowUpdateEvent {
 ...
 */
declare interface AdazzleReactDataGrid$DragHandleDoubleClickEvent {
 ...
 */
declare interface AdazzleReactDataGrid$GridRowsUpdatedEvent {
 ...
 */
declare export class ReactDataGrid mixins React.Component<AdazzleReactDataGrid$GridProps, {}>{}


/**
 * A react component that renders a row of the grid
 */
declare export class Row mixins React.Component<any, any>{}


/**
 * A react coponent that renders a cell of the grid
 */
declare export class Cell mixins React.Component<any, any>{}
declare export class AutoComplete mixins React.Component<any, {}>{}

declare export class DropDownEditor mixins React.Component<any, {}>{}

declare export class SimpleTextEditor mixins React.Component<any, {}>{}

declare export class CheckboxEditor mixins React.Component<any, {}>{}

declare export class ImageFormatter mixins React.Component<any, {}>{}

declare export class Toolbar mixins React.Component<any, any>{}
...
declare export class ContextMenu mixins React.Component<any, {}>{}

declare export class MenuHeader mixins React.Component<any, {}>{}

declare export class MenuItem mixins React.Component<any, {}>{}

declare export class SubMenu mixins React.Component<any, {}>{}

declare export var monitor: {
    getItem(): any,
    getPosition(): any,
    hideMenu(): void
};
...
declare export function Menu$ContextMenuLayer(identifier: any, configure?: (props: any) => any): (Component: any) => anydeclare module 'react-data-grid' {
    declare module.exports: typeof ReactDataGrid
}
