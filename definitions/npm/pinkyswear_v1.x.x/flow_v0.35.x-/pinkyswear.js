/**
 * Flowtype definitions for pinkyswear
...
declare interface PinkySwear$Promise {
    ...
    then(): PinkySwear$Promise,
         ...
         */
        then(
            onFulfilled?: () => PinkySwear$Promise,
            onRejected?: () => void): PinkySwear$Promise,
         ...
         * @returns  PinkySwear.Promise
         */
        then(onFulfilled?: () => void, onRejected?: () => void): PinkySwear$Promise,
         ...
         * @returns  PinkySwear.Promise
         */
        then(onFulfilled?: () => any, onRejected?: () => void): PinkySwear$Promise,
         ...
         */
        then(
            onFulfilled?: (...values: any[]) => PinkySwear$Promise,
            onRejected?: (...values: any[]) => void): PinkySwear$Promise,
        ...
        then(
            onFulfilled?: (...values: any[]) => PinkySwear$Promise,
            onRejected?: (error?: TypeError) => void): PinkySwear$Promise,
...
declare type PinkySwear$GenericPromise<T>= {
    ...
    then<G>(
        ...
        onRejected?: (value: T) => void): PinkySwear$GenericPromise<G>,
    ...
    then(
        ...
        onRejected?: (value: T) => void): PinkySwear$Promise,
    ...
    then<G>(
        onFulfilled?: (value: T) => G,
        onRejected?: (error: TypeError) => void): PinkySwear$GenericPromise<G>,
