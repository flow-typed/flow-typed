...
declare module 'yui-test' {
					
}

declare module 'npm$namespace$YUITest' {
		declare interface YUITestStatic {
		Assert: IAssert,
		Case: TestCase,
		Runner: TestRunner
	}
	...
	declare interface TestCase {
		...
		waitFor(
		condition: Function, segment: Function, timeout?: number, increment?: number
	): void,
