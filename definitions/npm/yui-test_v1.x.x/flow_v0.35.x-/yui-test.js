// @flow
/**
 * Flowtype definitions for yui-test
...
declare interface YUITest$YUITestStatic {
    Assert: YUITest$IAssert,
        Case: YUITest$TestCase,
        Runner: YUITest$TestRunner
}

declare interface YUITest$EventTarget {
...
declare type YUITest$TestRunner = {
    ...
    add(testObject: YUITest$TestSuite): void,
    add(testObject: YUITest$TestCase): void,
    clear(): void,
    isWaiting(): boolean,
    isRunning(): boolean,
...
declare interface YUITest$TestSuite {
    name: string,
        add(testObject: YUITest$TestSuite): void,
        add(testObject: YUITest$TestCase): void,
        setUp(): void,
...
declare interface YUITest$TestCase {
    new(template: Object): YUITest$TestCase,
    DEFAULT_WAIT: number,
        callback(...args: any[]): Function,
        resume(segment?: Function): void,
...
declare interface YUITest$IAssert {
    fail(message?: string): void,
