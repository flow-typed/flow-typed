...
declare module 'Application' {
			declare function setPromise(promise: Promise<any>): void
	...
	declare function onbackclick(eventInfo: CustomEvent): void
...
declare module 'Binding' {
	...
	declare function notify(name: string, newValue: string, oldValue: string): Promise<any>
...
declare module 'Animation' {
	...
	declare function continuumForwardIn(
		incomingPage: any, incomingItemRoot: any, incomingItemContent: any
	): Promise<any>

	declare function continuumForwardOut(outgoingPage: any, outgoingItem: any): Promise<any>

	declare function continuumBackwardIn(incomingPage: any, incomingItem: any): Promise<any>

	declare function continuumBackwardOut(outgoingPage: any): Promise<any>
	...
	declare function createPageNavigationAnimation(
		currentPreferredAnimation: PageNavigationAnimation, nextPreferredAnimation: PageNavigationAnimation, movingBackwards: boolean
	): {
		enter: () => any,
		exit: () => any
	}
	...
	declare function slideDown(outgoing: any): Promise<any>

	declare function slideUp(outgoing: any): Promise<any>

	declare function slideRightIn(
		page: any, firstIncomingElements: any, secondIncomingElements: any, thirdIncomingElements: any
	): Promise<any>

	declare function slideRightOut(
		page: any, firstOutgoingElements: any, secondOutgoingElements: any, thirdOutgoingElements: any
	): Promise<any>

	declare function slideLeftIn(
		page: any, firstIncomingElements: any, secondIncomingElements: any, thirdIncomingElements: any
	): Promise<any>

	declare function slideLeftOut(
		page: any, firstOutgoingElements: any, secondOutgoingElements: any, thirdOutgoingElements: any
	): Promise<any>
...
declare module 'UI' {
	...
	declare function setControl(element: HTMLElement, control: any): void
