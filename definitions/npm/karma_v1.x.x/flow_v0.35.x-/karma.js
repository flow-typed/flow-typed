/**
 * Flowtype definitions for karma
...
declare module 'karma' {
    declare interface karma$Karma {
        ...
        instead.
        */
        server: karma$DeprecatedServer,
            Server: karma$Server,
            runner: karma$Runner,
            stopper: karma$Stopper,
            launcher: karma$Launcher,
            VERSION: string
    }

    declare interface karma$LauncherStatic {
        generateId(): string,
            new(emitter: NodeJS.EventEmitter, injector: any): karma$Launcher
    }

    declare interface karma$Launcher {
        Launcher: karma$LauncherStatic,
            launch(
                names: string[],
                protocol: string,
                hostname: string,
    ...
    declare interface karma$DeprecatedServer {
        start(options?: any, callback?: karma$ServerCallback): void
    }

    declare interface karma$Runner {
        run(
            options?: karma$ConfigOptions | karma$ConfigFile,
            callback?: karma$ServerCallback): void
    }

    declare interface karma$Stopper {

        /**
         * This function will signal a running server to stop. The equivalent of karma stop.
         */
        stop(options?: karma$ConfigOptions, callback?: karma$ServerCallback): void
    }

    declare interface karma$TestResults {
    ...
    declare type karma$Server = {
        new(
            options?: karma$ConfigOptions | karma$ConfigFile,
            callback?: karma$ServerCallback): karma$Server,
        ...
        on(
            event: "run_complete",
            listener: (browsers: any, results: karma$TestResults) => void): this
    }

    declare interface karma$ServerCallback {
        (exitCode: number): void
    }

    declare interface karma$Config {
        set: (config: karma$ConfigOptions) => void,
            LOG_DISABLE: string,
            LOG_ERROR: string,
            LOG_WARN: string,
            LOG_INFO: string,
    ...
    declare interface karma$ConfigFile {
        configFile: string
    }

    declare interface karma$ConfigOptions {
        ...
        autoWatch?: boolean,
            ...
            */
             ...
             */
            files?: (karma$FilePattern | string)[],
    ...
    declare interface karma$ClientOptions {
    ...
    declare interface karma$FilePattern {
