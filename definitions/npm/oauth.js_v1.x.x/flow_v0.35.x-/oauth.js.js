 ...
 */
declare
function OAuth$percentEncode(s: string): string
 ...
 */
declare
function OAuth$decodePercent(s: string): string
 ...
 */
declare
function OAuth$getParameterList(parameters: OAuth$ParameterListOrMap): OAuth$ParameterList
 ...
 */
declare
function OAuth$getParameterMap(parameters: OAuth$ParameterListOrMap): OAuth$ParameterMap

declare
function OAuth$getParameter(parameters: OAuth$ParameterListOrMap, name: string): string

declare
function OAuth$formEncode(parameters: OAuth$ParameterListOrMap): string

declare
function OAuth$decodeForm(form: string): OAuth$ParameterList

declare
function OAuth$setParameter(message: OAuth$Message, name: string, value: string): void

declare
function OAuth$setParameters(message: OAuth$Message, parameters: OAuth$ParameterListOrMap): void
 ...
 */
declare
function OAuth$completeRequest(message: OAuth$Message, accessor: OAuth$Accessor): void

declare
function OAuth$setTimestampAndNonce(message: OAuth$Message): void
 ...
 */
declare
function OAuth$addToURL(url: string, parameters: OAuth$ParameterListOrMap): string
 ...
 */
declare
function OAuth$getAuthorizationHeader(realm: string, parameters: OAuth$ParameterListOrMap): string
 ...
 */
declare
function OAuth$correctTimestampFromSrc(parameterName?: string): void
 ...
 */
declare
function OAuth$correctTimestamp(timestamp: number): void

declare
var timeCorrectionMsec: number;

declare
function OAuth$timestamp(): number

declare
function OAuth$nonce(length: number): string
...
declare
var SignatureMethod: OAuth$SignatureMethodStatic;