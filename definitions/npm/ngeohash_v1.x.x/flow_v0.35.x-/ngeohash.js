...
declare function ngeohash$encode(latitude: number, longitude: number, precision?: number): string

declare function ngeohash$decode(hashstring: string): ngeohash$GeographicPoint

declare function ngeohash$decode_bbox(hashstring: string): ngeohash$GeographicBoundingBox
...
declare function ngeohash$bboxes(
    ...
    declare function ngeohash$neighbor(hashstring: string, direction: ngeohash$NSEW): string

declare function ngeohash$neighbors(hashstring: string): Array<string >

    declare function ngeohash$encode_int(latitude: number, longitude: number, bitDepth?: number): number

declare function ngeohash$decode_int(hashinteger: number, bitDepth?: number): ngeohash$GeographicPoint

declare function ngeohash$decode_bbox_int(hashinteger: number, bitDepth?: number): ngeohash$GeographicBoundingBox
...
declare function ngeohash$neighbor_int(hashinteger: number, direction: ngeohash$NSEW, bitDepth?: number): number

declare function ngeohash$neighbors_int(hashinteger: number, bitDepth?: number): numberdeclare module 'ngeohash' {
