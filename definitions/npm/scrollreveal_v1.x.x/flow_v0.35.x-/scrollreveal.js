import type { ScrollRevealObject } from 'npm$namespace$scrollReveal'

declare module 'scrollreveal' {
					
}

declare module 'npm$namespace$scrollReveal' {
		declare interface ScrollRevealRotateObject {
		x?: number,
		y?: number,
		z?: number
	}

	declare interface ScrollRevealPositionObject {
		top?: number,
		right?: number,
		bottom?: number,
		left?: number
	...
	declare interface ScrollRevealObjectOptions {
		origin?: string,
		distance?: string,
		duration?: number,
		delay?: number,
	...
	declare interface ScrollRevealObject {
		(): ScrollRevealObject,
		...
		reveal(
		selector: string, options: ScrollRevealObjectOptions, interval: number
	): ScrollRevealObject,
		...
		reveal(
		selector: HTMLElement, options: ScrollRevealObjectOptions, interval: number
	): ScrollRevealObject,
		...
		reveal(
		selector: NodeListOf<Element>, options: ScrollRevealObjectOptions
	): ScrollRevealObject,
		reveal(
		selector: NodeListOf<Element>, options: ScrollRevealObjectOptions, interval: number
	): ScrollRevealObject,
		sync(): void
	}
