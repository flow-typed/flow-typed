    ...
    return (
      <App centered={true} inline={true}>
        ...
        <Box pad={{ between: "medium" }} align="center">
          <Button label="Leave" primary={true} onClick={this.handleClick} />
          <Animate
            enter={{ animation: "fade", duration: 1000, delay: 0 }}
            keep={true}
          >
            <Box direction="row">
              <Box colorIndex="light-2" margin="medium" pad="large">
                <Value value={1} />
              </Box>
            </Box>
          </Animate>
        ...
        <Box>
          ...
          <Meter value={40} onActive={this.handleClick} />
        </Box>
        ...
        <Map
          data={{
            ...
            links: [{ parentId: "item-1-1", childId: "item-2-2" }]
          }}
        />
        <Distribution
          series={[
        ...
        <Table selectable={true} onSelect={this.handleClick}>
        ...
        <Tip target="actions" onClose={this.handleClick}>
          Available actions
        </Tip>
        <Label>Foo</Label>
        <FormField>
        ...
        <Form onSubmit={this.handleClick}>
          <FormFields>
            ...
            <FormField label="Foo" error={<p>foo</p>}>
              <NumberInput value={10} onChange={this.handleClick} />
            </FormField>
            <FormField>
              <RadioButton
                id="choice1-1"
        ...
        />
        <Tabs activeIndex={0} onActive={this.handleClick}>
          <Tab title="First Title">
            <Paragraph>First contents</Paragraph>
            <input type="text" value="" onChange={this.handleClick} />
          </Tab>
        ...
        <Quote credit="Ricky Baker">
          <Paragraph>Trees. Birds. Rivers. Sky.</Paragraph>
          <Paragraph>Running with my Uncle Hec</Paragraph>
          <Paragraph>Living forever.</Paragraph>
        </Quote>
        ...
        >
          <Value value={1} colorIndex="accent-1" />
          <Box
            direction="row"
            justify="start"
            align="center"
        ...
        <Toast status="ok" onClose={this.handleClick}>
