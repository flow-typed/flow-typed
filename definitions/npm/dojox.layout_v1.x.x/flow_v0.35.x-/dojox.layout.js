/**
 * Flowtype definitions for dojox.layout
...
*/
declare class ContentPane mixins undefined.ContentPane {
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class Dock mixins dijit._WidgetBase, dijit._TemplatedMixin {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class DragPane mixins dijit._Widget {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class ExpandoPane mixins undefined.ContentPane, dijit._TemplatedMixin, dijit._Contained, dijit._Container {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class FloatingPane mixins undefined.ContentPane, dijit._TemplatedMixin {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param node 
*/
declare class GridContainer mixins undefined.GridContainerLite {
 ...
 * @param node 
*/
declare class GridContainerLite mixins undefined._LayoutWidget, dijit._TemplatedMixin {
    constructor(props: Object, node: HTMLElement): this;
...
Properties set on children of a GridContainerLite
*/
declare interface GridContainerLite$ChildWidgetProperties {
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class RotatorContainer mixins undefined.StackContainer, dijit._Templated {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class ResizeHandle mixins dijit._Widget, dijit._TemplatedMixin {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class ScrollPane mixins undefined.ContentPane, dijit._Templated {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class TableContainer mixins undefined._LayoutWidget {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
...
Properties set on children of a GridContainerLite
*/
declare interface TableContainer$ChildWidgetProperties {
 ...
 * @param opacity 
*/
declare class Avatar mixins undefined.Avatar {
 ...
 * @param params 
*/
declare class PlottedDnd mixins undefined.Source {
 ...
 */
declare interface layout$BorderContainer {}
...
declare module 'dojox/layout/GridContainerLite.ChildWidgetProperties' {
    declare var exp: undefined.ChildWidgetProperties;
    declare module.exports: typeof exp
}
