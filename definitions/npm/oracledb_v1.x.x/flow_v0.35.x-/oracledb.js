// @flow
/**
 * Flowtype definitions for oracledb
...
declare module 'oracledb' {
    ...
    declare     export interface IResultSet {
        ...
        metaData?: Array<IMetaData>,
            ...
            /**
             * Closes a ResultSet. Applications should always call this at the end of fetch or when no more rows are needed.:any)=>void} callback Callback called on finish or when some error occurs.
             * @returns  void
             ...
             * At the end of fetching, the ResultSet should be freed by calling close().:any,row:Array<any>|Object)=>void} callback Callback called when the row is available or when some error occurs.
             * @returns  void
             */
    ...
    declare     export interface IConnection {
        ...
        action: string,
            ...
            If the running asynchronous operation is interrupted, its callback will return an error.: any) => void} callback Callback on break done.
            */
            ...
            */
            ...
            After releasing a connection to a pool, there is no guarantee a subsequent getConnection() call gets back the same database connection. The application must redo any ALTER SESSION statements on the new connection object, as required.: any) => void} callback Callback on close done.
            */
            close(callback: (err: any) => void): void,
            ...
            */
            ...
            A callback function returns a result object, containing any fetched rows, the values of any OUT and IN OUT bind variables, and the number of rows affected by the execution of DML statements.: any, value: IExecuteReturn) => void} callback Callback function to receive the result.
             * @param  SQL Statement.
            ...
            */
            ...
            /**
             * An alias for Connection.close().: any) => void} callback Callback on close done.
             */
    ...
    declare     export interface IConnectionPool {
        ...
        connectionsInUse: number,
            ...
            /**
             * An alias for IConnectionPool.close().:any)=>void} callback Callback called when the pool is terminated or when some error occurs
             * @returns  void
             */
    ...
    declare     export var extendedMetaData: boolean;
    declare     export var externalAuth: boolean;
    declare     export var fetchAsString: Array<number>;
    ...
    declare     export var queueRequests: boolean;
    declare     export var queueTimeout: number;
