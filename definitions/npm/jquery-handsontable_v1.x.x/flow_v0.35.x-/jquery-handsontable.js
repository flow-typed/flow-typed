/**
 * Flowtype definitions for jquery-handsontable
...
declare interface Handsontable$CellPosition {
    row: number,
        col: number
}

declare interface Handsontable$Options {
    ...
    data?: any,
        ...
        */
        beforeAutofill?: (
            start: Handsontable$CellPosition,
            end: Handsontable$CellPosition,
            data: string[][]) => void,
        ...
        */
        ...
        afterOnCellMouseDown?: (
            event: MouseEvent,
            coords: Handsontable$CellPosition,
            TD: HTMLTableDataCellElement) => void,
...
declare interface Handsontable$Context {

    /**
     * Use it if you need to change configuration after initialization.
     */
    updateSettings(options: Handsontable$Options): void,
        ...
        selectCell(
            ...
            row2: number,
            col2: number,
            scrollToSelection?: boolean): void,
