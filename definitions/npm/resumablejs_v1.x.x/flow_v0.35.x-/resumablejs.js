// @flow
/**
 * Flowtype definitions for resumablejs
...
declare interface Resumable$ConfigurationHash {
    ...
    target?: string,
        ...
        /**
         * The size in bytes of each uploaded chunk of data. The last uploaded chunk will be at least this size and up to two the size, see Issue #51 for details and reasons. (Default: 11024*1024)
         */
        chunkSize?: number,
         ...
         */
        headers?: Object | ((file: Resumable$ResumableFile) => Object),
         ...
         */
        maxFilesErrorCallback?: (files: Resumable$ResumableFile, errorCount: number) => void,
         ...
         */
        minFileSizeErrorCallback?: (file: Resumable$ResumableFile, errorCount: number) => void,
         ...
         */
        maxFileSizeErrorCallback?: (file: Resumable$ResumableFile, errorCount: number) => void,
         ...
         */
        fileTypeErrorCallback?: (file: Resumable$ResumableFile, errorCount: number) => void,
...
declare class Resumable {
    constructor(options: Resumable$ConfigurationHash): this;
    ...
    defaults: Resumable$ConfigurationHash;
    events: Event[];
    version: number;
    ...
    on(
        event: "fileAdded",
        callback: (file: Resumable$ResumableFile, event: DragEvent) => void): void;
    ...
    on(
        event: "filesAdded",
        callback: (files: Resumable$ResumableFile[]) => void): void;
    ...
    on(
        event: "fileError",
        callback: (file: Resumable$ResumableFile, message: string) => void): void;
    ...
    on(
        event: "error",
        callback: (message: string, file: Resumable$ResumableFile) => void): void;
    ...
    on(
        event: "chunkingStart",
        callback: (file: Resumable$ResumableFile) => void): void;
    ...
    on(
        ...
        callback: (file: Resumable$ResumableFile, ratio: number) => void): void;
...
declare interface Resumable$ResumableFile {

    /**
     * A back-reference to the parent Resumable object.
     */
    resumableObj: Resumable$Resumable,
...
declare interface Resumable$ResumableChunk {}
declare module 'resumablejs' {
    declare module.exports: typeof Resumable
}