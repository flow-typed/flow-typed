/**
 * Flowtype definitions for materialize-css
 ...
 */
declare interface Materialize$CollapsibleOptions {
...
declare interface Materialize$TooltipOptions {
 ...
 */
declare interface Materialize$DropDownOptions {
 ...
 * The slider options
 */
declare interface Materialize$SliderOptions {
 ...
 */
declare interface Materialize$CarouselOptions {
 ...
 */
declare interface Materialize$LeanModalOptions {
 ...
 */
declare interface Materialize$PushpinOptions {
 ...
 */
declare interface Materialize$ScrollSpyOptions {
 ...
 */
declare interface Materialize$SideNavOptions {
...
declare interface Materialize$ScrollFireOptions {
 ...
 */
declare interface Materialize$Materialize {
    ...
    toast(
         ...
         */
        scrollFire(options?: Materialize$ScrollFireOptions): void,
