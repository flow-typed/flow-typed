// @flow
/**
 * Flowtype definitions for chocolatechipjs
...
declare interface ChocolateChipStatic {
    ...
    (document: Document): Document[],
        ...
        replace(
            ...
            oldElement: ChocolateChipElementArray): void,
 ...
 */
declare type ChocolateChipElementArray = {
    ...
    */
    ...
    /**
     * Check the current matched set of elements against a selector or element and return it
     * if it matches the given arguments.return HTMLElement[]
    ...
    /**
     * Check the current matched set of elements against a selector or element and return it
     * if it does not match the given arguments.return HTMLElement[]
     * @param selector A string containing a selector expression to match elements against.
     */
    ...
    /**
     * Reduce the set of matched elements to those that have a descendant that matches the selector or DOM element.return HTMLElement[]
     * @param selector A string containing a selector expression to match elements against.
     */
    ...
    /**
     * Reduce the set of matched elements to those that have a descendant that does not match the selector or DOM element.return HTMLElement[]
     * @param selector A string containing a selector expression to match elements against.
     */
    ...
    /**
     * Get the descendants of each element in the current set of matched elements, filtered by a selector or element.return HTMLElement[]
     * @param selector A string containing a selector expression to match elements against.
     */
    ...
    /**
     * Get the immediately preceding sibling of each element in the set of matched elements.return HTMLElement[]
     */
    prev(): ChocolateChipElementArray,

    /**
     * Get the immediately following sibling of each element in the set of matched elements.return HTMLElement[]
     */
    ...
    */
     ...
     */
    before(
        content: ChocolateChipElementArray | HTMLElement | string): ChocolateChipElementArray,
    ...
    */
    append(
        content: ChocolateChipElementArray | HTMLElement | Text | string): ChocolateChipElementArray,
    ...
    */
    ...
    bind(
        ...
        useCapture?: boolean): ChocolateChipStatic,
    ...
    */
    ...
    on(
        ...
        selector: any,
        handler?: (eventObject: Event) => any,
        capturePhase?: boolean): ChocolateChipStatic,
...
declare interface Promise<T>{
    ...
    then<TResult>(
        ...
        onrejected?: (reason: any) => TResult | Promise<TResult>): Promise<TResult>,
