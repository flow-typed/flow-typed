/**
 * Flowtype definitions for phonegap-facebook-plugin
...
declare interface PhonegapFacebookPlugin$FacebookConnectPluginStatic {
    ...
    */
    api: (
         ...
         */
        getLoginStatus: (
            successCallback?: (status: PhonegapFacebookPlugin$LoginResult) => void,
            failureCallback?: (error: string) => void) => void,
        ...
        */
        ...
        login: (
            permissions: string[],
            successCallback?: (result: PhonegapFacebookPlugin$LoginResult) => void,
            failureCallback?: (error: string) => void) => void,
         ...
         */
        showDialog: (
            options: PhonegapFacebookPlugin$BaseDialogOptions,
            successCallback?: (status: PhonegapFacebookPlugin$BaseDialogResult) => void,
            failureCallback?: (error: string) => void) => void
}

declare interface PhonegapFacebookPlugin$BaseDialogOptions {
...
*/
declare type PhonegapFacebookPlugin$FeedDialogOptions = {
    ...
    */
    ref?: string
} & PhonegapFacebookPlugin$BaseDialogOptions
...
*/
declare type PhonegapFacebookPlugin$SendDialogOptions = {
...
*/
declare type PhonegapFacebookPlugin$ShareDialogOptions = {
...
*/
declare type PhonegapFacebookPlugin$ShareOpenGraphDialogOptions = {
 ...
 */
declare interface PhonegapFacebookPlugin$LoginResult {
    authResponse: {
            accessToken: string,
            expiresIn: string,
            secret: string,
 ...
 */
declare interface PhonegapFacebookPlugin$BaseDialogResult {
    error_code: string,
 ...
 */
declare type PhonegapFacebookPlugin$FeedDialogResult = {
 ...
 */
declare type PhonegapFacebookPlugin$SendDialogResult = {} & PhonegapFacebookPlugin$BaseDialogResult
 ...
 */
declare type PhonegapFacebookPlugin$ShareDialogResult = {
