// @flow
/**
 * Flowtype definitions for html2canvas
...
declare interface Html2Canvas$Html2CanvasOptions {
...
declare interface Html2CanvasStatic {
     ...
     * @param  The HTML element which will be rendered to the canvas. Use the root element to render the entire window.
     * @param  The options object that controls how the element will be rendered.
    */
...
declare interface Html2CanvasThenable<R>{
    then<U>(
        ...
        onRejected?: (error: any) => U | Html2CanvasThenable<U>): Html2CanvasThenable<U>,
    then<U>(
        onFulfilled?: (value: R) => U | Html2CanvasThenable<U>,
        onRejected?: (error: any) => void): Html2CanvasThenable<U >
}
declare type Html2CanvasPromise<R>= {
    then<U>(
        onFulfilled?: (value: R) => U | Html2CanvasThenable<U>,
        onRejected?: (error: any) => U | Html2CanvasThenable<U>): Html2CanvasPromise<U>,
    then<U>(
        onFulfilled?: (value: R) => U | Html2CanvasThenable<U>,
        onRejected?: (error: any) => void): Html2CanvasPromise<U>,
    catch<U>(
        onRejected?: (error: any) => U | Html2CanvasThenable<U>): Html2CanvasPromise<U >
} & Html2CanvasThenable
