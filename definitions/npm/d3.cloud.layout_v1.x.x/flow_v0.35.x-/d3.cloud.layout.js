...
declare module 'd3.cloud.layout' {
					
}

declare module 'layout' {
		declare interface Cloud<T> {
		start(): Cloud<T>,
		stop(): Cloud<T>,
		timeInterval(): number,
		...
		on(
		type: "end", listener: (tags: T[], bounds: {
		x: number,
		y: number
	}[]) => void
	): Cloud<T>,
	...
	declare export function cloud(): Cloud<cloud.Word>

	declare export function cloud<T>(): Cloud<T>
