import type { RunFunctionWithDescription, RunFunction, PauseFunction, SleepFunction, UsingFunction, BindingFunction } from 'npm$namespace$angularScenario'
import type { IAngularStatic } from 'npm$namespace$ng'

declare module 'angular-scenario-1.2' {
...
declare module 'npm$namespace$angularScenario' {
	...
	declare export interface Element {
		...
		query(
		callback: (
		selectedDOMElements: JQuery, callbackWhenDone: (objNull: any, futureValue: any) => any
	) => any
	): any,
		val(): Future,
		text(): Future,
