/**
 * Flowtype definitions for chosen.jquery
...
declare type Chosen$OnEvent = "chosen:ready" |
    "chosen:maxselected" |
    "chosen:showing_dropdown" |
    "chosen:hiding_dropdown" |
    "chosen:no_results";

declare type Chosen$TriggerEvent = "chosen:updated" | "chosen:activate" | "chosen:open" | "chosen:close";

declare interface Chosen$Options {
...
declare interface Chosen$SelectedData {
    selected: string,
        deselected: string
}
declare interface JQuery {
    chosen(): JQuery,
        ...
        on(
            events: "change",
            handler: (eventObject: JQueryEventObject, args: Chosen$SelectedData) => any): JQuery,
        on(
