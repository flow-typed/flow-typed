...
declare
var npm$namespace$Match: {
    test: typeof Match$test,
}
declare
function Match$test(value: any, pattern: any): boolean
declare
...
declare
function Meteor$clearInterval(id: number): void

declare
function Meteor$clearTimeout(id: number): void

declare
function Meteor$disconnect(): void
...
declare
function Meteor$loggingIn(): boolean

declare
function Meteor$loginWith<ExternalService>(
    options?: {
...
declare
function Meteor$loginWithPassword(user: Object | string, password: string, callback?: Function): void

declare
function Meteor$logout(callback?: Function): void

declare
function Meteor$logoutOtherClients(callback?: Function): void

declare
function Meteor$methods(methods: Object): void

declare
function Meteor$onConnection(callback: Function): void

declare
function Meteor$publish(name: string, func: Function): void

declare
function Meteor$reconnect(): void

declare
var release: string;

declare
function Meteor$setInterval(func: Function, delay: number): number

declare
function Meteor$setTimeout(func: Function, delay: number): number
...
declare
function Meteor$startup(func: Function): void

declare
function Meteor$status(): Meteor$StatusEnum

declare
function Meteor$subscribe(name: string, ...args: any[]): Meteor$SubscriptionHandle

declare
function Meteor$user(): Meteor$User

declare
function Meteor$userId(): string

declare
var users: Mongo$Collection<Meteor$User>;

declare
function Meteor$wrapAsync(func: Function, context?: Object): any
declare
var npm$namespace$DDP: {
    connect: typeof DDP$connect,
}
declare
function DDP$connect(url: string): DDP$DDPStaticdeclare
...
declare
function HTTP$patch(url: string, callOptions?: Object, asyncCallback?: Function): HTTP$HTTPResponse
...
declare
function Random$id(numberOfChars?: number): string

declare
function Random$secret(numberOfChars?: number): string

declare
function Random$fraction(): number

declare
function Random$hexString(numberOfDigits: number): string

declare
function Random$choice(array: any[]): string
declare
...
declare
function Accounts$addEmail(userId: string, newEmail: string, verified?: boolean): void

declare
function Accounts$changePassword(oldPassword: string, newPassword: string, callback?: Function): void

declare
function Accounts$createUser(
    options: {
        username?: string,
        email?: string,
        password?: string,
...
declare
function Accounts$findUserByEmail(email: string): Object

declare
function Accounts$findUserByUsername(username: string): Object

declare
function Accounts$forgotPassword(options: {
    email?: string
}, callback?: Function): void

declare
function Accounts$onEmailVerificationLink(callback: Function): void

declare
function Accounts$onEnrollmentLink(callback: Function): void

declare
function Accounts$onResetPasswordLink(callback: Function): void

declare
function Accounts$removeEmail(userId: string, email: string): void

declare
function Accounts$resetPassword(token: string, newPassword: string, callback?: Function): void

declare
function Accounts$sendEnrollmentEmail(userId: string, email?: string): void

declare
function Accounts$sendResetPasswordEmail(userId: string, email?: string): void

declare
function Accounts$sendVerificationEmail(userId: string, email?: string): void

declare
function Accounts$setPassword(userId: string, newPassword: string, options?: {
    logout?: Object
}): void

declare
function Accounts$setUsername(userId: string, newUsername: string): void
...
declare
function Accounts$verifyEmail(token: string, callback?: Function): void
...
declare
function Accounts$onLogin(func: Function): {
    stop: () => void
}

declare
function Accounts$onLoginFailure(func: Function): {
    stop: () => void
}

declare
function Accounts$user(): Meteor$User

declare
function Accounts$userId(): string

declare
function Accounts$loggingIn(): boolean

declare
function Accounts$logout(callback?: Function): void

declare
function Accounts$logoutOtherClients(callback?: Function): void

declare
function Accounts$onCreateUser(func: Function): void
...
declare
function Accounts$validateNewUser(func: Function): boolean
declare
var npm$namespace$Blaze: {
...
declare
function Blaze$Each(argFunc: Function, contentFunc: Function, elseFunc?: Function): Blaze$View
...
declare
function Blaze$Let(bindings: Function, contentFunc: Function): Blaze$View

declare
var Template: Blaze$TemplateStatic;
...
declare
var TemplateInstance: Blaze$TemplateInstanceStatic;
...
declare
function Blaze$Unless(
    conditionFunc: Function,
    contentFunc: Function,
    elseFunc?: Function): Blaze$View

declare
var View: Blaze$ViewStatic;
...
declare
function Blaze$With(data: Object | Function, contentFunc: Function): Blaze$View

declare
var currentView: Blaze$View;

declare
function Blaze$getData(elementOrView?: HTMLElement | Blaze$View): Object

declare
function Blaze$getView(element?: HTMLElement): Blaze$View

declare
function Blaze$isTemplate(value: any): boolean

declare
function Blaze$remove(renderedView: Blaze$View): void

declare
function Blaze$render(
...
declare
function Blaze$toHTML(templateOrView: Blaze$Template | Blaze$View): string

declare
function Blaze$toHTMLWithData(templateOrView: Blaze$Template | Blaze$View, data: Object | Function): stringdeclare interface BrowserPolicy$framing {
    disallow(): void,
...
declare
var npm$namespace$Tinytest: {
    add: typeof Tinytest$add,
    addAsync: typeof Tinytest$addAsync,
}
declare
function Tinytest$add(description: string, func: (test: ITinytestAssertions) => void): void

declare
function Tinytest$addAsync(description: string, func: (test: ITinytestAssertions) => void): void
declare
var npm$namespace$App: {
...
declare
function App$accessRule(pattern: string, options?: {
    type?: string,
    launchExternal?: boolean
}): void

declare
function App$configurePlugin(id: string, config: Object): void

declare
function App$icons(icons: Object): void
...
declare
function App$launchScreens(launchScreens: Object): void

declare
function App$setPreference(name: string, value: string, platform?: string): void
declare
var npm$namespace$Assets: {
    getBinary: typeof Assets$getBinary,
    getText: typeof Assets$getText,
}
declare
function Assets$getBinary(assetPath: string, asyncCallback?: Function): EJSON

declare
function Assets$getText(assetPath: string, asyncCallback?: Function): string
declare
var npm$namespace$Cordova: {
    depends: typeof Cordova$depends,
}
declare
function Cordova$depends(dependencies: {
    [id: string]: string
}): void
declare
var npm$namespace$DDPCommon: {
    MethodInvocation: typeof DDPCommon$MethodInvocation,
}
declare
function DDPCommon$MethodInvocation(options: {}): any
declare
var npm$namespace$EJSON: {
...
declare
var CustomType: EJSON$CustomTypeStatic;
...
declare
function EJSON$addType(name: string, factory: (val: JSONable) => EJSON$CustomType): void

declare
function EJSON$clone<T>(val: T): T

declare
function EJSON$equals(a: EJSON, b: EJSON, options?: {
    keyOrderSensitive?: boolean
}): boolean

declare
function EJSON$fromJSONValue(val: JSONable): any

declare
function EJSON$isBinary(x: Object): boolean

declare
var newBinary: any;

declare
function EJSON$parse(str: string): EJSON
...
declare
function EJSON$toJSONValue(val: EJSON): JSONable
declare
var npm$namespace$Npm: {
    depends: typeof Npm$depends,
    require: typeof Npm$require,
}
declare
function Npm$depends(dependencies: {
    [id: string]: string
}): void

declare
function Npm$require(name: string): any
declare
var npm$namespace$Package: {
...
declare
function Package$onTest(func: Function): void

declare
function Package$onUse(func: Function): void

declare
function Package$registerBuildPlugin(
    options?: {
        name?: string,
        use?: string | string[],
        sources?: string[],
...
declare
function Tracker$Computation(): void

declare
var Dependency: Tracker$DependencyStatic;
...
declare
function Tracker$afterFlush(callback: Function): void

declare
function Tracker$autorun(
...
declare
function Tracker$flush(): void

declare
function Tracker$nonreactive(func: Function): void

declare
function Tracker$onInvalidate(callback: Function): void
declare
var npm$namespace$Session: {
...
declare
function Session$equals(a: EJSON, b: EJSON, options?: {
    keyOrderSensitive?: boolean
}): boolean
...
declare
function Session$set(key: string, value: EJSONable | any): void

declare
function Session$setDefault(key: string, value: EJSONable | any): void
declare
var npm$namespace$Email: {
...
declare
function check(value: any, pattern: any): voiddeclare
