/**
 * Flowtype definitions for redux-form
...
declare module 'redux-form' {
    ...
    declare export interface ReduxFormProps {
        ...
        active?: string,
            ...
            */
            ...
            handleSubmit(
                submit: (data: FormData, dispatch?: Dispatch<any>) => Promise<any>| void): FormEventHandler,
    ...
    declare class ElementClass mixins Component<any, any>{}
    ...
    */
    declare export type Normalizer = (
        ...
        allValues: FormData,
        previousAllValues: FormData) => any;
    declare export var reducer: {
