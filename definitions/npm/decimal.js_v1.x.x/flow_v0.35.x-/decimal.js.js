/**
 * Flowtype definitions for decimal.js
...
declare interface decimal$IFormatConfig {
...
declare interface decimal$IDecimalConfig {
    ...
    */
    precision?: number,
        ...
        */
        format?: decimal$IFormatConfig
}

declare type decimal$IDecimalStatic = {
    (value: number | string | decimal$Decimal, base?: number): decimal$Decimal,
    new(value: number | string | decimal$Decimal, base?: number): decimal$Decimal,
    ...
    */
    config(object: decimal$IDecimalConfig): decimal$IDecimalStatic,

    /**
     * Returns a new independent Decimal constructor with configuration settings as described by object
     */
    constructor(object: decimal$IDecimalConfig): decimal$IDecimalStatic,
     ...
     */
    exp(n: number | string | decimal$Decimal): decimal$Decimal,
    ...
    */
    ln(n: number | string | decimal$Decimal): decimal$Decimal,
    ...
    */
     ...
     */
    noConflict(): decimal$IDecimalStatic,
    ...
    */
    pow(
        base: number | string | decimal$Decimal,
        exponent: number | string | decimal$Decimal): decimal$Decimal,
    ...
    */
    random(dp?: number): decimal$Decimal,
    ...
    */
    sqrt(arg: number | string | decimal$Decimal): decimal$Decimal,
     ...
     */
    EUCLID: number
} & decimal$IDecimalConfig


declare interface decimal$Decimal {
    ...
    */
    absoluteValue(): decimal$Decimal,
        ...
        */
        comparedTo(n: number | string | decimal$Decimal, base?: number): number,
         ...
         *          1   If the value of this Decimal is greater than the value
              ...
              null   If the value of either this Decimal or n is NaN
        */
        cmp(n: number | string | decimal$Decimal, base?: number): number,
         ...
         */
        dividedBy(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,

        /**
         * Returns a new Decimal whose value is the value of this Decimal divided by n, rounded to precision significant digits using rounding mode rounding.
         */
        div(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,
         ...
         */
        dividedToIntegerBy(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,

        /**
         * Return a new Decimal whose value is the integer part of dividing this Decimal by n, rounded to precision significant digits using rounding mode rounding.
         */
        divToInt(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,
        ...
        */
        equals(n: number | string | decimal$Decimal, base?: number): boolean,
        ...
        Note: This method uses the cmp method internally.
        */
        eq(n: number | string | decimal$Decimal, base?: number): boolean,

        /**
         * Returns a new Decimal whose value is the base e (Euler's number, the base of the natural logarithm) exponential of the value of this Decimal, rounded to precision significant digits using rounding mode rounding.
         */
        exponential(): decimal$Decimal,
         ...
         */
        greaterThan(n: number | string | decimal$Decimal, base?: number): boolean,

        /**
         * Note: This method uses cmp method internally.
         */
        gt(n: number | string | decimal$Decimal, base?: number): boolean,

        /**
         * Note: This method uses cmp method internally.
         */
        greaterThanOrEqualTo(n: number | string | decimal$Decimal, base?: number): boolean,

        /**
         * Note: This method uses cmp method internally.
         */
        gte(n: number | string | decimal$Decimal, base?: number): boolean,
         ...
         * Note: This method uses cmp method internally.
         */
        lessThan(n: number | string | decimal$Decimal, base?: number): boolean,

        /**
         * Note: This method uses cmp method internally.
         */
        lt(n: number | string | decimal$Decimal, base?: number): boolean,

        /**
         * Note: This method uses cmp method internally.
         */
        lessThanOrEqualTo(n: number | string | decimal$Decimal, base?: number): boolean,

        /**
         * Note: This method uses cmp method internally.
         */
        lte(n: number | string | decimal$Decimal, base?: number): boolean,
        ...
        If n is null or undefined, then the base 10 logarithm of the value of this Decimal will be returned.
        */
        logarithm(n?: number | string | decimal$Decimal, base?: number): decimal$Decimal,
        ...
        */
         ...
         */
        minus(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,
        ...
        */
        modulo(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,
        ...
        The value returned, and in particular its sign, is dependent on the value of the modulo property of this Decimal's constructor. If it is 1 (default value), the result will have the same sign as this Decimal, and it will match that of Javascript's % operator (within the limits of double precision) and BigDecimal's remainder method.
        */
        mod(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,
        ...
        */
         ...
         */
        plus(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,
        ...
        */
         ...
         */
        times(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,
        ...
        */
        toDecimalPlaces(dp?: number, rm?: RoundingMode): decimal$Decimal,
        ...
        If rm is omitted or is null or undefined, rounding mode rounding is used.
        */
        toDP(dp?: number, rm?: RoundingMode): decimal$Decimal,
        ...
        */
        toFraction(max_denominator?: number | string | decimal$Decimal): string[],
        toJSON(): string,
        ...
        The return value is not rounded to precision.
        */
        toNearest(n: number | string | decimal$Decimal, rm?: RoundingMode): decimal$Decimal,
        ...
        */
        ...
        The performance of this method degrades exponentially with increasing digits. For non-integer exponents in particular, the performance of this method may not be adequate.
        */
        toPower(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,
        ...
        The performance of this method degrades exponentially with increasing digits. For non-integer exponents in particular, the performance of this method may not be adequate.
        */
        pow(n: number | string | decimal$Decimal, base?: number): decimal$Decimal,
        ...
        */
        toSignificantDigits(sd?: number, rm?: RoundingMode): decimal$Decimal,
        ...
        if rm is omitted or is null or undefined, rounding mode rounding will be used.
        */
        toSD(sd?: number, rm?: RoundingMode): decimal$Decimal,
