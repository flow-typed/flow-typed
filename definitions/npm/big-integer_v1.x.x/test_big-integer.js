...
// constructor tests
var noArgument = bigInt(), numberArgument = bigInt(93), stringArgument = bigInt("75643564363473453456342378564387956906736546456235345"), baseArgumentInt = bigInt("101010", 2), baseArgumentStr = bigInt("101010", "2"), baseArgumentBi = bigInt("101010", bigInt(2)), bigIntArgument = bigInt(noArgument);
// method tests
var x = bigInt(), isBigInteger, isNumber, isBoolean, isString, isDivmod;
isBigInteger = x.abs();
