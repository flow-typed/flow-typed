...
var npm$namespace$pako: {
     ...
     */
declare
export function pako$deflate(data: Uint8Array | Array<number>| string, options?: any): string
 ...
 */
declare
export function pako$deflateRaw(data: Uint8Array | Array<number>| string, options?: any): string
 ...
 */
declare
export function pako$gzip(data: Uint8Array | Array<number>| string, options?: any): string
 ...
 */
declare
export function pako$inflate(data: Uint8Array | Array<number>| string, options?: any): Uint8Array
 ...
 */
declare
export function pako$inflateRaw(data: Uint8Array | Array<number>| string, options?: any): Uint8Array
 ...
 */
declare
export function pako$ungzip(data: Uint8Array | Array<number>| string, options?: any): Uint8Array
