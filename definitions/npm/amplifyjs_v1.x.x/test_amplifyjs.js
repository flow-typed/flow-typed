...
var myStoredValue = amplify.store("storeExample1"), myStoredValue2 = amplify.store("storeExample2"), myStoredValues = amplify.store();
...
//Example:
var appEnvelopeDecoder = function (data, status, xhr, success, error) {
