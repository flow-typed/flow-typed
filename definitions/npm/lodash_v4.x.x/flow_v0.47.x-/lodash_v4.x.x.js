...
declare module "lodash/fp" {
  ...
  declare class Lodash {
    ...
    chunk<T>(size: number, array: Array<T>): Array<Array<T>>,
    compact<T, N: T>(array: Array<N>): Array<T>,
    concat<T, U>(base: Array<T>): ((elements: Array<U>) => Array<T | U>) & ((element: U) => Array<T | U>),
    concat<T, U>(base: Array<T>, elements: Array<U>): Array<T | U>,
    concat<T, U>(base: Array<T>, element: U): Array<T | U>,
    ...
    find<V, A, T>(predicate: OPredicate<A>): ((object: T) => V) & ((array: Array<T>) => T | void),
    find<V, A, T: { [id: string]: A }>(predicate: OPredicate<A>, object: T): V,
    findFrom<T>(predicate: Predicate<T>): ((fromIndex: number) => (array: Array<T>) => T | void) & ((fromIndex: number, array: Array<T>) => T | void),
    findFrom<T>(predicate: Predicate<T>, fromIndex: number): (array: Array<T>) => T | void,
    findFrom<T>(predicate: Predicate<T>, fromIndex: number, array: Array<T>): T | void,
    findFrom<V, A, T: { [id: string]: A }>(predicate: OPredicate<A>): ((fromIndex: number) => (object: T) => V) & ((fromIndex: number, object: T) => V),
    findFrom<V, A, T: { [id: string]: A }>(predicate: OPredicate<A>, fromIndex: number): (object: T) => V,
    findFrom<V, A, T: { [id: string]: A }>(predicate: OPredicate<A>, fromIndex: number, object: T): V,
    findLast<T>(predicate: Predicate<T>): (array: Array<T>) => T | void,
    findLast<T>(predicate: Predicate<T>, array: Array<T>): T | void,
    findLast<V, A, T: { [id: string]: A }>(predicate: OPredicate<A>): (object: T) => V,
    findLast<V, A, T: { [id: string]: A }>(predicate: OPredicate<A>, object: T): V,
    findLastFrom<T>(predicate: Predicate<T>): ((fromIndex: number) => (array: Array<T>) => T | void) & ((fromIndex: number, array: Array<T>) => T | void),
    findLastFrom<T>(predicate: Predicate<T>, fromIndex: number): (array: Array<T>) => T | void,
    findLastFrom<T>(predicate: Predicate<T>, fromIndex: number, array: Array<T>): T | void,
    findLastFrom<V, A, T: { [id: string]: A }>(predicate: OPredicate<A>): ((fromIndex: number) => (object: T) => V) & ((fromIndex: number, object: T) => V),
    ...
    flatMapDeep<T: Object, U>(iteratee: OFlatMapIteratee<T, U>, object: T): Array<U>,
    flatMapDepth<T, U>(iteratee: FlatMapIteratee<T, U>): ((depth: number) => (array: Array<T>) => Array<U>) & ((depth: number, array: Array<T>) => Array<U>),
    flatMapDepth<T, U>(iteratee: FlatMapIteratee<T, U>, depth: number): (array: Array<T>) => Array<U>,
    flatMapDepth<T, U>(iteratee: FlatMapIteratee<T, U>, depth: number, array: Array<T>): Array<U>,
    flatMapDepth<T: Object, U>(iteratee: OFlatMapIteratee<T, U>): ((depth: number) => (object: T) => Array<U>) & ((depth: number, object: T) => Array<U>),
    ...
    includes<T: Object>(value: any, object: T): boolean,
    contains<T: Object>(value: any): (object: T) => boolean,
    contains<T: Object>(value: any, object: T): boolean,
    includes(value: string): (str: string) => boolean,
    includes(value: string, str: string): boolean,
    contains(value: string): (str: string) => boolean,
    contains(value: string, str: string): boolean,
    includesFrom<T>(value: T): ((fromIndex: number) => (array: Array<T>) => boolean) & ((fromIndex: number, array: Array<T>) => boolean),
    ...
    invokeMap<T: Object>(path: ((value: any) => Array<string> | string) | Array<string> | string, object: T): Array<any>,
    invokeArgsMap<T>(path: ((value: T) => Array<string> | string) | Array<string> | string): ((array: Array<T>) => (args: Array<any>) => Array<any>) & ((array: Array<T>, args: Array<any>) => Array<any>),
    invokeArgsMap<T>(path: ((value: T) => Array<string> | string) | Array<string> | string, array: Array<T>): (args: Array<any>) => Array<any>,
    invokeArgsMap<T>(path: ((value: T) => Array<string> | string) | Array<string> | string, array: Array<T>, args: Array<any>): Array<any>,
    invokeArgsMap<T: Object>(path: ((value: any) => Array<string> | string) | Array<string> | string): ((object: T) => (args: Array<any>) => Array<any>) & ((object: T, args: Array<any>) => Array<any>),
    ...
    keyBy<V, A, I, T>(iteratee: ValueOnlyIteratee<A>): ((object: T) => { [key: V]: A }) & ((array: Array<T>) => { [key: V]: T }),
    ...
    pluck(iteratee: (char: string) => any, str: string): string,
    orderBy<T>(iteratees: Array<Iteratee<T>> | string): ((orders: Array<"asc" | "desc"> | string) => (array: Array<T>) => Array<T>) & ((orders: Array<"asc" | "desc"> | string, array: Array<T>) => Array<T>),
    orderBy<T>(iteratees: Array<Iteratee<T>> | string, orders: Array<"asc" | "desc"> | string): (array: Array<T>) => Array<T>,
    orderBy<T>(iteratees: Array<Iteratee<T>> | string, orders: Array<"asc" | "desc"> | string, array: Array<T>): Array<T>,
    orderBy<V, T: Object>(iteratees: Array<OIteratee<*>> | string): ((orders: Array<"asc" | "desc"> | string) => (object: T) => Array<V>) & ((orders: Array<"asc" | "desc"> | string, object: T) => Array<V>),
    ...
    partition<V, A, T: { [id: string]: A }>(predicate: OPredicate<A>, object: T): NestedArray<V>,
    reduce<T, U>(iteratee: (accumulator: U, value: T) => U): ((accumulator: U) => (array: Array<T>) => U) & ((accumulator: U, array: Array<T>) => U),
    reduce<T, U>(iteratee: (accumulator: U, value: T) => U, accumulator: U): (array: Array<T>) => U,
    reduce<T, U>(iteratee: (accumulator: U, value: T) => U, accumulator: U, array: Array<T>): U,
    reduce<T: Object, U>(iteratee: (accumulator: U, value: any) => U): ((accumulator: U) => (object: T) => U) & ((accumulator: U, object: T) => U),
    reduce<T: Object, U>(iteratee: (accumulator: U, value: any) => U, accumulator: U): (object: T) => U,
    reduce<T: Object, U>(iteratee: (accumulator: U, value: any) => U, accumulator: U, object: T): U,
    reduceRight<T, U>(iteratee: (value: T, accumulator: U) => U): ((accumulator: U) => (array: Array<T>) => U) & ((accumulator: U, array: Array<T>) => U),
    reduceRight<T, U>(iteratee: (value: T, accumulator: U) => U, accumulator: U): (array: Array<T>) => U,
    reduceRight<T, U>(iteratee: (value: T, accumulator: U) => U, accumulator: U, array: Array<T>): U,
    reduceRight<T: Object, U>(iteratee: (value: any, accumulator: U) => U): ((accumulator: U) => (object: T) => U) & ((accumulator: U, object: T) => U),
