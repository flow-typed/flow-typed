 ...
 * _.keyBy
 */
_.keyBy([{ dir: "left", code: 97 }, { dir: "right", code: 100 }], function(o) {
...
var keyByTest_map2: KeyByTest$ByNumberMaybe<?KeyByTest$Record> = _.keyBy(
  keyByTest_map,
  "id"
);
 ...
 * _.sortedIndexBy
 */
_.sortedIndexBy([{ x: 4 }, { x: 5 }], { x: 4 }, function(o) {
  return o.x;
});
 ...
 * _.sortedLastIndexBy
 */
_.sortedLastIndexBy([{ x: 4 }, { x: 5 }], { x: 4 }, function(o) {
  return o.x;
});
...
boolFalse = _.isString(function(f) {
  return f;
});
boolFalse = _.isString();
...
num = _.tap(1, function(n) {
  return false;
});
bool = _.thru(1, function(n) {
  return false;
});
...
timesNums = _.times(5, function(i: number) {
  return i + 1;
});
// $ExpectError string. This type is incompatible with number
timesNums = _.times(5, function(i: number) {
 ...
 * _.memoize
 */
var memoized: (a: number) => string = _.memoize((a: number) => "foo");
 ...
 * _.debounce
 */
var debounced: (a: number) => string = _.debounce((a: number) => "foo");
