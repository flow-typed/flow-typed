/**
 * Flowtype definitions for rx.experimental
...
declare interface Rx$Observable<T>{
     ...
     */
    let<TResult>(
        selector: (source: Rx$Observable<T>) => Rx$Observable<TResult>): Rx$Observable<TResult>,
     ...
     */
    doWhile(condition: () => boolean): Rx$Observable<T>,
    ...
    forkJoin<TSecond,
    TResult>(
        second: Rx$Observable<TSecond>,
        resultSelector: (left: T, right: TSecond) => TResult): Rx$Observable<TResult>,
    forkJoin<TSecond,
    TResult>(
...
declare interface Rx$ObservableStatic {
     ...
     * @example  * res = Rx.Observable.if(condition, obs1, obs2);
    ...
    if <T>(
            condition: () => boolean,
            thenSource: Rx$Observable<T>,
            elseSource: Rx$Observable<T>): Rx$Observable<T>,
        if <T>(
            condition: () => boolean,
            thenSource: Rx$Observable<T>,
            elseSource: IPromise<T>): Rx$Observable<T>,
        if <T>(
            condition: () => boolean,
        ...
        /**
         * Determines whether an observable collection contains values. There is an alias for this method called 'ifThen' for browsers <IE9
         * @example  * res = Rx.Observable.if(condition, obs1, scheduler);
        ...
        for<T, TResult>(
            sources: T[],
            resultSelector: (item: T) => Rx$Observable<TResult>): Rx$Observable<TResult>,
         ...
         * @returns  An observable sequence which is repeated as long as the condition holds.
         */
        while<T>(condition: () => boolean, source: Rx$Observable<T>): Rx$Observable<T>,
        while<T>(condition: () => boolean, source: IPromise<T>): Rx$Observable<T>,
         ...
         * @returns  An observable sequence which is repeated as long as the condition holds.
         */
        whileDo<T>(condition: () => boolean, source: Rx$Observable<T>): Rx$Observable<T>,
        whileDo<T>(condition: () => boolean, source: IPromise<T>): Rx$Observable<T>,

        /**
         * Uses selector to determine which source in sources to use.
         * There is an alias 'switchCase' for browsers <IE9.
         * @example  *  res = Rx.Observable.case(selector, { '1': obs1, '2': obs2 }, obs0);
        ...
        case <T>(
            selector: () => string,
            sources: {
                [key: string]: Rx$Observable<T >
            },
            elseSource: Rx$Observable<T>):
    Rx$Observable<T>,
        case <T>(
            selector: () => string,
            sources: {
    ...
    Rx$Observable<T>,
         ...
         * Uses selector to determine which source in sources to use.
         * There is an alias 'switchCase' for browsers <IE9.
         * @example  *  res = Rx.Observable.case(selector, { '1': obs1, '2': obs2 });
    ...
    Rx$Observable<T>,
        ...
        */
         ...
         * @example  * res = Rx.Observable.forkJoin([obs1, obs2]);
         ...
         */
        forkJoin<T>(sources: Rx$Observable<T>[]): Rx$Observable<T[]>,
        forkJoin<T>(sources: IPromise<T>[]): Rx$Observable<T[]>,
         ...
         * @returns  An observable sequence with an array collecting the last elements of all the input sequences.
         */
        forkJoin<T>(...args: Rx$Observable<T>[]): Rx$Observable<T[]>,
        forkJoin<T>(...args: IPromise<T>[]): Rx$Observable<T[] >
}
