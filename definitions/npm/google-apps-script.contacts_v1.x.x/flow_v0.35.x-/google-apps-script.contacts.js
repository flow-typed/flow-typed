...
declare module 'google-apps-script.contacts' {
					
}

declare module 'Contacts' {
		declare export interface AddressField {
	...
	declare export interface CompanyField {
	...
	declare export interface ContactGroup {
	...
	declare export interface ContactsApp {
	...
	declare export interface CustomField {
	...
	declare export interface DateField {
	...
	declare export interface EmailField {
	...
	declare export interface IMField {
		deleteIMField(): void,
		getAddress(): string,
		getLabel(): Object,
		isPrimary(): boolean,
	...
	declare export interface PhoneField {
	...
	declare export interface UrlField {
		deleteUrlField(): void,
		getAddress(): string,
		getLabel(): Object,
		isPrimary(): boolean,
