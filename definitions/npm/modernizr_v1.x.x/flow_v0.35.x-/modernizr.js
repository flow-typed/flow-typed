/**
 * Flowtype definitions for modernizr
...
declare interface ___Modernizr$AudioBoolean {
    ogg: boolean,
        mp3: boolean,
        wav: boolean,
        m4a: boolean
...
declare interface ___Modernizr$VideoBoolean {
    ogg: boolean,
        h264: boolean,
        webm: boolean
}

declare interface ___Modernizr$InputBoolean {
...
declare interface ___Modernizr$InputTypesBoolean {
    color: boolean,
        date: boolean,
        datetime: boolean,
...
declare interface ___Modernizr$FeatureDetects {
    ambientlight: boolean,
        applicationcache: boolean,
        audio: ___Modernizr$AudioBoolean,
        batteryapi: boolean,
        ...
        input: ___Modernizr$InputBoolean,
        search: boolean,
        inputtypes: ___Modernizr$InputTypesBoolean,
        intl: boolean,
        json: boolean,
        ligatures: boolean,
        olreversed: boolean,
        ...
        userdata: boolean,
        vibrate: boolean,
        video: ___Modernizr$VideoBoolean,
        vml: boolean,
        webintents: boolean,
        animation: boolean,
        webgl: boolean,
...
declare interface ___Modernizr$Dictionary<T>{
    [key: string]: T
}

declare interface ___Modernizr$ModernizrAPI {
    on(feature: string, cb: (result: boolean) => any): void,
        addTest(feature: string, test: () => boolean): void,
        addTest(feature: string, test: boolean): void,
        addTest(feature: ___Modernizr$Dictionary<any>): void,
