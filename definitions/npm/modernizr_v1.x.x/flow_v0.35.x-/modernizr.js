import type { ModernizrStatic } from 'npm$namespace$___Modernizr'

declare module 'modernizr' {
					
}

declare module 'npm$namespace$___Modernizr' {
		declare interface AudioBoolean {
		ogg: boolean,
		mp3: boolean,
		wav: boolean,
		m4a: boolean
	...
	declare interface VideoBoolean {
		ogg: boolean,
		h264: boolean,
		webm: boolean
	}

	declare interface InputBoolean {
	...
	declare interface InputTypesBoolean {
		color: boolean,
		date: boolean,
		datetime: boolean,
	...
	declare interface FeatureDetects {
	...
	declare interface ModernizrAPI {
		...
		testStyles(
		rule: string, callback: (elem: HTMLDivElement, rule: string) => void, nodes?: number, testnames?: string[]
	): boolean
	}

	declare export interface ModernizrStatic {
