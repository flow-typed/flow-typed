...
declare export function launch/*:: <T> */(
  unit: Unit/*:: <T> */,
  payload: T
): void;
...
declare export function fromObservable/*:: <T> */(
  observable: mixed
): Event/*:: <T> */;

declare export function createEvent/*:: <E> */(
  eventName?: string
): Event/*:: <E> */;
...
declare export function restore/*:: <E> */(
  event: Event/*:: <E> */,
  defaultState: E
): Store/*:: <E> */;
...
declare export function withRegion(
  unit: Unit/*:: <any> */ | Node,
  cb: () => void
): void;
...
declare export function combine/*:: <State: StoreObject> */(
  ...
  $ObjMap/*:: <State, /*:: <S> */(field: Store/*:: <S> */ | S) => S> */
> */;
declare export function combine/*:: <State: StoreTuple> */(
  list: State
): Store/*:: <
  $TupleMap/*:: <State, /*:: <S> */(field: Store/*:: <S> */ | S) => S> */
> */;
...
declare export function combine/*:: <State: StoreObject, R> */(
  shape: State,
  fn: (
    shape: $ObjMap/*:: <State, /*:: <S> */(field: Store/*:: <S> */ | S) => S> */
  ) => R
): Store/*:: <R> */;
