/**
 * Flowtype definitions for synaptic
...
declare class Neuron {
     ...
     */
    project(neuron: Synaptic$Neuron, weight?: number): Neuron$Connection;
...
declare class Layer {
     ...
     */
    project(
        layer: Synaptic$Layer | Synaptic$Network,
...
declare class Network {
     ...
     */
    project(
        otherNetwork: Synaptic$Network | Synaptic$Layer,
        connectionType?: Layer$connectionType,
        weights?: any): Layer$LayerConnection;
     ...
     */
    fromJSON(exported: string): Synaptic$Network;
 ...
 */
declare class Perceptron mixins Network {
 ...
 */
declare class LSTM mixins Network {
    trainer: Synaptic$Trainer;
 ...
 */
declare class Liquid mixins Network {
    trainer: Synaptic$Trainer;
 ...
 */
declare class Hopfield mixins Network {
...
declare class Trainer {
     ...
     * @param network 
     */
    constructor(network: Synaptic$Network): this;
    ...
    train(
        ...
        trainingOptions?: Trainer$TrainingOptions): Trainer$TrainingResult;
    ...
    trainAsync(
        trainingSet: Trainer$TrainingSet,
        trainingOptions?: Trainer$TrainingOptions): Promise<Trainer$TrainingResult>;
