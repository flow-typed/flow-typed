/**
 * Flowtype definitions for sequelize-2.0.0
...
declare module 'sequelize' {
    declare interface sequelize$SequelizeStaticAndInstance {
        ...
        */
        Utils: sequelize$Utils,
            ...
            */
             ...
             */
            and(...args: Array<any>): sequelize$And,

            /**
             * An OR query.
             * @param args Each argument (string or object) will be joined by OR.
             */
            or(...args: Array<any>): sequelize$Or,
             ...
             */
            where(attr: string, condition: any): sequelize$Where
    }
    ...
    declare type sequelize$SequelizeStatic = {
         ...
         */
        new(database: string, username: string): sequelize$Sequelize,
         ...
         */
        new(database: string, username: string, password: string): sequelize$Sequelize,
         ...
         * @param options Options for sequelize. 
         * @see  Options
         */
        new(connectionString: string, options?: sequelize$Options): sequelize$Sequelize
    ...
    declare type sequelize$Sequelize = {
         ...
         */
        models: any,
        modelManager: sequelize$ModelManager,
        daoFactoryManager: sequelize$ModelManager,
        transactionManager: sequelize$TransactionManager,
        importCache: any,
         ...
         */
        getMigrator(options?: sequelize$MigratorOptions, force?: boolean): sequelize$Migrator,
        ...
        */
        ...
        TPojo>(
            daoName: string,
            attributes: any,
            options?: sequelize$DefineOptions): sequelize$Model<TInstance,
        TPojo>,
         ...
         */
        model<TInstance,
        TPojo>(daoName: string): sequelize$Model<TInstance,
        TPojo>,
        ...
        */
        import<TInstance,
        TPojo>(path: string): sequelize$Model<TInstance,
        TPojo>,
        ...
        */
        query(
            sql: string,
            callee?: sequelize$Model<any, any>,
            options?: sequelize$QueryOptions,
            replacements?: any): sequelize$EventEmitter,
        query<TInstance,
        TPojo>(
            sql: string,
            callee?: sequelize$Model<TInstance, TPojo>,
            options?: sequelize$QueryOptions): sequelize$EventEmitterT<sequelize$Model<TInstance,
        TPojo >> ,
         ...
         */
        createSchema(schema: string): sequelize$EventEmitter,

        /**
         * Show all defined schemas.
         */
        showAllSchemas(): sequelize$EventEmitter,

        /**
         * Drop a single schema.
         * @param schema Name of the schema.
         */
        dropSchema(schema: string): sequelize$EventEmitter,

        /**
         * Drop all schemas.
         */
        dropAllSchemas(): sequelize$EventEmitter,

        /**
         * Sync all defined DAOs to the DB.
         * @param options Options.
         */
        sync(options?: sequelize$SyncOptions): sequelize$EventEmitter,

        /**
         * Drop all tables defined through this sequelize instance. This is done by calling Model.drop on each model.
         * @param options The options passed to each call to Model.drop.
         */
        drop(options: sequelize$DropOptions): sequelize$EventEmitter,

        /**
         * Test the connection by trying to authenticate. Alias for 'validate'.
         */
        authenticate(): sequelize$EventEmitter,

        /**
         * Alias for authenticate(). Test the connection by trying to authenticate. Alias for 'validate'.
         */
        validate(): sequelize$EventEmitter,
        ...
        */
        transaction(callback: (transaction: sequelize$Transaction) => boolean): sequelize$Promise,
        ...
        */
        transaction(
            ...
            callback?: (transaction: sequelize$Transaction) => void): sequelize$PromiseT<sequelize$Transaction>,
        close(): void
    } & sequelize$SequelizeStaticAndInstance


    declare interface sequelize$Config {
        database?: string,
            username?: string,
            password?: string,
            host?: string,
    ...
    declare type sequelize$Model<TInstance, TPojo>= {
         ...
         */
        sync(
            options?: sequelize$SyncOptions): sequelize$PromiseT<sequelize$Model<TInstance,
        TPojo >> ,
         ...
         * @param options 
         */
        drop(options?: sequelize$DropOptions): sequelize$Promise,
        ...
        */
        schema(
            schema: string,
            options?: sequelize$SchemaOptions): sequelize$Model<TInstance,
        TPojo>,
        ...
        */
        scope(options: any): sequelize$Model<TInstance,
        TPojo>,
        ...
        */
        findAll(
            ...
            queryOptions?: sequelize$QueryOptions): sequelize$PromiseT<Array<TInstance >> ,
        ...
        */
        find(
            options?: sequelize$FindOptions,
            queryOptions?: sequelize$QueryOptions): sequelize$PromiseT<TInstance>,
        ...
        */
        ...
        aggregate<V>(
            ...
            options: sequelize$FindOptions): sequelize$PromiseT<V>,

        /**
         * Count the number of records matching the provided where clause.
         * @param options Conditions and options for the query.
         */
        count(options?: sequelize$FindOptions): sequelize$PromiseT<number>,
        ...
        findAndCountAll(
            ...
            queryOptions?: sequelize$QueryOptions): sequelize$PromiseT<sequelize$FindAndCountResult<TInstance >> ,
         ...
         * @param options 
         */
        max<V>(field: string, options?: sequelize$FindOptions): sequelize$PromiseT<V>,
         ...
         * @param options 
         */
        min<V>(field: string, options?: sequelize$FindOptions): sequelize$PromiseT<V>,
         ...
         * @param options 
         */
        sum(field: string, options?: sequelize$FindOptions): sequelize$PromiseT<number>,
         ...
         */
        build(values: TPojo, options?: sequelize$BuildOptions): TInstance,
         ...
         * @param options 
         */
        create(values: TPojo, options?: sequelize$CopyOptions): sequelize$PromiseT<TInstance>,
        ...
        */
        findOrInitialize(
            where: any,
            defaults?: TPojo,
            options?: sequelize$QueryOptions): sequelize$PromiseT<TInstance>,
        ...
        */
        findOrCreate(
            where: any,
            defaults?: TPojo,
            options?: sequelize$FindOrCreateOptions): sequelize$PromiseT<TInstance>,
        ...
        bulkCreate(
            records: Array<TPojo>,
            options?: sequelize$BulkCreateOptions): sequelize$PromiseT<Array<TInstance >> ,

        /**
         * Delete multiple instances.
         */
        destroy(where?: any, options?: sequelize$DestroyOptions): sequelize$Promise,
    ...
    declare interface sequelize$Instance<TInstance, TPojo>{
         ...
         */
        Model: sequelize$Model<TInstance,
        TPojo>,
         ...
         */
        set(key: string, value: any, options?: sequelize$SetOptions): void,
        ...
        */
        ...
        save(
            fields?: Array<string>,
            options?: sequelize$SaveOptions): sequelize$PromiseT<TInstance>,
        ...
        */
        reload(options?: sequelize$FindOptions): sequelize$PromiseT<TInstance>,

        /**
         * Validate the attribute of this instance according to validation rules set in the model definition.
         */
        validate(options?: sequelize$ValidateOptions): sequelize$PromiseT<Error>,

        /**
         * This is the same as calling setAttributes, then calling save.
         */
        updateAttributes(updates: TPojo, options: sequelize$SaveOptions): sequelize$PromiseT<TInstance>,
         ...
         */
        destroy(options?: sequelize$DestroyInstanceOptions): sequelize$Promise,
        ...
        */
        increment(fields: any, options?: sequelize$IncrementOptions): sequelize$Promise,
        ...
        */
        decrement(fields: any, options?: sequelize$IncrementOptions): sequelize$Promise,
    ...
    declare type sequelize$Transaction = {
         ...
         */
        rollback(): sequelize$Transaction
    } & sequelize$TransactionStatic
    ...
    declare interface sequelize$TransactionStatic {
        ...
        ISOLATION_LEVELS: sequelize$TransactionIsolationLevels,
             ...
             */
            LOCK: sequelize$TransactionLocks
    }
    ...
    declare interface sequelize$TransactionLocks {
        UPDATE: string,
            SHARE: string
    }

    declare interface sequelize$Hooks {
        ...
        addHook(hooktype: string, name: string, fn: (...args: Array<any>) => void): boolean,
            ...
            beforeValidate<T>(
                name: string,
                validator: (dao: T, callback: (err?: Error) => void) => void): void,
            ...
            afterValidate<T>(
                name: string,
                validator: (dao: T, callback: (err?: Error, dao?: T) => void) => void): void,
            ...
            beforeBulkCreate<T>(
                ...
                validator: (
                    daos: Array<T>,
                    fields: Array<string>,
                    callback: (err?: Error, dao?: T) => void) => void): void,
            ...
            beforeBulkDestroy<T>(
                name: string,
                validator: (where: any, callback: (err?: Error, where?: any) => void) => void): void,
            ...
            beforeBulkUpdate<T>(
                ...
                validator: (
                    instances: Array<T>,
                    where: any,
                    callback: (err?: Error, instances?: Array<T>, where?: any) => void) => void): void,
    ...
    declare interface sequelize$Associations {
        ...
        hasOne<TInstance, TPojo>(
                target: sequelize$Model<TInstance, TPojo>,
                options?: sequelize$AssociationOptions): void,
    ...
    */
    declare interface sequelize$Validator {}


    /**
     * Custom class defined, but no extra methods or functionality even.
     */
    declare type sequelize$ValidationError = {} & Error


    declare interface sequelize$QueryChainer {
        ...
        */
        add(
                ...
                method?: string,
                params?: any,
                options?: any): sequelize$QueryChainer,
             ...
             */
            run(): sequelize$EventEmitter,

            /**
             * Run the chainer serially, so that each query waits for the previous one to finish before it starts.
             * @param options 
             * @see  QueryChainerRunSeriallyOptions
             */
            runSerially(options?: sequelize$QueryChainerRunSeriallyOptions): sequelize$EventEmitter
    }
    ...
    declare interface sequelize$QueryInterface {
         ...
         */
        QueryGenerator: sequelize$QueryGenerator,
             ...
             * @param options 
             */
            showAllSchemas(options?: sequelize$QueryOptions): sequelize$EventEmitter,
             ...
             */
            createTable(tableName: string, attributes: any, options?: sequelize$QueryOptions): any,
             ...
             */
            dropTable(tableName: string, options?: sequelize$QueryOptions): sequelize$EventEmitter,
            dropAllTables(options?: sequelize$QueryOptions): sequelize$EventEmitter,
            dropAllEnums(options?: sequelize$QueryOptions): sequelize$EventEmitter,
            renameTable(before: string, after: string): sequelize$EventEmitter,
            showAllTables(options?: sequelize$QueryOptions): sequelize$EventEmitter,
            describeTable(tableName: string, options?: sequelize$QueryOptions): sequelize$EventEmitter,
            addColumn(
                tableName: string,
                attributeName: any,
                dataTypeOrOptions?: any): sequelize$EventEmitter,
            removeColumn(tableName: string, attributeName: string): sequelize$EventEmitter,
            changeColumn(
                tableName: string,
            ...
            renameColumn(
                ...
                attrNameAfter: string): sequelize$EventEmitter,
            addIndex(
                tableName: string,
                attributes: Array<any>,
                options?: sequelize$QueryOptions): sequelize$EventEmitter,
            showIndex(tableName: string, options?: sequelize$QueryOptions): sequelize$EventEmitter,
            getForeignKeysForTables(tableNames: Array<string>): sequelize$EventEmitter,
            removeIndex(tableName: string, attributes: Array<string>): sequelize$EventEmitter,
            removeIndex(tableName: string, indexName: string): sequelize$EventEmitter,
            insert<TModel>(
                dao: TModel,
                tableName: string,
                values: any,
            ...
            bulkInsert(
                ...
                records: Array<any>,
                options?: sequelize$QueryOptions,
                attributes?: any): sequelize$EventEmitter,
            update<TModel>(
                dao: TModel,
                tableName: string,
                values: Array<any>,
            ...
            bulkDelete<TModel>(
                ...
                where: any,
                options: sequelize$QueryOptions,
                model: TModel): sequelize$EventEmitter,
            select<TModel>(
                factory: TModel,
                tableName: string,
                scope?: any,
                queryOptions?: sequelize$QueryOptions): sequelize$EventEmitter,
            increment<TModel>(
                dao: TModel,
                tableName: string,
                values: Array<any>,
            ...
            createTrigger(
                ...
                optionsArray: Array<string>): sequelize$EventEmitter,
             ...
             * @param triggerName 
             */
            dropTrigger(tableName: string, triggerName: string): sequelize$EventEmitter,
            renameTrigger(
                tableName: string,
                oldTriggerName: string,
                newTriggerName: string): sequelize$EventEmitter,
            createFunction(
                functionName: string,
                params: Array<any>,
                returnType: string,
                ...
                body: string,
                options?: sequelize$QueryOptions): sequelize$EventEmitter,
            dropFunction(functionName: string, params: Array<any>): sequelize$EventEmitter,
            renameFunction(
                oldFunctionName: string,
                params: Array<any>,
                newFunctionName: string): sequelize$EventEmitter,
            ...
            false.
            */
            quoteIdentifier(identifier: string, force: boolean): sequelize$EventEmitter,
            quoteTable(tableName: string): sequelize$EventEmitter,
            quoteIdentifiers(identifiers: string, force: boolean): sequelize$EventEmitter,
            escape(value: string): sequelize$EventEmitter,
            setAutocommit(transaction: sequelize$Transaction, value: boolean): sequelize$EventEmitter,
            setIsolationLevel(transaction: sequelize$Transaction, value: string): sequelize$EventEmitter,
            startTransaction(
    ...
    declare interface sequelize$QueryGenerator {
        createSchema(schemaName: string): string,
            dropSchema(schemaName: string): string,
            showSchemasQuery(): string,
            addSchema<TInstance, TPojo>(param: sequelize$Model<TInstance, TPojo>): sequelize$Schema,
            createTableQuery(
                tableName: string,
                attributes: Array<any>,
                options?: sequelize$CreateTableQueryOptions): string,
            ...
            updateQuery(
                ...
                attrValueHash: any,
                where: any,
                options: sequelize$InsertOptions,
                attributes: any): string,
            deleteQuery(tableName: string, where: any, options: sequelize$DestroyOptions): string,
            deleteQuery<TInstance, TPojo>(
                tableName: string,
                where: any,
                options: sequelize$DestroyOptions,
                model: sequelize$Model<TInstance, TPojo>): string,
            ...
            addIndexQuery(
                tableName: string,
                attributes: Array<any>,
                options?: sequelize$IndexOptions): string,
            ...
            findAutoIncrementField<TInstance, TPojo>(factory: sequelize$Model<TInstance, TPojo>): Array<string>,
            ...
            createTrigger(
                ...
                triggerName: string,
                timingType: string,
                fireOnArray: sequelize$TriggerOptions,
                functionName: string,
                functionParams: Array<sequelize$TriggerParam>): string,
            ...
            createFunction(
                functionName: string,
                params: Array<sequelize$TriggerParam>,
                returnType: string,
                language: string,
                body: string,
                options?: Array<string>): string,
            dropFunction(functionName: string, params: Array<sequelize$TriggerParam>): string,
            renameFunction(
                oldFunctionName: string,
                params: Array<sequelize$TriggerParam>,
                newFunctionName: string): string,
            ...
            selectQuery<TInstance, TPojo>(
                tableName: string,
                options: sequelize$SelectOptions,
                model?: sequelize$Model<TInstance, TPojo>): string,
            selectQuery<TInstance, TPojo>(
            ...
            addLimitAndOffset(options: sequelize$SelectOptions, query?: string): string,
            getWhereConditions<TInstance, TPojo>(
                smth: any,
                tableName: string,
                factory: sequelize$Model<TInstance, TPojo>,
                options?: any,
                prepend?: boolean): string,
            prependTableNameToHash(tableName: string, hash?: any): string,
            findAssociation<TInstance, TPojo>(
                attribute: string,
                dao: sequelize$Model<TInstance, TPojo>): string,
            getAssociationFilterDAO<TInstance, TPojo>(
                filterStr: string,
                dao: sequelize$Model<TInstance, TPojo>): string,
            isAssociationFilter<TInstance, TPojo>(
                filterStr: string,
                dao: sequelize$Model<TInstance, TPojo>,
                options?: any): string,
            ...
            getConditionalJoins<TInstance, TPojo>(
                ...
                originalDao: sequelize$Model<TInstance, TPojo>): string,
            arrayValue(
                value: Array<string>,
                key: string,
                _key: string,
                factory?: any,
                logicResult?: any): string,
            hashToWhereConditions<TInstance, TPojo>(
                hash: any,
                dao: sequelize$Model<TInstance, TPojo>,
                options?: sequelize$HashToWhereConditionsOption): string,
            booleanValue(value: boolean): string
    }

    declare interface sequelize$Schema {
        tableName: string,
            table: string,
            name: string,
            schema: string,
    ...
    declare interface sequelize$ModelManager {
        daos: Array<sequelize$Model<any, any >> ,
            sequelize: sequelize$Sequelize,
            addDAO<TInstance, TPojo>(
                dao: sequelize$Model<TInstance, TPojo>): sequelize$Model<TInstance, TPojo>,
            removeDAO<TInstance, TPojo>(dao: sequelize$Model<TInstance, TPojo>): void,
            getDAO<TInstance, TPojo>(
                daoName: string,
                options?: sequelize$ModelMangerGetDaoOptions): sequelize$Model<TInstance, TPojo>,
            all: Array<sequelize$Model<any, any >> ,
            ...
            */
            forEachDAO(
                iterator: (dao: sequelize$Model<any, any>, name: string) => void,
                options?: sequelize$ModelManagerForEachDaoOptions): void
    }

    declare interface sequelize$TransactionManager {
        sequelize: sequelize$Sequelize,
            connectorManagers: any,
            getConnectorManager(uuid?: string): sequelize$ConnectorManager,
    ...
    declare interface sequelize$ConnectorManager {
    ...
    declare interface sequelize$Migrator {
        queryInterface: sequelize$QueryInterface,
            migrate(options?: sequelize$MigratorOptions): sequelize$EventEmitter,
            getUndoneMigrations(callback: (err: Error, result: Array<sequelize$Migrator>) => void): void,
            findOrCreateMetaDAO(syncOptions?: sequelize$SyncOptions): sequelize$EventEmitter,
            exec(
                filename: string,
                options?: sequelize$MigratorExecOptions): sequelize$EventEmitter,
            getLastMigrationFromDatabase(): sequelize$EventEmitter,
            getLastMigrationIdFromDatabase(): sequelize$EventEmitter,
            getFormattedDateString(s: string): string,
            stringToDate(s: string): Date,
            saveSuccessfulMigration(
                from: sequelize$Migration,
                to: sequelize$Migration,
                callback: (metaData: sequelize$MetaInstance) => void): void,
            deleteUndoneMigration(from: sequelize$Migration, to: sequelize$Migration, callback: () => void): void,
            execute(options?: sequelize$MigrationExecuteOptions): sequelize$EventEmitter,
            isBefore(date: Date, options?: sequelize$MigrationCompareOptions): boolean,
            isAfter(date: Date, options?: sequelize$MigrationCompareOptions): boolean
    }

    declare type sequelize$Migration = {
        migrator: sequelize$Migrator,
        path: string,
        filename: string,
        migrationId: number,
        date: Date,
    ...
    declare type sequelize$EventEmitter = {} & sequelize$EventEmitterT &


        declare type sequelize$EventEmitterT<R>= {
             ...
             */
            new(
                handler: (emitter: sequelize$EventEmitterT<R>) => void): sequelize$EventEmitterT<R>,

            /**
             * Run the function that was passed when the emitter was instantiated.
             */
            run(): sequelize$EventEmitterT<R>,

            /**
             * Listen for success events.
             * @param onSuccess 
             */
            success(onSuccess: (result: R) => void): sequelize$EventEmitterT<R>,

            /**
             * Alias for success(handler). Listen for success events.
             * @param onSuccess 
             */
            ok(onSuccess: (result: R) => void): sequelize$EventEmitterT<R>,

            /**
             * Listen for error events.
             * @param onError 
             */
            error(onError: (err: Error) => void): sequelize$EventEmitterT<R>,

            /**
             * Alias for error(handler). Listen for error events.
             * @param onError 
             */
            fail(onError: (err: Error) => void): sequelize$EventEmitterT<R>,

            /**
             * Alias for error(handler). Listen for error events.
             * @param onError 
             */
            failure(onError: (err: Error) => void): sequelize$EventEmitterT<R>,

            /**
             * Listen for both success and error events.
             * @param onDone 
             */
            done(onDone: (err: Error, result: R) => void): sequelize$EventEmitterT<R>,

            /**
             * Alias for done(handler). Listen for both success and error events.
             * @param onDone 
             */
            complete(onDone: (err: Error, result: R) => void): sequelize$EventEmitterT<R>,

            /**
             * Attach a function that is called every time the function that created this emitter executes a query.
             * @param onSQL 
             */
            sql(onSQL: (sql: string) => void): sequelize$EventEmitterT<R>,
             ...
             */
            proxy(
                emitter: sequelize$EventEmitterT<R>,
                options?: sequelize$ProxyOptions): sequelize$EventEmitterT<R >
        }
    ...
    declare interface sequelize$Options {
        ...
        dialect?: string,
             ...
             */
            define?: sequelize$DefineOptions,
    ...
    declare interface sequelize$AttributeOptions {
    ...
    declare type sequelize$ForeignKeyAttributeOptions = {

        /**
         * The name of the foreign key in the target table. Defaults to the name of source + primary key of source.
         */
        fieldName: string
    } & sequelize$AttributeOptions


    declare interface sequelize$DefineOptions {
        ...
        defaultScope?: sequelize$FindOptions,
            ...
            */
             ...
             * 
             */
            indexes?: Array<sequelize$DefineIndexOptions >
    }

    declare interface sequelize$DefineIndexOptions {
    ...
    declare interface sequelize$QueryOptions {
    ...
    declare interface sequelize$ReplicationOptions {
        read?: Array<sequelize$Server>,
            write?: sequelize$Server
    }

    declare interface sequelize$Server {
        host?: string,
            port?: number,
            database?: string,
            username?: string,
    ...
    declare interface sequelize$DropOptions {
    ...
    declare interface sequelize$SchemaOptions {
    ...
    declare interface sequelize$FindOptions {
    ...
    declare interface sequelize$BuildOptions {
    ...
    declare type sequelize$CopyOptions = {
         ...
         */
        transaction?: sequelize$Transaction
    } & sequelize$BuildOptions


    declare type sequelize$FindOrCreateOptions = {} & sequelize$FindOptions & sequelize$QueryOptions


    declare interface sequelize$BulkCreateOptions {
    ...
    declare interface sequelize$DestroyOptions {
    ...
    declare interface sequelize$DestroyInstanceOptions {
    ...
    declare interface sequelize$InsertOptions {
        limit?: number,
            returning?: string,
            allowNull?: string
    }

    declare interface sequelize$UpdateOptions {
    ...
    declare interface sequelize$SaveOptions {
    ...
    declare interface sequelize$ValidateOptions {
    ...
    declare interface sequelize$IncrementOptions {
    ...
    declare interface sequelize$IndexOptions {
        indicesType?: string,
            indexType?: string,
            indexName?: string,
            parser?: any
    ...
    declare interface sequelize$ProxyOptions {
    ...
    declare interface sequelize$TriggerOptions {
        insert?: Array<string>,
            update?: Array<string>,
            delete?: Array<string>,
    ...
    declare interface sequelize$TriggerParam {
        type: string,
            direction?: string,
            name?: string
    }

    declare interface sequelize$SelectOptions {
        limit?: number,
            offset?: number,
            attributes?: Array<any>,
    ...
    declare interface sequelize$HashToWhereConditionsOption {
        include?: boolean,
            keysEscaped?: boolean
    }

    declare interface sequelize$ModelMangerGetDaoOptions {
        attribute: string
    }

    declare interface sequelize$ModelManagerForEachDaoOptions {
    ...
    declare interface sequelize$MigratorOptions {
    ...
    declare interface sequelize$FindAndCountResult<T>{
    ...
    declare interface sequelize$QueryChainerRunSeriallyOptions {
    ...
    declare interface sequelize$CreateTableQueryOptions {
        comment?: string,
            uniqueKeys?: Array<any>,
            charset?: string
    }

    declare interface sequelize$MigratorExecOptions {
        before?: (migrator: sequelize$Migrator) => void,
            after?: (migrator: sequelize$Migrator) => void,
            success?: (migrator: sequelize$Migrator) => void
    }

    declare interface sequelize$MigrationExecuteOptions {
        method: string
    }

    declare interface sequelize$MigrationCompareOptions {
    ...
    declare interface sequelize$Promise {
        ...
        on(evt: string, fct: () => void): void,
             ...
             * Listen for success events.
             */
            success(onSuccess: () => void): sequelize$Promise,

            /**
             * Alias for success(handler). Listen for success events.
             */
            ok(onSuccess: () => void): sequelize$Promise,

            /**
             * Listen for error events.
             * @param onError Error handler.
             */
            error(onError: (err?: Error) => void): sequelize$Promise,

            /**
             * Alias for error(handler). Listen for error events.
             * @param onError Error handler.
             */
            fail(onError: (err?: Error) => void): sequelize$Promise,

            /**
             * Alias for error(handler). Listen for error events.
             * @param onError Error handler.
             */
            failure(onError: (err?: Error) => void): sequelize$Promise,

            /**
             * Listen for both success and error events..
             */
            done(handler: (err: Error, result?: any) => void): sequelize$Promise,

            /**
             * Alias for done(handler). Listen for both success and error events..
             */
            complete(handler: (err: Error, result?: any) => void): sequelize$Promise,

            /**
             * Attach a function that is called every time the function that created this emitter executes a query.
             * @param onSQL 
             */
            sql(onSQL: (sql: string) => void): sequelize$Promise,
            ...
            proxy(
                promise: sequelize$Promise,
                options?: sequelize$ProxyOptions): sequelize$Promise,
            ...
            */
            then(
                ...
                onRejected?: (result?: any) => void): sequelize$Promise,
            ...
            */
            then(
                onFulfilled?: (result?: any) => sequelize$Promise,
                onRejected?: (result?: any) => sequelize$Promise): sequelize$Promise,
            ...
            */
            then<R>(
                onFulfilled?: (result?: any) => sequelize$PromiseT<R>,
                onRejected?: (result?: any) => sequelize$PromiseT<R>): sequelize$PromiseT<R>,
            ...
            */
            then<R>(
                onFulfilled?: (result?: any) => sequelize$PromiseT<R>,
                onRejected?: (result?: any) => void): sequelize$PromiseT<R>,
            ...
            */
            then<R1, R2>(
                onFulfilled?: (result?: any) => sequelize$PromiseT<R1>,
                onRejected?: (result?: any) => sequelize$PromiseT<R2>): sequelize$Promise,
             ...
             */
            spread(
                onFulfilled?: (...results: Array<any>) => sequelize$Promise,
                onRejected?: (...results: Array<any>) => sequelize$Promise): sequelize$Promise,
             ...
             */
            spread(
                onFulfilled?: (...results: Array<any>) => void,
                onRejected?: (...results: Array<any>) => void): sequelize$Promise,
             ...
             */
            spread<R>(
                onFulfilled?: (...results: Array<any>) => sequelize$PromiseT<R>,
                onRejected?: (...results: Array<any>) => sequelize$PromiseT<R>): sequelize$PromiseT<R>,
            ...
            spread<R>(
                onFulfilled?: (...results: Array<any>) => sequelize$PromiseT<R>,
                onRejected?: (...results: Array<any>) => void): sequelize$PromiseT<R>,
             ...
             */
            spread<R1, R2>(
                onFulfilled?: (...results: Array<any>) => sequelize$PromiseT<R1>,
                onRejected?: (...results: Array<any>) => sequelize$PromiseT<R2>): sequelize$Promise,

            /**
             * Shorthand for then(null, onRejected)
             */
            catch (onRejected: (result?: any) => sequelize$Promise): sequelize$Promise,

            /**
             * Shorthand for then(null, onRejected)
             */
            catch<R>(onRejected: (result?: any) => sequelize$PromiseT<R>): sequelize$PromiseT<R>,

            /**
             * Shorthand for then(null, onRejected)
             */
            catch (onRejected: (result?: any) => void): sequelize$Promise
    }

    declare type sequelize$PromiseT<T>= {
         ...
         * Listen for success events.
         */
        success(onSuccess: (t: T) => void): sequelize$PromiseT<T>,

        /**
         * Alias for success(handler). Listen for success events.
         */
        ok(onSuccess: (t: T) => void): sequelize$PromiseT<T>,

        /**
         * Listen for both success and error events..
         */
        done(handler: (err: Error, result: T) => void): sequelize$PromiseT<T>,

        /**
         * Alias for done(handler). Listen for both success and error events..
         */
        complete(handler: (err: Error, result: T) => void): sequelize$PromiseT<T>,

        /**
         * Attach a function that is called every time the function that created this emitter executes a query.
         * @param onSQL 
         */
        sql(onSQL: (sql: string) => void): sequelize$PromiseT<T>,
         ...
         */
        proxy(
            promise: sequelize$PromiseT<T>,
            options?: sequelize$ProxyOptions): sequelize$PromiseT<T>,
        ...
        */
        then(
            ...
            onRejected?: (result?: T) => void): sequelize$Promise,
        ...
        */
        then(
            onFulfilled?: (result?: T) => sequelize$Promise,
            onRejected?: (result?: T) => sequelize$Promise): sequelize$Promise,
        ...
        */
        then<R>(
            onFulfilled?: (result?: T) => sequelize$PromiseT<R>,
            onRejected?: (result?: T) => sequelize$PromiseT<R>): sequelize$PromiseT<R>,
        ...
        */
        then<R>(
            onFulfilled?: (result?: T) => sequelize$PromiseT<R>,
            onRejected?: (result?: T) => void): sequelize$PromiseT<R>,
        ...
        */
        then<R1,
        R2>(
            onFulfilled?: (result?: T) => sequelize$PromiseT<R1>,
            onRejected?: (result?: T) => sequelize$PromiseT<R2>): sequelize$Promise,

        /**
         * Shorthand for then(null, onRejected)
         */
        catch (onRejected: (result?: T) => sequelize$Promise): sequelize$Promise,

        /**
         * Shorthand for then(null, onRejected)
         */
        catch<R>(onRejected: (result?: T) => sequelize$PromiseT<R>): sequelize$PromiseT<R>,

        /**
         * Shorthand for then(null, onRejected)
         */
        catch (onRejected: (result?: T) => void): sequelize$Promise
    } & sequelize$Promise
    ...
    declare interface sequelize$Utils {
        _: sequelize$Lodash,
            ...
            CustomEventEmitter: sequelize$EventEmitter,
            Promise: sequelize$Promise,
            QueryChainer: sequelize$QueryChainer,
            Lingo: any
    }

    declare type sequelize$Lodash = {
    ...
    declare interface sequelize$MetaPojo {
        from: string,
            to: string
    }

    declare type sequelize$MetaInstance = {} & sequelize$MetaPojo & sequelize$Model


    declare interface sequelize$DataTypeStringBase {
        BINARY: sequelize$DataTypeString
    }

    declare interface sequelize$DataTypeNumberBase {
        UNSIGNED: boolean,
            ZEROFILL: boolean
    }

    declare type sequelize$DataTypeString = {} & sequelize$DataTypeStringBase


    declare type sequelize$DataTypeChar = {} & sequelize$DataTypeStringBase


    declare type sequelize$DataTypeInteger = {} & sequelize$DataTypeNumberBase


    declare type sequelize$DataTypeBigInt = {} & sequelize$DataTypeNumberBase


    declare type sequelize$DataTypeFloat = {} & sequelize$DataTypeNumberBase


    declare interface sequelize$DataTypeBlob {}

    declare interface sequelize$DataTypeDecimal {
        PRECISION: number,
            SCALE: number
    }

    declare interface sequelize$DataTypeVirtual {}

    declare interface sequelize$DataTypeEnum {
        (...values: Array<string>): sequelize$DataTypeEnum
    }

    declare interface sequelize$DataTypeArray {}

    declare interface sequelize$DataTypeHstore {}
