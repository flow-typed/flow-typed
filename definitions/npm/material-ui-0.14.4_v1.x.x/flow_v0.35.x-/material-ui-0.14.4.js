...
declare module 'material-ui-0.14.4' {
...
declare module 'Styles' {
	...
	declare export function ThemeDecorator(muiTheme: Styles.MuiTheme): <TFunction>(Component: TFunction) => TFunction

	declare export function getMuiTheme(baseTheme: RawTheme, muiTheme?: MuiTheme): MuiTheme
...
declare module 'Popover' {
	...
	declare interface PopoverAnimationFromTopProps {
		className?: string,
		targetOrigin?: Origin,
		zDepth?: number
	}

	declare interface PopoverDefaultAnimationProps {
		className?: string,
		targetOrigin?: Origin,
		zDepth?: number
	}
	...
	declare export class PopoverAnimationFromTop extends React$Component<PopoverAnimationFromTopProps, {
		
	}> {
		
	}

	declare export class PopoverDefaultAnimation extends React$Component<PopoverDefaultAnimationProps, {
...
declare module 'Hoc' {
		...
		valueLink?: {
		value: any,
		requestChange: (e: TouchTapEvent, value: any) => void
	}
	}

	declare export function SelectableContainerEnhance<P>(
