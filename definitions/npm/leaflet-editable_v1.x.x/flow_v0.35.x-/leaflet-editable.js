/**
 * Flowtype definitions for leaflet-editable
...
export type L$Editable = {
     ...
     * Options to pass to L.Editable when instanciating.
     */
    options: L$EditOptions,
    currentPolygon: L$Polyline | L$Polygon | L$Marker,
...
export interface L$BaseEditor {
     ...
     */
    enable(): L$MarkerEditor | L$PolylineEditor | L$PolygonEditor,

        /**
         * Remove editing tools.
         */
        disable(): L$MarkerEditor | L$PolylineEditor | L$PolygonEditor
}
