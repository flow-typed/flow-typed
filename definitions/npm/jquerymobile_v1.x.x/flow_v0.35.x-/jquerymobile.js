...
declare module 'jquerymobile' {
		declare interface JQueryMobileEvent {
	...
	declare interface FixedToolbarOptions {
	...
	declare interface FixedToolbarEvents {
		create?: JQueryMobileEvent
	}
	...
	declare interface CollapsibleEvents {
		create?: JQueryMobileEvent,
		collapse?: JQueryMobileEvent,
		expand?: JQueryMobileEvent
	}

	declare interface CollapsibleSetOptions {
		collapsedIcon?: string,
		expandedIcon?: string,
		iconpos?: string,
		initSelector?: string,
	...
	declare interface CollapsibleSetEvents {
		create?: JQueryMobileEvent
	}
	...
	declare interface TextInputEvents {
		create?: JQueryMobileEvent
	}

	declare interface SearchInputOptions {
	...
	declare interface FlipswitchOptions {
		corners?: boolean,
		defaults?: boolean,
		disabled?: boolean,
		enhanced?: boolean,
	...
	declare interface CheckboxRadioOptions {
		mini?: boolean,
		theme?: string
	}

	declare interface CheckboxRadioEvents {
		create?: JQueryMobileEvent
	}
	...
	declare interface ListViewEvents {
		create?: JQueryMobileEvent
	}

	declare interface FilterableOptions {
		children?: any,
		defaults?: boolean,
		disabled?: boolean,
		enhanced?: boolean,
	...
	declare interface ControlgroupOptions {
		corners?: boolean,
	...
	declare interface JQueryMobileOptions {
	...
	declare interface JQueryMobileEvents {
		tap: any,
		taphold: any,
		swipe: any,
		swipeleft: any,
	...
	declare interface ChangePageOptions {
	...
	declare interface LoadPageOptions {
		data?: any,
		loadMsgDelay?: number,
		pageContainer?: JQuery,
		reloadPage?: boolean,
	...
	declare interface JQueryMobilePath {
	...
	declare interface JQueryMobile {
		version: string,
