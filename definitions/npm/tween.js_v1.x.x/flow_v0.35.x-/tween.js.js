...
declare module 'npm$namespace$TWEEN' {
			declare export function getAll(): Tween[]

	declare export function removeAll(): void

	declare export function add(tween: Tween): void

	declare export function remove(tween: Tween): void

	declare export function update(time?: number): boolean
