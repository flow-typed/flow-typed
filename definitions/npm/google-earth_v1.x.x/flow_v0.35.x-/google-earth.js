/**
 * Flowtype definitions for google-earth
...
declare module 'earth' {
    ...
    */
    declare export function fetchKml(
        ...
        url: string,
        completionCallback: (feature: KmlFeature) => void): void
    ...
    */
    ...
    Note: This interface is still under development.
    */
    declare export class KmlTour mixins KmlFeature {}
    ...
    */
     ...
     */
    declare export class KmlStyleMap mixins KmlStyleSelector {
    ...
    */
    declare export class KmlNetworkLink mixins KmlFeature {
    ...
    */
    declare export class KmlScreenOverlay mixins KmlOverlay {
    ...
    Note: This interface is still under development.
    */
    declare export class KmlPhotoOverlay mixins KmlOverlay {}
    ...
    */
    declare export class KmlGroundOverlay mixins KmlOverlay {
    ...
    */
    declare export class KmlOverlay mixins KmlFeature {
     ...
     */
    declare export class KmlViewerOptions mixins KmlObject {
     ...
     */
    declare export class KmlOrientation mixins KmlObject {
    ...
    */
    declare export class KmlLocation mixins KmlObject {
     ...
     */
    declare export class KmlScale mixins KmlObject {
    ...
    */
     ...
     */
    declare export class GEWindow mixins GEEventEmitter {
     ...
     */
    declare export class GEGlobe mixins KmlObject {
    ...
    declare export class GEView {
        ...
        */
        project(
            ...
            lng: number,
            alt: number,
            altitudeMode: KmlAltitudeModeEnum): KmlVec2;
        ...
        */
        hitTest(
            ...
            y: number,
            yUnits: KmlUnitsEnum,
            mode: GEHitTestModeEnum): GEHitTestResult
    }

    /**
     * Defines an image associated with an Icon style or overlay.
     */
    declare export class KmlIcon mixins KmlLink {
     ...
     */
    declare export class KmlLink mixins KmlObject {
     ...
     */
    declare export class GEFeatureContainer mixins GESchemaObjectContainer<KmlFeature>{}

    /**
     * A container object that contains an array of geometries, typically the children of a multi-geometry.
     */
    declare export class GEGeometryContainer mixins GESchemaObjectContainer<KmlGeometry>{}
    ...
    */
    declare export class GELinearRingContainer mixins GESchemaObjectContainer<KmlLinearRing>{}
    ...
    */
    declare export class GEStyleSelectorContainer mixins GESchemaObjectContainer<KmlStyleSelector>{}
    ...
    */
     ...
     */
    declare export class KmlMouseEvent mixins KmlEvent {
    ...
    */
    declare export class KmlObject mixins GEEventEmitter {
     ...
     */
    declare export class KmlStyleSelector mixins KmlObject {}

    /**
     * Defines the icon, label, line, list, polygon, and balloon styles.
     */
    declare export class KmlStyle mixins KmlStyleSelector {
     ...
     */
    declare export class KmlColorStyle mixins KmlObject {
    ...
    */
    declare export class KmlIconStyle mixins KmlColorStyle {
     ...
     * A custom color, color mode, and scale for the label (name) can be specified.
     */
    declare export class KmlLabelStyle mixins KmlColorStyle {
     ...
     * Line geometry includes the outlines of outlined polygons and the extruded "tether" of Placemark icons (if extrusion is enabled).
     */
    declare export class KmlLineStyle mixins KmlColorStyle {
     ...
     */
    declare export class KmlPolyStyle mixins KmlColorStyle {
     ...
     */
    declare export class KmlListStyle mixins KmlObject {
     ...
     */
    declare export class KmlBalloonStyle mixins KmlObject {
     ...
     */
    declare export class KmlLatLonBox mixins KmlObject {
     ...
     */
    declare export class KmlLatLonAltBox mixins KmlLatLonBox {
        ...
        setAltBox(
            ...
            minAltitude: number,
            maxAltitude: number,
            altitudeMode: KmlAltitudeModeEnum): void;
     ...
     */
    declare export class KmlLod mixins KmlObject {
    ...
    */
    declare export class KmlRegion mixins KmlObject {
     ...
     */
    declare export class KmlTimePrimitive mixins KmlObject {}
    ...
    */
    declare export class KmlTimeStamp mixins KmlTimePrimitive {
     ...
     */
    declare export class KmlTimeSpan mixins KmlTimePrimitive {
     ...
     */
    declare export class KmlAbstractView mixins KmlObject {
    ...
    */
    declare export class KmlLookAt mixins KmlAbstractView {
    ...
    */
    declare export class KmlCamera mixins KmlAbstractView {
     ...
     */
    declare export class KmlGeometry mixins KmlObject {}

    /**
     * Specifies an AltitudeMode for derived classes.
     */
    declare export class KmlAltitudeGeometry mixins KmlGeometry {
    ...
    */
    declare export class KmlModel mixins KmlAltitudeGeometry {
     ...
     */
    declare export class KmlMultiGeometry mixins KmlGeometry {
     ...
     */
    declare export class KmlExtrudableGeometry mixins KmlAltitudeGeometry {
    ...
    */
    declare export class KmlPolygon mixins KmlExtrudableGeometry {
    ...
    */
    declare export class KmlPoint mixins KmlExtrudableGeometry {
    ...
    */
    declare export class KmlLineString mixins KmlExtrudableGeometry {
    ...
    */
    declare export class KmlLinearRing mixins KmlLineString {}
     ...
     */
    declare export class KmlFeature mixins KmlObject {
     ...
     */
    declare export class KmlContainer mixins KmlFeature {
    ...
    */
    declare export class KmlDocument mixins KmlContainer {
     ...
     */
    declare export class KmlPlacemark mixins KmlFeature {
     ...
     */
    declare export class GEFeatureBalloon mixins GEAbstractBalloon {}

    /**
     * Creates a balloon that contains HTML.
     */
    declare export class GEHtmlBalloon mixins GEAbstractBalloon {
     ...
     */
    declare export class GEHtmlDivBalloon mixins GEHtmlBalloon {
     ...
     */
    declare export class GEHtmlStringBalloon mixins GEHtmlBalloon {
     ...
     */
    declare export class GETimeControl mixins GEControl {
