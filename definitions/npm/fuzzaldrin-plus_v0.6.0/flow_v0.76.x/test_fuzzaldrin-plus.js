...
import type { FuzzaldrinPlusOptions, Query } from "fuzzaldrin-plus";
...
describe("fuzzaldrin-plus@0.6.0", () => {
  it("generic correct usage", () => {
    ...
    const options: FuzzaldrinPlusOptions = { allowErrors: true };
  });
  ...
  it("generic wrong usage", () => {
    ...
    // $ExpectError
    const options: FuzzaldrinPlusOptions = { allowErrors: 'not a boolean' };
  });
  ...
  it("filter wrong usage", () => {
    ...
    // $ExpectError
    fuzzaldrinPlus.filter(["Maybe", "Me"], "me", { allowErrors: 'not a boolean' });
    // $ExpectError
