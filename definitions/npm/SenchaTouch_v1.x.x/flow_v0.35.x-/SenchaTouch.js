...
declare module 'npm$namespace$Ext' {
	...
	declare export interface IProgressIndicator {
		baseCls?: string,
		centered?: boolean,
		fallbackText?: any,
		hidden?: boolean,
	...
	declare export function factory(
		config?: any, classReference?: string, instance?: any, aliasNamespace?: string
	): void
	...
	declare export function isMSDate(value?: string): boolean
	...
	declare export class ModelMgr  {
		...
		onAvailable(id?: string, fn?: any, scope?: any): void;
		register(item?: any): void;
		registerType(name?: string, config?: any): any;
		statics(): Ext.IClass;
		unregister(item?: any): void
	}
	...
	declare export class Date  {
		...
		now(): number;
		parse(input?: any, format?: string, strict?: boolean): any
	}
...
declare module 'interactions' {
	...
	declare export interface ICrosshair {
		axes?: any,
		gesture?: string,
		lines?: any,
		getAxes(): any,
...
declare module 'util' {
	...
	declare export interface IBufferedCollection {
		getAutoFilter(): boolean,
		getAutoSort(): boolean,
		getPageSize(): number,
		getTotalCount(): number,
	...
	declare export class InputBlocker  {
		self: Ext.IClass;
		callOverridden(args?: any): any;
		callParent(args?: any): any;
		callSuper(args?: any): any;
...
declare module 'plugin' {
		declare export interface IBuffered {
	...
	declare export interface IBufferedList {
		getList(): any,
	...
	declare export interface ISortableList {
...
declare module 'accelerometer' {
	...
	declare export interface ICordova {
...
declare module 'device' {
	...
	declare export interface ICapture {
	...
	declare export interface IFileSystem {
	...
	declare export interface IGlobalization {
	...
	declare export interface IAnalytics {
		
	}

	declare export interface ITwitter {
	...
	declare export class FileSystem  {
		self: Ext.IClass;
		callOverridden(args?: any): any;
		callParent(args?: any): any;
		callSuper(args?: any): any;
	...
	declare export class Globalization  {
		self: Ext.IClass;
		callOverridden(args?: any): any;
		callParent(args?: any): any;
		callSuper(args?: any): any;
...
declare module 'filesystem' {
	...
	declare export interface IChrome {
		requestFileSystem(config?: any): void
	}
	...
	declare export interface IDirectoryEntry {
	...
	declare export interface IFileEntry {
		getEntry(config?: any): void,
		getOffset(): number,
...
declare module 'html5' {
	...
	declare export interface ISQLStatement {
...
declare module 'draw' {
	...
	declare export interface IPath {
		arc(
		x?: number, y?: number, radius?: number, startAngle?: number, endAngle?: number, anticlockwise?: number
	): void,
		arcSvg(
		rx?: number, ry?: number, rotation?: number, fA?: number, fS?: number, x2?: number, y2?: number
	): void,
		arcTo(
		...
		closePath(): void,
		ellipse(
		cx?: number, cy?: number, radiusX?: number, radiusY?: number, rotation?: number, startAngle?: number, endAngle?: number, anticlockwise?: number
	): void,
	...
	declare export interface ISegmentTree {
		...
		getStrategy(): string,
		setData(
		dataX?: number, dataOpen?: number, dataHigh?: number, dataLow?: number, dataClose?: number
	): void,
	...
	declare export class Draw  {
		...
		getInitialConfig(name?: string): any;
		initConfig(instanceConfig?: any): any;
		isBBoxIntersect(bbox1?: any, bbox2?: any, padding?: number): boolean;
		rad(degrees?: number): number;
		reflectFn(a?: any): any;
		smooth(dataX?: any, dataY?: any, value?: any): any;
	...
	declare export class Matrix  {
		...
		x0?: number, y0?: number, x1?: number, y1?: number, x0p?: number, y0p?: number, x1p?: number, y1p?: number
	): void;
		createAlias(alias?: any, origin?: any): void;
	...
	declare export class Solver  {
		...
		callParent(args?: any): any;
		callSuper(args?: any): any;
		cubicFunction(a?: number, b?: number, c?: number, d?: number): void;
		cubicRoot(number?: number): void;
		destroy(): void;
		getInitialConfig(name?: string): any;
		initConfig(instanceConfig?: any): any;
		linearFunction(a?: number, b?: number): void;
		quadraticFunction(a?: number, b?: number, c?: number): void;
		statics(): Ext.IClass
	}
...
declare module 'engine' {
	...
	declare export interface ISvgContext {
		...
		arcSvg(
		r1?: number, r2?: number, rotation?: number, large?: number, swipe?: number, x2?: number, y2?: number
	): void,
		arcTo(
		x1?: number, y1?: number, x2?: number, y2?: number, radiusX?: number, radiusY?: number, rotation?: number
	): void,
		beginPath(): void,
		bezierCurveTo(
		...
		drawImage(
		image?: HTMLElement, sx?: number, sy?: number, sw?: number, sh?: number, dx?: number, dy?: number, dw?: number, dh?: number
	): void,
		ellipse(
		x?: number, y?: number, radiusX?: number, radiusY?: number, rotation?: number, startAngle?: number, endAngle?: number, anticlockwise?: number
	): void,
		fill(): void,
		...
		save(): void,
		setTransform(
		xx?: number, yx?: number, xy?: number, yy?: number, dx?: number, dy?: number
	): void,
		stroke(): void,
...
declare module 'recognizer' {
	...
	declare export interface IEdgeSwipe {
		getMinDistance(): number,
		setMinDistance(minDistance?: number): void
	}
...
declare module 'field' {
	...
	declare export interface IFileInput {
		me?: any,
		name?: string,
		newValue?: any,
		type?: string,
...
declare module 'mixin' {
	...
	declare export interface IProgressable {
		dynamic?: boolean,
...
declare module 'ux' {
		declare export interface IActionOverFlowMenuButton {
		menuItems?: any
	}

	declare export interface IApplicationMenu {
		defaults?: any,
		getDefaults(): any,
		setDefaults(defaults?: any): void
	}

	declare export interface IContextMenu {
		
	}

	declare export interface IMenuButton {
		getMenuItems(): any[],
		setMenuItems(menuItems?: any[]): void
	}

	declare export interface ITabMenuButton {
		menuItems?: any
	}
