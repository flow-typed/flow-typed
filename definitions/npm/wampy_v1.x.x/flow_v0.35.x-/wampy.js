...
declare module 'wampy' {
	...
	declare interface SubscribeCallbacksHash {
		onEvent: (data: any) => void
	}

	declare interface RegisterCallbacksHash {
	...
	declare interface PublishAdvancedOptions {
	...
	declare interface Wampy {
		...
		abort(): Wampy,
		subscribe(
		topicURI: string, callbacks: (((data: any) => void) | SubscribeCallbacksHash)
	): Wampy,
		unsubscribe(
		topicURI: string, callbacks?: (((data: any) => void) | SubscribeCallbacksHash)
	): Wampy,
		publish(
		topicURI: string, payload?: any, callbacks?: SuccessErrorCallbacksHash, advancedOptions?: PublishAdvancedOptions
	): Wampy,
		call(
		topicURI: string, payload?: any, callbacks?: (((data: any) => void) | CallSuccessErrorCallbacksHash), advancedOptions?: CallAdvancedOptions
	): Wampy,
		cancel(
		reqId: number, callbacks?: ((() => void) | SuccessErrorCallbacksHash), advancedOptions?: CancelAdvancedOptions
	): Wampy,
		register(
		topicURI: string, callbacks: (((data: any, options: any) => any[]) | RegisterCallbacksHash)
	): Wampy,
		unregister(
		topicURI: string, callbacks?: ((() => void) | SuccessErrorCallbacksHash)
	): Wampy
	}
	...
	declare interface WampyInstance {
		new (url?: string, options?: WampyOptions): Wampy
			...
			declare module.exports: WampyInstance
