// @flow
/**
 * Flowtype definitions for qwest
...
declare interface Qwest$Static {
    ...
    base: string,
         ...
         */
        before(callback: () => any): Qwest$Static,
         ...
         */
        get(url: string, data?: any, options?: Qwest$Options): Qwest$Promise,
         ...
         * @param options Configuration options for the AJAX request
         */
        post(url: string, data?: any, options?: Qwest$Options): Qwest$Promise,
         ...
         * @param options Configuration options for the AJAX request
         */
        put(url: string, data?: any, options?: Qwest$Options): Qwest$Promise,
         ...
         * @param options Configuration options for the AJAX request
         */
        delete(url: string, data?: any, options?: Qwest$Options): Qwest$Promise
}

declare interface Qwest$Promise {

    /**
     * Request is successful 
     */
    then(callback: (xhr: any, response?: any) => any): Qwest$Promise,

        /**
         * Request has failed 
         */
        catch (callback: (e: any, xhr?: any, response?: any) => any): Qwest$Promise,

        /**
         * Always run 
         */
        complete(callback: () => any): Qwest$Promise
}

declare interface Qwest$Options {
