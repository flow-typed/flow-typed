// @flow
/**
 * Flowtype definitions for dygraphs
...
declare type dygraphs$DataArray = number[][];

declare type dygraphs$Data = string | dygraphs$DataArray | undefined.DataTable;

declare interface dygraphs$PerSeriesOptions {
...
declare interface dygraphs$PerAxisOptions {
...
declare type dygraphs$Options = {
    ...
    */
    axes?: {
        x?: dygraphs$PerAxisOptions,
        y?: dygraphs$PerAxisOptions,
        y2?: dygraphs$PerAxisOptions
    },

    /**
     * A function to call when the canvas is clicked.
     */
    clickCallback?: (e: MouseEvent, xval: number, points: dygraphs$Point[]) => any,
    ...
    */
    highlightSeriesOpts?: dygraphs$PerSeriesOptions,
    ...
    */
     ...
     */
    pointClickCallback?: (e: MouseEvent, point: dygraphs$Point) => any,
    ...
    */
    series?: {
        [seriesName: string]: dygraphs$PerSeriesOptions
    },
...
} & dygraphs$PerSeriesOptions & dygraphs$PerAxisOptions


declare interface dygraphs$SeriesProperties {
    name: string,
        column: number,
        visible: boolean,
        color: string,
...
declare interface dygraphs$Area {
    x: number,
        y: number,
        w: number,
        h: number
...
*/
declare interface dygraphs$Point {
    idx: number,
        name: string,
        x?: number,
        xval?: number,
...
declare interface dygraphs$Annotation {
...
declare type dygraphs$Axis = "x" | "y" | "y2";
declare class Dygraph {
    ...
    */
     ...
     * @param  The name of the option (e.g. 'strokeWidth')
     * @param  Series name to get per-series values.
    ...
    */
    ...
    If y is null, this returns null.
    if axis is null, this uses the first axis.
     * @param  The data y-coordinate.
     * @param  The axis number on which the data coordinate lives.
    ...
    */
    ...
    missing.
     * @param  The row number of the data (0-based). Row 0 is the
    first row of data, not a header row.
     * @param  The column number of the data (0-based)
    ...
    */
    ...
    using getSelection().
     * @param  Row number that should be highlighted (i.e. appear with
    hover dots on the chart).
     * @param  series name to highlight that series with the
    the highlightSeriesOpts setting.
     * @param  If true, keep seriesName selected when mousing
    ...
    */
     ...
     * @param  The new properties and values
     * @param  Usually the chart is redrawn after every
    ...
    */
     ...
     * @param  Number of points over which to average the data.
     */
     ...
     * @param  the series index
     * @param  true or false, identifying the visibility.
     */
...
declare module 'dygraphs' {
    declare module.exports: typeof Dygraph
}