...
declare module 'joi' {
    ...
    declare export type Schema = {} & AnySchema

    declare export type Reference = {} & Schema
    ...
    declare export type BooleanSchema = {} & AnySchema
    ...
    declare export type ArraySchema = {
    ...
    declare export type ObjectSchema = {
    ...
    declare export type BinarySchema = {
    ...
    declare export type FunctionSchema = {
    ...
    declare export type AlternativesSchema = {
