...
declare module 'joi' {
	...
	declare export interface Terms {
		value: any,
		state: {
		key: string,
		path: string,
	...
	declare export function alternatives(): AlternativesSchema

	declare export function alternatives(types: Schema[]): AlternativesSchema

	declare export function alternatives(type1: Schema, type2: Schema, ...types: Schema[]): AlternativesSchema

	declare export function lazy(cb: () => Schema): Schema

	declare export function validate<T>(value: T): ValidationResult<T>

	declare export function validate<T, R>(value: T, callback: (err: ValidationError, value: T) => R): R

	declare export function validate<T>(value: T, schema: Schema): ValidationResult<T>

	declare export function validate<T>(value: T, schema: Object): ValidationResult<T>

	declare export function validate<T, R>(
		value: T, schema: Schema, callback: (err: ValidationError, value: T) => R
	): R

	declare export function validate<T, R>(
		value: T, schema: Object, callback: (err: ValidationError, value: T) => R
	): R

	declare export function validate<T>(value: T, schema: Schema, options: ValidationOptions): ValidationResult<T>

	declare export function validate<T>(value: T, schema: Object, options: ValidationOptions): ValidationResult<T>

	declare export function validate<T, R>(
		value: T, schema: Schema, options: ValidationOptions, callback: (err: ValidationError, value: T) => R
	): R

	declare export function validate<T, R>(
		value: T, schema: Object, options: ValidationOptions, callback: (err: ValidationError, value: T) => R
	): R
	...
	declare export function attempt<T>(value: T, schema: Schema, message?: string | Error): T

	declare export function ref(key: string, options?: ReferenceOptions): Reference

	declare export function isRef(ref: any): boolean

	declare export function reach(schema: Schema, path: string): Schema

	declare export function extend(extention: Extension): any

	declare export function allow(value: any, ...values: any[]): Schema

	declare export function allow(values: any[]): Schema

	declare export function valid(value: any, ...values: any[]): Schema

	declare export function valid(values: any[]): Schema

	declare export function only(value: any, ...values: any[]): Schema

	declare export function only(values: any[]): Schema

	declare export function equal(value: any, ...values: any[]): Schema

	declare export function equal(values: any[]): Schema

	declare export function invalid(value: any, ...values: any[]): Schema

	declare export function invalid(values: any[]): Schema

	declare export function disallow(value: any, ...values: any[]): Schema

	declare export function disallow(values: any[]): Schema

	declare export function not(value: any, ...values: any[]): Schema

	declare export function not(values: any[]): Schema

	declare export function required(): Schema

	declare export function optional(): Schema

	declare export function forbidden(): Schema

	declare export function strip(): Schema

	declare export function description(desc: string): Schema

	declare export function notes(notes: string): Schema

	declare export function notes(notes: string[]): Schema

	declare export function tags(notes: string): Schema

	declare export function tags(notes: string[]): Schema

	declare export function meta(meta: Object): Schema

	declare export function example(value: any): Schema

	declare export function unit(name: string): Schema

	declare export function options(options: ValidationOptions): Schema

	declare export function strict(isStrict?: boolean): Schema

	declare export function concat<T>(schema: T): T

	declare export function when<U>(ref: string, options: WhenOptions<U>): AlternativesSchema

	declare export function when<U>(ref: Reference, options: WhenOptions<U>): AlternativesSchema

	declare export function label(name: string): Schema

	declare export function raw(isRaw?: boolean): Schema

	declare export function empty(schema?: any): Schema
