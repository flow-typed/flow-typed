declare module "awilix" {
  declare module .exports: {
    createContainer(?awilix$ContainerOptions): awilix$Container<{ [string]: * }>,
...
declare class awilix$Container<R> {
  ...
  register<Name: string, T>(name: Name,
    registration: awilix$Registration<T>): awilix$MergedRegistrations<R, { [Name]: T }>;
  register<RegistrationMap>(registrations: RegistrationMap,
    opts?: awilix$ContainerRegOptions<RegistrationMap>): awilix$Container<R | $ObjMap<RegistrationMap, <T>(awilix$Registration<T>) => T>>;

  registerClass<T>(className: Class<T>): awilix$Container<R & { [awilix$ClassName<T>]: T }>;
  registerClass<T, Name: string>(name: Name,
    clazz: Class<T>,
    opts?: awilix$ContainerRegOptions<T>): awilix$Container<{ [Name]: T } & R>;
  registerClass<T, Name: string>(name: Name,
    ctorAndOptionsPair: [Class<T>, awilix$ContainerRegOptions<T>]): awilix$Container<{ [Name]: T } & R>;
  registerClass<T>(ctorAndOptionsPair: [Class<T>, awilix$ContainerRegOptions<T>]): awilix$Container<awilix$ClassIdx<T> & R>;

  registerFunction<F: () => *>(fn: F,
    opts?: awilix$ContainerRegOptions<awilix$Return<F>>): awilix$Container<awilix$FnIdx<F> & R>;
  registerFunction<F: () => *>(fn: F,
    opts?: awilix$ContainerRegOptions<awilix$Return<F>>): awilix$Container<awilix$FnIdx<F> & R>;
  registerFunction<Name: string, F: () => *>(name: Name,
    fn: F,
    opts?: awilix$ContainerRegOptions<awilix$Return<F>>): awilix$Container<{ [Name]: awilix$Return<F> } & R>;
  registerFunction<Name: string, F: () => *>(name: string,
    funcAndOptionsPair: [Function, awilix$ContainerRegOptions<awilix$Return<F>>]): awilix$Container<{ [Name]: awilix$Return<F> } & R>;
  registerFunction<F: () => *, RegistrationMap: awilix$RegistrationMap<F>>(registrations: RegistrationMap): awilix$MergedRegistrations<R,
    $ObjMap<RegistrationMap, awilix$derefReturn>>;

  registerValue<Name: string, T>(name: Name,
    value: T): awilix$Container<{ [Name]: T } & R>;
  ...
  loadModules(globPatterns: string[] | Array<awilix$LoadModulesTuple<*>>,
    options?: awilix$LoadModulesOptions<*>): awilix$Container<R>;

  build<T: Function>(target: T | awilix$Registration<T>): awilix$Return<T>;
  build<T>(target: Class<T> | awilix$Registration<T>): T;
}

declare type awilix$listModules = (globPatterns: string | string[] | awilix$LoadModulesTuple<*>[],
  options?: awilix$LoadModulesOptions<*>) => awilix$ModuleDescriptor[];
...
declare type awilix$NameFormatter = (name: string,
  descriptor: awilix$ModuleDescriptor) => string;
...
declare interface awilix$asFunction extends awilix$AsProviderFunction {
  <F: () => *>(fn: F,
    options?: awilix$ContainerRegOptions<awilix$Return<F>>): awilix$FluidRegistration<awilix$Return<F>>;
}
...
declare interface awilix$asClass extends awilix$AsProviderFunction {
  <T>(type: Class<T>,
    options?: awilix$ContainerRegOptions<T>): awilix$FluidRegistration<T>;
}
