...
declare module 'logg' {
    ...
    declare     export var Level: loggingLevels;
    declare     export var rootLogger: Logger;
    declare     export var registerWatcher: (watcher: (logRecord: string) => void) => void;
}