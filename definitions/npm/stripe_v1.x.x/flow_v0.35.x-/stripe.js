/**
 * Flowtype definitions for stripe
...
declare interface StripeStatic {
    setPublishableKey(key: string): void,
        ...
        getToken(
            token: string,
            responseHandler: (status: number, response: StripeTokenResponse) => void): void,
        card: StripeCardData,
        createToken(
...
declare interface StripeBankAccount {
    createToken(
            ...
            stripeResponseHandler: (status: number, response: StripeBankTokenResponse) => void): void,
