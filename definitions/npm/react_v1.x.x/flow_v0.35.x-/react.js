...
function ___React$createClass<P, S>(spec: ___React$ComponentSpec<P, S>): ___React$ClassicComponentClass<P >
    ...
    declare
function ___React$createFactory<P, T>(type: string): ___React$DOMFactory<P, T >

    declare
function ___React$createElement<P, T>(
        type: string,
        props?: P & ___React$ClassAttributes<T>,
        ...children: ___React$ReactNode[]): ___React$DOMElement<P, T >

    declare
function ___React$cloneElement<P, T>(
        element: ___React$DOMElement<P, T>,
        props?: P & ___React$ClassAttributes<T>,
        ...children: ___React$ReactNode[]): ___React$DOMElement<P, T >

    declare
function ___React$isValidElement<P>(object: {}): ReactElement
