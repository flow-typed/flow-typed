// @flow
/**
 * Flowtype definitions for tedious
...
declare module 'tedious' {
    ...
    declare     export var TDS_VERSION: {
        [index: string]: number
    };
    ...
    declare     export type BulkLoadColumnOpts = {
        nullable: boolean,
        objName?: string
    } & ParameterOptions
    ...
    declare     export class Connection mixins events.EventEmitter {
        ...
        beginTransaction(
            ...
            name?: string,
            isolationLevel?: ISOLATION_LEVEL): void;
        ...
        */
        transaction(
            callback: (error: Error, done: (error?: Error) => void) => void,
            name?: string,
            isolationLevel?: ISOLATION_LEVEL): void;
        ...
        */
        ...
        newBulkLoad(
            tableName: string,
            callback: (error: Error, rowCount: number) => void): BulkLoad;
