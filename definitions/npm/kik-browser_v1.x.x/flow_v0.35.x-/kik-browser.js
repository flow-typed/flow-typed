...
declare module 'kik-browser' {
		...
		sign(
		data: string, callback: (signedData: string, username: string, host: string) => void
	): void,
		anonymousSign(
		data: string, callback: (signedData: string, anonToken: string, host: string) => void
	): void,
