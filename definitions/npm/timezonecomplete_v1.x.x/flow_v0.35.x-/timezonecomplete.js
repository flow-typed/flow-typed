// @flow
/**
 * Flowtype definitions for timezonecomplete
...
declare module '___timezonecomplete/datetime' {
    ...
    declare     export class DateTime {
        ...
        */
        ...
        /**
         * Same as add(-1duration);
         */
        sub(duration: Duration): DateTime;

        /**
         * Same as add(-1amount, unit);
         */
        sub(amount: number, unit: TimeUnit): DateTime;

        /**
         * Same as addLocal(-1amount, unit);
         */
...
declare module '___timezonecomplete/javascript' {
...
declare module '___timezonecomplete/timesource' {
    ...
    */
     ...
     */
    declare     export class RealTimeSource mixins TimeSource {
        now(): Date
    }
}
