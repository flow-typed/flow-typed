/**
 * Flowtype definitions for hapi-8.2.0
...
declare module 'hapi' {
     ...
     */
    declare export type ISeverConnectionOptions = {
    ...
    declare export interface IServerOptions {
        ...
        app?: any,
             ...
             * aprototype function (usually obtained by calling require() on a catbox strategy such as require('catbox-redis')).
            aconfiguration object with the following options:
            ...
            anarray of the above object for configuring multiple cache instances, each with a unique name. When an array of objects is provided, multiple cache connections are established and each array item (except one) must include a name.  
            */
    ...
    declare export interface IServerViewCompile {
        ...
        (template: string, options: any, callback: (
            ...
            compiled: (
                context: any,
                options: any,
                callback: (err: any, rendered: boolean) => void) => void) => void): void
    }
    ...
    declare export type IServerViewsEnginesOptions = {
            ...
            compile(
                ...
                callback: (
                    ...
                    compiled: (
                        context: any,
                        options: any,
                        callback: (err: any, rendered: any) => void) => void) => void): void
        }
    ...
    */
    declare export type IServerViewsConfiguration = {
    ...
    declare interface IReplyMethods {
        ...
        file(
             ...
             * theresponse flow control rules apply. 
             */
            view(template: string, context?: {}, options?: any): Response,
             ...
             * Theresponse flow control rules do not apply. 
             */
            close(
                options?: {
             ...
             * heresponse flow control rules apply. 
             */
    ...
    */
    ...
    When calling reply(), the framework waits until process.nextTick() to continue processing the request and transmit the response. This enables making changes to the returned response object before the response is sent. This means the framework will resume as soon as the handler method exits. To suspend this behavior, the returned response object supports the following methods: hold(), send() 
    */
    declare export type IStrictReply<T>= {
    ...
    declare export interface IProxyHandlerConfig {
        ...
        host?: string,
            ...
            */
            mapUri?: (
                request: Request,
                callback: (err: any, uri: string, headers?: {
                    [key: string]: string
                }) => void) => void,
    ...
    declare export interface IRouteAdditionalConfigurationOptions {
        ...
        app?: any,
             ...
             * astring with the name of an authentication strategy registered with server.auth.strategy().
            anobject  
            */
            auth?: boolean | string | {
            ...
            response?: {
                ...
                aJoi validation object.
                avalidation function using the signature function(value, options, next) where:
            ...
            validate?: {
                ...
                */
                ...
                'ignore'take no action.
                ORa custom error handler function with the signature 'function(request, reply, source, error)` where:
     ...
     * Therealm object contains server-wide or plugin-specific state that can be shared across various methods. For example, when calling server.bind(),
    theactive realm settings.bind property is set which is then used by routes and extensions added at the same level (server root or plugin).
    ...
    Theserver.realm object should be considered read-only and must not be changed directly except for the plugins property can be directly manipulated by the plugins (each setting its own under plugins[name]).
    ...
    */
    ...
    Theframework comes with a few built-in handler types available by setting the route handler config to an object containing one of these keys.
    */
    ...
    declare export interface IServerAuthScheme {
        ...
        .Ifthe err returned by the reply() method includes a message, no additional strategies will be attempted.
        Ifthe err does not include a message but does include a scheme name (e.g. Boom.unauthorized(null, 'Custom')), additional strategies will be attempted in order of preference.
        varserver = new Hapi.Server();
        server.connection({ port: 80 });
        varscheme = function (server, options) {
        return {
        authenticate: function (request, reply) {
        varreq = request.raw.req;
        varauthorization = req.headers.authorization;
        if(!authorization) {
     ...
     * Thereturn value is an array where each item is an object containing:
    ...
    */
    ...
    arg1, arg2, etc. - the method function arguments.
    thecallback option is set to false.
    themethod must returns a value (result, Error, or a promise) or throw an Error.
    */
    ...
    */
     ...
     * Request object
     * 
    Therequest object is created internally for each incoming request. It is different from the node.js request object received from the HTTP server callback (which is available in request.raw.req). The request object methods and properties change throughout the request lifecycle.
    Request events

    Therequest object supports the following events:
    ...
    varhash = Crypto.createHash('sha1');
    ...
    */
    declare export class Request mixins Events.EventEmitter {
        ...
        */
        ...
        Anylogs generated by the server internally will be emitted only on the 'request-internal' channel and will include the event.internal flag set to true.
        ...
        varhandler = function (request, reply) {
        ...
        */
        ...
        varget = function (request, reply) {

        vardbTail = request.tail('write to database');
     ...
     * Response events
     * 
    Theresponse object supports the following events:
    ...
    */
    declare export class Response mixins Events.EventEmitter {
    ...
    Server events
    Theserver object inherits from Events.EventEmitter and emits the following events:
    ...
    declare export class Server mixins Events.EventEmitter {
        ...
        */
        info: {
             ...
             * theconfigured port value before the server has been started.
            theactual port assigned when no port is configured or set to 0 after the server has been started.
            */
            port: number,
        ...
        varHapi = require('hapi');
        varserver = new Hapi.Server({ load: { sampleInterval: 1000 } });
        ...
        */
        ...
        varserver = new Hapi.Server();
        server.connection({ port: 80 });
        vario = SocketIO.listen(server.listener);
        ...
        */
        ...
        /**
         * server.methods
         * Anobject providing access to the server methods where each server method name is an object property.
        varHapi = require('hapi');
        varserver = new Hapi.Server();
        ...
        */
        ...
        varserver = new Hapi.Server(options);
        ...
        */
        ...
        /**
         * server.plugins
         * Anobject containing the values exposed by each plugin registered where each key is a plugin name and the values are the exposed properties by each plugin using server.expose(). Plugins may set the value of the server.plugins[name] object directly or via the server.expose() method.
        exports.register = function (server, options, next) {
        ...
        */
        ...
        /**
         * server.root
         * Theroot server object containing all the connections and the root server methods (e.g. start(), stop(), connection()).
         */
        root: Server;

        /**
         * server.settings
         * Theserver configuration object after defaults applied.
        varHapi = require('hapi');
        varserver = new Hapi.Server({
        app: {
        key: 'value'
        ...
        auth: {
            ...
            */
            test(
                strategy: string,
                request: Request,
                next: (err: any, credentials: any) => void): void
        };
        ...
        */
        ...
        varserver = new Hapi.Server();
        server.connection({ port: 80 });
        varcache = server.cache({ segment: 'countries', expiresIn: 60  60 * 1000 });
        ...
        */
        ...
        varHapi = require('hapi');
        varserver = new Hapi.Server();
        varweb = server.connection({ port: 8000, host: 'example.com', labels: ['web'] });
        varadmin = server.connection({ port: 8001, host: 'example.com', labels: ['admin'] });
        //server.connections.length === 2
        ...
        */
        dependency(
            ...
            after?: (server: Server, next: (err: any) => void) => void): void;
        ...
        */
        handler<THandlerConfig>(
            name: string,
            method: (route: IRoute, options: THandlerConfig) => ISessionHandler): void;
        ...
        */
        ...
        //Object argument
        varaddArray = function (array, next) {
        varsum = 0;
        ...
        */
        ...
        aplugin registration function.
        anobject with the following:
        ...
        */
        render(
            ...
            context: any,
            options: any,
            callback: (err: any, rendered: any, config: any) => void): void;
        ...
        */
        ...
        vara = server.select('a');          // The server with port 80
        varab = server.select(['a','b']);   // A list of servers containing the server with port 80 and the server with port 8080
        varc = server.select('c');          // A list of servers containing the server with port 8081 and the server with port 8082 
        */
        ...
        */
        ...
        varhandler = function (request, reply) {
        varsession = request.state.session;
        if(!session) {
        session = { user: 'joe' };
        }
        ...
        */
        ...
        server.connection({ port: 80, host: 'example.com' });
        server.route({ method: 'GET', path: '/example', handler: function (request, reply) { return reply(); } });
        vartable = server.connections[0].table();
        //[
        //  {
        //      method: 'get',
        //      path: '/example',
