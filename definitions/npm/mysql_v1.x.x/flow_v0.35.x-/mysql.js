/**
 * Flowtype definitions for mysql
...
declare module 'mysql' {
    ...
    declare interface IConnectionStatic {
        createQuery(sql: string): IQuery,
            ...
            createQuery(
                sql: string,
                values: Array<any>,
                callback: (err: IError, ...args: any[]) => void): IQuery
    }
    ...
    declare interface IPoolCluster {
        config: IPoolClusterConfig,
            ...
            getConnection(
                group: string,
                selector: string,
                callback: (err: IError, connection: IConnection) => void): void, of (pattern: string): IPool, of (pattern: string, selector: string): IPool,
    ...
    declare type IConnectionConfig = {
