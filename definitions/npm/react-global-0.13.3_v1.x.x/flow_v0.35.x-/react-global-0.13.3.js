...
declare
export function ReactPerf$start(): void

declare
export function ReactPerf$stop(): void

declare
export function ReactPerf$printInclusive(measurements: ___React$Measurements[]): void

declare
export function ReactPerf$printExclusive(measurements: ___React$Measurements[]): void

declare
export function ReactPerf$printWasted(measurements: ___React$Measurements[]): void

declare
export function ReactPerf$printDOM(measurements: ___React$Measurements[]): void

declare
export function ReactPerf$getLastMeasurements(): ___React$Measurements[]
...
declare
var npm$namespace$ReactTestUtils: {
...
declare
export function ReactTestUtils$renderIntoDocument<P>(element: ReactElement<P>): Component<P, any >

    declare
export function ReactTestUtils$mockComponent(
    mocked: ___React$MockedComponentClass,
    mockTagName?: string): typeof ReactTestUtils

declare
export function ReactTestUtils$isElementOfType(element: ReactElement<any>, type: ReactType): boolean

declare
export function ReactTestUtils$isTextComponent(instance: Component<any, any>): boolean

declare
export function ReactTestUtils$isDOMComponent(instance: Component<any, any>): boolean

declare
export function ReactTestUtils$isCompositeComponent(instance: Component<any, any>): boolean

declare
export function ReactTestUtils$isCompositeComponentWithType(instance: Component<any, any>, type: ComponentClass<any>): boolean

declare
export function ReactTestUtils$findAllInRenderedTree(
    tree: Component<any, any>,
    fn: (i: Component<any, any>) => boolean): Component<any, any >

    declare
export function ReactTestUtils$scryRenderedDOMComponentsWithClass(tree: Component<any, any>, className: string): DOMComponent<any>[]

declare
export function ReactTestUtils$findRenderedDOMComponentWithClass(tree: Component<any, any>, className: string): DOMComponent<any >

    declare
export function ReactTestUtils$scryRenderedDOMComponentsWithTag(tree: Component<any, any>, tagName: string): DOMComponent<any>[]

declare
export function ReactTestUtils$findRenderedDOMComponentWithTag(tree: Component<any, any>, tagName: string): DOMComponent<any >

    declare
export function ReactTestUtils$scryRenderedComponentsWithType<P>(tree: Component<any, any>, type: ComponentClass<P>): Component<P, {}>[]

declare
export function ReactTestUtils$findRenderedComponentWithType<P>(tree: Component<any, any>, type: ComponentClass<P>): Component<P, {} >

    declare
export function ReactTestUtils$createRenderer(): ___React$ShallowRenderer
