// @flow
/**
 * Flowtype definitions for gijgo
...
declare module 'Gijgo' {
    ...
    declare type Grid<Entity, Params>= {
        addRow(record: Entity): Grid<Entity,
        Params>,
        clear(showNotFoundText?: boolean): Grid<Entity,
        Params>,
        count(): number,
        ...
        hideColumn(field: string): Grid<Entity,
        Params>,
        makeResponsive(): void,
        reload(params?: Params): Grid<Entity,
        Params>,
        removeRow(id: string): Grid<Entity,
        Params>,
        render(response: any): Grid<Entity,
        Params>,
        selectAll(): Grid<Entity,
        Params>,
        setSelected(id: string | number): Grid<Entity,
        Params>,
        showColumn(field: string): Grid<Entity,
        Params>,
        title(text: any): any,
        unSelectAll(): Grid<Entity,
        Params>,
        updateRow(id: string, record: Entity): Grid<Entity,
        Params >
    } & JQuery
...
declare interface JQuery {
    grid(settings: Gijgo.GridSettings<any>): Gijgo.Grid<any, any>,
        ...
        grid<Entity, Params>(
            settings: Gijgo.GridSettings<Entity>): Gijgo.Grid<Entity, Params>,
