...
declare module 'zmq' {
    ...
    declare type Socket = {
        ...
        */
         ...
         * @param  interval in ms>0 or Undefined for default
         * @return  for chaining
         */
    ...
    declare     export var types: SocketTypes;
    declare     export var options: SocketOptions;
