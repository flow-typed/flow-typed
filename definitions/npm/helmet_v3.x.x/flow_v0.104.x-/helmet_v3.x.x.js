...
declare type helmet$XssFilterOptions = { setOnOldIE?: boolean, ... }

declare type helmet$ReferrerPolicyOptions = { policy?:   'no-referrer' | 'no-referrer-when-downgrade' | 'same-origin' | 'origin' | 'strict-origin' | 'origin-when-cross-origin' | 'strict-origin-when-cross-origin' | 'unsafe-url' | '', ... }
...
declare type helmet$hidePoweredByOptions = { setTo?: string, ... }
...
declare type helmet$DnsOptions = { allow?: boolean, ... }
