...
import {DateTime, Duration, Interval, Settings, Info} from 'luxon';
import type {Zone} from 'luxon';

class CustomZone {
  static offsetName(ts: number, opts?: {
    format?: ?string,
    localeCode?: ?string,
  }): string {
    return 'date'
...
(Info.months('2-digit', {numberingSystem: 'latn', outputCalendar: 'buddhist'}): Array<string>);
// $ExpectError
...
(Info.monthsFormat('2-digit', {numberingSystem: 'latn', outputCalendar: 'buddhist'}): Array<string>);
// $ExpectError
...
(Info.weekdays('long', {numberingSystem: 'latn', outputCalendar: 'buddhist'}): Array<string>);
// $ExpectError
...
(Info.weekdaysFormat('long', {numberingSystem: 'latn', outputCalendar: 'buddhist'}): Array<string>);
// $ExpectError
...
DateTime.fromHTTP('Sun, 06 Nov 1994 08:49:37 GMT', {zone: 'America/Chicago', setZone: true, locale: 'en-US', outputCalendar: 'gregory', numberingSystem: 'buddhist'});
// $ExpectError
DateTime.fromHTTP();
// $ExpectError
DateTime.fromHTTP({});
...
DateTime.fromObject({year: 2017, month: 1, day: 23, zone: 'America/Chicago', setZone: true, locale: 'en-US', outputCalendar: 'gregory', numberingSystem: 'buddhist'});
// $ExpectError
DateTime.fromObject();
// $ExpectError
...
DateTime.fromISO('2017-01-28T23:00:01', {zone: 'America/Chicago', setZone: true, locale: 'en-US', outputCalendar: 'gregory', numberingSystem: 'buddhist'});
// $ExpectError
DateTime.fromISO();
// $ExpectError
...
DateTime.fromJSDate(new Date(), {zone: 'America/Chicago', setZone: true, locale: 'en-US', outputCalendar: 'gregory', numberingSystem: 'buddhist'});
// $ExpectError
DateTime.fromJSDate();
// $ExpectError
...
DateTime.fromMillis(123412323, {zone: 'America/Chicago', setZone: true, locale: 'en-US', outputCalendar: 'gregory', numberingSystem: 'buddhist'});
// $ExpectError
DateTime.fromMillis();
// $ExpectError
...
DateTime.fromRFC2822('12/15/2017, 12:47:25 PM', {zone: 'America/Chicago', setZone: true, locale: 'en-US', outputCalendar: 'gregory', numberingSystem: 'buddhist'});
// $ExpectError
...
DateTime.fromSQL('12/15/2017, 12:47:25 PM', {zone: 'America/Chicago', setZone: true, locale: 'en-US', outputCalendar: 'gregory', numberingSystem: 'buddhist'});
// $ExpectError
DateTime.fromSQL();
// $ExpectError
...
var date: DateTime = DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a');
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {});
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {zone: 'America/Chicago'});
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {zone: new CustomZone()});
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {locale: 'en-US'});
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {zone: 'America/Chicago', setZone: true, locale: 'en-US', outputCalendar: 'gregory', numberingSystem: 'buddhist'});
// $ExpectError
DateTime.fromString();
// $ExpectError
...
// $ExpectError
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {foo: 'bar'});
// $ExpectError
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {zone: 2});
// $ExpectError
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {locale: 2});
// $ExpectError
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {setZone: 'yes'});
// $ExpectError
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {outputCalendar: 2});
// $ExpectError
DateTime.fromString('12/15/2017, 12:47:25 PM', 'dd/MM/yyyy h:mm:ss a', {numberingSystem: 2});
...
(date.diff(DateTime.utc(), ['year', 'month'], {}): Duration);
(date.diff(DateTime.utc(), ['year', 'month'], {conversionAccuracy: 'longterm'}): Duration);
// $ExpectError
...
(date.toISO(): string);
(date.toISO({}): string);
(date.toISO({suppressMilliseconds: true, suppressSeconds: true, includeOffset: true}): string);
// $ExpectError
(date.toISO({blah: true}): string);

(date.toISOTime(): string);
(date.toISOTime({}): string);
(date.toISOTime({suppressMilliseconds: true, suppressSeconds: true, includeOffset: true}): string);
// $ExpectError
...
(date.toLocaleParts({month: 'numeric'}): Array<{type: string, value: number}>);
(date.toLocaleParts({year: 'numeric'}): Array<{type: string, value: number}>);
// $ExpectError
...
(Duration.fromISO('lkasdfa', {locale: 'de-DE', numberingSystem: 'gujr', conversionAccuracy: 'casual'}): Duration);
// $ExpectError
...
(Duration.fromObject({year: 1, months: 1, locale: 'de-DE', numberingSystem: 'gujr', conversionAccuracy: 'casual'}): Duration);
// $ExpectError
...
(Duration.fromMillis(23123412, {locale: 'de-DE', numberingSystem: 'gujr', conversionAccuracy: 'casual'}): Duration);
// $ExpectError
...
(Interval.after({year: 2017, month: 1}, Duration.fromObject({year: 1})): Interval);
...
(Interval.before({year: 2017, month: 1}, Duration.fromObject({year: 1})): Interval);
...
(Interval.fromDateTimes({year: 2016, month: 1}, {year: 2017, month: 1}): Interval);
// $ExpectError
(Interval.fromDateTimes({year: 2016, month: 1, foo: 'bar'}, {year: 2017, month: 1}): Interval);
// $ExpectError
(Interval.fromDateTimes({year: 2016, month: 1}, {year: 2017, month: 1, foo: 'bar'}): Interval);

(Interval.fromISO('23;lkj1'): Interval);
(Interval.fromISO('23;lkj1', {zone: 'America/Chicago', locale: 'de-DE'}): Interval);
// $ExpectError
...
(int.toDuration(['year', 'month'], {conversionAccuracy: 'longterm'}): Duration);
...
(int.toISO(): string);
(int.toISO({suppressMilliseconds: true, suppressSeconds: true, includeOffset: true}): string);
// $ExpectError
(int.toISO({suressMilliseconds: true, suppressSeconds: true, includeOffset: true}): string);
