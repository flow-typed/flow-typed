// @flow
/**
 * Flowtype definitions for linq.3.0.4-Beta5
...
declare module 'linqjs' {
    ...
    declare interface Enumerable {
        Utils: {
                ...
                createEnumerator<T>(
                    initialize: () => void,
                    tryGetNext: () => boolean,
                    dispose: () => void): IEnumerator<T>,
                getDefaultEqualityComparer<T>(): IEqualityComparer<T>,
                createEqualityComparer<T>(
                    equals: (x: T, y: T) => boolean,
                    getHashCode: (obj: any) => string): IEqualityComparer<T>,
                createKeyedEqualityComparer<TKey,
                TValue>(
                    keySelector: (element: TValue) => TKey): IEqualityComparer<TValue>,
                createDictionary<TKey,
                TValue>(
                    compareSelector: (element: TValue) => TKey): IDictionary<TKey,
                TValue>,
                createDictionary<TKey,
                TValue>(
                    equalityComparer: IEqualityComparer<TValue>): IDictionary<TKey,
                TValue>,
    ...
    declare interface IEnumerable<T>{
        ...
        traverseBreadthFirst<TResult>(
            func: (element: T) => IEnumerable<T>,
            resultSelector: (element: T, nestLevel: number) => TResult): IEnumerable<TResult>,
        traverseDepthFirst<TResult>(func: (element: T) => Enumerable): IEnumerable<T>,
        traverseDepthFirst<TResult>(
            func: (element: T) => Enumerable,
            resultSelector?: (element: T, nestLevel: number) => TResult): IEnumerable<TResult>,
        ...
        scan<TAccumulate>(
            seed: TAccumulate,
            func: (prev: TAccumulate, current: T) => TAccumulate): IEnumerable<TAccumulate>,
        select<TResult>(
            selector: (element: T, index: number) => TResult): IEnumerable<TResult>,
        selectMany<TOther>(
            collectionSelector: (element: T, index: number) => IEnumerable<TOther>): IEnumerable<TOther>,
        ...
        selectMany<TOther>(
            collectionSelector: (element: T, index: number) => TOther[]): IEnumerable<TOther>,
        selectMany<TCollection,
        TResult>(
        ...
        TResult>(
            ...
            resultSelector: (outer: T, inner: TKey) => TResult,
            compareSelector?: (obj: T) => TKey): IEnumerable<TResult>,
        join<TInner,
        TKey,
        TResult>(
            inner: {
        ...
        orderBy<TKey>(
            ...
            comparison: (x: TKey, y: TKey) => number): IOrderedEnumerable<T>,
        ...
        groupBy<TKey>(keySelector: (element: T) => TKey): IEnumerable<IGrouping<TKey,
        any >> ,
        groupBy<TKey,
        TElement>(
            keySelector: (element: T) => TKey,
            elementSelector: (element: T) => TElement): IEnumerable<IGrouping<TKey,
        TElement >> ,
        groupBy<TKey,
        TElement,
        TResult>(
            ...
            resultSelector: (key: TKey, element: IEnumerable<TElement>) => TResult): IEnumerable<TResult>,
        groupBy<TKey,
        TElement,
        TResult,
        TCompare>(
            ...
            compareSelector: (element: TKey) => TCompare): IEnumerable<TResult>,
        partitionBy<TKey>(keySelector: (element: T) => TKey): IEnumerable<IGrouping<TKey,
        any >> ,
        partitionBy<TKey,
        TElement>(
            keySelector: (element: T) => TKey,
        ...
        TCompare>(
            ...
            elementSelector: (element: T) => TElement,
            resultSelector: (key: TKey, element: IEnumerable<TElement>) => TResult,
            compareSelector: (element: T) => TCompare): IEnumerable<TResult>,
        buffer(count: number): IEnumerable<T>,
        aggregate(func: (prev: T, current: T) => T): T,
        aggregate<TAccumulate>(
            seed: TAccumulate,
            func: (prev: TAccumulate, current: T) => TAccumulate): TAccumulate,
        aggregate<TAccumulate,
        TResult>(
            seed: TAccumulate,
            func: (prev: TAccumulate, current: T) => TAccumulate,
            resultSelector: (last: TAccumulate) => TResult): TResult,
        ...
        toArray(): T[],
        toList(): IList<T>,
        toLookup<TKey>(keySelector: (element: T) => TKey): ILookup<TKey,
        any>,
        toLookup<TKey,
        TElement>(
            keySelector: (element: T) => TKey,
            elementSelector: (element: T) => TElement): ILookup<TKey,
        TElement>,
        toLookup<TKey,
        TElement,
        TCompare>(
            keySelector: (element: T) => TKey,
            elementSelector: (element: T) => TElement,
            compareSelector: (key: TKey) => TCompare): ILookup<TKey,
        TElement>,
        toObject(
            keySelector: (element: T) => any,
            elementSelector?: (element: T) => any): Object,
        toDictionary<TKey>(keySelector: (element: T) => TKey): IDictionary<TKey,
        any>,
        toDictionary<TKey,
        TValue>(
            keySelector: (element: T) => TKey,
            elementSelector: (element: T) => TValue): IDictionary<TKey,
        TValue>,
        toDictionary<TKey,
        TValue,
        TCompare>(
            ...
            compareSelector: (key: TKey) => TCompare): IDictionary<TKey,
        TValue>,
        ...
        toJoinedString<TResult>(
            separator: string,
            selector: (element: T, index: number) => TResult): string,
        ...
        letBind<TResult>(
            func: (source: IEnumerable<T>) => IEnumerable<TResult>): IEnumerable<TResult>,
    ...
    declare type IOrderedEnumerable<T>= {
        createOrderedEnumerable<TKey>(
            keySelector: (element: T) => TKey,
            comparison: (x: TKey, y: TKey) => number,
    ...
    declare type IDisposableEnumerable<T>= {
        dispose(): void
    } & IEnumerable
    ...
    declare interface ILookup<TKey, TElement>{
        ...
        contains(key: TKey): boolean,
        toEnumerable(): IEnumerable<IGrouping<TKey,
        TElement >>
    }
    declare type IGrouping<TKey, TElement>= {
        key(): TKey
    } & IEnumerable
