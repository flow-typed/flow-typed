...
declare module 'linq.3.0.4-Beta5' {
...
declare module 'linqjs' {
	...
	declare interface IEqualityComparer<T> {
		equals(x: T, y: T): boolean,
		getHashCode(obj: any): string
	}

	declare interface ITuple<T1, T2, T3, T4, T5, T6, T7, T8> {
		equals(other: ITuple<T1, T2, T3, T4, T5, T6, T7, T8>): boolean,
		getHashCode(): string
	}

	declare interface ITupleArray {
	...
	declare interface Enumerable {
		...
		createEnumerator<T>(
		initialize: () => void, tryGetNext: () => boolean, dispose: () => void
	): IEnumerator<T>,
		getDefaultEqualityComparer<T>(): IEqualityComparer<T>,
		createEqualityComparer<T>(
		equals: (x: T, y: T) => boolean, getHashCode: (obj: any) => string
	): IEqualityComparer<T>,
		createKeyedEqualityComparer<TKey, TValue>(
		keySelector: (element: TValue) => TKey
	): IEqualityComparer<TValue>,
		createDictionary<TKey, TValue>(
		compareSelector: (element: TValue) => TKey
	): IDictionary<TKey, TValue>,
		createDictionary<TKey, TValue>(
		equalityComparer: IEqualityComparer<TValue>
	): IDictionary<TKey, TValue>,
		createList<T>(): IList<T>,
		createTuple<T1, T2, T3, T4, T5, T6, T7, T8>(
		item1: T1, item2: T2, item3?: T3, item4?: T4, item5?: T5, item6?: T6, item7?: T7, item8?: T8
	): ITuple<T1, T2, T3, T4, T5, T6, T7, T8>,
	...
	declare interface IEnumerable<T> {
		...
		func: (element: T) => IEnumerable<T>, resultSelector: (element: T, nestLevel: number) => TResult
	): IEnumerable<TResult>,
		traverseDepthFirst<TResult>(func: (element: T) => Enumerable): IEnumerable<T>,
		traverseDepthFirst<TResult>(
		func: (element: T) => Enumerable, resultSelector?: (element: T, nestLevel: number) => TResult
	): IEnumerable<TResult>,
		...
		scan<TAccumulate>(
		seed: TAccumulate, func: (prev: TAccumulate, current: T) => TAccumulate
		...
		collectionSelector: (element: T, index: number) => IEnumerable<TCollection>, resultSelector: (outer: T, inner: TCollection) => TResult
	): IEnumerable<TResult>,
		selectMany<TOther>(
		collectionSelector: (element: T, index: number) => TOther[]
	): IEnumerable<TOther>,
		selectMany<TCollection, TResult>(
		collectionSelector: (element: T, index: number) => TCollection[], resultSelector: (outer: T, inner: TCollection) => TResult
	): IEnumerable<TResult>,
		selectMany<TOther>(
		collectionSelector: (element: T, index: number) => {
		length: number,
		[x: number]: TOther
	}
	): IEnumerable<TOther>,
		...
		zip<TResult>(
		second: IEnumerable<T>, resultSelector: (first: T, second: T, index: number) => TResult
	): IEnumerable<TResult>,
		zip<TResult>(
		second: {
		length: number,
		...
		zip<TResult>(
		second: T[], resultSelector: (first: T, second: T, index: number) => TResult
	): IEnumerable<TResult>,
		...
		inner: IEnumerable<TInner>, outerKeySelector: (outer: T) => TKey, innerKeySelector: (inner: TInner) => TKey, resultSelector: (outer: T, inner: TKey) => TResult, compareSelector?: (obj: T) => TKey
	): IEnumerable<TResult>,
		join<TInner, TKey, TResult>(
		inner: {
		length: number,
		[x: number]: TInner
	}, outerKeySelector: (outer: T) => TKey, innerKeySelector: (inner: TInner) => TKey, resultSelector: (outer: T, inner: TKey) => TResult, compareSelector?: (obj: T) => TKey
	): IEnumerable<TResult>,
		join<TInner, TKey, TResult>(
		inner: TInner[], outerKeySelector: (outer: T) => TKey, innerKeySelector: (inner: TInner) => TKey, resultSelector: (outer: T, inner: TKey) => TResult, compareSelector?: (obj: T) => TKey
	): IEnumerable<TResult>,
		...
		second: IEnumerable<T>, compareSelector: (element: T) => TCompare
	): IEnumerable<T>,
		except(second: T[]): IEnumerable<T>,
		except<TCompare>(
		second: T[], compareSelector: (element: T) => TCompare
	): IEnumerable<T>,
		intersect(second: {
		length: number,
		[x: number]: T
		...
		orderBy<TKey>(
		keySelector: (element: T) => TKey, comparison: (x: TKey, y: TKey) => number
		...
		keySelector: (element: T) => TKey, elementSelector: (element: T) => TElement, resultSelector: (key: TKey, element: IEnumerable<TElement>) => TResult
	): IEnumerable<TResult>,
		groupBy<TKey, TElement, TResult, TCompare>(
		keySelector: (element: T) => TKey, elementSelector: (element: T) => TElement, resultSelector: (key: TKey, element: IEnumerable<TElement>) => TResult, compareSelector: (element: TKey) => TCompare
	): IEnumerable<TResult>,
		...
		keySelector: (element: T) => TKey, elementSelector: (element: T) => TElement, resultSelector: (key: TKey, element: IEnumerable<TElement>) => TResult, compareSelector: (element: T) => TCompare
	): IEnumerable<TResult>,
		...
		seed: TAccumulate, func: (prev: TAccumulate, current: T) => TAccumulate, resultSelector: (last: TAccumulate) => TResult
	): TResult,
		...
		keySelector: (element: T) => TKey, elementSelector: (element: T) => TElement, compareSelector: (key: TKey) => TCompare
	): ILookup<TKey, TElement>,
		toObject(
		keySelector: (element: T) => any, elementSelector?: (element: T) => any
	): Object,
		toDictionary<TKey>(keySelector: (element: T) => TKey): IDictionary<TKey, any>,
		toDictionary<TKey, TValue>(
		keySelector: (element: T) => TKey, elementSelector: (element: T) => TValue
	): IDictionary<TKey, TValue>,
		toDictionary<TKey, TValue, TCompare>(
		keySelector: (element: T) => TKey, elementSelector: (element: T) => TValue, compareSelector: (key: TKey) => TCompare
	): IDictionary<TKey, TValue>,
		...
		separator: string, selector: (element: T, index: number) => TResult
	): string,
		...
		letBind<TResult>(
		func: (source: IEnumerable<T>) => IEnumerable<TResult>
	): IEnumerable<TResult>,
	...
	declare interface IOrderedEnumerable<T> {
		createOrderedEnumerable<TKey>(
		keySelector: (element: T) => TKey, comparison: (x: TKey, y: TKey) => number, descending: boolean
	): IOrderedEnumerable<T>,
	...
	declare interface IDisposableEnumerable<T> {
		dispose(): void
	}

	declare interface IDictionary<TKey, TValue> {
	...
	declare interface ILookup<TKey, TElement> {
		count(): number,
	...
	declare interface IGrouping<TKey, TElement> {
		key(): TKey
	}
