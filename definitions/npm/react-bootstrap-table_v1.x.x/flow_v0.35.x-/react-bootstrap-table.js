/**
 * Flowtype definitions for react-bootstrap-table
...
declare module 'react-bootstrap-table' {
    ...
    declare export type BootstrapTableProps = {
         ...
         * @example  function trClassFormat(rowData,rowIndex){
    ...
    declare export type BootstrapTable = {
    ...
    declare export var BootstrapTable: BootstrapTable;
    declare export type DataAlignType = "left" |
        "center" |
        "right" |
        "start" |
        "end";
    declare export type TableHeaderColumnProps = {
    ...
    declare export type FilterType = "TextFilter" |
        "RegexFilter" |
        "SelectFilter" |
        "NumberFilter" |
        "DateFilter" |
    ...
    declare export type TableHeaderColumn = {} & ComponentClass

    declare export var TableHeaderColumn: TableHeaderColumn;
    declare export class TableDataSet mixins EventEmitter {
