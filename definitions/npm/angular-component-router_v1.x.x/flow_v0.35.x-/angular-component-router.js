// @flow
/**
 * Flowtype definitions for angular-component-router
...
```
*/
declare interface angular$Instruction {
    component: angular$ComponentInstruction,
        child: angular$Instruction,
        auxInstruction: {
            [key: string]: angular$Instruction
        },
        urlPath(): string,
        urlParams(): string[],
        specificity(): number,
        resolveComponent(): IPromise<angular$ComponentInstruction>,
         ...
         */
        replaceChild(child: angular$Instruction): angular$Instruction,
...
```
*/
declare interface angular$RouterOutlet {
    name: string,
         ...
         */
        activate(nextInstruction: angular$ComponentInstruction): IPromise<any>,
        ...
        */
        reuse(nextInstruction: angular$ComponentInstruction): IPromise<any>,

        /**
         * Called by the {@link Router} when an outlet disposes of a component's contents.
         * This method in turn is responsible for calling the `routerOnDeactivate` hook of its child.
         */
        deactivate(nextInstruction: angular$ComponentInstruction): IPromise<any>,
        ...
        */
        routerCanDeactivate(nextInstruction: angular$ComponentInstruction): IPromise<boolean>,
        ...
        */
        routerCanReuse(nextInstruction: angular$ComponentInstruction): IPromise<boolean >
}

declare interface angular$RouteRegistry {

    /**
     * Given a component and a configuration object, add the route to this registry
     */
    config(parentComponent: any, config: angular$RouteDefinition): void,
        ...
        recognize(
            url: string,
            ancestorInstructions: angular$Instruction[]): IPromise<angular$Instruction>,
        ...
        */
        generate(
            linkParams: any[],
            ancestorInstructions: angular$Instruction[],
            _aux?: boolean): angular$Instruction,
        hasRoute(name: string, parentComponent: any): boolean,
        generateDefault(componentCursor: any): angular$Instruction
}
...
*/
declare interface angular$Router {
    navigating: boolean,
        ...
        */
        registerPrimaryOutlet(outlet: angular$RouterOutlet): IPromise<boolean>,
        ...
        You probably don't need to use this unless you're writing a reusable component.
        */
        registerAuxOutlet(outlet: angular$RouterOutlet): IPromise<boolean>,
        ...
        ```
        */
        config(definitions: angular$RouteDefinition[]): IPromise<any>,
        ...
        */
         ...
         * complete.
         */
        navigateByInstruction(instruction: angular$Instruction, _skipLocationChange?: boolean): IPromise<any>,

        /**
         * Updates this router and all descendant routers according to the given instruction
         */
        commit(instruction: angular$Instruction, _skipLocationChange?: boolean): IPromise<any>,
         ...
         */
        deactivate(instruction: angular$Instruction): IPromise<any>,

        /**
         * Given a URL, returns an instruction representing the component graph
         */
        recognize(url: string): IPromise<angular$Instruction>,
 ...
 */
declare interface angular$RouteData {
    data: {
            [key: string]: any
        },
        get(key: string): any
...
*/
declare interface angular$ComponentInstruction {
    reuse: boolean,
        routeData: angular$RouteData,
        urlPath: string,
        urlParams: string[],
        data: angular$RouteData,
        componentType: any,
        terminal: boolean,
        specificity: number,
        params: {
...
*/
declare interface angular$OnActivate {
...
*/
declare interface angular$CanDeactivate {
    $routerCanDeactivate(
        next?: angular$ComponentInstruction,
        prev?: angular$ComponentInstruction): boolean | IPromise<boolean >
}
...
*/
declare interface angular$OnDeactivate {
...
*/
declare interface angular$CanReuse {
    $routerCanReuse(
        next?: angular$ComponentInstruction,
        prev?: angular$ComponentInstruction): boolean | IPromise<boolean >
}
 ...
 * @example  router/ts/reuse/reuse_example.ts region='reuseCmp'}
*/
declare interface angular$OnReuse {
...
declare module 'angular' {
    ...
    declare interface IModule {
        animation(name: string, animationFactory: undefined.IAnimateFactory): IModule,
