...
declare module 'xmlbuilder' {
		...
		name: string, xmldec?: Object, doctype?: any, options?: Object
	): XMLElementOrXMLNode
	...
	declare class XMLDocType  {
		...
		attList(
		elementName: string, attributeName: string, attributeType: string, defaultValueType?: string, defaultValue?: any
	): XMLDocType;
