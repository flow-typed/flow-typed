// @flow
/**
 * Flowtype definitions for couchbase
...
declare module 'couchbase' {
    ...
    declare type PrependOptions = {} & AppendOptions

    declare type RemoveOptions = {} & AppendOptions
    ...
    declare type UpsertOptions = {} & ReplaceOptions
     ...
     */
    declare class N1qlStringQuery mixins N1qlQuery {
    ...
    declare interface Bucket {
        ...
        clientVersion: string,
            ...
            append(
                ...
                callback: Bucket$OpCallback): void,
            ...
            */
             ...
             */
            query(
                query: ViewQuery | N1qlQuery,
                callback: Bucket$QueryCallback): Bucket$ViewQueryResponse | Bucket$N1qlQueryResponse,
     ...
     */
    declare interface Bucket$QueryCallback {
         ...
         */
        (error: CouchbaseError, rows: any[], meta: undefined.Meta): void
    }
    ...
    */
    declare interface Bucket$OpCallback {
     ...
     */
    declare interface Bucket$MultiGetCallback {
     ...
     */
    declare interface Bucket$EncoderFunction {
     ...
     */
    declare interface Bucket$DecoderFunction {
