// @flow
/**
 * Flowtype definitions for jsdom
...
declare module 'jsdom' {
    ...
    */
    ...
    declare     export type VirtualConsole = {
    ...
    declare     export function jQueryify(
        window: Window,
        jqueryUrl: string,
        callback: (window: Window, jquery: JQuery) => any): void
    declare     export var debugMode: boolean;
    declare     export type DocumentWithParentWindow = {
        parentWindow: Window
    } & Document
