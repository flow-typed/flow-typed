/**
 * Flowtype definitions for jquery.validation
...
declare type JQueryValidation$RulesDictionary = {
    [name: string]: any
};

declare type JQueryValidation$ShouldValidatePredicate = boolean | ((element: HTMLElement, event: JQueryEventObject) => void);

declare interface JQueryValidation$ValidationOptions {
    ...
    */
    debug?: boolean,
        ...
        */
         ...
         */
        invalidHandler?: (event: JQueryEventObject, validator: JQueryValidation$Validator) => void,
        ...
        */
        onclick?: JQueryValidation$ShouldValidatePredicate,
        ...
        A boolean true is not a valid value.
        */
        onfocusout?: JQueryValidation$ShouldValidatePredicate,
        ...
        A boolean true is not a valid value.
        */
        onkeyup?: JQueryValidation$ShouldValidatePredicate,
        ...
        */
         ...
         */
        rules?: JQueryValidation$RulesDictionary,
        ...
        showErrors?: (
            ...
            errorList: JQueryValidation$ErrorListItem[]) => void,
...
declare interface JQueryValidation$ErrorDictionary {
    [name: string]: string
}

declare interface JQueryValidation$ErrorListItem {
    message: string,
        element: HTMLElement
}
...
declare interface JQueryValidation$ValidatorStatic {
     ...
     */
    addClassRules(name: string, rules: JQueryValidation$RulesDictionary): void,

        /**
         * Add a compound class method - useful to refactor common combinations of rules into a single class.
         * @param rules A map of className-rules pairs
         */
        addClassRules(rules: JQueryValidation$RulesDictionary): void,
        ...
        addMethod(
            name: string,
            method: (value: any, element: HTMLElement, params: any) => boolean,
            message?: (params: any, element: HTMLElement) => string): void,
         ...
         */
        setDefaults(defaults: JQueryValidation$ValidationOptions): void,
        messages: {
            [index: string]: string
        },
        methods: {
...
declare interface JQueryValidation$Validator {
    element(element: string | JQuery): boolean,
         ...
         */
        resetForm(): void,
        settings: JQueryValidation$ValidationOptions,
