...
function test() {
    ...
    var line = { p1: { x: 0, y: 0 }, p2: { x: 1, y: 1 } };
    var abc = { A: null, B: null, C: null };
    var arc = { e: 0, s: 0, x: 0, y: 0, r: 1 };
    var bbox = bezier.bbox();
    var closest = { mdist: 1, mpos: 0 };
    var inflection = { values: null, x: [0], y: [0], z: [0] };
    var minmax = { min: 0, max: 0 };
    var offset = { x: 0, y: 0, c: point, n: point };
    var pair = { left: bezier, right: bezier };
    var poly = bezier.outline(1);
    var projection = { x: 0, y: 0, t: 9, d: 4 };
    var shape = {
        startcap: cap,
        endcap: cap,
        forward: bezier,
    ...
    var split = { left: bezier, right: bezier, span: [point] };
    bezier.arcs();
    bezier.clockwise;
    bezier.compute(.5);
