/**
 * Flowtype definitions for babel-traverse
...
declare module 'babel-traverse' {
    ...
    declare export default function traverse(
        ...
        scope?: Scope,
        state?: any,
        parentPath?: NodePath<Node>): void
    declare export type TraverseOptions = {
        scope?: Scope,
        noScope?: boolean
    } & Visitor
    ...
    declare export class NodePath<T>{
        ...
        buildCodeFrameError<TError>(msg: string, Error?: (msg: string) => TError): TError;
