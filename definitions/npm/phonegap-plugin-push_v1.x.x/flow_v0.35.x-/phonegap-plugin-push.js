/**
 * Flowtype definitions for phonegap-plugin-push
...
declare type PhonegapPluginPush$EventResponse = PhonegapPluginPush$RegistrationEventResponse | PhonegapPluginPush$NotificationEventResponse | Error;

declare interface PhonegapPluginPush$PushNotification {
    ...
    on(
            event: "registration",
            callback: (response: PhonegapPluginPush$RegistrationEventResponse) => any): void,
        ...
        on(
            event: "notification",
            callback: (response: PhonegapPluginPush$NotificationEventResponse) => any): void,
        ...
        on(
            event: string,
            callback: (response: PhonegapPluginPush$EventResponse) => any): void,
        off(
            event: "registration",
            callback: (response: PhonegapPluginPush$RegistrationEventResponse) => any): void,
        off(
 ...
 */
declare interface PhonegapPluginPush$InitOptions {
    ...
    android?: {
        ...
        ios?: {
            ...
            */
             ...
             */
            categories?: PhonegapPluginPush$CategoryArray,
...
declare interface PhonegapPluginPush$CategoryArray {
    [name: string]: PhonegapPluginPush$CategoryAction
}

declare interface PhonegapPluginPush$CategoryAction {
    yes?: PhonegapPluginPush$CategoryActionData,
        no?: PhonegapPluginPush$CategoryActionData,
        maybe?: PhonegapPluginPush$CategoryActionData
}

declare interface PhonegapPluginPush$CategoryActionData {
    callback: string,
        title: string,
        foreground: boolean,
        destructive: boolean
...
declare interface PhonegapPluginPush$RegistrationEventResponse {
...
declare interface PhonegapPluginPush$NotificationEventResponse {
    ...
    message: string,
         ...
         */
        additionalData: PhonegapPluginPush$NotificationEventAdditionalData
}
...
*/
declare interface PhonegapPluginPush$NotificationEventAdditionalData {
    [name: string]: any,
...
declare interface PhonegapPluginPush$PushNotificationStatic {
    init(options: PhonegapPluginPush$InitOptions): PhonegapPluginPush$PushNotification,
        new(options: PhonegapPluginPush$InitOptions): PhonegapPluginPush$PushNotification
}
