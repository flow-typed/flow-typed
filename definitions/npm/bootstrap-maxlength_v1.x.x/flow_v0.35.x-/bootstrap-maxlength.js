/**
 * Flowtype definitions for bootstrap-maxlength
 ...
 */
declare interface BootstrapMaxlength$PlacementOptions {
 ...
 */
declare interface BootstrapMaxlength$PositionParam {
    top: Number,
        right: Number,
        bottom: Number,
        left: Number,
...
declare export interface BootstrapMaxlength$Options {
    ...
    alwaysShow?: Boolean,
         ...
         * @default  'bottom'
         */
        placement?: string | BootstrapMaxlength$PlacementOptions | ((
            currentInput: JQuery,
            maxLengthIndicator: JQuery,
            currentInputPosition: BootstrapMaxlength$PositionParam) => void),
