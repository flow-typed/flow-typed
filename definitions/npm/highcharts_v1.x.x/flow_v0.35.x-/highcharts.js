// @flow
/**
 * Flowtype definitions for highcharts
...
declare interface ___Highcharts$Position {
    align?: string,
...
declare interface ___Highcharts$DateTimeFormats {
...
declare type ___Highcharts$AxisEvent = {
    min: number,
    max: number
} & Event


declare interface ___Highcharts$AxisLabels {
...
declare interface ___Highcharts$MousePlotEvents {
 ...
 */
declare interface ___Highcharts$PlotLabel {
...
declare interface ___Highcharts$PlotBands {

    /**
     * Border color for the plot band. Also requires borderWidth to be set.
     * @default  null
     */
    borderColor?: ___Highcharts$Color,
         ...
         * @since  1.2
        */
        events?: ___Highcharts$MousePlotEvents,
 ...
 * on one of the axes.
 */
declare interface ___Highcharts$PlotLines {

    /**
     * The color of the line.
     */
    color?: string | ___Highcharts$Gradient,
...
declare interface ___Highcharts$AxisTitle {
...
declare interface ___Highcharts$AxisBreak {
...
declare interface ___Highcharts$AxisOptions {
    ...
    */
    allowDecimals?: boolean,
         ...
         * @since  4.1.0
         */
        breaks?: ___Highcharts$AxisBreak[],
        ...
        */
         ...
         */
        crosshair?: ___Highcharts$CrosshairObject | boolean,
         ...
         */
        dateTimeLabelFormats?: ___Highcharts$DateTimeFormats,
        ...
        events?: {
             ...
             * @since  2.3
            */
            afterSetExtremes?: (event: ___Highcharts$AxisEvent) => void,
             ...
             * @since  1.2.0
            */
            setExtremes?: (event: ___Highcharts$AxisEvent) => void
        },
         ...
         */
        labels?: ___Highcharts$AxisLabels,

        /**
         * The color of the line marking the axis itself.
         * @default  '#C0D0E0'.
         */
        lineColor?: string | ___Highcharts$Gradient,
        ...
        */
        plotBands?: ___Highcharts$PlotBands[],

        /**
         * An array of lines stretching across the plot area, marking a specific value on one of the axes.
         */
        plotLines?: ___Highcharts$PlotLines[],
...
declare interface ___Highcharts$ColorAxisDataClass {
    from?: number,
        to?: number,
        color?: string | ___Highcharts$Gradient,
        name?: string
...
*/
declare interface ___Highcharts$ColorAxisOptions {
    ...
    */
    dataClassColor?: string,
         ...
         */
        dataClasses?: ___Highcharts$ColorAxisDataClass[],
        ...
        marker?: {
             ...
             * @default  {duration: 50}
             */
            animation?: boolean | ___Highcharts$Animation,
...
declare interface ___Highcharts$Extremes {
...
declare interface ___Highcharts$Animation {
...
declare type ___Highcharts$AddSeriesEvent = {

    /**
     * The series options that was passed to the addSeries method.
     */
    options: ___Highcharts$ChartOptions
} & Event


declare type ___Highcharts$AxisValueOptions = {

    /**
     * The axis value at the clicked spot
     */
    value: number
} & ___Highcharts$AxisOptions


declare type ___Highcharts$ChartClickEvent = {

    /**
     * Array containing the axes of each dimension and each axis' value at the clicked spot
     */
    xAxis: ___Highcharts$AxisValueOptions[],

    /**
     * Array containing the axes of each dimension and each axis' value at the clicked spot
     */
    yAxis: ___Highcharts$AxisValueOptions[]
} & Event


declare type ___Highcharts$ChartDrilldownEvent = {
     ...
     */
    point?: ___Highcharts$PointObject,

    /**
     * If a category label was clicked, this array holds all points corresponing to the category.
     */
    points?: ___Highcharts$PointObject[],

    /**
     * Options for the new series.
     */
    seriesOptions?: ___Highcharts$IndividualSeriesOptions
} & Event


declare type ___Highcharts$ChartSelectionEvent = {
...
declare interface ___Highcharts$ChartEvents {
     ...
     * @since  1.2.0
    */
    addSeries?: (event: ___Highcharts$AddSeriesEvent) => boolean | void,
         ...
         * @since  1.2.0
        */
        click?: (event: ___Highcharts$ChartClickEvent) => void,

        /**
         * Fires when a drilldown point is clicked, before the new series is added.
         * @since  3.0.8
         */
        drilldown?: (event: ___Highcharts$ChartDrilldownEvent) => void,
        ...
        */
        selection?: (event: ___Highcharts$ChartSelectionEvent) => void
}

declare interface ___Highcharts$LinearGradient {
    x1: number,
        y1: number,
        x2: number,
        y2: number
...
declare interface ___Highcharts$Gradient {
    linearGradient?: ___Highcharts$LinearGradient | number[],
        radialGradient?: {
            cx: number,
            cy: number,
            r: number
         ...
         * @param  
         */
        brighten(alpha: number): ___Highcharts$Gradient,
         ...
         * @return  
         */
        setOpacity(alpha: number): ___Highcharts$Gradient
}
 ...
 */
declare type ___Highcharts$Color = string | ___Highcharts$Gradient;

declare interface ___Highcharts$ChartOptions3dFrame {
...
declare interface ___Highcharts$ChartOptions3d {
    ...
    alpha?: number,
        ...
        frame?: {
             ...
             * @since  4.0
             */
            back?: ___Highcharts$ChartOptions3dFrame,

            /**
             * The bottom of the frame around a 3D chart.
             * @since  4.0
             */
            bottom?: ___Highcharts$ChartOptions3dFrame,

            /**
             * The side for the frame around a 3D chart.
             * @since  4.0
             */
            side?: ___Highcharts$ChartOptions3dFrame
        },
...
declare interface ___Highcharts$Shadow {
...
declare interface ___Highcharts$ChartResetZoomButton {
    ...
    position?: ___Highcharts$Position,
         ...
         * @since  2.2
        */
        theme?: ___Highcharts$ButtonStatesTheme
}

declare interface ___Highcharts$ButtonTheme {
    display?: string,

        /**
         * The button fill color, SVG color definition
         */
        fill?: string | ___Highcharts$Gradient,
...
declare type ___Highcharts$ButtonStatesTheme = {
    ...
    states?: {
         ...
         */
        hover?: ___Highcharts$ButtonTheme,

        /**
         * Attributes and styles applied when button is selected (tri-state).
         */
        select?: ___Highcharts$ButtonTheme
    }
} & ___Highcharts$ButtonTheme


declare interface ___Highcharts$ChartOptions {
    ...
    */
    alignTicks?: boolean,
        ...
        */
         ...
         * @default  '#FFFFFF'
         */
        backgroundColor?: string | ___Highcharts$Gradient,

        /**
         * The color of the outer chart border.
         * @default  '#4572A7'
         */
        borderColor?: string | ___Highcharts$Gradient,
         ...
         */
        events?: ___Highcharts$ChartEvents,
        ...
        */
         ...
         */
        options3d?: ___Highcharts$ChartOptions3d,
        ...
        */
         ...
         */
        plotBackgroundColor?: string | ___Highcharts$Gradient,
        ...
        */
         ...
         * @default  false
         */
        plotShadow?: boolean | ___Highcharts$Shadow,
         ...
         */
        resetZoomButton?: ___Highcharts$ChartResetZoomButton,
         ...
         * @default  false
         */
        shadow?: boolean | ___Highcharts$Shadow,
...
declare interface ___Highcharts$CSSObject {
    background?: string,
        border?: string,
        color?: string | ___Highcharts$Gradient,
        cursor?: string,
...
declare interface ___Highcharts$CreditsOptions {
...
declare interface ___Highcharts$DataSeriesMapping {
...
series.data option.
*/
declare interface ___Highcharts$DataOptions {
    ...
    */
    columns?: [string | number][],
         ...
         * @since  4.0
        */
        complete?: (options: ___Highcharts$Options) => void,
        ...
        */
         ...
         * @since  4.0.4
         */
        seriesMapping?: ___Highcharts$DataSeriesMapping[],
...
*/
declare interface ___Highcharts$DrilldownOptions {
...
declare interface ___Highcharts$MenuItem {
...
declare interface ___Highcharts$Button {
...
declare type ___Highcharts$ExportingContextButton = {
     ...
     * @since  2.0
    */
    menuItems?: ___Highcharts$MenuItem[],
     ...
     */
    x?: number
} & ___Highcharts$Button


declare interface ___Highcharts$ExportingOptions {
    ...
    */
    allowHTML?: boolean,
         ...
         */
        buttons?: {
            contextButton?: ___Highcharts$ExportingContextButton
        },
         ...
         * @default  null
         */
        chartOptions?: ___Highcharts$Options,
 ...
 */
declare interface ___Highcharts$GlobalObject {
...
declare interface ___Highcharts$LabelItem {
    html: string,
        style: ___Highcharts$CSSObject
}

declare interface ___Highcharts$LabelsOptions {
    items?: ___Highcharts$LabelItem[],
        style?: ___Highcharts$CSSObject
}

declare interface ___Highcharts$LangObject {
...
declare interface ___Highcharts$LegendNavigationOptions {
...
declare interface ___Highcharts$LegendTitleOptions {
...
declare interface ___Highcharts$LegendOptions {
    ...
    */
    align?: string,
         ...
         * @default  {color: '#CCC'}
         */
        itemHiddenStyle?: ___Highcharts$CSSObject,
         ...
         * @default  {color: '#000'}
         */
        itemHoverStyle?: ___Highcharts$CSSObject,
         ...
         */
        itemStyle?: ___Highcharts$CSSObject,
         ...
         */
        navigation?: ___Highcharts$LegendNavigationOptions,
        ...
        */
         ...
         * @since  3.0
         */
        title?: ___Highcharts$LegendTitleOptions,
...
*/
declare interface ___Highcharts$LoadingOptions {
 ...
 */
declare interface ___Highcharts$NavigationOptions {

    /**
     * A collection of options for buttons appearing in the exporting module.
     */
    buttonOptions?: ___Highcharts$Button,
 ...
 */
declare interface ___Highcharts$NoDataOptions {
...
declare interface ___Highcharts$PaneBackground {
 ...
 */
declare interface ___Highcharts$PaneOptions {
     ...
     * @since  2.3.0
     */
    background?: ___Highcharts$PaneBackground | ___Highcharts$PaneBackground[],
...
declare interface ___Highcharts$DataLabels {
...
declare type ___Highcharts$PieDataLabels = {
...
} & ___Highcharts$DataLabels


declare type ___Highcharts$AreaCheckboxEvent = {
     ...
     * The checked item
     */
    item: ___Highcharts$SeriesObject | ___Highcharts$PointObject
} & Event


declare type ___Highcharts$AreaClickEvent = {
...
declare interface ___Highcharts$PlotEvents {
    ...
    */
    afterAnimate?: (event: Event) => void,
         ...
         * @since  1.2.0
        */
        checkboxClick?: (event: ___Highcharts$AreaCheckboxEvent) => boolean | void,
        ...
        The this keyword refers to the Series object.
        */
        click?: (event: ___Highcharts$AreaClickEvent) => void,
...
declare interface ___Highcharts$MarkerState {
...
declare type ___Highcharts$MarkerHoverState = {
     ...
     */
    radiusPlus?: number
} & ___Highcharts$MarkerState


declare type ___Highcharts$Marker = {
...
declare interface ___Highcharts$PointEvents {
...
declare interface ___Highcharts$Halo {
...
declare interface ___Highcharts$LineStates {
    ...
    enabled?: boolean,
         ...
         * @since  4.0
        */
        halo?: boolean | ___Highcharts$Halo,
         ...
         */
        lineWidthPlus?: number,
        marker?: ___Highcharts$Marker
}

declare interface ___Highcharts$BarStates {
...
declare type ___Highcharts$PieStates = {} & ___Highcharts$BarStates & ___Highcharts$LineStates


declare interface ___Highcharts$AreaZone {
...
declare interface ___Highcharts$RangeDataLabels {
...
declare interface ___Highcharts$Dial {
...
declare interface ___Highcharts$Pivot {
 ...
 */
declare interface ___Highcharts$TreeMapLevel {
    ...
    borderColor?: string | ___Highcharts$Gradient,
         ...
         * @since  4.1.0
         */
        dataLabels?: ___Highcharts$DataLabels,
 ...
 */
declare interface ___Highcharts$SeriesChart {
    ...
    allowPointSelect?: boolean,
        ...
        */
        ...
        events?: ___Highcharts$PlotEvents,
        ...
        */
        ...
        point?: {
            events: ___Highcharts$PointEvents
        },
        ...
        */
        ...
        states?: {
             ...
             */
            hover?: ___Highcharts$LineStates
        },
        ...
        */
         ...
         * @since  2.3
         */
        tooltip?: ___Highcharts$SeriesTooltipOptions,
        ...
        */
         ...
         */
        zones?: ___Highcharts$AreaZone[]
}

declare type ___Highcharts$AreaChart = {

    /**
     * Fill color or gradient for the area. When null, the series' color is used with the series' fillOpacity.
     */
    fillColor?: string | ___Highcharts$Gradient,
     ...
     */
    trackByArea?: boolean
} & ___Highcharts$SeriesChart


declare type ___Highcharts$AreaRangeChart = {
     ...
     * @since  2.3.0
     */
    dataLabels?: ___Highcharts$RangeDataLabels
} & ___Highcharts$AreaChart


declare type ___Highcharts$AreaSplineChart = {} & ___Highcharts$AreaChart


declare type ___Highcharts$AreaSplineRangeChart = {} & ___Highcharts$AreaRangeChart


declare type ___Highcharts$BarChart = {
...
maximum).
*/
declare type ___Highcharts$BoxPlotChart = {
...
the Z value.
*/
declare type ___Highcharts$BubbleChart = {
...
declare type ___Highcharts$ColumnChart = {} & ___Highcharts$BarChart
 ...
 */
declare type ___Highcharts$ColumnRangeChart = {
    dataLabels?: ___Highcharts$RangeDataLabels
} & ___Highcharts$ColumnChart
 ...
 */
declare type ___Highcharts$ErrorBarChart = {
 ...
 */
declare type ___Highcharts$FunnelChart = {
     ...
     */
    colors?: string[],
    dataLabels?: ___Highcharts$PieDataLabels,
 ...
 */
declare type ___Highcharts$GaugeChart = {
 ...
 */
declare type ___Highcharts$HeatMapChart = {
...
declare type ___Highcharts$LineChart = {
 ...
 */
declare type ___Highcharts$PieChart = {
...
file.
*/
declare type ___Highcharts$PolygonChart = {
...
declare type ___Highcharts$PyramidChart = {
...
declare type ___Highcharts$ScatterChart = {} & ___Highcharts$SeriesChart
...
itself.
*/
declare type ___Highcharts$SolidGaugeChart = {
...
declare type ___Highcharts$SplineChart = {} & ___Highcharts$SeriesChart
 ...
 */
declare type ___Highcharts$TreeMapChart = {
     ...
     * Set options on specific levels. Takes precedence over series options, but not point options.
     */
    levels?: ___Highcharts$TreeMapLevel[],
...
declare type ___Highcharts$WaterFallChart = {
...
*/
declare interface ___Highcharts$PlotOptions {
    area?: ___Highcharts$AreaChart,
        arearange?: ___Highcharts$AreaRangeChart,
        areaspline?: ___Highcharts$AreaSplineChart,
        areasplinerange?: ___Highcharts$AreaSplineRangeChart,
        bar?: ___Highcharts$BarChart,
        boxplot?: ___Highcharts$BoxPlotChart,
        bubble?: ___Highcharts$BubbleChart,
        column?: ___Highcharts$ColumnChart,
        columnrange?: ___Highcharts$ColumnRangeChart,
        errorbar?: ___Highcharts$ErrorBarChart,
        funnel?: ___Highcharts$FunnelChart,
        gauge?: ___Highcharts$GaugeChart,
        heatmap?: ___Highcharts$HeatMapChart,
        line?: ___Highcharts$LineChart,
        pie?: ___Highcharts$PieChart,
        polygon?: ___Highcharts$PolygonChart,
        pyramid?: ___Highcharts$PyramidChart,
        scatter?: ___Highcharts$ScatterChart,
        series?: ___Highcharts$SeriesChart,
        solidgauge?: ___Highcharts$SolidGaugeChart,
        spline?: ___Highcharts$SplineChart,
        treemap?: ___Highcharts$TreeMapChart,
        waterfall?: ___Highcharts$WaterFallChart
}

declare interface ___Highcharts$IndividualSeriesOptions {
    type?: string,
        ...
        */
        data?: number[] | [number, number][] | [string, number][] | ___Highcharts$DataPoint[],
...
declare type ___Highcharts$SeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$SeriesChart


declare type ___Highcharts$AreaChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$AreaChart


declare type ___Highcharts$AreaRangeChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$AreaRangeChart


declare type ___Highcharts$AreaSplineChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$AreaSplineChart


declare type ___Highcharts$AreaSplineRangeChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$AreaSplineRangeChart


declare type ___Highcharts$BarChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$BarChart


declare type ___Highcharts$BoxPlotChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$BoxPlotChart


declare type ___Highcharts$BubbleChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$BubbleChart


declare type ___Highcharts$ColumnChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$ColumnChart


declare type ___Highcharts$ColumnRangeChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$ColumnRangeChart


declare type ___Highcharts$ErrorBarChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$ErrorBarChart


declare type ___Highcharts$FunnelChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$FunnelChart


declare type ___Highcharts$GaugeChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$GaugeChart


declare type ___Highcharts$HeatMapSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$HeatMapChart


declare type ___Highcharts$LineChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$LineChart


declare type ___Highcharts$PieChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$PieChart


declare type ___Highcharts$PolygonChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$PolygonChart


declare type ___Highcharts$PyramidChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$PyramidChart


declare type ___Highcharts$ScatterChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$ScatterChart


declare type ___Highcharts$SolidGaugeChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$SolidGaugeChart


declare type ___Highcharts$SplineChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$SplineChart


declare type ___Highcharts$TreeMapChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$TreeMapChart


declare type ___Highcharts$WaterFallChartSeriesOptions = {} & ___Highcharts$IndividualSeriesOptions & ___Highcharts$WaterFallChart


declare interface ___Highcharts$DataPoint {
 ...
 */
declare interface ___Highcharts$SubtitleOptions {
...
declare interface ___Highcharts$TitleOptions {
...
declare interface ___Highcharts$CrosshairObject {
    color?: string | ___Highcharts$Gradient,
        width?: number,
        dashStyle?: string,
        zIndex?: number
...
declare interface ___Highcharts$PlotPoint {
    plotX: number,
        plotY: number
}

declare type ___Highcharts$TooltipOptions = {
     ...
     * @default  null
    */
    crosshairs?: boolean | [boolean, boolean] | ___Highcharts$CrosshairObject | [___Highcharts$CrosshairObject, ___Highcharts$CrosshairObject],
    ...
    */
     ...
     */
    useHTML?: boolean
} & ___Highcharts$SeriesTooltipOptions


declare interface ___Highcharts$SeriesTooltipOptions {
...
declare interface ___Highcharts$Options {

    /**
     * Options regarding the chart area and plot area as well as general chart options.
     */
    chart?: ___Highcharts$ChartOptions,
        colorAxis?: ___Highcharts$ColorAxisOptions | ___Highcharts$ColorAxisOptions[],
        ...
        */
         ...
         */
        credits?: ___Highcharts$CreditsOptions,
        ...
        series.data option.
        */
        data?: ___Highcharts$DataOptions,
        ...
        package, or online at code.highcharts.com/modules/drilldown.js.
        */
        drilldown?: ___Highcharts$DrilldownOptions,

        /**
         * Options for the exporting module.
         */
        exporting?: ___Highcharts$ExportingOptions,

        /**
         * HTML labels that can be positioned anywhere in the chart area.
         */
        labels?: ___Highcharts$LabelsOptions,
        lang?: ___Highcharts$LangObject,

        /**
         * The legend is a box containing a symbol and name for each series item or point item in the chart.
         */
        legend?: ___Highcharts$LegendOptions,
        ...
        */
        loading?: ___Highcharts$LoadingOptions,

        /**
         * A collection of options for buttons and menus appearing in the exporting module.
         */
        navigation?: ___Highcharts$NavigationOptions,
         ...
         */
        noData?: ___Highcharts$NoDataOptions,
         ...
         */
        pane?: ___Highcharts$PaneOptions,
        ...
        */
        plotOptions?: ___Highcharts$PlotOptions,
        ...
        */
         ...
         * The chart's subtitle
         */
        subtitle?: ___Highcharts$SubtitleOptions,

        /**
         * The chart's main title.
         */
        title?: ___Highcharts$TitleOptions,

        /**
         * Options for the tooltip that appears when the user hovers over a series or point.
         */
        tooltip?: ___Highcharts$TooltipOptions,
         ...
         */
        xAxis?: ___Highcharts$AxisOptions[] | ___Highcharts$AxisOptions,
         ...
         */
        yAxis?: ___Highcharts$AxisOptions[] | ___Highcharts$AxisOptions
}

declare type ___Highcharts$GlobalOptions = {

    /**
     * Global options that don't apply to each chart. These options, like the lang options, must be set using the
     * Highcharts.setOptions method.
     */
    global?: ___Highcharts$GlobalObject,
     ...
     */
    lang?: ___Highcharts$LangObject
} & ___Highcharts$Options


declare interface ___Highcharts$DateFormatSpecifiers {
...
*/
declare interface ___Highcharts$AxisObject {

    /**
     * Add a plot band after render time.
     * @param  A configuration object consisting of the same members as options.xAxis.plotBands
     * @since  1.2.0
     */
    addPlotBand(options: ___Highcharts$PlotBands): void,

        /**
         * Add a plot line after render time.
         * @param  A configuration object consisting of the same members as options.xAxis.plotLines
         * @since  1.2.0
         */
        addPlotLine(options: ___Highcharts$PlotLines): void,

        /**
         * Get the current extremes for the axis.
         * @since  1.2.0
         */
        getExtremes(): ___Highcharts$Extremes,
         ...
         * @param  The plot band's id as given in the original configuration object or in the addPlotBand method.
         * @since  1.2.0
         */
         ...
         * @param  The plot line's id as given in the original configuration object or in the addPlotLine method.
         * @since  1.2.0
         */
         ...
         * @param  The new category names.
         * @param  Whether to redraw the axis or wait for an explicit call to chart.redraw().
         * @since  1.2.0
         */
         ...
         * @param  Whether to redraw the chart or wait for an explicit call to chart.redraw().
         * @param  When true, the resize will be animated with default animation options. The animation can also be a configuration object with properties duration and easing.
         * @since  1.2.0
        */
        setExtremes(
            min?: number,
         ...
         * @param  The new title options on the same format as given in xAxis.title.
         * @param  Whether to redraw the chart now or hold until the next chart.redraw()
         * @since  2.2
         */
        setTitle(title: ___Highcharts$AxisTitle, redraw?: boolean): void,

        /**
         * Translates a value in terms of axis units in to pixels within the chart.
         * @param  A value in terms of axis units.
         * @param  Whether to return the pixel coordinate relative to the chart or just the axis/pane itself.
         * @return  * 
         * @since  3.0
         */
         ...
         * @param  A pixel position along the axis.
         * @param  Whether the input pixel position is relative to the chart or just the axis/pane itself.
         * @return  * 
         * @since  3.0
         */
         ...
         * @param  The new options that will be merged in with existing options on the axis.
         * @param  Defaults to true. Whether to redraw the chart after the new options are set.
         * @since  3.0
         */
        update(options: ___Highcharts$AxisOptions, redraw?: boolean): void
}
...
declare interface ___Highcharts$ChartObject {
     ...
     * @param  The Axis options, as documented under xAxis and yAxis.
    ...
    */
    addAxis(
            options: ___Highcharts$AxisOptions,
            isX?: boolean,
            redraw?: boolean,
            animation?: boolean | ___Highcharts$Animation): ___Highcharts$AxisObject,
         ...
         * @param  The series options, as documented under plotOptions.series and under the plotOptions for each series type.
        ...
        */
        addSeries<T>(
            options: T,
            redraw?: boolean,
            animation?: boolean | ___Highcharts$Animation): ___Highcharts$SeriesObject,
         ...
         * @param  The existing Point object from which the drilldown will start.
         * @param  The series options, as documented under plotOptions.series and under the plotOptions for each series type.
         * @since  3.0.8
        */
        addSeriesAsDrilldown(
            point: ___Highcharts$PointObject,
            seriesOptions: ___Highcharts$IndividualSeriesOptions): void,
         ...
         * Export the chart to a PNG or SVG without sending it to a server. Requires
         * modules/exporting.js and modules/offline-exporting.js.
         * @param  Exporting options. Same as
        the exportChart params.
         * @since  2.0
        */
        exportChartLocal(options: ___Highcharts$ExportingOptions): void,
         ...
         * @param  Exporting options. Same as
        the exportChart params.
         * @param  Additional chart options for the
        ...
        */
         ...
         * @param  The id of the axis, series or point to get.
         * @return  * 
         * @since  1.2.0
         */
        get(
            id: string): ___Highcharts$AxisObject | ___Highcharts$SeriesObject | ___Highcharts$PointObject,

        /**
         * Exporting module required. Get an SVG string representing the chart.
         * @param  Chart options to add to the exported chart in addition to the options given for the original chart. For example if series.lineWidth should be greater in the exported chart than in the original, or the chart should have a different background color, this is added here.
         * @return  * 
         * @since  2.0
         */
        getSVG(additionalOptions?: ___Highcharts$Options): string,
         ...
         * @since  1.2.0
         */
        getSelectedPoints(): ___Highcharts$PointObject[],
         ...
         * @since  1.2.0
         */
        getSelectedSeries(): ___Highcharts$SeriesObject[],
         ...
         * @since  1.2.0
        */
        redraw(animation?: boolean | ___Highcharts$Animation): void,
        ...
        */
         ...
         * @since  1.2.0
         */
        series: ___Highcharts$SeriesObject[],

        /**
         * Resize the chart to a given width and height.
         * @param  The new pixel width of the chart.
         * @param  The new pixel height of the chart.
         * @param  Defaults to true. When true, the resize will be animated with default animation options. The animation can also be a configuration object with properties duration and easing.
         */
        setSize(
            width: number,
            height: number,
            animation?: boolean | ___Highcharts$Animation): void,

        /**
         * Set a new title or subtitle for the chart
         * @param  A configuration object for the new title as defined at #title.
         ...
         * @param  A configuration object for the new chart options as defined in the options section of the API.
         * @param boolean redraw Whether to redraw the chart. Defaults to true.
         * @since  5.0.0
        */
        update(options: ___Highcharts$ChartOptions, redraw?: boolean): void,
         ...
         * @since  1.2.0
         */
        xAxis: ___Highcharts$AxisObject[],

        /**
         * An array of the chart's y axes. If only one y axis, it is referenced by chart.yAxis[0].
         * @since  1.2.0
         */
        yAxis: ___Highcharts$AxisObject[],
        renderer: ___Highcharts$RendererObject
}

declare interface ___Highcharts$Chart {

    /**
     * This is the constructor for creating a new chart object.
     * @param  The chart options
     * @return  
     */
    new(options: ___Highcharts$Options): ___Highcharts$ChartObject,
    ...
    new(
        options: ___Highcharts$Options,
        callback: (chart: ___Highcharts$ChartObject) => void): ___Highcharts$ChartObject,

    /**
     * This is the constructor for creating a new chart object.
     * @param  The id or a reference to a DOM element where the chart should be rendered (since v4.2.0).
     * @param  The chart options
     * @return  
     */
    new(
        renderTo: string | HTMLElement,
        options: ___Highcharts$Options): ___Highcharts$ChartObject,
...
*/
declare interface ___Highcharts$ElementObject {

    /**
     * Add the element to the renderer canvas.
     * @param  The element can be added to a g (group) element.
     * @return  * 
     * @since  2.0
     */
    add(parent?: ___Highcharts$ElementObject): ___Highcharts$ElementObject,

        /**
         * Apply numeric attributes to the SVG/VML element by animation. See Element.attr() for more information on setting
         * attributes.
         * @param  A set of attributes to apply.
         * @param  Optional animation parameters that are passed over to jQuery or other framework. Valid properties depend on the library, but options like duration, easing and complete are supported by jQuery.
         * @return  * 
         * @since  2.0
         */
        animate(attributes: any, animation?: any): ___Highcharts$ElementObject,
         ...
         * @since  2.0
        */
        attr(hash: any): ___Highcharts$ElementObject,

        /**
         * Apply some CSS properties to the element
         * @param  The object literal of CSS properties to apply. Properties should be hyphenated, not camelCased.
         * @return  * 
         * @since  2.0
         */
        css(hash: Object): ___Highcharts$ElementObject,
         ...
         * @param  The event type to attach, for example 'click', 'mouseover', 'touch'.
         * @param handler The event handler function.
         * @return  * 
         * @since  2.0
         */
        on(eventType: string, handler: () => void): ___Highcharts$ElementObject,
         ...
         * @since  2.0
         */
        toFront(): ___Highcharts$ElementObject
}
...
*/
declare interface ___Highcharts$RendererObject {

    /**
     * Draw an arc on the renderer canvas.
     * @param  The x position of the arc's center in the SVG element.
     * @param  The y position of the arc's center in the SVG element.
     * @param  The outer radius of the arc.
     * @param  The inner radius of the arc.
     * @param  The starting angle of the arc in radians, where 0 is to the right and -Math.PI/2 is up.
     * @param  The ending angle of the arc in radians, where 0 is to the right and -Math.PI/2 is up.
     * @return  * 
     * @since  2.0
     */
    arc(
            ...
            innerRadius: number,
            start: number,
            end: number): ___Highcharts$ElementObject,

        /**
         * Draw circle on the renderer canvas.
         * @param  The x position of the circle's center in the SVG element.
         * @param  The y position of the circle's center in the SVG element.
         * @param  [description]
         * @return  * 
         * @since  2.0
         */
        circle(centerX: number, centerY: number, radius: number): ___Highcharts$ElementObject,
         ...
         * @since  2.0
         */
        g(name?: string): ___Highcharts$ElementObject,

        /**
         * Add an image from an external resource.
         * @param  The URL of the image.
         * @param  The x position of the image's upper left corner.
         * @param  The y position of the image's upper left corner.
        ...
        image(
            ...
            y: number,
            width: number,
            height: number): ___Highcharts$ElementObject,
        ...
        add.
         * @param  The text or HTML to draw
         * @param  The x position of the label's left side.
         * @param  The y position of the label's top side or baseline, depending on the baseline parameter.
        ...
        */
        label(
            ...
            useHTML?: boolean,
            baseline?: boolean,
            className?: string): ___Highcharts$ElementObject,
         ...
         * @param  An SVG path split up in array form.
         * @return  
         */
        path(path: [string | number]): ___Highcharts$ElementObject,

        /**
         * Add a rectangle.
         * @param  The x position of the rectangle's upper left corner.
         * @param  The y position of the rectangle's upper left corner.
         * @param  The width of the rectangle.
         * @param  The height of the rectangle.
         * @param  The corner radius of all the rectangle's corners.
         * @return  * 
         * @since  2.0
         */
        rect(
            ...
            width: number,
            height: number,
            cornerRadius: number): ___Highcharts$ElementObject,
         ...
         * @param  The text or HTML to draw
         * @param  The x position of the text's lower left corner.
         * @param  The y position of the text's lower left corner.
         * @return  * 
         * @since  2.0
         */
        text(str: string, x: number, y: number): ___Highcharts$ElementObject
}

declare interface ___Highcharts$Renderer {
    new(
        parentNode: HTMLElement,
        width: number,
        height: number): ___Highcharts$RendererObject
}

declare interface ___Highcharts$Static {
    Chart: ___Highcharts$Chart,
        Renderer: ___Highcharts$Renderer,
        Color(color: string | ___Highcharts$Gradient): string | ___Highcharts$Gradient,
         ...
         * @since  2.3.4
         */
        charts: ___Highcharts$ChartObject[],
         ...
         * @param  A string containing some of the formats.
        ...
        */
        ...
        of the date.
        */
        dateFormats: ___Highcharts$DateFormatSpecifiers,
         ...
         * @param  The raw number to format.
         * @param  The desired number of decimals.
         * @param  The decimal point. Defaults to '.' or to the string specified globally in options.lang.decimalPoint.
         * @param  The thousands separator. Defaults to ' ' or to the string specified globally in options.lang.thousandsSep.
         * @return  
         */
        numberFormat(
            value: number,
         ...
         * @return  
         */
        setOptions(options: ___Highcharts$GlobalOptions): ___Highcharts$Options,

        /**
         * Get the updated default options. Until 3.0.7, merely exposing defaultOptions for outside modules
         * wasn't enough because the setOptions method created a new object.
         */
        getOptions(): ___Highcharts$Options,
...
*/
declare interface ___Highcharts$PointObject {
    ...
    category: string | number,
         ...
         * @since  1.2.0
         */
        remove(redraw?: boolean, animation?: boolean | ___Highcharts$Animation): void,
         ...
         * @param  Defaults to true. When true, the update will be animated with default animation options. The animation can also be a configuration object with properties duration and easing.
         * @since  1.2.0
         */
        update(
            options: number | [number, number] | ___Highcharts$DataPoint,
            redraw?: boolean,
            animation?: boolean | ___Highcharts$Animation): void,
...
for example plotOptions.line. Next, options for one single series are given in the series array.
*/
declare interface ___Highcharts$SeriesObject {

    /**
     * Add a point to the series after render time. The point can be added at the end, or by giving it an X value, to
     * the start or in the middle of the series.(boolean|Animation)=false] animation - When shift is true, one point is shifted off the start of the series as one is appended to the end. Use this option for live charts monitoring a value over time.
     * @param  point options. If options is a single number, a point with that y value is appended to the series.If it is an array, it will be interpreted as x and y values respectively. If it is an object, advanced options as outlined under series.data are applied.
     * @param boolean redraw - Whether to redraw the chart after the point is added. When adding more than one point, it is highly recommended that the redraw option be set to false, and instead chart.redraw() is explicitly called after the adding of points is finished.
     * @param boolean shift - When shift is true, one point is shifted off the start of the series as one is appended to the end. Use this option for live charts monitoring a value over time.
     * @since  1.2.0
     */
    addPoint(
            options: number | [number, number] | ___Highcharts$DataPoint,
         ...
         * @since  1.2.0
         */
        chart: ___Highcharts$ChartObject,

        /**
         * Read only. An array with the series' data point objects.
         * @since  1.2.0
         */
        data: ___Highcharts$PointObject[],
         ...
         * @since  1.2.0
         */
        options: ___Highcharts$IndividualSeriesOptions,

        /**
         * Remove the series from the chart.
         * @param boolean redraw - Whether to redraw the chart after the series is removed.If doing more operations on the chart, it is a good idea to set redraw to false and call chart.redraw() after.
         * @since  1.2.0
         */
        remove(redraw?: boolean): void,
         ...
         * @param  - The index of the point in the data array.
         * @param boolean redraw - Whether to redraw the chart after the point is added. When adding more than one point, it is highly recommended that the redraw option be set to false, and instead chart.redraw() is explicitly called after the adding of points is finished.
         ...
         * @param  - Takes an array of data in the same format as described under series<type>data for the given series type.
         ...
         */
        setData(
            data: number[] | number[][] | ___Highcharts$DataPoint[],
            redraw?: boolean,
            animation?: boolean | ___Highcharts$Animation,
         ...
         * @param  New options that will be merged into the series' existing options.
         * @param boolean redraw - Whether to redraw the chart after the series is altered. If doing more operations on the chart, it is a good idea to set redraw to false and call chart.redraw() after.
         * @since  1.2.0
        */
        update(options: ___Highcharts$IndividualSeriesOptions, redraw?: boolean): void,
