import type { FusionChartStatic } from 'npm$namespace$FusionCharts'

declare module 'fusioncharts' {
					
}

declare module 'npm$namespace$FusionCharts' {
	declare type ChartDataFormats = "json" | "jsonurl" | "csv" | "xml" | "xmlurl";

	declare type ImageHAlign = "left" | "right" | "middle";

	declare type ImageVAlign = "top" | "bottom" | "middle";
	...
	declare interface FusionCharts {
		clone(overrides?: {
		
	}, argsOnly?: boolean): any,
		isActive(): boolean,
		chartType(value?: string, options?: any): string,
		addEventListener(
		type: string | string[], listener: (eventObject?: EventObject, eventArgs?: {
		...
		centerLabel(labelText: string, options?: {
		...
		getDataAsCSV(): any,
		render(
		containerElement?: string | Element, insertMode?: string, callback?: () => any
	): FusionCharts,
	...
	declare interface FusionChartStatic {
		new (chartObject: ChartObject | {
		...
		ready(
		callback: (fusionChartStatic?: FusionChartStatic) => any, context?: any
	): FusionChartStatic,
		transcodeData(
		data: string | {
		
	}, source: ChartDataFormats, target: ChartDataFormats, advanced: boolean
	): any,
		batchExport(options: {
		
	}): void,
		formatNumber(num: number, type?: string, config?: {
...
declare module 'FusionCharts' {
					declare module.exports: FusionChartStatic
