// @flow
/**
 * Flowtype definitions for fs-extra-promise
...
declare module 'fs-extra-promise' {
    ...
    declare     export function write(
        ...
        length: number,
        position: number,
        callback?: (err: Error, written: number, buffer: NodeBuffer) => void): void
    ...
    declare     export function read(
        ...
        length: number,
        position: number,
        callback?: (err: Error, bytesRead: number, buffer: NodeBuffer) => void): void
    ...
    declare     export function copyAsync(src: string, dest: string): Promise<void >
        ...
        offset: number,
        length: number,
        position: number): Promise<[number, NodeBuffer] >
