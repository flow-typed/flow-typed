// @flow
/**
 * Flowtype definitions for dojox.atom
...
*/
declare interface model$_actions {
...
*/
declare interface model$_Constants {
...
*/
declare class FeedEntryEditor mixins undefined.FeedEntryViewer {
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class FeedViewer mixins dijit._Widget, dijit._Templated, dijit._Container {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class FeedViewerEntry mixins dijit._Widget, dijit._Templated {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class FeedViewerGrouping mixins dijit._Widget, dijit._Templated {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class FeedEntryViewer mixins dijit._Widget, dijit._Templated, dijit._Container {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class EntryHeader mixins dijit._Widget, dijit._Templated, dijit._Container {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
