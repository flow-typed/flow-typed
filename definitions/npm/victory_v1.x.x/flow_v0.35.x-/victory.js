// @flow
/**
 * Flowtype definitions for victory
...
declare module 'victory' {
    ...
    declare     export type AnimationEasing = "back" |
        "backIn" |
        "backOut" |
        "backInOut" |
        "bounce" |
     ...
     */
    declare     export class VictoryAnimation mixins React.Component<VictoryAnimationProps, any>{}
     ...
     */
    declare     export class VictoryLabel mixins React.Component<VictoryLabelProps, any>{}
    ...
    declare     export class VictoryContainer mixins React.Component<VictoryContainerProps, any>{}
    ...
    declare     export var VictoryTheme: VictoryThemeInterface;
    ...
    declare     export interface EventPropTypeInterface<TTarget, TEventKey>{
        ...
        */
        ...
        eventHandlers: {
            [key: string]: {
                (event: React.SyntheticEvent): EventCallbackInterface<TTarget,
                TEventKey >
            } | {
                (event: React.SyntheticEvent): EventCallbackInterface<TTarget,
                TEventKey>[]
    ...
    declare type InterpolationPropType = "basis" |
        "basisClosed" |
        "basisOpen" |
        "bundle" |
        "cardinal" |
        ...
        "stepAfter" |
        "stepBefore";
    declare type ColorScalePropType = "greyscale" |
        "qualitative" |
        "heatmap" |
        "warm" |
        "cool" |
    ...
    declare type VictoryMultiLabeableProps = {
    ...
    declare type VictorySingleLabableProps = {
    ...
    declare     export type VictoryAreaProps = {
        ...
        */
        events?: EventPropTypeInterface<"data" | "labels" | "parent",
        "all">[],
        ...
        */
        style?: VictoryStyleInterface
    } & VictoryCommonProps & VictoryDatableProps & VictorySingleLabableProps
     ...
     */
    declare     export class VictoryArea mixins React.Component<VictoryAreaProps, any>{}
    declare     export type VictoryAxisProps = {
        ...
        */
        events?: EventPropTypeInterface<"axis" |
            "axisLabel" |
            "grid" |
            "ticks" |
            "tickLabels" |
    ...
    */
    declare     export class VictoryAxis mixins React.Component<VictoryAxisProps, any>{}
    declare     export type VictoryBarProps = {
        ...
        */
        style?: VictoryStyleInterface
    } & VictoryCommonProps & VictoryDatableProps & VictoryMultiLabeableProps
     ...
     */
    declare     export class VictoryBar mixins React.Component<VictoryBarProps, any>{}
    declare     export type VictoryChartProps = {
        ...
        */
        events?: EventPropTypeInterface<string,
    ...
    - VictoryBar
    */
    declare     export class VictoryChart mixins React.Component<VictoryChartProps, any>{}
    declare     export type VictoryGroupProps = {
        ...
        */
         ...
         */
        style?: VictoryStyleInterface
    } & VictoryCommonProps & VictoryMultiLabeableProps

    declare     export class VictoryGroup mixins React.Component<VictoryGroupProps, any>{}
    declare     export type VictoryLineProps = {
     ...
     */
    declare     export class VictoryLine mixins React.Component<VictoryLineProps, any>{}
    declare type ScatterSymbolType = "circle" |
        "diamond" |
        "plus" |
        "square" |
        "star" |
        "triangleDown" |
        "triangleUp";
    declare     export type VictoryScatterProps = {
     ...
     */
    declare     export class VictoryScatter mixins React.Component<VictoryScatterProps, any>{}
    declare     export type VictoryStackProps = {
    ...
    declare     export class VictoryStack mixins React.Component<VictoryStackProps, any>{}
    declare     export type VictoryPieProps = {
    ...
    Data changes are animated with VictoryAnimation.
    */
    declare     export class VictoryPie mixins React.Component<VictoryPieProps, any>{}
}