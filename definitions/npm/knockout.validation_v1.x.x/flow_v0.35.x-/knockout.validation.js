// @flow
/**
 * Flowtype definitions for knockout.validation
...
declare interface KnockoutValidationStatic {
    init(options?: KnockoutValidationConfiguration, force?: boolean): void,
        ...
        addRule<T>(
            ...
            rule: KnockoutValidationRule): KnockoutObservable<T>,
        addAnonymousRule(
            observable: KnockoutObservable<any>,
            ruleObj: KnockoutValidationAnonymousRuleDefinition): void,
        ...
        defineLocale(
            newLocale: string,
            msgTranslations: KnockoutValidationLocalizationDictionary): KnockoutValidationLocalizationDictionary,
...
declare interface KnockoutStatic {
    validation: KnockoutValidationStatic,
        ...
        applyBindingsWithValidation(
            viewModel: any,
            rootNode?: any,
            options?: KnockoutValidationConfiguration): void
}
