/**
 * Flowtype definitions for paper
...
declare module 'paper' {
    ...
    declare export var project: Project;
    declare export var projects: Project[];
    declare export var view: View;
    declare export var tool: Tool;
    declare export var tools: Tool[];
    ...
    */
     ...
     */
    declare export class Group mixins Item {
    ...
    */
    declare export class Layer mixins Group {
    ...
    declare export class Shape mixins Item {
     ...
     */
    declare export class Raster mixins Item {
     ...
     */
    declare export class PlacedSymbol mixins Item {
     ...
     */
    declare export class PathItem mixins Item {
        ...
        /**
         * Subtracts the geometry of the specified path from this path's geometry and returns the result as a new path item.- the path to subtract
         */
        subtract(path: PathItem): PathItem;

        /**
         * Excludes the intersection of the geometry of the specified path with this path's geometry and returns the result as a new group item.- the path to exclude the intersection of
         */
        exclude(path: PathItem): PathItem;

        /**
         * Splits the geometry of this path along the geometry of the specified path returns the result as a new group item.- the path to divide by
         */
     ...
     */
    declare export class Path mixins PathItem {
     ...
     */
    declare export class CompoundPath mixins PathItem {
    ...
    declare export class Curve {
        ...
        /**
         * TODO?Divides the curve into two curves at the given offset. The curve itself is modified and becomes the first part, the second part is returned as a new curve. If the modified curve belongs to a path item, the second part is also added to the path.
    ...
    */
     ...
     */
    declare export class ToolEvent mixins Event {
     ...
     */
    declare export class KeyEvent mixins Event {
     ...
     */
    declare export class TextItem mixins Item {
     ...
     */
    declare export class PointText mixins TextItem {
