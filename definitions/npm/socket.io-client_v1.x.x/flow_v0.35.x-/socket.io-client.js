// @flow
/**
 * Flowtype definitions for socket.io-client
 ...
 */
declare interface SocketIOClient$Emitter {
 ...
 */
declare interface SocketIOClient$SocketStatic {
 ...
 */
declare type SocketIOClient$Socket = {
 ...
 */
declare interface SocketIOClient$ManagerStatic {
 ...
 */
declare type SocketIOClient$Manager = {
     ...
     * @return  This Manager
     */
    reconnection(v: boolean): SocketIOClient$Manager,
     ...
     * @return  This Manager
     */
    reconnectionAttempts(v: number): SocketIOClient$Manager,
     ...
     * @return  This Manager
     */
    reconnectionDelay(v: number): SocketIOClient$Manager,
     ...
     * @return  This Manager
     */
    reconnectionDelayMax(v: number): SocketIOClient$Manager,
     ...
     * @return  This Manager
     */
    randomizationFactor(v: number): SocketIOClient$Manager,
     ...
     * @return  This Manager
     */
    timeout(v: boolean): SocketIOClient$Manager,
     ...
     * @return  This Manager
    */
    open(fn?: (err?: any) => void): SocketIOClient$Manager,

    /**
     * 
     * @see  open( fn );
     */
    connect(fn?: (err?: any) => void): SocketIOClient$Manager,
 ...
 */
declare interface SocketIOClient$ConnectOpts {
