// @flow
/**
 * Flowtype definitions for dynatable
...
declare interface JQueryDynatable$Features {
...
declare interface JQueryDynatable$Column {
    index: number,
        label: string,

        /**
         * Determined by the `data-dynatable-column` or using the `defaultColumnIdStyle`
         * @example  * // Using the `defaultColumnIdStyle` of `camelCase`
        ...
        */
         ...
         * @example  * function exampleAttributeWriter(record) {
        ...
        */
         ...
         * @example  * function exampleAttributeReader(cell, record) {
        return $(cell).html();
        };
        */
...
declare interface JQueryDynatable$Table {
     ...
     * @example  * // Given the html `<th>Favorite Music</th>` column header
...
declare interface JQueryDynatable$Inputs {
...
declare interface JQueryDynatable$Dataset {
...
declare interface JQueryDynatable$Writers {
     ...
     * @example  * function exampleRowWriter(rowIndex, record, columns, cellWriter) {
    var tr = '';
    ...
    */
    _rowWriter?: (
         ...
         * @example  * function exampleCellWriter(column, record) {
        ...
        */
        _cellWriter?: (column: JQueryDynatable$Column, record: any) => string,
...
declare interface JQueryDynatable$Readers {
     ...
     * @default  null
     * @example  * function exampleRowReader(index, this, record) {
    //...
    };
    */
...
declare interface JQueryDynatable$Params {
...
declare interface JQueryDynatable$Options {
    features?: JQueryDynatable$Features,
        table?: JQueryDynatable$Table,
        inputs?: JQueryDynatable$Inputs,
        dataset?: JQueryDynatable$Dataset,
        writers?: JQueryDynatable$Writers,
        readers?: JQueryDynatable$Readers,
        params?: JQueryDynatable$Params
}

declare interface JQueryDynatable$DOM {
...
declare interface JQueryDynatable$DOMColumns {
...
declare interface JQueryDynatable$InputsSearch {
...
declare interface JQueryDynatable$PaginationLinks {
...
declare interface JQueryDynatable$PaginationPage {
...
declare interface JQueryDynatable$PaginationPerPage {
...
declare interface JQueryDynatable$ProcessingIndicator {
...
declare interface JQueryDynatable$Queries {
     ...
     */
    add(name: string, value: any): JQueryDynatable$Dynatable,

        /**
         * functions object for Queries 
         */
        functions: JQueryDynatable$QueriesFunctions,
         ...
         * @return  A reference to the related Dynatable object
         */
        remove(name: string): JQueryDynatable$Dynatable,
...
declare interface JQueryDynatable$QueriesFunctions {
...
declare interface JQueryDynatable$Records {
...
declare interface JQueryDynatable$RecordsCount {
...
declare interface JQueryDynatable$Settings {
    dataset: JQueryDynatable$Dataset,
        features: JQueryDynatable$Features,
        inputs: JQueryDynatable$Inputs,
        params: JQueryDynatable$Params,
...
declare interface JQueryDynatable$Sorts {
     ...
     * @return  A reference to the related Dynatable object
     */
    add(attr: string, direction: number): JQueryDynatable$Dynatable,
         ...
         */
        functions: JQueryDynatable$SortsFunctions,
         ...
         * @return  A reference to the related Dynatable object
         */
        remove(attr: string): JQueryDynatable$Dynatable
}

declare interface JQueryDynatable$SortsFunctions {
...
declare interface JQueryDynatable$SortsHeaders {
    ...
    appendArrowDown($link: JQuery): void,
         ...
         */
        sortedByColumn($link: JQuery, column: JQueryDynatable$Column): boolean,
         ...
         */
        sortedByColumnValue(column: JQueryDynatable$Column): number,
         ...
         */
        toggleSort(e: Event, $link: JQuery, column: JQueryDynatable$Column): void
}

declare interface JQueryDynatable$State {
...
declare interface JQueryDynatable$Dynatable {
     ...
     */
    init(element: Element, options: JQueryDynatable$Options): JQueryDynatable$Dynatable,
         ...
         * The `dom` API 
         */
        dom: JQueryDynatable$DOM,

        /**
         * The `domColumns` API 
         */
        domColumns: JQueryDynatable$DOMColumns,
         ...
         */
        inputsSearch: JQueryDynatable$InputsSearch,

        /**
         * The `paginationLinks` API 
         */
        paginationLinks: JQueryDynatable$PaginationLinks,

        /**
         * The `paginationPage` API 
         */
        paginationPage: JQueryDynatable$PaginationPage,

        /**
         * The `paginationPerPage` API 
         */
        paginationPerPage: JQueryDynatable$PaginationPerPage,

        /**
         * The `processingIndicator` API 
         */
        processingIndicator: JQueryDynatable$ProcessingIndicator,

        /**
         * The `queries` API 
         */
        queries: JQueryDynatable$Queries,

        /**
         * The `records` API 
         */
        records: JQueryDynatable$Records,

        /**
         * The `recordsCount` API 
         */
        recordsCount: JQueryDynatable$RecordsCount,

        /**
         * The `settings` API 
         */
        settings: JQueryDynatable$Settings,

        /**
         * The `sorts` API 
         */
        sorts: JQueryDynatable$Sorts,

        /**
         * The `sortsHeaders` API 
         */
        sortsHeaders: JQueryDynatable$SortsHeaders,

        /**
         * The `state` API 
         */
        state: JQueryDynatable$State
}