...
declare module 'qtip2' {
		...
		qtip(
		methodName: "option", propertyName: "content.button"
		...
		qtip(
		methodName: "option", propertyName: "show.effect"
		...
		qtip(
		methodName: "option", propertyName: "hide.effect"
	): boolean | ((offset: any) => void),
		...
		qtip(
		methodName: "option", propertyName: "content", value: QTip2.Text | QTip2.Content
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "content.title", value: QTip2.Title | {
		text: QTip2.Title
	}
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "content.text", value: QTip2.Text
	): QTip2.Api,
		qtip(methodName: "option", propertyName: "content.attr", value: string): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "content.button", value: string | JQuery | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "position", value: QTip2.Position
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "position.my", value: string | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "position.at", value: string | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "position.target", value: QTip2.Target | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "position.container", value: JQuery | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "position.viewport", value: JQuery | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "position.effect", value: boolean | ((api: QTip2.Api, pos: any, viewport: any) => void)
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "position.adjust", value: QTip2.PositionAdjust
	): QTip2.Api,
		qtip(methodName: "option", propertyName: "show", value: QTip2.Show): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "show.target", value: JQuery | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "show.event", value: string | boolean
	): QTip2.Api,
		qtip(methodName: "option", propertyName: "show.delay", value: number): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "show.solo", value: JQuery | string | boolean
	): QTip2.Api,
		qtip(methodName: "option", propertyName: "show.ready", value: boolean): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "show.effect", value: boolean | ((offset: any) => void)
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "show.modal", value: boolean | QTip2.Modal
	): QTip2.Api,
		qtip(methodName: "option", propertyName: "hide", value: QTip2.Hide): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "hide.target", value: JQuery | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "hide.event", value: string | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "hide.inactive", value: number | boolean
	): QTip2.Api,
		qtip(methodName: "option", propertyName: "hide.fixed", value: boolean): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "hide.leave", value: string | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "hide.distance", value: number | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "hide.effect", value: boolean | ((offset: any) => void)
	): QTip2.Api,
		qtip(methodName: "option", propertyName: "style", value: QTip2.Style): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "style.classes", value: string | boolean
	): QTip2.Api,
		...
		qtip(
		methodName: "option", propertyName: "style.width", value: string | number | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "style.height", value: string | number | boolean
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "style.tip", value: string | boolean | QTip2.Tip
	): QTip2.Api,
		qtip(methodName: "option", propertyName: "events", value: QTip2.Events): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "events.render", value: QTip2.EventApiFunc
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "events.show", value: QTip2.EventApiFunc
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "events.hide", value: QTip2.EventApiFunc
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "events.toggle", value: QTip2.EventApiFunc
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "events.visible", value: QTip2.EventApiFunc
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "events.hidden", value: QTip2.EventApiFunc
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "events.move", value: QTip2.EventApiFunc
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "events.focus", value: QTip2.EventApiFunc
	): QTip2.Api,
		qtip(
		methodName: "option", propertyName: "events.blur", value: QTip2.EventApiFunc
	): QTip2.Api,
...
declare module 'npm$namespace$QTip2' {
	declare type EventApiFunc = (event: Event, api: Api) => void;

	declare type Title = string | JQuery | EventApiFunc | boolean | JQueryGenericPromise<any>;

	declare type Text = string | JQuery | EventApiFunc | boolean | JQueryGenericPromise<any>;

	declare type Target = JQuery | number[] | string;
	...
	declare interface PositionAdjust {
		x?: number,
		y?: number,
		mouse?: boolean,
		resize?: boolean,
	...
	declare interface Api {
		...
		set(propertyName: "content.title", value: Title | {
		text: Title
	}): Api,
		...
		set(
		propertyName: "position.effect", value: boolean | ((api: Api, pos: any, viewport: any) => void)
	): Api,
