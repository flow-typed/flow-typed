...
/**
 * These TypeScript delcarations for ChocolateChip-UI contain interfaces for both ChocolateChipJS and jQuery. Depending on which library you are using, you will get the type interfaces appropriate for it.Interface for ChocolateChipJS.
 */
...
declare interface JQueryStatic {
    ...
    concat(...string: string[]): string,
        ...
        /**
         * Create a segmented control: {id: "mySegments", className: "seggie", labels: ["one", "two","three"], selected: 1}: options UICreateSegmentedOptions
         * @return  JQuery
         */
        UICreateSegmented(
            options: {
...
declare interface JQuery {
    ...
    forEach(callback: (ctx: HTMLElement, idx: number) => any): JQuery,
        ...
        trigger(
            eventType: string | ChUIEventInterface,
            extraParameters?: any[] | Object): JQuery,
         ...
         */
        undelegate(
            selector: string | ChUIEventInterface,
            eventType: string,
            handler?: (eventObject: JQueryEventObject) => any): JQuery,
 ...
 */
declare type BaseJQueryEventObject = {} & Event
declare type JQueryEventObject = {} & BaseJQueryEventObject & JQueryInputEventObject & JQueryMouseEventObject & JQueryKeyEventObject
declare type JQueryInputEventObject = {} & BaseJQueryEventObject
declare type JQueryMouseEventObject = {} & JQueryInputEventObject
declare type JQueryKeyEventObject = {} & JQueryInputEventObject