// @flow
/**
 * Flowtype definitions for blessed
...
declare module 'blessed' {
    ...
    declare module 'Widgets' {
        ...
        declare         export type TputsOptions = {
            terminal?: string,
            extended?: boolean,
            debug?: boolean,
            termcap?: string,
        ...
        declare         export class Tput mixins IHasOptions<TputsOptions>{
        ...
        declare         export type INodeOptions = {
            name?: string,
            screen?: Screen,
            parent?: Node,
            children?: Node[],
        ...
        declare         export class Node mixins EventEmitter, IHasOptions<INodeOptions>, IDestroyable {
        ...
        declare         export class NodeWithEvents mixins Node {
            ...
            on(
                event: "keypress",
                callback: (ch: string, key: Events.IKeyEventArg) => void): this;
            ...
            /**
             * Received on key event for [name].Received when the terminal window focuses/blurs. Requires a terminal supporting the 
        ...
        declare         export type IScreenOptions = {
        ...
        declare         export class Screen mixins NodeWithEvents, IHasOptions<IScreenOptions>{
            ...
            */
            ...
            spawn(
                file: string,
                args: string[],
                options: NodeChildProcessExecOptions): child_process.ChildProcess;
            ...
            exec(
                ...
                callback: Function): child_process.ChildProcess;
        ...
        declare         export type ElementOptions = {
            tags?: boolean,
            fg?: string,
            bg?: string,
            bold?: string,
        ...
        declare         export class BlessedElement mixins NodeWithEvents, IHasOptions<ElementOptions>{
        ...
        declare         export type ScrollableBoxOptions = {
        ...
        declare         export type ScrollableTextOptions = {
        ...
        declare         export type BoxOptions = {
            bindings?: any
         ...
         */
        declare         export class ScrollableBoxElement mixins BlessedElement {
        ...
        */
        declare         export class ScrollableTextElement mixins ScrollableBoxElement {}

        /**
         * A box element which draws a simple box containing content or other elements.
         */
        declare         export class BoxElement mixins ScrollableTextElement, IHasOptions<BoxOptions>{
        ...
        declare         export type TextOptions = {
         ...
         */
        declare         export class TextElement mixins BlessedElement, IHasOptions<TextOptions>{
         ...
         */
        declare         export type LineOptions = {
         ...
         * A simple line which can be line or bg styled.
         */
        declare         export class LineElement mixins BoxElement, IHasOptions<LineOptions>{
        ...
        declare         export type BigTextOptions = {
         ...
         */
        declare         export class BigTextElement mixins BoxElement, IHasOptions<BigTextOptions>{
        ...
        declare         export type ListOptions<TStyle>= {
        ...
        declare         export class ListElement mixins BoxElement, IHasOptions<ListOptions<ListElementStyle >> {
            ...
            on(
                event: "select item",
                callback: (item: BlessedElement, index: number) => void): this
        }
        declare         export type FileManagerOptions = {
        ...
        declare         export class FileManagerElement mixins ListElement, IHasOptions<FileManagerOptions>{
        ...
        declare         export type StyleListTable = {
        ...
        declare         export type ListTableOptions = {
        ...
        declare         export class ListTableElement mixins ListElement, IHasOptions<ListTableOptions>{
        ...
        declare         export type ListbarOptions = {
        ...
        declare         export class ListbarElement mixins BoxElement, IHasOptions<ListbarOptions>{
        ...
        declare         export type FormOptions = {
        ...
        declare         export class FormElement<TFormData>mixins BoxElement, IHasOptions<FormOptions>{
        ...
        declare         export type InputOptions = {} & BoxOptions

        declare         export class InputElement mixins BoxElement {
         ...
         */
        declare         export type TextareaOptions = {
        ...
        declare         export class TextareaElement mixins InputElement, IHasOptions<TextareaOptions>{
        ...
        declare         export type TextboxOptions = {
        ...
        declare         export class TextboxElement mixins TextareaElement, IHasOptions<TextboxOptions>{
        ...
        declare         export type ButtonOptions = {} & BoxOptions

        declare         export class ButtonElement mixins InputElement, IHasOptions<ButtonOptions>{
        ...
        declare         export type CheckboxOptions = {
         ...
         */
        declare         export class CheckboxElement mixins InputElement, IHasOptions<CheckboxOptions>{
        ...
        declare         export type RadioSetOptions = {} & BoxOptions
         ...
         * with each other.
         */
        declare         export class RadioSetElement mixins BoxElement {
            constructor(opts: RadioSetOptions): this
        }
        declare         export type RadioButtonOptions = {} & BoxOptions


        /**
         * A radio button which can be used in a form element.
         */
        declare         export class RadioButtonElement mixins CheckboxElement {
            constructor(opts: RadioButtonOptions): this
        }
        declare         export type PromptOptions = {} & BoxOptions


        /**
         * A prompt box containing a text input, okay, and cancel buttons (automatically hidden).
         */
        declare         export class PromptElement mixins BoxElement, IHasOptions<PromptOptions>{
        ...
        declare         export type QuestionOptions = {} & BoxOptions


        /**
         * A question box containing okay and cancel buttons (automatically hidden).
         */
        declare         export class QuestionElement mixins BoxElement, IHasOptions<QuestionOptions>{
        ...
        declare         export type MessageOptions = {} & BoxOptions


        /**
         * A box containing a message to be displayed (automatically hidden).
         */
        declare         export class MessageElement mixins BoxElement, IHasOptions<MessageOptions>{
        ...
        declare         export type LoadingOptions = {} & BoxOptions


        /**
         * A box with a spinning line to denote loading (automatically hidden).
         */
        declare         export class LoadingElement mixins BoxElement, IHasOptions<LoadingOptions>{
        ...
        declare         export type ProgressBarOptions = {
         ...
         */
        declare         export class ProgressBarElement mixins InputElement, IHasOptions<ProgressBarOptions>{
        ...
        declare         export type LogOptions = {
         ...
         */
        declare         export class Log mixins ScrollableTextElement, IHasOptions<LogOptions>{
        ...
        declare         export type TableOptions = {
         ...
         */
        declare         export class TableElement mixins BoxElement, IHasOptions<TableOptions>{
        ...
        declare         export type TerminalOptions = {
        ...
        declare         export class TerminalElement mixins BoxElement, IHasOptions<TerminalOptions>{
        ...
        declare         export type ImageOptions = {
         ...
         */
        declare         export class ImageElement mixins BoxElement, IHasOptions<ImageOptions>{
            constructor(options?: ImageOptions): this;
            options: ImageOptions
        }
        declare         export type ANSIImageOptions = {
         ...
         */
        declare         export class ANSIImageElement mixins BoxElement, IHasOptions<ANSIImageOptions>{
        ...
        declare         export type OverlayImageOptions = {
         ...
         * Convert any .png file (or .gif, see below) to an ANSI image and display it as an element. 
         */
        declare         export class OverlayImageElement mixins BoxElement, IHasOptions<OverlayImageOptions>{
        ...
        declare         export type VideoOptions = {
        ...
        declare         export class VideoElement mixins BoxElement, IHasOptions<VideoOptions>{
        ...
        declare         export type LayoutOptions = {
        ...
        declare         export class LayoutElement mixins BlessedElement, IHasOptions<LayoutOptions>{
    ...
    declare module 'widget' {
        declare         export class Element mixins Widgets.BlessedElement {}
        declare         export class Node mixins Widgets.Node {}
        declare         export class Screen mixins Widgets.Screen {}
        declare         export class Box mixins Widgets.BoxElement {}
        declare         export class ScrollableBox mixins Widgets.ScrollableBoxElement {}
        declare         export class ScrollableText mixins Widgets.ScrollableTextElement {}
        declare         export class Text mixins Widgets.BoxElement {}
        declare         export class Line mixins Widgets.LineElement {}
        declare         export class BigText mixins Widgets.BigTextElement {}
        declare         export class List mixins Widgets.ListElement {}
        declare         export class FileManager mixins Widgets.FileManagerElement {}
        declare         export class ListTable mixins Widgets.ListTableElement {}
        declare         export class ListBar mixins Widgets.ListbarElement {}
        declare         export class Form<TFormData>mixins Widgets.FormElement<TFormData>{}
        declare         export class Textarea mixins Widgets.TextareaElement {}
        declare         export class Button mixins Widgets.ButtonElement {}
        declare         export class Checkbox mixins Widgets.CheckboxElement {}
        declare         export class RadioSet mixins Widgets.RadioSetElement {}
        declare         export class RadioButton mixins Widgets.RadioButtonElement {}
        declare         export class Prompt mixins Widgets.PromptElement {}
        declare         export class question mixins Widgets.QuestionElement {}
        declare         export class Message mixins Widgets.MessageElement {}
        declare         export class Loading mixins Widgets.LoadingElement {}
        declare         export class ProgressBar mixins Widgets.ProgressBarElement {}
        declare         export class Terminal mixins Widgets.TerminalElement {}
    }
