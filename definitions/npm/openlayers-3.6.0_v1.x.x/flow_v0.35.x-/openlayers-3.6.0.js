/**
 * Flowtype definitions for openlayers-3.6.0
...
declare interface olx$StaticImageOptions {
...
declare interface olx$ZoomToExtentOptions {
    className?: string,
        target?: Element,
        label?: string | Node,
        tipLabel?: string,
...
declare interface olx$OverviewMapOptions {
    collapsed?: boolean,
...
declare interface olx$RotateOptions {
    className?: string,
...
declare interface olx$OSMOptions {
...
declare interface interaction$DrawOptions {
    ...
    */
    clickTolerance?: number,
         ...
         */
        finishCondition?: undefined.ConditionType,
...
declare interface interaction$DragAndDropOptions {
     ...
     * Format constructors.
     */
    formatConstructors?: Array<undefined.Feature>,
...
declare type layer$VectorOptions = {
     ...
     */
    style?: undefined.Style | Array<undefined.Style>| any
} & layer$LayerOptions
...
declare type source$ClusterOptions = {
...
declare type ol$AttributionLike = string | Array<string>| ol$Attribution | Array<ol$Attribution>;
...
declare class Map mixins ol$Object {
     ...
     * @returns  Coordinate.
     */
    getEventCoordinate(event: render$Event): ol$Coordinate;
     ...
     * @returns  Pixel.
     */
    getEventPixel(event: render$Event): ol$Pixel;
...
declare class Object mixins Observable {
     ...
     */
    constructor(values?: ol$Object): this;
     ...
     * @param Values .
     */
    setProperties(values: ol$Object): void;
...
declare class Observable {
     ...
     */
    on(type: string, listener: (event: undefined.Event) => void, ref?: any): any;
    ...
    on(
        type: Array<string>,
        listener: (event: undefined.Event) => void,
        ref?: any): any;
     ...
     * @returns  Unique key for the listener.
     */
    once(type: string, listener: (event: undefined.Event) => void, ref?: any): any;
...
declare function control$defaults(options?: undefined.DefaultsOptions): ol$Collection<undefined.Control >
     ...
     */
    declare type ScaleLine$Units = "degrees" |
    "imperial" |
    "nautical" |
    "metric" |
    "us";
...
declare class Attribution mixins Control {}

declare class FullScreen mixins Control {}

declare class MousePosition mixins Control {}

declare class OverviewMap mixins Control {
...
declare class Rotate mixins Control {
    constructor(opt_options?: olx$RotateOptions): this
}

declare class ScaleLine mixins Control {
...
declare class Zoom mixins Control {}

declare class ZoomSlider mixins Control {}

declare class ZoomToExtent mixins Control {
...
declare class WFS {
    readFeatures(
        source: Document | Node | ol$Object | string,
...
declare class Geometry mixins ol$Object {
    ...
    */
    transform(
        source: undefined.ProjectionLike | undefined.Projection,
        destination: undefined.ProjectionLike | undefined.Projection): undefined.Geometry
}
...
declare function interaction$defaults(options?: undefined.DefaultsOptions): ol$Collection<undefined.Control >
    ...
    declare interface interaction$DrawGeometryFunctionType {
        (coordinates: ol$Coordinate, geom?: undefined.Geometry): undefined.Geometry
    }
 ...
 * Units for the scale line. Supported values are 'degrees', 'imperial', 'nautical', 'metric', 'us'.
 */
declare type proj$Units = "degrees" |
    "imperial" |
    "nautical" |
    "metric" |
    "us";

declare var METERS_PER_UNIT: ol$Object;
