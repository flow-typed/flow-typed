...
declare module 'ioredis' {
    ...
    declare class Redis extends Commander {
        ...
        status: 'close' | 'disconnecting' | 'wait' | 'connecting' | 'connect' | 'ready' | 'end';
        connect(callback?: Function): Promise<any>;
        disconnect(): void;
        duplicate(): Redis;
        monitor(callback?: (error: Error, monitor: events$EventEmitter) => void): Promise<events$EventEmitter>;
        ...
        append(key: string, value: string, callback?: ResCallbackT<number>): Promise<number>;
        bitcount(key: string, callback?: ResCallbackT<number>): Promise<number>;
        bitcount(key: string, start: number, end: number, callback?: ResCallbackT<number>): Promise<number>;
        set(key: string, value: string, nx?: 'NX', ex?: 'EX', expires?: number, callback?: ResCallbackT<string>): Promise<string>;
        get(key: string, callback?: ResCallbackT<string>): Promise<string>;
        exists(key: string, value: string, callback?: ResCallbackT<number>): Promise<number>;
    ...
    declare class Cluster extends Redis {
        constructor(nodes: { host: string; port: number; }[], options?: ClusterOptions): void;
