...
declare
function SIPml$getNavigatorFriendlyName(): string

declare
function SIPml$getNavigatorVersion(): string

declare
function SIPml$getSystemFriendlyName(): string

declare
function SIPml$getWebRtc4AllVersion(): string

declare
function SIPml$haveMediaStream(): boolean

declare
function SIPml$init(readyCallback?: (e: any) => any, errorCallback?: (e: any) => any): boolean

declare
function SIPml$isInitialized(): boolean

declare
function SIPml$isNavigatorOutdated(): boolean

declare
function SIPml$isReady(): boolean

declare
function SIPml$isScreenShareSupported(): boolean

declare
function SIPml$isWebRtcPluginOutdated(): boolean

declare
function SIPml$isWebRtc4AllSupported(): boolean

declare
function SIPml$isWebRtcSupported(): boolean

declare
function SIPml$isWebSocketSupported(): boolean

declare
function SIPml$setDebugLevel(level: string): void

declare
function SIPml$setWebRtcType(type: string): boolean