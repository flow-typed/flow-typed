/**
 * Flowtype definitions for famous
...
declare module 'famous/core' {
    ...
    declare export class Scene mixins Node {}
...
declare module 'famous/physics' {
    ...
    declare export class Wall mixins Particle {
        constructor(options: IWallOptions): this;
        normal: Vec3;
        invNormal: Vec3
    }
    declare export type IWallOptions = {
        direction?: number
    } & IParticleOptions
    ...
    declare export type IDragOptions = {
        type?: (v: number) => number,
        strength?: number,
        max?: number
    } & IForceOptions

    declare export class Drag mixins Force {
    ...
    declare export type ISpringOptions = {
        length?: number,
    ...
    declare export class Spring mixins Force {
    ...
    declare export type IRotationalSpringOptions = {
        max?: number,
        type?: (dist: any, rMax: any) => number,
        stiffness?: number,
        damping?: number,
    ...
    declare export class RotationalSpring mixins Force {
    ...
    declare export class ConvexBody mixins Particle {}
    declare export class Box mixins ConvexBody {
        constructor(options?: any): this
    }
    declare export class Constraint {}
    declare export class Angle mixins Constraint {
