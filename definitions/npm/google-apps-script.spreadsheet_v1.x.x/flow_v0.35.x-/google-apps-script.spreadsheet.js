/**
 * Flowtype definitions for google-apps-script.spreadsheet
    ...
    declare export interface EmbeddedAreaChartBuilder {
        addRange(range: Range): EmbeddedChartBuilder,
            ...
            setPosition(
                ...
                offsetX: Integer,
                offsetY: Integer): EmbeddedChartBuilder,
    ...
    */
    ...
    declare export interface Sheet {
        activate(): Sheet,
            ...
            clearFormats(): Sheet,
            clearNotes(): Sheet,
            copyTo(spreadsheet: GoogleAppsScript$Spreadsheet): Sheet,
            ...
            getMaxRows(): Integer,
            getName(): string,
            getParent(): GoogleAppsScript$Spreadsheet,
    ...
    declare export interface Spreadsheet {
        addEditor(emailAddress: string): GoogleAppsScript$Spreadsheet,
            addEditor(user: Base.User): GoogleAppsScript$Spreadsheet,
            addEditors(emailAddresses: String[]): GoogleAppsScript$Spreadsheet,
            addMenu(name: string, subMenus: Object[]): void,
            addViewer(emailAddress: string): GoogleAppsScript$Spreadsheet,
            addViewer(user: Base.User): GoogleAppsScript$Spreadsheet,
            addViewers(emailAddresses: String[]): GoogleAppsScript$Spreadsheet,
            appendRow(rowContents: Object[]): Sheet,
            autoResizeColumn(columnPosition: Integer): Sheet,
            copy(name: string): GoogleAppsScript$Spreadsheet,
            ...
            removeEditor(emailAddress: string): GoogleAppsScript$Spreadsheet,
            removeEditor(user: Base.User): GoogleAppsScript$Spreadsheet,
            removeMenu(name: string): void,
            removeNamedRange(name: string): void,
            removeViewer(emailAddress: string): GoogleAppsScript$Spreadsheet,
            removeViewer(user: Base.User): GoogleAppsScript$Spreadsheet,
    ...
    declare export interface SpreadsheetApp {
        DataValidationCriteria: DataValidationCriteria,
            ...
            create(name: string): GoogleAppsScript$Spreadsheet,
            create(name: string, rows: Integer, columns: Integer): GoogleAppsScript$Spreadsheet,
            flush(): void,
            getActive(): GoogleAppsScript$Spreadsheet,
            getActiveRange(): Range,
            getActiveSheet(): Sheet,
            getActiveSpreadsheet(): GoogleAppsScript$Spreadsheet,
            getUi(): Base.Ui,
            newDataValidation(): DataValidationBuilder,
            open(file: Drive.File): GoogleAppsScript$Spreadsheet,
            openById(id: string): GoogleAppsScript$Spreadsheet,
            openByUrl(url: string): GoogleAppsScript$Spreadsheet,
            setActiveRange(range: Range): Range,
            setActiveSheet(sheet: Sheet): Sheet,
