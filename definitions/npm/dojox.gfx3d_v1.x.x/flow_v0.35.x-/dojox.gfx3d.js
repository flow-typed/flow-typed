/**
 * Flowtype definitions for dojox.gfx3d
...
declare class object {
     ...
     */
    applyLeftTransform(matrix: undefined.Matrix3D): Function;
     ...
     * @param matrix a matrix or a matrix-like object(see an argument of dojox.gfx.matrix.Matrixconstructor for a list of acceptable arguments)
     */
    applyRightTransform(matrix: undefined.Matrix3D): Function;

    /**
     * a shortcut for dojox.gfx.shape.Shape.applyRightTransform
     * @param matrix a matrix or a matrix-like object(see an argument of dojox.gfx.matrix.Matrixconstructor for a list of acceptable arguments)
     */
    applyTransform(matrix: undefined.Matrix3D): Function;
...
declare module '_base' {
    ...
    */
    ...
    declare class Viewport {
         ...
         */
        applyCameraLeftTransform(matrix: undefined.Matrix3D): Function;
         ...
         * @param matrix a matrix or a matrix-like object(see an argument of dojox.gfx3d.matrix.Matrix3Dconstructor for a list of acceptable arguments)
         */
        applyCameraRightTransform(matrix: undefined.Matrix3D): Function;

        /**
         * a shortcut for dojox.gfx3d.Object.applyRightTransform
         * @param matrix a matrix or a matrix-like object(see an argument of dojox.gfx3d.matrix.Matrix3Dconstructor for a list of acceptable arguments)
         */
        applyCameraTransform(matrix: undefined.Matrix3D): any;
        ...
        */
         ...
         * @param matrix a matrix or a matrix-like object(see an argument of dojox.gfx.matrix.Matrixconstructor for a list of acceptable arguments)
         */
        setCameraTransform(matrix: undefined.Matrix3D): Function;
        ...
        */
         ...
         */
        setLights(lights: any[], ambient: undefined.Color, specular: undefined.Color): Function;
    ...
    */
    ...
    declare interface matrix {
        ...
        identity: Object,
            ...
            */
             ...
             * @param c Optionala z coordinate of a point
             */
            project(matrix: Object, a: undefined.Point, b: number, c: number): any,
    ...
    declare interface vector {
        ...
        center(): Object,
             ...
             * @param f z coordinate of second point
             */
            crossProduct(a: undefined.Point, b: number, c: number, d: number, e: number, f: number): any,
             ...
             * @param f z coordinate of second point
             */
            crossProduct(a: number, b: undefined.Point, c: number, d: number, e: number, f: number): any,
             ...
             * @param f Optionalz coordinate of second point
             */
            dotProduct(a: undefined.Point, b: number, c: number, d: number, e: number, f: number): any,
             ...
             * @param f Optionalz coordinate of second point
             */
            dotProduct(a: number, b: undefined.Point, c: number, d: number, e: number, f: number): any,
 ...
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/gfx3d/_base.scheduler.html
 */
declare interface gfx3d$scheduler {
...
declare class BinarySearchTree {
    constructor(obj: undefined.object, outline: any): this;
 ...
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/gfx3d/_base.drawer.html
 */
declare interface scheduler$drawer {
 ...
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/gfx3d/_base.scheduler.html
 */
declare interface scheduler$scheduler {
 ...
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/gfx3d/_base.vector.html
 */
declare interface gfx3d$vector {
 ...
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/gfx3d/_base.lighting.html
 */
declare interface gfx3d$lighting {
 ...
 */
declare interface lighting$finish {
 ...
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/gfx3d/_base.matrix.html
 */
declare interface gfx3d$matrix {
...
*/
declare interface gfx3d$gradient {
...
declare module 'dojox/gfx3d/object' {
    declare var exp: undefined.object;
    declare module.exports: typeof exp
}
...
declare module 'dojox/gfx3d/_base.Cube' {
    declare var exp: undefined.Cube;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx3d/_base.Cylinder' {
    declare var exp: undefined.Cylinder;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx3d/_base.Edges' {
    declare var exp: undefined.Edges;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx3d/_base.Polygon' {
    declare var exp: undefined.Polygon;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx3d/_base.Orbit' {
    declare var exp: undefined.Orbit;
    declare module.exports: typeof exp
}
...
declare module 'dojox/gfx3d/scheduler.BinarySearchTree' {
    declare var exp: undefined.BinarySearchTree;
    declare module.exports: typeof exp
}
...
declare module 'dojox/gfx3d/lighting.Model' {
    declare var exp: undefined.Model;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx3d/lighting.finish' {
    declare var exp: undefined.finish;
    declare module.exports: typeof exp
}
