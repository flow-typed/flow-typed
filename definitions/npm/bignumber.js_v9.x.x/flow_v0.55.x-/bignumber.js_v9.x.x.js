...
declare module 'bignumber.js' {
  ...
  declare type Value = string | number | Instance
  ...
  declare export class BigNumber {
     ...
     */
    constructor(n: Value, base?: number): this;
    static (n: Value, base?: number): this;
    ...
    decimalPlaces(decimalPlaces: number, roundingMode?: RoundingMode): BigNumber;
     ...
     *    * ```
     * @param {RoundingMode} rm The roundng mode, an integer, 0 to 8.
     */
     ...
     * @param roundingMode Rounding mode, integer, 0 to 8.
     */
    precision(significantDigits: number, roundingMode?: RoundingMode): BigNumber;
  ...
  declare export default BigNumber
}
