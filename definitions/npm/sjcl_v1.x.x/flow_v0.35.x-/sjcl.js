...
declare export var bn: sjcl$BigNumberStatic;

declare export var bitArray: sjcl$BitArrayStatic;

declare export var codec: sjcl$SjclCodecs;

declare export var hash: sjcl$SjclHashes;

declare export var exception: sjcl$SjclExceptions;

declare export var cipher: sjcl$SjclCiphers;

declare export var mode: sjcl$SjclModes;

declare export var misc: sjcl$SjclMisc;

declare export var ecc: sjcl$SjclEllipticCurveCryptography;

declare export var random: sjcl$SjclRandom;

declare export var prng: sjcl$SjclRandomStatic;

declare export var keyexchange: sjcl$SjclKeyExchange;

declare export var json: sjcl$SjclJson;

declare export var encrypt: sjcl$SjclConveninceEncryptor;

declare export var decrypt: sjcl$SjclConveninceDecryptor;
