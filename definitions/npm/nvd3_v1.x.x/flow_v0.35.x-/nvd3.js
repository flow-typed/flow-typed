import type { Nvd3Static } from 'npm$namespace$nv'

declare module 'nvd3' {
					declare module.exports: Nvd3Static


}

declare module 'npm$namespace$nv' {
	...
	declare interface InteractiveLayer {
		tooltip: Tooltip
	}

	declare interface SymbolMap {
	...
	declare interface ChartFactory<TChart> {
		generate: () => TChart,
		callback?: (chart: TChart) => void
	}

	declare interface Nvd3TooltipStatic {
		show(undefined: [number, number], content: string, gravity?: string): void,
		cleanup(): void
	}

	declare interface Nvd3Element {
		dispatch: d3.Dispatch,
	...
	declare interface CandlestickBar {
		clipEdge(): boolean,
	...
	declare interface HistoricalBar {
		clipEdge(): boolean,
		clipEdge(value: boolean): this,
		color(value: string[]): this,
		color(func: (d: any, i: number) => string): this,
	...
	declare interface MultiBarHorizontal {
		barColor(value: string[]): this,
		barColor(func: (d: any, i: number) => string): this,
		color(value: string[]): this,
		color(func: (d: any, i: number) => string): this,
	...
	declare interface ParallelCoordinates {
		color(value: string[]): this,
		color(func: (d: any, i: number) => string): this,
		dimensionData(): any,
	...
	declare interface SparkLinePlus {
		sparkline: SparkLine,
		alignValue(): boolean,
	...
	declare interface CandlestickBarChart {
		bars: CandlestickBar,
		legend: Legend,
		xAxis: Nvd3Axis,
		yAxis: Nvd3Axis,
	...
	declare interface CumulativeLineChart {
		controls: Legend,
	...
	declare interface DiscreteBarChart {
	...
	declare interface HistoricalBarChart {
		bars: HistoricalBar,
		legend: Legend,
		xAxis: Nvd3Axis,
		yAxis: Nvd3Axis,
	...
	declare interface LinePlusBarChart {
		legend: Legend,
		lines: Line,
		lines2: Line,
		bars: HistoricalBar,
	...
	declare interface LineWithFocusChart {
		legend: Legend,
		lines: Line,
		lines2: Line,
		xAxis: Nvd3Axis,
	...
	declare interface MultiBarChart {
		multibar: MultiBar,
		legend: Legend,
		controls: Legend,
		xAxis: Nvd3Axis,
	...
	declare interface MultiBarHorizontalChart {
		multibar: MultiBar,
		legend: Legend,
		controls: Legend,
		xAxis: Nvd3Axis,
	...
	declare interface OhlcBarChart {
		bars: OhlcBar,
		legend: Legend,
		xAxis: Nvd3Axis,
		yAxis: Nvd3Axis,
	...
	declare interface ParallelCoordinatesChart {
	...
	declare interface StackedAreaChart {
		stacked: StackedArea,
		legend: Legend,
		controls: Legend,
		xAxis: Nvd3Axis,
	...
	declare interface SunburstChart {
		sunburst: Sunburst,
		tooltip: Tooltip,
		duration(): number,
		duration(value: number): this,
	...
	declare interface Nvd3Static {
		...
		utils: Utils,
		logs: any,
		addGraph<TChart>(factory: ChartFactory<TChart>): void,
