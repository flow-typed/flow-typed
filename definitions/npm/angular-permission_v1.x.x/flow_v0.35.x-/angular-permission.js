// @flow
/**
 * Flowtype definitions for angular-permission
...
declare module 'acl' {
    ...
    declare interface Acl {
        addUserRoles: (userId: OData$Value, roles: strings, cb?: Callback) => Promise<void>,
            removeUserRoles: (userId: OData$Value, roles: strings, cb?: Callback) => Promise<void>,
            userRoles: (
                userId: OData$Value,
                cb?: (err: Error, roles: string[]) => any) => Promise<string[]>,
            roleUsers: (role: OData$Value, cb?: (err: Error, users: Values) => any) => Promise<any>,
            hasRole: (
                userId: OData$Value,
                role: string,
            ...
            allowedPermissions: (userId: OData$Value, resources: strings, cb?: AnyCallback) => Promise<void>,
            isAllowed: (
                userId: OData$Value,
                resources: strings,
                permissions: strings,
