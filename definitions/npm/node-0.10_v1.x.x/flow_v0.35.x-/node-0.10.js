...
declare module 'querystring' {
	...
	declare export function escape(): any

	declare export function unescape(): any
...
declare module 'http' {
	...
	declare export function request(
		options: RequestOptions, callback?: (response: ClientResponse) => void
	): ClientRequest
...
declare module 'https' {
	...
	declare export function request(
		options: RequestOptions, callback?: (res: http.ClientResponse) => void
	): http.ClientRequest
