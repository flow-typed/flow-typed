/**
 * Flowtype definitions for jquery-jsonrpcclient
...
declare type JsonRpcClientOptions = {
    ajaxUrl: string,
    headers?: {
        [key: string]: any
    },
...
declare interface JsonRpcClient {
     ...
     * @param  The method to run on JSON-RPC server.
     * @param  The params; an array or object.
     * @param  A callback for successful request.
     * @param  A callback for error.
     * @return  Returns the deferred object that $.ajax returns or {null} for websockets
     */
    call(
            method: string,
            params: Object | Array<any>,
            successCb: (result: any) => void,
            errorCb: (result: any) => void): JQueryDeferred<JQueryXHR>,
        ...
        */
         ...
         * @fn  batch
         * @memberof  JsonRpcClient
         * @param  This function will get a batch handler to run call and notify on.
         * @param  A callback function to call after all results have been handled.
         * @param  A callback function to call if there is an error from the server.
        Note, that batch calls should always get an overall success, and the
        only error
        */
        batch(
            callback: (batch: JsonRpcClient) => void,
            allDoneCb: (result: any) => void,
            errorCb: (error: any) => void): void
}
declare interface JsonRpcClientFactory {
     ...
     * @fn  new
     * @memberof  JsonRpcClient
     * @param  An object stating the backends:
