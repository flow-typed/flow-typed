/**
 * Flowtype definitions for dojox.mvc
 ...
 */
declare class _Container mixins dijit._WidgetBase {
 ...
 */
declare class _Controller mixins dojo.Stateful, undefined._atBindingMixin {
    constructor(): this;
...
*/
declare class EditModelRefController mixins undefined.ModelRefController {
    constructor(): this;
...
NOTE - If this class is used with a widget by data-dojo-mixins, make sure putting the widget in data-dojo-type and putting this class to data-dojo-mixins.
*/
declare class EditStoreRefController mixins undefined.StoreRefController, undefined.EditModelRefController {
    constructor(): this;
     ...
     */
    addStore(object: Object, options: undefined.PutDirectives): any;
     ...
     * @param options OptionalAdditional metadata for storing the data.  Includes an "id" property if a specific id is to be used.
     */
    putStore(object: Object, options: undefined.PutDirectives): any;
     ...
     */
    queryStore(query: Object, options: undefined.QueryOptions): any;
...
NOTE - If this class is used with a widget by data-dojo-mixins, make sure putting the widget in data-dojo-type and putting this class to data-dojo-mixins.
*/
declare class EditStoreRefListController mixins undefined.EditStoreRefController, undefined.ListController {
    constructor(): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class Element mixins dijit._WidgetBase {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class Generate mixins undefined._Container {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class Group mixins dijit._WidgetBase {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
...
NOTE - If this class is used with a widget by data-dojo-mixins, make sure putting the widget in data-dojo-type and putting this class to data-dojo-mixins.
*/
declare class ModelRefController mixins undefined._Controller {
    constructor(): this;
...
NOTE - If this class is used with a widget by data-dojo-mixins, make sure putting the widget in data-dojo-type and putting this class to data-dojo-mixins.
*/
declare class ListController mixins undefined.ModelRefController {
    constructor(): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class Output mixins dijit._WidgetBase {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class Repeat mixins undefined._Container {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
...
*/
declare class StatefulModel mixins dojo.Stateful {
    ...
    */
    commit(store?: undefined.DataStore): void;
...
An object that defines how model object should be created from plain object hierarchy.
*/
declare interface StatefulModel$getStatefulOptions {
...
An object that defines how plain value should be created from model object.
*/
declare interface StatefulModel$getPlainValueOptions {

    /**
     * 
     * @param a 
     */
    getPlainArray(a: undefined.StatefulArray): any,

        /**
         * 
         * @param o 
         */
        getPlainObject(o: undefined.StatefulModel): Object,
...
NOTE - If this class is used with a widget by data-dojo-mixins, make sure putting the widget in data-dojo-type and putting this class to data-dojo-mixins.
*/
declare class StoreRefController mixins undefined.ModelRefController {
    constructor(): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class Templated mixins dijit._WidgetBase, dijit._TemplatedMixin, dijit._WidgetsInTemplateMixin {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class WidgetList mixins dijit._WidgetBase, dijit._Container {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param w The widget.
*/
declare interface mvc$atBindingExtension {
 ...
 */
declare interface equals$equalsArray {
 ...
 * @param src 
 */
declare interface equals$equalsDate {
 ...
 */
declare interface equals$equalsObject {
 ...
 * @param src 
 */
declare interface equals$equalsValue {
    (dst: any, src: any): boolean
}
 ...
 * @param v The value.
 */
declare interface equals$getType {
    (v: any): String
}
 ...
 * @param options The object that defines how plain value should be created from stateful value.
*/
declare interface mvc$getPlainValue {
 ...
 * @param a The array.
 */
declare interface getPlainValue$getPlainArray {
    (a: any[]): any
}
 ...
 * @param o The object.
 */
declare interface getPlainValue$getPlainObject {
    (o: Object): Object
}
 ...
 * @param options The object that defines how plain value should be created from stateful value.
*/
declare interface getPlainValue$getPlainValue {
    (value: any, options: Object): void
}
 ...
 * @param v The value.
 */
declare interface getPlainValue$getType {
    (v: any): String
}
 ...
 * @param options The object that defines how model object should be created from plain object hierarchy.
*/
declare interface mvc$getStateful {
    (value: any, options: Object): void
}
 ...
 * @param a The array.
 */
declare interface getStateful$getStatefulArray {
    (a: any[]): any
}
 ...
 * @param o The object.
 */
declare interface getStateful$getStatefulObject {
    (o: Object): any
}
 ...
 * @param v 
 */
declare interface getStateful$getStatefulValue {
    (v: any): any
}
 ...
 * @param v The value.
 */
declare interface getStateful$getType {
    (v: any): String
}
 ...
 * @param a 
*/
declare interface mvc$StatefulArray {
    (a: any[]): void
}
 ...
 */
declare interface StatefulArray$_meta {
 ...
 * @param options The object that defines how two stateful values are compared.
*/
declare interface sync$equals {
    (dst: any, src: any, options: Object): void
}

declare module '_atBindingExtension' {

}


declare module '_DataBindingExtension' {

}


declare module '_patches' {

}


declare module '_TextBoxExtensions' {

}


declare module 'dojox/mvc' {
    declare var exp: dojox$mvc;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/_atBindingMixin' {
    declare var exp: undefined._atBindingMixin;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/_atBindingMixin.mixin' {
    declare var exp: undefined.mixin;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/_InlineTemplateMixin' {
    declare var exp: undefined._InlineTemplateMixin;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/_DataBindingMixin' {
    declare var exp: undefined._DataBindingMixin;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/_Controller' {
    declare var exp: undefined._Controller;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/_Container' {
    declare var exp: undefined._Container;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/EditModelRefController' {
    declare var exp: undefined.EditModelRefController;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/EditStoreRefListController' {
    declare var exp: undefined.EditStoreRefListController;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/EditStoreRefController' {
    declare var exp: undefined.EditStoreRefController;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/ListController' {
    declare var exp: undefined.ListController;
    declare module.exports: typeof exp
}
...
declare module 'dojox/mvc/ModelRefController' {
    declare var exp: undefined.ModelRefController;
    declare module.exports: typeof exp
}
...
declare module 'dojox/mvc/Generate' {
    declare var exp: undefined.Generate;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/Output' {
    declare var exp: undefined.Output;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/StatefulModel' {
    declare var exp: undefined.StatefulModel;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/StatefulModel.getPlainValueOptions' {
    declare var exp: undefined.getPlainValueOptions;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/StatefulModel.getStatefulOptions' {
    declare var exp: undefined.getStatefulOptions;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/Repeat' {
    declare var exp: undefined.Repeat;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/StoreRefController' {
    declare var exp: undefined.StoreRefController;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/StatefulSeries' {
    declare var exp: undefined.StatefulSeries;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/Templated' {
    declare var exp: undefined.Templated;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/WidgetList' {
    declare var exp: undefined.WidgetList;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/atBindingExtension' {
    declare var exp: undefined.atBindingExtension;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/at' {
    declare var exp: undefined.at;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/at.handle' {
    declare var exp: undefined.handle;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/equals' {
    declare var exp: undefined.equals;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/getPlainValue' {
    declare var exp: undefined.getPlainValue;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/getStateful' {
    declare var exp: undefined.getStateful;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/resolve' {
    declare var exp: undefined.resolve;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/StatefulArray' {
    declare var exp: undefined.StatefulArray;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/StatefulArray._meta' {
    declare var exp: undefined._meta;
    declare module.exports: typeof exp
}
declare module 'dojox/mvc/sync' {
    declare var exp: undefined.sync;
    declare module.exports: typeof exp
}
...
declare module 'dojox/mvc/Bind' {
    declare var exp: undefined.Bind;
    declare module.exports: typeof exp
}
