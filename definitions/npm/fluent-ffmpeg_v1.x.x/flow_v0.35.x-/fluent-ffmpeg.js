...
declare module 'fluent-ffmpeg' {
	...
	declare interface FfmpegCommand {
		...
		autopad(pad: boolean, color: string): FfmpegCommand,
		addOutput(
		target: string | stream.Writable, pipeopts?: {
		end?: boolean
	}
	): FfmpegCommand,
		output(
	...
	): (err: any, data: FfprobeData) => void,
		ffprobe(
		index: number, callback: (err: any, data: FfprobeData) => void
	): (err: any, data: FfprobeData) => void,
		ffprobe(
		options: string[], callback: (err: any, data: FfprobeData) => void
	): (err: any, data: FfprobeData) => void,
		ffprobe(
		index: number, options: string[], callback: (err: any, data: FfprobeData) => void
	): (err: any, data: FfprobeData) => void,
		...
		mergeToFile(
		target: string | stream.Writable, options?: {
		end?: boolean
	}
	): FfmpegCommand,
		concatenate(
	...
	declare function Ffmpeg(): FfmpegCommand

	declare function Ffmpeg(options: FfmpegCommandOptions): FfmpegCommand

	declare function Ffmpeg(input: string | stream.Readable, options: FfmpegCommandOptions): FfmpegCommand
