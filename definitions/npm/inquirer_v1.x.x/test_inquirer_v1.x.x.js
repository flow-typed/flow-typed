...
var choices = Array.from(new Array(26), function(x: number, y: number) {
...
var questions2 = [{
  ...
  choices: [
    { key: "p", name: "Peperonni and chesse", value: "PeperonniChesse" },
    { key: "a", name: "All dressed", value: "alldressed" },
    { key: "w", name: "Hawaïan", value: "hawaian" }
  ]
}, {
  type: "rawlist",
  name: "beverage",
...
var output2: Array<string|boolean> = [];
