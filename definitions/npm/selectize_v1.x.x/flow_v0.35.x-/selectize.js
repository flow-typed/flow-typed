// @flow
/**
 * Flowtype definitions for selectize
...
declare interface Selectize$IOptions<T, U>{
    ...
    */
    score(search: Selectize$ISearch): (item: any) => number,
    ...
    */
     ...
     */
    onLoad(data: U[]): any,
    render?: Selectize$ICustomRenderers<U >
}
...
*/
declare interface Selectize$ICustomRenderers<U>{
...
declare interface Selectize$IApi<T, U>{
...
declare interface Selectize$ISearchToken {
    regex: RegExp,
        string: string
}

declare interface Selectize$ISearchResult {
    id: string,
        score: number
}

declare interface Selectize$ISearch {
