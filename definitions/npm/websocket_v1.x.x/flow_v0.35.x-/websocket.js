/**
 * Flowtype definitions for websocket
...
declare module 'websocket' {
    ...
    declare export type IServerConfig = {
    ...
    declare export class server mixins events.EventEmitter {
        ...
        */
        ...
        on(
            event: "close",
            cb: (connection: connection, reason: number, desc: string) => void): this;
    ...
    declare export type IBufferList = {
        encoding: string,
        length: number,
    ...
    declare class connection mixins events.EventEmitter {
    ...
    declare export type IClientConfig = {
    ...
    declare class client mixins events.EventEmitter {
        protocols: string[];
        origin: string;
        url: url.Url;
        secure: boolean;
    ...
    declare class routerRequest mixins events.EventEmitter {
    ...
    declare class router mixins events.EventEmitter {
