/**
 * Flowtype definitions for oclazyload
...
declare interface oc$ILazyLoad {
     ...
     */
    load(
            module: string | oc$ITypedModuleConfig | oc$IModuleConfig | (string | oc$ITypedModuleConfig | oc$IModuleConfig)[],
         ...
         */
        setModuleConfig(config: oc$IModuleConfig): oc$IModuleConfig,

        /**
         * Gets the specified module config object.
         * @param name The name of the module config object to get
         */
        getModuleConfig(name: string): oc$IModuleConfig,
...
declare type oc$ITypedModuleConfig = {
...
declare type oc$IOptionsConfig = {
...
declare interface oc$ILazyLoadProvider {

    /**
     * Configures the main service provider.
     * @param config The configuration settings to use
     */
    config(config: oc$IProviderConfig): void
}

declare interface oc$IProviderConfig {
...
declare interface angular$IAngularStatic {
    ...
    */
    module(
        name: string,
        requires?: (string | oc$IModuleConfig)[],
