...
declare module 'any-db' {
    ...
    declare export interface Adapter {
        name: string,
            ...
            createConnection(
                opts: ConnectOpts,
                callback?: (error: Error, result: Connection) => void): Connection,
            ...
            */
            createQuery(
                text: string,
                params?: any[],
                callback?: (error: Error, result: ResultSet) => void): Query,
    ...
    declare export type Queryable = {
        ...
        */
        query(
            text: string,
            params?: any[],
            callback?: (error: Error, results: ResultSet) => void): Query
    }
    ...
    */
        ...
        min?: number,
            ...
            */
            ...
            onConnect?: (
                ...
                ready: (error: Error, result: Connection) => void) => void,
    ...
    declare export function createConnection(
        url: string,
        callback?: (error: Error, connection: Connection) => void): Connection
