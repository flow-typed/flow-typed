...
declare module 'tape' {
    ...
    */
     ...
     */
    declare interface tape$TestOptions {
        skip?: boolean,
            timeout?: number
    }
     ...
     */
    declare interface tape$StreamOptions {
        objectMode?: boolean
    }
     ...
     */
    declare     export function tape$skip(name: string, cb: tape$TestCase): void
     ...
     */
    declare     export function tape$only(name: string, cb: tape$TestCase): void


    /**
     * Create a new test harness instance, which is a function like test(), but with a new pending stack and test state.
     */
    declare     export function tape$createHarness(): typeof tape
     ...
     */
    declare     export function tape$createStream(opts?: tape$StreamOptions): NodeJS.ReadableStream

    declare interface tape$Test {
