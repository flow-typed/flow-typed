// @flow
/**
 * Flowtype definitions for dojox.fx
...
*/
declare class Shadow mixins dijit._Widget {
...
returned.
*/
declare interface ext_dojo$reverse {
    (): void
}
 ...
 */
declare interface reverse$gotoPercent {
 ...
 */
declare interface reverse$pause {
    (): Function
}
 ...
 */
declare interface reverse$play {
...
returned.
*/
declare interface reverse$reverse {
    (): void
}
 ...
 */
declare interface reverse$status {
    (): String
}
 ...
 */
declare interface reverse$stop {
...
there.
*/
declare interface ext_dojo$complex {}
...
These are experimental animations, in an experimental
*/
declare interface ext_dojo$NodeList_style {}
declare module 'dojox/fx' {
    declare     var exp: dojox$fx;
    declare module.exports: typeof exp
}
declare module 'dojox/fx/Shadow' {
    declare     var exp: undefined.Shadow;
    declare module.exports: typeof exp
}
declare module 'dojox/fx/_core' {
    declare     var exp: undefined._core;
    declare module.exports: typeof exp
}
declare module 'dojox/fx/scroll' {
    declare     var exp: undefined.scroll;
    declare module.exports: typeof exp
}
declare module 'dojox/fx/_arg' {
    declare     var exp: undefined._arg;
    declare module.exports: typeof exp
}
declare module 'dojox/fx/easing' {
    declare     var exp: undefined.easing;
    declare module.exports: typeof exp
}
...
declare module 'dojox/fx/flip' {
    declare     var exp: undefined.flip;
    declare module.exports: typeof exp
}
declare module 'dojox/fx/style' {
    declare     var exp: undefined.style;
    declare module.exports: typeof exp
}
...
declare module 'dojox/fx/split' {
    declare     var exp: undefined.split;
    declare module.exports: typeof exp
}
declare module 'dojox/fx/Timeline' {
    declare     var exp: undefined.Timeline;
    declare module.exports: typeof exp
}
declare module 'dojox/fx/ext-dojo/reverse' {
    declare     var exp: undefined.reverse;
    declare module.exports: typeof exp
}
declare module 'dojox/fx/ext-dojo/complex' {
    declare     var exp: undefined.complex;
    declare module.exports: typeof exp
}
...
declare module 'dojox/fx/ext-dojo/NodeList-style' {
    declare     var exp: undefined.NodeList_style;
    declare module.exports: typeof exp
}