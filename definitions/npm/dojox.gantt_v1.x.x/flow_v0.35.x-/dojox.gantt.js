/**
 * Flowtype definitions for dojox.gantt
 ...
 * @param configuration 
 */
declare class GanttProjectItem mixins undefined.GanttTaskItem {
...
declare module 'dojox/gantt/contextMenuTab' {
    declare var exp: undefined.contextMenuTab;
    declare module.exports: typeof exp
}
declare module 'dojox/gantt/GanttProjectControl' {
    declare var exp: undefined.GanttProjectControl;
    declare module.exports: typeof exp
}
declare module 'dojox/gantt/GanttProjectItem' {
    declare var exp: undefined.GanttProjectItem;
    declare module.exports: typeof exp
}
declare module 'dojox/gantt/GanttResourceItem' {
    declare var exp: undefined.GanttResourceItem;
    declare module.exports: typeof exp
}
declare module 'dojox/gantt/GanttChart' {
    declare var exp: undefined.GanttChart;
    declare module.exports: typeof exp
}
declare module 'dojox/gantt/GanttTaskControl' {
    declare var exp: undefined.GanttTaskControl;
    declare module.exports: typeof exp
}
declare module 'dojox/gantt/TabMenu' {
    declare var exp: undefined.TabMenu;
    declare module.exports: typeof exp
}
declare module 'dojox/gantt/GanttTaskItem' {
    declare var exp: undefined.GanttTaskItem;
    declare module.exports: typeof exp
}