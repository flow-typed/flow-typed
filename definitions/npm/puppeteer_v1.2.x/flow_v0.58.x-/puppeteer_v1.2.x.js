...
type $npm$puppeteer$MousePressOptions = {
  /**
   * left, right, or middle.
   * @default left
   */
  button?: $npm$puppeteer$MouseButtons,
...
type $npm$puppeteer$Mouse = {
   ...
   */
  click(x: number, y: number, options?: $npm$puppeteer$ClickOptions): Promise<void>,

  /**
   * Dispatches a `mousedown` event.
   * @param options The mouse press options.
   */
  down(options?: $npm$puppeteer$MousePressOptions): Promise<void>,
   ...
   * @param options The mouse press options.
   */
  up(options?: $npm$puppeteer$MousePressOptions): Promise<void>,
};

type $npm$puppeteer$Touchscreen = {
  /**
 ...
 */
type $npm$puppeteer$Tracing = {
  start(options: $npm$puppeteer$TracingStartOptions): Promise<void>,

  stop(): Promise<void>,
};

type $npm$puppeteer$TracingStartOptions = {
...
type $npm$puppeteer$ConsoleMessage = {
  /** The message arguments. */
  args(): Array<$npm$puppeteer$JSHandle>,
...
type $npm$puppeteer$BrowserEvents =
  | 'disconnected'
  | 'targetchanged'
  | 'targetcreated'
  | 'targetdestroyed';

type $npm$puppeteer$AuthOptions = {
  password: string,
  username: string,
};

type $npm$puppeteer$MouseButtons = 'left' | 'right' | 'middle';

type $npm$puppeteer$ClickOptions = {
  /** defaults to left */
  button?: $npm$puppeteer$MouseButtons,
...
type $npm$puppeteer$DeleteCookie = {
  domain?: string,
  /** The cookie name. */
  name: string,
  path?: string,
...
type $npm$puppeteer$EmulateOptions = {
  /** The emulated user-agent. */
  userAgent?: string,

  /** The viewport emulation options. */
  viewport?: $npm$puppeteer$Viewport,
};

type $npm$puppeteer$EvaluateFn = string | ((...args: Array<mixed>) => mixed);

type $npm$puppeteer$LoadEvent = 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2';

/** The navigation options. */
type $npm$puppeteer$NavigationOptions = {
  /**
   ...
   */
  waitUntil?: $npm$puppeteer$LoadEvent | Array<$npm$puppeteer$LoadEvent>,
};

type $npm$puppeteer$PDFFormat =
  | 'Letter'
  | 'Legal'
  | 'Tabload'
  | 'Ledger'
...
type $npm$puppeteer$PDFOptions = {
  ...
  format?: $npm$puppeteer$PDFFormat,
...
type $npm$puppeteer$ScreenshotOptions = {
  /**
   * An object which specifies clipping region of the page.
   */
  clip?: $npm$puppeteer$BoundingBox,
...
type $npm$puppeteer$StyleTagOptions = {
...
type $npm$puppeteer$ScriptTagOptions = {
...
type $npm$puppeteer$PageFnOptions = {
  polling?: 'raf' | 'mutation' | number,
  timeout?: number,
};

type $npm$puppeteer$BoundingBox = {
  /** The height. */
  height: number,
 ...
 */
type $npm$puppeteer$ElementHandle = $npm$puppeteer$JSHandle & {
  /**
   ...
   * @since 0.13.0
   */
  $(selector: string): Promise<$npm$puppeteer$ElementHandle | null>,
   ...
   * @since 0.13.0
   */
  $$(selector: string): Promise<Array<$npm$puppeteer$ElementHandle>>,

  /**
   * @param selector XPath expression to evaluate.
   */
  $x(expression: string): Promise<Array<$npm$puppeteer$ElementHandle>>,
   ...
   */
  boundingBox(): Promise<$npm$puppeteer$BoundingBox | null>,
   ...
   */
  screenshot(options?: $npm$puppeteer$ScreenshotOptions): Promise<Buffer>,
...
type $npm$puppeteer$ExecutionContext = {
  evaluate(fn: $npm$puppeteer$EvaluateFn, ...args: Array<mixed>): Promise<mixed>,
  evaluateHandle(
    fn: $npm$puppeteer$EvaluateFn,
    ...args: Array<mixed>
  ): Promise<$npm$puppeteer$JSHandle>,
  queryObjects(prototypeHandle: $npm$puppeteer$JSHandle): $npm$puppeteer$JSHandle,
};

/** JSHandle represents an in-page JavaScript object. */
type $npm$puppeteer$JSHandle = {
  /**
   * Returns a ElementHandle
   */
  asElement(): $npm$puppeteer$ElementHandle | null,
   ...
   */
  executionContext(): $npm$puppeteer$ExecutionContext,

  /**
   * Returns a map with property names as keys and JSHandle instances for the property values.
   */
  getProperties(): Promise<Map<string, $npm$puppeteer$JSHandle>>,

  /**
   * Fetches a single property from the objectHandle.
   * @param propertyName The property to get.
   */
  getProperty(propertyName: string): Promise<$npm$puppeteer$JSHandle>,
...
type $npm$puppeteer$Headers = { [key: string]: string };
type $npm$puppeteer$HttpMethod = 'GET' | 'POST' | 'PATCH' | 'PUT' | 'DELETE' | 'OPTIONS';

type $npm$puppeteer$ResourceType =
  | 'document'
  | 'stylesheet'
  | 'image'
  | 'media'
...
type $npm$puppeteer$Overrides = {
  headers?: $npm$puppeteer$Headers,
  method?: $npm$puppeteer$HttpMethod,
  postData?: string,
  url?: string,
};

/** Represents a page request. */
type $npm$puppeteer$Request = {
  /**
   * Aborts request.
   ...
   * @throws An exception is immediately thrown if the request interception is not enabled.
   */
  continue(overrides?: $npm$puppeteer$Overrides): Promise<void>,

  /**
   * @returns The `Frame` object that initiated the request, or `null` if navigating to error pages
   */
  frame(): Promise<?$npm$puppeteer$Frame>,
  ...
  resourceType(): $npm$puppeteer$ResourceType,
   ...
   */
  respond(response: $npm$puppeteer$RespondOptions): Promise<void>,

  /** A matching `Response` object, or `null` if the response has not been received yet. */
  response(): ?$npm$puppeteer$Response,
...
type $npm$puppeteer$RespondOptions = {
...
type $npm$puppeteer$FrameBase = {
   ...
   */
  $(selector: string): Promise<?$npm$puppeteer$ElementHandle>,
  ...
  addScriptTag(options: $npm$puppeteer$ScriptTagOptions): Promise<void>,

  /** Adds a `<link rel="stylesheet">` tag into the page with the desired url or a `<style type="text/css">` tag with the content. */
  addStyleTag(options: $npm$puppeteer$StyleTagOptions): Promise<void>,
  ...
  waitForFunction(
    ...
    // eslint-disable-next-line flowtype/no-weak-types
    fn: string | Function,
    options?: $npm$puppeteer$PageFnOptions,
    ...args: Array<mixed>
  ): Promise<mixed>,
  ...
  ): Promise<$npm$puppeteer$ElementHandle>,
};

type $npm$puppeteer$Frame = $npm$puppeteer$FrameBase & {
  childFrames(): Array<$npm$puppeteer$Frame>,
  ...
  parentFrame(): ?$npm$puppeteer$Frame,
};

type $npm$puppeteer$PageEventObj = {
  /**
   * Emitted when JavaScript within the page calls one of console API methods, e.g. console.log or console.dir.
   * Also emitted if the page throws an error or a warning.
   */
  console: $npm$puppeteer$ConsoleMessage,
   ...
   */
  dialog: $npm$puppeteer$Dialog,

  /** Emitted when the page crashes. */
  error: Error,

  /** Emitted when a frame is attached. */
  frameattached: $npm$puppeteer$Frame,

  /** Emitted when a frame is detached. */
  framedetached: $npm$puppeteer$Frame,

  /** Emitted when a frame is navigated to a new url. */
  framenavigated: $npm$puppeteer$Frame,
  ...
  requestfailed: $npm$puppeteer$Request,

  /** Emitted when a request finishes successfully. */
  requestfinished: $npm$puppeteer$Request,
...
type $npm$puppeteer$Page = EventEmitter &
  $npm$puppeteer$FrameBase & {
    /**
     * Provide credentials for http authentication.
     * To disable authentication, pass `null`.
     */
    authenticate(credentials: $npm$puppeteer$AuthOptions | null): Promise<void>,
     ...
     */
    click(selector: string, options?: $npm$puppeteer$ClickOptions): Promise<void>,
     ...
     */
    cookies(...urls: Array<string>): Promise<Array<$npm$puppeteer$Cookie>>,

    coverage: $npm$puppeteer$Coverage,

    /**
     * Deletes the specified cookies.
     */
    deleteCookie(...cookies: Array<$npm$puppeteer$DeleteCookie>): Promise<void>,

    /** Emulates given device metrics and user agent. This method is a shortcut for `setUserAgent` and `setViewport`.  */
    emulate(options: $Shape<$npm$puppeteer$EmulateOptions>): Promise<void>,
     ...
     * @param args The arguments to pass to the `fn`.
     */
    evaluateOnNewDocument(fn: $npm$puppeteer$EvaluateFn, ...args: Array<mixed>): Promise<void>,
    ...
    frames(): Array<$npm$puppeteer$Frame>,
     ...
     */
    goBack(
      options?: $Shape<$npm$puppeteer$NavigationOptions>
    ): Promise<$npm$puppeteer$Response | null>,
    ...
    keyboard: $npm$puppeteer$Keyboard,

    /** Page is guaranteed to have a main frame which persists during navigation's. */
    mainFrame(): $npm$puppeteer$Frame,

    /** Gets the page metrics. */
    metrics(): Promise<$npm$puppeteer$Metrics>,

    /** Gets the virtual mouse. */
    mouse: $npm$puppeteer$Mouse,
     ...
     */
    on<K: $npm$puppeteer$PageEvents>(
      eventName: K,
      handler: (e: $ElementType<$npm$puppeteer$PageEventObj, K>, ...args: Array<mixed>) => void
    ): $npm$puppeteer$Page,
     ...
     * @param handler The callback function.
     */
    once<K: $npm$puppeteer$PageEvents>(
      eventName: K,
      handler: (e: $ElementType<$npm$puppeteer$PageEventObj, K>, ...args: Array<mixed>) => void
    ): $npm$puppeteer$Page,
     ...
     */
    pdf(options?: $Shape<$npm$puppeteer$PDFOptions>): Promise<Buffer>,

    /**
     * The method iterates JavaScript heap and finds all the objects with the given prototype.
     * @param prototypeHandle A handle to the object prototype.
     */
    queryObjects(prototypeHandle: $npm$puppeteer$JSHandle): Promise<$npm$puppeteer$JSHandle>,

    /**
     * Reloads the current page.
     * @param options The navigation parameters.
     */
    reload(options?: $npm$puppeteer$NavigationOptions): Promise<$npm$puppeteer$Response>,
     ...
     */
    setCookie(...cookies: Array<$npm$puppeteer$SetCookie>): Promise<void>,
     ...
     */
    setExtraHTTPHeaders(headers: $npm$puppeteer$Headers): Promise<void>,
     ...
     */
    setViewport(viewport: $npm$puppeteer$Viewport): Promise<void>,
    ...
    target(): $npm$puppeteer$Target,

    /** Returns the page's title. */
    title(): Promise<string>,

    /** Returns the virtual touchscreen object. */
    touchscreen: $npm$puppeteer$Touchscreen,

    /** Returns the tracing object. */
    tracing: $npm$puppeteer$Tracing,
     ...
     * @param options The navigation parameters.
     */
    waitForNavigation(options?: $npm$puppeteer$NavigationOptions): Promise<$npm$puppeteer$Response>,
  };

/** A Browser is created when Puppeteer connects to a Chromium instance, either through puppeteer.launch or puppeteer.connect. */
type $npm$puppeteer$Browser = EventEmitter & {
  /**
  ...
  newPage(): Promise<$npm$puppeteer$Page>,
   ...
   * @param handler The callback function.
   */
  on<K: $npm$puppeteer$BrowserEvents>(
    eventName: K,
    handler: (e: $ElementType<$npm$puppeteer$BrowserEventObj, K>, ...args: Array<mixed>) => void
  ): $npm$puppeteer$Browser,
   ...
   * @param handler The callback function.
   */
  once<K: $npm$puppeteer$BrowserEvents>(
    eventName: K,
    handler: (e: $ElementType<$npm$puppeteer$BrowserEventObj, K>, ...args: Array<mixed>) => void
  ): $npm$puppeteer$Browser,

  /** Promise which resolves to an array of all open pages. */
  pages(): Promise<Array<$npm$puppeteer$Page>>,
  ...
  targets(): Promise<Array<$npm$puppeteer$Target>>,
...
type $npm$puppeteer$LaunchOptions = {
...
type $npm$puppeteer$ConnectOptions = {
...
type $npm$puppeteer$CDPSession = EventEmitter & {
  /**
...
type $npm$puppeteer$Coverage = {
  startCSSCoverage(options?: $npm$puppeteer$StartCoverageOptions): Promise<void>,
  startJSCoverage(options?: $npm$puppeteer$StartCoverageOptions): Promise<void>,
  stopCSSCoverage(): Promise<Array<$npm$puppeteer$CoverageEntry>>,
  stopJSCoverage(): Promise<Array<$npm$puppeteer$CoverageEntry>>,
};

type $npm$puppeteer$StartCoverageOptions = {
  /** Whether to reset coverage on every navigation. Defaults to `true`. */
  resetOnNavigation?: boolean,
};

type $npm$puppeteer$CoverageEntry = {
...
declare module 'puppeteer' {
  ...
  declare function connect(
    options?: $npm$puppeteer$ConnectOptions
  ): Promise<$npm$puppeteer$Browser>;
  ...
  declare function launch(options?: $npm$puppeteer$LaunchOptions): Promise<$npm$puppeteer$Browser>;
}
