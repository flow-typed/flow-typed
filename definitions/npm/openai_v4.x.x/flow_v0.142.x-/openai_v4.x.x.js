declare module "openai" {
  ...
  declare var Moderation: typeof npm$namespace$Moderation;

  declare var npm$namespace$Moderation: {|
    Categories: Class<Moderation$Categories>,
    CategoryScores: Class<Moderation$CategoryScores>,
  |};
  ...
  declare export interface ModerationCreateResponse {
     ...
     */
    results: Array<typeof Moderation>;
  }
