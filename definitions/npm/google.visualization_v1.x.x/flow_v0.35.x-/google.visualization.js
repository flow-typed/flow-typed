...
declare function google$load(visualization: string, version: string, packages: any): void
...
declare function charts$load(visualization: string, version: string, packages: any): void
...
declare function visualization$arrayToDataTable(data: any[], firstRowIsData?: boolean): visualization$DataTable
...
declare export class GeoChart mixins ChartBase {
...
declare export class ScatterChart mixins CoreChartBase {
    draw(
...
declare export class ColumnChart mixins CoreChartBase {
...
declare export class LineChart mixins CoreChartBase {
...
declare export class BarChart mixins CoreChartBase {
...
declare export class Histogram mixins CoreChartBase {
...
declare export class AreaChart mixins CoreChartBase {
...
declare export class AnnotationChart mixins CoreChartBase {
    draw(
        data: visualization$DataTable,
...
declare export class SteppedAreaChart mixins CoreChartBase {
    draw(
        data: visualization$DataTable,
...
declare export class PieChart mixins CoreChartBase {
...
declare export class BubbleChart mixins CoreChartBase {
    draw(
        data: visualization$DataTable,
...
declare export class TreeMap mixins ChartBase {
...
declare export class Table mixins ChartBase {
...
declare export class CandlestickChart mixins CoreChartBase {
    draw(
        data: visualization$DataTable,
...
declare export class ComboChart mixins CoreChartBase {
...
declare function events$addListener(visualization: any, eventName: string, callback: Function): any
...
declare function events$trigger(visualization: any, eventName: string, args?: any): void
 ...
 */
declare export class ArrowFormat mixins DefaultFormatter {
 ...
 */
declare export class BarFormat mixins DefaultFormatter {
 ...
 */
declare export class ColorFormat mixins DefaultFormatter {
    constructor(): this;
 ...
 */
declare export class DateFormat mixins DefaultFormatter {
 ...
 */
declare export class NumberFormat mixins DefaultFormatter {
