...
declare type Knex$Identifier = string | Knex$Ref | Knex$Raw<R>;
...
declare type Knex$ComparisonOperator =
  ...
  | string;
declare type Knex$JoinConditionOperator = Knex$ComparisonOperator | Knex$Raw<R>;

declare type Knex$OrderByColumn = {
  column: string,
  order?: string,
  ...
};

declare type Knex$As = {|
  as: string,
|};
...
declare class Knex$QueryBuilder<R> mixins Promise<R> {
  ...
  orderBy(columns: Array<Knex$Identifier | Knex$OrderByColumn>): this;
  orderByRaw(sql: string, bindings?: Knex$RawBindings): this;
  orOn(builder: Knex$QueryBuilderFn<R> | knex$Raw<R>): this;
  orOn(
    column: Knex$Identifier,
    operator: Knex$JoinConditionOperator,
    value: any
