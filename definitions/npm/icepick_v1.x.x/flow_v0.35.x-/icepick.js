...
declare module 'icepick' {
		declare interface IcepickWrapper<T> {
		value(): T,
		...
		updateIn<T, V>(
		collection: T, path: Array<number | string>, callback: (value: V) => V
	): IcepickWrapper<T>,
	...
	declare export function updateIn<T, V>(
		collection: T, path: Array<number | string>, callback: (value: V) => V
	): T
	...
	declare export function assign<T, S1, S2, S3, S4>(
		target: T, s1: S1, s2: S2, s3: S3, s4: S4
	): (T & S1 & S2 & S3 & S4)
