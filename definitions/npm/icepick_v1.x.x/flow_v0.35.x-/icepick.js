/**
 * Flowtype definitions for icepick
...
declare module 'icepick' {
    ...
    declare interface IcepickWrapper<T>{
        ...
        V>(
            collection: T,
            path: Array<number | string>,
            callback: (value: V) => V): IcepickWrapper<T>,
        assign<S1>(source1: S1): IcepickWrapper<T & S1>,
        assign<S1,
        S2>(s1: S1, s2: S2): IcepickWrapper<T & S1 & S2>,
        assign<S1,
        S2,
        S3>(s1: S1, s2: S2, s3: S3): IcepickWrapper<T & S1 & S2 & S3>,
        assign<S1,
        S2,
        S3,
        S4>(
            ...
            s2: S2,
            s3: S3,
            s4: S4): IcepickWrapper<T & S1 & S2 & S3 & S4>,
