...
declare module 'devextreme-15.1.3' {
...
declare module 'devices' {
	...
	declare export function current(deviceName: any): void

	declare export function current(): Device

	declare export function orientation(): string

	declare export function real(): Device
