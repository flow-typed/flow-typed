...
declare var npm$namespace$SemVerModule: {
     ...
     */
declare function SemVerModule$valid(v: string, loose?: boolean): string


/**
 * Returns cleaned (removed leading/trailing whitespace, remove '=v' prefix) and parsed version, or null if version is invalid.
 */
declare function SemVerModule$clean(version: string, loose?: boolean): string


/**
 * Return the version incremented by the release type (major, minor, patch, or prerelease), or null if it's not valid.
 */
declare function SemVerModule$inc(v: string, release: string, loose?: boolean): string


/**
 * Return the major version number.
 */
declare function SemVerModule$major(v: string, loose?: boolean): number


/**
 * Return the minor version number.
 */
declare function SemVerModule$minor(v: string, loose?: boolean): number


/**
 * Return the patch version number.
 */
declare function SemVerModule$patch(v: string, loose?: boolean): number


/**
 * Returns an array of prerelease components, or null if none exist.
 */
declare function SemVerModule$prerelease(v: string, loose?: boolean): string[]


/**
 * v1>v2
 */
declare function SemVerModule$gt(v1: string, v2: string, loose?: boolean): boolean


/**
 * v1 >= v2
 */
declare function SemVerModule$gte(v1: string, v2: string, loose?: boolean): boolean


/**
 * v1<v2
 */
declare function SemVerModule$lt(v1: string, v2: string, loose?: boolean): boolean


/**
 * v1 <= v2
 */
declare function SemVerModule$lte(v1: string, v2: string, loose?: boolean): boolean


/**
 * v1 == v2 This is true if they're logically equivalent, even if they're not the exact same string. You already know how to compare strings.
 */
declare function SemVerModule$eq(v1: string, v2: string, loose?: boolean): boolean


/**
 * v1 != v2 The opposite of eq.
 */
declare function SemVerModule$neq(v1: string, v2: string, loose?: boolean): boolean
 ...
 */
declare function SemVerModule$cmp(v1: string, comparator: any, v2: string, loose?: boolean): boolean


/**
 * Return 0 if v1 == v2, or 1 if v1 is greater, or -1 if v2 is greater. Sorts in ascending order if passed to Array.sort().
 */
declare function SemVerModule$compare(v1: string, v2: string, loose?: boolean): number


/**
 * The reverse of compare. Sorts an array of versions in descending order when passed to Array.sort().
 */
declare function SemVerModule$rcompare(v1: string, v2: string, loose?: boolean): number


/**
 * Returns difference between two versions by the release type (major, premajor, minor, preminor, patch, prepatch, or prerelease), or null if the versions are the same.
 */
declare function SemVerModule$diff(v1: string, v2: string, loose?: boolean): string


/**
 * Return the valid range or null if it's not valid
 */
declare function SemVerModule$validRange(range: string, loose?: boolean): string


/**
 * Return true if the version satisfies the range.
 */
declare function SemVerModule$satisfies(version: string, range: string, loose?: boolean): boolean


/**
 * Return the highest version in the list that satisfies the range, or null if none of them do.
 */
declare function SemVerModule$maxSatisfying(versions: string[], range: string, loose?: boolean): string


/**
 * Return the lowest version in the list that satisfies the range, or null if none of them do.
 */
declare function SemVerModule$minSatisfying(versions: string[], range: string, loose?: boolean): string


/**
 * Return true if version is greater than all the versions possible in the range.
 */
declare function SemVerModule$gtr(version: string, range: string, loose?: boolean): boolean


/**
 * Return true if version is less than all the versions possible in the range.
 */
declare function SemVerModule$ltr(version: string, range: string, loose?: boolean): boolean
 ...
 */
declare function SemVerModule$outside(version: string, range: string, hilo: string, loose?: boolean): boolean
