// @flow
/**
 * Flowtype definitions for httperr
...
declare module 'httperr' {
    ...
    declare interface HttpErr {
        ...
        HttpError: HttpErrorStatic,
             ...
             * @param  - The HTTP response status code for the HTTP error.
             * @param  - A human-readable title for the HTTP error.
             * @param  - (optional) A function which will be invoked as a method of the
            ...
            */
            createHttpError(
                status: number,
                title: string,
                init?: (config: Config) => void): HttpErrorStatic,
    ...
    declare interface ErrorBuilder {
         ...
         * @param  - If config is a string, it will be treated as config.message.
