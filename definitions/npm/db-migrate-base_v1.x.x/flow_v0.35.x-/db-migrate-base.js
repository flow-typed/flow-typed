...
declare module 'db-migrate-base' {
	...
	declare export interface InternalModule {
		log: any,
		type: any
	}

	declare export interface InternalOptions {
		mod: InternalModule
	}
	...
	declare export interface ForeignKeySpec {
		name: string,
		table: string,
	...
	declare export interface ForeignKeyRules {
		onDelete: string,
		onUpdate: string
	}

	declare export interface RemoveForeignKeyOptions {
		dropIndex?: boolean
	}
	...
	declare export interface CreateTableOptions {
		columns?: Array<ColumnSpec>,
		ifNotExists?: boolean
	}

	declare export interface DropTableOptions {
		ifExists?: boolean
	}

		declare export class Base  {
		constructor(intern: InternalOptions): this;
		...
		bindForeignKey(
		tableName: string, columnName: string, fkOptions: ForeignKeySpec
	): (callback: CallbackFunction) => void;
		createColumnDef(name: string, spec: ColumnSpec, options?: any): ColumnDef;
		createMigrationsTable(callback: CallbackFunction): void;
		createSeedsTable(callback: CallbackFunction): void;
		createTable(
		tableName: string, options: any | CreateTableOptions, callback: CallbackFunction
	): void;
		dropTable(
		tableName: string, optionsOrCb?: DropTableOptions | CallbackFunction, callback?: CallbackFunction
	): void;
		renameTable(tableName: string, newTableName: string, callback: CallbackFunction): void;
		addColumn(
		tableName: string, columnName: string, columnSpec: ColumnSpec, callback: CallbackFunction
	): void;
		removeColumn(tableName: string, columnName: string, callback: CallbackFunction): void;
		renameColumn(
		tableName: string, oldColumnName: string, newColumnName: string, callback: CallbackFunction
	): void;
		changeColumn(
		tableName: string, columnName: string, columnSpec: ColumnSpec, callback: CallbackFunction
	): void;
		...
		addIndex(
		tableName: string, indexName: string, columns: string | Array<string>, uniqueOrCb?: boolean | CallbackFunction, callback?: CallbackFunction
	): void;
		insert(
		tableName: string, columnNameOrValueArray: any, valueArrayOrCb?: any | CallbackFunction, callback?: CallbackFunction
	): void;
		update(
		tableName: string, columnNameOrValueArray: any, valueArrayOrIds?: any, idsOrCb?: any | CallbackFunction, callback?: CallbackFunction
	): void;
		lookup(tableName: string, column: string, id?: any, callback?: CallbackFunction): void;
		removeIndex(
		tableNameOrIndexName: string, indexNameOrCb?: string | CallbackFunction, callback?: CallbackFunction
	): void;
		addForeignKey(
		tableName: string, referencedTableName: string, keyName: string, fieldMapping: any, rules: ForeignKeyRules, callback: CallbackFunction
	): void;
		removeForeignKey(
		tableName: string, keyName: string, optionsOrCb?: RemoveForeignKeyOptions | CallbackFunction, callback?: CallbackFunction
	): void;
		...
		runSql(
		sql?: string, paramsOrCb?: Array<any> | CallbackFunction, callback?: CallbackFunction
	): void;
		...
		remove(table: string, ids: any, callback: CallbackFunction): void;
		...
		addIndexAsync(
		tableName: string, indexName: string, columns: string | Array<string>, unique?: boolean
	): Promise<any>;
		insertAsync(
		tableName: string, columnNameOrValueArray: any, valueArrayOrCb?: any | CallbackFunction, callback?: CallbackFunction
	): Promise<any>;
		...
		lookupAsync(
		tableName: string, column: string, id?: any, callback?: CallbackFunction
	): Promise<any>;
		removeIndexAsync(tableNameOrIndexName: string, indexName?: string): Promise<any>;
		addForeignKeyAsync(
		tableName: string, referencedTableName: string, keyName: string, fieldMapping: any, rules: ForeignKeyRules
	): Promise<any>;
		removeForeignKeyAsync(
		tableName: string, keyName: string, options?: RemoveForeignKeyOptions
	): Promise<any>;
