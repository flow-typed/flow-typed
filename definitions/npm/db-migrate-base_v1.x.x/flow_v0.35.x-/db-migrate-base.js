/**
 * Flowtype definitions for db-migrate-base
...
declare module 'db-migrate-base' {
    ...
    declare export class Base {
        ...
        bindForeignKey(
            tableName: string,
            columnName: string,
            fkOptions: ForeignKeySpec): (callback: CallbackFunction) => void;
        ...
        createTable(
            tableName: string,
            options: any | CreateTableOptions,
            callback: CallbackFunction): void;
        dropTable(
            tableName: string,
            optionsOrCb?: DropTableOptions | CallbackFunction,
            callback?: CallbackFunction): void;
        ...
        removeIndex(
            ...
            indexNameOrCb?: string | CallbackFunction,
            callback?: CallbackFunction): void;
        addForeignKey(
            tableName: string,
        ...
        removeForeignKey(
            tableName: string,
            keyName: string,
            optionsOrCb?: RemoveForeignKeyOptions | CallbackFunction,
            callback?: CallbackFunction): void;
        ...
        runSql(
            sql?: string,
            paramsOrCb?: Array<any>| CallbackFunction,
            callback?: CallbackFunction): void;
        ...
        addIndexAsync(
            ...
            indexName: string,
            columns: string | Array<string>,
            unique?: boolean): Promise<any>;
        insertAsync(
            tableName: string,
            columnNameOrValueArray: any,
            valueArrayOrCb?: any | CallbackFunction,
            callback?: CallbackFunction): Promise<any>;
        updateAsync(
            tableName: string,
            columnNameOrValueArray: any,
            valueArrayOrIds?: any,
        ...
        addForeignKeyAsync(
            ...
            keyName: string,
            fieldMapping: any,
            rules: ForeignKeyRules): Promise<any>;
        removeForeignKeyAsync(
            tableName: string,
            keyName: string,
            options?: RemoveForeignKeyOptions): Promise<any>;
