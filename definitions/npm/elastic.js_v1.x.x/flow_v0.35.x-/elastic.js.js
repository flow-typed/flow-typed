...
declare module 'elasticjs' {
	...
	declare export interface ScoreFunction {
		...
		declare export class AggregationMixin extends Aggregation {
		_type(): string;
	...
	declare export class AndFilter extends Filter {
	...
	declare export class AvgAggregation extends Aggregation {
	...
	declare export class BoolFilter extends Filter {
		constructor(): this;
		_type(): string;
	...
	declare export class BoolQuery extends Query {
		constructor(): this;
		_type(): string;
	...
	declare export class BoostFactorScoreFunction extends ScoreFunction {
	...
	declare export class BoostingQuery extends Query {
	...
	declare export class CardinalityAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class CommonTermsQuery extends Query {
	...
	declare export class CompletionSuggester extends Suggest {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class ConstantScoreQuery extends Query {
		constructor(): this;
		_type(): string;
	...
	declare export class DateHistogramAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class DateHistogramFacet extends Facet {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class DateRangeAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class DecayScoreFunction extends ScoreFunction {
	...
	declare export class DirectGenerator extends Generator {
		constructor(): this;
		_type(): string;
	...
	declare export class DisMaxQuery extends Query {
		constructor(): this;
		_type(): string;
	...
	declare export class ExistsFilter extends Filter {
	...
	declare export class ExtendedStatsAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class FieldMaskingSpanQuery extends Query {
	...
	declare export class FilterAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class FilteredQuery extends Query {
	...
	declare export class FilterFacet extends Facet {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class FunctionScoreQuery extends Query {
		constructor(): this;
		_type(): string;
	...
	declare export class FuzzyLikeThisFieldQuery extends Query {
	...
	declare export class FuzzyLikeThisQuery extends Query {
	...
	declare export class FuzzyQuery extends Query {
	...
	declare export class GeoBboxFilter extends Filter {
		constructor(fieldName: string): this;
		_type(): string;
	...
	declare export class GeoDistanceAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class GeoDistanceFacet extends Facet {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class GeoDistanceFilter extends Filter {
		constructor(fieldName: string): this;
		_type(): string;
	...
	declare export class GeoDistanceRangeFilter extends Filter {
		constructor(fieldName: string): this;
		_type(): string;
	...
	declare export class GeoHashGridAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class GeoPoint extends Geo {
	...
	declare export class GeoShapeFilter extends Filter {
		constructor(): this;
		_type(): string;
	...
	declare export class GeoShapeQuery extends Query {
		constructor(): this;
		_type(): string;
	...
	declare export class GlobalAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class HasChildFilter extends Filter {
	...
	declare export class HasChildQuery extends Query {
		constructor(qry: Object, type: string): this;
		_type(): string;
	...
	declare export class HasParentFilter extends Filter {
	...
	declare export class HasParentQuery extends Query {
		constructor(qry: Object, parentType: string): this;
		_type(): string;
	...
	declare export class HistogramAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class HistogramFacet extends Facet {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class IdsFilter extends Filter {
	...
	declare export class IdsQuery extends Query {
		constructor(ids: string | string[]): this;
		_type(): string;
	...
	declare export class IndexedShape extends Geo {
	...
	declare export class IndicesFilter extends Filter {
	...
	declare export class IndicesQuery extends Query {
	...
	declare export class IPv4RangeAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class LimitFilter extends Filter {
	...
	declare export class MatchAllFilter extends Filter {
		constructor(): this;
		_type(): string;
	...
	declare export class MatchAllQuery extends Query {
		constructor(): this;
		_type(): string;
	...
	declare export class MatchQuery extends Query {
		constructor(field: string, qstr: string): this;
		_type(): string;
	...
	declare export class MaxAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class MetricsAggregationMixin extends Aggregation {
		_type(): string;
	...
	declare export class MinAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class MissingAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class MissingFilter extends Filter {
		constructor(fieldName: string): this;
		_type(): string;
	...
	declare export class MoreLikeThisFieldQuery extends Query {
		constructor(field: string, likeText: string): this;
		_type(): string;
	...
	declare export class MoreLikeThisQuery extends Query {
	...
	declare export class MultiMatchQuery extends Query {
	...
	declare export class NestedAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class NestedFilter extends Filter {
	...
	declare export class NestedQuery extends Query {
		constructor(path: string): this;
		_type(): string;
	...
	declare export class NotFilter extends Filter {
	...
	declare export class NumericRangeFilter extends Filter {
		constructor(fieldName: string): this;
		_type(): string;
	...
	declare export class OrFilter extends Filter {
	...
	declare export class PercentilesAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class PhraseSuggester extends Suggest {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class PrefixFilter extends Filter {
	...
	declare export class PrefixQuery extends Query {
		constructor(field: string, value: string): this;
		_type(): string;
	...
	declare export class QueryFacet extends Facet {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class QueryFilter extends Filter {
	...
	declare export class QueryStringQuery extends Query {
	...
	declare export class RandomScoreFunction extends ScoreFunction {
		constructor(): this;
		_type(): string;
	...
	declare export class RangeAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class RangeFacet extends Facet {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class RangeFilter extends Filter {
		constructor(field: string): this;
		_type(): string;
	...
	declare export class RangeQuery extends Query {
		constructor(field: string): this;
		_type(): string;
	...
	declare export class RegexpFilter extends Filter {
		constructor(field: string, value: string): this;
		_type(): string;
	...
	declare export class RegexpQuery extends Query {
		constructor(field: string, value: string): this;
		_type(): string;
	...
	declare export class ScoreFunctionMixin extends ScoreFunction {
		_type(): string;
	...
	declare export class ScriptFilter extends Filter {
	...
	declare export class ScriptScoreFunction extends ScoreFunction {
		constructor(): this;
		_type(): string;
	...
	declare export class Shape extends Geo {
	...
	declare export class SignificantTermsAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class SpanFirstQuery extends Query {
	...
	declare export class SpanMultiTermQuery extends Query {
	...
	declare export class SpanNearQuery extends Query {
	...
	declare export class SpanNotQuery extends Query {
	...
	declare export class SpanOrQuery extends Query {
	...
	declare export class SpanTermQuery extends Query {
		constructor(field: string, value: string): this;
		_type(): string;
	...
	declare export class StatisticalFacet extends Facet {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class StatsAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class SumAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class TermFilter extends Filter {
	...
	declare export class TermQuery extends Query {
	...
	declare export class TermsAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class TermsFacet extends Facet {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class TermsFilter extends Filter {
	...
	declare export class TermsQuery extends Query {
		constructor(field: string, terms: string | string[]): this;
		_type(): string;
	...
	declare export class TermStatsFacet extends Facet {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class TermSuggester extends Suggest {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class TopChildrenQuery extends Query {
		constructor(qry: Object, type: string): this;
		_type(): string;
	...
	declare export class TypeFilter extends Filter {
	...
	declare export class ValueCountAggregation extends Aggregation {
		constructor(name: string): this;
		_type(): string;
	...
	declare export class WildcardQuery extends Query {
		constructor(field: string, value: string): this;
		_type(): string;
