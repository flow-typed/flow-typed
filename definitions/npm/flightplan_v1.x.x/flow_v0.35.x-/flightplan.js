import type { Flightplan } from 'npm$namespace$FlightplanInterfaces'

declare module 'flightplan' {
					declare module.exports: Flightplan


}

declare module 'npm$namespace$FlightplanInterfaces' {
		declare interface CommandOptions {
		silent?: boolean,
		failsafe?: boolean
	}

	declare interface SudoOptions {
		user?: string
	}
	...
	declare interface Transport {
		...
		transfer(
		files: CommandResult, remoteDir: string, options?: CommandOptions
	): Array<CommandResult>,
		transfer(
		files: CommandResult[], remoteDir: string, options?: CommandOptions
	): Array<CommandResult>,
		transfer(
		files: string[], remoteDir: string, options?: CommandOptions
	): Array<CommandResult>,
