/**
 * Flowtype definitions for dojox.rpc
...
*/
declare interface rpc$OfflineRest {
    ...
    stores: any[],
         ...
         */
        addStore(store: undefined.Read, baseQuery: String): void,
 ...
 */
declare interface rpc$JsonRest {
