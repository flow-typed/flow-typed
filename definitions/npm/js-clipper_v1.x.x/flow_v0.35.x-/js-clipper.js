...
declare module 'npm$namespace$ClipperLib' {
			declare export function Math_Abs_Int64(a: number): number

	declare export function Math_Abs_Int32(a: number): number

	declare export function Math_Abs_Double(a: number): number

	declare export function Math_Max_Int32_Int32(a: number, b: number): number

	declare export function Cast_Int32(a: number): number

	declare export function Cast_Int64(a: number): number

	declare export function Clear(a: ArrayLike<any>): void
	...
	declare export function Clean(
		polygon: ArrayLike<IntPoint> | ArrayLike<ArrayLike<IntPoint>>, delta: number
	): ArrayLike<IntPoint> | ArrayLike<ArrayLike<IntPoint>>

	declare export function Lighten(
		polygon: ArrayLike<IntPoint> | ArrayLike<ArrayLike<IntPoint>>, tolerance: number
	): ArrayLike<IntPoint> | ArrayLike<ArrayLike<IntPoint>>
	...
	declare export class IntPoint  {
		...
		Y: number;
		constructor(): this;
		constructor(PointXY: IntPoint): this;
	...
	declare export class Polygon  {
		constructor(): this;
		constructor(poly: ArrayLike<IntPoint>): this
	}

	declare export class Polygons  {
		constructor(): this;
		constructor(polys: ArrayLike<ArrayLike<IntPoint>>): this
	}
	...
	declare export class ClipperBase  {
		...
		AddPolygon(
		pg: ArrayLike<IntPoint>, polyType: PolyType, multiple: boolean
	): boolean | string;
	...
	declare export class Clipper extends ClipperBase {
		...
		Execute(
		clipType: ClipType, solution: ArrayLike<IntPoint> | ExPolygon, subjFillType: PolyFillType, clipFillType: PolyFillType
	): boolean;
		...
		GetOverlapSegment(
		pt1a: IntPoint, pt1b: IntPoint, pt2a: IntPoint, pt2b: IntPoint, pt1: IntPoint, pt2: IntPoint
	): boolean;
		...
		OffsetPolygons(
		poly: Polygon, delta: number, jointype: JoinType, MiterLimit: number, AutoFix: boolean
	...
	declare export class PolyOffsetBuilder  {
		...
		constructor(pts: Polygons, solution: {
		value: Polygons
