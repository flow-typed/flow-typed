...
declare
export function ClipperLib$Math_Abs_Int64(a: number): number

declare
export function ClipperLib$Math_Abs_Int32(a: number): number

declare
export function ClipperLib$Math_Abs_Double(a: number): number

declare
export function ClipperLib$Math_Max_Int32_Int32(a: number, b: number): number

declare
export function ClipperLib$Cast_Int32(a: number): number

declare
export function ClipperLib$Cast_Int64(a: number): number

declare
export function ClipperLib$Clear(a: ArrayLike<any>): void
...
declare
export class Clipper mixins ClipperBase {
...
declare
export function ClipperLib$Error(message: string): void

declare
export function ClipperLib$Clone(
    ...
    declare
export function ClipperLib$Clean(
    ...
    declare
export function ClipperLib$Lighten(
    polygon: ArrayLike<ClipperLib$IntPoint>| ArrayLike<ArrayLike<ClipperLib$IntPoint >> ,
