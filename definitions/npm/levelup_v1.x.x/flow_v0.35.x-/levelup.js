...
declare module 'levelup' {
	...
	declare interface LevelUpChain {
		put(key: any, value: any): LevelUpChain,
		put(key: any, value: any, options?: {
		sync?: boolean
	}): LevelUpChain,
	...
	declare interface levelupOptions {
	...
	declare function levelup(hostname: string, options?: levelupOptions): LevelUp
...
declare module 'leveldown' {
			declare export function destroy(location: string, callback?: Function): void

	declare export function repair(location: string, callback?: Function): void
