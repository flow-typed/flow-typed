/**
 * Flowtype definitions for microsoft.ajax
 ...
 * @see  {
 * @link  http://msdn.microsoft.com/en-us/library/bb310818(v=vs.100).aspx}Provides extended reflection-like functionality to the base ECMAScript (JavaScript) Object object.
 ...
 * @see  {
 * @link  http://msdn.microsoft.com/en-us/library/bb310835(v=vs.100).aspx}
 */
...
declare interface DateConstructor {
     ...
     * @param value A locale-specific string that represents a date.
     * @param formats (Optional) An array of custom formats.
     */
...
declare interface FunctionConstructor {
    ...
    createCallback(method: Function, ...context: any[]): Function,
        ...
        validateParameters(
            ...
            validateParameterCount?: boolean): any
}
/**
 ...
 * @see  {
 * @link  http://msdn.microsoft.com/en-us/library/bb310947(v=vs.100).aspx}
 */
 ...
 * @see  {
 * @link  http://msdn.microsoft.com/en-us/library/bb397557(v=vs.100).aspx}
 */
...
declare class Type {
     ...
     * @param method The function for which the callback method will be created.
     * @param context The parameter to pass to the function. This parameter can be null, but it cannot be omitted.
     */
     ...
     * @param instance The object instance that will be the context for the function. This parameter can be null.
     ...
     * @param instance The instance for which the base method is requested.
     * @param name The name of the method to retrieve as a reference.
     */
    ...
    */
     ...
     * @param interfaceType The interface to test.
     ...
     * @param parentType The fully qualified name of the class to test as a base class for the current instance.
     ...
     * @param baseArguments (Optional) The arguments for the base constructor. Can be null.
     */
    ...
    /**
     * Get a value that indicates whether the specified type is an integer of flags.The type to test.
     ...
     * @param typeInstanceVar The instance on which the interface is tested.
     * @return  
     */
     ...
     * @param typeName A string that represents a fully qualified class name. Can be null.
     * @param ns (Optional) The namespace that contains the class.
     ...
     * @param baseType (Optional) The base type.
     * @param interfaceTypes (Optional) An unbounded array of interface type definitions that the type implements.
     ...
     * @param name The fully-qualified name of the enumeration.
     * @param flags (Optional) true if the enumeration is a collection of flags; otherwise, false.
     */
    registerEnum(name: string, flags?: boolean): void;

    /**
     * Registers an interface defined by a constructor.
     * @param typeName A string that represents the fully qualified name of the class to be registered as an interface.
     ...
     * @param namespacePath A string that represents the fully qualified namespace to register.
     */
 ...
 * @param properties (Optional) A JSON object that describes the properties and their values.
 * @param events (Optional) A JSON object that describes the events and their handlers.
 * @param references (Optional) A JSON object that describes the properties that are references to other components.
...
declare function $create(
    ...
    events?: any,
    references?: any,
    element?: HTMLElement): Sys$Component
/**
...
*/
declare type Sys$Application = {
    constructor(): void,

    /**
     * Raised after all scripts have been loaded but before objects are created.
     */
    add_init(handler: (sender: Sys$Application, eventArgs: Sys$EventArgs) => void): void,

    /**
     * Raised after all scripts have been loaded but before objects are created.
     */
    remove_init(handler: (sender: Sys$Application, eventArgs: Sys$EventArgs) => void): void,

    /**
     * Raised after all scripts have been loaded and after the objects in the application have been created and initialized.
     */
    add_load(
        handler: (sender: Sys$Application, eventArgs: Sys$ApplicationLoadEventArgs) => void): void,
     ...
     */
    add_navigate(
        handler: (sender: Sys$Application, eventArgs: Sys$HistoryEventArgs) => void): void,
     ...
     * @param childNodesOnly A boolean value used to determine whether to dispose of the element and its child nodes or to dispose only its child nodes.
     */
     ...
     */
    removeComponent(component: Sys$Component): void,
    ...
    /**
     * Gets or sets a value that indicates whether the Web application supports history point management.
     * @param value true to allow the Web application to support history points, or false to not allow history points.
     */
 ...
 * @see  {
 * @link  http://msdn.microsoft.com/en-us/library/cc679064(v=vs.100).aspx}
 */
declare interface Sys$Browser {
...
declare class Component {
    ...
    */
     ...
     * @return  *      An EventHandlerList object that contains references to all the events and handlers for this component.
     */
    get_events(): any;
     ...
     * @return  *      true if the current Component is initialized; otherwise, false.
     */
    get_isInitialized(): boolean;

    /**
     * Gets a value indicating whether the current Component object is updating.
     * @return  *      true if the current Component object is updating; otherwise, false.
     */
...
declare class CultureInfo {
     ...
     * @param name The culture value (locale) that represents a language and region.
     * @param numberFormat A culture-sensitive numeric formatting string.
     * @param dateTimeFormat A culture-sensitive date formatting string.
     */
    ...
    */
     ...
     */
    InvariantCulture: Sys$CultureInfo;
     ...
     */
    CurrentCulture: Sys$CultureInfo;
...
declare class Debug {
     ...
     * @param displayCaller (Optional) true to indicate that the name of the function that is calling assert should be displayed in the message. The default is false.
    */
 ...
 * @see  {
 * @link  http://msdn.microsoft.com/en-us/library/bb397705(v=vs.100).aspx}
...
declare class StringBuilder {
     ...
     * @param initialText (Optional) The string that is used to initialize the value of the instance. If the value is null, the new StringBuilder instance will contain an empty string ("").
     */
     ...
     * @param text The string to append to the end of the StringBuilder instance.
     */
     ...
     * @param text (Optional) The string to append with a line terminator to the end of the StringBuilder instance.
     */
     ...
     * @param separator (Optional) A string to append between each element of the string that is returned.
 ...
 */
declare interface Sys$IContainer {
     ...
     */
    addComponent(component: Sys$Component): void,
         ...
         * @param id The ID of the Component object to search for.
         * @return  The Component instance with the specified ID.
         */
        findComponent(id: string): Sys$Component,
...
*/
declare interface Sys$IDisposable {
 ...
 */
declare interface Sys$INotifyDisposing {

    /**
     * Occurs when an object's resources are released.
     * @param handler The name of the event handler for the disposing event.
     */
    add_disposing(handler: Function): void,
 ...
 */
declare interface Sys$INotifyPropertyChange {

    /**
     * Occurs when a component property is set to a new value.
     * @param handler The name of the event handler for the propertyChanged event.
     */
    add_propertyChanged(handler: Function): void,
...
declare class ApplicationLoadEventArgs {
     ...
     * @param components The list of components that were created since the last time the load event was raised.
     * @param isPartialLoad true to indicate that the event is a partial-page update.
     */
 ...
 */
declare class CommandEventArgs mixins EventArgs {
 ...
 */
declare class CancelEventArgs mixins EventArgs {
 ...
 */
declare class HistoryEventArgs mixins EventArgs {
 ...
 */
declare class NotifyCollectionChangedEventArgs mixins EventArgs {
     ...
     */
    constructor(changes: Sys$CollectionChange): this;
     ...
     */
    get_changes(): Sys$CollectionChange[]
}
 ...
 */
declare class PropertyChangedEventArgs mixins EventArgs {
 ...
 * @see  {
 * @link  http://msdn.microsoft.com/en-us/library/bb310823(v=vs.100).aspx}
 */
declare class WebServiceProxy {
    invoke(
        ...
        useGet?: boolean,
        params?: any,
        onSuccess?: (result: string, eventArgs: Sys$EventArgs) => void,
        onFailure?: (error: Net$WebServiceError) => void,
        userContext?: any,
        timeout?: number,
        enableJsonp?: boolean,
        jsonpCallbackParameter?: string): Net$WebRequest
}
...
declare class NetworkRequestEventArgs {
     ...
     */
    constructor(value: Net$WebRequest): this;
...
declare class WebRequest {
    ...
    get_executor(): Net$WebRequestExecutor;
    set_executor(value: Net$WebRequestExecutor): void;
...
declare class WebRequestExecutor {
    ...
    */
     ...
     */
    get_webRequest(): undefined.WebRequest
}
...
declare class IWebRequestManager {
     ...
     * @param handler The function registered to handle the completed request event.
     */
    add_completedRequest(
        handler: (sender: Net$WebRequestExecutor, eventArgs: Sys$EventArgs) => void): void;

    /**
     * Registers a handler for processing the invoking request event of the WebRequestManager.
     * @param handler The function registered to handle the invoking request event.
     */
    add_invokingRequest(
        handler: (
            sender: Net$WebRequestExecutor,
            networkRequestEventArgs: Net$NetworkRequestEventArgs) => void): void;
     ...
     */
    executeRequest(WebRequest: undefined.WebRequest): void;
     ...
     * @param handler The function that handles the completed request event.
     */
     ...
     * @param handler The function that handles the invoking request event.
     */
     ...
     */
    get_defaultExecutorType(): undefined.WebRequestExecutor;

    /**
     * Gets or sets the default network executor type that is used to make network requests.
     * @param value A reference to an implementation of the WebRequestExecutor class.
     */
    set_defaultExecutorType(value: undefined.WebRequestExecutor): void;

    /**
     * Gets or sets the time-out for the default network executor.
     * @return  *      An integer value that indicates the current time-out for the default executor.
     */
     ...
     * @param value The time in milliseconds that the default executor should wait before timing out a Web request. This value must be 0 or a positive integer.
     */
...
declare class AuthenticationService {
     ...
     * @param password The user's password. The default is null.
     * @param isPersistent true if the issued authentication ticket should be persistent across browser sessions; otherwise, false. The default is false.
     * @param redirctUrl The URL to redirect the browser to on successful login. The default is null.
     * @param customInfo 
     * @param loginCompletedCallback The function to call when the login has finished successfully. The default is null.
     * @param failedCallback The function to call if the login fails. The default is null.
     * @param userContext User context information that you are passing to the callback functions.
     ...
     * @param redirectUrl The URL to redirect the browser to on successful logout. The default is null.
     * @param logoutCompletedCallback The function that is called when the logout has finished. The default is null.
     * @param failedCallback The function that is called if the logout has failed. The default is null.
     * @param userContext User context information that you are passing to the callback functions.
    */
    logout(
        redirectUrl: string,
    ...
    /**
     * Gets or sets the name of the default failure callback function.
     * @param value A string that contains the name of the default failure callback function.
     */
    ...
    /**
     * Gets or sets the default succeeded callback function for the service.
     * @param value A reference to the succeeded callback function for the service.
     */
    ...
    /**
     * Gets or sets the default user context for the service.
     * @param value A reference to the user context for the service.
     */
     ...
     * @param value The authentication service path.
    */
     ...
     * @param value The time-out value in milliseconds.
    */
    set_timeout(value: number): void;
...
declare class ProfileGroup {
     ...
     * @param properties (Optional) An object that contains the settings for this profile group. This parameter can be null.
     */
 ...
 * @see  {
 * @link  http://msdn.microsoft.com/en-us/library/bb513880(v=vs.100).aspx}
 */
...
declare class ProfileService {
     ...
     * @example  *      Sys.Services.ProfileService.load(null, LoadCompletedCallback, ProfileFailedCallback, null);
     * @param propertyName A string array that contains the profile properties to load.
     * @param loadCompletedCallback The function that is called when loading has completed. The default is null.
     * @param failedCallback The function that is called when loading has failed. The default is null.
     * @param userContext User context information passed to the callback functions.
    */
    load(
    ...
    /**
     * 
     * @param propertyNames A string array that contains the profile properties to save.
     * @param saveCompletedCallback The function that is called when the save method has finished. The default is null.
     * @param failedCallback The function that is called if the save method has failed. The default is null.
     * @param userContext User context information passed to the callback functions.
     */
    save(
        propertyNames: string[],
     ...
     * @param value A string that contains the name of the default load-completed callback function.
     */
     ...
     * @param value A string that contains the name of the default save-completed callback function.
     */
     ...
     * @param value A string that contains the profile service path.
     */
    set_path(value: string): void;
 ...
 */
declare class Behavior mixins Sys$Component {
     ...
     */
    getBehaviorByName(element: HTMLElement, name: string): UI$Behavior;
     ...
     */
    getBehaviorsByType(element: HTMLElement, type: undefined.Behavior): UI$Behavior[];
     ...
     */
    getBehaviors(element: UI$DomElement): UI$Behavior[];
    ...
    /**
     * Gets or sets the identifier for the Sys.UI.Behavior object.
     * @param value The string value to use as the identifier.
     */
    set_id(value: string): void;
 ...
 */
declare class Control mixins Sys$Component {
     ...
     * @param element The HTMLElement object that the control will be associated with.
     ...
     * @param className A string that contains the name of the CSS class to add.
     */
    ...
    */
     ...
     * @param className A string that contains the name of the CSS class to remove.
     */
    removeCssClass(className: string): void;

    /**
     * Toggles a CSS class of the HTML Document Object Model (DOM) element that the control is attached to.
     * @param className A string that contains the name of the CSS class to toggle.
     */
...
declare interface UI$DomElement {
     ...
     * @param element The HTMLElement object to add the CSS class to.
    ...
    addCssClass(element: HTMLElement, className: string): void,
         ...
         * @param element The HTMLElement object to test for the CSS class.
         * @param className The name of the CSS class to test for.
         * @return  *          true if the element contains the specified CSS class; otherwise, false.
         */
         ...
         * @param element The HTMLElement instance to get the coordinates of.
         * @return  *      An object of the JavaScript type Object that contains the x-coordinate and y-coordinate of the upper-left corner, the width, and the height of the element in pixels.
         */
         ...
         * @param element (optional) The parent element to search in. The default is the document element.
         */
         ...
         */
        getLocation(element: HTMLElement): undefined.Point,
        getVisibilityMode(element: HTMLElement): undefined.VisibilityMode,
         ...
         * @return  *      true if element is visible on the Web page; otherwise, false
         */
         ...
         * @param obj An object
         * @return  *      true if the object is a DOM element; otherwise, false.
         */
         ...
         * @param source The DOM element that triggers the event.
         * @param args The event arguments
         */
        raiseBubbleEvent(source: HTMLElement, args: Sys$EventArgs): void,
         ...
         * @param element The HTMLElement object to remove the CSS class from.
         ...
         * @param elementOrElementId The element to resolve, or the ID of the element to resolve. This parameter can be null.
         * @param containerElement (Optional) The specified container.
        ...
        */
        setVisibilityMode(element: HTMLElement, value: undefined.VisibilityMode): void,
         ...
         * @param element The target DOM element.
         * @param value true to make element visible on the Web page; false to hide element.
        */
         ...
         * @param element The HTMLElement object to toggle.
 ...
 * @see  {
 * @link  http://msdn.microsoft.com/en-us/library/bb310935(v=vs.100).aspx}
 */
declare class DomEvent {
    ...
    */
    ...
    removeHandler(
        element: HTMLElement,
        eventName: string,
        handler: (e: UI$DomEvent) => void): void;
 ...
 */
declare class BeginRequestEventArgs mixins EventArgs {
     ...
     * @param postBackElement The postback element that initiated the async postback.
     ...
     */
    constructor(request: undefined.WebRequest, postBackElement: any, updatePanelsToUpdate: string[]): this;
     ...
     */
    get_request(): undefined.WebRequest;
 ...
 */
declare class EndRequestEventArgs mixins EventArgs {

    /**
     * Initializes a new instance of the EndRequestEventArgs class.
     * @param error An error object.
     * @param dataItems An object containing data items.
     * @param response An object of type Sys.Net.WebRequestExecutor.
     */
    constructor(error: Error, dataItems: any, response: undefined.WebRequestExecutor): this;
     ...
     */
    get_response(): undefined.WebRequestExecutor
}
 ...
 */
declare class InitializeRequestEventArgs mixins EventArgs {

    /**
     * Initializes a new instance of the EndRequestEventArgs class.
     * @param request A Sys.Net.WebRequest object that represents the Web request for the EventArgs object.
     * @param datapostBackElementItems The postback element that initiated the asynchronous postback.
     ...
     */
    get_request(): undefined.WebRequestExecutor;
 ...
 */
declare class PageLoadedEventArgs mixins EventArgs {
 ...
 */
declare class PageLoadingEventArgs mixins EventArgs {
...
declare class PageRequestManager {
     ...
     * @param beginRequestHandler The name of the handler method that will be called.
     */
    add_beginRequest(
        beginRequestHandler: (sender: any, args: WebForms$BeginRequestEventArgs) => void): void;

    /**
     * Raised before the processing of an asynchronous postback starts and the postback request is sent to the server.
     *   
     * @param beginRequestHandler The handler method that will be removed.
     */
    remove_beginRequest(beginRequestHandler: Function): void;

    /**
     * Raised after an asynchronous postback is finished and control has been returned to the browser.
     * @param endRequestHandler The name of the handler method that will be called.
     */
    add_endRequest(
        endRequestHandler: (sender: any, args: undefined.EndRequestEventArgs) => void): void;

    /**
     * Raised after an asynchronous postback is finished and control has been returned to the browser.
     * @param endRequestHandler The name of the handler method that will be removed.
     */
    remove_endRequest(
        endRequestHandler: (sender: any, args: undefined.EndRequestEventArgs) => void): void;
     ...
     * @param initializeRequestHandler The name of the handler method that will be called.
     */
    add_initializeRequest(
        initializeRequestHandler: (sender: any, args: WebForms$InitializeRequestEventArgs) => void): void;
     ...
     * @param pageLoadedHandler The name of the handler method that will be called.
     */
    add_pageLoaded(
        pageLoadedHandler: (sender: any, args: WebForms$PageLoadedEventArgs) => void): void;
     ...
     */
    add_pageLoading(
        pageLoadingHandler: (sender: any, args: WebForms$PageLoadingEventArgs) => void): void;
     ...
     */
    getInstance(): WebForms$PageRequestManager;
 ...
 * @see  {
 * @link  http://msdn.microsoft.com/en-us/library/bb397466(v=vs.100).aspx}
*/
