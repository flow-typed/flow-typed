...
declare export function QioFS$open(path: string, options?: any): Q.Promise<any >

    declare export function QioFS$read(path: string, options?: any): Q.Promise<any >

    declare export function QioFS$write(path: string, content: Buffer, options?: any): Q.Promise<void >

    declare export function QioFS$append(path: string, content: Buffer, options?: any): Q.Promise<void >

    declare export function QioFS$copy(source: string, target: string): Q.Promise<void >

    declare export function QioFS$copyTree(source: string, target: string): Q.Promise<void >
    ...
    declare export function QioFS$listDirectoryTree(path: string): Q.Promise<string[] >

    declare export function QioFS$makeDirectory(path: string, mode?: string): Q.Promise<void >

    declare export function QioFS$makeTree(path: string, mode?: string): Q.Promise<void >
    ...
    declare export function QioFS$rename(source: string, target: string): Q.Promise<void >

    declare export function QioFS$move(source: string, target: string): Q.Promise<void >

    declare export function QioFS$link(source: string, target: any): Q.Promise<void >

    declare export function QioFS$symbolicCopy(source: string, target: string, type: string): Q.Promise<void >

    declare export function QioFS$symbolicLink(target: string, link: string, type: string): Q.Promise<void >

    declare export function QioFS$chown(path: string, uid: number, gid: number): Q.Promise<void >

    declare export function QioFS$chmod(path: string, mode?: string): Q.Promise<void >
    ...
    declare export function QioFS$isSymbolicLink(path: string): Q.Promise<boolean >
...
declare export function QioFS$canonical(path: string): Q.Promise<string >
    ...
    declare export function QioFS$contains(parent: string, child: string): boolean

declare export function QioFS$relative(source: string, target: string): Q.Promise<string >

    declare export function QioFS$relativeFromFile(source: string, target: string): string

declare export function QioFS$relativeFromDirectory(source: string, target: string): string
...
declare export function QioFS$toObject(path: string): {
    [path: string]: Buffer
}
...
declare export function QioHTTP$request(request: QioHTTP$Request): Q.Promise<QioHTTP$Response >

    declare export function QioHTTP$read(path: string, options?: any): Q.Promise<any >

    declare export function QioHTTP$normalizeRequest(request: QioHTTP$Request): QioHTTP$Request

declare export function QioHTTP$normalizeResponse(response: QioHTTP$Response): QioHTTP$Response
