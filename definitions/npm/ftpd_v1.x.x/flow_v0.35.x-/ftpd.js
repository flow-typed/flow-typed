...
declare module 'ftpd' {
    ...
    declare export interface FtpServerOptions {
        ...
        getInitialCwd: (
                ...
                callback?: (error: Error, path: string) => void) => void | string,
    ...
    */
    ...
    declare export interface FtpFileSystem {
        unlink: (path: string, callback?: (err?: NodeJS.ErrnoException) => void) => void,
            ...
            stat: (
                path: string,
                callback?: (err: NodeJS.ErrnoException, stats: fs.Stats) => any) => void,
