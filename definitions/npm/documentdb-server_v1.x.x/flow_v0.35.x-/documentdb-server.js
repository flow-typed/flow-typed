// @flow
/**
 * Flowtype definitions for documentdb-server
...
declare interface IQueryAPI {
    ...
    filter(
            ...
            callback?: (
                ...
                options: IFeedCallbackOptions) => void): IQueryResponse,
        filter<T>(
            predicate: (document: Object) => boolean,
            options?: IFeedOptions,
            callback?: (
         ...
         */
        sortBy(
            predicate: (document: Object) => string,
            options?: IFeedOptions,
            callback?: (
                error: IFeedCallbackError,
                resources: Array<Object>,
                options: IFeedCallbackOptions) => void): IQueryResponse,
        sortBy(
            predicate: (document: Object) => number,
            options?: IFeedOptions,
            callback?: (
                error: IFeedCallbackError,
                resources: Array<Object>,
...
declare type ICollection = {
    ...
    createAttachment(
        ...
        callback?: (
            ...
            resources: Object,
            options: IRequestCallbackOptions) => void): boolean,
    ...
    queryAttachments(
        ...
        callback?: (
            error: IFeedCallbackError,
            resources: Array<Object>,
            options: IFeedCallbackOptions) => void): boolean,
    queryAttachments(
        documentLink: string,
