// @flow
/**
 * Flowtype definitions for express-openapi
...
declare module 'express-openapi' {
    ...
    declare module 'OpenApi' {
        ...
        declare         export interface OperationObject {
            tags?: string[],
                ...
                schemes?: string[],
                deprecated?: boolean,
                security?: SecurityRequirementObject[], [index: string]: any
        }
    ...
    declare     export type OperationFunction = {
        apiDoc?: OpenApi.OperationObject
    }
    declare     export interface OperationHandlerArray {
        apiDoc?: OpenApi.OperationObject, [index: number]: express.RequestHandler
    }
