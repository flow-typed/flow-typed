/**
 * Flowtype definitions for socket.io
...
declare interface SocketIO$Server {
    engine: {
        ...
        */
        ...
        on(
            event: "connection",
            listener: (socket: SocketIO$Socket) => void): SocketIO$Namespace,
...
different return)
*/
declare interface SocketIO$Socket {
    ...
    nsp: SocketIO$Namespace,
        ...
        */
         ...
         * @return  This Socket
        */
        on(event: string, fn: Function): SocketIO$Socket,

        /**
         * 
         * @see  on( event, fn )
         */
        addListener(event: string, fn: Function): SocketIO$Socket,
         ...
         * @return  This Socket
        */
        once(event: string, fn: Function): SocketIO$Socket,
         ...
         * @return  This Socket
         */
        removeListener(event: string, fn?: Function): SocketIO$Socket,

        /**
         * Removes all event listeners on this object
         * @return  This Socket
         */
        removeAllListeners(event?: string): SocketIO$Socket,
         ...
         * @return  This Socket
         */
        setMaxListeners(n: number): SocketIO$Socket,
