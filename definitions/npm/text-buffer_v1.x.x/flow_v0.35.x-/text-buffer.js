import type { ITextBufferStatic } from 'npm$namespace$TextBuffer'

declare module 'text-buffer' {
					declare module.exports: ITextBufferStatic


}

declare module 'npm$namespace$TextBuffer' {
	...
	declare interface IRangeStatic {
	...
	declare interface IMarkerManager {
	...
	declare interface IBufferPatch {
		
	}

	declare interface ITextBufferStatic {
		Point: IPointStatic,
		Range: IRangeStatic,
		newlineRegex: any,
	...
	declare interface ITextBuffer {
		...
		buildPatch(
		oldRange: IRange, newText: string, normalizeLineEndings?: boolean
	): IBufferPatch,
