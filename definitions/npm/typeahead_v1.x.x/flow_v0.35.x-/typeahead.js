/**
 * Flowtype definitions for typeahead
...
declare interface JQuery {
     ...
     */
    typeahead<T>(options: undefined.Options, datasets: undefined.Dataset<T>[]): JQuery,
        ...
        typeahead<T>(
            ...
            dataset: undefined.Dataset<T>,
            ...datasets: undefined.Dataset<T>[]): JQuery,
    ...
    */
    declare interface Dataset<T>{
        ...
        */
        source: Bloodhound<T>| ((
            query: string,
            syncResults: (result: T[]) => void,
            asyncResults?: (result: T[]) => void) => void),
...
declare interface Bloodhound$BloodhoundOptions<T>{
    ...
    */
     ...
     */
    prefetch?: string | Bloodhound$PrefetchOptions<T>,
    ...
    */
    remote?: string | Bloodhound$RemoteOptions<T >
}
...
*/
declare interface Bloodhound$PrefetchOptions<T>{
...
*/
declare interface Bloodhound$RemoteOptions<T>{
 ...
 */
declare interface Bloodhound$Tokenizers {
    ...
    whitespace(str: string): string[],
         ...
         */
        obj: Bloodhound$ObjTokenizer
}

declare interface Bloodhound$ObjTokenizer {
...
declare module 'bloodhound' {
    declare module.exports: typeof Bloodhound
}