...
declare module 'twit' {
				declare class Twit  {
		constructor(config: Twit.Options): this;
...
declare module 'Twit' {
	declare export type StreamEndpoint = "statuses/filter" | "statuses/sample" | "statuses/firehose" | "user" | "site";
	...
	declare export interface PromiseResponse {
		data: Response,
	...
	declare export interface ConfigKeys {
		consumer_key: string,
...
declare module 'Twitter' {
	declare export type ResultType = "mixed" | "popular" | "recent";

	declare export interface Contributors {
		id: number,
		id_str: number,
		screen_name: string
	}

	declare export interface HashtagEntity {
		indices: number[],
		text: string
	}
	...
	declare export interface Sizes {
		thumb: Size,
		large: Size,
		medium: Size,
		small: Size
	...
	declare export interface MediaEntity {
		id: number,
		id_str: string,
		indices: number[],
		url: string,
	...
	declare export interface UserMentionEntity {
		id: number,
		id_str: string,
		indices: number[],
		name: string,
	...
	declare export interface PlaceAttribute {
