import type { WuStatic } from 'npm$namespace$Wu'

declare module 'wu' {
					
}

declare module 'npm$namespace$Wu' {
	declare type Consumer<T> = (t: T) => void;

	declare type Filter<T> = (t: T) => boolean;

	declare export interface WuStatic {
		(iterable: Iterable<T>): WuIterable<T>,
	...
	declare export interface WuIterable<T> {
