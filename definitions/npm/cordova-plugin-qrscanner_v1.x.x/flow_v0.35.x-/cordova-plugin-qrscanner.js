/**
 * Flowtype definitions for cordova-plugin-qrscanner
...
declare interface QRScanner {
     ...
     * @param  Callback that gets an error or the QRScannerStatus object.
    */
    prepare: (callback?: (error: QRScannerError, status: QRScannerStatus) => any) => void,
         ...
         * @param  Callback that gets an error or the results string.
        */
         ...
         * @param  Callback that gets the QRScannerStatus object.
         */
        ...
        */
        ...
        this method performs that setup as well.
         * @param  A number representing the index of the camera to use.
         * @param  Callback that gets an error or the QRScannerStatus object.
        */
        useCamera: (
            index: Number,
            callback?: (error: QRScannerError, status: QRScannerStatus) => any) => void,
