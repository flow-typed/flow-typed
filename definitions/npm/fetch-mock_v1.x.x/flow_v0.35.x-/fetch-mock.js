// @flow
/**
 * Flowtype definitions for fetch-mock
...
declare module 'fetch-mock' {
    ...
    */
    declare type MockResponse = Response |
        Promise<Response >
        |
        number |
        Promise<number >
    ...
    declare type MockOptionsMethodGet = {
        method: "GET"
    } & MockOptions

    declare type MockOptionsMethodPost = {
        method: "POST"
    } & MockOptions

    declare type MockOptionsMethodPut = {
        method: "PUT"
    } & MockOptions

    declare type MockOptionsMethodDelete = {
        method: "DELETE"
    } & MockOptions

    declare type MockOptionsMethodHead = {
        method: "HEAD"
    } & MockOptions
        ...
        mock(matcher: MockMatcher, response: MockResponse | MockResponseFunction): this,
            ...
            */
            get(
                ...
                options?: MockOptionsMethodGet): this,
            ...
            */
            post(
                matcher: MockMatcher,
                reponse: MockResponse | MockResponseFunction,
                options?: MockOptionsMethodPost): this,
            ...
            */
            put(
                matcher: MockMatcher,
                reponse: MockResponse | MockResponseFunction,
                options?: MockOptionsMethodPut): this,
            ...
            */
            delete(
                matcher: MockMatcher,
                reponse: MockResponse | MockResponseFunction,
                options?: MockOptionsMethodDelete): this,
            ...
            */
            head(
                matcher: MockMatcher,
                reponse: MockResponse | MockResponseFunction,
                options?: MockOptionsMethodHead): this,
    ...
    declare module.exports: typeof fetchMock
}