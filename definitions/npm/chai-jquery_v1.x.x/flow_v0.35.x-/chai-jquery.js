/**
 * Flowtype definitions for chai-jquery
...
declare interface Chai$Assertion {
    attr: (name: string, value?: string) => Chai$Assertion,
        css: (name: string, value?: string) => Chai$Assertion,
        data: (name: string, value?: string) => Chai$Assertion,
        class(className: string): Chai$Assertion,
        id(id: string): Chai$Assertion,
        html(html: string): Chai$Assertion,
        text(text: string): Chai$Assertion,
...
declare interface ChaiJQueryStatic {
    ...
    ajax(settings: JQueryAjaxSettings): JQueryXHR,
        ...
        getScript(
            url: string,
            success?: (script: string, textStatus: string, jqXHR: JQueryXHR) => any): JQueryXHR,
        ...
        map<T, U>(
            array: T[],
            callback: (elementOfArray: T, indexInArray: number) => U): U[],
...
declare interface ChaiJQuery {
    ...
    ajaxComplete(
            handler: (
                ...
                ajaxOptions: any) => any): ChaiJQuery,
        ...
        ajaxError(
            handler: (
                ...
                jqXHR: JQueryXHR,
                ajaxSettings: JQueryAjaxSettings,
                thrownError: any) => any): ChaiJQuery,
        ...
        ajaxSend(
            handler: (
                event: JQueryEventObject,
                jqXHR: JQueryXHR,
                ajaxOptions: JQueryAjaxSettings) => any): ChaiJQuery,
        ...
        load(
            ...
            complete?: (
                responseText: string,
                textStatus: string,
                XMLHttpRequest: XMLHttpRequest) => any): ChaiJQuery,
        ...
        attr(
            ...
            func: (index: number, attr: string) => string | number): ChaiJQuery,
        ...
        prop(
            propertyName: string,
            func: (index: number, oldPropertyValue: any) => any): ChaiJQuery,
        ...
        css(
            propertyName: string,
            value: (index: number, value: string) => string | number): ChaiJQuery,
         ...
         */
        offset(
            func: (index: number, coords: JQueryCoordinates) => JQueryCoordinates): ChaiJQuery,
        ...
        bind(
            eventType: string,
            eventData: any,
            handler: (eventObject: JQueryEventObject) => any): ChaiJQuery,
        ...
        hover(
            ...
            handlerOut: (eventObject: JQueryEventObject) => any): ChaiJQuery,
        ...
        keydown(
            eventData?: any,
            handler?: (eventObject: JQueryKeyEventObject) => any): ChaiJQuery,
        ...
        mousedown(
            eventData: Object,
            handler: (eventObject: JQueryMouseEventObject) => any): ChaiJQuery,
        ...
        on(
            events: string,
            handler: (eventObject: JQueryEventObject, ...args: any[]) => any): ChaiJQuery,
        ...
        on(
            events: string,
            selector: string,
            handler: (eventObject: JQueryEventObject, ...eventData: any[]) => any): ChaiJQuery,
        ...
        */
         ...
         */
        selector: string, [index: string]: any, [index: number]: HTMLElement,
