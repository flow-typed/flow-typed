/**
 * Flowtype definitions for dojox.av
 ...
 * @param options 
*/
declare class FLVideo mixins dijit._Widget, undefined._Media {
    constructor(options: Object): this;
...
*/
declare class PlayButton mixins dijit._Widget, dijit._TemplatedMixin {
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class ProgressSlider mixins dijit._Widget, dijit._TemplatedMixin {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class Player mixins dijit._Widget, dijit._TemplatedMixin {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class Status mixins dijit._Widget, dijit._TemplatedMixin {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class VolumeButton mixins dijit._Widget, dijit._TemplatedMixin {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
