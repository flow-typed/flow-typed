...
terminal.on('key', (key: string, event: KeyboardEvent) => console.log(key, event));
terminal.on('keydown', () => {});
...
terminal.on('refresh', () => {});
terminal.on('refresh', (data: {start: number, end: number}) => console.log(data));
terminal.on('resize', () => {});
terminal.on('resize', (data: {cols: number, rows: number}) => console.log(data));
terminal.on('scroll', () => {});
...
terminal.off('key', (key: string, event: KeyboardEvent) => console.log(key, event));
...
terminal.off('refresh', (data: {element: HTMLElement, start: number, end: number}) => console.log(data));
terminal.off('resize', () => {});
terminal.off('resize', (data: {terminal: Terminal, cols: number, rows: number}) => console.log(data));
terminal.off('scroll', () => {});
...
terminal.registerLinkMatcher(/foo/, () => {}, {});
terminal.registerLinkMatcher(/foo/, (event: MouseEvent, uri: string) => {
