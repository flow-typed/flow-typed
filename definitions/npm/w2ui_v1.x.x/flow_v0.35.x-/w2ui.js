import type { W2Popup, W2UI } from 'npm$namespace$W2UI'
...
declare module 'npm$namespace$W2UI' {
	declare type W2EventHandler = ((e: W2Event) => void) | ((id: string, e: W2Event) => void);

	declare type W2Object = W2Layout | W2Grid | W2Toolbar | W2Sidebar | W2Tabs | W2Form | W2Popup;

	declare interface W2Event {
		onComplete: () => void,
		target: string
	}

	declare interface W2Item {
		checked?: boolean,
		caption?: string,
		group?: string,
		id?: string,
	...
	declare interface W2Tab {
		caption?: string,
		id?: string
	}

	declare interface W2UI {
		[s: string]: any
	}

	declare interface W2Common {
		box: HTMLElement,
		handlers: Function[],
		name: string,
		style: string,
	...
	declare interface W2OnClickable {
...
declare module 'W2Grid' {
		declare interface Columns {
		
	}

	declare interface Ranges {
