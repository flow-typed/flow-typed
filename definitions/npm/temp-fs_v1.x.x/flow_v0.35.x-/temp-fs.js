 ...
 */
declare
function tempfs$clear(callback?: () => any): any
...
*/
declare
function tempfs$mkdir(options?: tempfs$options, callback?: (err: any, dir: tempfs$dir) => any): any
 ...
 */
declare
function tempfs$mkdirSync(options?: tempfs$options): tempfs$dir
 ...
 */
declare
function tempfs$name(options?: tempfs$options): string
...
*/
declare
function tempfs$open(options?: tempfs$options, callback?: (err: any, file: tempfs$file) => any): any
 ...
 */
declare
function tempfs$openSync(options?: tempfs$options): tempfs$file
...
*/
declare
function tempfs$track(on?: Boolean): voiddeclare module 'temp-fs' {
