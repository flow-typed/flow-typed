...

{
  ...
  const f1: Array<Vec2> = vec3.forEach([a,b,c], 1, 0, 1, ( a: Vec3, b: number ) : Vec2 => vec2.create(), 12 );

  // $ExpectError
  const f2: Array<number> = vec3.forEach([a,b,c], 1, 0, 1, ( a: Vec3, b: number ) : Vec2 => vec2.create(), 12 );
}
