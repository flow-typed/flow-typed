...
declare class Mongoose$Connection {
  constructor(): this;
  close(): Promise<any>;
  connect(uri: string, opts?: ConnectionConnectOpts, fn?: (error: any) => void): Promise<any>;
...
declare module "mongoose" {
  ...
  declare module.exports: {
    ...
    connect: (uri: string, options?: ConnectionConnectOpts, fn?: (error: any) => void) => Promise<any>,
