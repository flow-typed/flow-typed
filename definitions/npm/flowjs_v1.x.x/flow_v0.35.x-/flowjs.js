...
declare module 'npm$namespace$flowjs' {
		...
		files: IFlowFile[],
		assignBrowse(
		domNodes: HTMLElement[], isDirectory: boolean, singleFile: boolean, attributes: Object
	): void,
	...
	declare interface IFlowOptions {
		target?: string,
		singleFile?: boolean,
		chunkSize?: number,
