import type { LazyStatic } from 'npm$namespace$LazyJS'

declare module 'lazy.js' {
					declare module.exports: LazyStatic


}

declare module 'npm$namespace$LazyJS' {
		declare interface LazyStatic {
		(value: string): StringLikeSequence,
		(value: T[]): ArrayLikeSequence<T>,
		(value: any[]): ArrayLikeSequence<any>,
		(value: Object): ObjectLikeSequence<T>,
	...
	declare interface ValueCallback<T> {
		(value: T): void
	}

	declare interface GetKeyCallback<T> {
		(value: T): string
	}

	declare interface TestCallback<T> {
		(value: T): boolean
	}

	declare interface MapCallback<T, U> {
		(value: T): U
	}

	declare interface MapStringCallback {
		(value: string): string
	}

	declare interface NumberCallback<T> {
		(value: T): number
	}

	declare interface MemoCallback<T, U> {
		(memo: U, value: T): U
	}

	declare interface GeneratorCallback<T> {
		(index: number): T
	}
	...
	declare interface SequenceBaser<T> {
	...
	declare interface ArrayLikeSequence<T> {
	...
	declare interface ObjectLikeSequence<T> {
	...
	declare interface StringLikeSequence {
...
declare module 'Sequence' {
			declare function define(methodName: string[], overrides: Object): Function

		
}

declare module 'ArrayLikeSequence' {
			declare function define(methodName: string[], overrides: Object): Function

		
}

declare module 'ObjectLikeSequence' {
			declare function define(methodName: string[], overrides: Object): Function

		
}

declare module 'StringLikeSequence' {
			declare function define(methodName: string[], overrides: Object): Function
