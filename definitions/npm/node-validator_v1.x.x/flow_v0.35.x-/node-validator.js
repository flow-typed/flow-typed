...
declare
function Validator$express(validator: Validator$Validatable): any

declare
function Validator$bodyValidator(validator: Validator$Validatable): any

declare
function Validator$expressParams(validator: Validator$Validatable): any

declare
function Validator$paramsValidator(validator: Validator$Validatable): any

declare
function Validator$expressQuery(validator: Validator$Validatable): any

declare
function Validator$queryValidator(validator: Validator$Validatable): any
...
declare
function Validator$isObject(): Validator$IsObjectValidator

declare
function Validator$isString(options?: ValidatorOptions$IsStringOptions): Validator$Validatable

declare
function Validator$isStringOrNull(options?: ValidatorOptions$IsStringOptions): Validator$Validatable

declare
function Validator$isBoolean(): Validator$Validatable

declare
function Validator$isNumber(options?: ValidatorOptions$IsNumberOptions): Validator$Validatable

declare
function Validator$isInteger(options?: ValidatorOptions$IsNumberOptions): Validator$Validatable

declare
function Validator$isDate(options?: ValidatorOptions$IsDateOptions): Validator$Validatable

declare
function Validator$isIsoDate(options?: ValidatorOptions$IsDateOptions): Validator$Validatable

declare
function Validator$isIsoDateTime(options?: ValidatorOptions$IsDateOptions): Validator$Validatable

declare
function Validator$isArray(
    validator?: Validator$Validatable,
    options?: ValidatorOptions$Options): Validator$Validatable

declare
function Validator$isAnyObject(): Validator$IsObjectValidatordeclare module 'node-validator' {
