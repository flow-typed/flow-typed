/**
 * Flowtype definitions for db-migrate-pg
...
declare module 'db-migrate-pg' {
    ...
    declare export class PgDriver mixins DbMigrateBase.Base {
        ...
        createDatabase(
            ...
            callback?: DbMigrateBase.CallbackFunction): void;
        dropDatabase(
            dbName: string,
        ...
        createColumnConstraint(
            ...
            tableName: string,
            columnName: string): ColumnConstraint;
