/**
 * Flowtype definitions for fs-ext
...
declare module 'fs-ext' {
    ...
    */
     ...
     * @param fd File Descriptor
     * @param offset Offset
     * @param whence Whence can be 0 (SEEK_SET) to set the new position in bytes to offset, 1 (SEEK_CUR) to set the new 
    ...
    */
    declare export function seek(
        ...
        offset: number,
        whence: number,
        callback: (err: Error, currFilePos: number) => void): void
    ...
    */
     ...
     * @param atime Arguments atime and mtime are in seconds as for the system call.Note that the number value of Date() is in milliseconds,
     ...
     * @param mtime Arguments atime and mtime are in seconds as for the system call.Note that the number value of Date() is in milliseconds,
    so to use the 'now' value with fs.utime() you would have to divide by 1000 first, e.g. Date.now()/1000
    Just like for utime(2), the absence of the atime and mtime means 'now'.
    */
