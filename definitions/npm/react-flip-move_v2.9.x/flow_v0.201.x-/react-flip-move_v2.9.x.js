declare module "react-flip-move" {
  declare export type Styles = { [key: string]: string, ... };

  declare type ReactStyles = { [key: string]: string | number, ... };
  ...
  declare export type ElementShape = {
    +type: $PropertyType<React$Element<any>, "type">,
    +props: $PropertyType<React$Element<any>, "props">,
    +key: $PropertyType<React$Element<any>, "key">,
    +ref: $PropertyType<React$Element<any>, "ref">,
    ...
  };
  ...
  declare export type Child = void | null | boolean | React$Element<any>;
