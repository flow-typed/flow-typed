...
declare module 'highcharts' {
     ...
     * @since  5.0.0
     */
    declare interface KeyboardNavigationOptions {
    ...
    */
    ...
    declare type ChartDrilldownEvent = {
    ...
    declare type ChartSelectionEvent = {
    ...
    declare type ButtonStatesTheme = {
    ...
    */
    ...
    declare type ExportingContextButton = {
    ...
    */
     ...
     * @since  5.0.0
     */
    declare interface ResponsiveOptions {
     ...
     * A set of rules for responsive settings. The rules are executed from the top down.
     */
    declare interface RulesOptions {
     ...
     * Under which conditions the rule applies.
     */
    declare interface ConditionOptions {
    ...
    declare type AreaCheckboxEvent = {
    ...
    declare type PieStates = {} & BarStates & LineStates
    ...
    declare type AreaSplineChart = {} & AreaChart

    declare type AreaSplineRangeChart = {} & AreaRangeChart

    declare type BarChart = {
    ...
    */
    ...
    declare type ColumnChart = {} & BarChart
    ...
    */
    ...
    declare type ScatterChart = {} & SeriesChart
    ...
    */
    ...
    declare type SplineChart = {} & SeriesChart
    ...
    */
    ...
    declare type SeriesOptions = {} & IndividualSeriesOptions & SeriesChart

    declare type AreaChartSeriesOptions = {} & IndividualSeriesOptions & AreaChart

    declare type AreaRangeChartSeriesOptions = {} & IndividualSeriesOptions & AreaRangeChart

    declare type AreaSplineChartSeriesOptions = {} & IndividualSeriesOptions & AreaSplineChart

    declare type AreaSplineRangeChartSeriesOptions = {} & IndividualSeriesOptions & AreaSplineRangeChart

    declare type BarChartSeriesOptions = {} & IndividualSeriesOptions & BarChart

    declare type BoxPlotChartSeriesOptions = {} & IndividualSeriesOptions & BoxPlotChart

    declare type BubbleChartSeriesOptions = {} & IndividualSeriesOptions & BubbleChart

    declare type ColumnChartSeriesOptions = {} & IndividualSeriesOptions & ColumnChart

    declare type ColumnRangeChartSeriesOptions = {} & IndividualSeriesOptions & ColumnRangeChart

    declare type ErrorBarChartSeriesOptions = {} & IndividualSeriesOptions & ErrorBarChart

    declare type FunnelChartSeriesOptions = {} & IndividualSeriesOptions & FunnelChart

    declare type GaugeChartSeriesOptions = {} & IndividualSeriesOptions & GaugeChart

    declare type HeatMapSeriesOptions = {} & IndividualSeriesOptions & HeatMapChart

    declare type LineChartSeriesOptions = {} & IndividualSeriesOptions & LineChart

    declare type PieChartSeriesOptions = {} & IndividualSeriesOptions & PieChart

    declare type PolygonChartSeriesOptions = {} & IndividualSeriesOptions & PolygonChart

    declare type PyramidChartSeriesOptions = {} & IndividualSeriesOptions & PyramidChart

    declare type ScatterChartSeriesOptions = {} & IndividualSeriesOptions & ScatterChart

    declare type SolidGaugeChartSeriesOptions = {} & IndividualSeriesOptions & SolidGaugeChart

    declare type SplineChartSeriesOptions = {} & IndividualSeriesOptions & SplineChart

    declare type TreeMapChartSeriesOptions = {} & IndividualSeriesOptions & TreeMapChart

    declare type WaterFallChartSeriesOptions = {} & IndividualSeriesOptions & WaterFallChart
    ...
    */
    declare interface AxisObject {
         ...
         * @param  When true, the resize will be animated with default animation options.
    ...
    */
    declare interface ChartObject {
        ...
        */
        addAxis(
            ...
            isX?: boolean,
            redraw?: boolean,
            animation?: boolean | Animation): AxisObject,
        ...
        */
        addSeries<T>(
            options: T,
            redraw?: boolean,
            animation?: boolean | Animation): SeriesObject,
        ...
        */
        addSeriesAsDrilldown(
            point: PointObject,
            seriesOptions: IndividualSeriesOptions): void,
         ...
         * Exporting module required. Submit an SVG version of the chart to a server along with some parameters for
         * conversion.
         * @param  Exporting options. Out of the exporting options, the following options can be given as parameters to the exportChart method.
        ...
        */
         ...
         */
        get(
            id: string): AxisObject | SeriesObject | PointObject,

        /**
         * Exporting module required. Get an SVG string representing the chart.
         * @param  Chart options to add to the exported chart in addition to the options given for the original chart.
        ...
        */
         ...
         * @param  Defaults to true. When true, the resize will be animated with default animation options.
        The animation can also be a configuration object with properties duration and easing.
        */
        setSize(
            width: number,
            height: number,
            animation?: boolean | Animation): void,
    ...
    declare interface Chart {
        ...
        */
        new(
            options: Options,
            callback: (chart: ChartObject) => void): ChartObject,
    ...
    */
    declare interface ElementObject {
         ...
         * @param  Optional animation parameters that are passed over to jQuery or other framework.
    ...
    */
    declare interface RendererObject {
         ...
         * @param  serialized form of an SVG definition, including children.
         * @since  5.0.0
        */
        ...
        */
        label(
            ...
            useHTML?: boolean,
            baseline?: boolean,
            className?: string): ElementObject,
        ...
        rect(
            ...
            width: number,
            height: number,
            cornerRadius: number): ElementObject,
    ...
    */
    declare interface PointObject {
        ...
        */
         ...
         * @param  The point options. Point options are handled as described under the series<type>.data item for each series type.
        ...
        it is a good idea to set redraw to false and call chart.redraw() after.
         * @param  Defaults to true. When true, the update will be animated with default animation options.
        The animation can also be a configuration object with properties duration and easing.
         * @since  1.2.0
        */
        update(
    ...
    */
    declare interface SeriesObject {
         ...
         * the start or in the middle of the series.(boolean|Animation)=false] animation - When shift is true, one point is shifted off the start of the series as one is appended to the end.
        Use this option for live charts monitoring a value over time.
         * @param  point options. If options is a single number, a point with that y value is appended to the series.
         ...
         * @param boolean redraw - Whether to redraw the chart after the point is added. When adding more than one point,
         ...
         * @param boolean shift - When shift is true, one point is shifted off the start of the series as one is appended to the end.
        Use this option for live charts monitoring a value over time.
         * @since  1.2.0
        */
        addPoint(
         ...
         * @param boolean redraw - Whether to redraw the chart after the series is removed.If doing more operations on the chart,
        it is a good idea to set redraw to false and call chart.redraw() after.
         * @since  1.2.0
        */
        remove(redraw?: boolean): void,
    ...
    declare interface LegendObject {

        /**
         * Update the legend with new options.
         * @param  New options that will be merged into the legend's existing options.
         * @param boolean redraw - Whether to redraw the chart. Defaults to true.
         * @since  5.0.0
         */
    ...
    declare interface Highcharts {
        ...
        */
         ...
         * @param  |String The error code. If this is a number, the default error function prints a link to a human readable error code
        description according to error definition file. If it's a string, the description is printed in the console.
         * @param  the error should stop execution.
         * @since  5.0.6
        */
        ...
        wrap(
            prototype: any,
            type: string,
            cb: (proceed: Function, ...args: any[]) => void): void
    }

    declare var exports: Highcharts
}
