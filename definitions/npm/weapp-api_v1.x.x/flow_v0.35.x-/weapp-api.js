 ...
 */
declare
function wx$request(options: wx$RequestOptions): void
...
*/
declare
function wx$uploadFile(options: wx$UploadFileOptions): void
 ...
 */
declare
function wx$downloadFile(options: wx$DownloadFileOptions): void
...
*/
declare
function wx$connectSocket(options: wx$ConnectSocketOptions): void
 ...
 */
declare
function wx$onSocketOpen(callback: wx$OneParamCallback): void
 ...
 */
declare
function wx$onSocketError(callback: wx$ErrorCallback): void
 ...
 */
declare
function wx$sendSocketMessage(options: wx$SendSocketMessageOptions): void
 ...
 */
declare
function wx$onSocketMessage(callback: wx$DataResponseCallback): void
 ...
 */
declare
function wx$onSocketClose(callback: wx$ResponseCallback): void
 ...
 */
declare
function wx$chooseImage(options: wx$ChooseImageOptions): void
 ...
 */
declare
function wx$previewImage(options: wx$PreviewImageOptions): void
...
*/
declare
function wx$startRecord(options: wx$StartRecordOptions): void
 ...
 */
declare
function wx$playVoice(options: wx$PlayVoiceOptions): void
 ...
 */
declare
function wx$getBackgroundAudioPlayerState(options: wx$GetBackgroundAudioPlayerStateOptions): void
 ...
 */
declare
function wx$playBackgroundAudio(options: wx$PlayBackgroundAudioOptions): void
 ...
 */
declare
function wx$pauseBackgroundAudio(): void
 ...
 */
declare
function wx$seekBackgroundAudio(options: wx$SeekBackgroundAudioOptions): void
 ...
 */
declare
function wx$stopBackgroundAudio(): void
 ...
 */
declare
function wx$onBackgroundAudioPlay(callback: wx$NoneParamCallback): void
 ...
 */
declare
function wx$onBackgroundAudioPause(callback: wx$NoneParamCallback): void
 ...
 */
declare
function wx$onBackgroundAudioStop(callback: wx$NoneParamCallback): void
 ...
 */
declare
function wx$saveFile(options: wx$SaveFileOptions): void
 ...
 */
declare
function wx$chooseVideo(options: wx$ChooseVideoOptions): void
 ...
 */
declare
function wx$setStorage(options: wx$SetStorageOptions): void
 ...
 */
declare
function wx$setStorageSync(key: string, data: any | string): void
 ...
 */
declare
function wx$getStorage(options: wx$GetStorageOptions): void
 ...
 */
declare
function wx$getStorageSync(key: string): any | string
 ...
 */
declare
function wx$clearStorageSync(): void
 ...
 */
declare
function wx$getLocation(options: wx$GetLocationOptions): void
 ...
 */
declare
function wx$openLocation(options: wx$OpenLocationOptions): void
 ...
 */
declare
function wx$getNetworkType(options: wx$GetNetworkTypeOptions): void
 ...
 */
declare
function wx$getSystemInfo(options: wx$GetSystemInfoOptions): void
 ...
 */
declare
function wx$onAccelerometerChange(callback: wx$AccelerometerChangeCallback): void
...
declare
function wx$onCompassChange(callback: wx$CompassChangeCallback): void
 ...
 */
declare
function wx$setNavigationBarTitle(options: wx$SetNavigationBarTitleOptions): void
 ...
 */
declare
function wx$showNavigationBarLoading(): void
 ...
 */
declare
function wx$hideNavigationBarLoading(): void
...
*/
declare
function wx$navigateTo(options: wx$NavigateToOptions): void
 ...
 */
declare
function wx$redirectTo(options: wx$RedirectToOptions): void
...
*/
declare
function wx$createAnimation(options?: wx$CreateAnimationOptions): wx$Animation
...
*/
declare
function wx$createContext(): wx$CanvasContext
 ...
 */
declare
function wx$drawCanvas(options: wx$DrawCanvasOptions): void
...
*/
declare
function wx$login(option: wx$LoginOptions): void
 ...
 */
declare
function wx$getUserInfo(options: wx$GetUserInfoOptions): void
 ...
 */
declare
function wx$requestPayment(options: wx$RequestPaymentOptions): voiddeclare interface Page {
