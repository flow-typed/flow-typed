...
declare module 'google-apps-script.jdbc' {
					
}

declare module 'JDBC' {
		declare export interface Jdbc {
	...
	declare export interface JdbcArray {
		free(): void,
		getArray(): Object,
	...
	declare export interface JdbcBlob {
		free(): void,
		...
		setBytes(
		position: Integer, blobSource: Base.BlobSource, offset: Integer, length: Integer
	): Integer,
	...
	declare export interface JdbcCallableStatement {
		addBatch(): void,
		...
		execute(
		sql: string, autoGeneratedKeys: Integer, sql_: string, columnIndexes: Integer[]
	): boolean,
		execute(
		sql: string, autoGeneratedKeys: Integer, sql_: string, columnIndexes: Integer[]
	): boolean,
		...
		setObject(
		parameterIndex: Integer, x: Object, targetSqlType: Integer, scaleOrLength: Integer
	): void,
	...
	declare export interface JdbcClob {
		free(): void,
		getAppsScriptBlob(): Base.Blob,
		getAs(contentType: string): Base.Blob,
		...
		setString(
		position: Integer, blobSource: Base.BlobSource, offset: Integer, len: Integer
	): Integer,
	...
	declare export interface JdbcConnection {
		clearWarnings(): void,
		close(): void,
		commit(): void,
		...
		createStatement(
		resultSetType: Integer, resultSetConcurrency: Integer, resultSetHoldability: Integer
	): JdbcStatement,
		...
		prepareCall(
		sql: string, resultSetType: Integer, resultSetConcurrency: Integer
	): JdbcCallableStatement,
		prepareCall(
		sql: string, resultSetType: Integer, resultSetConcurrency: Integer, resultSetHoldability: Integer
	): JdbcCallableStatement,
	...
	declare export interface JdbcDatabaseMetaData {
		...
		getAttributes(
		catalog: string, schemaPattern: string, typeNamePattern: string, attributeNamePattern: string
	): JdbcResultSet,
		getBestRowIdentifier(
		catalog: string, schema: string, table: string, scope: Integer, nullable: boolean
	): JdbcResultSet,
		...
		getColumns(
		catalog: string, schemaPattern: string, tableNamePattern: string, columnNamePattern: string
	): JdbcResultSet,
		getConnection(): JdbcConnection,
		getCrossReference(
		parentCatalog: string, parentSchema: string, parentTable: string, foreignCatalog: string, foreignSchema: string, foreignTable: string
	): JdbcResultSet,
		...
		getFunctionColumns(
		catalog: string, schemaPattern: string, functionNamePattern: string, columnNamePattern: string
	): JdbcResultSet,
		getFunctions(
		...
		getProcedureColumns(
		catalog: string, schemaPattern: string, procedureNamePattern: string, columnNamePattern: string
	): JdbcResultSet,
		getProcedureTerm(): string,
		getProcedures(
		catalog: string, schemaPattern: string, procedureNamePattern: string
	): JdbcResultSet,
		getResultSetHoldability(): Integer,
		...
		getTables(
		catalog: string, schemaPattern: string, tableNamePattern: string, types: String[]
	): JdbcResultSet,
		getTimeDateFunctions(): string,
		getTypeInfo(): JdbcResultSet,
		getUDTs(
		catalog: string, schemaPattern: string, typeNamePattern: string, types: Integer[]
	): JdbcResultSet,
		getURL(): string,
		getUserName(): string,
	...
	declare export interface JdbcDate {
	...
	declare export interface JdbcParameterMetaData {
	...
	declare export interface JdbcPreparedStatement {
		addBatch(): void,
		addBatch(sql: string): void,
		cancel(): void,
		clearBatch(): void,
	...
	declare export interface JdbcRef {
		getBaseTypeName(): string,
		getObject(): Object,
		setObject(object: Object): void
	}

	declare export interface JdbcResultSet {
	...
	declare export interface JdbcResultSetMetaData {
	...
	declare export interface JdbcRowId {
		getBytes(): Byte[]
	}

	declare export interface JdbcSQLXML {
		free(): void,
		getString(): string,
		setString(value: string): void
	}

	declare export interface JdbcSavepoint {
		getSavepointId(): Integer,
		getSavepointName(): string
	}

	declare export interface JdbcStatement {
		addBatch(sql: string): void,
		cancel(): void,
		clearBatch(): void,
		clearWarnings(): void,
	...
	declare export interface JdbcStruct {
		getAttributes(): Object[],
		getSQLTypeName(): string
	}

	declare export interface JdbcTime {
	...
	declare export interface JdbcTimestamp {
