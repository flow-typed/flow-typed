/**
 * Flowtype definitions for rosie
...
declare interface rosie$IFactoryStatic {
     ...
     * on the result to define the properties of this factory.*=} constructor
     * @param  
     * @return  
     */
    define(name: String, constructor?: Function): rosie$IFactory,
...
declare interface rosie$IFactory {
    ...
    partially-specified child objects.| any dependenciesOrValue
     * @param  
     * @param any 
     * @return  
    */
    attr(name: string, dependenciesOrValue: any | string[], value?: any): rosie$IFactory,
        ...
        when building.| any dependencies or value*=} value
         * @param  
         * @return  
        */
        option(
        ...
        conflict.
           ...
           Factory.define('Person').sequence('id');| Function dependencies or builder*=} builder
         * @param  
         * @return  
        */
        sequence(
            name: string,
            dependenciesOrBuilder?: Function | string[],
            builder?: Function): rosie$IFactory,
         ...
         * @return  
        */
        after(functionArg: Function): rosie$IFactory,
         ...
         * @return  
         */
        inherits(functionArg: Function): rosie$IFactory,
