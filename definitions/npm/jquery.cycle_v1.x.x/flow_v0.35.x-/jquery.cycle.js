...
declare module 'jquery.cycle' {
		...
		after?: (
		currSlideElement: Element, nextSlideElement: Element, options: CycleOptions, forwardFlag: boolean
	) => void,
		...
		fx?: string,
		fxFn?: (
		currSlideElement: Element, nextSlideElement: Element, options: CycleOptions, afterCalback: Function, forwardFlag: boolean
	) => void,
		height?: any,
		manualTrump?: boolean,
		metaAttr?: string,
	...
	declare interface Cycle {
		...
		custom: (
		currSlideElement: Element, nextSlideElement: Element, options: CycleOptions, afterCalback: Function, forwardFlag: boolean, speedOverride?: number
	) => void,
		commonReset: (
		currSlideElement: Element, nextSlideElement: Element, options: CycleOptions, w?: boolean, h?: boolean, rev?: boolean
	) => void,
		hopsFromLast: (options: CycleOptions, forwardFlag?: boolean) => number,
		createPagerAnchor: (
		index: number, DOMElement: Element, $pager: JQuery, els: any, options: CycleOptions
	) => string,
		updateActivePagerLink: (pager: any, currSlide: number, clsName: string) => void,
