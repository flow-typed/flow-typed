...
declare module 'google-apps-script.calendar' {
...
declare module 'Calendar' {
		...
		title: string, startDate: Date, recurrence: EventRecurrence
	): CalendarEventSeries,
		createAllDayEventSeries(
		title: string, startDate: Date, recurrence: EventRecurrence, options: Object
	): CalendarEventSeries,
		...
		createEventSeries(
		title: string, startTime: Date, endTime: Date, recurrence: EventRecurrence
	): CalendarEventSeries,
		createEventSeries(
		title: string, startTime: Date, endTime: Date, recurrence: EventRecurrence, options: Object
	): CalendarEventSeries,
		deleteCalendar(): void,
		getColor(): string,
	...
	declare export interface CalendarEventSeries {
		...
		setRecurrence(
		recurrence: EventRecurrence, startTime: Date, endTime: Date
	): CalendarEventSeries,
