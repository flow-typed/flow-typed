// @flow
/**
 * Flowtype definitions for mandrill-api
...
declare module 'mandrill-api' {
    ...
    declare     export class Templates {
        ...
        /**
         * Add a new template
         * @param  the hash of the parameters to pass to the request
         ...
         * @param  an optional callback to execute when the API call is successfully made
         * @param  an optional callback to execute when the API call errors out - defaults to throwing the error as an exception
        */
