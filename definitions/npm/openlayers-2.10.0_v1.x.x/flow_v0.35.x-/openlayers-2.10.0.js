/**
 * Flowtype definitions for openlayers-2.10.0
...
export class Events {
    ...
    */
    triggerEvent(type: string, evt: OpenLayers$Event): boolean;
    ...
    evt - {Event}
    */
    handleBrowserEvent(evt: OpenLayers$Event): void;
...
export class Layer {
    ...
    */
    constructor(name: string, options: OpenLayers$LayerOptions): this;
    ...
    */
    addOptions(newOptions: OpenLayers$LayerOptions, reinitialize: boolean): void;
    ...
    */
    ...
    map - {<OpenLayers.Map>}
    */
    removeMap(map: OpenLayers$Map): void;
    ...
    account gutters.
    */
    getImageSize(bounds: OpenLayers$Bounds): OpenLayers$Size;
    ...
    */
    setTileSize(size: OpenLayers$Size): void;
    ...
    */
    ...
    parameter.
    */
    getZoomForExtent(extent: OpenLayers$Bounds, closest?: boolean): number;
    ...
    */
    getLonLatFromViewPortPx(viewPortPx: OpenLayers$Pixel): OpenLayers$LonLat;
    ...
    */
    getViewPortPxFromLonLat(lonlat: OpenLayers$LonLat, resolution: number): OpenLayers$Pixel;
    ...
    */
    ...
    bounds - {<OpenLayers.Bounds>}
    */
    adjustBounds(bounds: OpenLayers$Bounds): OpenLayers$Bounds;
    CLASS_NAME: string
}
...
export class Geometry {
     ...
     */
    setBounds(bounds: OpenLayers$Bounds): void;
     ...
     */
    extendBounds(newBounds: OpenLayers$Bounds): void;

    /**
     * Get the bounds for this Geometry.  If bounds is not set, it is calculated again, this makes queries faster.
     */
    getBounds(): OpenLayers$Bounds;

    /**
     * Calculate the closest distance between two geometries (on the x-y plane).
     */
    distanceTo(geometry: OpenLayers$Geometry, options: Object): Object;
...
export class Projection {
    ...
    transform(
        ...
        dest: OpenLayers$Projection): Object;
...
export class Bounds {
     ...
     */
    clone(): OpenLayers$Bounds;

    /**
     * Test a two bounds for equivalence.
     */
    equals(bounds: OpenLayers$Bounds): boolean;
    ...
    is passed.
    */
    scale(ratio: number, origin?: OpenLayers$Pixel): void;
    ...
    is passed.
    */
    scale(ratio: number, origin?: OpenLayers$LonLat): void;

    /**
     * Shifts the coordinates of the bound by the given horizontal and vertical
     * deltas.
     */
    add(x: number, y: number): OpenLayers$Bounds;

    /**
     * Extend the bounds.
     */
    extend(object: OpenLayers$LonLat): void;
     ...
     * Extend the bounds.
     */
    extend(object: OpenLayers$Bounds): void;
     ...
     */
    containsLonLat(ll: OpenLayers$LonLat, options: OpenLayers$BoundsOptions): boolean;

    /**
     * Returns whether the bounds object contains the given <OpenLayers.LonLat>.
     */
    containsLonLat(ll: Object, options: OpenLayers$BoundsOptions): boolean;

    /**
     * Returns whether the bounds object contains the given <OpenLayers.Pixel>.
     */
    containsPixel(px: OpenLayers$Pixel, inclusive: boolean): boolean;
    ...
    */
    intersectsBounds(bounds: OpenLayers$Bounds, options: OpenLayers$BoundsOptions): boolean;

    /**
     * Returns whether the bounds object contains the given <OpenLayers.Bounds>.
     */
    containsBounds(bounds: OpenLayers$Bounds, partial: boolean, inclusive: boolean): boolean;

    /**
     * Returns the the quadrant ("br", "tr", "tl", "bl") in which the given
     * <OpenLayers.LonLat> lies.
     */
    determineQuadrant(lonlat: OpenLayers$LonLat): string;

    /**
     * Transform the Bounds object from source to dest.
     */
    transform(source: OpenLayers$Projection, dest: OpenLayers$Projection): OpenLayers$Bounds;
    ...
    wrapDateLine(
        maxExtent: OpenLayers$Bounds,
        options: OpenLayers$WrapDateLineOptions): OpenLayers$Bounds;
    CLASS_NAME: string;
     ...
     * parameter string.
     */
    fromString(str: string, reverseAxisOrder: boolean): OpenLayers$Bounds;

    /**
     * Alternative constructor that builds a new OpenLayers.Bounds from an array.
     */
    fromArray(bbox: number[], reverseAxisOrder: boolean): OpenLayers$Bounds;

    /**
     * Alternative constructor that builds a new OpenLayers.Bounds from a size.
     */
    fromSize(size: OpenLayers$Size): OpenLayers$Bounds;
...
export class LonLat {
     ...
     */
    equals(ll: OpenLayers$LonLat): boolean;
...
export class Map {
    ...
    */
     ...
     */
    layerContainerOrigin: OpenLayers$LonLat;
    ...
    */
    paddingForPopups: OpenLayers$Bounds;
    ...
    */
    ...
    (end)
    */
    constructor(id: HTMLElement, options?: OpenLayers$MapOptions): this;
    constructor(id: string, options?: OpenLayers$MapOptions): this;
    ...
    */
    getLayersBy(property: string, match: string): OpenLayers$Layer[];
    getLayersBy(property: string, match: Object): OpenLayers$Layer[];
    ...
    An empty array is returned if no matches are found.
    */
    getLayersByName(match: string): OpenLayers$Layer[];
    getLayersByName(match: Object): OpenLayers$Layer[];
    ...
    An empty array is returned if no matches are found.
    */
    getLayersByClass(match: string): OpenLayers$Layer[];
    getLayersByClass(match: Object): OpenLayers$Layer[];
    ...
    */
    getControlsBy(property: string, match: string): OpenLayers$Control[];
    getControlsBy(property: string, match: Object): OpenLayers$Control[];
    ...
    An empty array is returned if no matches are found.
    */
    getControlsByClass(match: string): OpenLayers$Control[];
    getControlsByClass(match: Object): OpenLayers$Control[];
    ...
    */
    getLayer(id: string): OpenLayers$Layer;
    ...
    */
    addLayer(layer: OpenLayers$Layer): boolean;
    ...
    */
    addLayers(layers: OpenLayers$Layer[]): void;
    ...
    */
    removeLayer(layer: OpenLayers$Layer, setNewBaseLayer?: boolean): void;
    ...
    */
    getLayerIndex(layer: OpenLayers$Layer): number;
    ...
    idx - {int}
    */
    setLayerIndex(layer: OpenLayers$Layer, idx: number): void;
    ...
    delta - {int}
    */
    raiseLayer(layer: OpenLayers$Layer, delta: number): void;
    ...
    */
    setBaseLayer(newBaseLayer: OpenLayers$Layer): void;
    ...
    px - {<OpenLayers.Pixel>}
    */
    addControl(control: OpenLayers$Control, px: OpenLayers$Pixel): void;
    ...
    */
    addControls(controls: OpenLayers$Control[], pixels: OpenLayers$Pixel[]): void;
    ...
    returns null.
    */
    getControl(id: string): OpenLayers$Control;
    ...
    */
    removeControl(control: OpenLayers$Control): void;
    ...
    */
    addPopup(popup: OpenLayers$Popup, exclusive: boolean): void;
    ...
    popup - {<OpenLayers.Popup>}
    */
    removePopup(popup: OpenLayers$Popup): void;
    ...
    */
    ...
    current mapsize.
    */
    calculateBounds(center?: OpenLayers$LonLat, resolution?: number): OpenLayers$Bounds;
    ...
    */
    ...
    lonlat - {<OpenLayers.LonLat>}
    */
    panTo(lonlat: OpenLayers$LonLat): void;
    ...
    */
    getProjectionObject(): OpenLayers$Projection;
    ...
    */
    ...
    If no baselayer is set, returns null.
    */
    getZoomForExtent(bounds: OpenLayers$Bounds, closest?: boolean): number;
    ...
    */
    ...
    zoom - {Integer}
    */
    zoomTo(zoom: number, px: OpenLayers$Pixel): void;
    ...
    Default is false.
    */
    zoomToExtent(bounds: OpenLayers$Bounds, closest?: boolean): void;
    ...
    */
    getViewPortPxFromLonLat(lonlat: OpenLayers$LonLat): OpenLayers$Pixel;
    ...
    current base layer
    */
    getLonLatFromPixel(px: OpenLayers$Pixel): OpenLayers$LonLat;
    ...
    base layer.
    */
    getPixelFromLonLat(lonlat: OpenLayers$LonLat): OpenLayers$Pixel;
    ...
    coordinates
    */
    getViewPortPxFromLayerPx(layerPx: OpenLayers$Pixel): OpenLayers$Pixel;
    ...
    coordinates
    */
    getLayerPxFromViewPortPx(viewPortPx: OpenLayers$Pixel): OpenLayers$Pixel;
    ...
    */
    getLayerPxFromLonLat(lonlat: OpenLayers$LonLat): OpenLayers$Pixel;
    TILE_WIDTH: string;
    TILE_HEIGHT: string
}
...
export class Date {
    ...
    */
    toISOString(date: OpenLayers$Date): string;
...
export class Pixel {
    ...
    */
    equals(px: OpenLayers$Pixel): boolean;
    equals(px: {
        x: number,
        y: number
    }): boolean;
    ...
    distance to.
    */
    distanceTo(px: OpenLayers$Pixel): number;
    ...
    values passed in.
    */
    add(x: number, y: number): OpenLayers$Pixel;
    ...
    */
    offset(px: OpenLayers$Pixel): OpenLayers$Pixel;
    offset(px: {
        x: number,
        y: number
    }): OpenLayers$Pixel;
...
export class Size {
    ...
    */
    equals(sz: OpenLayers$Size): boolean;
    CLASS_NAME: string
}
...
export class Collection mixins Geometry {
     ...
     */
    components: OpenLayers$Geometry[];
    ...
    */
     ...
     */
    constructor(components: OpenLayers$Geometry[]): this;
     ...
     */
    addComponents(components: OpenLayers$Geometry[]): void;

    /**
     * Add a new component (geometry) to the collection. If this.componentTypes
     * is set, then the component class name must be in the componentTypes array.
     */
    addComponent(component: OpenLayers$Geometry, index: number): boolean;

    /**
     * Remove components from this geometry.
     */
    removeComponents(components: OpenLayers$Geometry[]): boolean;

    /**
     * Remove a component from this geometry.
     */
    removeComponent(component: OpenLayers$Geometry): boolean;
     ...
     * the earth.
     */
    getGeodesicArea(projection: OpenLayers$Projection): number;

    /**
     * Compute the centroid for this geometry collection.
     */
    getCentroid(weighted?: boolean): Symbolizer$Point;

    /**
     * Calculate the approximate length of the geometry were it projected onto
     * the earth.
     */
    getGeodesicLength(projection: OpenLayers$Projection): number;
    ...
    */
     ...
     */
    rotate(angle: number, origin: Symbolizer$Point): void;

    /**
     * Resize a geometry relative to some origin. Use this method to apply
     * a uniform scaling to a geometry.
     */
    resize(scale: number, origin: Symbolizer$Point, ratio: number): OpenLayers$Geometry;

    /**
     * Calculate the closest distance between two geometries (on the x-y plane).
     */
    distanceTo(geometry: OpenLayers$Geometry, options: OpenLayers$DistanceOptions): Object;

    /**
     * Determine whether another geometry is equivalent to this one. Geometries
     * are considered equivalent if all components have the same coordinates.
     */
    equals(geometry: OpenLayers$Geometry): boolean;
    ...
    transform(
        source: OpenLayers$Projection,
        dest: OpenLayers$Projection): OpenLayers$Geometry;

    /**
     * Determine if the input geometry intersects this one.
     */
    intersects(geometry: OpenLayers$Geometry): boolean;
...
export class Point mixins Geometry {
     ...
     */
    clone(obj: Geometry$Point): Geometry$Point;
     ...
     */
    equals(geom: Geometry$Point): boolean;
     ...
     */
    rotate(angle: number, origin: Geometry$Point): void;
     ...
     */
    resize(scale: number, origin: Geometry$Point, ratio: number): OpenLayers$Geometry;
...
export class Grid mixins HTTPRequest {
    ...
    */
    ...
    options - {Object} Hashtable of extra options to tag onto the layer
    */
    constructor(name: string, url: string, params: {}, options: {}): this;
    ...
    */
    ...
    onscreen).
    */
    getTilesBounds(): OpenLayers$Bounds;
    getImageSize(): OpenLayers$Size;
    ...
    */
    addTile(bounds: OpenLayers$Bounds, position: number): OpenLayers$Tile;
...
export class HTTPRequest mixins Layer {
    ...
    */
    clone(obj?: Object): Layer$HTTPRequest;
...
export class OSM mixins Layer$XYZ {
    ...
    */
     ...
     */
    tileOptions: Layer$TileOptions;
    constructor(): this;
    constructor(name: string, url: string, options: Layer$TileOptions): this;
...
export class WMS mixins Layer$Grid {
    ...
    */
    constructor(name: string, url: string, params: Layer$WMSGetMapParams, options: Layer$WMSOptions): this;
