declare module "antd" {
  ...
  declare export type AutoCompleteDataItem =
    ...
    | React$Element<React$ComponentType<typeof SelectOption>>
    | React$Element<React$ComponentType<typeof SelectOptGroup>>;
  ...
  declare type InputProps = {
    ...
    onChange?: (event: SyntheticKeyboardEvent<>) => mixed,
    ...
  };
