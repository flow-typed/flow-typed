...
describe("Button", () => {
  ...
  it("should accept nullary or unary onClick handler", () => {
    ...
    const good1 = <Button onClick={(event: SyntheticEvent<>) => undefined} />
    // $ExpectError
...
describe("Form", () => {
  ...
  it("have create method that wrap a component with a form", () => {
    ...
    class GoodTestComponent extends React.Component<> {
      static defaultProps: PropsGoodTest;
    }
    class BadTestComponent extends React.Component<> {
      static defaultProps: PropsBadTest;
    }
