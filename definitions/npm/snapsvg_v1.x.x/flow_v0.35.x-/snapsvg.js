...
declare export interface mina$MinaAnimation {
    id: string,
        duration: Function,
        easing: Function,
        speed: Function,
...
declare export interface mina$AnimationDescriptor {
    id: string,
        start: number,
        end: number,
        b: number,
...
declare export function mina$backin(n: number): number

declare export function mina$backout(n: number): number

declare export function mina$bounce(n: number): number

declare export function mina$easein(n: number): number

declare export function mina$easeinout(n: number): number

declare export function mina$easeout(n: number): number

declare export function mina$elastic(n: number): number

declare export function mina$getById(id: string): mina$AnimationDescriptor

declare export function mina$linear(n: number): number

declare export function mina$time(): numberdeclare function Snap(width: number | string, height: number | string): Snap$Paper
...
declare export var filter: Snap$Filter;

declare export var path: Snap$Path;
...
declare export function Snap$getElementByPoint(x: number, y: number): Snap$Element

declare export function Snap$is(o: any, type: string): boolean

declare export function Snap$load(url: string, callback: Function, scope?: Object): void
...
declare export function Snap$snapTo(values: Array<number>, value: number, tolerance?: number): number
...
declare export function Snap$len(x1: number, y1: number, x2: number, y2: number): number

declare export function Snap$len2(x1: number, y1: number, x2: number, y2: number): number
...
declare export function Snap$parsePathString(pathString: string): Array<any >
    ...
    declare export function Snap$closest(x: number, y: number, X: number, Y: number): boolean
