// @flow
/**
 * Flowtype definitions for node-snap7
        ...
        Connect(callback?: (err: any) => void): boolean,
            ...
            */
            ReadArea(
                ...
                amount: number,
                wordLen: WordLen,
                callback?: (err: any, data: Buffer) => void): Buffer | boolean,
            ...
            */
            DBRead(
                ...
                start: number,
                size: number,
                callback?: (err: any, data: any) => void): Buffer | boolean,
            ...
            */
            ReadMultiVars(
                ...
                callback?: (err: any, data: MultiVarsReadResult[]) => void): MultiVarsReadResult[] | boolean,
            ...
            */
            WriteMultiVars(
                ...
                callback?: (err: any, data: MultiVarsWriteResult[]) => void): MultiVarsWriteResult[] | boolean,
            ...
            */
            GetAgBlockInfo(
                blockType: BlockType,
                blockNum: number,
                callback?: (err: any, data: any) => void): any | boolean,
            ...
            */
            FullUpload(
                blockType: BlockType,
                blockNum: number,
                callback?: (err: any, data: Object) => void): Object | boolean,
