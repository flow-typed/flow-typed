/**
 * Flowtype definitions for jquery.prettyphoto
 ...
 */
declare interface scaron_prettyPhoto$PrettyPhotoSettings {
...
declare interface scaron_prettyPhoto$moduleJQuery {
     ...
     */
    (pp_settings: scaron_prettyPhoto$PrettyPhotoSettings): JQuery
}

declare interface scaron_prettyPhoto$moduleJQueryStatic {
    ...
    version: string,
         ...
         * Opens the prettyPhoto modal box.
         * Note: Always returns false.
         * @param image Full path to the image to be open, can also be an array containing full images paths.
         * @param title The title to be displayed with the picture, can also be an array containing all the titles.
         * @param description The description to be displayed with the picture, can also be an array containing all the descriptions.
         */
         ...
         * @param direction Direction of the paging, previous or next.
         */
