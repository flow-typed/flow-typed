// @flow
/**
 * Flowtype definitions for dojox.gfx
...
declare interface dojox$gfx {
    ...
    arc: Object,
        ...
        */
         ...
         */
        createSurface(parentNode: HTMLElement, width: String, height: String): undefined.Surface,
         ...
         * @param height height of surface, e.g., "100px" or 100
         */
        createSurface(parentNode: HTMLElement, width: number, height: String): undefined.Surface,
         ...
         * @param height height of surface, e.g., "100px" or 100
         */
        createSurface(parentNode: HTMLElement, width: String, height: number): undefined.Surface,
         ...
         * @param height height of surface, e.g., "100px" or 100
         */
        createSurface(parentNode: HTMLElement, width: number, height: number): undefined.Surface,
        ...
        */
        decompose(matrix: undefined.Matrix2D): void,
        ...
        */
         ...
         */
        normalizeColor(color: undefined.Color): any,
...
declare class Circle {
     ...
     */
    applyLeftTransform(matrix: undefined.Matrix2D): Function;
     ...
     * @param matrix a matrix or a matrix-like object(see an argument of dojox/gfx/matrix.Matrix2Dconstructor for a list of acceptable arguments)
     */
    applyRightTransform(matrix: undefined.Matrix2D): Function;

    /**
     * a shortcut for dojox/gfx/shape.Shape.applyRightTransform
     * @param matrix a matrix or a matrix-like object(see an argument of dojox/gfx/matrix.Matrix2Dconstructor for a list of acceptable arguments)
     */
    applyTransform(matrix: undefined.Matrix2D): Function;
    ...
    */
     ...
     * @param matrix a matrix or a matrix-like object(see an argument of dojox/gfx/matrix.Matrix2Dconstructor for a list of acceptable arguments)
     */
    setTransform(matrix: undefined.Matrix2D): any
}
...
declare class Group {
    ...
    */
     ...
     * @param silently if true, do not redraw a picture yet
     */
    remove(shape: undefined.Shape, silently: boolean): Function;
...
declare class Moveable {
    constructor(shape: undefined.Shape, params: Object): this;
     ...
     */
    onFirstMove(mover: undefined.Mover): void;
     ...
     */
    onMove(mover: undefined.Mover, shift: Object): void;
     ...
     * @param shift An object as {dx,dy} that represents the shift.
     */
    onMoved(mover: undefined.Mover, shift: Object): void;

    /**
     * called before every move operation
     * @param mover A Mover instance that fired the event.
     */
    onMoveStart(mover: undefined.Mover): void;

    /**
     * called after every move operation
     * @param mover A Mover instance that fired the event.
     */
    onMoveStop(mover: undefined.Mover): void;
     ...
     * @param shift An object as {dx,dy} that represents the shift.
     */
    onMoving(mover: undefined.Mover, shift: Object): void
}
 ...
 */
declare class Mover {
    constructor(shape: undefined.Shape, e: Event, host?: Object): this;
...
declare class Surface {
    ...
    */
     ...
     * @param surface 
    */
    onLoad(surface: undefined.Surface): void
}
...
declare class VectorFont {
    ...
    */
    draw(
        group: undefined.Container,
        textArgs: undefined.Text,
        fontArgs: undefined.Font,
        fillArgs: undefined.Fill,
        strokeArgs: undefined.Stroke): any;
     ...
     * @param url The svg to parse.
     */
    load(url: undefined.url): Function;

    /**
     * 
     * @param font 
     */
    onLoad(font: undefined.VectorText): void;
 ...
 */
declare interface gfx$_svgFontCache {}


/**
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/gfx/_gfxBidiSupport.html
 */
declare interface gfx$_gfxBidiSupport {
 ...
 */
declare interface gfx$_vectorFontCache {}
 ...
 */
declare interface gfx$bezierutils {
...
API.
*/
declare interface gfx$canvas_attach {
...
*/
declare interface gfx$canvasext {}
...
using the dojoConfig option, canvasEvents:true|false.
*/
declare interface gfx$canvasWithEvents {
...
An object defining the default Circle prototype.
*/
declare interface gfx$defaultCircle {
...
Defines the default Ellipse prototype.
*/
declare interface gfx$defaultEllipse {
...
An object specifying the default properties for a Font used in text operations.
*/
declare interface gfx$defaultFont {
...
Defines the default Image prototype.
*/
declare interface gfx$defaultImage {
...
An object defining the default Line prototype.
*/
declare interface gfx$defaultLine {
...
Defines the default Path prototype object.
*/
declare interface gfx$defaultPath {
...
Linear gradients are drawn along a virtual line, which results in appearance of a rotated pattern in a given direction/orientation.
*/
declare interface gfx$defaultLinearGradient {
...
An object specifying the default properties for a Pattern using in fill operations.
*/
declare interface gfx$defaultPattern {
...
Defines the default PolyLine prototype.
*/
declare interface gfx$defaultPolyline {
...
An object specifying the default properties for RadialGradients using in fills patterns.
*/
declare interface gfx$defaultRadialGradient {
...
Defines the default Rect prototype.
*/
declare interface gfx$defaultRect {
...
Defines the default Text prototype.
*/
declare interface gfx$defaultText {
...
This object defines the default Stroke prototype.
*/
declare interface gfx$defaultStroke {
...
Defines the default TextPath prototype.
*/
declare interface gfx$defaultTextPath {
 ...
 */
declare interface gfx$defaultVectorFont {
 ...
 */
declare interface gfx$defaultVectorText {
 ...
 */
declare interface gfx$gradient {
 ...
 */
declare interface gfx$gradutils {
...
Linear gradients are drawn along a virtual line, which results in appearance of a rotated pattern in a given direction/orientation.
*/
declare interface gfx$LinearGradient {
...
declare interface gfx$matrix {
    ...
    flipX: Object,
         ...
         */
        multiplyPoint(matrix: undefined.Matrix2D, a: number, b: number): undefined.Point,
         ...
         * @param b Optionala y coordinate of a point
         */
        multiplyPoint(matrix: undefined.Matrix2D, a: undefined.Point, b: number): undefined.Point,
        ...
        */
        multiplyRectangle(matrix: undefined.Matrix2D, rect: undefined.Rect): undefined.Rectangle,
        ...
        */
        normalize(matrix: Object): undefined.Matrix2D,
        ...
        */
        project(a: undefined.Point, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala y coordinate value
        */
        project(a: number, b: number): undefined.Matrix2D,
        ...
        */
        reflect(a: undefined.Point, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala Y value
        */
        reflect(a: number, b: number): undefined.Matrix2D,
        ...
        */
        rotate(angle: number): undefined.Matrix2D,
         ...
         */
        rotateAt(angle: number, a: number, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        rotateAt(angle: number, a: undefined.Point, b: number): undefined.Matrix2D,
        ...
        */
        rotateg(degree: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        rotategAt(degree: number, a: number, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        rotategAt(degree: number, a: undefined.Point, b: number): undefined.Matrix2D,
         ...
         */
        scale(a: number, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala scaling factor used for the y coordinate
         */
        scale(a: undefined.Point, b: number): undefined.Matrix2D,
         ...
         */
        scaleAt(a: number, b: number, c: number, d: number): undefined.Matrix2D,
         ...
         * @param d a y component of a central point
         */
        scaleAt(a: number, b: number, c: undefined.Point, d: number): undefined.Matrix2D,
        ...
        */
        skewX(angle: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        skewXAt(angle: number, a: number, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        skewXAt(angle: number, a: undefined.Point, b: number): undefined.Matrix2D,
        ...
        */
        skewXg(degree: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        skewXgAt(degree: number, a: number, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        skewXgAt(degree: number, a: undefined.Point, b: number): undefined.Matrix2D,
         ...
         * @param angle a skewing angle in radians
        */
        skewY(angle: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        skewYAt(angle: number, a: number, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        skewYAt(angle: number, a: undefined.Point, b: number): undefined.Matrix2D,
         ...
         * @param degree a skewing angle in degrees
        */
        skewYg(degree: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        skewYgAt(degree: number, a: number, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala y component of a central point
         */
        skewYgAt(degree: number, a: undefined.Point, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala y coordinate value
         */
        translate(a: number, b: number): undefined.Matrix2D,
         ...
         * @param b Optionala y coordinate value
         */
        translate(a: undefined.Point, b: number): undefined.Matrix2D
}
...
Specifies the properties for RadialGradients using in fills patterns.
*/
declare interface gfx$RadialGradient {
...
Silverlight is a faster implementation on IE6-8 than the default 2d graphics, VML
*/
declare interface gfx$silverlight_attach {
...
Silverlight is a faster implementation on IE6-8 than the default 2d graphics, VML
*/
declare interface gfx$silverlight {
...
declare interface gfx$utils {
     ...
     */
    deserialize(parent: undefined.Shape, object: undefined.Shape): any,
         ...
         * @param object The shapes to deserialize.
         */
        deserialize(parent: undefined.Shape, object: any[]): any,
        ...
        */
        forEach(object: undefined.Shape, f: Function, o: Object): void,
         ...
         * @param o OptionalThe scope.
        */
        forEach(object: undefined.Shape, f: String, o: Object): void,
         ...
         * @param o OptionalThe scope.
        */
        forEach(object: undefined.Shape, f: any[], o: Object): void,
         ...
         */
        fromJson(parent: undefined.Shape, json: String): any,
         ...
         */
        serialize(object: undefined.Shape): any,
         ...
         */
        toJson(object: undefined.Shape, prettyPrint: boolean): String,
        ...
        */
        toSvg(surface: undefined.Surface): any
}
 ...
 */
declare interface gfx$vectorFontFitting {
...
This is the preferred renderer to use for interactive and accessible graphics.
*/
declare interface gfx$svg_attach {
...
declare class Group {
     ...
     */
    add(shape: undefined.Shape): Function;
 ...
 */
declare interface svg_attach$dasharray {
 ...
 */
declare interface svg_attach$xmlns {
...
IE9+ defaults to the standard W3C SVG renderer.
*/
declare interface gfx$vml_attach {
 ...
 */
declare interface vml_attach$_bool {
 ...
 */
declare interface vml_attach$text_alignment {
 ...
 * @param matrix a 2D matrix-like object
*/
declare interface gfx$decompose {
    (matrix: undefined.Matrix2D): void
}

declare module 'dojox/gfx' {
    declare     var exp: dojox$gfx;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.__MoveableCtorArgs' {
    declare     var exp: undefined.___MoveableCtorArgs;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Circle' {
    declare     var exp: undefined.Circle;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Ellipse' {
    declare     var exp: undefined.Ellipse;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/path' {
    declare     var exp: undefined.path;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/Mover' {
    declare     var exp: undefined.Mover;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/Moveable' {
    declare     var exp: undefined.Moveable;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Line' {
    declare     var exp: undefined.Line;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Point' {
    declare     var exp: undefined.Point;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Group' {
    declare     var exp: undefined.Group;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Polyline' {
    declare     var exp: undefined.Polyline;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Rect' {
    declare     var exp: undefined.Rect;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Rectangle' {
    declare     var exp: undefined.Rectangle;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Surface' {
    declare     var exp: undefined.Surface;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.TextPath' {
    declare     var exp: undefined.TextPath;
    declare module.exports: typeof exp
}
...
declare module 'dojox/gfx.VectorFont' {
    declare     var exp: undefined.VectorFont;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/VectorText' {
    declare     var exp: undefined.VectorText;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/decompose' {
    declare     var exp: undefined.decompose;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx._vectorFontCache' {
    declare     var exp: undefined._vectorFontCache;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx._svgFontCache' {
    declare     var exp: undefined._svgFontCache;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/arc' {
    declare     var exp: undefined.arc;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/bezierutils' {
    declare     var exp: undefined.bezierutils;
    declare module.exports: typeof exp
}
...
declare module 'dojox/gfx/_gfxBidiSupport' {
    declare     var exp: undefined._gfxBidiSupport;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/canvas' {
    declare     var exp: undefined.canvas;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/canvasWithEvents' {
    declare     var exp: undefined.canvasWithEvents;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultCircle' {
    declare     var exp: undefined.defaultCircle;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/canvasext' {
    declare     var exp: undefined.canvasext;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultImage' {
    declare     var exp: undefined.defaultImage;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultLine' {
    declare     var exp: undefined.defaultLine;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/canvas_attach' {
    declare     var exp: undefined.canvas_attach;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultLinearGradient' {
    declare     var exp: undefined.defaultLinearGradient;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultEllipse' {
    declare     var exp: undefined.defaultEllipse;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultFont' {
    declare     var exp: undefined.defaultFont;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultPath' {
    declare     var exp: undefined.defaultPath;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultPattern' {
    declare     var exp: undefined.defaultPattern;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultRadialGradient' {
    declare     var exp: undefined.defaultRadialGradient;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultRect' {
    declare     var exp: undefined.defaultRect;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultPolyline' {
    declare     var exp: undefined.defaultPolyline;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultStroke' {
    declare     var exp: undefined.defaultStroke;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultText' {
    declare     var exp: undefined.defaultText;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Fill' {
    declare     var exp: undefined.Fill;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultVectorFont' {
    declare     var exp: undefined.defaultVectorFont;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultVectorText' {
    declare     var exp: undefined.defaultVectorText;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.defaultTextPath' {
    declare     var exp: undefined.defaultTextPath;
    declare module.exports: typeof exp
}
...
declare module 'dojox/gfx/gradient' {
    declare     var exp: undefined.gradient;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Font' {
    declare     var exp: undefined.Font;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/gradutils' {
    declare     var exp: undefined.gradutils;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.LinearGradient' {
    declare     var exp: undefined.LinearGradient;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/move' {
    declare     var exp: undefined.move;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/matrix' {
    declare     var exp: undefined.matrix;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Pattern' {
    declare     var exp: undefined.Pattern;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.RadialGradient' {
    declare     var exp: undefined.RadialGradient;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/shape' {
    declare     var exp: undefined.shape;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/silverlight' {
    declare     var exp: undefined.silverlight;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.Stroke' {
    declare     var exp: undefined.Stroke;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/silverlight_attach' {
    declare     var exp: undefined.silverlight_attach;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/svgext' {
    declare     var exp: undefined.svgext;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/svg' {
    declare     var exp: undefined.svg;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx.vectorFontFitting' {
    declare     var exp: undefined.vectorFontFitting;
    declare module.exports: typeof exp
}
...
declare module 'dojox/gfx/vml' {
    declare     var exp: undefined.vml;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/filters' {
    declare     var exp: undefined.filters;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/registry' {
    declare     var exp: undefined.registry;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/renderer' {
    declare     var exp: undefined.renderer;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/svg_attach' {
    declare     var exp: undefined.svg_attach;
    declare module.exports: typeof exp
}
...
declare module 'dojox/gfx/svg_attach.Image' {
    declare     var exp: undefined.Image;
    declare module.exports: typeof exp
}
...
declare module 'dojox/gfx/svg_attach.dasharray' {
    declare     var exp: undefined.dasharray;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/svg_attach.xmlns' {
    declare     var exp: undefined.xmlns;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/vml_attach' {
    declare     var exp: undefined.vml_attach;
    declare module.exports: typeof exp
}
...
declare module 'dojox/gfx/vml_attach._bool' {
    declare     var exp: undefined._bool;
    declare module.exports: typeof exp
}
declare module 'dojox/gfx/vml_attach.text_alignment' {
    declare     var exp: undefined.text_alignment;
    declare module.exports: typeof exp
}