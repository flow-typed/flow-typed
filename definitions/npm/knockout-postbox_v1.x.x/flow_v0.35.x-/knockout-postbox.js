// @flow
/**
 * Flowtype definitions for knockout-postbox
...
declare interface KnockoutPostBox {
    subscribe<T>(
            ...
            target?: any): KnockoutSubscription,
...
declare interface KnockoutObservable<T>{
    subscribeTo(
        ...
        transform?: (val: any) => T): KnockoutObservable<T>,
    unsubscribeFrom(topic: string): KnockoutObservable<T>,
    publishOn(
        topic: string,
        skipInitialPublish?: boolean,
        equalityComparer?: (newValue: T, oldValue: T) => boolean): KnockoutObservable<T>,
...
declare interface KnockoutObservableArray<T>{
    subscribeTo(
        topic: string,
        useLastPublishedValueToInitialize?: boolean,
        transform?: (val: any) => any): KnockoutObservableArray<T>,
    unsubscribeFrom(topic: string): KnockoutObservableArray<T>,
    publishOn(
        topic: string,
        skipInitialPublish?: boolean,
        equalityComparer?: (newValue: any, oldValue: any) => boolean): KnockoutObservableArray<T>,
