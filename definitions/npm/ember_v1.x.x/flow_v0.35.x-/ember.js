/**
 * Flowtype definitions for ember
...
*/
declare function Ember$A(arr?: any[]): Em$NativeArray
...
declare class ArrayProxy mixins Object, MutableArray {
    ...
    length: number;
    addObject(object: any): any;
    addObjects(objects: Em$Enumerable): Em$MutableEnumberable;
    removeObject(object: any): any;
    removeObjects(objects: Em$Enumerable): Em$MutableEnumberable
}

declare var BOOTED: boolean;
...
declare class Button mixins Component, TargetActionSupport {
    detect(obj: any): boolean;
    detectInstance(obj: any): boolean;
 ...
 */
declare class Checkbox mixins Component {
    detect(obj: any): boolean;
    detectInstance(obj: any): boolean;
...
declare function Ember$DEFAULT_GETTER_FUNCTION(name: string): Function
...
declare export var EXTEND_PROTOTYPES: typeof undefined;

declare export var LOG_BINDINGS: boolean;

declare export var LOG_STACKTRACE_ON_DEPRECATION: boolean;

declare export var LOG_VERSION: boolean;

declare export var MODEL_FACTORY_INJECTIONS: boolean;

declare export var RAISE_ON_DEPRECATION: boolean;

declare export var Array: boolean;

declare export var Function: boolean;

declare export var String: boolean;
...
declare var FROZEN_ERROR: string;
...
declare function Handlebars$compile(string: string): Function
...
declare var K: Function;

declare var LOG_BINDINGS: boolean;

declare var LOG_STACKTRACE_ON_DEPRECATION: boolean;

declare var LOG_VERSION: boolean;
...
declare function Ember$MANDATORY_SETTER_FUNCTION(value: string): void

declare var META_KEY: string;
...
declare class MutableArray mixins Array, MutableEnumberable {
    ...
    length: number;
    addObject(object: any): any;
    addObjects(objects: Ember$Enumerable): Em$MutableEnumberable;
    removeObject(object: any): any;
    removeObjects(objects: Ember$Enumerable): Em$MutableEnumberable
}
...
declare var ORDER_DEFINITION: string[];
...
declare function String$camelize(str: string): string

declare function String$capitalize(str: string): string

declare function String$classify(str: string): string

declare function String$dasherize(str: string): string

declare function String$decamelize(str: string): string

declare function String$fmt(...args: string[]): string

declare function String$htmlSafe(str: string): void

declare function String$loc(...args: string[]): string

declare function String$underscore(str: string): string

declare function String$w(str: string): string[]
...
declare class Adapter mixins Ember$Object {
    constructor(): this
}
...
declare function Test$oninjectHelpers(callback: Function): void

declare function Test$promise(resolver: Function, label: string): undefined.Promise

declare function Test$unregisterHelper(name: string): void

declare function Test$registerHelper(name: string, helperMethod: Function): void

declare function Test$registerAsyncHelper(name: string, helperMethod: Function): void

declare var adapter: Ember$Object;

declare var QUnitAdapter: Ember$Object;

declare function Test$registerWaiter(callback: Function): void

declare function Test$unregisterWaiter(callback: Function): void

declare function Test$resolve(result: any): undefined.Promise

declare class TextArea mixins Component, TextSupport {
    detect(obj: any): boolean;
    detectInstance(obj: any): boolean;
...
declare class TextField mixins Component, TextSupport {
    detect(obj: any): boolean;
    detectInstance(obj: any): boolean;
...
declare var ViewUtils: {};

declare function Ember$addListener(
    obj: any,
    eventName: string,
    target: any,
    method: Function,
...
declare var addObserver: ModifyObserver;

declare var alias: typeof deprecateFunc;

declare function Ember$aliasMethod(methodName: string): Ember$Descriptor

declare function Ember$assert(desc: string, test: boolean): void

declare function Ember$beginPropertyChanges(): void

declare function Ember$bind(obj: any, to: string, from: string): Ember$Binding

declare function Ember$cacheFor(obj: any, key: string): any

declare function Ember$canInvoke(obj: any, methodName: string): boolean

declare function Ember$changeProperties(callback: Function, binding?: any): void

declare function Ember$compare(v: any, w: any): number

declare var computed: {
...
declare function Ember$controllerFor(
    container: Ember$Container,
    controllerName: string,
    lookupOptions?: {}): Ember$Controller

declare function Ember$copy(obj: any, deep: boolean): any
 ...
 * @param arguments A hash containing values with which to initialize the newly instantiated object.
 */
declare function Ember$create(arguments?: {}): Ember$CoreObject

declare function Ember$debug(message: string): void

declare function Ember$defineProperty(obj: any, keyName: string, desc: {}): void

declare function Ember$deprecate(message: string, test?: boolean): void

declare function Ember$deprecateFunc(message: string, func: Function): Function

declare function Ember$destroy(obj: any): void

declare var empty: typeof deprecateFunc;

declare function Ember$endPropertyChanges(): void

declare function Ember$finishChains(obj: any): void

declare function Ember$generateController(
    container: Ember$Container,
    controllerName: string,
    context: any): Ember$Controller

declare function Ember$generateGuid(obj: any, prefix?: string): string

declare function Ember$get(obj: any, keyName: string): any

declare var getPath: typeof deprecateFunc;

declare function Ember$getWithDefault(root: string, key: string, defaultValue: any): any

declare function Ember$guidFor(obj: any): string

declare function Ember$handleErrors(func: Function, context: any): any

declare function Ember$hasListeners(context: any, name: string): boolean

declare function Ember$hasOwnProperty(prop: string): boolean

declare function Ember$immediateObserver(func: Function, ...propertyNames: any[]): Function

declare function Ember$inspect(obj: any): string

declare function Ember$instrument(name: string, payload: any, callback: Function, binding: any): void

declare function Ember$isArray(obj: any): boolean

declare function Ember$isEmpty(obj: any): boolean

declare function Ember$isEqual(a: any, b: any): boolean

declare function Ember$isGlobalPath(path: string): boolean

declare var isNamespace: boolean;

declare function Ember$isNone(obj: any): boolean

declare function Ember$isPrototypeOf(obj: {}): boolean

declare function Ember$isWatching(obj: any, key: string): boolean

declare function Ember$keys(obj: any): any[]

declare function Ember$listenersDiff(obj: any, eventName: string, otherActions: any[]): any[]

declare function Ember$listenersFor(obj: any, eventName: string): any[]

declare function Ember$listenersUnion(obj: any, eventName: string, otherActions: any[]): void

declare var lookup: {};

declare function Ember$makeArray(obj: any): any[]

declare function Ember$merge(original: any, updates: any): any

declare function Ember$meta(obj: any): {}

declare function Ember$mixin(obj: any, ...args: any[]): any

declare var none: typeof deprecateFunc;

declare function Ember$observer(...args: any[]): Function

declare function Ember$observersFor(obj: any, path: string): any[]

declare function Ember$onLoad(name: string, callback: Function): void

declare var onError: Error;

declare function Ember$overrideChains(obj: any, keyName: string, m: any): boolean
...
declare function Ember$propertyDidChange(obj: any, keyName: string): void

declare function Ember$propertyIsEnumerable(prop: string): boolean

declare function Ember$propertyWillChange(obj: any, keyName: string): void

declare function Ember$removeChainWatcher(obj: any, keyName: string, node: any): void

declare function Ember$removeListener(obj: any, eventName: string, target: any, method: Function): void

declare function Ember$removeObserver(obj: any, path: string, target: any, method: Function): any

declare function Ember$required(): Ember$Descriptor

declare function Ember$rewatch(obj: any): void
...
declare function Ember$runLoadHooks(name: string, object: any): void

declare function Ember$sendEvent(obj: any, eventName: string, params?: any[], actions?: any[]): boolean

declare function Ember$set(obj: any, keyName: string, value: any): any

declare var setPath: typeof deprecateFunc;

declare function Ember$setProperties(self: any, hash: {}): any

declare function Ember$subscribe(pattern: string, object: any): void

declare function Ember$toLocaleString(): string

declare function Ember$toString(): string

declare function Ember$tryCatchFinally(
    tryable: Function,
    catchable: Function,
    finalizer: Function,
    binding?: any): any

declare function Ember$tryInvoke(obj: any, methodName: string, args?: any[]): any

declare function Ember$trySet(obj: any, path: string, value: any): void

declare var trySetPath: typeof deprecateFunc;

declare function Ember$typeOf(item: any): string

declare function Ember$unwatch(obj: any, keyPath: string): void

declare function Ember$unwatchKey(obj: any, keyName: string): void

declare function Ember$unwatchPath(obj: any, keyPath: string): void

declare var uuid: number;

declare function Ember$valueOf(): {}

declare function Ember$warn(message: string, test?: boolean): void

declare function Ember$watch(obj: any, keyPath: string): void

declare function Ember$watchKey(obj: any, keyName: string): void

declare function Ember$watchPath(obj: any, keyPath: string): void

declare function Ember$watchedEvents(obj: {}): any[]

declare function Ember$wrap(func: Function, superFunc: Function): Function

declare var _ContainerProxyMixin: Ember$Mixin;

declare var _RegistryProxyMixin: Ember$Mixin;

declare function Ember$getOwner(object: any): any

declare function Ember$setOwner(object: any, owner: any): void

declare var testing: boolean;

declare var MODEL_FACTORY_INJECTIONS: boolean;

declare function Ember$assign(original: any, ...sources: any[]): anydeclare var $: typeof undefined;
...
declare class MutableEnumberable mixins Ember$MutableEnumberable {}
...
declare class Registry mixins Ember$Registry {}
...
declare class Adapter mixins undefined.Adapter {}

declare class Promise mixins undefined.Promise {}

declare var oninjectHelpers: typeof undefined;

declare var promise: typeof undefined;

declare var unregisterHelper: typeof undefined;

declare var registerHelper: typeof undefined;

declare var registerAsyncHelper: typeof undefined;

declare var adapter: typeof undefined;

declare var QUnitAdapter: typeof undefined;

declare var registerWaiter: typeof undefined;

declare var unregisterWaiter: typeof undefined;
...
declare var _ContainerProxyMixin: typeof undefined;

declare var _RegistryProxyMixin: typeof undefined;

declare var getOwner: typeof undefined;

declare var setOwner: typeof undefined;

declare var testing: typeof undefined;

declare var MODEL_FACTORY_INJECTIONS: typeof undefined;

declare var assign: typeof undefined;
declare module 'Ember' {
    declare module.exports: typeof Ember
}