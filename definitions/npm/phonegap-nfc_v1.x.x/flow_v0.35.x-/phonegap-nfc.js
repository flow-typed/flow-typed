// @flow
/**
 * Flowtype definitions for phonegap-nfc
 ...
 * Global object NFC.
 */
declare interface PhoneGapNfc$Window {
    nfc: PhoneGapNfc$Nfc,
        ndef: PhoneGapNfc$Ndef,
        util: PhoneGapNfc$Util,
        fireNfcTagEvent(event: PhoneGapNfc$TagEvent, tagAsJson: string): void
}

declare interface PhoneGapNfc$Tag {
    id: Array<number>,
...
declare interface PhoneGapNfc$NdefRecord {
...
declare type PhoneGapNfc$NdefTag = {
    canMakeReadOnly: boolean,
    isWritable: boolean,
    maxSize: number,
    ndefMessage: Array<PhoneGapNfc$NdefRecord >
} & PhoneGapNfc$Tag


declare type PhoneGapNfc$TagEvent = {
    tag: PhoneGapNfc$Tag
} & Event


declare type PhoneGapNfc$NdefTagEvent = {
    tag: PhoneGapNfc$NdefTag
} & PhoneGapNfc$TagEvent


declare interface PhoneGapNfc$UriHelper {
...
declare interface PhoneGapNfc$TextHelper {
 ...
 * The Ndef object.
 */
declare interface PhoneGapNfc$Ndef {
    TNF_EMPTY: number,
        ...
        uriHelper: PhoneGapNfc$UriHelper,
        textHelper: PhoneGapNfc$TextHelper,
        ...
        record(
            ...
            type: Array<number>,
            id: Array<number>,
            payload: Array<number>): PhoneGapNfc$NdefRecord,
         ...
         * @return  NdefRecord
         */
        textRecord(text: string, languageCode: string, id: Array<number>): PhoneGapNfc$NdefRecord,
         ...
         * @return  NdefRecord
         */
        uriRecord(uri: string, id: Array<number>): PhoneGapNfc$NdefRecord,
         ...
         * @return  NdefRecord
        */
        absoluteUriRecord(uri: string, payload: Array<number>, id: Array<number>): PhoneGapNfc$NdefRecord,
        ...
        mimeMediaRecord(
            mimeType: string,
            payload: Array<number>,
            id: Array<number>): PhoneGapNfc$NdefRecord,
         ...
         */
        smartPoster(
            ndefRecords: Array<PhoneGapNfc$NdefRecord>,
            id: Array<number>): PhoneGapNfc$NdefRecord,

        /**
         * Helper that creates an empty NdefRecord.
         */
        emptyRecord(): PhoneGapNfc$NdefRecord,
         ...
         */
        androidApplicationRecord(packageName: string): PhoneGapNfc$NdefRecord,
         ...
         */
        encodeMessage(ndefRecords: Array<PhoneGapNfc$NdefRecord>): Array<number>,
         ...
         * @see  NFC Data Exchange Format (NDEF) http://www.nfc-forum.org/specs/spec_list/
         */
        decodeMessage(bytes: Array<number>): Array<PhoneGapNfc$NdefRecord>,
...
declare interface PhoneGapNfc$Util {
...
declare type PhoneGapNfc$Nfc = {
    ...
    addTagDiscoveredListener(
        callback: (event: PhoneGapNfc$TagEvent) => void,
        win?: () => void,
        fail?: () => void): void,
    ...
    */
    addNdefListener(
        callback: (event: PhoneGapNfc$NdefTagEvent) => void,
        win?: () => void,
        fail?: () => void): void,
...
declare module 'ndef' {
    declare module.exports: typeof ndef
}
declare module 'util' {
