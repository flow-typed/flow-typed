/**
 * Flowtype definitions for AmCharts
 ...
 */
declare
function AmCharts$ready(Function: << UNKNOWN PARAM FORMAT >> ): void
 ...
 */
declare
function AmCharts$makeChart(selector: string, params: any, delay?: number): AmCharts$AmChart
...
*/
declare
function AmCharts$addInitHandler(handler: Function, types: string[]): void
