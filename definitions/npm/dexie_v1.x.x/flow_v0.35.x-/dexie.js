...
declare module 'dexie' {
	...
	declare interface Thenable<R> {
		...
		addons: Array<(db: Dexie) => void>;
		version: number;
		getDatabaseNames(): Dexie.Promise<Array<string>>;
		getDatabaseNames<U>(onFulfilled: (value: Array<string>) => Thenable<U>): Dexie.Promise<U>;
		getDatabaseNames<U>(onFulfilled: (value: Array<string>) => U): Dexie.Promise<U>;
		...
		delete(databaseName: string): Dexie.Promise<void>;
		exists(databaseName: string): Dexie.Promise<boolean>;
		...
		transaction<U>(
		mode: string, table: Dexie.Table<any, any>, scope: () => Thenable<U>
	): Dexie.Promise<U>;
		transaction<U>(
		mode: string, table: Dexie.Table<any, any>, table2: Dexie.Table<any, any>, scope: () => Thenable<U>
	): Dexie.Promise<U>;
		transaction<U>(
		mode: string, table: Dexie.Table<any, any>, table2: Dexie.Table<any, any>, table3: Dexie.Table<any, any>, scope: () => Thenable<U>
	): Dexie.Promise<U>;
		transaction<U>(
		mode: string, tables: Dexie.Table<any, any>[], scope: () => Thenable<U>
	): Dexie.Promise<U>;
		transaction<U>(
		mode: string, table: Dexie.Table<any, any>, scope: () => U
	): Dexie.Promise<U>;
		transaction<U>(
		mode: string, table: Dexie.Table<any, any>, table2: Dexie.Table<any, any>, scope: () => U
	): Dexie.Promise<U>;
		transaction<U>(
		mode: string, table: Dexie.Table<any, any>, table2: Dexie.Table<any, any>, table3: Dexie.Table<any, any>, scope: () => U
	): Dexie.Promise<U>;
		transaction<U>(
		mode: string, tables: Dexie.Table<any, any>[], scope: () => U
	): Dexie.Promise<U>;
		close(): void;
...
declare module 'npm$namespace$Dexie' {
	...
	declare interface DexieEvent {
		subscribe(fn: () => any): void,
		unsubscribe(fn: () => any): void,
		fire(): any
	}

	declare interface DexieErrorEvent {
		subscribe(fn: (error: any) => any): void,
		unsubscribe(fn: (error: any) => any): void,
		fire(error: any): any
	}

	declare interface DexieVersionChangeEvent {
	...
	declare interface DexieOnReadyEvent {
		subscribe(fn: () => any, bSticky: boolean): void,
		unsubscribe(fn: () => any): void,
		fire(): any
	}

	declare interface Table<T, Key> {
		name: string,
		schema: TableSchema,
		hook: {
		(eventName: string, subscriber: () => any): void,
	...
	declare interface WhereClause<T, Key> {
		...
		between(
		lower: IndexableType, upper: IndexableType, includeLower?: boolean, includeUpper?: boolean
	): Collection<T, Key>,
	...
	declare interface Collection<T, Key> {
	...
	declare interface IndexSpec {
		...
		declare class Promise<R> extends Thenable<R> {
...
declare module 'Promise' {
			declare function resolve<R>(value?: Thenable<R>): Promise<R>

	declare function resolve<R>(value?: R): Promise<R>

	declare function reject(error: any): Promise<any>

	declare function all<R>(promises: Thenable<R>[]): Promise<R[]>

	declare function all<R>(...promises: Thenable<R>[]): Promise<R[]>

	declare function race<R>(promises: Thenable<R>[]): Promise<R>

	declare function newPSD<R>(scope: () => R): R
