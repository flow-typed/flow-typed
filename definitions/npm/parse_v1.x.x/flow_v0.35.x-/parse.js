...
declare
var npm$namespace$Analytics: {
    track: typeof Analytics$track,
}
declare
function Analytics$track<T>(name: string, dimensions: any): Parse$Promise<T >


    declare
var npm$namespace$FacebookUtils: {
...
declare
function FacebookUtils$init(options?: any): void

declare
function FacebookUtils$isLinked(user: Parse$User): boolean

declare
function FacebookUtils$link(
    user: Parse$User,
    permissions: any,
    options?: Parse$SuccessFailureOptions): void

declare
function FacebookUtils$logIn(permissions: any, options?: Parse$SuccessFailureOptions): void

declare
function FacebookUtils$unlink(user: Parse$User, options?: Parse$SuccessFailureOptions): void


declare
var npm$namespace$Cloud: {
...
declare
function Cloud$afterDelete(arg1: any, func?: (request: Cloud$AfterDeleteRequest) => void): void

declare
function Cloud$afterSave(arg1: any, func?: (request: Cloud$AfterSaveRequest) => void): void

declare
function Cloud$beforeDelete(
    arg1: any,
    func?: (
...
declare
function Cloud$run<T>(name: string, data?: any, options?: Cloud$RunOptions): Parse$Promise<T >

    declare
function Cloud$useMasterKey(): void

declare type Cloud$RunOptions = {} & Parse$SuccessFailureOptions & Parse$ScopeOptions


declare
var HTTPOptions: () => Cloud$HTTPOptions;
...
declare
var npm$namespace$Push: {
    send: typeof Push$send,
}
declare
function Push$send<T>(data: Push$PushData, options?: Push$SendOptions): Parse$Promise<T >
 ...
 */
declare
function Parse$initialize(applicationId: string, javaScriptKey?: string, masterKey?: string): voiddeclare module 'parse/node' {
