/**
 * Flowtype definitions for react-datagrid
...
declare module 'react-datagrid' {
    declare module.exports: typeof DataGrid
}
declare type ReactDataGrid$DataGridProps = {
    ...
    */
     ...
     */
    onSortChange?: (sortInfo: ReactDataGrid$SortInfo[]) => void,

    /**
     * Array - an array with sorting information.
     */
    sortInfo?: ReactDataGrid$SortInfo[],
    ...
    */
    rowStyle?: ___React.CSSProperties | ((data: any, props: ReactDataGrid$RowProps) => React.CSSProperties),
     ...
     */
    onColumnResize?: (
        firstCol: ReactDataGrid$Column,
        firstSize: number,
        secondCol: ReactDataGrid$Column,
        secondSize: number) => void,
     ...
     */
    onColumnVisibilityChange?: (column: ReactDataGrid$Column, visibility: boolean) => void,
     ...
     */
    onFilter?: (column: ReactDataGrid$Column, value: any, allFilterValues: any[]) => void,
    ...
    */
     ...
     */
    paginationToolbarProps?: ReactDataGrid$PaginationToolbarProps,
     ...
     */
    onPageSizeChange?: (pageSize: number, props: ReactDataGrid$DataGridProps) => void
}

declare interface ReactDataGrid$SortInfo {
    name: string,
        dir: string
}

declare interface ReactDataGrid$Column {
    ...
    name: string,
        ...
        */
        render?: (value: any, data: any, cellProps: ReactDataGrid$CellProps) => any,
...
declare interface ReactDataGrid$CellProps {
...
declare interface ReactDataGrid$RowProps {
...
declare interface ReactDataGrid$PaginationToolbarProps {
