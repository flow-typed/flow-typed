import type { Color } from 'npm$namespace$Color'
...
declare module 'npm$namespace$Color' {
	declare type ColorParam = string | RGBColor | FullRGBColor | HSLColor | FullHSLColor | HSVColor | FullHSVColor | HBWColor | FullHBWColor | CMYKColor | FullCMYKColor;
	...
	declare interface FullRGBColor {
		red: number,
		green: number,
		blue: number,
		alpha?: number
	...
	declare interface FullHSLColor {
		hue: number,
		saturation: number,
		lightness: number,
		alpha?: number
	...
	declare interface FullHSVColor {
		hue: number,
		saturation: number,
		value: number
	}

	declare interface HBWColor {
		h: number,
		b: number,
		w: number
	}

	declare interface FullHBWColor {
		hue: number,
		whiteness: number,
		blackness: number
	}
	...
	declare interface FullCMYKColor {
		cyan: number,
		magenta: number,
		yellow: number,
		black: number
