import type { Atmosphere } from 'npm$namespace$Atmosphere'

declare module 'atmosphere' {
					declare module.exports: Atmosphere


}

declare module 'npm$namespace$Atmosphere' {
	...
	declare interface AtmosphereRequest {
		new (): Request
	}
