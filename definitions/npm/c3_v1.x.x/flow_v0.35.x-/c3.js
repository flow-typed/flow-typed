...
declare type c3$FormatFunction = (v: any, id: string, i: number, j: number) => void;

declare interface c3$TargetIds {
    ids: c3$ArrayOrString
}

declare type c3$ArrayOrString = Array<string>| string;

declare interface c3$ChartConfiguration {
    ...
    */
    bindto?: string | HTMLElement | d3.Selection<any>,
        ...
        */
        regions?: Array<c3$RegionOptions>,
...
declare interface c3$Data {
    ...
    url?: string,
         ...
         */
        rows?: Array<c3$PrimitiveArray>,
        columns?: Array<c3$PrimitiveArray>,
        ...
        */
        labels?: boolean | {
            format: c3$FormatFunction
        } | {
            format: {
                [key: string]: c3$FormatFunction
            }
        },
...
declare interface c3$Axis {

    /**
     * Switch x and y axis position.
     */
    rotated?: boolean,
        x?: c3$XAxisConfiguration,
        y?: c3$YAxisConfiguration,
        y2?: c3$YAxisConfiguration
}

declare interface c3$XAxisConfiguration {
...
declare interface c3$YAxisConfiguration {
...
declare interface c3$XTickConfiguration {
    ...
    centered?: boolean,
         ...
         */
        culling?: boolean | c3$CullingConfiguration,
...
declare interface c3$YTickConfiguration {
...
declare interface c3$CullingConfiguration {
...
declare interface c3$LineOptions {
    value: number,
        text?: string,
        axis?: string,
        position?: string,
...
declare interface c3$RegionOptions {
    axis?: string,
...
declare interface c3$LegendOptions {
...
declare interface c3$TooltipOptions {
...
declare interface c3$SubchartOptions {
...
declare interface c3$ZoomOptions {
...
declare interface c3$PointOptions {
...
declare interface c3$ChartAPI {
    ...
    focus(targetIds?: c3$ArrayOrString): void,
        ...
        */
        show(targetIds?: c3$ArrayOrString, options?: {
            withLegend: boolean
        }): void,
        ...
        */
        hide(targetIds?: c3$ArrayOrString, options?: {
            withLegend: boolean
        }): void,
        ...
        */
        toggle(targetIds?: c3$ArrayOrString, options?: {
            withLegend: boolean
        }): void,
        ...
        */
        ...
        NOTE: done will be called after data loaded, but it's not after rendering. It's because rendering will finish after some transition and there is some time lag between loading and rendering.
        */
        unload(targetIds?: c3$TargetIds, done?: () => any): any,
        ...
        */
         ...
         */
        selected(targetId?: string): c3$Data,
         ...
         */
        transform(type: string, targetIds?: c3$ArrayOrString): void,
        ...
        xgrids: c3$GridOperations,
        ygrids: c3$GridOperations,
        regions: {
        ...
        data: {
             ...
             */
            (targetIds?: c3$ArrayOrString): c3$Data,
             ...
             */
            shown(targetIds?: c3$ArrayOrString): c3$Data,
             ...
             */
            values(targetIds?: c3$ArrayOrString): Array<any>,
         ...
         */
        x(x?: c3$PrimitiveArray): c3$PrimitiveArray,
        ...
        legend: {
             ...
             */
            show(targetIds?: c3$ArrayOrString): void,
             ...
             */
            hide(targetIds?: c3$ArrayOrString): void
        },
        zoom: {
...
declare interface c3$GridOperations {
