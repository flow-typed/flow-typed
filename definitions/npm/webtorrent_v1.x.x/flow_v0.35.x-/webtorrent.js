// @flow
/**
 * Flowtype definitions for webtorrent
...
declare export type WebTorrent$Client = {
    ...
    */
    add(
        magnetUriOrPathOrInfoHash: string,
        opts?: WebTorrent$TorrentOptions,
        onTorrentCallback?: (torrent: WebTorrent$Torrent) => void): WebTorrent$Torrent,
    add(
        torrentFileOrInfoHash: Buffer,
        opts?: WebTorrent$TorrentOptions,
        onTorrentCallback?: (torrent: WebTorrent$Torrent) => void): WebTorrent$Torrent,
    add(
        parsedTorrent: ParseTorrent.ParsedTorrent,
        opts?: WebTorrent$TorrentOptions,
        onTorrentCallback?: (torrent: WebTorrent$Torrent) => void): WebTorrent$Torrent,
    add(
        magnetUriOrPathOrInfoHash: string,
    ...
    */
    seed(
        ...
        opts?: WebTorrent$TorrentOptions | any,
        onSeed?: (torrent: WebTorrent$Torrent) => void): void,
    seed(
        inputFile: File,
        opts?: WebTorrent$TorrentOptions | any,
        onSeed?: (torrent: WebTorrent$Torrent) => void): void,
    ...
    seed(
        ...
        onSeed?: (torrent: WebTorrent$Torrent) => void): void,
    seed(
        inputBuffersFilesOrPaths: Array<string | File | Buffer>,
        opts?: WebTorrent$TorrentOptions | any,
        onSeed?: (torrent: WebTorrent$Torrent) => void): void,
    seed(
        inputFileOrFolderPath: string,
        onSeed?: (torrent: WebTorrent$Torrent) => void): void,
    seed(inputFile: File, onSeed?: (torrent: WebTorrent$Torrent) => void): void,
    seed(inputFileList: FileList, onSeed?: (torrent: WebTorrent$Torrent) => void): void,
    seed(inputBuffer: Buffer, onSeed?: (torrent: WebTorrent$Torrent) => void): void,
    seed(
        inputBuffersFilesOrPaths: Array<string | File | Buffer>,
        onSeed?: (torrent: WebTorrent$Torrent) => void): void,
     ...
     */
    torrents: Array<WebTorrent$Torrent>,
     ...
     */
    get(torrentId: string): WebTorrent$Torrent,
...
declare export type WebTorrent$Torrent = {
     ...
     */
    files: Array<WebTorrent$InTorrentFile>,
...
declare export type WebTorrent$InTorrentFile = {
    ...
    */
    appendTo(
        ...
        callback?: (err: Error, elem: Element) => void): void,
...
declare module 'webtorrent' {
    ...
    declare module.exports: typeof webTorrentStatic
}