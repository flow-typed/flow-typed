/**
 * Flowtype definitions for jasmine-jquery
...
declare
function sandbox(attributes?: any): stringdeclare
function readFixtures(...uls: string[]): stringdeclare
function preloadFixtures(...uls: string[]): voiddeclare
function loadFixtures(...uls: string[]): voiddeclare
function appendLoadFixtures(...uls: string[]): voiddeclare
function setFixtures(html: string): stringdeclare
function appendSetFixtures(html: string): voiddeclare
function preloadStyleFixtures(...uls: string[]): voiddeclare
function loadStyleFixtures(...uls: string[]): voiddeclare
function appendLoadStyleFixtures(...uls: string[]): voiddeclare
function setStyleFixtures(html: string): voiddeclare
function appendSetStyleFixtures(html: string): voiddeclare
function loadJSONFixtures(...uls: string[]): jasmine$JSONFixturesdeclare
function getJSONFixture(url: string): anydeclare
function spyOnEvent(selector: string, eventName: string): jasmine$JQueryEventSpy
declare
var npm$namespace$jasmine: {
    spiedEventsKey: typeof jasmine$spiedEventsKey,
    getFixtures: typeof jasmine$getFixtures,
    getStyleFixtures: typeof jasmine$getStyleFixtures,
    getJSONFixtures: typeof jasmine$getJSONFixtures,
}
declare
function jasmine$spiedEventsKey(selector: JQuery, eventName: string): string

declare
function jasmine$getFixtures(): jasmine$Fixtures

declare
function jasmine$getStyleFixtures(): jasmine$StyleFixtures

declare
function jasmine$getJSONFixtures(): jasmine$JSONFixtures

declare interface jasmine$Fixtures {
    fixturesPath: string,
        containerId: string,
...
declare interface jasmine$StyleFixtures {
    fixturesPath: string,
        set(html: string): string,
        appendSet(html: string): void,
        preload(...uls: string[]): void,
...
declare interface jasmine$JSONFixtures {
    fixturesPath: string,
        load(...uls: string[]): void,
        read(...uls: string[]): string,
        clearCache(): void,
    ...
    */
    toHaveClass(className: string): boolean,
        ...
        */
         ...
         * @example  * expect($('<span></span>').addClass('js-something')).toBeMatchedBy('.js-something')
         * @returns  true if DOM contains the element
         */
        ...
        */
         ...
         * @example  * expect($form).toHandleWith("submit", yourSubmitCallback)
         */
        ...
        */
         ...
         * @example  * expect($('#id-name')[0]).toBeInDOM()
         */
        toBeInDOM(): boolean
}

declare interface jasmine$JQueryEventSpy {
    selector: string,
        eventName: string,
...
declare interface jasmine$JasmineJQuery {
    browserTagCaseIndependentHtml(html: string): string,
        elementToString(element: JQuery): string,
        matchersClass: any,
        events: jasmine$JasmineJQueryEvents
}

declare interface jasmine$JasmineJQueryEvents {
    spyOn(selector: string, eventName: string): jasmine$JQueryEventSpy,
...
declare
var JQuery: jasmine$JasmineJQuery;