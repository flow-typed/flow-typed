...
declare function sandbox(attributes?: any): stringdeclare function readFixtures(...uls: string[]): stringdeclare function preloadFixtures(...uls: string[]): voiddeclare function loadFixtures(...uls: string[]): voiddeclare function appendLoadFixtures(...uls: string[]): voiddeclare function setFixtures(html: string): stringdeclare function appendSetFixtures(html: string): voiddeclare function preloadStyleFixtures(...uls: string[]): voiddeclare function loadStyleFixtures(...uls: string[]): voiddeclare function appendLoadStyleFixtures(...uls: string[]): voiddeclare function setStyleFixtures(html: string): voiddeclare function appendSetStyleFixtures(html: string): voiddeclare function loadJSONFixtures(...uls: string[]): jasmine$JSONFixturesdeclare function getJSONFixture(url: string): anydeclare function spyOnEvent(selector: string, eventName: string): jasmine$JQueryEventSpy
...
declare function jasmine$spiedEventsKey(selector: JQuery, eventName: string): string

declare function jasmine$getFixtures(): jasmine$Fixtures

declare function jasmine$getStyleFixtures(): jasmine$StyleFixtures

declare function jasmine$getJSONFixtures(): jasmine$JSONFixtures
...
declare var JQuery: jasmine$JasmineJQuery;