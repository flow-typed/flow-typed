/**
 * Flowtype definitions for mixpanel
...
declare interface Mixpanel {
    people: Mixpanel$People,
        ...
        register_once(params: {
            [index: string]: any
        }, defaultValue?: string, days?: number): void,
...
declare interface Mixpanel$People {
    set(keys: {
            [index: string]: any
        }, callback?: () => void): void,
        ...
        track_charge(amount: number, params?: {
            [index: string]: any
        }, callback?: () => void): void,
        clear_charges(): void,
        delete_user(): void
