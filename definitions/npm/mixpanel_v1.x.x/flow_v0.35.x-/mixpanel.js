import type mixpanel from 'npm$namespace$Mixpanel'
...
declare module 'mixpanel' {
		...
		track_links(
		querySelector: string, eventName: string, params?: {
		[index: string]: any
	}
	): void,
		track_forms(
		...
		params: {
		[index: string]: any
	}, defaultValue?: string, days?: number
	): void,
...
declare module 'npm$namespace$Mixpanel' {
