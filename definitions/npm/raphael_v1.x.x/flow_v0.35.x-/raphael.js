...
declare module 'raphael' {
	...
	declare interface RaphaelAnimation {
		delay(delay: number): RaphaelAnimation,
		repeat(repeat: number): RaphaelAnimation
	}

	declare interface RaphaelFont {
		w: number,
		face: any,
		glyphs: any
	}

	declare interface RaphaelElement {
		animate(
		params: {
		[key: string]: any
	}, ms: number, easing?: string, callback?: Function
	): RaphaelElement,
		animate(animation: RaphaelAnimation): RaphaelElement,
		animateWith(
		el: RaphaelElement, anim: RaphaelAnimation, params: any, ms: number, easing?: string, callback?: Function
	): RaphaelElement,
		animateWith(
		el: RaphaelElement, anim: RaphaelAnimation, animation: RaphaelAnimation
	): RaphaelElement,
	...
	}, mcontext?: any, scontext?: any, econtext?: any
	): RaphaelElement,
		...
		hide(): RaphaelElement,
		hover(
		f_in: Function, f_out: Function, icontext?: any, ocontext?: any
	): RaphaelElement,
		id: string,
	...
	declare interface RaphaelMatrix {
		add(
		a: number, b: number, c: number, d: number, e: number, f: number, matrix: RaphaelMatrix
	): RaphaelMatrix,
		clone(): RaphaelMatrix,
	...
	declare interface RaphaelPaper {
		...
		print(
		x: number, y: number, str: string, font: RaphaelFont, size?: number, origin?: string, letter_spacing?: number
	): RaphaelPath,
		rect(
	...
	declare interface RaphaelStatic {
		...
		animation(
		params: any, ms: number, easing?: string, callback?: Function
	): RaphaelAnimation,
		bezierBBox(
		p1x: number, p1y: number, c1x: number, c1y: number, c2x: number, c2y: number, p2x: number, p2y: number
	): {
		min: {
		x: number,
		y: number
		...
		vml: boolean
			...
			declare module.exports: RaphaelStatic
