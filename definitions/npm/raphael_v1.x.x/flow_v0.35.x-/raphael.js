/**
 * Flowtype definitions for raphael
...
declare interface RaphaelElement {
    animate(
            ...
            ms: number,
            easing?: string,
            callback?: Function): RaphaelElement,
        ...
        animateWith(
            el: RaphaelElement,
            anim: RaphaelAnimation,
            animation: RaphaelAnimation): RaphaelElement,
...
declare interface RaphaelSet {
    clear(): void,
        ...
        length: number, [key: number]: RaphaelElement,
        animate(
            params: {
                [key: string]: any
            },
        ...
        animateWith(
            el: RaphaelElement,
            anim: RaphaelAnimation,
            animation: RaphaelAnimation): RaphaelSet,
...
declare interface RaphaelMatrix {
    add(
            ...
            e: number,
            f: number,
            matrix: RaphaelMatrix): RaphaelMatrix,
        clone(): RaphaelMatrix,
...
declare interface RaphaelPaper {
    add(JSON: any): RaphaelSet,
        ...
        print(
            ...
            size?: number,
            origin?: string,
            letter_spacing?: number): RaphaelPath,
        rect(
            x: number,
            y: number,
            width: number,
            height: number,
            r?: number): RaphaelElement,
        remove(): void,
        renderfix(): void,
        safari(): void,
...
declare interface RaphaelStatic {
    ...
    angle(
        ...
        animation(
            ...
            ms: number,
            easing?: string,
            callback?: Function): RaphaelAnimation,
        bezierBBox(
            p1x: number,
            p1y: number,
            c1x: number,
