...
declare module 'hashtable' {
		...
		putAll(
		hashtable: IHashtable<TKey, TValue>, conflictCallback?: (key: TKey, thisValue: TValue, value: TValue) => TValue
	): void,
		get(key: TKey): TValue,
	...
	declare interface IHashtableStatic {
		...
		new <TKey, TValue>(
		hashCode?: (value: TValue) => any, equals?: (value1: TValue, value2: TValue) => boolean
	): IHashtable<TKey, TValue>
	}

			declare module.exports: IHashtableStatic
