/**
 * Flowtype definitions for cal-heatmap
...
declare interface CalHeatMap$CalHeatMapStatic {
    new(): CalHeatMap$CalHeatMap
}

declare interface CalHeatMap$CalHeatMap {

    /**
     * Initialise the CalHeatMap with the specified options
     * @param  The CalHeatMap options
     */
    init(options?: CalHeatMap$InitOptions): void,
        options: CalHeatMap$RuntimeOptions,
         ...
         * @param  The number of domains to shift back. The default is 1.
         */
        previous(n?: number): void,

        /**
         * Shift the calendar n domains forward
         * @param  The number of domains to shift forward. The default is 1.
         */
        next(n?: number): void,
         ...
         * @param  The date to jump to.
         * @param  Whether to set the domain with the specified as the calendar's first domain.
         */
         ...
         * @param  Accept the same format as the data option.
         * @param  Whether to execute the afterLoad() callback to convert your data into the json object, expected by cal-heatmap.
        It can also directly takes a function, in case your data can not be converted with the afterLoad() function you defined.
         * @param  Define how to insert the new data into the calendar.
        Accepted values are:
        ...
        */
         ...
         * @param  The date or dates to highlight.
         */
         ...
         * @param  Same as legend : an array of thresholds
         * @param  Same as legendColors : an object with the heatmap's colors, or an array of 2 colors
         */
        setLegend(legend?: number[], legendColors?: CalHeatMap$LegendColor | string[]): void,
         ...
         * @param  function that will be executed when the calendar is removed from the DOM, at the end of the animation.
         * @returns  always returns null.
         */
        destroy(callback?: Function): CalHeatMap$CalHeatMap
}

declare interface CalHeatMap$LegendColor {
...
declare interface CalHeatMap$InitOptions {
    ...
    itemSelector?: string | HTMLElement | Element | EventTarget,
        ...
        */
        legendColors?: CalHeatMap$LegendColor | string[],
        ...
        */
        subDomainTitleFormat?: CalHeatMap$SubDomainFormatTemplates,
        ...
        */
        legendTitleFormat?: CalHeatMap$LegendTitleTemplates,
        ...
        */
        afterLoadData?: (data: any) => CalHeatMap$DataFormat,
...
declare type CalHeatMap$RuntimeOptions = {
     ...
     */
    itemName: string[]
} & CalHeatMap$InitOptions


declare interface CalHeatMap$LegendTitleTemplates {
...
declare interface CalHeatMap$SubDomainFormatTemplates {
...
declare interface CalHeatMap$DataFormat {
    [timestamp: string]: number
}

declare interface CalHeatMap$LabelOffset {
    x: number,
        y: number
}
 ...
 * Position and alignment of the domain label. 
 */
declare interface CalHeatMap$Label {
