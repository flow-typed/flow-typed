...
declare
export interface twilio$BaseRequestCallback {
...
declare
export type twilio$MappedResource<T>= {} & twilio$Resource & twilio$BaseMappedResource
...
declare
export type twilio$ListMappedResource<T>= {} & twilio$CreatableMappedResource & twilio$ListableResource
...
declare
export class IpMessagingGrant mixins Grant {
    serviceSid: string;
    endpointId: string;
    deploymentRoleSid: string;
    pushCredentialSid: string;
...
declare
export class ConversationsGrant mixins Grant {
    configurationProfileSid: string;
...
declare
export class IpMessagingClient mixins Client {
...
declare
export class LookupsClient mixins Client {
    phoneNumbers: twilio$PhoneNumberResource;
    constructor(sid?: string, tkn?: string, options?: twilio$ClientOptions): this
}

declare
export class MonitorClient mixins Client {
...
declare
export class PricingClient mixins Client {
...
declare
export class RestClient mixins Client {
    constructor(sid?: string, tkn?: string, options?: twilio$ClientOptions): this;
...
declare
export class TaskRouterClient mixins Client {
...
declare
export class TaskRouterTaskQueueCapability mixins TaskRouterCapability {
    constructor(accountSid: string, authToken: string, workspaceSid: string, taskQueueSid: string): this;
    _setupResource(): void
}

declare
export class TaskRouterWorkerCapability mixins TaskRouterCapability {
...
declare
export class TaskRouterWorkspaceCapability mixins TaskRouterCapability {
    constructor(accountSid: string, authToken: string, workspaceSid: string): this;
    _setupResource(): void
}

declare
export class TrunkingClient mixins Client {
...
declare
export class Node mixins NodeOptions {
    name: string;
    attributes: any;
    text: any;
    topLevel: boolean;
...
declare
export class TwimlResponse mixins Node {}
...
declare
export function twilio$webhook(authToken: string, options?: twilio$WebhookOptions): twilio$MiddlewareFunction

declare
export function twilio$validateRequest(authToken: string, twilioHeader: string, url: string, params?: any): boolean

declare
export function twilio$validateExpressRequest(
...
declare
export type twilio$OutgoingCallerIdResource = {} & twilio$CreatableMappedResource
...
declare
export type twilio$SMSMessageResource = {} & twilio$CreatableMappedResource
...
declare
export type twilio$SMSShortCodeResource = {} & twilio$MappedResource
...
declare
export type twilio$ApplicationResource = {} & twilio$CreatableMappedResource
...
declare
export type twilio$ConnectAppResource = {} & twilio$MappedResource
...
declare
export type twilio$AuthorizedConnectAppResource = {} & twilio$MappedResource
...
declare
export type twilio$TranscriptionResource = {} & twilio$MappedResource
...
declare
export type twilio$NotificationResource = {} & twilio$MappedResource
...
declare
export type twilio$UsageTriggerResource = {} & twilio$CreatableMappedResource
...
declare
export type twilio$KeyResource = {} & twilio$CreatableMappedResource
...
declare
export type twilio$AccountResource = {} & twilio$AccountInstance & twilio$ListMappedResource
...
declare
export type twilio$AddressResource = {} & twilio$ListMappedResource
...
declare
export type twilio$AvailablePhoneNumberResource = {} & twilio$BaseMappedResource
...
declare
export type twilio$ConferenceParticipantResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$ConferenceResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$MessageMediaResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$MessageResource = {} & twilio$ListMappedResource
...
declare
export type twilio$QueueResource = {} & twilio$CreatableMappedResource
...
declare
export type twilio$RecordingResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$CredentialResource = {} & twilio$ListMappedResource
...
declare
export type twilio$ServiceUserResource = {} & twilio$ListMappedResource
...
declare
export type twilio$ServiceRoleResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$ServiceChannelMessageResource = {} & twilio$ListMappedResource
...
declare
export type twilio$ServiceChannelMemberResource = {} & twilio$ListMappedResource
...
declare
export type twilio$ServiceChannelResource = {} & twilio$ListMappedResource
...
declare
export type twilio$ServiceResource = {} & twilio$ListMappedResource
...
declare
export type twilio$PhoneNumberResource = {} & twilio$BaseMappedResource
...
declare
export type twilio$AlertResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$EventResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$CountryResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$NumberResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$CredentialListResource = {} & twilio$ListMappedResource
...
declare
export type twilio$IPAccessControlListMappingResource = {} & twilio$ListMappedResource
...
declare
export type twilio$CredentialListMappingResource = {} & twilio$ListMappedResource
...
declare
export type twilio$DomainResource = {} & twilio$ListMappedResource
...
declare
export type twilio$IPAddressResource = {} & twilio$ListMappedResource
...
declare
export type twilio$IPAccessControlListResource = {} & twilio$ListMappedResource
...
declare
export type twilio$WorkspaceActivityResource = {} & twilio$ListMappedResource
...
declare
export type twilio$WorkspaceEventResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$WorkspaceTaskReservationResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$WorkspaceTaskResource = {} & twilio$ListMappedResource
...
declare
export type twilio$WorkspaceWorkerReservationResource = {} & twilio$MappedResource & twilio$ListableResource
...
declare
export type twilio$WorkspaceResource = {} & twilio$CreatableMappedResource
...
declare
export type twilio$OriginationURLResource = {} & twilio$ListMappedResource
...
declare
export type twilio$TrunkResource = {} & twilio$ListMappedResource