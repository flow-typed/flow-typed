/**
 * Flowtype definitions for dojox.geo
...
declare class KeyboardInteractionSupport {
    constructor(map: undefined.Map, options?: Object): this;
...
declare class TouchInteractionSupport {
    constructor(map: undefined.Map): this;
...
declare class Map {
     ...
     */
    setDataStore(dataStore: undefined.ItemFileReadStore, dataBindingProp: String): void;
     ...
     */
    onFeatureClick(feature: undefined.Feature): void;

    /**
     * Invoked when the specified feature is hovered.
     * @param feature A Feature.
     */
    onFeatureOver(feature: undefined.Feature): void;

    /**
     * Invoked when the specified feature has been zoomed.
     * @param feature A Feature.
     */
    onZoomEnd(feature: undefined.Feature): void
}
...
*/
declare class Legend mixins dijit._Widget {
 ...
 * @param div 
*/
declare class Map mixins dijit._Widget {
 ...
 */
declare interface charting$_base {
...
*/
declare class Collection mixins undefined.Geometry {
 ...
 * @param options 
*/
declare class GfxLayer mixins undefined.Layer {
     ...
     */
    addFeature(f: undefined.Feature): void;
     ...
     */
    removeFeature(f: undefined.Feature): void;
     ...
     */
    renderFeature(f: undefined.Feature): void;
...
*/
declare class GeometryFeature mixins undefined.Feature {
    constructor(geometry: undefined.Geometry): this;
    ...
    */
    createShape(s: undefined.Surface, g: undefined.Geometry): any;
 ...
 * @param coords Coordinates of the geometry. {x:x, y:y} object for a point geometry, array of {x:x, y:y}objects for line string geometry, array of geometries for collection geometry.
*/
declare class LineString mixins undefined.Geometry {
    constructor(coords: Object): this;
...
declare class Map {
     ...
     */
    addLayer(layer: undefined.Layer): void;
 ...
 * @param coords Coordinates of the geometry. {x:x, y:y} object for a point geometry, array of {x:x, y:y}objects for line string geometry, array of geometries for collection geometry.
*/
declare class Point mixins undefined.Geometry {
    constructor(coords: Object): this;
...
*/
declare class WidgetFeature mixins undefined.Feature {
    constructor(params: Object): this;
    ...
    */
    ...
    declare interface GreatCircle {
        ...
        DEG2RAD: number,
            ...
            */
            toGeometryFeature(p1: undefined.Point, p2: undefined.Point, increment: number): any,
             ...
             * @param increment The value at which a new point is computed.
            */
            toLineString(p1: undefined.Point, p2: undefined.Point, increment: number): any,
             ...
             * @param increment The value at which a new point is computed.
            */
            toPointArray(p1: undefined.Point, p2: undefined.Point, increment: number): any[]
    }
 ...
 * Permalink: http://dojotoolkit.org/api/1.9/dojox/geo/openlayers/_base.GreatCircle.html
 */
declare interface openlayers$GreatCircle {
 ...
 */
declare interface openlayers$Patch {
...
declare module 'dojox/geo/openlayers/_base.Geometry' {
    declare var exp: undefined.Geometry;
    declare module.exports: typeof exp
}
declare module 'dojox/geo/openlayers/_base.Collection' {
    declare var exp: undefined.Collection;
    declare module.exports: typeof exp
}
...
declare module 'dojox/geo/openlayers/Patch' {
    declare var exp: undefined.Patch;
    declare module.exports: typeof exp
}
