...
declare module 'alexa-sdk' {
    ...
    declare interface ResponseBody {
        version: string,
            ...
            response: apiErrorHandler$Response
    }
    declare     export type Response = {
        request_seq: number,
        success: boolean,
...
declare module 'any-db' {
    ...
    declare     export interface Adapter {
        name: string,
            ...
            createConnection(
                opts: ConnectOpts,
                callback?: (error: error$Error, result: Connection) => void): Connection,
            ...
            */
            createQuery(
                text: string,
                params?: any[],
                callback?: (error: error$Error, result: ResultSet) => void): anydbSQL$Query,
            createQuery(query: anydbSQL$Query): anydbSQL$Query
    }
    ...
    declare     export type Queryable = {
        ...
        */
        query(
            text: string,
            params?: any[],
            callback?: (error: error$Error, results: ResultSet) => void): anydbSQL$Query
    }
    declare type Connection = {
        close(): when.Promise<void>,
        createChannel(): when.Promise<Channel>,
    ...
    */
    declare     export type ConnectionPool = {
         ...
         */
        acquire(callback: (error: error$Error, result: Connection) => void): void,
        ...
        min?: number,
            ...
            */
            ...
            onConnect?: (
                ...
                ready: (error: error$Error, result: Connection) => void) => void,
            ...
            */
            reset?: (connection: Connection, done: (error: error$Error) => void) => void,
    ...
    declare     export function createConnection(
        url: string,
        callback?: (error: error$Error, connection: Connection) => void): Connection
    ...
    declare     export class Connection mixins events$EventEmitter {
        ...
        */
        pushNotification(
            ...
            recipient: Device | string | Buffer | (Device | string | Buffer)[]): void;
        ...
        on(
            event: "transmitted",
            listener: (notification: Notification, decive: Device) => void): this;
        ...
        */
        on(
            ...
            listener: (errorCode: number, notification: Notification, device: Device | Buffer) => void): this;
