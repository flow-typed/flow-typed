 ...
 */
declare
function ajax$addOnEvent(callback: (data: ajax$RequestData) => void): void
 ...
 */
declare
function ajax$addOnError(callback: (data: ajax$RequestData) => void): void
 ...
 */
declare
function ajax$request(source: any, event?: String, options?: ajax$RequestOptions): void
 ...
 */
declare
function ajax$response(request: any, context: any): void