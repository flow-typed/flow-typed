// @flow
/**
 * Flowtype definitions for jquery.bbq
...
declare interface JQueryBbq$JQuery {
...
declare interface JQueryBbq$ParamFragment {
    (url?: string): string,
...
declare interface JQueryBbq$JQueryDeparam {
...
declare type JQueryBbq$EventObject = {
    fragment: string,
    getState(key?: string, coerce?: boolean): void
} & JQueryEventObject
