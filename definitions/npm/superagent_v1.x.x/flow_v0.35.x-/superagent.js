/**
 * Flowtype definitions for superagent
...
declare module 'superagent' {
    ...
    declare type request$SuperAgentRequest = {} & request$Request
    ...
    declare type request$SuperAgentStatic = {
        ...
        agent(): request$SuperAgent<request$SuperAgentRequest >
    } & request$SuperAgent


    declare type request$SuperAgent<Req>= {
        ...
        parse(
            fn: (res: request$Response, callback: (err: Error, body: any) => void) => void): this,
