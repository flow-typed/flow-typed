// @flow
/**
 * Flowtype definitions for js-git
...
declare interface JSGit$GitObject {
    type: string,
        body: any
}

declare interface JSGit$GitCommit {
    tree: string,
        author: JSGit$GitAuthor,
        message: string
}

declare interface JSGit$GitAuthor {
    name: string,
        email: string,
        date: Date
}

declare interface JSGit$GitTree {
    [i: number]: JSGit$GitTreeElem
}

declare interface JSGit$GitTreeElem {
    mode: number,
        name: string,
        hash: string
}

declare interface JSGit$StringMap {
    [i: string]: string
}

declare interface JSGit$Remote {
    hostname: string,
        pathname: string,
        discover(callback: (err: any, refs: JSGit$StringMap) => void): void,
        fetch(repo: JSGit$Repo, opts: Object, callback: (err: any) => void): void,
        close(callback?: (err: any) => void): void
}

declare interface JSGit$DB {
...
declare interface JSGit$Repo {
    ...
    */
    load(
            hashish: string,
            callback: (err: any, git_object: JSGit$GitObject) => void): void,

        /**
         * Save an object to the database. This will give you back the hash of the cotent by which you can retrieve the value back.
         */
        save(git_object: JSGit$GitObject, callback: (err: any, hash: string) => void): void,
        ...
        */
         ...
         */
        fetch(remote: JSGit$Remote, opts: Object, callback: (err: any) => void): void
}