...
declare
function CodeMirror$fromTextArea(
 ...
 */
declare
function CodeMirror$defineExtension(name: string, value: any): void
 ...
 */
declare
function CodeMirror$defineDocExtension(name: string, value: any): void
...
*/
declare
function CodeMirror$defineOption(name: string, default_: any, updateFunc: Function): void
...
*/
declare
function CodeMirror$defineInitHook(func: Function): void
...
*/
declare
function CodeMirror$registerHelper(namespace: string, name: string, helper: any): void

declare
function CodeMirror$on(element: any, eventName: string, handler: Function): void

declare
function CodeMirror$off(element: any, eventName: string, handler: Function): void
...
*/
declare
function CodeMirror$signal(target: any, name: string, ...args: any[]): void
 ...
 */
declare
function CodeMirror$defineMode(id: string, modefactory: CodeMirror$ModeFactory<any>): void
 ...
 */
declare
function CodeMirror$getMode<T>(config: CodeMirror$EditorConfiguration, mode: any): CodeMirror$Mode<T >
    ...
    */
    declare
function CodeMirror$overlayMode<T, S>(
