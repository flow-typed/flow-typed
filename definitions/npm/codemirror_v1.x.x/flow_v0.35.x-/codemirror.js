/**
 * Flowtype definitions for codemirror
...
declare var npm$namespace$CodeMirror: {
    ...
    defineExtension: typeof CodeMirror$defineExtension,
    defineDocExtension: typeof CodeMirror$defineDocExtension,
    defineOption: typeof CodeMirror$defineOption,
    defineInitHook: typeof CodeMirror$defineInitHook,
    registerHelper: typeof CodeMirror$registerHelper,
    on: typeof CodeMirror$on,
    off: typeof CodeMirror$off,
    signal: typeof CodeMirror$signal,
    defineMode: typeof CodeMirror$defineMode,
    getMode: typeof CodeMirror$getMode,
    overlayMode: typeof CodeMirror$overlayMode,
    MergeView: typeof CodeMirror$MergeView,
}
declare export var Doc: CodeMirror$DocConstructor;

declare export var Pos: CodeMirror$PositionConstructor;

declare export var Pass: any;

declare function CodeMirror$fromTextArea(
    host: HTMLTextAreaElement,
    options?: CodeMirror$EditorConfiguration): CodeMirror$EditorFromTextArea
 ...
 */
declare function CodeMirror$defineExtension(name: string, value: any): void


/**
 * Like defineExtension, but the method will be added to the interface for Doc objects instead. 
 */
declare function CodeMirror$defineDocExtension(name: string, value: any): void


/**
 * Similarly, defineOption can be used to define new options for CodeMirror.
 * TheupdateFunc will be called with the editor instance and the new value when an editor is initialized,
andwhenever the option is modified through setOption. 
*/
declare function CodeMirror$defineOption(name: string, default_: any, updateFunc: Function): void
...
*/
declare function CodeMirror$defineInitHook(func: Function): void
...
thegiven type, pointing to an object that maps names to values. I.e. after doing
CodeMirror.registerHelper("hint", "foo", myFoo), the value CodeMirror.hint.foo will point to myFoo. 
*/
declare function CodeMirror$registerHelper(namespace: string, name: string, helper: any): void

declare function CodeMirror$on(element: any, eventName: string, handler: Function): void

declare function CodeMirror$off(element: any, eventName: string, handler: Function): void
...
Tofire your own events, use CodeMirror.signal(target, name, args...), where target is a non-DOM-node object. 
*/
declare function CodeMirror$signal(target: any, name: string, ...args: any[]): void
...
declare interface CodeMirror$Editor {
    ...
    hasFocus(): boolean,
        ...
        */
         ...
         * Theother arguments and the returned value have the same interpretation as they have in findPosH. 
         */
        findPosV(
            start: CodeMirror$Position,
            amount: number,
        ...
        themaps added earlier have a lower precedence than those added later, unless the bottom argument was passed,
        inwhich case they end up below other keymaps added with this method. 
        */
         ...
         * Forexample, the search add - on uses it to highlight the term that's currently being searched.
        ...
        tooverride the styling of the base mode entirely, instead of the two being applied together. 
        */
        ...
        */
        ...
        Toremove the widget again, simply use DOM methods (move it somewhere else, or call removeChild on its parent). 
        */
        ...
        */
        ...
        Youcan pass null for either of them to indicate that that dimension should not be changed. 
        */
         ...
         * andthe size of the visible area(minus scrollbars). 
         */
         ...
         * Themargin parameter is optional. When given, it indicates the amount of pixels around the given area that should be made visible as well. 
         */
         ...
         * Ifmode is "local" , they will be relative to the top-left corner of the editable document.
        Ifit is "page" or not given, they are relative to the top-left corner of the page.
        where is a boolean indicating whether you want the start(true) or the end(false) of the selection. 
        */
        cursorCoords(where: boolean, mode: string): {
            left: number,
            top: number,
            bottom: number
        },
        ...
        */
         ...
         * Theoptional mode parameter determines relative to what the coordinates are interpreted. It may be "window" , "page"(the default) , or "local". 
         */
        coordsChar(object: {
            left: number,
            top: number
         ...
         * Inbig documents, when most content is scrolled out of view, CodeMirror will only render the visible part, and a margin around it.
        Seealso the viewportChange event. 
        */
        getViewport(): {
            from: number,
            to: number
         ...
         * youshould probably follow up by calling this method to ensure CodeMirror is still looking as intended. 
         */
        refresh(): void,
         ...
         * Ifno line number is given, the state at the end of the document is returned.
        ...
        */
         ...
         * Ifyou need to perform a lot of operations on a CodeMirror instance, you can call this method with a function argument.
        Itwill call the function, buffering up all changes, and only doing the expensive update after the function returns.
        ...
        */
         ...
         * Thesecond argument (which defaults to "smart") may be one of:
        ...
        */
        ...
        Theinstance argument always refers to the editor instance. 
        */
        ...
        on(
            eventName: "change",
            handler: (instance: CodeMirror$Editor, change: CodeMirror$EditorChangeLinkedList) => void): void,
        off(
            eventName: "change",
            handler: (instance: CodeMirror$Editor, change: CodeMirror$EditorChangeLinkedList) => void): void,
        ...
        */
        on(
            ...
            handler: (
                ...
                change: CodeMirror$EditorChangeLinkedList[]) => void): void,
        off(
            eventName: "changes",
            handler: (
                instance: CodeMirror$Editor,
         ...
         * ThechangeObj never has a next property, since this is fired for each individual change, and not batched per operation.
        ...
        */
        on(
            ...
            handler: (
                instance: CodeMirror$Editor,
                change: CodeMirror$EditorChangeCancellable) => void): void,
        off(
            eventName: "beforeChange",
            handler: (
                instance: CodeMirror$Editor,
        ...
        on(
            ...
            handler: (instance: CodeMirror$Editor) => void): void,
        off(
            eventName: "cursorActivity",
            handler: (instance: CodeMirror$Editor) => void): void,
         ...
         * Thefrom and to arguments give the new start and end of the viewport. 
         */
        on(
            eventName: "viewportChange",
            handler: (instance: CodeMirror$Editor, from: number, to: number) => void): void,
        off(
            eventName: "viewportChange",
            handler: (instance: CodeMirror$Editor, from: number, to: number) => void): void,
        ...
        andthe raw mousedown event object as fourth argument. 
        */
        on(
         ...
         * Thehandler may mess with the style of the resulting element, or add event handlers, but should not try to change the state of the editor. 
         */
        on(
            eventName: "renderLine",
            handler: (instance: CodeMirror$Editor, line: number, element: HTMLElement) => void): void,
        off(
            eventName: "renderLine",
            handler: (instance: CodeMirror$Editor, line: number, element: HTMLElement) => void): void,
...
declare type CodeMirror$EditorFromTextArea = {
...
declare interface CodeMirror$DocConstructor {
    new(
        text: string,
        mode?: any,
        firstLineNumber?: number,
        lineSep?: string): CodeMirror$Doc,
    (text: string, mode?: any, firstLineNumber?: number, lineSep?: string): CodeMirror$Doc
}
...
declare interface CodeMirror$Doc {
    ...
    getValue(seperator?: string): string,
         ...
         * Anoptional third argument can be given to indicate the line separator string to use (defaults to "\n"). 
         */
         ...
         * ordocuments instantiated with a non-zero first line, it might return other values. 
         */
        firstLine(): number,
        ...
        */
         ...
         * Theoptional collapse argument can be used to change this � passing "start" or "end" will collapse the selection to the start or end of the inserted text. 
         */
        replaceSelection(replacement: string, collapse?: string): void,

        /**
         * start is a an optional string indicating which end of the selection to return.
         * Itmay be "start" , "end" , "head"(the side of the selection that moves when you press shift + arrow),
        ...
        */
        ...
        (inaddition to whatever lies between that region and the current anchor). 
        */
         ...
         * inthat it will cause cursor movement and calls to extendSelection to leave the selection anchor in place. 
         */
        ...
        linkedDoc(
            options: {
                ...
                sothat for example a subview starting at line 10 will refer to its first line as line 10, not 0. 
                */
                to?: number,
         ...
         * thelinked document and a boolean indicating whether that document shares history with the target. 
         */
        ...
        markText(
            from: CodeMirror$Position,
            to: CodeMirror$Position,
            options?: CodeMirror$TextMarkerOptions): CodeMirror$TextMarker,

        /**
         * Inserts a bookmark, a handle that follows the text around it as it is being edited, at the given position.
         * Abookmark has two methods find() and clear(). The first returns the current position of the bookmark, if it is still in the document,
        andthe second explicitly removes the bookmark. 
        */
        setBookmark(
            pos: CodeMirror$Position,
            options?: {
                 ...
                 * Setthis option to true to make it go to the left instead. 
                 */
                insertLeft?: boolean
         ...
         * Ifthe index is out of range of the text then the returned object is clipped to start or end of the text respectively. 
         */
...
declare interface CodeMirror$LineHandle {
    text: string
}

declare interface CodeMirror$ScrollInfo {
    left: any,
        top: any,
        width: any,
        height: any,
...
declare interface CodeMirror$TextMarker {
    ...
    clear(): void,
         ...
         * orundefined if the marker is no longer in the document. 
         */
...
declare interface CodeMirror$LineWidget {
...
declare interface CodeMirror$EditorChange {
...
declare type CodeMirror$EditorChangeLinkedList = {
...
declare type CodeMirror$EditorChangeCancellable = {
...
declare interface CodeMirror$PositionConstructor {
    new(line: number, ch?: number): CodeMirror$Position,
    (line: number, ch?: number): CodeMirror$Position
}

declare interface CodeMirror$Range {
    from: CodeMirror$Position,
        to: CodeMirror$Position
}

declare interface CodeMirror$Position {
    ch: number,
        line: number
}
...
declare interface CodeMirror$EditorConfiguration {
    ...
    value?: any,
         ...
         * Itmay be a string, which either simply names the mode or is a MIME type associated with the mode.
        ...
        */
        ...
        /**
         * Whether, when indenting, the first NtabSize spaces should be replaced by N tabs. Default is false. 
         */
         ...
         * isvisual (pressing the left arrow moves the cursor left)
        orlogical (pressing the left arrow moves to the next lower index in the string, which is visually right in right-to-left text).
        Thedefault is false on Windows, and true on other platforms. 
        */
        ...
        andwhich will be used to draw the background of the gutters.
        Mayinclude the CodeMirror-linenumbers class, in order to explicitly set the position of the line number gutter
        (itwill default to be to the right of all other gutters). These class names are the keys passed to setGutterMarker. 
        */
        gutters?: string[],

        /**
         * Determines whether the gutter scrolls along with the content horizontally (false)
         * orwhether it stays fixed during horizontal scrolling (true, the default). 
         */
        fixedGutter?: boolean,
        ...
        orit has an autofocus attribute and no other element is focused. 
        */
        autofocus?: boolean,
         ...
         * Itwill be passed the editor instance and the event object as arguments.
        Thecallback can choose to handle the event itself , in which case it should return true to indicate that CodeMirror should not do anything further. 
        */
         ...
         * Ifprovided, this function will be called on every keydown, keyup, and keypress event that CodeMirror captures.
        Itwill be passed two arguments, the editor instance and the key event.
        This key event is pretty much the raw key event, except that a stop() method is always added to it.
        Youcould feed it to, for example, jQuery.Event to further normalize it.
        This function can inspect the key event, and handle it if it wants to.
        Itmay return true to tell CodeMirror to ignore the event.
        Bewary that, on some browsers, stopping a keydown does not stop the keypress from firing, whereas on others it does.
        Ifyou respond to an event, you should probably inspect its type property and only do something when it is keydown
        (orkeypress for actions that need character data). 
        */
         ...
         * Forsome fonts (and by some tastes) a smaller height (for example 0.85),
        ...
        */
         ...
         * andthen use timeout to sleep for workDelay milliseconds.
        Thedefaults are 200 and 300, you can change these options to make the highlighting more or less aggressive. 
        */
        workTime?: number,
        ...
        */
         ...
         * therest of the line as plain text when it reaches a certain position. The default is 10000.
        Youcan set this to Infinity to turn off this behavior. 
        */
        ...
        Youshould usually leave it at its default, 10. Can be set to Infinity to make sure the whole document is always rendered,
        andthus the browser's text search works on it. This will have bad effects on performance of big documents. 
        */
...
declare interface CodeMirror$TextMarkerOptions {
    ...
    className?: string,
         ...
         * Inatomic ranges, inclusiveLeft and inclusiveRight have a different meaning — they will prevent the cursor from being placed
        ...
        */
         ...
         * Thegiven DOM node must be an inline element(as opposed to a block element). 
         */
        ...
        */
         ...
         * Bydefault, a marker appears only in its target document. 
         */
        shared?: boolean
}

declare interface CodeMirror$StringStream {
 ...
 */
declare interface CodeMirror$Mode<T>{
     ...
     */
    token(stream: CodeMirror$StringStream, state: T): string,
    ...
    /**
     * The four below strings are used for working with the commenting addon. String that starts a line comment.
     */
    lineComment?: string,
 ...
 */
declare interface CodeMirror$ModeFactory<T>{
    (config: CodeMirror$EditorConfiguration, modeOptions?: any): CodeMirror$Mode<T >
}
 ...
 */
declare function CodeMirror$defineMode(id: string, modefactory: CodeMirror$ModeFactory<any>): void
 ...
 */
declare function CodeMirror$getMode<T>(config: CodeMirror$EditorConfiguration, mode: any): CodeMirror$Mode<T >
    ...
    */
    declare function CodeMirror$overlayMode<T, S>(
        base: CodeMirror$Mode<T>,
        overlay: CodeMirror$Mode<S>,
        combine?: boolean): CodeMirror$Mode<any >
    ...
    */
    declare interface CodeMirror$LintStateOptions {
        async: boolean,
        hasGutters: boolean
    }
 ...
 * linter.
 */
declare type CodeMirror$LintOptions = {
    getAnnotations: CodeMirror$AnnotationsCallback
 ...
 */
declare interface CodeMirror$AnnotationsCallback {
    (content: string, updateLintingCallback: CodeMirror$UpdateLintingCallback, options: CodeMirror$LintStateOptions, codeMirror: CodeMirror$Editor): void
}
 ...
 */
declare interface CodeMirror$UpdateLintingCallback {
    (codeMirror: CodeMirror$Editor, annotations: CodeMirror$Annotation[]): void
}
 ...
 */
declare interface CodeMirror$Annotation {
    from: CodeMirror$Position,
        message?: string,
        severity?: string,
        to?: CodeMirror$Position
 ...
 */
declare function CodeMirror$MergeView(
    element: HTMLElement,
    options?: MergeView$MergeViewEditorConfiguration): MergeView$MergeViewEditor


/**
 * Options available to MergeView.
 */
declare type MergeView$MergeViewEditorConfiguration = {
     ...
     */
    onCollapse(
        mergeView: MergeView$MergeViewEditor,
        line: number,
        size: number,
        mark: CodeMirror$TextMarker): void,
...
declare type MergeView$MergeViewEditor = {
     ...
     */
    left: MergeView$DiffView,
    leftChunks(): MergeView$MergeViewDiffChunk,
    leftOriginal(): CodeMirror$Editor,

    /**
     * Right side of the merge view.
     */
    right: MergeView$DiffView,
    rightChunks(): MergeView$MergeViewDiffChunk,
 ...
 */
declare interface MergeView$MergeViewDiffChunk {
    editFrom: number,
        editTo: number,
        origFrom: number,
        origTo: number
...
declare interface MergeView$DiffView {
