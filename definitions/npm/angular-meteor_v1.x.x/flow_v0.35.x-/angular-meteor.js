/**
 * Flowtype definitions for angular-meteor
...
declare module 'meteor' {
    declare type IRootScopeService = {
    ...
    declare interface IMeteorService {
         ...
         * @param autoClientSave - By default, changes in the Angular collection will automatically update the Meteor collection.
        ...
        */
        collection<T>(
                ...
                autoClientSave?: boolean): AngularMeteorCollection<T>,
            ...
            */
            collection<T, U>(
                ...
                updateCollection: Mongo.Collection<U>): AngularMeteorCollection2<T, U>,
             ...
             * @param autoClientSave - By default, changes in the Angular object will automatically update the Meteor object.
            ...
            */
            object<T>(
                ...
                autoClientSave?: boolean): AngularMeteorObject<T>,
            ...
            */
            requireValidUser(
                validatorFn: (user: Meteor.User) => boolean | string): angular$IPromise<Meteor.User>,
            ...
            loginWithPassword(
                ...
                password: string): angular$IPromise<void>,
    ...
    */
     ...
     */
    declare type AngularMeteorCollection<T>= {} & AngularMeteorCollection2
     ...
     */
    declare type AngularMeteorCollection2<T, U>= {
        ...
        */
         ...
         * @param subscriptionName - The subscription name to subscribe to. Exactly like the first parameter in $meteor.subscribe service.
         */
        subscribe(subscriptionName: string): AngularMeteorCollection2<T,
        U >
    } & Array
