...
declare
export interface DC$IGetSet<T, V>{
    (): T,
    (t: T): V
}

declare
export interface DC$IBiGetSet<T, R, V>{
    (): T,
    (t: T, r?: R): V
}

declare
export interface DC$IGetSetComputed<T, R, V>{
    (): R,
    (t: T): V
}

declare
export interface DC$Scale<T>{
    (x: any): T,
...
declare
export interface DC$Accessor<T, V>{
    (datum: T, index?: number): V
}

declare
export interface DC$UnitFunction {
    (start: number, end: number, domain?: Array<any>): number | Array<any >
}

declare
export interface DC$FloatPointUnits {
    precision(precision: number): DC$UnitFunction
}

declare
export interface DC$Units {
...
declare
export interface DC$BaseMixin<T>{
...
declare
export interface DC$MarginMixin<T>{
    margins: DC$IGetSet<DC$Margins,
    T >
}

declare
export interface DC$ColorMixin<T>{
...
declare
export type DC$CoordinateGridMixin<T>= {
...
declare
export interface DC$StackMixin<T>{
...
declare
export interface DC$CapMixin<T>{
...
declare
export interface DC$RenderDataPointOptions {
    fillOpacity: number,
...
declare
export interface DC$DataCountWidgetHTML {
    all: string,
        some: string
}

declare
export type DC$DataCountWidget = {
...
declare
export type DC$DataTableWidget = {
...
declare
export type DC$ICompositeChart<T>= {
...
declare
export type DC$CompositeChart = {} & DC$ICompositeChart


declare
export type DC$SeriesChart = {
...
declare
export interface DC$GeoChoroplethLayer {
    name: string,
...
declare
export type DC$GeoChoroplethChart = {
...
declare
export interface DC$NumberDisplayWidgetHTML {
    one: string,
        some: string,
        none: string
}
...
declare
export type DC$NumberDisplayWidget = {
...
declare
export interface DC$ChartRegistry {
