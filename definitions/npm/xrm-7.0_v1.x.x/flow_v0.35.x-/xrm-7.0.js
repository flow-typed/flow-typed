/**
 * Flowtype definitions for xrm-7.0
...
declare module 'Page' {
    ...
    declare export interface EventContext {
        ...
        getContext(): Xrm$Context,
             ...
             */
            getEventSource(): undefined.Attribute | undefined.Entity,
    ...
    declare export interface Attribute {
        ...
        addOnChange(handler: ContextSensitiveHandler): void,
            ...
            */
            ...
            /**
             * Sets submit mode.
             * @param  Always submit this attribute.
             */
            setSubmitMode(submitMode: "always"): void,

            /**
             * Sets submit mode.
             * @param  Never submit this attribute.
             */
            setSubmitMode(submitMode: "never"): void,

            /**
             * Sets submit mode.
             * @param  Submit this attribute when changed.
             */
    ...
    declare export interface Entity {
        ...
        addOnSave(handler: ContextSensitiveHandler): void,
            ...
            */
             ...
             * @param  Saves the record, and closes the form.
             */
            save(saveMode: "saveandclose"): void,

            /**
             * Saves the record with the given save mode.
             * @param  Saves the record, and opens a blank form.
             */
    ...
    declare module 'data' {
        ...
        declare     export interface ProcessManager {
            ...
            getActiveProcess(): Process,
                ...
                */
                 ...
                 * entity.
                 * @param  The callback function must accept a parameter
                ...
                */
                 ...
                 * @param  The function will be added to the bottom of the event handler
        ...
        */
        ...
        declare     export var entity: Entity;
        declare     export var process: ProcessManager;
    }
    ...
    */
    ...
    declare module 'ui' {
        ...
        */
         ...
         * @param  A unique identifier for the message.
         * @return  true if it succeeds, false if it fails.
         */
        declare     export function setFormNotification(message: string, level: "ERROR", uniqueId: string): boolean
        declare     export var process: ProcessManager;
        declare     export var controls: Collection.ItemCollection<Control>;
        declare     export var formSelector: FormSelector;
        declare     export var navigation: Navigation;
        declare     export var tabs: Collection.ItemCollection<Tab>;
    }
    ...
    declare export var context: Xrm$Context;
 ...
 * @returns  The application context for the user's current session.
