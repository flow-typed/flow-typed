// @flow
/**
 * Flowtype definitions for dojox.app
...
*/
declare class View mixins dijit._TemplatedMixin, dijit._WidgetsInTemplateMixin, dijit.Destroyable, undefined.ViewBase {
 ...
 */
declare class History mixins undefined.Controller {
    constructor(): this;
 ...
 * @param app dojox/app application instance.
 */
declare class HistoryHash mixins undefined.Controller {
 ...
 * @param events : handler}
 */
declare class BorderLayout mixins undefined.LayoutBase {
    constructor(app: any, events: any): this;
    ...
    */
     ...
     * @param event : view, "callback": function(){}};
     */
    initLayout(event: Object): void;

    /**
     * Response to dojox/app "app-layoutView" event.
     * @param event :parent, "view":view, "removeView": boolean}
     */
 ...
 * @param events : handler}
 */
declare class LayoutBase mixins undefined.Controller {
    constructor(app: any, events: any): this;
 ...
 * @param events : handler}
 */
declare class Load mixins undefined.Controller {
    constructor(app: any, events: any): this;
 ...
 * @param events : handler}
 */
declare class Layout mixins undefined.LayoutBase {
    constructor(app: any, events: any): this;
 ...
 * @param events : handler}
 */
declare class Transition mixins undefined.Controller {
    constructor(app: any, events: any): this;
...
*/
declare interface utils$mvcModel {
 ...
 * @param item The String with the name of this model
*/
declare interface utils$simpleModel {
    (config: Object, params: Object, item: String): void
}
 ...
 */
declare interface utils$constraints {
     ...
     */
    getAllSelectedChildren(view: undefined.View, selChildren: any[]): any,
         ...
         */
        getSelectedChild(view: undefined.View, constraint: Object): any,
         ...
         */
        setSelectedChild(view: undefined.View, constraint: Object, child: undefined.View): void
}
...
*/
declare interface utils$config {
 ...
 */
declare interface utils$layout {

    /**
     * Layout a bunch of child dom nodes within a parent dom node
     * @param container parent node
     * @param dim , t, w, h} object specifying dimensions of container into which to place children
...
*/
declare class _ScrollableMixin mixins undefined.scrollable {
    constructor(): this;
 ...
 */
declare class Container mixins dijit._WidgetBase, dijit._Container, dijit._Contained, undefined._ScrollableMixin {
...
declare module 'dojox/app/module/env' {
    declare     var exp: undefined.env;
    declare module.exports: typeof exp
}
declare module 'dojox/app/module/lifecycle' {
    declare     var exp: undefined.lifecycle;
    declare module.exports: typeof exp
}
declare module 'dojox/app/utils/mvcModel' {
    declare     var exp: undefined.mvcModel;
    declare module.exports: typeof exp
}
declare module 'dojox/app/utils/nls' {
    declare     var exp: undefined.nls;
    declare module.exports: typeof exp
}
...
declare module 'dojox/app/utils/simpleModel' {
    declare     var exp: undefined.simpleModel;
    declare module.exports: typeof exp
}
declare module 'dojox/app/utils/config' {
    declare     var exp: undefined.config;
    declare module.exports: typeof exp
}
declare module 'dojox/app/utils/constraints' {
    declare     var exp: undefined.constraints;
    declare module.exports: typeof exp
}
...
declare module 'dojox/app/utils/hash' {
    declare     var exp: undefined.hash;
    declare module.exports: typeof exp
}
declare module 'dojox/app/widgets/_ScrollableMixin' {
    declare     var exp: undefined._ScrollableMixin;
    declare module.exports: typeof exp
}
declare module 'dojox/app/widgets/Container' {
    declare     var exp: undefined.Container;
    declare module.exports: typeof exp
}