...
declare module 'm' {
		declare export interface ClassOptions {
		imageMagick?: boolean,
		nativeAutoOrient?: boolean
	}

	declare export interface CompareCallback {
		(err: Error, isEqual: boolean, equality: number, raw: number): any
	}

	declare export interface GetterCallback<T> {
		(err: Error, value: T): any
	}

	declare export interface WriteCallback {
		(err: Error, stdout: string, stderr: string, cmd: string): any
	}

	declare export interface ChannelInfo<T> {
		Red: T,
		Green: T,
		Blue: T
	}

	declare export interface CompareOptions {
		file?: string,
	...
	declare export interface ColorStatistics {
		Minimum: string,
		Maximum: string,
		Mean: string,
	...
	declare export interface State {
		...
		crop(
		width: number, height: number, x?: number, y?: number, percent?: boolean
	): State,
		...
		frame(
		width: number, height: number, outerBevelWidth: number, outBevelHeight: number
	): State,
		...
		level(
		blackPoint: number, gamma: number, whitePoint: number, percent?: boolean
	): State,
		...
		operator(
		channel: string, operator: "Multiply", rvalue: number, percent?: boolean
	): State,
		...
		operator(
		channel: string, operator: "Subtract", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Threshold", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Threshold-White", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Threshold-White-Negate", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Threshold-Black", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Threshold-Black-Negate", rvalue: number, percent?: boolean
	): State,
		operator(channel: string, operator: "Xor", rvalue: number, percent?: boolean): State,
		operator(
		channel: string, operator: "Noise-Gaussian", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Noise-Impulse", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Noise-Laplacian", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Noise-Multiplicative", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Noise-Poisson", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Noise-Random", rvalue: number, percent?: boolean
	): State,
		operator(
		channel: string, operator: "Noise-Uniform", rvalue: number, percent?: boolean
	): State,
		...
		thumb(
		width: number, height: number, outName: string, quality: number, callback: WriteCallback
	): State,
		thumb(
		width: number, height: number, outName: string, quality: number, align: "topleft", callback: WriteCallback
	): State,
		thumb(
		width: number, height: number, outName: string, quality: number, align: "center", callback: WriteCallback
	): State,
		thumb(
		width: number, height: number, outName: string, quality: number, align: string, callback: WriteCallback
	): State,
		...
		drawBezier(
		x0: number, y0: number, x1: number, y1: number, x2: number, y2: number, ...coords: number[]
	): State,
		...
		toBuffer(
		format: string, callback: (err: Error, buffer: Buffer) => any
	): stream.PassThrough,
		write(filename: string, callback: WriteCallback): void
	}

	declare export interface SubClass {
		(image: string): State
	}

	declare export function compare(filename1: string, filename2: string, callback: CompareCallback): void

	declare export function compare(
		filename1: string, filename2: string, tolerance: number, callback: CompareCallback
	): void

	declare export function compare(
		filename1: string, filename2: string, options: CompareOptions, callback: CompareCallback
	): void

	declare export function subClass(options: ClassOptions): SubClass
