/**
 * Flowtype definitions for underscore
...
declare interface UnderscoreStatic {
    ...
    (value: _.Dictionary<T>): Underscore<T>,
        ...
        */
        ...
        /**
         * Returns a negated version of the pass-in predicate.(...args: any[]) => boolean predicate
        ...
        */
        template(
            ...
            settings?: _.TemplateSettings): (...data: any[]) => string,
...
declare interface Underscore<T>{
     ...
     * @see  _.matches
     */
    matches<TResult>(): _.ListIterator<T,
    TResult>,
     ...
     * @see  _.matcher
     */
    matcher<TResult>(): _.ListIterator<T,
    TResult>,
...
declare interface _Chain<T>{
    ...
    map<TArray>(
        ...
        context?: any): _ChainOfArrays<TArray>,
    ...
    reduce<TResult>(
        iterator: _.MemoIterator<T, TResult>,
        memo?: TResult,
        context?: any): _ChainSingle<TResult>,
    ...
    findIndex<T>(
        predicate: _.ListIterator<T, boolean>| {},
        context?: any): _ChainSingle<number>,
