...
declare module "underscore" {
  ...
  declare function $underscore$Extend<A: {}, B: {}>(
    a: A,
    b: B,
    ...rest: Array<void>
  ): A & B;
  declare function $underscore$Extend<A: {}, B: {}, C: {}>(
    a: A,
    b: B,
    c: C,
    ...rest: Array<void>
  ): A & B & C;
  declare function $underscore$Extend<A: {}, B: {}, C: {}, D: {}>(
    a: A,
    b: B,
    c: C,
    d: D,
  ...
  declare function $underscore$Extend<A: {}, B: {}, C: {}, D: {}, E: {}>(
    a: A,
    b: B,
    c: C,
    d: D,
  ...
  declare function $underscore$ExtendParameterized<A: {}>(
    ...rest: Array<void>
  ): A;
  declare function $underscore$ExtendParameterized<A: {}, B: {}>(
    b: B,
    ...rest: Array<void>
  ): A & B;
  declare function $underscore$ExtendParameterized<A: {}, B: {}, C: {}>(
    b: B,
    c: C,
    ...rest: Array<void>
  ): A & B & C;
  declare function $underscore$ExtendParameterized<A: {}, B: {}, C: {}, D: {}>(
    b: B,
    c: C,
    d: D,
    ...rest: Array<void>
  ): A & B & C & D;
  declare function $underscore$ExtendParameterized<
    A: {},
    B: {},
    C: {},
    D: {},
  ...
  declare class UnderscoreWrappedList<T> {
    ...
    reduce<U>(
      iteratee: (memo: Object, value: T, index: number) => U,
      init: Object
    ): Object,
    reduce<U>(
      iteratee: (memo: Array<U>, value: T, index: number) => U,
      init: Array<U>
    ): Array<U>,
    ...
    reduceRight<U>(
      iteratee: (memo: U, value: T, index: number) => U,
      init: U
    ): U,
  ...
  declare class UnderscoreChainedList<T> {
    ...
    // Handle Collections functions
    each(
      iteratee: (element: T, index: number, list: Array<T>) => void
    ): Array<T>,
    each(iteratee: (val: mixed, key: mixed, list: Object) => void): Object,
    map<U>(
      iteratee: (value: T, index: number, list: Array<T>) => U
    ): UnderscoreChainedList<U>,
    reduce<U>(
      iteratee: (memo: Object, value: T, index: number) => U,
      init: Object
    ): UnderscoreChainedValue<Object>,
    reduce<U>(
      iteratee: (memo: Array<U>, value: T, index: number) => U,
      init: Array<U>
    ): UnderscoreChainedList<U>,
    ...
    reject(
      ...
      context?: mixed
    ): UnderscoreChainedList<T>,
    every(
      predicate: (value: T) => boolean,
      context?: mixed
    ): UnderscoreChainedValue<boolean>,
    some(
      predicate: (value: T) => boolean,
      context?: mixed
    ): UnderscoreChainedValue<boolean>,
    ...
    groupBy<U>(
      iteratee: (value: T) => U,
      context?: mixed
    ): UnderscoreChainedValue<{ [key: U]: T }>,
    groupBy(
      iteratee: string,
      context?: mixed
    ): UnderscoreChainedValue<{ [key: any]: T }>,
    indexBy<U>(
      iteratee: (value: T) => U,
      context?: mixed
    ): UnderscoreChainedValue<{ [key: U]: T }>,
  ...
  declare class UnderscoreList {
    ...
    each(
      list: Object,
      iteratee: (val: mixed, key: mixed, list: Object) => void
    ): void,
    forEach<T>(
      o: { [key: string]: T },
      iteratee: (val: T, key: string) => void
    ...
    filter<T>(
      o: { [key: string]: T },
      pred: (val: T, k: string, o: { [string]: T }) => boolean
    ): T[],
  ...
  declare class UnderscoreObject {
    ...
    findKey<K, V>(
      object: { [keys: K]: V },
      predicate: (V, K, { [keys: K]: V }) => boolean,
      context?: mixed
    ): ?string,
  ...
  declare class UnderscoreChainedObject<WrappedObj: {}> {
    ...
    map<T>(
      mapFn: (v: any, k: $Keys<WrappedObj>, obj: WrappedObj) => T
    ): UnderscoreChainedList<T>,
    ...
    findKey(
      ...
      context?: mixed
    ): UnderscoreChainedValue<?$Keys<WrappedObj>>,
    ...
    pick(
      ...rest: Array<string | Array<string>>
    ): UnderscoreChainedObject<WrappedObj>,
    pick(
      predicate: (v: any, k: any, object: WrappedObj) => boolean
    ): UnderscoreChainedObject<WrappedObj>,
    omit(
      ...rest: Array<string | Array<string>>
    ): UnderscoreChainedObject<WrappedObj>,
  ...
  declare class UnderscoreWrappedObject<WrappedObj: {}> {
    ...
    find(
      predicate: (v: any, k: $Keys<WrappedObj>, obj: WrappedObj) => boolean
    ): ?any,
    findKey(
      predicate: (
        $Values<WrappedObj>,
    ...
    pick(
      predicate: (v: any, k: $Keys<WrappedObj>, object: WrappedObj) => boolean
    ): WrappedObj,
  ...
  declare type WrappedExports = {
    $call: // A type that can be an object or an array (usually 'any') should have both return types.
    (<AnyType: {} & []>(
      arg: AnyType
    ) => UnderscoreWrappedObject<AnyType> & UnderscoreWrappedList<AnyType>) &
      // It's important that UnderscoreWrappedObject, UnderscoreWrappedList takes precedence over UnderscoreWrappedValue
      (<WrappedObj: {}>(
        arg: WrappedObj
      ) => UnderscoreWrappedObject<WrappedObj>) &
      (<T>(arg: Array<T>) => UnderscoreWrappedList<T>) &
      (<T>(arg: [T]) => UnderscoreWrappedList<T>) &
      (<T>(arg: T) => UnderscoreWrappedValue<T>)
  };

  declare type Underscore = UnderscoreList &
    UnderscoreFunctions &
    UnderscoreObject &
    UnderscoreUtility &
    WrappedExports;
