declare module '@@parse' {
  ...
  declare type AttributeMap = { [attr: string]: any }
  declare type ObjectCache = { [attr: string]: string }
  ...
  // Promises results
  // =========================
  declare type MixedPromiseResult = Promise<ParseObject | ParseUser | ParseRole>
  ...
  // ParseQuery
  // =========================
  declare type BatchOptions = FullOptions & { batchSize?: number }
  ...
  // ParseFile
  // =========================
  declare type Base64 = { base64: string }
  declare type FileData = Array<number> | Base64 | File
  declare type FileSource = { format: 'file', file: File, type: string } | { format: 'base64', base64: string, type: string }
  ...
  // ParseACL
  // =========================
  declare type PermissionsMap = { [permission: string]: boolean }
  declare type ByIdMap = { [userId: string]: PermissionsMap }
