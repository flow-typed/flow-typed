/**
 * Flowtype definitions for mathjs
...
declare type mathjs$MathArray = number[] | number[][];

declare type mathjs$MathType = number |
    mathjs$BigNumber |
    mathjs$Fraction |
    mathjs$Complex |
    mathjs$Unit |
...
declare type mathjs$MathExpression = string | string[] | mathjs$MathArray | mathjs$Matrix;

declare export interface mathjs$IMathJsStatic {
    e: number,
        pi: number,
        i: number,
        Infinity: number,
         ...
         */
        lsolve(
            L: mathjs$Matrix | mathjs$MathArray,
            b: mathjs$Matrix | mathjs$MathArray): mathjs$Matrix | mathjs$MathArray,

        /**
         * Calculate the Matrix LU decomposition with partial pivoting. Matrix A is decomposed in two matrices (L, U)
         * andarowpermutation vector p where A[p,:] = L  U
         ...
         */
        lusolve(
            A: mathjs$Matrix | mathjs$MathArray | Number,
            b: mathjs$Matrix | mathjs$MathArray): mathjs$Matrix | mathjs$MathArray,

        /**
         * Calculate the Sparse Matrix LU decomposition with full pivoting. Sparse Matrix A is decomposed in
         * twomatrices(L, U) and two permutation vectors (pinv, q) where P  A  Q = L  U
        ...
        */
         ...
         */
        usolve(
            U: mathjs$Matrix | mathjs$MathArray,
            b: mathjs$Matrix | mathjs$MathArray): mathjs$Matrix | mathjs$MathArray,
        ...
        */
        ...
        log(
            ...
            mathjs$MathArray |
            mathjs$Matrix,
            base?: number | mathjs$BigNumber | mathjs$Complex): number |
        mathjs$BigNumber |
        mathjs$Complex |
        mathjs$MathArray |
        mathjs$Matrix,
        ...
        */
         ...
         */
        multiply(
            x: mathjs$MathArray | mathjs$Matrix,
            y: mathjs$MathArray | mathjs$Matrix): mathjs$Matrix,
        ...
        norm(
            ...
            mathjs$MathArray |
            mathjs$Matrix,
            p?: number | mathjs$BigNumber | string): number | mathjs$BigNumber,
        ...
        */
        nthRoot(
            ...
            mathjs$Matrix |
            mathjs$Complex,
            root?: number | mathjs$BigNumber): number | mathjs$Complex | mathjs$MathArray | mathjs$Matrix,
        ...
        pow(
            ...
            mathjs$MathArray |
            mathjs$Matrix,
            y: number | mathjs$BigNumber | mathjs$Complex): number |
        mathjs$BigNumber |
        mathjs$Complex |
        mathjs$MathArray |
        mathjs$Matrix,
        ...
        round(
            ...
            mathjs$MathArray |
            mathjs$Matrix,
            n?: number | mathjs$BigNumber | mathjs$MathArray): number |
        mathjs$BigNumber |
        mathjs$Fraction |
        mathjs$Complex |
        mathjs$MathArray |
        ...
        */
         ...
         */
        bitAnd(
            x: number | mathjs$BigNumber | mathjs$MathArray | mathjs$Matrix,
            y: number | mathjs$BigNumber | mathjs$MathArray | mathjs$Matrix): number | mathjs$BigNumber | mathjs$MathArray | mathjs$Matrix,
        ...
        leftShift(
            x: number | mathjs$BigNumber | mathjs$MathArray | mathjs$Matrix,
            y: number | mathjs$BigNumber): number | mathjs$BigNumber | mathjs$MathArray | mathjs$Matrix,
         ...
         */
        rightLogShift(
            x: number | mathjs$MathArray | mathjs$Matrix,
            y: number): number | mathjs$MathArray | mathjs$Matrix,
        ...
        composition(
            ...
            k: Number | mathjs$BigNumber): Number | mathjs$BigNumber,
         ...
         * Formatrices, the function is evaluated element wise.
         */
        im(
            x: number |
            mathjs$BigNumber |
            mathjs$Complex |
            mathjs$MathArray |
            mathjs$Matrix): number | mathjs$BigNumber | mathjs$MathArray | mathjs$Matrix,
        ...
        boolean(
            ...
            boolean |
            mathjs$MathArray |
            mathjs$Matrix): boolean | mathjs$MathArray | mathjs$Matrix,
        ...
        */
        chain(value?: any): mathjs$IMathJsChain,

        /**
         * Create a complex value or convert a value to a complex value.
         */
        complex(): mathjs$Complex,
        complex(re: number, im: number): mathjs$Complex,
        complex(complex: mathjs$Complex): mathjs$Complex,
        complex(arg: string): mathjs$Complex,
        complex(array: mathjs$MathArray): mathjs$Complex,
        complex(obj: mathjs$IPolarCoordinates): mathjs$Complex,

        /**
         * Create a fraction convert a value to a fraction.
         */
        fraction(
            numerator: number | string | mathjs$MathArray | mathjs$Matrix,
            denominator?: number | string | mathjs$MathArray | mathjs$Matrix): mathjs$Fraction | mathjs$MathArray | mathjs$Matrix,
        ...
        storageformats are 'dense' and 'sparse'.
        */
        matrix(format?: string): mathjs$Matrix,
        matrix(
            data: mathjs$MathArray | mathjs$Matrix,
            format?: string,
            dataType?: string): mathjs$Matrix,
        ...
        number(
            ...
            mathjs$MathArray |
            mathjs$Matrix |
            mathjs$Unit): number | mathjs$MathArray | mathjs$Matrix,
        number(
            unit: mathjs$Unit,
            valuelessUnit: mathjs$Unit | string): number | mathjs$MathArray | mathjs$Matrix,

        /**
         * Create a Sparse Matrix. The function creates a new math.type.Matrix object from an Array. A Matrix has utility
         * functionstomanipulate the data in the matrix, like getting the size and getting or setting values in the matrix.
         ...
         * Whenamatrix is provided, all elements will be converted to units.
         */
         ...
         */
        eval(expr: mathjs$MathExpression, scope?: any): any,
        eval(exprs: mathjs$MathExpression[], scope?: any): any,
        ...
        equationofa 3D line, x0, y0, z0, a, b, c are from: (x−x0, y−y0, z−z0) = t(a, b, c)
        */
        distance(
            x: mathjs$MathArray | mathjs$Matrix | any,
            y: mathjs$MathArray | mathjs$Matrix | any): Number | mathjs$BigNumber,
        ...
        returnnullif the lines do not meet.
        Note:Fillthe plane coefficients as x + y + z = c and not as x + y + z + c = 0.
        ...
        */
        intersect(
            w: mathjs$MathArray | mathjs$Matrix,
            x: mathjs$MathArray | mathjs$Matrix,
            y: mathjs$MathArray | mathjs$Matrix,
            z: mathjs$MathArray | mathjs$Matrix): mathjs$MathArray,
        ...
        */
         ...
         */
        inv(
            x: number | mathjs$Complex | mathjs$MathArray | mathjs$Matrix): number | mathjs$Complex | mathjs$MathArray | mathjs$Matrix,

        /**
         * Create a matrix filled with ones. The created matrix can have one or multiple dimensions.
         */
        ones(n: number, format?: string): mathjs$MathArray | mathjs$Matrix,
        ones(m: number, n: number, format?: string): mathjs$MathArray | mathjs$Matrix,
        ones(size: number[], format?: string): mathjs$MathArray | mathjs$Matrix,
        ...
        range(
            ...
            includeEnd?: boolean): mathjs$Matrix,
        range(
            start: number | mathjs$BigNumber,
            end: number | mathjs$BigNumber,
            step: number | mathjs$BigNumber,
            includeEnd?: boolean): mathjs$Matrix,
        ...
        resize(
            x: mathjs$MathArray | mathjs$Matrix,
            size: mathjs$MathArray | mathjs$Matrix,
            defaultValue?: number | string): mathjs$MathArray | mathjs$Matrix,
        ...
        size(
            ...
            string |
            mathjs$MathArray |
            mathjs$Matrix): mathjs$MathArray | mathjs$Matrix,
         ...
         */
        subset(
            value: mathjs$MathArray | mathjs$Matrix | string,
            index: mathjs$Index,
            replacement?: any,
            defaultValue?: any): mathjs$MathArray | mathjs$Matrix | string,
         ...
         */
        zeros(n: number, format?: string): mathjs$MathArray | mathjs$Matrix,
        zeros(m: number, n: number, format?: string): mathjs$MathArray | mathjs$Matrix,
        zeros(size: number[], format?: string): mathjs$MathArray | mathjs$Matrix,

        /**
         * Compute the number of ways of picking k unordered outcomes from n possibilities.
         * Combinationsonly takes integer arguments. The following condition must be enforced: k <= n.
         */
        combinations(
            n: number | mathjs$BigNumber,
            k: number | mathjs$BigNumber): number | mathjs$BigNumber,
         ...
         */
        factorial(
            n: number | mathjs$BigNumber | mathjs$MathArray | mathjs$Matrix): number | mathjs$BigNumber | mathjs$MathArray | mathjs$Matrix,

        /**
         * Compute the gamma function of a value using Lanczos approximation for small values, and an extended
         * Stirlingapproximation for large values.
        Formatrices, the function is evaluated element wise.
        */
        gamma(
            n: number | mathjs$MathArray | mathjs$Matrix): number | mathjs$MathArray | mathjs$Matrix,
        ...
        random(
            size: mathjs$MathArray | mathjs$Matrix,
            max?: number): mathjs$MathArray | mathjs$Matrix,
        random(
            size: mathjs$MathArray | mathjs$Matrix,
            min: number,
            max: number): mathjs$MathArray | mathjs$Matrix,
        ...
        */
        equal(
            x: mathjs$MathType,
            y: mathjs$MathType): boolean | mathjs$MathArray | mathjs$Matrix,
        ...
        */
         ...
         * arraywillbe calculated. When dim is provided, the maximum over the selected dimension will be calculated. Parameter dim is zero-based.
         */
         ...
         * evennumberof values, the average of the two middle values is returned. Supported types of values are: Number, BigNumber, Unit

        Incaseofa(multi dimensional) array or matrix, the median of all elements will be calculated.
        */
         ...
         * Supportedtypes of sequence values are: Number, BigNumber, Unit Supported types of probability are: Number, BigNumber

        Incaseofa(multi dimensional) array or matrix, the prob order quantile of all elements will be calculated.
        */
        quantileSeq(
            A: mathjs$MathArray | mathjs$Matrix,
            prob: Number | mathjs$BigNumber | mathjs$MathArray,
            sorted?: boolean): Number | mathjs$BigNumber | mathjs$Unit | mathjs$MathArray,
        ...
        'biased'Thesum of squared errors is divided by (n + 1)
        */
        ...
        */
         ...
         * computedangle can be determined.
        ...
        */
        ...
        atan2(
            y: mathjs$MathArray | mathjs$Matrix,
            x: mathjs$MathArray | mathjs$Matrix): mathjs$MathArray | mathjs$Matrix,
         ...
         */
        to(
            x: mathjs$Unit | mathjs$MathArray | mathjs$Matrix,
            unit: mathjs$Unit | string): mathjs$Unit | mathjs$MathArray | mathjs$Matrix,
        ...
        */
        filter(
            x: mathjs$MathArray | mathjs$Matrix,
            test: RegExp | ((item: any) => boolean)): mathjs$MathArray | mathjs$Matrix,
        ...
        format(
            value: any,
            options?: mathjs$IFormatOptions | number | ((item: any) => string)): string,

        /**
         * Test whether a value is an integer number. The function supports number, BigNumber, and Fraction.
         * Thefunctionis evaluated element-wise in case of Array or Matrix input.
         */
        ...
        map(
            x: mathjs$MathArray | mathjs$Matrix,
            callback: (item: any) => any): mathjs$MathArray | mathjs$Matrix,
        ...
        partitionSelect(
            x: mathjs$MathArray | mathjs$Matrix,
            k: number,
            compare?: string | ((a: any, b: any) => number)): any,
        ...
        sort(
            x: mathjs$MathArray | mathjs$Matrix,
            compare?: string | ((a: any, b: any) => number)): mathjs$MathArray | mathjs$Matrix,
...
declare export interface mathjs$Matrix {
    size(): number[],
        subset(index: mathjs$Index, replacement?: any, defaultValue?: any): mathjs$Matrix,
        resize(
            size: mathjs$MathArray | mathjs$Matrix,
            defaultValue?: number | string): mathjs$Matrix,
        clone(): mathjs$Matrix
}

declare export interface mathjs$BigNumber {}

declare export interface mathjs$Fraction {}

declare export interface mathjs$Complex {
    re: number,
        im: number,
        toPolar(): mathjs$IPolarCoordinates,
        clone(): mathjs$Complex
}

declare export interface mathjs$IPolarCoordinates {
    r: number,
        phi: number
}

declare export interface mathjs$Unit {
    to(unit: string): mathjs$Unit,
        toNumber(unit: string): number
}

declare export interface mathjs$Index {}

declare export interface mathjs$EvalFunction {
    eval(scope?: any): any
}

declare export interface mathjs$MathNode {
    isNode: boolean,
        ...
        op?: string,
        fn?: string,
        args?: mathjs$MathNode[],
        type: string,
        name?: string,
        value?: any,
        compile(): mathjs$EvalFunction,
        eval(): any,
        ...
        ```
        var node = math.parse('x^2 + x/4 + 3y');
        ...
        */
        filter(
            callback: (node: mathjs$MathNode, path: string, parent: mathjs$MathNode) => any): mathjs$MathNode[],
         ...
         */
        forEach(
            callback: (node: mathjs$MathNode, path: string, parent: mathjs$MathNode) => boolean): mathjs$MathNode[],
        ...
        */
        traverse(
            callback: (node: mathjs$MathNode, path: string, parent: mathjs$MathNode) => void): any,
        transform(
            callback: (node: mathjs$MathNode, path: string, parent: mathjs$MathNode) => boolean): mathjs$MathNode[]
}

declare export interface mathjs$Parser {
    eval(expr: string): any,
...
declare export interface mathjs$Distribution {
    random(size: any, min?: any, max?: any): any,
        randomInt(min: any, max?: any): any,
        pickRandom(array: any): any
}

declare export interface mathjs$IFormatOptions {
    ...
    */
    notation?: string,
        ...
        precisiondefines the number of significant digits after the decimal point, and is 0 by default.
        */
        precision?: number,

        /**
         * An object containing two parameters, {number} lower and {number} upper, used by notation 'auto' to determine
         * whentoreturn exponential notation. Default values are lower=1e-3 and upper=1e5. Only applicable for notation auto.
         */
        exponential?: {
            lower: number,
            upper: number
         ...
         * isconfigured, and will output 0.(3) when 'decimal' is configured.
         */
        fraction?: string,
...
declare export interface mathjs$Help {
    toString(): string,
        toJSON(): string
}

declare export interface mathjs$IMathJsChain {

    /**
     * Solves the linear equation system by forwards substitution. Matrix must be a lower triangular matrix.
     * @param b A column vector with the b values
     */
    lsolve(b: mathjs$Matrix | mathjs$MathArray): mathjs$IMathJsChain,

        /**
         * Calculate the Matrix LU decomposition with partial pivoting. Matrix A is decomposed in two matrices (L, U)
         * andarowpermutation vector p where A[p,:] = L  U
         */
        lup(): mathjs$IMathJsChain,

        /**
         * Solves the linear system A  x = b where A is an [n x n] matrix and b is a [n] column vector.
         * @param b Column Vector
         */
        lusolve(b: mathjs$Matrix | mathjs$MathArray): mathjs$IMathJsChain,
         ...
         * @returns  The lower triangular matrix, the upper triangular matrix and the permutation vectors.
        */
        slu(order: Number, threshold: Number): mathjs$IMathJsChain,
         ...
         * @returns  A column vector with the linear system solution (x)
         */
        usolve(b: mathjs$Matrix | mathjs$MathArray): mathjs$IMathJsChain,

        /**
         * Calculate the absolute value of a number. For matrices, the function is evaluated element wise.
         */
        abs(): mathjs$IMathJsChain,

        /**
         * Add two values, x + y. For matrices, the function is evaluated element wise.
         * @param y Second value to add
         */
        add(y: mathjs$MathType): mathjs$IMathJsChain,

        /**
         * Calculate the cubic root of a value. For matrices, the function is evaluated element wise.
         * @param allRoots Optional, false by default. Only applicable when x is a number or complex number. If true, all complex roots are returned, if false (default) the principal root is returned.
         */
        cbrt(allRoots?: boolean): mathjs$IMathJsChain,

        /**
         * Round a value towards plus infinity If x is complex, both real and imaginary part are rounded towards plus infinity. For matrices, the function is evaluated element wise.
         */
        ceil(): mathjs$IMathJsChain,

        /**
         * Compute the cube of a value, x  x  x. For matrices, the function is evaluated element wise.
         */
        cube(): mathjs$IMathJsChain,

        /**
         * Divide two values, x / y. To divide matrices, x is multiplied with the inverse of y: x  inv(y).
         * @param y Denominator
         */
        divide(y: mathjs$MathType): mathjs$IMathJsChain,

        /**
         * Divide two matrices element wise. The function accepts both matrices and scalar values.
         * @param y Denominator
         */
        dotDivide(y: mathjs$MathType): mathjs$IMathJsChain,

        /**
         * Multiply two matrices element wise. The function accepts both matrices and scalar values.
         * @param y Right hand value
         */
        dotMultiply(y: mathjs$MathType): mathjs$IMathJsChain,

        /**
         * Calculates the power of x to y element wise.
         * @param y The exponent
         */
        dotPow(y: mathjs$MathType): mathjs$IMathJsChain,

        /**
         * Calculate the exponent of a value. For matrices, the function is evaluated element wise.
         */
        exp(): mathjs$IMathJsChain,

        /**
         * Round a value towards zero. For matrices, the function is evaluated element wise.
         */
        fix(): mathjs$IMathJsChain,

        /**
         * Round a value towards minus infinity. For matrices, the function is evaluated element wise.
         */
        floor(): mathjs$IMathJsChain,

        /**
         * Calculate the greatest common divisor for two or more values or arrays. For matrices, the function is evaluated element wise.
         */
        gcd(...args: number[]): mathjs$IMathJsChain,
        gcd(...args: mathjs$BigNumber[]): mathjs$IMathJsChain,
        gcd(...args: mathjs$Fraction[]): mathjs$IMathJsChain,
        gcd(...args: mathjs$MathArray[]): mathjs$IMathJsChain,
        gcd(...args: mathjs$Matrix[]): mathjs$IMathJsChain,
        ...
        For matrix input, the hypotenusa is calculated for all values in the matrix.
        */
        hypot(...args: number[]): mathjs$IMathJsChain,
        hypot(...args: mathjs$BigNumber[]): mathjs$IMathJsChain,
        ...
        For matrices, the function is evaluated element wise.
        */
        lcm(b: number): mathjs$IMathJsChain,
        lcm(b: mathjs$BigNumber): mathjs$IMathJsChain,
        lcm(b: mathjs$MathArray): mathjs$IMathJsChain,
        lcm(b: mathjs$Matrix): mathjs$IMathJsChain,

        /**
         * Calculate the logarithm of a value. For matrices, the function is evaluated element wise.
         * @param base Optional base for the logarithm. If not provided, the natural logarithm of x is calculated. Default value: e.
         */
        log(base?: number | mathjs$BigNumber | mathjs$Complex): mathjs$IMathJsChain,

        /**
         * Calculate the 10-base of a value. This is the same as calculating log(x, 10). For matrices, the function is evaluated element wise.
         */
        log10(): mathjs$IMathJsChain,
        ...
        */
        mod(
            ...
            mathjs$Fraction |
            mathjs$MathArray |
            mathjs$Matrix): mathjs$IMathJsChain,

        /**
         * Multiply two values, x  y. The result is squeezed. For matrices, the matrix product is calculated.
         */
        multiply(y: mathjs$MathType): mathjs$IMathJsChain,

        /**
         * Calculate the norm of a number, vector or matrix. The second parameter p is optional. If not provided, it defaults to 2.
         * @param p Vector space. Supported numbers include Infinity and -Infinity. Supported strings are: 'inf', '-inf', and 'fro' (The Frobenius norm) Default value: 2.
         */
        norm(p?: number | mathjs$BigNumber | string): mathjs$IMathJsChain,
         ...
         * @param root The root. Default value: 2.
        */
        nthRoot(root?: number | mathjs$BigNumber): mathjs$IMathJsChain,

        /**
         * Calculates the power of x to y, x ^ y. Matrix exponentiation is supported for square matrices x, and positive integer exponents y.
         * @param y The exponent
         */
        pow(y: number | mathjs$BigNumber | mathjs$Complex): mathjs$IMathJsChain,

        /**
         * Round a value towards the nearest integer. For matrices, the function is evaluated element wise.
         * @param n Number of decimals Default value: 0.
         */
        round(n?: number | mathjs$BigNumber | mathjs$MathArray): mathjs$IMathJsChain,
        ...
        For matrices, the function is evaluated element wise.
        */
        sign(): mathjs$IMathJsChain,

        /**
         * Calculate the square root of a value. For matrices, the function is evaluated element wise.
         */
        sqrt(): mathjs$IMathJsChain,

        /**
         * Compute the square of a value, x  x. For matrices, the function is evaluated element wise.
         */
        square(): mathjs$IMathJsChain,

        /**
         * Subtract two values, x - y. For matrices, the function is evaluated element wise.
         */
        subtract(y: mathjs$MathType): mathjs$IMathJsChain,

        /**
         * Inverse the sign of a value, apply a unary minus operation.
         * For matrices, the function is evaluated element wise. Boolean values and strings will be converted to a number. For complex numbers, both real and complex value are inverted.
         */
        unaryMinus(): mathjs$IMathJsChain,

        /**
         * Unary plus operation. Boolean values and strings will be converted to a number, numeric values will be returned as is.
         * For matrices, the function is evaluated element wise.
         */
        unaryPlus(): mathjs$IMathJsChain,

        /**
         * Calculate the extended greatest common divisor for two values. See http://en.wikipedia.org/wiki/Extended_Euclidean_algorithm.
         */
        xgcd(b: number | mathjs$BigNumber): mathjs$IMathJsChain,

        /**
         * Bitwise AND two values, x & y. For matrices, the function is evaluated element wise.
         */
        bitAnd(
            y: number | mathjs$BigNumber | mathjs$MathArray | mathjs$Matrix): mathjs$IMathJsChain,

        /**
         * Bitwise NOT value, ~x. For matrices, the function is evaluated element wise. For units, the function is evaluated on the best prefix base.
         */
        bitNot(): mathjs$IMathJsChain,

        /**
         * Bitwise OR two values, x | y. For matrices, the function is evaluated element wise. For units, the function is evaluated on the lowest print base.
         */
        bitOr(): mathjs$IMathJsChain,
         ...
         * @param y Amount of shifts
         */
        leftShift(y: number | mathjs$BigNumber): mathjs$IMathJsChain,
         ...
         * @param y Amount of shifts
         */
        rightArithShift(y: number | mathjs$BigNumber): mathjs$IMathJsChain,
         ...
         * @param y Amount of shifts
         */
        rightLogShift(y: number): mathjs$IMathJsChain,

        /**
         * The Bell Numbers count the number of partitions of a set. A partition is a pairwise disjoint subset of S whose union is S. bellNumbers only takes integer arguments. The following condition must be enforced: n >= 0
         * @param n Total number of objects in the set
         */
        bellNumbers(): mathjs$IMathJsChain,

        /**
         * The Catalan Numbers enumerate combinatorial structures of many different types. catalan only takes integer arguments. The following condition must be enforced: n >= 0
         * @pararm  n nth Catalan number
         */
        catalan(): mathjs$IMathJsChain,
         ...
         * @returns  Returns the composition counts of n into k parts.
         */
        composition(k: Number | mathjs$BigNumber): mathjs$IMathJsChain,
         ...
         * @param k Number of objects in the subset
         */
        stirlingS2(k: Number | mathjs$BigNumber): mathjs$IMathJsChain,

        /**
         * Compute the argument of a complex value. For a complex number a + bi, the argument is computed as atan2(b, a). For matrices, the function is evaluated element wise.
         * @param x A complex number or array with complex numbers
         */
        arg(): mathjs$IMathJsChain,

        /**
         * Compute the complex conjugate of a complex value. If x = a+bi, the complex conjugate of x is a - bi. For matrices, the function is evaluated element wise.
         * @param x A complex number or array with complex numbers
         */
        conj(): mathjs$IMathJsChain,

        /**
         * Get the imaginary part of a complex number. For a complex number a + bi, the function returns b.
         * Formatrices, the function is evaluated element wise.
         */
        im(): mathjs$IMathJsChain,

        /**
         * Get the real part of a complex number. For a complex number a + bi, the function returns a.
         * For matrices, the function is evaluated element wise.
         */
        re(): mathjs$IMathJsChain,
        ...
        equationofa 3D line, x0, y0, z0, a, b, c are from: (x−x0, y−y0, z−z0) = t(a, b, c)
        */
        distance(y: mathjs$MathArray | mathjs$Matrix | any): mathjs$IMathJsChain,
        ...
        */
        intersect(
            x: mathjs$MathArray | mathjs$Matrix,
            y: mathjs$MathArray | mathjs$Matrix,
            z: mathjs$MathArray | mathjs$Matrix): mathjs$IMathJsChain,
        ...
        cross(A,B)= [ a2  b3 - a3  b2, a3  b1 - a1  b3, a1  b2 - a2  b1 ]
        */
        cross(y: mathjs$MathArray | mathjs$Matrix): mathjs$IMathJsChain,

        /**
         * Calculate the determinant of a matrix.
         */
        det(): mathjs$IMathJsChain,
        ...
        resize(
            size: mathjs$MathArray | mathjs$Matrix,
            defaultValue?: number | string): mathjs$IMathJsChain,

        /**
         * Calculate the size of a matrix or scalar.
         */
        size(): mathjs$IMathJsChain,

        /**
         * Squeeze a matrix, remove inner and outer singleton dimensions from a matrix.
         */
        squeeze(): mathjs$IMathJsChain,
        ...
        subset(
            index: mathjs$Index,
            replacement?: any,
            defaultValue?: any): mathjs$IMathJsChain,

        /**
         * Calculate the trace of a matrix: the sum of the elements on the main diagonal of a square matrix.
         */
        trace(): mathjs$IMathJsChain,

        /**
         * Transpose a matrix. All values of the matrix are reflected over its main diagonal. Only two dimensional matrices are supported.
         */
        transpose(): mathjs$IMathJsChain,

        /**
         * Random pick a value from a one dimensional array. Array element is picked using a random function with uniform distribution.
         */
        pickRandom(): mathjs$IMathJsChain,

        /**
         * Return a random number larger or equal to min and smaller than max using a uniform distribution.
         */
        random(): mathjs$IMathJsChain,
        random(max?: number): mathjs$IMathJsChain,
        random(min: number, max: number): mathjs$IMathJsChain,

        /**
         * Return a random integer number larger or equal to min and smaller than max using a uniform distribution.
         */
        randomInt(max?: number): mathjs$IMathJsChain,
        randomInt(min: number, max: number): mathjs$IMathJsChain,
        ...
        For matrices, the function is evaluated element wise.
        */
        compare(y: mathjs$MathType): mathjs$IMathJsChain,

        /**
         * Test element wise whether two matrices are equal. The function accepts both matrices and scalar values.
         */
        deepEqual(y: mathjs$MathType): mathjs$IMathJsChain,
        ...
        Values null and undefined are compared strictly, thus null is only equal to null and nothing else, and undefined is only equal to undefined and nothing else.
        */
        equal(y: mathjs$MathType): mathjs$IMathJsChain,
        ...
        For matrices, the function is evaluated element wise.
        */
        larger(y: mathjs$MathType): mathjs$IMathJsChain,
        ...
        For matrices, the function is evaluated element wise.
        */
        largerEq(y: mathjs$MathType): mathjs$IMathJsChain,
        ...
        For matrices, the function is evaluated element wise.
        */
        smaller(IMathJsChainy: mathjs$MathType): mathjs$IMathJsChain,
        ...
        The function cannot be used to compare values smaller than approximately 2.22e-16. For matrices, the function is evaluated element wise.
        */
        smallerEq(IMathJsChainy: mathjs$MathType): mathjs$IMathJsChain,
        ...
        everying except. undefined.
        */
        unequal(IMathJsChainy: mathjs$MathType): mathjs$IMathJsChain,

        /**
         * Compute the maximum value of a matrix or a list with values. In case of a multi dimensional array, the maximum of the flattened
         * arraywillbe calculated. When dim is provided, the maximum over the selected dimension will be calculated. Parameter dim is zero-based.
         */
        max(dim?: number): mathjs$IMathJsChain,

        /**
         * Compute the mean value of matrix or a list with values. In case of a multi dimensional array, the mean of the flattened array will be
         * calculated.When dim is provided, the maximum over the selected dimension will be calculated. Parameter dim is zero-based.
         */
        mean(dim?: number): mathjs$IMathJsChain,
        ...
        Incaseofa(multi dimensional) array or matrix, the median of all elements will be calculated.
        */
        median(): mathjs$IMathJsChain,

        /**
         * Compute the maximum value of a matrix or a list of values. In case of a multi dimensional array, the maximum of the flattened
         * arraywillbe calculated. When dim is provided, the maximum over the selected dimension will be calculated. Parameter dim is zero-based.
         */
        min(dim?: number): mathjs$IMathJsChain,

        /**
         * Computes the mode of a set of numbers or a list with values(numbers or characters). If there are more than one modes, it returns a list of those values.
         */
        mode(): mathjs$IMathJsChain,

        /**
         * Compute the product of a matrix or a list with values. In case of a (multi dimensional) array or matrix, the sum of all elements will be calculated.
         */
        prod(): mathjs$IMathJsChain,
        ...
        */
        quantileSeq(
            prob: Number | mathjs$BigNumber | mathjs$MathArray,
            sorted?: boolean): mathjs$IMathJsChain,
        ...
        'biased'Thesum of squared errors is divided by (n + 1)
        */
        std(normalization?: string): mathjs$IMathJsChain,

        /**
         * Compute the sum of a matrix or a list with values. In case of a (multi dimensional) array or matrix, the sum of all elements will be calculated.
         */
        sum(): mathjs$IMathJsChain,
        ...
        insteadofmath.var(...).
        */
        var (normalization?: string): mathjs$IMathJsChain,

        /**
         * Calculate the inverse cosine of a value. For matrices, the function is evaluated element wise.
         */
        acos(): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic arccos of a value, defined as acosh(x) = ln(sqrt(x^2 - 1) + x).
         * For matrices, the function is evaluated element wise.
         */
        acosh(): mathjs$IMathJsChain,

        /**
         * Calculate the inverse cotangent of a value. For matrices, the function is evaluated element wise.
         */
        acot(): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic arccotangent of a value, defined as acoth(x) = (ln((x+1)/x) + ln(x/(x-1))) / 2.
         * For matrices, the function is evaluated element wise.
         */
        acoth(): mathjs$IMathJsChain,

        /**
         * Calculate the inverse cosecant of a value. For matrices, the function is evaluated element wise.
         */
        acsc(): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic arccosecant of a value, defined as acsch(x) = ln(1/x + sqrt(1/x^2 + 1)).
         * For matrices, the function is evaluated element wise.
         */
        acsch(): mathjs$IMathJsChain,

        /**
         * Calculate the inverse secant of a value. For matrices, the function is evaluated element wise.
         */
        asec(): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic arcsecant of a value, defined as asech(x) = ln(sqrt(1/x^2 - 1) + 1/x). For matrices, the function is evaluated element wise.
         */
        asech(): mathjs$IMathJsChain,

        /**
         * Calculate the inverse sine of a value. For matrices, the function is evaluated element wise.
         */
        asin(): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic arcsine of a value, defined as asinh(x) = ln(x + sqrt(x^2 + 1)). For matrices, the function is evaluated element wise.
         */
        asinh(): mathjs$IMathJsChain,

        /**
         * Calculate the inverse tangent of a value. For matrices, the function is evaluated element wise.
         */
        atan(): mathjs$IMathJsChain,
        ...
        Formatrices, the function is evaluated element wise.
        */
        atan2(x: number): mathjs$IMathJsChain,
        atan2(x: mathjs$MathArray | mathjs$Matrix): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic arctangent of a value, defined as atanh(x) = ln((1 + x)/(1 - x)) / 2.
         * For matrices, the function is evaluated element wise.
         */
        atanh(): mathjs$IMathJsChain,
         ...
         * Calculate the hyperbolic cosine of a value, defined as cosh(x) = 1/2  (exp(x) + exp(-x)). For matrices, the function is evaluated element wise.
         */
        cosh(): mathjs$IMathJsChain,

        /**
         * Calculate the cotangent of a value. cot(x) is defined as 1 / tan(x). For matrices, the function is evaluated element wise.
         */
        cot(): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic cotangent of a value, defined as coth(x) = 1 / tanh(x). For matrices, the function is evaluated element wise.
         */
        coth(): mathjs$IMathJsChain,

        /**
         * Calculate the cosecant of a value, defined as csc(x) = 1/sin(x). For matrices, the function is evaluated element wise.
         */
        csc(): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic cosecant of a value, defined as csch(x) = 1 / sinh(x). For matrices, the function is evaluated element wise.
         */
        csch(): mathjs$IMathJsChain,

        /**
         * Calculate the secant of a value, defined as sec(x) = 1/cos(x). For matrices, the function is evaluated element wise.
         */
        sec(): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic secant of a value, defined as sech(x) = 1 / cosh(x). For matrices, the function is evaluated element wise.
         */
        sech(): mathjs$IMathJsChain,

        /**
         * Calculate the sine of a value. For matrices, the function is evaluated element wise.
         */
        sin(): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic sine of a value, defined as sinh(x) = 1/2  (exp(x) - exp(-x)). For matrices, the function is evaluated element wise.
         */
        sinh(): mathjs$IMathJsChain,

        /**
         * Calculate the tangent of a value. tan(x) is equal to sin(x) / cos(x). For matrices, the function is evaluated element wise.
         */
        tan(): mathjs$IMathJsChain,

        /**
         * Calculate the hyperbolic tangent of a value, defined as tanh(x) = (exp(2  x) - 1) / (exp(2  x) + 1). For matrices, the function is evaluated element wise.
         */
        tanh(): mathjs$IMathJsChain,
         ...
         * @param unit New unit. Can be a string like "cm" or a unit without value.
         */
        to(unit: mathjs$Unit | string): mathjs$IMathJsChain,

        /**
         * Clone an object.
         */
        clone(): mathjs$IMathJsChain,
         ...
         * @param test 
        */
        filter(test: RegExp | ((item: any) => boolean)): mathjs$IMathJsChain,

        /**
         * Format a value of any type into a string.
         */
        format(
            options?: mathjs$IFormatOptions | number | ((item: any) => string)): mathjs$IMathJsChain,

        /**
         * Create a new matrix or array with the results of the callback function executed on each entry of the matrix/array.
         * @param callback The callback method is invoked with three parameters: the value of the element, the index of the element, and the matrix being traversed.
         */
        map(callback: (item: any) => any): mathjs$IMathJsChain,
        ...
        partitionSelect(
            k: number,
            compare?: string | ((a: any, b: any) => number)): mathjs$IMathJsChain,

        /**
         * Sort the items in a matrix.
         * @param compare An optional comparator function. The function is called as compare(a, b), and must return 1 when a>b, -1 when a<b, and 0 when a == b. Default value: 'asc'.
         */
        sort(compare?: string | ((a: any, b: any) => number)): mathjs$IMathJsChain,
        done(): any,
        valueOf(): any,
        toString(): string
}
