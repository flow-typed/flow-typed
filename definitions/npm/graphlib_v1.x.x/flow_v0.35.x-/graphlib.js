// @flow
/**
 * Flowtype definitions for graphlib
...
declare module 'graphlib' {
    ...
    declare     var npm$namespace$json: {
         ...
         */
    declare     function json$write(g: Graph): Object
    ...
    */
    ...
    declare     var npm$namespace$alg: {
            ...
            floydWarshall: typeof alg$floydWarshall,
            isAcyclic: typeof alg$isAcyclic,
            prim: typeof alg$prim,
            tarjan: typeof alg$tarjan,
        ...
        */
    declare     function alg$components(g: Graph): string[][]
    ...
    */
    ...
    cycle or not.
    */
    declare     function alg$findCycles(graph: Graph): string[][]
    ...
    */
    ...
    Takes O(|V| + |E|) time.
    */
    declare     function alg$topsort(graph: Graph): string[]
}