/**
 * Flowtype definitions for ramda
...
declare interface R$Functor<T>{
    map<T>(a: any): T
}

declare interface R$ObjectIterator<T, TResult>{
    (element: T, key: string, obj: R$Dictionary<T>): R$Dictionary<TResult >
}

declare type R$KeyValuePair<K, V>= {
    0: K,
    1: V
} & Array


declare interface R$ArrayLike {
    nodeType: number
}

declare interface R$Arity0Fn {
    (): any
}

declare interface R$Arity1Fn {
    (a: any): any
}

declare interface R$Arity2Fn {
    (a: any, b: any): any
}

declare interface R$ObjFunc {
    [index: string]: Function
}

declare interface R$ObjFunc2 {
    [index: string]: (x: any, y: any) => boolean
}

declare interface R$Pred {
    (...a: any[]): boolean
}

declare interface R$ObjPred {
    (value: any, key: string): boolean
}

declare interface R$Dictionary<T>{
    [index: string]: T
}

declare type R$CharList = {
    push(x: string): void
} & String


declare interface R$Nested<U>{
    [index: string]: R$Nested<U>| {
        (value: any): U
    }
}

declare interface R$Lens {
    (obj: T): U,
    set<T, U>(str: string, obj: T): U
}

declare interface R$CurriedFunction2<T1, T2, R>{
    (t1: T1): (t2: T2) => R,
    (t1: T1, t2: T2): R
}

declare interface R$CurriedFunction3<T1, T2, T3, R>{
    (t1: T1): R$CurriedFunction2<T2,
    T3,
    R>,
    (t1: T1, t2: T2): (t3: T3) => R,
    (t1: T1, t2: T2, t3: T3): R
...
declare interface R$CurriedFunction4<T1, T2, T3, T4, R>{
    (t1: T1): R$CurriedFunction3<T2,
    T3,
    T4,
    R>,
    (t1: T1, t2: T2): R$CurriedFunction2<T3,
    T4,
    R>,
...
declare interface R$CurriedFunction5<T1, T2, T3, T4, T5, R>{
    (t1: T1): R$CurriedFunction4<T2,
    T3,
    T4,
    T5,
    R>,
    (t1: T1, t2: T2): R$CurriedFunction3<T3,
    T4,
    T5,
    R>,
    (t1: T1, t2: T2, t3: T3): R$CurriedFunction2<T4,
    T5,
    R>,
...
declare interface R$CurriedFunction6<T1, T2, T3, T4, T5, T6, R>{
    (t1: T1): R$CurriedFunction5<T2,
    T3,
    T4,
    T5,
    T6,
    R>,
    (t1: T1, t2: T2): R$CurriedFunction4<T3,
    T4,
    T5,
    T6,
    R>,
    (t1: T1, t2: T2, t3: T3): R$CurriedFunction3<T4,
    T5,
    T6,
    R>,
    (t1: T1, t2: T2, t3: T3, t4: T4): R$CurriedFunction2<T5,
    T6,
    R>,
...
declare interface R$Reduced {}

declare interface R$Static {
    ...
    add(a: number, b: number): number,
         ...
         */
        addIndex<T, U>(
            fn: (f: (item: T) => U, list: T[]) => U[]): R$CurriedFunction2<(item: T, idx: number, list?: T[]) => U, T[], U[]>,
        addIndex<T>(
            fn: (f: (item: T) => void, list: T[]) => T[]): R$CurriedFunction2<(item: T, idx: number, list?: T[]) => void, T[], T[]>,
        addIndex<T, U>(
            fn: (f: (acc: U, item: T) => U, aci: U, list: T[]) => U): R$CurriedFunction3<(acc: U, item: T, idx: number, list?: T[]) => U, U, T[], U>,
        ...
        */
        both(pred1: R$Pred, pred2: R$Pred): R$Pred,
        both(pred1: R$Pred): (pred2: R$Pred) => R$Pred,
        ...
        */
        ...
        /**
         * TODO composeKTODO composePReturns a new list consisting of the elements of the first list followed by the elements
         * of the second.
         */
        ...
        */
        cond(fns: [R$Pred, Function][]): Function,
        ...
        */
         ...
         */
        curry<T1, T2, TResult>(
            fn: (a: T1, b: T2) => TResult): R$CurriedFunction2<T1, T2, TResult>,
        curry<T1, T2, T3, TResult>(
            fn: (a: T1, b: T2, c: T3) => TResult): R$CurriedFunction3<T1, T2, T3, TResult>,
        curry<T1, T2, T3, T4, TResult>(
            fn: (a: T1, b: T2, c: T3, d: T4) => TResult): R$CurriedFunction4<T1, T2, T3, T4, TResult>,
        curry<T1, T2, T3, T4, T5, TResult>(
            fn: (a: T1, b: T2, c: T3, d: T4, e: T5) => TResult): R$CurriedFunction5<T1, T2, T3, T4, T5, TResult>,
        curry<T1, T2, T3, T4, T5, T6, TResult>(
            fn: (a: T1, b: T2, c: T3, d: T4, e: T5, f: T6) => TResult): R$CurriedFunction6<T1, T2, T3, T4, T5, T6, TResult>,
        ...
        */
        either(pred1: R$Pred, pred2: R$Pred): R$Pred,
        either(pred1: R$Pred): (pred2: R$Pred) => R$Pred,
        ...
        */
         ...
         */
        evolve<V>(transformations: R$Nested<V>, obj: V): R$Nested<V>,
        evolve<V>(transformations: R$Nested<V>):<V>(obj: V) => R$Nested<V>,
        F(): boolean,
         ...
         */
        flip<T, U, TResult>(
            fn: (arg0: T, arg1: U) => TResult): (arg1: U, arg0?: T) => TResult,
        flip<T, U, TResult>(
            fn: (arg0: T, arg1: U, ...args: any[]) => TResult): (arg1: U, arg0?: T, ...args: any[]) => TResult,
         ...
         */
        fromPairs<V>(pairs: R$KeyValuePair<string, V>[]): {
            [index: string]: V
        },
        fromPairs<V>(pairs: R$KeyValuePair<number, V>[]): {
            [index: number]: V
        },
        ...
        */
         ...
         */
        ifElse(fn: R$Pred, onTrue: R$Arity1Fn, onFalse: R$Arity1Fn): R$Arity1Fn,
        ...
        */
        lens<T, U, V>(getter: (s: T) => U, setter: (a: U, s: T) => V): R$Lens,

        /**
         * Creates a lens that will focus on index n of the source array.
         */
        lensIndex(n: number): R$Lens,

        /**
         * Returns a lens whose focus is the specified path.
         * See also view, set, over.
         */
        lensPath(path: string[]): R$Lens,
        ...
        map<T, U>(fn: (x: T) => U, obj: R$Functor<T>): R$Functor<U>,
        map<T, U>(fn: (x: T) => U): (list: T[]) => U[],
        ...
        mapAccum<T, U, TResult>(
            ...
            list: T[]): [U, TResult[]],
        mapAccum<T, U, TResult>(
            fn: (acc: U, value: T) => [U, TResult]): (acc: U, list: T[]) => [U, TResult[]],
        mapAccum<T, U, TResult>(
            fn: (acc: U, value: T) => [U, TResult],
        ...
        */
         ...
         */
        maxBy<T>(keyFn: (a: T) => R$Ord, a: T, b: T): T,
        maxBy<T>(keyFn: (a: T) => R$Ord, a: T): (b: T) => T,
        maxBy<T>(keyFn: (a: T) => R$Ord): R$CurriedFunction2<T, T, T>,
        ...
        */
         ...
         */
        minBy<T>(keyFn: (a: T) => R$Ord, a: T, b: T): T,
        minBy<T>(keyFn: (a: T) => R$Ord, a: T): (b: T) => T,
        minBy<T>(keyFn: (a: T) => R$Ord): R$CurriedFunction2<T, T, T>,
        ...
        */
         ...
         */
        over<T>(lens: R$Lens, fn: R$Arity1Fn, value: T): T,
        over<T>(lens: R$Lens, fn: R$Arity1Fn, value: T[]): T[],
        over(lens: R$Lens, fn: R$Arity1Fn):<T>(value: T) => T,
        over(lens: R$Lens, fn: R$Arity1Fn):<T>(value: T[]) => T[],
        over(lens: R$Lens):<T>(fn: R$Arity1Fn, value: T) => T,
        over(lens: R$Lens):<T>(fn: R$Arity1Fn, value: T[]) => T[],
        ...
        */
         ...
         */
        pickBy<T, U>(pred: R$ObjPred, obj: T): U,
        pickBy(pred: R$ObjPred):<T, U>(obj: T) => U,
        ...
        */
        ...
        propSatisfies<T, U>(pred: (val: T) => boolean, name: string): (obj: U) => boolean,
        propSatisfies<T, U>(pred: (val: T) => boolean): R$CurriedFunction2<string, U, boolean>,
        ...
        */
        reduce<T, TResult>(
            fn: (acc: TResult, elem: T) => TResult | R$Reduced,
            acc: TResult,
            list: T[]): TResult,
        reduce<T, TResult>(
            fn: (acc: TResult, elem: T) => TResult | R$Reduced): (acc: TResult, list: T[]) => TResult,
        reduce<T, TResult>(
            fn: (acc: TResult, elem: T) => TResult | R$Reduced,
        ...
        reduceBy<T, TResult>(
            valueFn: (acc: TResult, elem: T) => TResult,
            acc: TResult,
            keyFn: (elem: T) => string): (list: T[]) => {
            [index: string]: TResult
        },
        reduceBy<T, TResult>(
            valueFn: (acc: TResult, elem: T) => TResult,
            acc: TResult): R$CurriedFunction2<(elem: T) => string, T[], {
            [index: string]: TResult
        }>,
        reduceBy<T, TResult>(
            valueFn: (acc: TResult, elem: T) => TResult): R$CurriedFunction3<TResult, (elem: T) => string, T[], {
            [index: string]: TResult
        }>,
        ...
        */
        reduceRight<T, TResult>(
            ...
            list: T[]): TResult,
        reduceRight<T, TResult>(
            fn: (acc: TResult, elem: T) => TResult): (acc: TResult, list: T[]) => TResult,
        reduceRight<T, TResult>(
            fn: (acc: TResult, elem: T) => TResult,
            acc: TResult): (list: T[]) => TResult,
        ...
        scan<T, TResult>(
            ...
            acc: TResult): (list: T[]) => TResult[],
        scan<T, TResult>(
            fn: (acc: TResult, elem: T) => any): (acc: TResult, list: T[]) => TResult[],

        /**
         * Returns the result of "setting" the portion of the given data structure focused by the given lens to the
         * given value.
         */
        set<T, U>(lens: R$Lens, a: U, obj: T): T,
        set<U>(lens: R$Lens, a: U):<T>(obj: T) => T,
        set(lens: R$Lens):<T, U>(a: U, obj: T) => T,
        ...
        */
        ...
        symmetricDifferenceWith<T>(pred: (a: T, b: T) => boolean): R$CurriedFunction2<T[], T[], T[]>,
        ...
        */
        transduce<T, U>(
            ...
            list: T[]): U,
        transduce<T, U>(
            xf: (arg: T[]) => T[]): (fn: (acc: U[], val: U) => U[], acc: T[], list: T[]) => U,
        transduce<T, U>(
            xf: (arg: T[]) => T[],
        ...
        */
        ...
        unionWith<T>(pred: (a: T, b: T) => boolean): R$CurriedFunction2<T[], T[], T[]>,
        ...
        */
        ...
        where<ObjFunc2, U>(spec: R$ObjFunc2, testObj: U): boolean,
        where<ObjFunc2>(spec: R$ObjFunc2):<U>(testObj: U) => boolean,
        ...
        */
         ...
         */
        xprod<K, V>(as: K[], bs: V[]): R$KeyValuePair<K, V>[],
        xprod<K>(as: K[]):<V>(bs: V[]) => R$KeyValuePair<K, V>[],

        /**
         * Creates a new list out of the two supplied by pairing up equally-positioned items from
         * both lists. Note: `zip` is equivalent to `zipWith(function(a, b) { return [a, b] })`.
         */
        zip<K, V>(list1: K[], list2: V[]): R$KeyValuePair<K, V>[],
        zip<K>(list1: K[]):<V>(list2: V[]) => R$KeyValuePair<K, V>[],
        ...
        zipWith<T, U, TResult>(
            fn: (x: T, y: U) => TResult): (list1: T[], list2: U[]) => TResult[]
}
