...
declare module 'postal-0.8.9' {
	...
	declare interface IChannelDefinition {
		...
		subscribe(
		topic: string, callback: (data: any, envelope: IEnvelope) => void
	...
	declare interface IPostal {
		...
		linkChannels(
		sources: IEnvelope | IEnvelope[], destinations: IEnvelope | IEnvelope[]
	): ISubscriptionDefinition[],
		utils: IPostalUtils,
...
declare module 'postal' {
					declare module.exports: IPostal
