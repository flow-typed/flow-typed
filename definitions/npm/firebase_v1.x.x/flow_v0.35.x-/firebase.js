/**
 * Flowtype definitions for firebase
...
declare interface FirebaseDataSnapshot {
    ...
    exists(): boolean,
        ...
        */
         ...
         * @returns  , number, null} The priority, or null if no priority was set.
         */
        getPriority(): any,
...
declare interface FirebaseQuery {
    ...
    on(
            eventType: string,
            callback: (dataSnapshot: FirebaseDataSnapshot, prevChildName?: string) => void,
            cancelCallback?: (error: any) => void,
            context?: Object): (dataSnapshot: FirebaseDataSnapshot, prevChildName?: string) => void,
        ...
        once(
            eventType: string,
            successCallback: (dataSnapshot: FirebaseDataSnapshot) => void,
            context?: Object): void,
        once(
            eventType: string,
            successCallback: (dataSnapshot: FirebaseDataSnapshot) => void,
...
declare type Firebase = {
    ...
    */
    auth(
        authToken: string,
        onComplete: (error: any, result: FirebaseAuthResult) => void,
        onCancel?: (error: any) => void): void,
    ...
    authWithCustomToken(
        autoToken: string,
        onComplete: (error: any, authData: FirebaseAuthData) => void,
        options?: Object): void,
    ...
    authWithOAuthToken(
        provider: string,
        credentials: string | Object,
        options?: Object): Promise<FirebaseAuthData>,
    ...
    */
    ...
    transaction(
        ...
        onComplete?: (error: any, committed: boolean, snapshot: FirebaseDataSnapshot) => void,
    ...
    createUser(
        credentials: FirebaseCredentials,
        onComplete: (error: any, userData: any) => void): void,

    /**
     * Updates the email associated with an email / password user account.
     */
    changeEmail(
        credentials: FirebaseChangeEmailCredentials,
        onComplete: (error: any) => void): void,
...
declare type FirebaseWithPromise<T>= {} & Firebase & Promise
