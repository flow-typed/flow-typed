...
describe('puppeteer.launch', () => {
  it('should complain if you pass in a string arg', () => {
    // $FlowExpectedError[incompatible-call] string is incompatible with `LaunchOptions`
    puppeteer.launch('testing...');
  });
  it('should complain if an option arg key is of the wrong type', () => {
    // $FlowExpectedError[incompatible-call] string is incompatible with boolean inproperty `headless`
