...
declare module 'webdriverio' {
    ...
    declare export class Client<T> extends EventEmitter {
        ...
        selectorExecute(selector: string, script: Function, ...args: Array<any>): Array<ElementValue>;
        selectorExecuteAsync(selector: string, script: Function, ...args: Array<any>): Client<Array<ElementValue>>; // XXX: Is return type correct?
        ...
        reset(): this;
        rotate(x: number, y: number, duration: number, radius: number, rotation: number, touchCount: number): this;
        ...
        swipe(selector?: string, xoffset?: number, yoffset?: number, speed?: number): this;
        ...
        getElementSize(selector: string, which?: string): Client<number | ElementSize>;
        ...
        getLocationInView(selector: string, which?: string): Client<Position | number>;
        ...
        touchFlick(id: string, xoffset: number, yoffset: number, speed: number): this;
        touchLongClick(id: string): this;
        touchMove(x: number, y: number): this;
        touchScroll(id: string, xoffset: number, yoffset: number, speed: number): this;
        ...
        waitForEnabled(selector: string, ms?: number, reverse?: boolean): Client<boolean>;
        waitForExist(selector: string, ms?: number, reverse?: boolean): Client<boolean>;
        waitForSelected(selector: string, ms?: number, reverse?: boolean): Client<boolean>;
        waitForText(selector: string, ms?: number, reverse?: boolean): Client<boolean>;
        waitForValue(selector: string, ms?: number, reverse?: boolean): Client<boolean>;
        waitForVisible(selector: string, ms?: number, reverse?: boolean): Client<boolean>;
        waitUntil(condition: Function | Promise<any>, timeout?: number, timeoutMsg?: string, interval?: number): this;
