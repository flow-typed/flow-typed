// @flow
/**
 * Flowtype definitions for jquery.ui.layout
...
declare interface JQueryUILayout$PaneOptions {
    applyDefaultStyles?: boolean,
        ...
        initHidden?: boolean,
        onshow_start?: string | {
            (name: string, pane: JQuery, state: JQueryUILayout$PaneState, options: JQueryUILayout$PaneOptions, layout_name: string): (boolean | void)
        },
        onshow_end?: string | {
            (name: string, pane: JQuery, state: JQueryUILayout$PaneState, options: JQueryUILayout$PaneOptions, layout_name: string): void
        },
        onshow?: string | {
            (name: string, pane: JQuery, state: JQueryUILayout$PaneState, options: JQueryUILayout$PaneOptions, layout_name: string): void
        },
...
declare type JQueryUILayout$Options = {
    defaults?: JQueryUILayout$PaneOptions,
    north?: JQueryUILayout$PaneOptions,
    east?: JQueryUILayout$PaneOptions,
    south?: JQueryUILayout$PaneOptions,
    west?: JQueryUILayout$PaneOptions,
    center?: JQueryUILayout$PaneOptions,
...
} & JQueryUILayout$PaneOptions


declare interface JQueryUILayout$PaneState {
    isClosed: boolean,
        isSliding: boolean,
        isResizing: boolean,
        isHidden: boolean,
...
declare interface JQueryUILayout$Layout {
    panes: {
        ...
        options: JQueryUILayout$Options,
        state: {
            north: JQueryUILayout$PaneState,
            east: JQueryUILayout$PaneState,
            south: JQueryUILayout$PaneState,
            west: JQueryUILayout$PaneState
        },
