...
declare module 'plugapi' {
	...
	declare interface PlugAPIInstance {
		...
		on(
		event: "roomMinChatLevelUpdate", callback: (data: Event.RoomMinChatLevelUpdate) => void
	): void,
	...
	declare interface PlugAPIStatic {
		new (
		login: PlugLogin, callback?: (error: Error, bot: PlugAPIInstance) => void
	): PlugAPIInstance,
		...
		events: Enum.Events
			...
			declare module.exports: PlugAPIStatic
...
declare module 'Enum' {
	...
	declare interface Mute {
		SHORT: "s",
		MEDIUM: "m",
		LONG: "l"
	}

	declare interface MuteReason {
...
declare module 'Event' {
	declare type Grab = number;

	declare type RoomJoin = string;

	declare type UserJoin = User.User;

	declare type UserLeave = User.User;

	declare interface BoothCycle {
		moderator: string,
		cycle: boolean
	}

	declare interface BoothLocked {
		m: string,
		c: boolean,
		ml: string,
		f: boolean
	...
	declare interface ChatDelete {
		mi: number,
		chatID: string
	}

	declare interface Advance {
		media: Media,
		startTime: string,
		historyID: string,
		djs: User.DJ[],
	...
	declare interface DJListUpdate {
		djs: User.DJ[],
		remove: string
	}
	...
	declare interface FollowJoin {
		data: FollowJoinData,
		type: string
	}

	declare interface ModAddDJ {
		moderator: string,
		username: string
	}

	declare interface ModBan {
		moderator: string,
		username: string,
		duration: number,
		ref: string,
	...
	declare interface ModRemoveDJ {
		moderator: string,
		username: string,
		userID: string
	}

	declare interface ModSkip {
		mi: number,
		m: string
	}

	declare interface RoomMinChatLevelUpdate {
		level: number,
		id: number,
		user: User.User
	}
