...
declare module 'hapi' {
    ...
    declare interface IThenable<R>{
        then<U>(
            ...
            onRejected?: (error: any) => U | IThenable<U>): IThenable<U>,
        then<U>(
            onFulfilled?: (value: R) => U | IThenable<U>,
            onRejected?: (error: any) => void): IThenable<U >
    }
    declare type IPromise<R>= {
        then<U>(
            onFulfilled?: (value: R) => U | IThenable<U>,
            onRejected?: (error: any) => U | IThenable<U>): IPromise<U>,
        then<U>(
            onFulfilled?: (value: R) => U | IThenable<U>,
     ...
     */
    declare export type IServerConnectionOptions = {
    ...
    */
    declare export interface IRouteHandlerConfig {
         ...
         * arelative or absolute file path string (relative paths are resolved based on the route files configuration).
    ...
    */
     ...
     */
    declare export class ResponseRedirect mixins Response {
     ...
     */
    declare export class ServerConnection mixins Events.EventEmitter {
        domain: any;
        _events: {
            route: Function,
            domain: Function,
    ...
    declare type RequestExtPoints = "onRequest" |
        "onPreResponse" |
        "onPreAuth" |
        "onPostAuth" |
        "onPreHandler" |
    ...
    declare export class Server mixins Events.EventEmitter {
        ...
        */
        ...
        auth: {
            ...
            /**
             * server.auth.api
             * Anobject where each key is a strategy name and the value is the exposed strategy API. Available on when the authentication scheme exposes an API by returning an api key in the object returned from its implementation function.
        ...
        */
        ...
        Ifno `callback` is provided, a `Promise` object is returned.

        Note that if the method fails and the callback includes an error, the server is considered to be in
        anundefined state and should be shut down. In most cases it would be impossible to fully recover as
        ...
        toassert that no error has been returned after calling `initialize()` to abort the process when the
