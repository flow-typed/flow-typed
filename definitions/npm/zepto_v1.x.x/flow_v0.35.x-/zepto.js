/**
 * Flowtype definitions for zepto
...
declare interface ZeptoStatic {
    ...
    /**
     * CoreCreate a Zepto collection object by performing a CSS selector, wrapping DOM nodes, or creating elements from an HTML string.
     * @param selector 
     * @param context 
     * @return  *
     */
    ...
    camelCase(str: string): string,
        ...
        /**
         * EventCreate and initialize a DOM event of the specified type. If a properties object is given, use it to extend the new event object. The event is configured to bubble by default; this can be turned off by setting the bubbles property to false.
        ...
        /**
         * AjaxPerform an Ajax request. It can be to a local resource, or cross-domain via HTTP access control support in browsers or JSONP.
         * Options:
        ...
        */
         ...
         * @example  *	timeout (default: 0): set to a non-zero value to specify a default timeout for Ajax requests in milliseconds
        ...
        */
        ...
        /**
         * EffectsGlobal settings for animations.
         */
        fx: ZeptoEffects,

        /**
         * DetectThe following boolean flags are set to true if they apply, if not they're either set to 'false' or 'undefined'.  We recommend accessing them with `!!` prefixed to coerce to a boolean.
         */
        os: {
...
declare interface ZeptoCollection {
    ...
    /**
     * CoreModify the current collection by adding the results of performing the CSS selector on the whole document, or, if context is given, just inside context elements.
     * @param selector 
     * @param context 
     * @return  Self object.
     */
    add(selector: string, context?: any): ZeptoCollection,
        ...
        */
         ...
         */
        reduce(
            fn: (memo: any, item: any, index: number, array: any[], initial: any) => any): any,
        ...
        toggleClass(
            ...
            setting?: boolean): ZeptoCollection,
        ...
        /**
         * EventAttach an event handler to elements.
        ...
        /**
         * AjaxSet the html contents of the current collection to the result of a GET Ajax call to the given URL. Optionally, a CSS selector can be specified in the URL, like so, to use only the HTML content matching the selector for updating the collection:
        ...
        */
        load(
            url: string,
            fn?: (data: any, status: string, xhr: XMLHttpRequest) => void): ZeptoCollection,

        /**
         * FormSerialize form values to an URL-encoded string for use in Ajax post requests.
        ...
        /**
         * EffectsSmoothly transition CSS properties of elements in the current collection.
