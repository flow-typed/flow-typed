/**
 * Flowtype definitions for jstree
...
declare interface JSTreeStatic {
    ...
    version: string,
         ...
         * @param  the element to create the instance on, can be jQuery extended or a selector
         * @param  options for this instance (extends `$.jstree.defaults`)
...
declare type JSTree = {
     ...
     * @param  the plugin to decorate with
     * @param  options for the plugin
     * @return  
     */
     ...
     * @param  the element we are transforming
     * @param  options for this instance
     ...
     * destroy an instance
     * @name  destroy()
     * @param  if not set to `true` the container will be emptied, otherwise the current DOM elements will be kept intact
     */
     ...
     * @param  the name of the event to trigger
     * @param  additional data to pass with the eventreturns the jQuery extended instance container
     * @name  get_container()
     * @return  
     */
     ...
     * @param  the node
     * @param  if you want the path as a string - pass the glue here (for example '/'), if a falsy value is supplied here, an array is returned
     * @param  if set to true build the path using ID, otherwise node text is used
     * @return  
     */
     ...
     * @param  
     * @param  a function to be executed once loading is conplete, the function is executed in the instance's scope 
    ...
    */
     ...
     * @param  
     * @param  a function to be executed once loading is complete, the function is executed in the instance's scope and receives one argument - the array passed to _load_nodes
     * @param  - if false reloads node (AP - original comment missing in source code)
     * @param  - if true force reloads node (AP - original comment missing in source code)
     */
    _load_nodes: (
        nodes: any[],
        callback?: (nodes: any[]) => void,
        is_callback?: boolean,
        force_reload?: boolean) => void,

    /**
     * loads all unloaded nodes
     * @name  load_all([obj, callback])
     * @param  the node to load recursively, omit to load all nodes in the tree
     * @param  a function to be executed once loading all the nodes is complete,
     ...
     * @param  
     * @param  a function to be executed once loading is complete, the function is executed in the instance's scope and receives one argument - a boolean status
     * @return  
     */
     ...
     * @param  the node to append to
     * @param  the HTML string to parse and append
     * @param  function which takes boolean flag executes after append (AP: originally lack of comment)
     ...
     * @param  the node to append to
     * @param  the JSON object to parse and append
     * @param  function which takes boolean flag executes after append (AP: originally lack of comment)
     * @param  internal param - do not set
     * @trigger  model.jstree, changed.jstree
     */
    _append_json_data: (
        dom: any,
        ...
        force_processing: boolean) => void,

    /**
     * parses a node from a jQuery object and appends them to the in memory tree model. Used internally.
     * @private  * 
     * @name  _parse_model_from_html(d [, p, ps])
     * @param  the jQuery object to parse
     * @param  the parent ID
     * @param  list of all parents
     * @return  the ID of the object added to the model
     */
     ...
     * @param  the JSON object to parse
     * @param  the parent ID
     * @param  list of all parents
     * @return  the ID of the object added to the model
     */
     ...
     * @name  redraw([full])
     * @param  if set to `true` all nodes are redrawn.
     */
     ...
     * @param  the node whose children will be redrawn
     */
     ...
     * @param  the node to redraw
     * @param  should child nodes be redrawn too
     * @param  is this a recursion call
     * @param  should children of closed parents be drawn anyway
     */
     ...
     * @param  the node to open
     * @param  a function to execute once the node is opened
     * @param  the animation duration in milliseconds 
    ...
    */
     ...
     * @param  the node to open recursively, omit to open all nodes in the tree
     * @param  the animation duration in milliseconds when opening the nodes, the default is no animation
     * @param  to the node that started the process (internal use)
     ...
     * @param  the node to close recursively, omit to close all nodes in the tree
     * @param  the animation duration in milliseconds when closing the nodes, the default is no animation
     ...
     * @name  hide_node(obj)
     * @param  the node to hide
     * @param  internal parameter controlling if redraw is called
     ...
     * @param  an array can be used to select multiple nodes
     * @param  if set to `true` the `changed.jstree` event won't be triggered
     * @param  if set to `true` parents of the selected node won't be opened
     ...
     * @param  an array can be used to deselect multiple nodes
     * @param  if set to `true` the `changed.jstree` event won't be triggered
     ...
     * @param  if set to `true` the returned array will consist of the full node objects, otherwise - only IDs will be returned
     * @return  
     */
     ...
     * @private  * 
     * @param  the state to restore
     * @param  an optional function to execute once the state is restored.
     ...
     * @name  refresh()
     * @param  an option to skip showing the loading indicator
     * @param  if set to `true` state will not be reapplied, 
    ...
    */
     ...
     * @param  the node, you can pass an array to set the text on multiple nodes
     ...
     * @param  
     * @param  
     * @param  .no_state do not return state information
     * @param  .no_id do not return ID
     * @param  .no_children do not include children
     * @param  .no_data do not include node data
     * @param  .no_li_attr do not include LI attributes
     * @param  .no_a_attr do not include A attributes
     * @param  .flat return flat JSON instead of nested
     * @return  
     */
     ...
     * @param  the parent node (to create a root node use either "#" (string) or `null`)
     * @param  the data for the new node (a valid JSON object, or a simple string with the name)
     * @param  the index at which to insert the node, "first" and "last" are also supported, default is "last"
     * @param  a function to be called once the node is created
     * @param  internal argument indicating if the parent node was succesfully loaded
     * @return  the ID of the newly create node
    ...
    create_node: (
        ...
        pos?: any,
        callback?: any,
        is_loaded?: boolean) => string,

    /**
     * set the text value of a node
     * @name  rename_node(obj, val)
     * @param  the node, you can pass an array to rename multiple nodes to the same name
     * @param  the new text value
     * @return  * 
     ...
     * @param  the node, you can pass an array to delete multiple nodes
     * @return  * 
     ...
     * @param  the operation to check, can be "create_node", "rename_node", "delete_node", "copy_node" or "move_node"
     * @param  the node
     * @param  the parent
     * @param  the position to insert at, or if "rename_node" - the new name
     * @param  some various additional information, for example if a "move_node" operations is triggered by DND this will be the hovered node
     * @return  
     */
     ...
     * @param  the node to move, pass an array to move multiple nodes
     * @param  the new parent
     * @param  the position to insert at (besides integer values, "first" and "last" are supported, as well as "before" and "after"), defaults to integer `0`
     * @param  a function to call once the move is completed, receives 3 arguments - the node, the new parent and the position
     * @param  internal parameter indicating if the parent node has been loaded
     * @param  internal parameter indicating if the tree should be redrawn
     * @param  internal parameter indicating if the node comes from another instance
     ...
     * @param  the node to copy, pass an array to copy multiple nodes
     * @param  the new parent
     * @param  the position to insert at (besides integer values, "first" and "last" are supported, as well as "before" and "after"), defaults to integer `0`
     * @param  a function to call once the move is completed, receives 3 arguments - the node, the new parent and the position
     * @param  internal parameter indicating if the parent node has been loaded
     ...
     * @name  cut(obj)
     * @param  multiple objects can be passed using an array
     * @trigger  cut.jstree
     */
    cut: (obj: any) => void,
     ...
     * @name  get_buffer()
     * @return  an object consisting of `mode` ("copy_node" or "move_node"), `node` (an array of objects) and `inst` (the instance)
     */
    get_buffer: () => Buffer,
     ...
     * @name  paste(obj [, pos])
     * @param  the new parent
     * @param  the position to insert at (besides integer, "first" and "last" are supported), defaults to integer `0`
     ...
     * @param  
     * @param  the text to populate the input with (if omitted or set to a non-string value the node's text value is used)
     * @param  a function to be called once the text box is blurred, it is called in the instance's scope and receives the node, a status parameter (true if the rename is successful, false otherwise) and a boolean indicating if the user cancelled the edit. You can access the node's title using .text
     */
    edit: (
        obj: any,
        default_text?: string,
        callback?: (node: any, status: boolean, canceled: boolean) => void) => void,

    /**
     * changes the theme
     * @name  set_theme(theme_name [, theme_url])
     * @param  the name of the new theme to apply
     * @param  the location of the CSS file for this theme. Omit or set to `false` 
    ...
    */
     ...
     * @param  the variant to apply (if `false` is used the current variant is removed)
     */
     ...
     * @param  
     * @param  the new icon - can be a path to an icon or a className, 
    ...
    */
    ...
    /**
     * checkbox pluginset the undetermined state where and if necessary. Used internally.
     * @private  * 
     * @name  _undetermined()
     * @plugin  checkbox
     */
     ...
     * @param  an array can be used too
     ...
     * @name  check_node(obj)
     * @param  an array can be used to check multiple nodes
    ...
    /**
     * context menu pluginprepare and show the context menu for a node
     * @name  show_contextmenu(obj [, x, y])
     * @param  the node
     * @param  the x-coordinate relative to the document to show the menu at
     * @param  the y-coordinate relative to the document to show the menu at
     * @param  the event if available that triggered the contextmenu
     * @plugin  contextmenu
     ...
     * @param  the x-coordinate relative to the document to show the menu at
     * @param  the y-coordinate relative to the document to show the menu at
     * @param  the object of items to show
     * @plugin  contextmenu
     * @trigger  show_contextmenu.jstree
     * @private  
     */
    ...
    /**
     * search pluginused to search the tree nodes for a given string
     * @name  search(str [, skip_async])
     * @param  the search string
     * @param  if set to true server will not be queried even if configured
     * @param  if set to true only matching nodes will be shown (keep in mind this can be very slow on large trees or old browsers)
     * @param  an optional node to whose children to limit the search
     * @param  if set to true the results of this search are appended to the previous search
     * @param  show only matched children
     * @plugin  search
    ...
    search: (
        ...
        inside?: any,
        append?: boolean,
        show_only_matches_children?: boolean) => void,
    ...
    /**
     * sort pluginused to sort a node's children
     * @private  * 
     * @name  sort(obj [, deep])
     * @param  the node
     * @param  if set to `true` nodes are sorted recursively.
     * @plugin  sort
     * @trigger  search.jstree
     */
    ...
    /**
     * types pluginused to retrieve the type settings object for a node
     * @name  get_rules(obj)
     * @param  the node to find the rules for
     * @return  * 
     * @plugin  types
     */
     ...
     * @param  the node to find the rules for
     * @param  if set to `true` instead of a string the settings object will be returned
     * @return  * 
     * @plugin  types
     */
