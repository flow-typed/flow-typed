/**
 * Flowtype definitions for react-select
...
declare interface ReactSelect$AutocompleteResult {

    /**
     * the search-results to be displayed  
     */
    data: ReactSelect$Option[],
...
declare interface ReactSelect$Option {
...
declare interface ReactSelect$MenuRendererProps {
    ...
    focusedOption: ReactSelect$Option,
         ...
         */
        options: ReactSelect$Option[],

        /**
         * Callback to select a new option; receives the option as a parameter.
         */
        selectValue: (option: ReactSelect$Option) => void,

        /**
         * Array of currently selected options.
         */
        valueArray: ReactSelect$Option[]
}

declare type ReactSelect$ReactSelectProps = {
     ...
     */
    filterOption?: (option: ReactSelect$Option, filter: string) => ReactSelect$Option,

    /**
     * method to filter the options array
     */
    filterOptions?: (
        options: Array<ReactSelect$Option>,
        filter: string,
        currentValues: Array<ReactSelect$Option>) => Array<ReactSelect$Option>,
     ...
     */
    menuRenderer?: (props: ReactSelect$MenuRendererProps) => ___React.ReactElement<any>,
     ...
     */
    onChange?: (newValue: ReactSelect$Option | ReactSelect$Option[]) => void,
     ...
     */
    optionRenderer?: (option: ReactSelect$Option) => JSX.Element,
     ...
     * @default  false
     */
    valueRenderer?: (option: ReactSelect$Option) => JSX.Element,
...
declare type ReactSelect$ReactAsyncSelectProps = {
    ...
    loadOptions: (
        input: string,
        callback: (err: any, result: ReactSelect$AutocompleteResult) => any) => any,
...
declare type ReactSelect$ReactCreatableSelectProps = {
     ...
     */
    newOptionCreator?: (input: string) => ReactSelect$Option,
...
declare class ReactSelectCreatableClass mixins ___React.Component<ReactSelect$ReactCreatableSelectProps, {}>{}

declare class ReactSelectAsyncClass mixins ___React.Component<ReactSelect$ReactAsyncSelectProps, {}>{}

declare class ReactSelectClass mixins ___React.Component<ReactSelect$ReactSelectProps, {}>{
    Async: ReactSelect$ReactSelectAsyncClass;
    Creatable: ReactSelect$ReactSelectCreatableClass
}
declare module 'react-select' {
    declare module.exports: typeof ReactSelect$ReactSelectClass
}
