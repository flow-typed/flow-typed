/**
 * Flowtype definitions for nomnom
...
declare export interface NomnomInternal$Parser {
    ...
    command(name: string): Parser$Command,
         ...
         * @returns  The command-line parser.
         */
        option(name: string, spec: Parser$Option): NomnomInternal$Parser,
         ...
         * @returns  The command-line parser.
         */
        printer(print: (message: string, code?: number) => void): NomnomInternal$Parser,
