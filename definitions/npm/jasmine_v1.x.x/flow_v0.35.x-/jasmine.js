...
declare function describe(description: string, specDefinitions: () => void): voiddeclare function fdescribe(description: string, specDefinitions: () => void): voiddeclare function xdescribe(description: string, specDefinitions: () => void): voiddeclare function it(expectation: string, assertion?: () => void, timeout?: number): voiddeclare function fit(expectation: string, assertion?: () => void, timeout?: number): voiddeclare function xit(expectation: string, assertion?: () => void, timeout?: number): void
/**
 * If you call the function pending anywhere in the spec body, no matter the expectations, the spec will be marked pending. 
 */
declare function pending(reason?: string): voiddeclare function beforeEach(action: () => void, timeout?: number): voiddeclare function afterEach(action: () => void, timeout?: number): voiddeclare function beforeAll(action: () => void, timeout?: number): voiddeclare function afterAll(action: () => void, timeout?: number): voiddeclare function expect(spy: Function): jasmine$Matchersdeclare function fail(e?: any): void
/**
...
declare function spyOn(object: any, method: string): jasmine$Spydeclare function runs(asyncMethod: Function): voiddeclare function waitsFor(latchMethod: () => boolean, failureMessage?: string, timeout?: number): voiddeclare function waits(timeout?: number): void
...
declare function jasmine$addMatchers(matchers: jasmine$CustomMatcherFactories): void

declare function jasmine$stringMatching(str: string): jasmine$Any

declare function jasmine$formatErrorMsg(domain: string, usage: string): (msg: string) => string
...
declare export var HtmlReporter: jasmine$HtmlReporter;

declare export var HtmlSpecFilter: jasmine$HtmlSpecFilter;

declare export var DEFAULT_TIMEOUT_INTERVAL: number;