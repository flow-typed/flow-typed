...
declare module 'npm$namespace$CryptoJS' {
	declare type Hash = (message: string, key?: string, ...options: any[]) => string;

	declare export type DecryptedMessage = {
	...
	declare interface Cipher {
		...
		decrypt(
		encryptedMessage: string | WordArray, secretPassphrase: string, option?: CipherOption
	): DecryptedMessage
	}

	declare interface CipherAlgorythm {
	...
	declare interface CipherOption {
		iv?: string,
		mode?: Mode,
		padding?: Padding,
		[option: string]: any
	...
	declare export interface Hashes {
		MD5: Hash,
		SHA1: Hash,
		SHA256: Hash,
		SHA224: Hash,
