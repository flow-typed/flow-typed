...
declare module 'npm$namespace$UniversalAnalytics' {
		...
		pageview(
		path: string, title: string, hostname: string, callback?: (err: any) => void
	): void,
		...
		event(
		category: string, action: string, label: string, callback?: (err: any) => void
	): void,
		event(category: string, action: string, label: string, value: any): Client,
		event(
		category: string, action: string, label: string, value: any, callback?: (err: any) => void
	): void,
		event(
		category: string, action: string, label: string, value: any, params: Object, callback?: (err: any) => void
	): void,
		...
		transaction(
		id: string, revenue: number, shipping: number, callback: (err: any) => void
	): void,
		transaction(id: string, revenue: number, shipping: number, taxping: number): Client,
		transaction(
		id: string, revenue: number, shipping: number, taxping: number, callback: (err: any) => void
	): void,
		transaction(
		id: string, revenue: number, shipping: number, taxping: number, affiliation: string
	): Client,
		transaction(
		id: string, revenue: number, shipping: number, taxping: number, affiliation: string, callback: (err: any) => void
	): void,
		...
		item(
		price: number, quantity: number, sku: number, callback: (err: any) => void
	): void,
		item(price: number, quantity: number, sku: number, name: string): Client,
		item(
		price: number, quantity: number, sku: number, name: string, callback: (err: any) => void
	): void,
		item(
		price: number, quantity: number, sku: number, name: string, variation: string
	): Client,
		item(
		price: number, quantity: number, sku: number, name: string, variation: string, callback: (err: any) => void
	): void,
		item(
		price: number, quantity: number, sku: number, name: string, variation: string, params: Object
	): Client,
		item(
		price: number, quantity: number, sku: number, name: string, variation: string, params: Object, callback: (err: any) => void
	): void,
		...
		timing(
		category: string, variable: string, time: number, callback: (err: any) => void
	): void,
		timing(category: string, variable: string, time: number, label: string): Client,
		timing(
		category: string, variable: string, time: number, label: string, callback: (err: any) => void
	): void,
