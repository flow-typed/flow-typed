/**
 * Flowtype definitions for jquery.fancytree
...
declare interface Fancytree$Fancytree {
    $div: JQuery,
         ...
         * @returns  activate node (null, if not found)
        */
        activateKey(key: string): Fancytree$FancytreeNode,
         ...
         */
        findNextNode(match: string, startNode?: Fancytree$FancytreeNode): Fancytree$FancytreeNode,
        ...
        findNextNode(
            ...
            startNode?: Fancytree$FancytreeNode): Fancytree$FancytreeNode,
         ...
         */
        getNodeByKey(key: string, searchRoot?: Fancytree$FancytreeNode): Fancytree$FancytreeNode,

        /**
         * [ext-clones] Return all nodes with a given refKey (null if not found).
         * @param rootNode optionally restrict results to descendants of this node.
         */
        getNodesByRef(refKey: string, rootNode?: Fancytree$FancytreeNode): Fancytree$FancytreeNode[],
        ...
        loadKeyPath(
            keyPathList: string[],
            callback: (node: Fancytree$FancytreeNode, status: string) => void): JQueryPromise<any>,
         ...
         */
        toDict(includeRoot?: boolean, callback?: (node: Fancytree$FancytreeNode) => void): any,
...
declare interface Fancytree$FancytreeNode {
    ...
    tree: Fancytree$Fancytree,
        ...
        addChildren(
            ...
            insertBefore?: Fancytree$FancytreeNode): Fancytree$FancytreeNode,
         ...
         * @returns  The first child added.
         */
        addChildren(children: Fancytree$NodeData[], insertBefore?: string): Fancytree$FancytreeNode,
         ...
         * @returns  The first child added.
         */
        addChildren(children: Fancytree$NodeData[], insertBefore?: number): Fancytree$FancytreeNode,
         ...
         * @returns  The child added.
         */
        addChildren(child: Fancytree$NodeData, insertBefore?: string): Fancytree$FancytreeNode,
         ...
         * @returns  The child added.
         */
        addChildren(child: Fancytree$NodeData, insertBefore?: number): Fancytree$FancytreeNode,
        ...
        copyTo(
            ...
            mode?: string,
            map?: (node: Fancytree$NodeData) => void): Fancytree$FancytreeNode,
         ...
         */
        findAll(match: (node: Fancytree$FancytreeNode) => boolean): Fancytree$FancytreeNode[],
         ...
         * @param match a function that returns `true` if a node is matched.
         */
        findFirst(match: (node: Fancytree$FancytreeNode) => boolean): Fancytree$FancytreeNode,
         ...
         */
        getParentList(includeRoot: boolean, includeSelf: boolean): Fancytree$FancytreeNode[],
        ...
        */
        moveTo(
            ...
            mode: string,
            map?: (node: Fancytree$FancytreeNode) => void): void,
         ...
         * @param options : null, effects: ..., parent: ...} this node will remain visible in any case, even if `this` is outside the scroll pane.
         */
        ...
        toDict(
            recursive?: boolean,
            callback?: (dict: Fancytree$NodeData) => void): Fancytree$NodeData,
        ...
        */
        visit(fn: (node: Fancytree$FancytreeNode) => any, includeSelf?: boolean): boolean,
        ...
        */
        visitAndLoad(
            ...
            includeSelf?: boolean): JQueryPromise<any>,
         ...
         * @param includeSelf (default=false)
        */
        visitParents(fn: (node: Fancytree$FancytreeNode) => any, includeSelf?: boolean): boolean,
...
declare interface Fancytree$FancytreeEvents {
    ...
    activate(event: JQueryEventObject, data: Fancytree$EventData): void,
         ...
         */
        beforeActivate(event: JQueryEventObject, data: Fancytree$EventData): boolean,

        /**
         * Return `false` to prevent default processing 
         */
        beforeExpand(event: JQueryEventObject, data: Fancytree$EventData): boolean,

        /**
         * Return `false` to prevent default processing 
         */
        beforeSelect(event: JQueryEventObject, data: Fancytree$EventData): boolean,
         ...
         */
        loadChildren(event: JQueryEventObject, data: Fancytree$EventData): void,

        /**
         * A load error occured. Return `false` to prevent default processing. 
         */
        loadError(event: JQueryEventObject, data: Fancytree$EventData): boolean,
