/**
 * Flowtype definitions for urbanairship-cordova
...
declare interface UrbanAirshipPlugin$UrbanAirshipStatic {
    ...
    notificationType: {
        ...
        */
        ...
        runAction(
            actionName: string,
            actionValue: string,
            callback: (result: UrbanAirshipPlugin$RunActionResult) => void): void,
 ...
 */
declare interface UrbanAirshipPlugin$EditNamedUserTagGroupsApi {
    ...
    addTags: (
            tagGroup: string,
            tags: string[]) => UrbanAirshipPlugin$EditNamedUserTagGroupsApi,
 ...
 */
declare interface UrbanAirshipPlugin$EditChannelTagGroupsApi {
     ...
     * @returns  The chainable API instance.
     */
    addTags: (tagGroup: string, tags: string[]) => UrbanAirshipPlugin$EditChannelTagGroupsApi,
         ...
         * @returns  The chainable API instance.
         */
        removeTags: (tagGroup: string, tags: string[]) => UrbanAirshipPlugin$EditChannelTagGroupsApi,
...
declare type UrbanAirshipPlugin$PushEvent = {
    message: string,
    extras: {
        [key: string]: any
    }
...
declare type UrbanAirshipPlugin$RegistrationEvent = {
    error: string,
...
*/
declare interface UrbanAirshipPlugin$QuietTimeTimeSpan {
    startHour: number,
        startMinute: number,
        endHour: number,
        endMinute: number
 ...
 */
declare interface UrbanAirshipPlugin$RunActionResult {
    error: string,
        value: any
}
