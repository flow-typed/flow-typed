...
declare
var currentInstance: CKEDITOR$editor;

declare
var document: dom$document;

declare
var env: CKEDITOR$environmentConfig;

declare
var instances: CKEDITOR$editor[];
...
declare
function CKEDITOR$add(editor: CKEDITOR$editor): void

declare
function CKEDITOR$addCss(css: string): void

declare
function CKEDITOR$addTemplate(name: string, source: string): CKEDITOR$template

declare
function CKEDITOR$appendTo(element: string, config?: CKEDITOR$config, data?: string): CKEDITOR$editor

declare
function CKEDITOR$domReady(): void

declare
function CKEDITOR$dialogCommand(dialogName: string): void

declare
function CKEDITOR$editorConfig(config: CKEDITOR$config): void

declare
function CKEDITOR$getCss(): string

declare
function CKEDITOR$getTemplate(name: string): CKEDITOR$template

declare
function CKEDITOR$getUrl(resource: string): string

declare
function CKEDITOR$inline(element: string, instanceConfig?: CKEDITOR$config): CKEDITOR$editor

declare
function CKEDITOR$inlineAll(): void

declare
function CKEDITOR$loadFullCore(): void
...
declare
function CKEDITOR$replaceAll(className?: string): void
...
declare
var npm$namespace$ajax: {
    load: typeof ajax$load,
    loadXml: typeof ajax$loadXml,
}
declare
function ajax$load(url: string, callback?: Function): string

declare
function ajax$loadXml(url: string, callback?: Function): CKEDITOR$xml
...
declare
function link$getEditorAnchors(editor: CKEDITOR$editor): dom$element[]

declare
function link$getSelectedLink(editor: CKEDITOR$editor): dom$elementPath

declare
function link$tryRestoreFakeAnchor(editor: CKEDITOR$editor, element: dom$element): dom$element
...
declare
function plugins$add(editor: CKEDITOR$editor): void

declare
function plugins$addExternal(name: string, path: string, fileName: string): void

declare
function plugins$get(name: string): any

declare
function plugins$getFilePath(name: string): string

declare
function plugins$getPath(name: string): string

declare
function plugins$load(url: string, callback?: Function): string

declare
function plugins$setLang(pluginName: string, languageCode: string, languageEntries: any): void
...
declare
function dialog$add(editor: CKEDITOR$editor): void

declare
function dialog$addIframe(
    name: string,
    title: string,
    minWidth: number,
    minHeight: number,
...
declare
function dialog$addUIElement(typeName: string, builder: Function): void

declare
function dialog$cancelButton(): void

declare
function dialog$exists(name: string | number): void

declare
function dialog$getCurrent(): void

declare
function dialog$isTabEnabled(editor: CKEDITOR$editor, dialogName: string, tabName: string): boolean

declare
function dialog$okButton(): void
...
declare
function tools$enableHtml5Elements(doc: Object, withAppend?: Boolean): void


declare
var npm$namespace$lang: {
...
declare
function lang$load(url: string, callback?: Function): string

declare
function lang$detect(defaultLanguage: string, probeLanguage: string): string