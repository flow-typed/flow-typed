...
declare
export function Sammy$Cache(app: << UNKNOWN PARAM FORMAT >> , options: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$DataCacheProxy(initial: << UNKNOWN PARAM FORMAT >> , $element: << UNKNOWN PARAM FORMAT >> ): void

declare
export var DataLocationProxy: Sammy$DataLocationProxy;

declare
export function Sammy$DefaultLocationProxy(
    app: << UNKNOWN PARAM FORMAT >> ,
    run_interval_every: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$EJS(app: << UNKNOWN PARAM FORMAT >> , method_alias: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Exceptional(app: << UNKNOWN PARAM FORMAT >> , errorReporter: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Flash(app: << UNKNOWN PARAM FORMAT >> ): void

declare
export var FormBuilder: Sammy$FormBuilder;

declare
export function Sammy$Form(app: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Haml(app: << UNKNOWN PARAM FORMAT >> , method_alias: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Handlebars(app: << UNKNOWN PARAM FORMAT >> , method_alias: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Hogan(app: << UNKNOWN PARAM FORMAT >> , method_alias: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Hoptoad(app: << UNKNOWN PARAM FORMAT >> , errorReporter: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$JSON(app: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Meld(app: << UNKNOWN PARAM FORMAT >> , method_alias: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$MemoryCacheProxy(initial: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Mustache(app: << UNKNOWN PARAM FORMAT >> , method_alias: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$NestedParams(app: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$OAuth2(app: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$PathLocationProxy(app: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Pure(app: << UNKNOWN PARAM FORMAT >> , method_alias: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$PushLocationProxy(app: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Session(app: << UNKNOWN PARAM FORMAT >> , options: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Storage(app: << UNKNOWN PARAM FORMAT >> ): void

declare
export var Store: Sammy$Store;

declare
export function Sammy$Title(): void

declare
export function Sammy$Template(app: << UNKNOWN PARAM FORMAT >> , method_alias: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$Tmpl(app: << UNKNOWN PARAM FORMAT >> , method_alias: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$addLogger(logger: << UNKNOWN PARAM FORMAT >> ): void

declare
export function Sammy$log(...args: any[]): void
...
declare
export type Sammy$EventContext = {
    new(
        app: << UNKNOWN PARAM FORMAT >> ,
...
declare
export interface Sammy$GoogleAnalytics {
