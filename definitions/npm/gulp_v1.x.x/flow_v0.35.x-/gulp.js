...
declare module 'gulp' {
    ...
    declare interface gulp$GulpPlugin {
        (...args: any[]): NodeJS.ReadWriteStream
    }

    declare interface gulp$WatchMethod {
         ...
         * @param fn a callback or array of callbacks to be called on each change, or names of task(s) to run when a file changes, added with task().
         */
        (glob: string | string[], fn: (gulp$WatchCallback | string)): NodeJS.EventEmitter,
             ...
             * @param fn a callback or array of callbacks to be called on each change, or names of task(s) to run when a file changes, added with task().
             */
            (glob: string | string[], opt: gulp$WatchOptions, fn: (gulp$WatchCallback | string)): NodeJS.EventEmitter,
    ...
    declare interface gulp$DestMethod {
         ...
         * @param opt 
         */
        (outFolder: string | ((file: VinylFile) => string), opt?: gulp$DestOptions): NodeJS.ReadWriteStream
    }

    declare interface gulp$SrcMethod {
         ...
         * @param opt Options to pass to node-glob through glob-stream.
         */
        (glob: string | string[], opt?: gulp$SrcOptions): NodeJS.ReadWriteStream
    }
    ...
    */
    declare interface gulp$SrcOptions {
    ...
    declare interface gulp$DestOptions {
     ...
     */
    declare interface gulp$WatchOptions {
    ...
    declare interface gulp$WatchEvent {
     ...
     */
    declare interface gulp$WatchCallback {
        (event: gulp$WatchEvent): void
    }

    declare interface gulp$TaskCallback {
    ...
    declare module.exports: typeof gulp
}