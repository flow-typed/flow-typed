// @flow
/**
 * Flowtype definitions for asana
...
declare module 'asana' {
    ...
    declare interface asana$ClientStatic {
        ...
        */
         ...
         */
        create(options?: asana$ClientOptions): asana$Client
    }
     ...
     */
    declare type asana$ClientOptions = {
    ...
    declare interface asana$Client {
         ...
         * @returns  A promise that resolves to this client when
        ...
        */
        authorize(): Promise<asana$Client>,
            ...
            more features.
             * @param  The Asana Api Key of the user
             * @return  this
             * @param apiKey 
             * @return  
            */
             ...
             * @param  The Personal Access Token to use for
            ...
            */
             ...
             * @param  Options for Oauth. Includes any options for
            the selected flow.
    ...
    */
    ...
    declare interface auth$App {
        ...
        /**
         * 
         * @param  Overrides to the app's defaults
         * @option  {String} asanaBaseUrl
         * @option  {String} redirectUri
         * @returns  The URL used to authorize a user for the app.
         * @param options 
         * @return  
         */
        asanaAuthorizeUrl(options?: auth$AsanaAuthorizeUrlOptions): string,
             ...
             * @option  {String} asanaBaseUrl
             * @option  {String} redirectUri
             * @returns  The URL used to acquire an access token.
             * @param options 
             * @return  
             */
            ...
            */
            accessTokenFromCode(
                code: string,
                options?: auth$AsanaAuthorizeUrlOptions): Promise<auth$Credentials>,

            /**
             * 
             * @param  A refresh token obtained via Oauth.
             * @param  Overrides to the app's defaults
             * @option  {String} asanaBaseUrl
             * @option  {String} redirectUri
             * @return  The token, which will include the `access_token`
    ...
    */
    declare type resources$Attachments = {
        ...
        findById(
            ...
            dispatchOptions?: any): Promise<Attachments$Type>,
        ...
        findByTask(
            ...
            dispatchOptions?: any): Promise<resources$ResourceList<Attachments$Type >>
    } & resources$Resource
    ...
    */
    declare type resources$Projects = {
        ...
        create(
            ...
            dispatchOptions?: any): Promise<Projects$Type>,
        ...
        findAll(
            ...
            dispatchOptions?: any): Promise<resources$ResourceList<Projects$Type >> ,
        ...
        sections(
            project: number,
            params?: resources$PaginationParams,
            dispatchOptions?: any): Promise<resources$ResourceList<Tasks$Type >> ,
    ...
    */
    declare type resources$Stories = {
        ...
        findByTask(
            task: number,
            params?: resources$PaginationParams,
            dispatchOptions?: any): Promise<resources$ResourceList<Stories$Type >> ,
        ...
        findById(
            story: number,
            params?: resources$Params,
            dispatchOptions?: any): Promise<Stories$Type>,
        ...
        createOnTask(
            task: number,
            data: any,
            dispatchOptions?: any): Promise<resources$ResourceList<Stories$ShortType >>
    } & resources$Resource
    ...
    */
    declare type resources$Tags = {
        ...
        create(
            ...
            dispatchOptions?: any): Promise<Tags$Type>,
        ...
        findAll(
            ...
            dispatchOptions?: any): Promise<resources$ResourceList<Tags$Type >> ,
    ...
    */
    declare type resources$Tasks = {
        ...
        create(
            ...
            dispatchOptions?: any): Promise<Tasks$Type>,
    ...
    declare type resources$Teams = {
        ...
        findById(
            team: number,
            params?: resources$Params,
            dispatchOptions?: any): Promise<Teams$Type>,
        ...
        findByOrganization(
            organization: number,
            params?: resources$Params,
            dispatchOptions?: any): Promise<resources$SimpleResourceList>,
         ...
         * @return  
         */
        addUser(team: number, data: resources$UserParams, dispatchOptions?: any): Promise<any>,
         ...
         * @return  
         */
        removeUser(team: number, data: resources$UserParams, dispatchOptions?: any): Promise<any >
    } & resources$Resource
    ...
    */
    declare type resources$Users = {
        ...
        findById(
            user: string | number,
            params?: resources$Params,
            dispatchOptions?: any): Promise<Users$Type>,
        ...
        findByWorkspace(
            workspace: number,
            params?: resources$Params,
            dispatchOptions?: any): Promise<resources$ResourceList<Users$Type >> ,
    ...
    */
    declare class Webhooks mixins Resource {
        ...
        create(
            ...
            target: string,
            data: any,
            dispatchOptions?: any): Promise<any>;
    ...
    */
    declare type resources$Workspaces = {
        ...
        findById(
            workspace: number,
            params?: resources$Params,
            dispatchOptions?: any): Promise<Workspaces$Type>,
        ...
        findAll(
            params?: resources$PaginationParams,
            dispatchOptions?: any): Promise<resources$ResourceList<Workspaces$ShortType >> ,
