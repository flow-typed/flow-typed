/**
 * Flowtype definitions for umbraco-resources
...
declare module 'resources' {
    ...
    */
     ...
     * @description  * This Resource perfomrs actions to common authentication tasks for the Umbraco backoffice user
     * @requires  $q
     * @requires  $http
    ...
    declare interface IAuthResource {
         ...
         * @description  * Logs the Umbraco backoffice user in if the credentials are good
         ...
         * @param  Username of backoffice user
         * @param  Password of backoffice user
         * @returns  resourcePromise object
        */
        performLogin(username: string, password: string): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.authResource
             * @description  * Logs out the Umbraco backoffice user
            ...
            */
             ...
             * @methodOf  umbraco.resources.authResource
             * @description  * Sends a request to the server to get the current user details, will return a 401 if the user is not logged in
            ...
            */
             ...
             * @methodOf  umbraco.resources.authResource
             * @description  * Checks if the user is logged in or not - does not return 401 or 403
            ...
            */
             ...
             * @methodOf  umbraco.resources.authResource
             * @description  * Gets the user's remaining seconds before their login times out
    ...
    */
    declare interface IContentResource {
         ...
         * @description  * Sorts all children below a given parent node id, based on a collection of node-ids
         ...
         * @param  .sortedIds array of node IDs as they should be sorted
         * @returns  resourcePromise object.
        */
        sort(...args: any[]): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Moves a node underneath a new parentId
             ...
             * @param  .parentId the ID of the parent node to move to
             * @returns  resourcePromise object.
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Copies a node underneath a new parentId
             ...
             * @param  .parentId the ID of the parent node to copy to
             * @param  .relateToOriginal if true, relates the copy to the original through the relation api
             * @returns  resourcePromise object.
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Unpublishes a content item with a given Id
             ...
             * @param  the ID of the node to unpublish
             * @returns  resourcePromise object.
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Empties the content recycle bin
            ...
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Deletes a content item with a given id
             ...
             * @param  id of content item to delete
             * @returns  resourcePromise object.
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Gets a content item with a given id
             ...
             * @param  id of content item to return
             * @returns  resourcePromise object containing the content item.
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Gets an array of content items, given a collection of ids
             ...
             * @param  ids of content items to return as an array
             * @returns  resourcePromise object containing the content items array.
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Returns a scaffold of an empty content item, given the id of the content item to place it underneath and the content type alias.
             ...
             * @param  id of content item to return
             * @param  contenttype alias to base the scaffold on
             * @returns  resourcePromise object containing the content scaffold.
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Returns a url, given a node ID
             ...
             * @param  Id of node to return the public url to
             * @returns  resourcePromise object containing the url.
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Gets children of a content item with a given id
             ...
             * @param  id of content item to return children of
             * @param  optional options object
             * @param  .pageSize if paging data, number of nodes per page, default = 0
             * @param  .pageNumber if paging data, current page index, default = 0
             * @param  .filter if provided, query will only return those with names matching the filter
             * @param  .orderDirection can be `Ascending` or `Descending` - Default: `Ascending`
             * @param  .orderBy property to order items by, default: `SortOrder`
             * @returns  resourcePromise object containing an array of content items.
            */
            getChildren(
                parentId: number,
                options?: {
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Returns true/false given a permission char to check against a nodeID
             ...
             * @param  char representing the permission to check
             * @param  id of content item to delete
             * @returns  resourcePromise object.
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Saves changes made to a content item to its current version, if the content item is new, the isNew paramater must be passed to force creation
             ...
             * @param  The content item object with changes applied
             * @param  set to true to create a new item or to update an existing
             * @param  collection of files for the document
             * @returns  resourcePromise object containing the saved content item.
            */
            save(
                content: IContentResource,
                isNew: boolean,
                files: any[]): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Saves and publishes changes made to a content item to a new version, if the content item is new, the isNew paramater must be passed to force creation
            if the content item needs to have files attached, they must be provided as the files param and passed seperately
            ...
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Saves changes made to a content item, and notifies any subscribers about a pending publication
            ...
            */
             ...
             * @methodOf  umbraco.resources.contentResource
             * @description  * Publishes a content item with a given ID
             ...
             * @param  The ID of the conten to publish
             * @returns  resourcePromise object containing the published content item.
            */
    ...
    declare interface IContentTypeResource {
         ...
         * @description  * Returns a list of allowed content types underneath a content item with a given ID
         ...
         * @param  id of the content item to retrive allowed child types for
         * @returns  resourcePromise object.
        */
        getAllowedTypes(contentId: number): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.contentTypeResource
             * @description  * Returns a list of defined property type aliases
             * @returns  resourcePromise object.
             */
    ...
    declare interface ICurrentUserResource {
         ...
         * @description  * Changes the current users password
         * @returns  resourcePromise object containing the user array.
         */
        changePassword(changePasswordArgs: any): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.currentUserResource
             * @description  * Gets the configuration of the user membership provider which is used to configure the change password form
             */
    ...
    declare interface IDashboardResource {
         ...
         * @description  * Retrieves the dashboard configuration for a given section
         * @param  Alias of section to retrieve dashboard configuraton for
         * @returns  resourcePromise object containing the user array.
         */
    ...
    declare interface IDataTypeResource {
         ...
         * @description  * Retrieves available prevalues for a given data type + editor
         ...
         * @param  string alias of editor type to retrive prevalues configuration for
         * @param  id of datatype to retrieve prevalues for
         * @returns  resourcePromise object.
        */
        getPreValues(editorAlias: string, dataTypeId: number): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.dataTypeResource
             * @description  * Gets a data type item with a given id
             ...
             * @param  id of data type to retrieve
             * @returns  resourcePromise object.
            */
            getById(id: number): ng.IPromise<IResourcePromise>,
            getAll(): any,
             ...
             * @name  umbraco.resources.contentResource#getScaffold
             * @methodOf  umbraco.resources.contentResource
             * @description  * Returns a scaffold of an empty data type item
             ...
             * @returns  resourcePromise object containing the data type scaffold.
            */
             ...
             * @methodOf  umbraco.resources.dataTypeResource
             * @description  * Deletes a data type with a given id
            ...
            */
             ...
             * @methodOf  umbraco.resources.dataTypeResource
             * @description  * Saves or update a data type
             * @param  data type object to create/update
             * @param  collection of prevalues on the datatype
             * @param  set to true if type should be create instead of updated
             * @returns  resourcePromise object.
             */
            save(
                dataType: Object,
                preValues: any[],
                isNew: boolean): ng.IPromise<IResourcePromise >
    }
    ...
    */
    declare interface IEntityResource {
         ...
         * @description  * Returns a path, given a node ID and type
        ...
        */
        getPath(id: number, type: string): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.entityResource
             * @description  * Gets an entity with a given id
             ...
             * @param  id of entity to return
             * @param  Object type name
             * @returns  resourcePromise object containing the entity.
            */
            getById(id: number, type: string): ng.IPromise<IResourcePromise>,
            getByQuery(
                query: string,
                nodeContextId: number | string,
                type: string): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.entityResource
             * @description  * Gets an array of entities, given a collection of ids
             ...
             * @param  ids of entities to return as an array
             * @param  type name
             * @returns  resourcePromise object containing the entity array.
            */
             ...
             * @param  Object type name
             * @param  optional filter expression which will execute a dynamic where clause on the server
             * @param  optional parameters for the postFilter expression
             * @returns  resourcePromise object containing the entity.
            */
            getAll(
                type: string,
                postFilter: string,
                postFilterParams: string): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.entityResource
             * @description  * Gets ancestor entities for a given item
             * @param  Object type name
             * @returns  resourcePromise object containing the entity.
             */
             ...
             * @name  umbraco.resources.entityResource#getAncestors
             * @methodOf  umbraco.resources.entityResource
             * @description  * Gets children entities for a given item
             * @param  Object type name
             * @returns  resourcePromise object containing the entity.
             */
             ...
             * @methodOf  umbraco.resources.entityResource
             * @description  * Gets an array of entities, given a lucene query and a type
             ...
             * @param  search query
             * @param  type of conten to search
             * @returns  resourcePromise object containing the entity array.
            */
            search(
                query: string,
                type: string,
                searchFrom: any,
                canceler: any): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.entityResource
             * @description  * Gets an array of entities from all available search indexes, given a lucene query
    ...
    declare interface ILogResource {
         ...
         * @description  * Gets the log history for a give entity id
         ...
         * @param  id of entity to return log history
         * @returns  resourcePromise object containing the log.
        */
        getEntityLog(id: number): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.logResource
             * @description  * Gets the current users' log history for a given type of log entry
             ...
             * @param  logtype to query for
             * @param  query the log back to this date, by defalt 7 days ago
             * @returns  resourcePromise object containing the log.
            */
             ...
             * @methodOf  umbraco.resources.logResource
             * @description  * Gets the log history for a given type of log entry
    ...
    declare interface IMacroResource {
         ...
         * @description  * Gets the editable macro parameters for the specified macro alias
         * @param  The macro id to get parameters for
         */
        getMacroParameters(macroId: number): any,
             ...
             * @methodOf  umbraco.resources.macroResource
             * @description  * Gets the result of a macro as html to display in the rich text editor
             * @param  The macro id to get parameters for
             * @param  The current page id
             * @param  A dictionary of macro parameters
             */
    ...
    declare interface IMediaResource {
        ...
        */
        sort(...args: any[]): ng.IPromise<IResourcePromise>,
             ...
             * @param  arguments object
             * @param  .idd the ID of the node to move
             * @param  .parentId the ID of the parent node to move to
             * @returns  resourcePromise object.
            */
            move(...args: any[]): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.mediaResource
             * @description  * Gets a media item with a given id
             ...
             * @param  id of media item to return
             * @returns  resourcePromise object containing the media item.
            */
            getById(id: number): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.mediaResource
             * @description  * Deletes a media item with a given id
             ...
             * @param  id of media item to delete
             * @returns  resourcePromise object.
            */
            deleteById(id: number): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.mediaResource
             * @description  * Gets an array of media items, given a collection of ids
             ...
             * @param  ids of media items to return as an array
             * @returns  resourcePromise object containing the media items array.
            */
            getByIds(ids: number[]): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.mediaResource
             * @description  * Returns a scaffold of an empty media item, given the id of the media item to place it underneath and the media type alias.
             ...
             * @param  id of media item to return
             * @param  mediatype alias to base the scaffold on
             * @returns  resourcePromise object containing the media scaffold.
            */
            getScaffold(parentId: number, alias: string): ng.IPromise<IResourcePromise>,
            rootMedia(): any,
             ...
             * @methodOf  umbraco.resources.mediaResource
             * @description  * Gets children of a media item with a given id
            ...
            */
             ...
             * @methodOf  umbraco.resources.mediaResource
             * @description  * Saves changes made to a media item, if the media item is new, the isNew paramater must be passed to force creation
             ...
             * @param  The media item object with changes applied
             * @param  set to true to create a new item or to update an existing
             * @param  collection of files for the media item
             * @returns  resourcePromise object containing the saved media item.
            */
             ...
             * @methodOf  umbraco.resources.mediaResource
             * @description  * Shorthand for adding a media item of the type "Folder" under a given parent ID
             ...
             * @param  Id of the media item to create the folder underneath
             * @returns  resourcePromise object.
            */
    ...
    declare interface IMediaTypeResource {
         ...
         * @description  * Returns a list of allowed media types underneath a media item with a given ID
         ...
         * @param  id of the media item to retrive allowed child types for
         * @returns  resourcePromise object.
        */
    ...
    declare interface IMemberResource {
        getPagedResults(memberTypeAlias: string, options: any): any,
             ...
             * @description  * Gets a member item with a given key
             ...
             * @param  key of member item to return
             * @returns  resourcePromise object containing the member item.
            */
             ...
             * @methodOf  umbraco.resources.memberResource
             * @description  * Deletes a member item with a given key
             ...
             * @param  id of member item to delete
             * @returns  resourcePromise object.
            */
             ...
             * @methodOf  umbraco.resources.memberResource
             * @description  * Returns a scaffold of an empty member item, given the id of the member item to place it underneath and the member type alias.
             ...
             * @param  membertype alias to base the scaffold on
             * @returns  resourcePromise object containing the member scaffold.
            */
             ...
             * @methodOf  umbraco.resources.memberResource
             * @description  * Saves changes made to a member, if the member is new, the isNew paramater must be passed to force creation
             ...
             * @param  The member item object with changes applied
             * @param  set to true to create a new item or to update an existing
             * @param  collection of files for the media item
             * @returns  resourcePromise object containing the saved media item.
            */
    ...
    declare interface IPackageResource {
         ...
         * @description  * Downloads a package file from our.umbraco.org to the website server.
        ...
        */
        fetch(id: string): string,
             ...
             * @methodOf  umbraco.resources.packageInstallResource
             * @description  * Creates a package manifest for a given folder of files.
             ...
             * @param  the path to the temporary folder containing files
             * @returns  the ID assigned to the saved package manifest
            */
    ...
    declare interface IStylesheetResource {
         ...
         * @description  * Gets all registered stylesheets
         ...
         * @returns  resourcePromise object containing the stylesheets.
        */
        getAll(): ng.IPromise<IResourcePromise>,
             ...
             * @methodOf  umbraco.resources.stylesheetResource
             * @description  * Returns all defined child rules for a stylesheet with a given ID
             ...
             * @returns  resourcePromise object containing the rules.
            */
             ...
             * @methodOf  umbraco.resources.stylesheetResource
             * @description  * Returns all defined child rules for a stylesheet with a given name
