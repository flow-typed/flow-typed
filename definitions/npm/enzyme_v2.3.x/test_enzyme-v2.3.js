...
class MyComponent extends React.Component<void, MyComponentProps, MyComponentState> {
...
function ShallowWrapperTest() {
  let shallowWrapper: ShallowWrapper<MyComponentProps, MyComponentState> =
    shallow(<MyComponent stringProp="value"/>);
  ...
  let elementWrapper: ShallowWrapper<$react$HTMLAttributes, {}>;
  let statelessWrapper: ShallowWrapper<StatelessProps, any>;
  ...
  function test_dive() {
    ...
    const diveWrapper: ShallowWrapper<TmpProps, TmpState> = shallowWrapper.dive({ context: { foobar: 'barfoo' } });
  }
  ...
  function test_childAt() {
    ...
    const childWrapper2: ShallowWrapper<TmpType1, TmpType2> = shallowWrapper.childAt(0);
  }
  ...
  function test_state() {
    ...
    const prop2: number = shallowWrapper.state('key');
  ...
  function test_props() {
    ...
    const props4: $react$HTMLAttributes = shallowWrapper.find('.selector').props();
  }

  function test_prop() {
    const tmp: number = shallowWrapper.prop('numberProp');
    const tmp2: string = shallowWrapper.prop('key');
  ...
  function test_instance() {
    const myComponent: ReactComponent<MyComponentProps, MyComponentState> = shallowWrapper.instance();
  }
  ...
  function test_type() {
    type WrapperType =
      | string
      | ReactStatelessComponent<MyComponentProps>
      | ReactComponentClass<MyComponentProps, MyComponentState>;
    const type: WrapperType = shallowWrapper.type();
  }
...
function ReactWrapperTest() {
  let reactWrapper: ReactWrapper<MyComponentProps, MyComponentState> =
    mount(<MyComponent stringProp="value" />);

  let reactElement: React$Element<any>;
  let reactElements: Array<React$Element<any>>;
  let domElement: Element;
  let boolVal: boolean;
  let stringVal: string;
  let elementWrapper: ReactWrapper<$react$HTMLAttributes, {}>;
  let statelessWrapper: ReactWrapper<StatelessProps, any>;
  ...
  function test_ref() {
    ...
    const tmp: ReactWrapper<TmpType1, TmpType2> = reactWrapper.ref('refName');
  }
  ...
  function test_childAt() {
    ...
    const childWrapper2: ReactWrapper<TmpType1, TmpType2> = reactWrapper.childAt(0);
  }
  ...
  function test_state() {
    ...
    const prop2: number = reactWrapper.state('key');
  ...
  function test_props() {
    ...
    const props4: $react$HTMLAttributes = reactWrapper.find('.selector').props();
  }

  function test_prop() {
    const tmp: number = reactWrapper.prop('numberProp');
    const tmp2: string = reactWrapper.prop('key');
  ...
  function test_instance() {
    const myComponent: ReactComponent<MyComponentProps, MyComponentState> = reactWrapper.instance();
  }
  ...
  function test_type() {
    type WrapperType =
      ...
      | ReactStatelessComponent<MyComponentProps>
      | ReactComponentClass<MyComponentProps, MyComponentState>;
    const type: WrapperType = reactWrapper.type();
  }
