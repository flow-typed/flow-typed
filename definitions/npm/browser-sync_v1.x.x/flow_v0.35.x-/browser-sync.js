// @flow
/**
 * Flowtype definitions for browser-sync
...
declare module 'browser-sync' {
    ...
    declare interface browserSync$Options {
        ...
        */
        ui?: browserSync$UIOptions | boolean,
            ...
            Default: false
            */
            files?: string | (string | browserSync$FileCallback)[],
            ...
            */
             ...
             * Default: false
             */
            server?: browserSync$ServerOptions,
            ...
            */
            proxy?: string | boolean | browserSync$ProxyOptions,
            ...
            */
            ...
            middleware?: browserSync$MiddlewareHandler | browserSync$PerRouteMiddleware | (browserSync$MiddlewareHandler | browserSync$PerRouteMiddleware)[]
    }
    ...
    declare interface browserSync$ServerOptions {
        ...
        baseDir?: string | string[],
             ...
             */
            middleware?: (browserSync$MiddlewareHandler | browserSync$PerRouteMiddleware)[]
    }
    ...
    declare interface browserSync$ProxyOptions {
        target?: string,
            ...
            ws: boolean,
            reqHeaders: (config: any) => browserSync$Hash<any>,
    ...
    declare type browserSync$BrowserSyncStatic = {
         ...
         */
        (config?: browserSync$Options, callback?: (err: Error, bs: Object) => any): browserSync$BrowserSyncInstance,

        /**
         * Create a Browsersync instance
         * @param name an identifier that can used for retrieval later
         */
        create(name?: string): browserSync$BrowserSyncInstance,
    ...
    declare interface browserSync$BrowserSyncInstance {
        ...
        name: string,
            ...
            init(
                ...
                callback?: (err: Error, bs: Object) => any): browserSync$BrowserSyncInstance,
            ...
            */
            ...
            watch(
                ...
                fn?: (event: string, file: fs.Stats) => any): NodeJS.EventEmitter,
    ...
    declare     var browserSync: browserSync$BrowserSyncStatic;
