/**
 * Flowtype definitions for blissfuljs
...
declare interface BlissNS$BlissStatic {
    (selector: string, context?: Element): BlissNS$BlissDecoratedElement<T>,
        ...
        create<T>(tag: string): BlissNS$BlissDecoratedElement<T>,
        create<T>(options: Object): BlissNS$BlissDecoratedElement<T>,
        ...
        create<T>(tag: string, options: Object): BlissNS$BlissDecoratedElement<T>,
        create<T>(...args: any[]): BlissNS$BlissDecoratedElement<T>,
        set<T>(
            subject: BlissNS$BlissDecoratedElement<T>,
            options: Object): BlissNS$BlissDecoratedElement<T>,
        contents<T>(
            subject: BlissNS$BlissDecoratedElement<T>,
            elements: Object |
            Array<any >
            ...
            string |
            Number |
            Node): BlissNS$BlissDecoratedElement<T>,
        contents<T>(
            subject: BlissNS$BlissDecoratedElement<T>[],
            elements: Object |
            Array<any >
            ...
            Number |
            Node): BlissNS$BlissDecoratedElement<T>[],
        clone<T>(subject: BlissNS$BlissDecoratedElement<T>): BlissNS$BlissDecoratedElement<T>,
        after<T>(
            subject: BlissNS$BlissDecoratedElement<T>,
            element: Element): BlissNS$BlissDecoratedElement<T>,
        around<T>(
            subject: BlissNS$BlissDecoratedElement<T>,
            element: Element): BlissNS$BlissDecoratedElement<T>,
        attributes<T>(
            subject: BlissNS$BlissDecoratedElement<T>,
            attrs: Object): BlissNS$BlissDecoratedElement<T>,
        attributes<T>(
            subject: BlissNS$BlissDecoratedElement<T>[],
            attrs: Object): BlissNS$BlissDecoratedElement<T>[],
        before<T>(
        ...
        properties<T>(
            subject: BlissNS$BlissDecoratedElement<T>,
            props: Object): BlissNS$BlissDecoratedElement<T>,
        properties<T>(
            subject: BlissNS$BlissDecoratedElement<T>[],
            props: Object): BlissNS$BlissDecoratedElement<T>[],
        start<T>(
        ...
        style<T>(
            subject: BlissNS$BlissDecoratedElement<T>,
            properties: Object): BlissNS$BlissDecoratedElement<T>,
        style<T>(
            subject: BlissNS$BlissDecoratedElement<T>[],
            properties: Object): BlissNS$BlissDecoratedElement<T>[],
        transition<T>(
            subject: BlissNS$BlissDecoratedElement<T>| BlissNS$BlissDecoratedElement<T>[],
            properties: Object,
        ...
        delegate<T>(
            ...
            type: string,
            selector: string,
            callback: (event: Event) => void): BlissNS$BlissDecoratedElement<T>,
        delegate<T>(
            subject: BlissNS$BlissDecoratedElement<T>[],
            type: string,
            selector: string,
        ...
        delegate<T>(
            ...
            }): BlissNS$BlissDecoratedElement<T>,
        delegate<T>(
            subject: BlissNS$BlissDecoratedElement<T>[],
            type: string,
            selectorsToCallbacks: {
        ...
        events<T>(
            ...
            } | Element): BlissNS$BlissDecoratedElement<T>,
        events<T>(
            subject: BlissNS$BlissDecoratedElement<T>[],
            handlers: {
                [eventName: string]: (event: Event) => void
        ...
        remove(subject: Element | BlissNS$BlissStatic): void,
        ...
        each<T>(obj: {
            [propertyName: string]: any
        }, callback: Function, ret?: Object): T,
        each(obj: {
            [propertyName: string]: any
        }, callback: Function, ret?: Object): Object,
        extend(
            target: Object,
            source: any,
            whitelist?: string[] | string | Function | RegExp): Object,
        extend<T>(
            target: Object,
            source: any,
            whitelist?: string[] | string | Function | RegExp): T,
        ...
        add(
            name: string,
            callback: Function,
            on?: BlissNS$BlissStatic | BlissNS$BlissStaticCollection | Element | Array<any>): void,
        add(
            callbacks: {
        ...
        $: BlissNS$BlissStaticCollection
}

declare type BlissNS$BlissStaticCollection = {
    (selector: string, context?: Element): BlissNS$BlissDecoratedArrayElement<T>,
...
declare interface BlissNS$BlissNativeExtentions<T>{
    blur(): T,
    click(): T,
    ...
    addEventListener(
        ...
        listener: (ev: MSGestureEvent) => any,
        useCapture?: boolean): T,
    addEventListener(
    ...
    addEventListener(
        ...
        listener: (ev: MSPointerEvent) => any,
        useCapture?: boolean): T,
    addEventListener(
        type: "MSInertiaStart",
        listener: (ev: MSGestureEvent) => any,
    ...
    addEventListener(
        ...
        listener: (ev: MSManipulationEvent) => any,
        useCapture?: boolean): T,
    addEventListener(
    ...
    addEventListener(
        type: "mousewheel",
        listener: (ev: MouseWheelEvent) => any,
        useCapture?: boolean): T,
...
declare type BlissNS$BlissBindedElement<T>= {
    set(options: Object): BlissNS$BlissDecoratedElement<T>,
    contents(
        elements: Object |
        Array<any >
        |
        ...
        Number |
        Node): BlissNS$BlissDecoratedElement<T>,
    clone(): BlissNS$BlissDecoratedElement<T>,
    after(element: Element): BlissNS$BlissDecoratedElement<T>,
    around(element: Element): BlissNS$BlissDecoratedElement<T>,
    attributes(attrs: Object): BlissNS$BlissDecoratedElement<T>,
    before(element: Element): BlissNS$BlissDecoratedElement<T>,
    inside(element: Element): BlissNS$BlissDecoratedElement<T>,
    properties(props: Object): BlissNS$BlissDecoratedElement<T>,
    start(element: Element): BlissNS$BlissDecoratedElement<T>,
    style(properties: Object): BlissNS$BlissDecoratedElement<T>,
    ...
    remove(): BlissNS$BlissDecoratedElement<T >
} & BlissNS$BlissNativeExtentions


declare interface BlissNS$BlissBindedArray<T>{
    all(method: string, ...args: Array<any>): Array<any>,
    all<T>(method: string, ...args: Array<any>): Array<T >
}

declare interface BlissNS$BlissCollectionArray<T>{
    set(options: Object): BlissNS$BlissCollectionArray<T>,
    contents(
        elements: Object |
        Array<any >
        |
        string |
        Number |
        Node): BlissNS$BlissCollectionArray<T>,
    clone(): BlissNS$BlissCollectionArray<T>,
    after(element: Element): BlissNS$BlissCollectionArray<T>,
    around(element: Element): BlissNS$BlissCollectionArray<T>,
    attributes(attrs: Object): BlissNS$BlissCollectionArray<T>,
    before(element: Element): BlissNS$BlissCollectionArray<T>,
    inside(element: Element): BlissNS$BlissCollectionArray<T>,
    properties(props: Object): BlissNS$BlissCollectionArray<T>,
    start(element: Element): BlissNS$BlissCollectionArray<T>,
    style(properties: Object): BlissNS$BlissCollectionArray<T>,
    transition(properties: Object, duration?: number): Promise<T>[],
    delegate(
        type: string,
        selector: string,
        callback: (event: Event) => void): BlissNS$BlissCollectionArray<T>,
    delegate(
        type: string,
        selectorsToCallbacks: {
            [selector: string]: (event: Event) => void
    ...
    events(
        handlers: {
            [eventName: string]: (event: Event) => void
        } | Element): BlissNS$BlissCollectionArray<T>,
    fire(
        type: string,
        properties?: {
            [propertyName: string]: any
