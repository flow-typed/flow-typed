import type { BlissStatic, BlissStaticCollection } from 'npm$namespace$BlissNS'
...
declare module 'npm$namespace$BlissNS' {
	declare export type BlissDecoratedElement<T> = Element & T;

	declare export type BlissDecoratedArrayElement<T> = Array<T> & BlissNS.BlissCollectionArray<T>;

	declare interface BlissStatic {
		(selector: string, context?: Element): BlissDecoratedElement<T>,
		classProps: Object,
		...
		set<T>(
		subject: BlissDecoratedElement<T>, options: Object
	): BlissDecoratedElement<T>,
		contents<T>(
		subject: BlissDecoratedElement<T>, elements: Object | Array<any> | string | Number | Node
	): BlissDecoratedElement<T>,
		contents<T>(
		subject: BlissDecoratedElement<T>[], elements: Object | Array<any> | string | Number | Node
	): BlissDecoratedElement<T>[],
		...
		after<T>(
		subject: BlissDecoratedElement<T>, element: Element
	): BlissDecoratedElement<T>,
		around<T>(
		subject: BlissDecoratedElement<T>, element: Element
	): BlissDecoratedElement<T>,
		...
		attributes<T>(
		subject: BlissDecoratedElement<T>[], attrs: Object
	): BlissDecoratedElement<T>[],
		before<T>(
		subject: BlissDecoratedElement<T>, element: Element
	): BlissDecoratedElement<T>,
		...
		properties<T>(
		subject: BlissDecoratedElement<T>[], props: Object
	): BlissDecoratedElement<T>[],
		start<T>(
		subject: BlissDecoratedElement<T>, element: Element
	): BlissDecoratedElement<T>,
		style<T>(
		subject: BlissDecoratedElement<T>, properties: Object
	): BlissDecoratedElement<T>,
		style<T>(
		subject: BlissDecoratedElement<T>[], properties: Object
	): BlissDecoratedElement<T>[],
		transition<T>(
		subject: BlissDecoratedElement<T> | BlissDecoratedElement<T>[], properties: Object, duration?: number
	): Promise<T>,
		delegate<T>(
		subject: BlissDecoratedElement<T>, type: string, selector: string, callback: (event: Event) => void
	): BlissDecoratedElement<T>,
		delegate<T>(
		subject: BlissDecoratedElement<T>[], type: string, selector: string, callback: (event: Event) => void
	): BlissDecoratedElement<T>[],
		delegate<T>(
		subject: BlissDecoratedElement<T>, type: string, selectorsToCallbacks: {
		...
		delegate<T>(
		subject: BlissDecoratedElement<T>, typesToSelectorsToCallbacks: {
		[type: string]: {
		[selector: string]: (event: Event) => void
	}
	}
		...
		events<T>(
		subject: BlissDecoratedElement<T>, handlers: {
		...
		fire<T>(
		subject: BlissDecoratedElement<T>, type: string, properties?: {
		...
		extend(
		target: Object, source: any, whitelist?: string[] | string | Function | RegExp
	): Object,
		extend<T>(
		target: Object, source: any, whitelist?: string[] | string | Function | RegExp
	): T,
		...
		lazy(object: Object, properties: {
		[propertyName: string]: () => any
	}): Object,
		lazy<T>(object: Object, properties: {
		[propertyName: string]: () => any
	}): T,
		...
		[propertyName: string]: Object | Function
	}
	): Object,
		live<T>(
		object: Object, properties: {
		...
		add(
		name: string, callback: Function, on?: BlissStatic | BlissStaticCollection | Element | Array<any>
	): void,
		add(
		callbacks: {
		[callbackName: string]: Function
	}, on?: BlissStatic | BlissStaticCollection | Element | Array<any>
	): void,
		hooks: {
	...
	declare interface BlissStaticCollection {
		(selector: string, context?: Element): BlissDecoratedArrayElement<T>,
		(expr: Object, context?: Element): Array<T>,
		(expr: Window, context?: Element): [Window],
		(expr: Node, context?: Element): [Node]
	}

	declare interface BlissNativeExtentions<T> {
		blur(): T,
		click(): T,
		...
		addEventListener(
		type: "MSGestureChange", listener: (ev: MSGestureEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSGestureDoubleTap", listener: (ev: MSGestureEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSGestureEnd", listener: (ev: MSGestureEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSGestureHold", listener: (ev: MSGestureEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSGestureStart", listener: (ev: MSGestureEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSGestureTap", listener: (ev: MSGestureEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSGotPointerCapture", listener: (ev: MSPointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSInertiaStart", listener: (ev: MSGestureEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSLostPointerCapture", listener: (ev: MSPointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSManipulationStateChanged", listener: (ev: MSManipulationEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSPointerCancel", listener: (ev: MSPointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSPointerDown", listener: (ev: MSPointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSPointerEnter", listener: (ev: MSPointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSPointerLeave", listener: (ev: MSPointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSPointerMove", listener: (ev: MSPointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSPointerOut", listener: (ev: MSPointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSPointerOver", listener: (ev: MSPointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "MSPointerUp", listener: (ev: MSPointerEvent) => any, useCapture?: boolean
	): T,
		...
		addEventListener(
		type: "ariarequest", listener: (ev: AriaRequestEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "beforeactivate", listener: (ev: UIEvent) => any, useCapture?: boolean
	): T,
		...
		addEventListener(
		type: "beforedeactivate", listener: (ev: UIEvent) => any, useCapture?: boolean
	): T,
		...
		addEventListener(
		type: "contextmenu", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		...
		addEventListener(
		type: "gotpointercapture", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		...
		addEventListener(
		type: "keypress", listener: (ev: KeyboardEvent) => any, useCapture?: boolean
	): T,
		...
		addEventListener(
		type: "lostpointercapture", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		...
		addEventListener(
		type: "mousewheel", listener: (ev: MouseWheelEvent) => any, useCapture?: boolean
	): T,
		...
		addEventListener(
		type: "pointercancel", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "pointerdown", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "pointerenter", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "pointerleave", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "pointermove", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "pointerout", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "pointerover", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "pointerup", listener: (ev: PointerEvent) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "progress", listener: (ev: ProgressEvent) => any, useCapture?: boolean
	): T,
		...
		addEventListener(
		type: "touchcancel", listener: (ev: TouchEvent) => any, useCapture?: boolean
	): T,
		...
		addEventListener(
		type: "webkitfullscreenchange", listener: (ev: Event) => any, useCapture?: boolean
	): T,
		addEventListener(
		type: "webkitfullscreenerror", listener: (ev: Event) => any, useCapture?: boolean
	): T,
	...
	declare interface BlissBindedElement<T> {
		set(options: Object): BlissDecoratedElement<T>,
		contents(
		elements: Object | Array<any> | string | Number | Node
	): BlissDecoratedElement<T>,
		...
		delegate(
		type: string, selector: string, callback: (event: Event) => void
	): BlissDecoratedElement<T>,
		delegate(
		type: string, selectorsToCallbacks: {
		[selector: string]: (event: Event) => void
	}
	): BlissDecoratedElement<T>,
		delegate(
