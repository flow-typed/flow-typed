...
declare module 'casperjs' {
		declare interface CasperModule {
	...
	declare interface Casper {
		...
		thenOpen(
		location: string, options?: OpenSettings, then?: (response: HttpResponse) => void
	): Casper,
		...
		waitFor(
		testFx: Function, then?: Function, onTimeout?: Function, timeout?: number
	): Casper,
		waitForAlert(then: Function, onTimeout?: Function, timeout?: number): Casper,
		waitForPopup(
		urlPattern: string, then?: Function, onTimeout?: Function, timeout?: number
	): Casper,
		waitForPopup(
		urlPattern: RegExp, then?: Function, onTimeout?: Function, timeout?: number
	): Casper,
		...
		waitForSelector(
		selector: string, then?: Function, onTimeout?: Function, timeout?: number
	): Casper,
		waitWhileSelector(
		selector: string, then?: Function, onTimeout?: Function, timeout?: number
	): Casper,
		...
		waitForText(
		pattern: string, then?: Function, onTimeout?: Function, timeout?: number
	): Casper,
		waitForText(
		pattern: RegExp, then?: Function, onTimeout?: Function, timeout?: number
	): Casper,
		waitUntilVisible(
		selector: string, then?: Function, onTimeout?: Function, timeout?: number
	): Casper,
	...
	declare interface OpenSettings {
		method: string,
		data: any,
		headers: any
	}
	...
	declare interface CasperOptions {
		clientScripts?: any[],
		exitOnError?: boolean,
