/**
 * Flowtype definitions for turf-2.0
...
declare module 'turf' {
    ...
    declare function aggregate(
        ...
        points: GeoJSON.FeatureCollection<GeoJSON.Point>,
        field: string,
        outField: string): GeoJSON.FeatureCollection<GeoJSON.Polygon >
        ...
        polygons: GeoJSON.FeatureCollection<GeoJSON.Polygon>,
        points: GeoJSON.FeatureCollection<GeoJSON.Point>,
        countField: string): GeoJSON.FeatureCollection<GeoJSON.Polygon >
    ...
    declare function midpoint(
        ...
        feature: GeoJSON.Feature<any>| GeoJSON.FeatureCollection<any>,
        distance: number,
        units: string): GeoJSON.FeatureCollection<GeoJSON.Polygon>| GeoJSON.FeatureCollection<GeoJSON.MultiPolygon>| GeoJSON.Polygon | GeoJSON.MultiPolygon
    ...
    declare function concave(
        ...
        */
        ...
        poly1: GeoJSON.Feature<GeoJSON.Polygon>,
        poly2: GeoJSON.Feature<GeoJSON.Polygon>): GeoJSON.Feature<GeoJSON.Polygon | GeoJSON.MultiLineString>| typeof undefined
    ...
    declare function merge(
        fc: GeoJSON.FeatureCollection<GeoJSON.Polygon>): GeoJSON.Feature<GeoJSON.Polygon | GeoJSON.MultiPolygon >
    ...
    declare function union(
        ...
        features: GeoJSON.FeatureCollection<any>,
        key: string,
         ...
         * @param count How many geometries should be generated.
        ...
        */
        ...
        features: GeoJSON.FeatureCollection<any>,
        n: number): GeoJSON.FeatureCollection<any >
        ...
        bbox: Array<number>,
        cellWidth: number,
        units: string): GeoJSON.FeatureCollection<GeoJSON.Polygon >
    ...
    declare function pointGrid(
        extent: Array<number>,
        cellWidth: number,
        units: string): GeoJSON.FeatureCollection<GeoJSON.Point >
    ...
    declare function tag(
        ...
        polygons: GeoJSON.FeatureCollection<GeoJSON.Polygon>,
        polyId: string,
        containingPolyId: string): GeoJSON.FeatureCollection<GeoJSON.Point >
        ...
        input: GeoJSON.FeatureCollection<any>,
        field: string,
        numberOfBreaks: number): Array<number >
        ...
        input: GeoJSON.FeatureCollection<any>,
        field: string,
        percentiles: Array<number>): Array<number >
        ...
        inField: string,
        outField: string,
        translations: Array<any>): GeoJSON.FeatureCollection<any >
