...
declare class Bluebird$Promise<+R> extends Promise<R> {
  ...
  static PromiseInspection: Class<Bluebird$PromiseInspection<any>>;
  ...
  >;
  static props(
    input: Object | Map<any, any> | $Promisable<Object | Map<any, any>>
  ...
  spread<T>(...args: Array<T>): Bluebird$Promise<any>;

  reflect(): Bluebird$Promise<Bluebird$PromiseInspection<any>>;
  ...
  disposer(
    disposer: (value: R, promise: Promise<any>) => void
