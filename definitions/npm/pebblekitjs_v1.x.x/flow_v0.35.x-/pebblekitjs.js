// @flow
/**
 * Flowtype definitions for pebblekitjs
...
declare interface PebbleKit$Error {
    message: string
}

declare interface PebbleKit$Event {
    type: string,
        payload?: Object,
        response?: string
}

declare interface PebbleKit$Layout {
    icon: string,
 ...
 */
declare interface PebbleKit$AppGlanceSlice {
    expirationTime?: string,
        layout: PebbleKit$Layout
}

declare interface PebbleKit$AppMessageData {
    transactionId: string
}

declare interface PebbleKit$AppMessageEvent {
    data: PebbleKit$AppMessageData,
        error?: PebbleKit$Error
}
 ...
 */
declare interface PebbleKit$Firmware {
    major: number,
        minor: number,
        patch: number,
        suffix: string
...
*/
declare interface PebbleKit$WatchInfo {
    platform: string,
        model: string,
        language: string,
        firmware: PebbleKit$Firmware
}

declare interface PebbleKit$Pebble {
     ...
     */
    addEventListener(type: string, callback: (e: PebbleKit$Event) => void): void,
         ...
         * @param callback A developer-defined function to receive any events of the type specified that occur.
         */
        on(type: string, callback: (e: PebbleKit$Event) => void): void,
        ...
        */
        removeEventListener(type: string, callback?: (e: PebbleKit$Event) => void): void,
         ...
         * @see  addEventListener
        */
        off(type: string, callback?: (e: PebbleKit$Event) => void): void,
        ...
        */
        sendAppMessage(
            ...
            callbackForAck?: (e: PebbleKit$AppMessageEvent) => void,
            callbackForNack?: (e: PebbleKit$AppMessageEvent) => void): string,
        ...
        */
        timelineSubscribe(
            topic: string,
            successCb: () => void,
            errorCb: (errorString: string) => void): void,
         ...
         * @return  WatchInfo
         */
        getActiveWatchInfo(): PebbleKit$WatchInfo,
         ...
         */
        appGlanceReload(
            appGlanceSlices: PebbleKit$AppGlanceSlice[],
            onSuccess: (appGlanceSlices: PebbleKit$AppGlanceSlice[]) => void,
            onFailure: (appGlanceSlices: PebbleKit$AppGlanceSlice[]) => void): void,
