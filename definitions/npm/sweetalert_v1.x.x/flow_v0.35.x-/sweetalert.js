// @flow
/**
 * Flowtype definitions for sweetalert
...
declare type SweetAlert$AlertType = "warning" | "error" | "success" | "info";

declare type SweetAlert$PromtType = "input" | "prompt";

declare interface SweetAlert$SettingsBase {
...
declare type SweetAlert$AlertModalSettings = {
     ...
     * Default: null
     */
    type?: SweetAlert$AlertType
} & SweetAlert$SettingsBase


declare type SweetAlert$PromtModalSettings = {

    /**
     * The type of the modal. SweetAlert comes with 4 built-in types which will show a corresponding icon animation: "warning", "error", "success" and "info". You can also set it as "input" to get a prompt modal.
     * Default: null
     */
    type?: SweetAlert$PromtType,
...
declare interface SweetAlert$Settings {
...
declare interface SweetAlert$SetDefaultsSettings {
...
declare interface SweetAlert$SweetAlertStatic {
     ...
     */
    (title: string, text: string, type: SweetAlert$AlertType | SweetAlert$PromtType): void,

    /**
     * SweetAlert automatically centers itself on the page and looks great no matter if you're using a desktop computer, mobile or tablet. An awesome replacement for JavaScript's alert.
     * @param callback The callback from the users action. The value is true or false if the user confirms or cancels the alert.
     */
    (settings: SweetAlert$Settings & SweetAlert$AlertModalSettings, callback?: (isConfirm: boolean) => any): void,
     ...
     */
    (settings: SweetAlert$Settings & SweetAlert$PromtModalSettings, callback?: (isConfirmOrInputValue: boolean | string) => any): void,
     ...
     */
    setDefaults(
            settings: SweetAlert$SetDefaultsSettings & SweetAlert$AlertModalSettings & SweetAlert$PromtModalSettings): void,
