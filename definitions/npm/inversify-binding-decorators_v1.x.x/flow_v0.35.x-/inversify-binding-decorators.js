...
declare
var npm$namespace$inversifyBindingDecorators: {
...
declare
export type interfaces$ProvideInSyntax<T>= {
    inSingletonScope(): interfaces$ProvideWhenOnSyntax<T >
} & interfaces$ProvideDoneSyntax


declare
export interface interfaces$ProvideDoneSyntax<T>{
    done(): (target: any) => any
}

declare
export type interfaces$ProvideOnSyntax<T>= {
    onActivation(
...
declare
export type interfaces$ProvideInWhenOnSyntax<T>= {} & interfaces$ProvideInSyntax & interfaces$ProvideWhenSyntax & interfaces$ProvideOnSyntax


declare
export type interfaces$ProvideWhenOnSyntax<T>= {} & interfaces$ProvideWhenSyntax & interfaces$ProvideOnSyntax


declare
export type interfaces$ProvideWhenSyntax<T>= {
    when(
...
declare
export function inversifyBindingDecorators$autoProvide(kernel: undefined.Kernel, ...modules: any[]): void

declare
export function inversifyBindingDecorators$makeProvideDecorator(
    kernel: undefined.Kernel): (serviceIdentifier: undefined.ServiceIdentifier<any>) => (target: any) => any

declare
export function inversifyBindingDecorators$makeFluentProvideDecorator(
