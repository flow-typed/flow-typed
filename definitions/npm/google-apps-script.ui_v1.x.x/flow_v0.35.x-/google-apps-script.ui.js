...
declare module 'google-apps-script.ui' {
					
}

declare module 'UI' {
		declare export interface AbsolutePanel {
	...
	declare export interface CaptionPanel {
	...
	declare export interface CheckBox {
	...
	declare export interface ClientHandler {
	...
	declare export interface DateBox {
	...
	declare export interface DecoratedStackPanel {
	...
	declare export interface DecoratedTabBar {
	...
	declare export interface DecoratedTabPanel {
	...
	declare export interface DecoratorPanel {
	...
	declare export interface DialogBox {
	...
	declare export interface DocsListDialog {
	...
	declare export interface FileUpload {
	...
	declare export interface FlexTable {
	...
	declare export interface FlowPanel {
	...
	declare export interface FocusPanel {
	...
	declare export interface FormPanel {
	...
	declare export interface Hidden {
	...
	declare export interface HorizontalPanel {
	...
	declare export interface Image {
		...
		url: string, left: Integer, top: Integer, width: Integer, height: Integer
	): Image,
	...
	declare export interface InlineLabel {
	...
	declare export interface ListBox {
	...
	declare export interface MenuBar {
	...
	declare export interface MenuItemSeparator {
	...
	declare export interface PasswordTextBox {
	...
	declare export interface PopupPanel {
	...
	declare export interface PushButton {
	...
	declare export interface RadioButton {
	...
	declare export interface ResetButton {
	...
	declare export interface ScrollPanel {
	...
	declare export interface ServerHandler {
	...
	declare export interface SimpleCheckBox {
	...
	declare export interface SimplePanel {
	...
	declare export interface SimpleRadioButton {
	...
	declare export interface SplitLayoutPanel {
	...
	declare export interface StackPanel {
	...
	declare export interface SubmitButton {
	...
	declare export interface SuggestBox {
	...
	declare export interface TabBar {
	...
	declare export interface TabPanel {
	...
	declare export interface ToggleButton {
	...
	declare export interface UiApp {
	...
	declare export interface UiInstance {
	...
	declare export interface VerticalPanel {
