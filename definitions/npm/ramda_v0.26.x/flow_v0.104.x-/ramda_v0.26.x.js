...
declare module ramda {
  ...
  > = ((...r: [AA]) => CurriedFunction4<BB, CC, DD, EE, R>) &
    ((
      ...r: [$npm$ramda$Placeholder, BB]
    ) => CurriedFunction4<AA, CC, DD, EE, R>) &
    ((...r: [AA, BB]) => CurriedFunction3<CC, DD, EE, R>) &
    ((
      ...r: [$npm$ramda$Placeholder, BB, CC]
    ) => CurriedFunction3<AA, DD, EE, R>) &
    ((
      ...r: [AA, $npm$ramda$Placeholder, CC]
    ) => CurriedFunction3<BB, DD, EE, R>) &
    ((...r: [AA, BB, CC]) => CurriedFunction2<DD, EE, R>) &
    ((
      ...r: [$npm$ramda$Placeholder, BB, CC, DD]
    ) => CurriedFunction2<AA, EE, R>) &
    ((
      ...r: [AA, $npm$ramda$Placeholder, CC, DD]
    ) => CurriedFunction2<BB, EE, R>) &
    ((
      ...r: [AA, BB, $npm$ramda$Placeholder, DD]
    ) => CurriedFunction2<CC, EE, R>) &
    ((...r: [AA, BB, CC, DD]) => CurriedFunction1<EE, R>) &
    ((
      ...r: [$npm$ramda$Placeholder, BB, CC, DD, EE]
    ) => CurriedFunction1<AA, R>) &
    ((
      ...r: [AA, $npm$ramda$Placeholder, CC, DD, EE]
    ) => CurriedFunction1<BB, R>) &
    ((
      ...r: [AA, BB, $npm$ramda$Placeholder, DD, EE]
    ) => CurriedFunction1<CC, R>) &
    ((
      ...r: [AA, BB, CC, $npm$ramda$Placeholder, EE]
    ) => CurriedFunction1<DD, R>) &
    ((...r: [AA, BB, CC, DD, EE]) => R);
  ...
  > = ((...r: [AA]) => CurriedFunction5<BB, CC, DD, EE, FF, R>) &
    ((
      ...r: [$npm$ramda$Placeholder, BB]
    ) => CurriedFunction5<AA, CC, DD, EE, FF, R>) &
    ((...r: [AA, BB]) => CurriedFunction4<CC, DD, EE, FF, R>) &
    ((
      ...r: [$npm$ramda$Placeholder, BB, CC]
    ) => CurriedFunction4<AA, DD, EE, FF, R>) &
    ((
      ...r: [AA, $npm$ramda$Placeholder, CC]
    ) => CurriedFunction4<BB, DD, EE, FF, R>) &
    ((...r: [AA, BB, CC]) => CurriedFunction3<DD, EE, FF, R>) &
    ((
      ...r: [$npm$ramda$Placeholder, BB, CC, DD]
    ) => CurriedFunction3<AA, EE, FF, R>) &
    ((
      ...r: [AA, $npm$ramda$Placeholder, CC, DD]
    ) => CurriedFunction3<BB, EE, FF, R>) &
    ((
      ...r: [AA, BB, $npm$ramda$Placeholder, DD]
    ) => CurriedFunction3<CC, EE, FF, R>) &
    ((...r: [AA, BB, CC, DD]) => CurriedFunction2<EE, FF, R>) &
    ((
      ...r: [$npm$ramda$Placeholder, BB, CC, DD, EE]
    ) => CurriedFunction2<AA, FF, R>) &
    ((
      ...r: [AA, $npm$ramda$Placeholder, CC, DD, EE]
    ) => CurriedFunction2<BB, FF, R>) &
    ((
      ...r: [AA, BB, $npm$ramda$Placeholder, DD, EE]
    ) => CurriedFunction2<CC, FF, R>) &
    ((
      ...r: [AA, BB, CC, $npm$ramda$Placeholder, EE]
    ) => CurriedFunction2<DD, FF, R>) &
    ((...r: [AA, BB, CC, DD, EE]) => CurriedFunction1<FF, R>) &
    ((
      ...r: [$npm$ramda$Placeholder, BB, CC, DD, EE, FF]
    ) => CurriedFunction1<AA, R>) &
    ((
      ...r: [AA, $npm$ramda$Placeholder, CC, DD, EE, FF]
    ) => CurriedFunction1<BB, R>) &
    ((
      ...r: [AA, BB, $npm$ramda$Placeholder, DD, EE, FF]
    ) => CurriedFunction1<CC, R>) &
    ((
      ...r: [AA, BB, CC, $npm$ramda$Placeholder, EE, FF]
    ) => CurriedFunction1<DD, R>) &
    ((
      ...r: [AA, BB, CC, DD, $npm$ramda$Placeholder, FF]
    ) => CurriedFunction1<EE, R>) &
  ...
  declare function then<A, R>(
    onSuccess: UnaryFn<A, R> | UnaryPromiseFn<A, R>
  ): CurriedFunction1<Promise<A>, Promise<R>>;
  declare function then<A, R>(
    onSuccess: UnaryFn<A, R> | UnaryPromiseFn<A, R>,
    p: Promise<A>
  ): Promise<R>;
  ...
  declare type ReplacementFn = (
    substring: string,
    ...args: Array<string>
  ) => string;
  declare function replace<A: RegExp | string, B: string | ReplacementFn>(
    A
  ): CurriedFunction2<B, string, string>;
  declare function replace<A: RegExp | string, B: string | ReplacementFn>(
    A,
    B
  ): CurriedFunction1<string, string>;
  declare function replace<A: RegExp | string, B: string | ReplacementFn>(
    A,
    B,
    string
  ...
  declare function append<A, E>(
    A
  ): CurriedFunction1<$ReadOnlyArray<E>, Array<E | A>>;
  ...
  declare function groupBy<T>(
    fn: (x: T) => string
  ): CurriedFunction1<$ReadOnlyArray<T>, { [string]: Array<T>, ... }>;
  ...
  declare function pluck<V, K: $Keys<V>>(
    key: K,
    list: V[]
  ): Array<$ElementType<V, K>>;
  declare function pluck<V, K: $Keys<V>>(
    key: K
  ): (list: V[]) => Array<$ElementType<V, K>>;
  declare function pluck<T, V: T[]>(
    key: number,
    list: V[]
  ): Array<$ElementType<V, number>>;
  declare function pluck<T, V: T[]>(
    key: number
  ): (list: V[]) => Array<$ElementType<V, number>>;
   ...
   */
  declare type MakeComparator = <A, B>(
    (A) => B
  ) => CurriedFunction2<A, A, number>;
  ...
  declare function without<T, E>(
    $ReadOnlyArray<E>,
    $ReadOnlyArray<E | T>
  ): Array<E | T>;
  declare function without<T, E>(
    $ReadOnlyArray<E>
  ): CurriedFunction1<$ReadOnlyArray<E | T>, Array<E | T>>;
  ...
  declare function fromPairs<T, V>(
    pair: Array<[T, V]>
  ): { [key: string]: V, ... };
  ...
  declare type RelationCompare = ((x: number) => (y: number) => boolean) &
  ...
  declare function hasPath<T: string | number>(
    path: Array<T>
  ): (o: Object) => boolean;
  declare function hasPath<T: string | number>(
    path: Array<T>,
  ...
  declare var lens: (<A, B, Fa, Fb>(
    getter: (f: Fa) => A
  ) => (setter: (b: B, f: Fa) => Fb) => LensObj<Fa, A, Fb>) &
    (<A, B, Fa, Fb>(
      getter: (f: Fa) => A,
      setter: (b: B, f: Fa) => Fb
    ) => LensObj<Fa, A, Fb>) &
    (<A, B, Fa: Functor<A>, Fb: Functor<B>>(
      getter: (f: Fa) => A
    ) => (setter: (b: B, f: Fa) => Fb) => Lens<A, B, Fa, Fb>) &
    (<A, B, Fa: Functor<A>, Fb: Functor<B>>(
      getter: (f: Fa) => A,
      setter: (b: B, f: Fa) => Fb
    ) => Lens<A, B, Fa, Fb>);
   ...
   */
  declare function lensPath<O, F, K: $Keys<F>>(
    p: [K]
  ): LensObj<F, $ElementType<F, K>, O>;
  ...
  declare function lensPath<
    ...
    E0: $ElementType<F, K0>,
    K1: $Keys<E0>,
    E1: $ElementType<E0, K1>,
    K2: $Keys<E1>
  >(
    p: [K0, K1, K2]
  ): LensObj<F, $ElementType<E1, K2>, O>;
  declare function lensPath<
    O,
    F,
    K0: $Keys<F>,
    ...
    E1: $ElementType<E0, K1>,
    K2: $Keys<E1>,
    E2: $ElementType<E1, K2>,
    K3: $Keys<E2>
  >(
    p: [K0, K1, K2, K3]
  ): LensObj<F, $ElementType<E2, K3>, O>;
  declare function lensPath<
    O,
    F,
    K0: $Keys<F>,
    ...
    E2: $ElementType<E1, K2>,
    K3: $Keys<E2>,
    E3: $ElementType<E2, K3>,
    K4: $Keys<E3>
  >(
    p: [K0, K1, K2, K3, K4]
  ): LensObj<F, $ElementType<E3, K4>, O>;

  // declare function lensProp(str: string): Lens;
  declare function lensProp<O, F, K: $Keys<F>>(
    K
  ): LensObj<F, $ElementType<F, K>, O>;
  ...
  declare var over: (<A, B, Oa, Ob>(
    lens: LensObj<Oa, A, B>
  ) => CurriedFunction2<(A) => B, Oa, Ob>) &
    (<A, B, Oa, Ob>(
      lens: LensObj<Oa, A, B>,
      (A) => B
    ) => CurriedFunction1<Oa, Ob>) &
    (<A, B, Oa, Ob>(lens: LensObj<Oa, A, B>, (A) => B, Oa) => Ob) &
    (<A, B, Fa: Functor<A>, Fb: Functor<B>>(
      lens: Lens<A, B, Fa, Fb>
    ) => CurriedFunction2<(A) => B, Fa, Fb>) &
    (<A, B, Fa: Functor<A>, Fb: Functor<B>>(
      lens: Lens<A, B, Fa, Fb>,
      (A) => B
    ) => CurriedFunction1<Fa, Fb>) &
    (<A, B, Fa: Functor<A>, Fb: Functor<B>>(
      lens: Lens<A, B, Fa, Fb>,
      (A) => B,
      Fa
  ...
  declare function path<T: string | number, V>(p: Array<T>): (o: mixed) => ?V;
  declare function path<T: string | number, V, A: NestedObject<V>>(
    p: Array<T>,
    o: A
  ): V;
  declare function path<T: string | number, V, A: null | void>(
    p: Array<T>,
    o: A
  ): void;
  ...
  declare function pathOr<T, U: string | number, V, A: NestedObject<V>>(
    or: T
  ): ((p: Array<U>) => (o: ?A) => V | T) & ((p: Array<U>, o: ?A) => V | T);
  declare function pathOr<T, U: string | number, V, A: NestedObject<V>>(
    or: T,
    p: Array<U>
  ): (o: ?A) => V | T;
  ...
  declare function pick<O, K: $ReadOnlyArray<$Keys<O>>>(keys: K): (val: O) => O;
  declare function pick<O, K: $ReadOnlyArray<$Keys<O>>>(keys: K, val: O): O;
  ...
  declare function valuesIn<T, O: { [k: string]: T, ... }>(
    o: O
  ): Array<T | any>;
  ...
  declare var view: (<A, B, Oa, Ob>(LensObj<Oa, A, B>) => Oa => A) &
