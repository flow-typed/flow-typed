// @flow
/**
 * Flowtype definitions for dojox.calc
...
*/
declare class GraphPro mixins undefined.Standard {
 ...
 * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
*/
declare class Standard mixins dijit._WidgetBase, dijit._TemplatedMixin, dijit._WidgetsInTemplateMixin {
    constructor(params?: Object, srcNodeRef?: HTMLElement): this;
...
declare module '_Executor' {
     ...
     * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
    */
    declare class _Executor mixins dijit._WidgetBase, dijit._TemplatedMixin {
        constructor(params?: Object, srcNodeRef?: HTMLElement): this;
     ...
     * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
    */
    declare class FuncGen mixins dijit._WidgetBase, dijit._TemplatedMixin, dijit._WidgetsInTemplateMixin {
        constructor(params?: Object, srcNodeRef?: HTMLElement): this;
     ...
     * @param srcNodeRef OptionalIf a srcNodeRef (DOM node) is specified:use srcNodeRef.innerHTML as my contentsif this is a behavioral widget then apply behavior to that srcNodeRefotherwise, replace srcNodeRef with my generated DOM tree
    */
    declare class Grapher mixins dijit._WidgetBase, dijit._TemplatedMixin, dijit._WidgetsInTemplateMixin {
        constructor(params?: Object, srcNodeRef?: HTMLElement): this;
        ...
        */
         ...
         * @param chart 
         */
        addXYAxes(chart: undefined.Chart2D): any;
 ...
 */
declare interface calc$FuncGen {
    ...
    approx(r: number): number,
         ...
         */
        draw(chart: undefined.Chart2D, functionToGraph: Function, params: Object): any,
 ...
 */
declare interface calc$Grapher {
...
declare module 'dojox/calc/_Executor' {
    declare     var exp: undefined._Executor;
...
declare module 'dojox/calc/_Executor.FuncGen' {
    declare     var exp: undefined.FuncGen;
    declare module.exports: typeof exp
}
declare module 'dojox/calc/_Executor.Grapher' {
    declare     var exp: undefined.Grapher;
    declare module.exports: typeof exp
}
...
declare module 'dojox/calc/toFrac' {
    declare     var exp: undefined.toFrac;
    declare module.exports: typeof exp
}
...
declare module 'dojox/calc/GraphPro' {
    declare     var exp: undefined.GraphPro;
    declare module.exports: typeof exp
}
declare module 'dojox/calc/Standard' {
    declare     var exp: undefined.Standard;
    declare module.exports: typeof exp
}