declare module "redux-actions" {
   ...
   *     }
   */
  declare type ActionType<ActionCreator> = _ActionType<any, ActionCreator>;
  declare type _ActionType<R, Fn: (...rest: any) => R> = R;
  ...
  */
  ...
  declare function handleAction<State, Action: { type: any, ... }>(
