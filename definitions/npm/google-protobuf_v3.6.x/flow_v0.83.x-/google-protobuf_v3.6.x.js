 ...
 * https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/google-protobuf
 */
...
declare module 'google-protobuf' {
  ...
  declare type Message$MessageArray = any[]; // This type needs to reference itself
  ...
  declare export class Message {
    ...
    // $FlowFixMe: flow doesn't support abstract instance method definitions.
  ...
  declare type Map$Iterator<T> = {
    next(): IteratorResult<T>,
  };

  declare type Map$IteratorResult<T> = {
    done: boolean,
    value: T,
  };
  ...
  declare export class BinaryIterator {
    ...
    get: () => ?ScalarFieldType;
    atEnd: () => boolean;
    next: () => ?ScalarFieldType;
  }

  declare type BinaryConstants$FieldType = {
    INVALID: -1,
    DOUBLE: 1,
    FLOAT: 2,
    INT64: 3,
  ...
  declare type BinaryConstants$WireType = {
    INVALID: -1,
    VARINT: 0,
    FIXED64: 1,
    DELIMITED: 2,
