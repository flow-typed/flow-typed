import type { FoundationStatic } from 'npm$namespace$Foundation'
...
declare module 'npm$namespace$Foundation' {
		declare interface AbidePatterns {
		alpha?: RegExp,
	...
	declare interface AbideOptions {
	...
	declare interface ClearingOptions {
		templates?: Object,
	...
	declare interface InterchangeOptions {
		load_attr?: string,
	...
	declare interface MagellanOptions {
		active_class?: string,
		threshold?: number,
	...
	declare interface OffCanvasOptions {
		open_method?: string,
		close_on_click?: boolean
	}

	declare interface OrbitOptions {
		animation?: string,
		timer_speed?: number,
	...
	declare interface RevealCSSOptions {
		opacity?: number,
		visibility?: string,
		display?: string
	}
	...
	declare interface TopbarOptions {
		index?: number,
		sticky_class?: string,
	...
	declare interface FoundationStatic {
		name: string,
		version: string,
		...
		debounce(
		func: (...args: any[]) => any, delay: number, immediate: boolean
	): (...args: any[]) => any,
