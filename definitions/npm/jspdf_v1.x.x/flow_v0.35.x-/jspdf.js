...
declare module 'jspdf' {
				declare class jsPDF  {
		constructor(orientation?: any, unit?: string, format?: string, compressPdf?: number): this;
		CapJoinStyles: any;
		version: string;
		internal: {
		...
		clip(): void;
		lines(
		lines: any, x: any, y: any, scale?: any, style?: string, closed?: boolean
	): jsPDF;
		...
		roundedRect(
		x: number, y: number, w: number, h: number, rx: number, ry: number, style: string
	): jsPDF;
		...
		createImageInfo(
		data: any, wd: any, ht: any, cs: any, bpc: any, imageIndex: number, alias: any, f?: any, dp?: any, trns?: any, pal?: any, smask?: any
	): any;
		addImage(
		imageData?: any, format?: any, x?: number, y?: number, w?: number, h?: number, alias?: any, compression?: any, rotation?: any
	): jsPDF;
		processJPEG(
		data: any, index: number, alias: any, compression?: any, dataAsBinaryString?: string
	): any;
		processJPG(): any;
		...
		cellInitialize(): void;
		cell(
		x: number, y: number, w: number, h: number, txt: string, ln: number, align: string
	): jsPDF;
		...
		arc(
		x: number, y: number, radius: number, startAngle: number, endAngle: number, anticlockwise: any
	): void,
		drawImage(
		img: string, x: number, y: number, w: number, h: number, x2?: number, y2?: number, w2?: number, h2?: number
	): void,
		stroke(): void,
		fill(): void,
		...
		fromHTML(
		HTML: string | HTMLElement, x: number, y: number, settings?: any, callback?: Function, margins?: any
	): jsPDF;
		addJS(txt: string): jsPDF;
		processPNG(
		imageData: any, imageIndex: number, alias: string, compression: any, dataAsBinaryString: string
	): any;
