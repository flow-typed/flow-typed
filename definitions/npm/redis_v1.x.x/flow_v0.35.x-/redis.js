...
declare module 'redis' {
		declare export interface MessageHandler<M> {
		(channel: string, message: M): void
	}

	declare export interface CommandT<R> {
		(args: any[], callback?: ResCallbackT<R>): void,
		(...args: any[]): void
	}

	declare export interface ResCallbackT<R> {
		(err: Error, res: R): void
	}

	declare export interface ServerInfo {
		redis_version: string,
		versions: number[]
	}

	declare export interface RetryStrategyOptions {
		error: Error,
	...
	declare export interface RetryStrategy {
		(options: RetryStrategyOptions): number | Error
	}

	declare export interface ClientOpts {
		parser?: string,
	...
	declare export interface RedisClient {
		connected: boolean,
		retry_delay: number,
		...
		bitcount(
		key: string, start: number, end: number, callback?: ResCallbackT<number>
	): boolean,
	...
	declare export interface Multi {
