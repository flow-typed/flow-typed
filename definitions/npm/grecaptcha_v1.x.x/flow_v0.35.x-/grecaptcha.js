/**
 * Flowtype definitions for grecaptcha
...
declare class ReCaptcha {
     ...
     * @param parameters An object containing parameters as key=value pairs, for example, {"sitekey": "your_site_key", "theme": "light"}. See 
     * @see  render parameters.
     * @return  the ID of the newly created widget.
     */
    render(container: (string | HTMLElement), parameters?: ReCaptchaV2$Parameters): number;
...
declare type ReCaptchaV2$Theme = "light" | "dark";

declare type ReCaptchaV2$Type = "image" | "audio";

declare type ReCaptchaV2$Size = "normal" | "compact";

declare interface ReCaptchaV2$Parameters {
