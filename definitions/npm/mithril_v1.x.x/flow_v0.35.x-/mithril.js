// @flow
/**
 * Flowtype definitions for mithril
...
declare type Mithril$ChildArray = {} & Array


declare type Mithril$Children = Mithril$Child | Mithril$ChildArray;

declare type Mithril$Child = string | Mithril$VirtualElement | Mithril$Component<Mithril$Controller>;
...
declare interface Mithril$Static {
     ...
     * @see  m.component
    */
    (selector: string, ...children: Mithril$Children[]): Mithril$VirtualElement,
     ...
     * @see  m.component
    */
    (selector: string, attributes: Mithril$Attributes, ...children: Mithril$Children[]): Mithril$VirtualElement,
     ...
     * @see  m
     */
    (component: Mithril$Component<T>, ...args: any[]): Mithril$Component<T>,
         ...
         * @see  m.withAttr
        */
        prop<T>(promise: Mithril$Thennable<T>): Mithril$Promise<T>,
         ...
         * @see  m.withAttr
         */
        prop<T>(value: T): Mithril$BasicProperty<T>,
         ...
         * @see  m.withAttr
         */
        prop<T>(): Mithril$BasicProperty<T>,
        ...
        withAttr(
            ...
            callbackThis?: any): (e: Mithril$Event) => void,

        /**
         * 
         * @deprecated  Use m.mount instead
         */
        module<T>(rootElement: Node, component: Mithril$Component<T>): T,
         ...
         */
        mount<T>(rootElement: Node, component: Mithril$Component<T>): T,
         ...
         * @see  m
         */
        component<T>(component: Mithril$Component<T>, ...args: any[]): Mithril$Component<T>,
        ...
        it as trusted.
        */
        trust(html: string): Mithril$TrustedString,
        ...
        */
        render(
            rootElement: Element,
            children: Mithril$VirtualElement | Mithril$VirtualElement[],
        ...
        redraw: {
            ...
            */
            strategy: Mithril$BasicProperty<"all" | "diff" | "none" >
        },
        route: {
            ...
            */
            (rootElement: Element, defaultRoute: string, routes: Mithril$Routes): void,
            ...
            ```
            */
            (element: Element, isInitialized: boolean, context?: Mithril$Context, vdom?: Mithril$VirtualElement): void,
         ...
         */
        request(options: Mithril$XHROptions): Mithril$Promise<any>,
         ...
         */
        request(options: Mithril$JSONPOptions): Mithril$Promise<any>,
        deferred: {
        ...
        */
        sync<T>(promises: Mithril$Thennable<T>[]): Mithril$Promise<T[]>,
...
declare type Mithril$TrustedString = {
 ...
 * @see  m
 */
declare interface Mithril$VirtualElement {
 ...
 */
declare interface Mithril$Event {
 ...
 * @see  ElementConfig
 */
declare interface Mithril$Context {
 ...
 * @see  Context
*/
declare interface Mithril$ElementConfig {
 ...
 * @see  m
 */
declare interface Mithril$Attributes {
    ...
    className?: string,
         ...
         */
        key?: string | number, [property: string]: any
}
 ...
 */
declare interface Mithril$Controller {
     ...
     */
    onunload(evt: Mithril$Event): any
}
 ...
 */
declare interface Mithril$ControllerFunction<T>{
    (...args: any[]): T
}
 ...
 */
declare interface Mithril$ControllerConstructor<T>{
    new(...args: any[]): T
}
 ...
 * @see  m.component
 */
declare interface Mithril$Component<T>{

    /**
     * The component's controller.
     * @see  m.component
     */
    controller: Mithril$ControllerFunction<T>| Mithril$ControllerConstructor<T>,

    /**
     * Creates a view out of virtual elements.
     * @see  m.component
     */
    view(ctrl?: T, ...args: any[]): Mithril$VirtualElement
}
 ...
 * @see  m.prop
 */
declare interface Mithril$Property<T>{
 ...
 */
declare type Mithril$BasicProperty<T>= {
 ...
 */
declare interface Mithril$Routes {
    [key: string]: Mithril$Component<Mithril$Controller >
}
 ...
 */
declare interface Mithril$Deferred<T>{
 ...
 */
declare interface Mithril$SuccessCallback<T, U>{
    (value: T): U | Mithril$Thennable<U >
}
 ...
 */
declare interface Mithril$ErrorCallback<T>{
    (value: Error): T | Mithril$Thennable<T >
}
 ...
 */
declare interface Mithril$Thennable<T>{
    then<U>(success: Mithril$SuccessCallback<T, U>): Mithril$Thennable<U>,
    then<U,
    V>(
        success: Mithril$SuccessCallback<T, U>,
        error: Mithril$ErrorCallback<V>): Mithril$Thennable<U | V>,
    catch (error: Mithril$ErrorCallback<T>): Mithril$Thennable<T>,
    catch<U>(error: Mithril$ErrorCallback<U>): Mithril$Thennable<T | U >
}
 ...
 */
declare type Mithril$Promise<T>= {
     ...
     */
    then<U>(success: Mithril$SuccessCallback<T, U>): Mithril$Promise<U>,
    ...
    V>(
        success: Mithril$SuccessCallback<T, U>,
        error: Mithril$ErrorCallback<V>): Mithril$Promise<U | V>,
     ...
     * @return  The chained promise.
     */
    catch<U>(error: Mithril$ErrorCallback<U>): Mithril$Promise<T | U >
} & Mithril$Thennable & Mithril$Property
 ...
 * @see  m.request
 */
declare interface Mithril$RequestOptions {
 ...
 * @see  m.request
 */
declare type Mithril$XHROptions = {
