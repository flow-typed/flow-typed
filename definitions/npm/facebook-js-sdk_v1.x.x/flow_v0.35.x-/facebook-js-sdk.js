/**
 * Flowtype definitions for facebook-js-sdk
...
declare interface facebook$FacebookStatic {
    api: any,
         ...
         */
        getAuthResponse(callback: (response: facebook$AuthResponse) => void): void,
         ...
         * @param callback function to handle the response.
         */
        getLoginStatus(callback: (response: facebook$AuthResponse) => void, roundtrip?: boolean): void,
        ...
        */
        login(
            callback: (response: facebook$AuthResponse) => void,
         ...
         * @param callback function to handle the response
         */
        logout(callback: (response: facebook$AuthResponse) => void): void,
        ui: any,
        XFBML: any
}
