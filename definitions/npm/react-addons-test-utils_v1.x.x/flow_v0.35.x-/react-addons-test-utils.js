...
declare var npm$namespace$TestUtils: {
...
declare export var copy: ___React$EventSimulator;
...
declare export function TestUtils$renderIntoDocument<T>(element: DOMElement<any, T>): T

declare export function TestUtils$mockComponent(mocked: ___React$MockedComponentClass, mockTagName?: string): typeof TestUtils

declare export function TestUtils$isElementOfType<T>(element: ReactElement<any>, type: string): ReactHTMLElement

declare export function TestUtils$isDOMComponent(instance: ReactInstance): Element

declare export function TestUtils$isCompositeComponent(instance: ReactInstance): Component

declare export function TestUtils$isCompositeComponentWithType<T, C>(instance: ReactInstance, type: ClassType<any, T, C>): T

declare export function TestUtils$findAllInRenderedTree(root: Component<any, any>, fn: (i: ReactInstance) => boolean): ReactInstance[]

declare export function TestUtils$scryRenderedDOMComponentsWithClass(root: Component<any, any>, className: string): Element[]

declare export function TestUtils$findRenderedDOMComponentWithClass(root: Component<any, any>, className: string): Element

declare export function TestUtils$scryRenderedDOMComponentsWithTag(root: Component<any, any>, tagName: string): Element[]

declare export function TestUtils$findRenderedDOMComponentWithTag(root: Component<any, any>, tagName: string): Element

declare export function TestUtils$scryRenderedComponentsWithType<T, C>(root: Component<any, any>, type: ClassType<any, T, C>): T[]

declare export function TestUtils$findRenderedComponentWithType<T, C>(root: Component<any, any>, type: ClassType<any, T, C>): T

declare export function TestUtils$createRenderer(): ___React$ShallowRendererdeclare module 'react-addons-test-utils' {
