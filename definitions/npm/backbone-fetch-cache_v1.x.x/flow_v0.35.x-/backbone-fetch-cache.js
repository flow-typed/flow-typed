// @flow
/**
 * Flowtype definitions for backbone-fetch-cache
...
declare interface BackboneFetchCache$SuperMethods {
...
declare interface BackboneFetchCache$GetCacheOptions {
    data?: any,
        url?: string
}

declare type BackboneFetchCache$SetCacheOptions = {
    cache: boolean,
    expires: boolean | number,
    prefill: boolean,
    prefillExpires: boolean | number
} & BackboneFetchCache$GetCacheOptions


declare interface BackboneFetchCache$Cache {
    expires: number,
        lastSync: number,
...
declare interface BackboneFetchCache$GetCacheKeyObject {
    getCacheKey?: (opts?: BackboneFetchCache$GetCacheOptions) => string,
        url?: () => string
}

declare type BackboneFetchCache$GetCacheKeyOptions = string | {
    url: string
} | BackboneFetchCache$GetCacheKeyObject;

declare interface BackboneFetchCache$Static {
    ...
    enabled: boolean,
        ...
        */
        getCache(
            key: () => string,
            opts?: BackboneFetchCache$GetCacheOptions): BackboneFetchCache$Cache,
        getCache(
            key: BackboneFetchCache$GetCacheKeyOptions,
            opts?: BackboneFetchCache$GetCacheOptions): BackboneFetchCache$Cache,
        getCacheKey(key: () => string, opts?: BackboneFetchCache$GetCacheOptions): string,
        getCacheKey(
            key: BackboneFetchCache$GetCacheKeyOptions,
            opts?: BackboneFetchCache$GetCacheOptions): string,

        /**
         * If you want to know when was the last (server) sync of a given key, you can use.
         */
        getLastSync(key: () => string, opts?: BackboneFetchCache$GetCacheOptions): number,
        getLastSync(
            key: BackboneFetchCache$GetCacheKeyOptions,
            opts?: BackboneFetchCache$GetCacheOptions): number,
        ...
        */
        priorityFn(a: BackboneFetchCache$Cache, b: BackboneFetchCache$Cache): number,
        reset(): void,
        setCache(
            instance: () => string,
            opts?: BackboneFetchCache$SetCacheOptions,
            attrs?: any): void,
        setCache(
            instance: BackboneFetchCache$GetCacheKeyOptions,
            opts?: BackboneFetchCache$SetCacheOptions,
            attrs?: any): void,
        setLocalStorage(...args: any[]): any,
        _superMethods: BackboneFetchCache$SuperMethods
}
declare module 'Backbone' {
    declare     var fetchCache: BackboneFetchCache$Static;
    ...
    */
    declare type ModelFetchWithCacheOptions = {
