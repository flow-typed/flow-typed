...
declare module 'samlp' {
	...
	declare export interface IdPOptions {
		...
		getPostURL: (
		audience: string, authnRequestDom: any, req: express.Request, callback: (err: any, url: string) => void
	) => void
	}
	...
	declare export function getSamlResponse(
		options: IdPOptions, user: any, callback: (err: any, samlResponse: string) => void
	): void
