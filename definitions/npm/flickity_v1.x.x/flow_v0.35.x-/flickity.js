/**
 * Flowtype definitions for flickity
...
declare class Flickity {
    ...
    */
     ...
     * @see  FlickityEvents class for filckity supported events)
     * @param callback callback funtion to execute when event fires
     */
    on(
        eventname: string,
        callback: (eventt?: Event, cellElement?: Element) => any): void;
    ...
    on(
        eventname: string,
        callback: (event?: Event, pointer?: Element | Touch) => any): void;
    ...
    on(
        eventname: string,
        callback: (event?: Event, pointer?: Element | Touch, moveVector?: Object) => any): void;
    ...
    off(
        eventname: string,
        callback: (event?: Event, cellElement?: Element) => any): void;
