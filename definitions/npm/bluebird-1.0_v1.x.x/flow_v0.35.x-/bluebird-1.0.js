/**
 * Flowtype definitions for bluebird-1.0
...
declare class Promise<R>mixins Promise$Thenable<R>{
    ...
    */
        ...
        onReject: (error: any) => Promise$Thenable<U>): Promise<U>;
    caught<U>(
        predicate: (error: any) => boolean,
        onReject: (error: any) => Promise$Thenable<U>): Promise<U>;
    ...
    */
    ...
    spread<U>(
        onFulfill: Function,
        onReject?: (reason: any) => Promise$Thenable<U>): Promise<U>;
    ...
    map<Q,
    U>(
        mapper: (item: Q, index: number, arrayLength: number) => Promise$Thenable<U>): Promise<U[]>;
    map<Q,
    U>(mapper: (item: Q, index: number, arrayLength: number) => U): Promise<U[]>;
     ...
     */
    filter<U>(
        filterer: (item: U, index: number, arrayLength: number) => Promise$Thenable<boolean>): Promise<U[]>;
    filter<U>(
        filterer: (item: U, index: number, arrayLength: number) => boolean): Promise<U[]>;
    ...
    */
     ...
     */
    settle<R>(
        values: Promise$Thenable<Promise$Thenable<R>[]>): Promise<Promise$Inspection<R>[]>;
    ...
    */
    ...
    U>(
        values: Promise$Thenable<Promise$Thenable<R>[]>,
        mapper: (item: R, index: number, arrayLength: number) => Promise$Thenable<U>): Promise<U[]>;
    map<R,
    U>(
        values: Promise$Thenable<Promise$Thenable<R>[]>,
        mapper: (item: R, index: number, arrayLength: number) => U): Promise<U[]>;
    map<R,
    U>(
    ...
    */
    ...
    U>(
        ...
        reducer: (
            ...
            current: R,
            index: number,
            arrayLength: number) => Promise$Thenable<U>,
        initialValue?: U): Promise<U>;
    reduce<R,
    U>(
        values: Promise$Thenable<Promise$Thenable<R>[]>,
    ...
    */
    filter<R>(
        values: Promise$Thenable<Promise$Thenable<R>[]>,
        filterer: (item: R, index: number, arrayLength: number) => Promise$Thenable<boolean>): Promise<R[]>;
    filter<R>(
        values: Promise$Thenable<Promise$Thenable<R>[]>,
