...
declare
export type axe$ImpactValue = "minor" | "moderate" | "serious" | "critical";

declare
export type axe$TagValue = "wcag2a" | "wcag2aa" | "section508" | "best-practice";

declare
export type axe$ReporterVersion = "v1" | "v2";

declare
export type axe$RunOnlyType = "rule" | "rules" | "tag" | "tags";

declare
export interface axe$ElementContext {
    node?: Object,
        selector?: string,
        include?: any[],
        exclude?: any[]
...
declare
export interface axe$AxeResults {
    url: string,
        timestamp: string,
        passes: axe$Pass[],
...
declare
export interface axe$Violation {
    description: string,
        help: string,
        helpUrl: string,
        id: string,
...
declare
export interface axe$NodeResult {
    html: string,
        impact: axe$ImpactValue,
        target: string[],
        any: axe$CheckResult[],
...
declare
export interface axe$CheckResult {
    id: string,
        impact: string,
        message: string,
        data: any,
...
declare
export interface axe$RelatedNode {
    target: string[],
        html: string
}

declare
export interface axe$Spec {
    branding?: {
            brand: string,
            application: string
        },
...
declare
export interface axe$AxePlugin {
    id: string,
        run(...args: any[]): any,
        commands: {
            id: string,
 ...
 */
declare
export function axe$configure(spec: axe$Spec): void
 ...
 */
declare
export function axe$getRules(tags?: string[]): Object[]
 ...
 */
declare
export function axe$reset(): void
 ...
 */
declare
export function axe$registerPlugin(plugin: axe$AxePlugin): void
 ...
 */
declare
export function axe$cleanup(): voiddeclare module 'axe-core' {
