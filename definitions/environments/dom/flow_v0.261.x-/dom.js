...
declare class Document extends Node {
  ...
  createElement<TName: $Keys<HTMLElementMap>>(localName: TName, options?: string | ElementCreationOptions): HTMLElementMap[TName];
  createElementNS<TName: $Keys<HTMLElementMap>>(namespaceURI: 'http://www.w3.org/1999/xhtml', qualifiedName: TName, options?: string | ElementCreationOptions): HTMLElementMap[TName];
  ...
  getElementsByTagName<TName: $Keys<HTMLElementMap>>(qualifiedName: TName): HTMLCollection<HTMLElementMap[TName]>;
  getElementsByTagNameNS<TName: $Keys<HTMLElementMap>>(namespaceURI: 'http://www.w3.org/1999/xhtml', qualifiedName: TName): HTMLCollection<HTMLElementMap[TName]>;
  ...
  querySelector<TSelector: $Keys<HTMLElementMap>>(selector: TSelector): HTMLElementMap[TSelector] | null;
  querySelectorAll<TSelector: $Keys<HTMLElementMap>>(selector: TSelector): NodeList<HTMLElementMap[TSelector]>;
...
declare class CanvasRenderingContext2D {
  ...
  roundRect(x: number, y: number, w: number, h: number, radii?: number | DOMPointInit | $ReadOnlyArray<number | DOMPointInit>): void;
...
declare class HTMLCanvasElement extends HTMLElement {
  ...
  getContext(contextId: "webgl", contextAttributes?: Partial<WebGLContextAttributes>): ?WebGLRenderingContext;
  // IE currently only supports "experimental-webgl"
  getContext(contextId: "experimental-webgl", contextAttributes?: Partial<WebGLContextAttributes>): ?WebGLRenderingContext;
