...
yup.addMethod(yup.date, 'newMethod', function(date: Date, message?: string) {
...
const asyncValidationErrorTest = function(): Promise<ValidationError> {
...
const syncValidationErrorTest = function(): ValidationError {
...
yup.string().transform(function(value: any, originalvalue: any) {
